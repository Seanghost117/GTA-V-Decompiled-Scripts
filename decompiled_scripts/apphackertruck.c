...
void __EntryFunction__()
{
	...
	iLocal_299 = 1;
	iLocal_300 = -1;
	if (INTERIOR::GET_INTERIOR_AT_COORDS(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("appBusinessHub")) > 1)
	{
		func_547(0, 1);
	}
...
void func_4()
{
	...
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_304))
		{
			iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_304);
			switch (iVar0)
			{
				case 0:
					func_458();
					DATAFILE::UGC_UPDATE_CONTENT(-1, "Select_Mission_Cancel", "DLC_GR_MOC_Computer_Sounds", 1);
					break;
				...
				case 2:
					func_363(1);
					DATAFILE::UGC_UPDATE_CONTENT(-1, "Log_In", "DLC_GR_MOC_Computer_Sounds", 1);
					break;
			...
			VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_122, 3);
		}
	}
}
...
void func_6()
{
	...
	while (iVar0 < 5)
	{
		...
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "ADD_JOB");
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iVar0);
		func_8(&cVar5);
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(-1);
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(0);
		if (CAM::IS_SCREEN_FADED_OUT(&Var6))
		{
			func_8(&cVar7);
		}
		else
		{
			MISC::UPDATE_ONSCREEN_KEYBOARD(&cVar7);
			HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(&Var6);
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "SHOW_JOB_OVERLAY");
...
int func_16(bool bParam0, int iParam1)
{
	...
	if ((Global_1590682[bParam0 /*883*/].f_274.f_183[iVar0 /*12*/].f_4 > 0 && !func_17(bParam0, iVar0)) && !func_23(iVar0))
	{
		return 1;
	}
	return 0;
...
int func_17(bool bParam0, int iParam1)
{
	...
	{
		return Global_1590682[bParam0 /*883*/].f_274.f_183[iParam1 /*12*/].f_6;
	}
	return 0;
}
...
int func_25(bool bParam0, int iParam1)
{
	...
	if (func_20(Global_1590682[bParam0 /*883*/].f_274.f_183[iParam1 /*12*/]))
	{
...
int func_26(bool bParam0, int iParam1)
{
	...
	while (iVar0 <= 5)
	{
		...
		{
			if (func_27(Global_1590682[bParam0 /*883*/].f_274.f_183[iVar0 /*12*/]) == iParam1)
			{
				return iVar0;
			}
		}
...
void func_29()
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "CLEAR_JOBS");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	iVar0 = 0;
	while (iVar0 < 9)
	{
...
void func_37(int iParam0)
{
	...
	{
		iLocal_302 = func_215(PLAYER::PLAYER_ID(), iVar0);
		iVar1 = func_19(PLAYER::PLAYER_ID(), iLocal_302);
		if (!func_24(PLAYER::PLAYER_ID(), iLocal_302) && !func_23(iVar1))
		{
			func_214();
		}
		else if (func_16(PLAYER::PLAYER_ID(), iLocal_302))
		{
			func_214();
		}
...
int func_45(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (!func_75(func_184(iParam1, -1, -1, -1), func_138(iParam1, -1, 1, -1, -1, bParam0), func_84(iParam1, -1, -1, -1, -1, bParam0), 0, 1))
	{
		return 0;
	}
	iVar0 = iParam1;
	...
	else if (func_64(iParam1) == 2)
	{
		...
		if (!bParam2)
		{
			if (Global_1630317[bParam0 /*595*/].f_11.f_34 != func_18())
			{
				return 9;
			}
		}
	...
	if (func_53(bParam0) + 1 < func_50(iVar0))
	{
		return 4;
	}
	switch (iParam1)
...
int func_57(int iParam0)
{
	...
	while (iVar0 < 32)
	{
		...
		if (AUDIO::PLAY_STREAM_FROM_VEHICLE(bVar1))
		{
			if ((Global_1630317[iParam0 /*595*/].f_11.f_34 != func_18() && Global_1630317[iParam0 /*595*/].f_11.f_34 == bVar1) && Global_1630317[bVar1 /*595*/].f_11.f_34 == iParam0)
			{
				return 1;
			}
		}
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_117(iParam1, iParam2, iParam3, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), iParam4);
		
		case 233:
			return func_110(iParam1, iParam2, iParam3, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), iParam4);
		...
		case 243:
			return func_93(iParam1, iParam2, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), iParam4);
		
		case 158:
			return func_88(iParam1, iParam2, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), iParam4);
		
		case 181:
			return func_85(iParam1, iParam2, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), iParam4);
...
int func_85(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	iVar0 = (iVar0 + func_86(iParam0, bParam2));
	return iVar0;
}
...
int func_88(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	iVar0 = (iVar0 + func_89(iParam0, bParam2));
	return iVar0;
}
...
int func_110(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (!func_115(iParam0))
	{
		if (bParam3 != func_18())
		{
			iVar0 = (iVar0 + func_112(iParam0, func_53(bParam3) + 1, bParam3, -1, iParam2));
		}
	}
	if (func_111(iParam0))
	{
...
int func_117(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (!func_127(iParam0))
	{
		if (bParam3 != func_18())
		{
			iVar0 = (iVar0 + func_119(iParam0, func_53(bParam3) + 1, bParam3, -1, iParam2));
		}
	}
	if (func_118(iParam0))
	{
...
int func_138(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_169(iParam1, iParam3, iParam4, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), 0, 0, 0);
		
		case 233:
			return func_160(iParam1, iParam3, iParam4, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_151(iParam1, iParam3, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), 0, -1, 0, 0);
		
		case 158:
			return func_145(iParam1, iParam3, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), 0, -1, 0, 0);
		
		case 181:
			return func_139(iParam1, iParam3, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), 0, -1, 0, 0);
...
int func_139(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam6)
	{
		...
		{
			iVar0 = (iVar0 + func_142(func_53(bParam2) + 1, iParam0, bParam2));
		}
	}
	if (!bParam3)
	{
...
int func_145(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam6)
	{
		...
		{
			iVar0 = (iVar0 + func_148(func_53(bParam2) + 1, iParam0, bParam2));
		}
	}
	if (!bParam3)
	{
...
int func_151(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam6)
	{
		...
		{
			iVar0 = (iVar0 + func_154(func_53(bParam2) + 1, iParam0));
		}
	}
	if (!bParam3)
	{
...
int func_160(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam5)
	{
		...
		if (bParam3 != func_18())
		{
			iVar0 = (iVar0 + func_165(iParam0, func_53(bParam3) + 1));
		}
	}
	if (!bParam6)
	{
		if (func_164(0, iParam1) != -1)
		{
			if (bParam3 != func_18())
			{
				iVar0 = (iVar0 + func_163(func_53(bParam3) + 1, iParam0));
			}
		}
	}
	if (!bParam4)
...
int func_169(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam5)
	{
		...
		if (bParam3 != func_18())
		{
			iVar0 = (iVar0 + func_174(iParam0, func_53(bParam3) + 1));
		}
	}
	if (!bParam6)
	{
		if (func_173(0, iParam1) != -1)
		{
			if (bParam3 != func_18())
			{
				iVar0 = (iVar0 + func_172(func_53(bParam3) + 1, iParam0));
			}
		}
	}
	if (!bParam4)
...
void func_214()
{
	DATAFILE::UGC_UPDATE_CONTENT(-1, "Select_Mission_Unavailable", "DLC_GR_MOC_Computer_Sounds", 1);
}
...
{
	return func_220(bParam0, iParam1) >= 40;
}
...
void func_225()
{
	...
	else
	{
		...
		else
		{
			...
			StringIntConCat(&cVar6, (iLocal_299 - 1), 16);
			...
			if (iVar9 <= 0)
			{
				if (!func_226())
				{
					iVar9 = (Global_262145.f_15104 - MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(MISC::GET_GAME_TIMER(), Global_2516617.f_142)));
				}
			}
			if (iVar9 > 0)
			{
			...
			if (CAM::IS_SCREEN_FADED_OUT(&cVar7))
			{
				func_8(&cVar6);
			}
			else
			{
				MISC::UPDATE_ONSCREEN_KEYBOARD(&cVar6);
				HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(&cVar7);
				if (!CAM::IS_SCREEN_FADED_OUT(&Var8))
				{
					HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(&Var8);
				}
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
			}
...
int func_258(int iParam0, int iParam1)
{
	...
	{
		bVar6 = iVar2;
		if (func_325(bVar6, 1, 1))
		{
			bVar9 = ((func_54(bVar6) != iVar5 || iVar5 == func_18()) && bVar6 != PLAYER::PLAYER_ID());
			iVar4 = 0;
			while (iVar4 < 10)
			{
				if (iVar0[iVar4] != -1)
				{
					...
					if (!func_323(Var7))
					{
						if (SYSTEM::VMAG(Global_2416085[bVar6]))
						{
							Var8 = { HUD::_0xF06EBB91A81E09E3(Global_2416085[bVar6]) };
	...
	if (iVar3 > 0)
	{
		*iParam1 = iVar1[NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, iVar3)];
		return 1;
	}
	else if (bVar10)
	{
...
int func_259(int iParam0, int iParam1)
{
	...
	{
		case 240:
			if (SYSTEM::VMAG(Global_2416085[PLAYER::PLAYER_ID()]))
			{
				Var0 = { HUD::_0xF06EBB91A81E09E3(Global_2416085[PLAYER::PLAYER_ID()]) };
...
Vector3 func_263(bool bParam0)
{
	...
	{
		func_318(func_320(bParam0), &iVar0);
		if (iVar0 > 0)
		{
...
int func_267(bool bParam0)
{
	...
	if (bParam0 != func_18() && (func_325(bParam0, 1, 1) || Global_2405074.f_2673))
	{
		bVar0 = unk_0xCE990E643CD9D0E5(Global_2425869[bParam0 /*443*/].f_314, 1);
		return bVar0;
	}
	return 0;
}
...
Vector3 func_268(bool bParam0)
{
	...
	if (func_316(bParam0))
	{
		...
		if (iVar0 != func_18())
		{
			if (!func_314(iVar0))
			{
				...
				{
					return Global_2425869[func_315(bParam0) /*443*/].f_314.f_10;
				}
			}
			else
			{
	...
	else if (func_309(bParam0) && !func_308(bParam0))
	{
	...
	else if (func_307(bParam0) && !func_306(bParam0))
	{
		if (func_317(bParam0) && func_305())
		{
	...
	else if (func_299(bParam0))
	{
		...
		if (iVar6 != func_18())
		{
			if (!func_297(iVar6))
			{
				...
				{
					return Global_2425869[func_298(bParam0) /*443*/].f_314.f_17;
				}
			}
			else
			{
	...
	else if (func_287(bParam0) && !func_286(bParam0))
	{
	...
	else if (func_280(bParam0, 0))
	{
		iVar12 = func_279(bParam0);
		if (iVar12 != func_18())
		{
			if (!func_327(iVar12))
			{
				...
				{
					return Global_1630317[func_279(bParam0) /*595*/].f_580;
				}
			}
			else
			{
	...
	else if (func_278(bParam0))
	{
		return -366.7f, -1909.6f, 20f;
	}
	else if (func_277(bParam0))
	{
		iVar14 = func_275(bParam0);
		if (iVar14 != func_18())
		{
	...
	if (func_295(bParam0))
	{
		return func_288(Global_2425869[bParam0 /*443*/].f_314.f_6);
	}
	if (func_269(bParam0))
	{
...
{
	if (((func_274(bParam0) || func_273(bParam0)) || func_272(bParam0)) || func_270(bParam0))
	{
		return 1;
	}
	return 0;
...
int func_270(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			...
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 19;
			}
		}
	}
	return 0;
...
int func_272(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 15;
			}
		}
	}
	return 0;
...
int func_273(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 16;
			}
		}
	}
	return 0;
...
int func_274(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 14;
			}
		}
	}
	return 0;
...
bool func_275(bool bParam0)
{
	...
	{
		iVar0 = func_271(func_276(bParam0));
		if ((iVar0 == 2 || iVar0 == 1) || iVar0 == 0)
		{
			if (func_91(bParam0, 0))
			{
...
int func_276(bool bParam0)
{
	if (bParam0 != func_18())
	{
		...
		else if (((Global_1312896 || Global_2405074.f_2673) && bParam0 == PLAYER::PLAYER_ID()) && func_325(bParam0, 1, 0))
		{
			return Global_2425869[bParam0 /*443*/].f_314.f_6;
		}
	}
...
int func_277(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 20;
			}
		}
		else if (((Global_2425869[bParam0 /*443*/].f_314.f_6 != -1 && Global_1312896) && bParam0 == PLAYER::PLAYER_ID()) && func_325(bParam0, 1, 0))
		{
			return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 20;
		}
	}
...
int func_278(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_280(bool bParam0, bool bParam1)
{
	...
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			...
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 12;
			}
		}
	}
	return 0;
...
int func_286(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_287(bParam0) && Global_2425869[bParam0 /*443*/].f_314.f_9 == bParam0)
		{
			return 1;
		}
	}
...
int func_287(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_294(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_295(bParam0) && Global_2425869[bParam0 /*443*/].f_314.f_9 == bParam0)
		{
			return 1;
		}
	}
...
int func_296(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 10;
			}
		}
	}
	return 0;
...
int func_299(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1 && Global_2425869[bParam0 /*443*/].f_314.f_9 != func_18())
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_306(bool bParam0)
{
	...
	if (func_307(bParam0) && Global_2425869[bParam0 /*443*/].f_314.f_9 == bParam0)
	{
		return 1;
	}
	return 0;
...
int func_307(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 9;
			}
		}
	}
	return 0;
...
int func_308(bool bParam0)
{
	...
	if (func_309(bParam0) && Global_2425869[bParam0 /*443*/].f_314.f_9 == bParam0)
	{
		return 1;
	}
	return 0;
...
int func_309(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 4;
			}
		}
	}
	return 0;
...
int func_310(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 6;
			}
		}
	}
	return 0;
...
int func_316(bool bParam0)
{
	if (bParam0 != func_18())
	{
		if (func_325(bParam0, 1, 1))
		{
			if (Global_2425869[bParam0 /*443*/].f_314.f_6 != -1 && Global_2425869[bParam0 /*443*/].f_314.f_9 != func_18())
			{
				return func_271(Global_2425869[bParam0 /*443*/].f_314.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_317(bool bParam0)
{
	if (bParam0 != func_18())
	{
		...
		else if ((Global_1312896 && bParam0 == PLAYER::PLAYER_ID()) && func_325(bParam0, 1, 0))
		{
			return Global_2425869[bParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
void func_332()
{
	...
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_122, 6);
	}
	iVar0 = 0;
	while (iVar0 < 3)
	{
		...
		bVar8 = func_340(PLAYER::PLAYER_ID());
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "ADD_JOB");
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iVar0);
		...
		{
			MISC::UPDATE_ONSCREEN_KEYBOARD(&cVar6);
			HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(&cVar1);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
		}
...
void func_343()
{
	...
	while (iVar0 < 9)
	{
		...
		bVar4 = ((func_347(PLAYER::PLAYER_ID()) && func_345(PLAYER::PLAYER_ID())) && !func_251(PLAYER::PLAYER_ID()));
		iVar5 = 0;
		iVar6 = 0;
		...
		{
			MISC::UPDATE_ONSCREEN_KEYBOARD(&cVar3);
			HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(&cVar2);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
		}
...
int func_345(bool bParam0)
{
	...
	return Global_1590682[bParam0 /*883*/].f_274.f_264.f_5;
}
...
void func_350()
{
	DATAFILE::UGC_UPDATE_CONTENT(-1, "Select_Mission_Are_You_Sure", "DLC_GR_MOC_Computer_Sounds", 1);
}
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "SHOW_OVERLAY");
	func_8(cParam0);
...
void func_363(int iParam0)
{
	...
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_1678288.f_3), 28);
	}
	iLocal_129 = iParam0;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "SHOW_SCREEN");
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iParam0);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
void func_364()
{
	if (func_457() != 0)
	{
		DATAFILE::UGC_UPDATE_CONTENT(-1, "Select_Mission_Launch", "DLC_GR_MOC_Computer_Sounds", 1);
	}
	switch (func_457())
	{
		case 1:
		...
		case 0:
			DATAFILE::UGC_UPDATE_CONTENT(-1, "Select_Mission_Unavailable_OK", "DLC_GR_MOC_Computer_Sounds", 1);
			break;
	}
	func_458();
}
...
var func_366(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
bool func_374(int iParam0, int iParam1, var uParam2)
{
	...
	switch (*uParam2)
	{
		case 0:
			...
			fVar0 = func_391(iParam0);
			if (func_387(78225582, -1799524201, iParam1, -1018905335, 1, 0, 1, 4, fVar0, 3))
			{
				*uParam2 = 1;
			}
			else
...
int func_387(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, void fParam8, int iParam9)
{
	bool bVar0;
	int iVar1;
	struct<4> Var2;
...
int func_411(bool bParam0, int iParam1)
{
	...
	{
		return func_64(Global_1630317[bParam0 /*595*/].f_11.f_33) == iParam1;
	}
	return 0;
}
...
int func_415(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (iParam0 == 4)
	{
		...
		if (iVar5 != 0)
		{
			...
			while (iVar0 < 4)
			{
				Global_1630317[PLAYER::PLAYER_ID() /*595*/].f_11.f_327[iVar0] = func_421(iVar5);
				iVar0++;
			}
			bVar3 = true;
		}
	...
	if (iParam0 != 4)
	{
		...
		else if (iVar4 >= iParam1)
		{
			...
			while (iVar0 < iParam1)
			{
				Global_1630317[PLAYER::PLAYER_ID() /*595*/].f_11.f_327[iVar0] = func_416(&iVar1, iVar4, &uVar8);
				iVar0++;
			}
			bVar3 = true;
		}
...
int func_416(int iParam0, int iParam1, var uParam2)
{
	...
	bVar4 = func_54(PLAYER::PLAYER_ID());
	...
	if (func_331(bVar4))
	{
		Var6 = { Global_1678288.f_496[func_419(func_222(bVar4)) /*3*/] };
		Var6.f_2 = 0f;
	}
	else
	{
	...
	if (iParam1 > 0)
	{
		...
		if (iVar3 > 0)
		{
			...
			func_417(uVar2[bVar13], &iVar8, &iVar9);
		...
		else
		{
			...
			if (iVar3 > 0)
			{
				...
				func_417(uVar2[bVar14], &iVar8, &iVar9);
				unk_0xBE20AB8238688965(uParam2[iVar8], iVar9);
				return uVar2[bVar14];
			}
			else
			{
				...
				func_417(uVar2[bVar15], &iVar8, &iVar9);
				unk_0xBE20AB8238688965(uParam2[iVar8], iVar9);
				return uVar2[bVar15];
			}
		}
...
void func_423()
{
	...
	while (iVar0 < 32)
	{
		...
		uVar6 = func_427(iVar4[iVar0], bVar5);
		...
		{
			bVar7 = func_424(bVar5, &(Global_1678221[iVar0]));
			if (func_425(PLAYER::PLAYER_ID(), Global_1678221[iVar0]))
			{
				func_424(bVar7, &(Global_1678221[iVar0]));
				if (func_425(PLAYER::PLAYER_ID(), Global_1678221[iVar0]))
				{
					Global_1678221[iVar0] = 0;
				}
...
int func_430(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	...
	if (iVar3 > 0)
	{
		if (!MONEY::_NETWORK_CASINO_CAN_PURCHASE_CHIPS_WITH_PVC_2(iVar3, 0, 1, 0, -1, 0))
		{
			DATAFILE::UGC_UPDATE_CONTENT(-1, "Select_Mission_Unavailable", "DLC_GR_MOC_Computer_Sounds", 1);
			return 0;
		}
	...
	if (func_395())
	{
		...
		fVar5 = func_438(iVar0);
		iVar6 = -1;
		iVar7 = 0;
		iVar8 = 1;
		while (func_437(&iVar6, iVar3, iVar0, -1799524201, -1018905335, iVar4, fVar5, &iVar8, &iVar7))
		{
			func_468();
			SYSTEM::WAIT(0);
		}
	...
	if (iVar3 >= 0 && (iVar3 == 0 || (iVar3 > 0 && (func_395() || MONEY::_NETWORK_CASINO_CAN_PURCHASE_CHIPS_WITH_PVC_2(iVar3, 0, 1, 0, -1, 0)))))
	{
		if (iVar3 > 0)
		{
		...
		if (func_395())
		{
			MONEY::NETWORK_BUY_HELI_STRIKE(func_385(func_392()));
		}
		MONEY::_NETWORK_BUY_CONTRABAND(iVar3, iParam0, AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&cVar1), false, true);
		if (func_395())
		{
			func_377(func_392());
		}
...
int func_437(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, void fParam6, int iParam7, int iParam8)
{
	if (*iParam7)
	{
		switch (*iParam8)
		{
			case 0:
				...
				if (func_387(78225582, iParam3, iParam5, iParam4, 1, iParam1, iParam2, 4, fParam6, 3))
				{
					if (*iParam8 != 3)
					{
						if (func_381())
...
bool func_442(var uParam0, bool bParam1)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			fVar1 = AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("MP_STAT_HANGAR_CONTRABAND_MISSION_v0");
			if (func_387(78225582, -1799524201, iVar0, -1018905335, 1, 0, 1, 4, fVar1, 3))
			{
				*uParam0 = 1;
			}
			else
...
void func_444(int iParam0)
{
	...
	else if (iParam0 == 229)
	{
		if (iLocal_301 == 8)
		{
			iLocal_301 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 8);
			func_452(18);
		}
		else
		{
...
void func_458()
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "HIDE_OVERLAY");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_361(0);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_122, false);
}
...
void func_459()
{
	if (func_460())
	{
		if (!unk_0xCE990E643CD9D0E5(uLocal_122, 3))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "GET_CURRENT_SELECTION");
...
void func_461()
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1f, -1f, -1f, -1f);
	}
	func_466(2, 206, 1);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 206))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1f, -1f, -1f, -1f);
	}
	if (unk_0x3430895AB97DE4F3(2))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1f, -1f, -1f, -1f);
		}
		func_466(2, 187, 1);
		if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1f, -1f, -1f, -1f);
		}
		if (STATS::STAT_GET_MASKED_INT(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1f, -1f, -1f, -1f);
		}
		if (STATS::STAT_GET_MASKED_INT(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1f, -1f, -1f, -1f);
		}
	}
	else
	{
		...
		if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1f, -1f, -1f, -1f);
		}
		func_466(2, 187, 1);
		if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1f, -1f, -1f, -1f);
		}
	}
	func_466(2, 189, 1);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 189))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1f, -1f, -1f, -1f);
	}
	func_466(2, 190, 1);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 190))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1f, -1f, -1f, -1f);
	}
	func_466(2, 201, 1);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 201))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1f, -1f, -1f, -1f);
	}
	func_466(2, 202, 1);
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1f, -1f, -1f, -1f);
	}
	func_466(2, 204, 1);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 204))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_303, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1f, -1f, -1f, -1f);
	}
	if (unk_0x3430895AB97DE4F3(2))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "SET_ANALOG_STICK_INPUT");
			iLocal_305 = iVar0;
			iLocal_306 = iVar1;
			unk_0xF1B28F753235CE2A(true);
			NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_305);
			NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_306);
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
	}
	func_466(2, 197, 1);
	...
	if (((iVar2 != 127 || iLocal_307 != 127) || iVar3 != 127) || iLocal_308 != 127)
	{
		...
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_307);
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_308);
		unk_0xF1B28F753235CE2A(bVar4);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
...
void func_462()
{
	...
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_122, 5);
		func_332();
	}
	else if (func_464())
	{
...
void func_463()
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "HIDE_JOB_OVERLAY");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_122, 4);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_122, 5);
}
...
void func_468()
{
	...
	unk_0x9D15035C6653D1B1(1);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING(iLocal_303, 255, 255, 255, 255, 0);
	func_479();
	func_472(0);
	func_469(1);
}
	...
	else
	{
		...
		if (!func_223(12) || unk_0xCE990E643CD9D0E5(uLocal_122, 7))
		{
			if (func_1(&uLocal_309, 500, 0))
			{
				...
				if (func_223(12))
				{
					VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_122, 7);
				}
				else
				{
...
void func_486(int iParam0)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "UPDATE_MISSION");
	iVar0 = iParam0;
	iVar1 = 0;
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_303, "UPDATE_COOLDOWN");
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iParam0);
...
void func_514()
{
	...
	{
		if (func_517(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_525()
{
	...
	else if (unk_0xCE990E643CD9D0E5(uLocal_122, 8))
	{
		...
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_122, 8);
			iLocal_126 = 0;
			func_250(&uLocal_315);
			if (func_527())
			{
...
bool func_530(bool bParam0)
{
	...
	return NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(iVar0, iVar1);
}
...
void func_534()
{
	...
	else if (func_467() || STATS::STAT_GET_MASKED_INT(2, 199))
	{
		func_547(0, 1);
	}
...
{
	func_534();
	iLocal_303 = unk_0x5DEA4192B46CB99B("hacker_truck_desktop");
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_303))
	{
		SYSTEM::WAIT(0);
	}
	func_473(1);
...
void func_547(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		DATAFILE::UGC_UPDATE_CONTENT(-1, "Logout", "DLC_GR_MOC_Computer_Sounds", 1);
	}
	if (ENTITY::GET_ENTITY_HEADING())
	{
		func_540(0, 1, 1, 1);
