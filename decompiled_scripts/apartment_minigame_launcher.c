...
void __EntryFunction__()
{
	...
	while (!bVar0)
	{
		...
		if (!bVar0 && func_149(&uLocal_118) >= 25f)
		{
			func_170();
		}
	}
...
void func_3()
{
	...
	while (iVar4 < 2)
	{
		...
		{
			if (!func_183(&uLocal_204))
			{
				func_16(&uLocal_204, 1f);
			}
			else if (func_14(&uLocal_204) >= 1f)
			{
				func_11(&uLocal_204);
				iVar8 = -1;
				bVar9 = false;
...
void func_25(var uParam0, var uParam1, var uParam2)
{
	...
	switch (Local_209[unk_0x59E2AD1A8ACEDA31() /*5*/].f_4)
	{
		case 0:
			...
			{
				if (!func_183(&uLocal_124))
				{
					func_182(&uLocal_124);
				}
				else if (func_14(&uLocal_124) >= 4f)
				{
		...
		case 3:
			if (!func_183(&uLocal_121))
			{
				func_182(&uLocal_121);
				iLocal_87 = 0;
			}
			else if (func_14(&uLocal_121) >= 30f)
			{
				iLocal_87 = 1;
			}
			if (!unk_0x7BCC91F3C1CF24E8(Local_137.f_3))
	...
	if (bParam1)
	{
		switch (Local_137.f_4)
		{
				...
				if (Local_127.f_4 && Local_127.f_7)
				{
					...
					else
					{
						...
						if (unk_0x1BD7199394D7F19A(2, 51))
						{
							...
							func_17(&uLocal_128, 1, 1);
							func_17(&uLocal_128, 2, 1);
							func_17(&uLocal_128, 3, 0);
							func_17(&uLocal_128, 5, 1);
							Local_127 = true;
							if (!func_183(&uLocal_115))
							{
								func_182(&uLocal_115);
			...
			case 2:
				...
				unk_0x779660A9E5364C4D(0, 12, 1);
				unk_0x779660A9E5364C4D(0, 13, 1);
				fVar5 = unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_149[0 /*13*/], 1);
				fVar6 = unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_149[1 /*13*/], 1);
				if (fVar5 < fVar6)
				{
					Var4 = { Local_149[0 /*13*/] };
				}
				...
				if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
				{
					unk_0x83CAF206A9B8748C(unk_0x9B0761B4C3EB8BC7(), Var4, 1f, 300, uVar7, 0.05f);
				}
				func_41(&Local_137, 6);
				break;
			...
			case 6:
				...
				unk_0x779660A9E5364C4D(0, 12, 1);
				unk_0x779660A9E5364C4D(0, 13, 1);
				if (func_183(&uLocal_198))
				{
					func_150(&uLocal_198);
				}
				if (!func_183(&uLocal_201))
				{
					func_16(&uLocal_201, 1f);
				}
				else if (func_14(&uLocal_201) >= 1f || !func_19(&(Local_209[unk_0x59E2AD1A8ACEDA31() /*5*/]), 3))
				{
					func_11(&uLocal_201);
				...
				if (!func_183(&uLocal_112))
				{
					func_182(&uLocal_112);
				}
				else if (func_14(&uLocal_112) >= 1f)
				{
				...
				func_17(&uLocal_128, 0, 1);
				func_17(&uLocal_128, 1, 0);
				func_17(&uLocal_128, 2, 1);
				func_17(&uLocal_128, 3, 1);
				func_44(&(Local_209[unk_0x59E2AD1A8ACEDA31() /*5*/]), 1, 1);
				if (func_19(&(Local_209[unk_0x59E2AD1A8ACEDA31() /*5*/]), 3))
				{
...
void func_114(var uParam0)
{
	...
	uParam0->f_12 = 1;
	if ((!func_112(&uLocal_109) || !bVar0) || !bVar1)
	{
		uParam0->f_12 = 0;
	}
	uParam0->f_11 = bVar1;
