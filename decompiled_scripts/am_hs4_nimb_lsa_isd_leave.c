...
void func_3(var uParam0)
{
	...
	if (MISC::IS_BIT_SET(uParam0->f_22))
	{
		VEHICLE::DELETE_VEHICLE(&(uParam0->f_22));
	}
	if (MISC::IS_BIT_SET(uParam0->f_20))
	{
...
void func_5()
{
	...
	if (MISC::SET_BIT() && func_15(&Global_2549408))
	{
...
void func_6(bool bParam0)
{
	...
	{
		if (!func_13(&(Global_2549413[bParam0 /*2*/]), 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(bParam0))
		{
			if (!func_12())
			{
				if (PED::REMOVE_SCENARIO_BLOCKING_AREA())
				{
					func_11(&(Global_2549413[bParam0 /*2*/]), 1, 0);
				}
		...
		else
		{
			...
			func_52(&(Global_2549413[bParam0 /*2*/]));
		...
		if (AUDIO::PLAY_STREAM_FROM_VEHICLE(iParam0) && (ENTITY::IS_ENTITY_AT_COORD(bParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				...
				if (!ENTITY::IS_ENTITY_ATTACHED(iVar27))
				{
					if (!bVar21)
					{
						ENTITY::SET_ENTITY_COORDS(iVar27, false);
					}
			...
			else
			{
				if (!func_20(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					...
					if (!ENTITY::IS_ENTITY_ATTACHED(iVar27))
					{
						if (!bVar21)
						{
							ENTITY::SET_ENTITY_COORDS(iVar27, bVar16);
						}
						if (!bVar16)
						{
							ENTITY::_SET_ENTITY_SOMETHING(iVar27, true);
					...
					{
						ENTITY::SET_ENTITY_COORDS(iVar27, true);
					}
				}
				if (Global_1312872)
				{
				...
				if (bVar3)
				{
					if (!PED::IS_PED_FATALLY_INJURED(iVar27) && !SYSTEM::VDIST(iVar27, 0))
					{
...
void func_36(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_28(PLAYER::PLAYER_ID())) && !func_8(PLAYER::PLAYER_ID(), 0)) && !func_37()) && !bParam4) && !bParam5)
			{
...
void func_56()
{
	...
	if (!MISC::IS_BIT_SET(iVar0) || !func_58(iVar0))
	{
		return;
	}
	if (ENTITY::GET_ENTITY_ROTATION(iVar0, 746734512))
	{
		func_57("Heist4CameraFlash");
	}
	if (ENTITY::GET_ENTITY_ROTATION(iVar0, 1102081548))
	{
		GRAPHICS::ANIMPOSTFX_STOP("Heist4CameraFlash");
		func_57("Heist4CameraFlash2");
	}
	if (ENTITY::GET_ENTITY_ROTATION(iVar0, 1401065908))
	{
...
void func_59(char* sParam0)
{
	...
	if (MISC::IS_BIT_SET(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY(sParam0, joaat("baller2"))))
	{
...
void func_62()
{
	STREAMING::SET_FOCUS_POS_AND_VEL(CAM::SET_WIDESCREEN_BORDERS(), 0f, 0f, 0f);
}
...
void func_63(var uParam0)
{
	func_62();
	func_65(uParam0);
	if (!OBJECT::ADD_DOOR_TO_SYSTEM() || CUTSCENE::GET_CUTSCENE_TIME() > (unk_0xC510274D776094AE() - 800))
	{
		func_64(uParam0, 4);
	}
}
...
void func_65(var uParam0)
{
	...
	if (!ENTITY::GET_ENTITY_COORDS(uParam0->f_22, false))
	{
		return;
	}
	func_66(uParam0);
	if (VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(uParam0->f_22, 0) < 0.0001f)
	{
		...
		if ((MISC::IS_BIT_SET(uParam0->f_20) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uParam0->f_20)) && !unk_0xE0B3BC41DDA88DF0(uParam0->f_20, uParam0->f_22, 0))
		{
			ENTITY::SET_ENTITY_COLLISION(uParam0->f_20, true, false);
			ENTITY::SET_ENTITY_COORDS(uParam0->f_20, false);
...
int func_66(var uParam0)
{
	...
	ENTITY::SET_ENTITY_COORDS(uParam0->f_20, true);
...
void func_76(var uParam0)
{
	...
	if (!uParam0->f_14)
	{
		if (CAM::IS_SCREEN_FADED_OUT(uParam0->f_1))
		{
			func_64(uParam0, 4);
			return;
		}
...
int func_82(int iParam0, char* sParam1, int iParam2, int iParam3, void fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	void fVar0;
	int iVar1;
	...
	if (fParam4 == 0)
	{
		iVar1 = func_93(fVar0, sParam1, fParam4);
		fParam4 = AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(func_92(iVar1));
	}
	...
	switch (fParam4)
	{
		...
		case joaat("STOMACH_RIGHT"):
			...
			if ((((fParam4 == joaat("CHEST_FULL") || (fParam4 == joaat("CHEST_MID") && fVar0 == joaat("mp_f_freemode_01"))) || fParam4 == joaat("CHEST_RIGHT")) || fParam4 == joaat("CHEST_STOM")) || fParam4 == joaat("CHEST_STOM_FULL"))
			{
				if (!bParam6)
				{
					if (Global_4269381 == -1)
			...
			else if (fParam4 == joaat("CHEST_LEFT"))
			{
				if (!bParam6)
				{
					if (Global_4269381 == -1)
			...
			else if ((fParam4 == joaat("STOMACH_FULL") || fParam4 == 1361645381) || fParam4 == joaat("STOMACH_LEFT"))
			{
				if (!bParam6)
				{
					if (Global_4269381 == -1)
			...
			else if (fParam4 == joaat("BACK_UPPER"))
			{
				if (!bParam6)
				{
					if (Global_4269381 == -1)
			...
			if (bParam5)
			{
				if (Global_4269381 == -1)
				{
					if (!Global_99007.f_1521)
					{
						...
						{
							if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam1, "TAT_FMM_CLB"))
							{
								return 0;
							}
						}
		...
		case -518474626:
			if (bParam5)
			{
				...
				{
					switch (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(sParam1))
					{
...
bool func_83(int iParam0, int iParam1)
{
	...
	bVar1 = func_84(iParam0);
	if (bVar1 < 0 || bVar1 >= 32)
	{
		return 0;
	}
	return unk_0xCE990E643CD9D0E5(uVar0, bVar1);
}
...
int func_93(void fParam0, char* sParam1, int iParam2)
{
	switch (iParam2)
	{
		case 1019352240:
	...
	if (iParam2 == 0 && CAM::IS_SCREEN_FADED_OUT(sParam1))
	{
		return -1;
	}
	switch (iParam2)
...
void func_101(char* sParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9)
{
	...
	sParam0->f_8 = AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(sParam6);
	sParam0->f_6 = iParam7;
	sParam0->f_7 = iParam8;
	...
	if (MISC::IS_BIT_SET(iParam2) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam2))
	{
		...
		else if (sParam0->f_6 == 3 || sParam0->f_6 == 4)
		{
			...
			else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam6, "torsoDecal") || NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam6, "hairOverlay"))
			{
...
int func_102(int iParam0, int iParam1)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		if (MISC::GET_MODEL_DIMENSIONS(iParam0) == joaat("mp_m_freemode_01"))
		{
		...
		else if (MISC::GET_MODEL_DIMENSIONS(iParam0) == joaat("mp_f_freemode_01"))
		{
			iVar0 = PED::GET_PED_DRAWABLE_VARIATION(iParam0, 11);
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_105(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		if (fVar0 == joaat("mp_m_freemode_01"))
		{
			return func_113(MISC::GET_MODEL_DIMENSIONS(iParam0), iVar1, 14, 3);
		}
		else if (fVar0 == joaat("mp_f_freemode_01"))
		{
			return func_113(MISC::GET_MODEL_DIMENSIONS(iParam0), iVar1, 14, 4);
		}
	}
...
int func_113(void fParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar1 != -1)
		{
			return (func_104(fParam0, func_105(iParam2)) + iVar1);
		}
	}
	return -99;
}
...
int func_115(int iParam0, int iParam1, int iParam2)
{
	...
	fVar0 = MISC::GET_MODEL_DIMENSIONS(iParam0);
	Global_76647[1 /*14*/] = { func_131(fVar0, iParam1, iParam2, -1) };
		...
		while (iVar7 < 7)
		{
			...
			if (uVar8[iVar4] != -99)
			{
				if (!func_115(iParam0, iVar4, uVar8[iVar4]))
				{
					...
					if (iVar4 == 13)
					{
						uVar9 = { func_124(fVar0, uVar8[iVar4]) };
						iVar5 = 0;
						while (iVar5 <= 8)
						{
							if (!func_115(iParam0, 14, uVar9[iVar5]))
							{
								...
								while (iVar6 <= 19)
								{
									Global_76647[2 /*14*/] = { func_131(fVar0, 14, iVar6, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar5)
									{
										if (func_115(iParam0, 14, iVar6))
										{
											if (!func_119(fVar0, iParam2, 14, iVar6, &uVar8, &(Global_76647[2 /*14*/])))
											{
												Global_2621444 = uVar2;
												Global_2621445 = uVar3;
												return 0;
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_131(fVar0, iVar4, iVar1, -1) };
						if (!func_119(fVar0, iParam2, iVar4, iVar1, &uVar8, &(Global_76647[2 /*14*/])))
						{
							Global_2621444 = uVar2;
							Global_2621445 = uVar3;
							return 0;
		...
		if (((Global_76647[1 /*14*/].f_12 == 0 && unk_0xCE990E643CD9D0E5(Global_76647[1 /*14*/].f_6, 6)) && unk_0x4D0432E34C5996D9(Global_2621444, joaat("HELMET"), 1)) && unk_0xA45BF7AC8135700A(Global_2621444) > 0)
		{
			...
			while (iVar12 < iVar16)
			{
				...
				if (iVar13 != 0 && iVar13 != joaat("0"))
				{
					...
					if (Var17.f_3 == PED::GET_PED_PROP_INDEX(iParam0, Global_76647[1 /*14*/].f_12) && Var17.f_4 == PED::GET_PED_PROP_TEXTURE_INDEX(iParam0, Global_76647[1 /*14*/].f_12))
					{
						return 1;
					}
				}
	...
	else
	{
		...
		if (iParam1 == 4)
		{
			...
			if (Global_76646 == 1)
			{
				if (func_118(fVar0, 11, func_108(iParam0, 11), -1))
				{
					if (func_117(fVar0, 4, iParam2, &uVar18))
					{
						return func_115(iParam0, 4, uVar18);
					}
				}
				else if (func_116(fVar0, 4, iParam2, &uVar18))
				{
					return func_115(iParam0, 4, uVar18);
				}
			}
...
int func_116(void fParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (iParam2 >= 256)
					{
						iVar0 = func_103(fParam0, iParam2, iParam1, 4);
						if (iVar0 != -1)
						{
							...
							while (iVar2 < iVar1)
							{
								...
								if (iVar5 == 4)
								{
									if (iVar3 != 0 && iVar3 != joaat("0"))
									{
										...
										{
											*uParam3 = func_113(fParam0, iVar3, iParam1, 4);
											return 1;
										}
									}
								}
...
int func_117(void fParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			switch (iParam1)
			{
				case 11:
					if (iParam2 >= 256)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_103(fParam0, iParam2, 11, 4);
						}
...
int func_119(void fParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar1;
	...
	if (iParam2 == 14)
	{
		uVar0 = { func_124(fParam0, (*uParam4)[13]) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
	...
	if (func_123(fParam0, iParam2, iParam3))
	{
		return 1;
	}
	if (fParam0 == joaat("player_zero"))
	{
		if (func_122(fParam0, iParam2, iParam3, -1))
		{
		...
		else if (func_121(fParam0, iParam2, iParam3, -1))
		{
		...
		else if (func_120(fParam0, iParam2, iParam3, -1))
		{
			if (((((((((iParam1 == 1 || iParam1 == 2) || iParam1 == 4) || iParam1 == 5) || iParam1 == 10) || iParam1 == 11) || iParam1 == 12) || iParam1 == 14) || iParam1 == 18) || iParam1 == 50)
			{
				return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_103(fParam0, iParam2, 14, 3);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 1) || unk_0x4D0432E34C5996D9(func_103(fParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_103(fParam0, iParam2, 1, 3);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 0) || unk_0x4D0432E34C5996D9(func_103(fParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_103(fParam0, iParam2, 14, 4);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 1) || unk_0x4D0432E34C5996D9(func_103(fParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_103(fParam0, iParam2, 1, 4);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 0) || unk_0x4D0432E34C5996D9(func_103(fParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_121(void fParam0, int iParam1, int iParam2, int iParam3)
{
	if (fParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_123(void fParam0, int iParam1, int iParam2)
{
	switch (fParam0)
	{
		case joaat("player_zero"):
...
struct<10> func_124(void fParam0, int iParam1)
{
	int iVar0;
	struct<10> Var1;
	...
	switch (fParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				default:
					func_125(&Var1, fParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				default:
					func_125(&Var1, fParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_125(&Var1, fParam0, iParam1, 25);
					break;
			}
			break;
...
struct<17> func_127(void fParam0, int iParam1)
{
	int iVar0;
	struct<17> Var1;
	...
	switch (fParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				default:
					func_128(&Var1, fParam0, iParam1, 53);
					break;
			}
			break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				default:
					func_128(&Var1, fParam0, iParam1, 47);
					break;
			}
			break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				default:
					func_128(&Var1, fParam0, iParam1, 48);
					break;
			}
			break;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_128(&Var1, fParam0, iParam1, 26);
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_128(&Var1, fParam0, iParam1, 28);
					break;
			}
			break;
	}
...
struct<14> func_131(void fParam0, int iParam1, int iParam2, int iParam3)
{
	func_177();
	if (fParam0 == joaat("mp_m_freemode_01"))
	{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			bVar0 = func_86(func_136(iParam1, uParam0->f_2), Global_76644, 0);
			...
			{
				bVar0 = func_86(iVar1, Global_76644, 0);
				if (!unk_0xCE990E643CD9D0E5(bVar0, uParam0->f_1))
				{
					unk_0xBE20AB8238688965(&(uParam0->f_6), 4);
				}
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_105(iParam0));
			if (iVar11 > iVar10)
			{
...
{
	if (VEHICLE::GET_VEHICLE_MOD(iParam0, 1))
	{
		return 0;
	}
...
int func_204()
{
	...
	if (func_205() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_205()) == 0)
		{
			return 1;
		}
	}
...
void func_215()
{
	...
	{
		func_216();
		if (PED::GET_PED_PROP_INDEX(unk_0x9B0761B4C3EB8BC7(), 0) == 19)
		{
...
var func_220(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
