...
void __EntryFunction__()
{
	...
	if (MISC::SET_BIT())
	{
		...
		{
			if (func_227(PLAYER::PLAYER_ID()) != 1 && !unk_0xCE990E643CD9D0E5(Global_2540384.f_897.f_7, 0))
			{
				func_228();
			}
		}
	...
	while (true)
	{
		...
		if (STATS::STAT_SET_INT() != bLocal_68)
		{
			func_228();
		}
		...
		switch (func_215(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			...
			case 1:
				...
				{
					if ((!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_60.f_3, 500f, 500f, 500f, 0, 1, 0) && func_227(PLAYER::PLAYER_ID()) != 1) && !unk_0xCE990E643CD9D0E5(Global_2540384.f_897.f_7, 0))
					{
...
void func_5()
{
	...
	{
		case 0:
			if (!HUD::DOES_BLIP_EXIST(Local_60.f_2) || Local_60.f_6 != -1)
			{
				Local_60.f_8 = 1;
			}
			break;
	...
	if (!HUD::DOES_BLIP_EXIST(Local_60.f_2))
	{
		if (func_214())
		{
			if (NETWORK::CAN_REGISTER_MISSION_OBJECTS(1))
			{
				...
				{
					iVar6 = unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID());
				...
				if (iVar2 == 0)
				{
					if (unk_0xCE990E643CD9D0E5(Local_60.f_1, 8) || func_183(Var4, fVar3, &Var0, &fVar1, &Var7))
					{
						...
						{
							Local_60.f_2 = NETWORK::OBJ_TO_NET(unk_0x7CCB49ADC5A1DAB4(joaat("pickup_portable_package"), Var0, 1, joaat("prop_drug_package_02")));
						}
		...
		if (uParam5->f_5)
		{
			...
			else
			{
				switch (uParam5->f_7)
				{
					case 0:
						Var7 = { *uParam5 };
						if (func_63(uParam5->f_4) || !unk_0x0B1B45E748AD48BA(CUTSCENE::IS_CUTSCENE_PLAYING(Var7)))
						{
							iVar6 += 4;
						}
						break;
					...
					case 1:
						...
						if (func_62(uParam5->f_8, uParam5->f_11, 0f) || !unk_0x0B1B45E748AD48BA(CUTSCENE::IS_CUTSCENE_PLAYING(Var7)))
						{
							iVar6 += 4;
						}
						break;
					...
					case 2:
						Var7 = { uParam5->f_8 + uParam5->f_11 * Vector(0.5f, 0.5f, 0.5f) };
						if (func_62(uParam5->f_8, uParam5->f_11, uParam5->f_14) || !unk_0x0B1B45E748AD48BA(CUTSCENE::IS_CUTSCENE_PLAYING(Var7)))
						{
							iVar6 += 4;
						}
						break;
	...
	if (func_42(PLAYER::PLAYER_ID(), 1, 0))
	{
		...
		if (Global_969055.f_268 > 0)
		{
			...
			while (iVar0 < Global_969055.f_268)
			{
				...
				{
					if (func_34(Param0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Global_969055.f_233[iVar0], 1), ENTITY::IS_ENTITY_IN_WATER(Global_969055.f_233[iVar0]), MISC::GET_MODEL_DIMENSIONS(Global_969055.f_233[iVar0]), 0.5f))
					{
						return 1;
					}
				}
		...
		if (Global_969055.f_266 > 0)
		{
			...
			while (iVar0 < Global_969055.f_266)
			{
				...
				{
					if (func_34(Param0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Global_969055.f_119[iVar0], 1), ENTITY::IS_ENTITY_IN_WATER(Global_969055.f_119[iVar0]), MISC::GET_MODEL_DIMENSIONS(Global_969055.f_119[iVar0]), 0.5f))
					{
						return 1;
					}
				}
...
int func_34(struct<3> Param0, struct<3> Param1, bool bParam2, void fParam3, float fParam4)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	if (SYSTEM::VDIST(Param0, Param1) < func_41(fParam3, 1008981770))
	{
		func_35(Param1, bParam2, fParam3, &Var0, &Var1, &fVar2, fParam4);
...
void func_36(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)
{
	int iVar0;
	...
	else
	{
		...
		if (iVar0 != 0)
		{
			func_37(iVar0, fParam1, fParam2, 1086324736, 1080033280, 1077936128);
			return;
		}
	}
			...
			if (iVar8 >= Global_2405074.f_2485.f_6[iVar18 /*10*/])
			{
				...
				else
				{
					if (!bVar20)
					{
						...
						bVar5 = func_74(Param0, fVar1, 1, 1, 0, -1, 1);
						bVar6 = func_78(Param0, 1, 1, 1, 1, 0);
						if (bVar5 > 15f && bVar6 > 5f)
						{
							fVar3 = func_73(bVar5, 0f, 80f, 160f, 1f, 1.2f);
						}
						else
						{
							fVar3 = func_73(bVar6, 0f, 80f, 160f, 0f, 0.2f);
						}
						bVar20 = true;
					}
...
float func_73(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)
{
	float fVar0;
					...
					if (func_75(iVar1) || !bParam6)
					{
						if (!bParam4)
						{
							if ((iParam3 || (iParam3 == 0 && unk_0x6CC163E30ECE0790(iVar1) != unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()))) || unk_0x6CC163E30ECE0790(iVar1) == -1)
							{
								...
								{
									fVar4 = SYSTEM::VDIST2(Param0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(PLAYER::GET_PLAYER_PED(iVar1), 0));
									if (fVar4 < fVar3)
									{
										fVar3 = fVar4;
										bVar2 = true;
...
var func_78(struct<3> Param0, bool bParam1, bool bParam2, int iParam3, bool bParam4, int iParam5)
{
	int iVar0;
	void fVar1;
	void fVar2;
	...
	while (iVar0 < 32)
	{
		...
		if (func_26(iVar7, 1, 1) || (iParam5 == 1 && func_26(iVar7, 0, 0)))
		{
			if (!iVar7 == PLAYER::PLAYER_ID() || iParam3 == 1)
			{
				...
				if (bParam2)
				{
					if (unk_0x6CC163E30ECE0790(iVar7) == unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()))
					{
						if (!unk_0x6CC163E30ECE0790(iVar7) == -1 || !func_56(PLAYER::PLAYER_ID(), 1))
						{
							bVar4 = true;
						}
					}
				...
				if (bVar4)
				{
					if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar7) || !bParam4)
					{
						if (func_75(iVar7))
						{
							...
							{
								Var6 = { unk_0x20B541C8E40D2E74(PLAYER::GET_PLAYER_PED(iVar7)) };
							}
							else
							{
								Var6 = { Var5 };
		...
		if (!func_87(iParam0))
		{
			if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam0))
			{
				if (!unk_0x6CC163E30ECE0790(iParam0) == unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()))
				{
					if (func_42(PLAYER::PLAYER_ID(), 1, 0))
					{
						if (!func_86(unk_0x6CC163E30ECE0790(iParam0), unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()), 0))
						{
							return 1;
						}
					}
				...
				else if (unk_0x6CC163E30ECE0790(iParam0) == -1 && unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1)
				{
					if (!func_42(PLAYER::PLAYER_ID(), 1, 0))
					{
						if (!func_81(iParam0))
...
bool func_90(struct<3> Param0, var uParam1, var uParam2)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
float func_91(struct<3> Param0, struct<3> Param1, bool bParam2, bool bParam3, bool bParam4, int iParam5, var uParam6)
{
	...
	*uParam6 = 1E+07f;
	bVar4 = func_78(Param0, 1, 0, 0, 1, 0);
	fVar0 = func_73(bVar4, 0f, func_98(), func_96(), 0f, 0.3f);
	fVar1 = (fVar1 * (fVar0 * 0.95f));
	if (bVar4 < *uParam6)
	{
		bVar4 = bVar4;
	}
	bVar4 = func_94(Param0);
	fVar0 = func_73(bVar4, 0f, 0f, 60f, 0.5f, 1f);
	fVar1 = (fVar1 * (fVar0 * 0.95f));
	if (bVar4 < *uParam6)
	{
		bVar4 = bVar4;
	...
	fVar5 = 100f;
	if (unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1 && !func_56(PLAYER::PLAYER_ID(), 1))
	{
		fVar5 = 1f;
	}
	bVar4 = func_93(Param0, PLAYER::PLAYER_ID(), 0);
	fVar0 = func_73(bVar4, 0f, 0f, fVar5, 0f, 1f);
	fVar1 = (fVar1 * (fVar0 * 0.95f));
	if (bVar4 < *uParam6)
	{
		bVar4 = bVar4;
	...
	if (bParam3)
	{
		if (func_92(Param0, &bVar2, &bVar3))
		{
			...
			fVar0 = func_73(bVar2, 0f, 0f, 200f, 1f, 0.1f);
			fVar0 = (fVar0 + func_73(bVar3, 0f, 0f, 6f, 1f, 0.5f));
			fVar0 = (fVar0 * 0.5f);
...
bool func_93(struct<3> Param0, int iParam1, int iParam2)
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (iParam2 && !bParam5)
	{
		if (func_26(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!PED::REMOVE_SCENARIO_BLOCKING_AREA())
			{
				...
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_116(PLAYER::PLAYER_ID()), Param0, 1) <= (fVar2 + fParam1))
				{
					if (CAM::IS_SPHERE_VISIBLE(Param0, fParam1))
					{
						return 1;
				...
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_75(iVar1) || !bParam8) && !Global_2425869[iVar1 /*443*/].f_263)
					{
						...
						if (!bParam5)
						{
							if ((iParam3 || (iParam3 == 0 && unk_0x6CC163E30ECE0790(iVar1) != unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()))) || unk_0x6CC163E30ECE0790(iVar1) == -1)
							{
								if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_116(iVar1), Param0, 1) <= (fVar2 + fParam1))
								{
									if (NETWORK::IS_SPHERE_VISIBLE_TO_PLAYER(iVar1, Param0, fParam1))
									{
										return 1;
...
int func_125(struct<3> Param0, float fParam1)
{
	...
	while (iVar0 < 32)
	{
		...
		if ((func_26(iVar1, 1, 1) && func_75(iVar1)) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
		{
			if ((unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1 && unk_0x6CC163E30ECE0790(iVar1) == -1) && !func_56(PLAYER::PLAYER_ID(), 1))
			{
				return 0;
			}
			else if ((unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1 && !PLAYER::PLAYER_ID() == iVar1) || !func_124(PLAYER::PLAYER_ID(), iVar1, -2, 0))
			{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && PLAYER::PLAYER_ID() != iVar1) || iParam6 == 0)
		{
			if (func_26(iVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(PLAYER::GET_PLAYER_PED(iVar1)) && func_75(iVar1)))
					{
						...
						{
							if (((unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1 && iParam7) && bParam4) && func_81(iVar1))
							{
							}
							else if (MISC::IS_BIT_SET(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_79(iVar1), Param0, 1) < fParam1)
								{
									return 1;
								}
							}
		...
		while (iVar0 < 32)
		{
			...
			if (func_26(iVar1, 1, 1))
			{
				if ((!func_141(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1)) && iVar1 != PLAYER::PLAYER_ID())
				{
					...
					{
						if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_79(iVar1), Param0, 1) <= (fVar2 + fParam1))
						{
							if (NETWORK::IS_SPHERE_VISIBLE_TO_PLAYER(iVar1, Param0, fParam1))
							{
								return 1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam7 == 1 && PLAYER::PLAYER_ID() != iVar1) || iParam7 == 0)
		{
			if (func_26(iVar1, bParam3, bParam4))
			{
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam6 || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(PLAYER::GET_PLAYER_PED(iVar1)) && func_75(iVar1)))
					{
						if ((!bParam5 || (bParam5 == 1 && unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) != unk_0x6CC163E30ECE0790(iVar1))) || unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1)
						{
							if (((unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1 && iParam8) && bParam5) && func_81(iVar1))
							{
							}
							else if (MISC::IS_BIT_SET(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								fVar2 = 0.1f;
								if (SYSTEM::VDIST(PLAYER::GET_PLAYER_PED(iVar1), 0))
								{
									iVar3 = ENTITY::GET_ENTITY_MODEL(PLAYER::GET_PLAYER_PED(iVar1), 0);
									if (MISC::IS_BIT_SET(iVar3) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iVar3, 0))
									{
										...
										if (func_154(Param0, fParam1, iParam2, Var5, bVar6, fVar4, 0))
										{
											return 1;
										}
									}
...
int func_154(struct<3> Param0, float fParam1, int iParam2, struct<3> Param3, bool bParam4, void fParam5, bool bParam6)
{
	int iVar0;
	struct<3> Var1[4];
	struct<3> Var2;
	...
	if (func_34(Param0, Param3, bParam4, fParam5, 1036831949))
	{
		return 1;
	}
	if (Global_1312332 && (iParam2 == joaat("kosatka") || fParam5 == joaat("kosatka")))
	{
		...
		func_35(Param3, bParam4, fParam5, &(Global_1707737.f_7), &(Global_1707737.f_10), &(Global_1707737.f_13), 1036831949);
	...
	else
	{
		...
		while (iVar0 < 4)
		{
			if (func_34(Var1[iVar0 /*3*/], Param3, bParam4, fParam5, 1036831949))
			{
				return 1;
			}
			iVar0++;
		...
		if (!bParam6)
		{
			if (func_154(Param3, bParam4, fParam5, Param0, fParam1, iParam2, 1))
			{
				return 1;
			}
		}
...
int func_155(struct<3> Param0, float fParam1, int iParam2)
{
	...
	if (MISC::IS_BIT_SET(iVar1) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iVar1, 0))
	{
		...
		if (func_154(Param0, fParam1, iParam2, Var3, bVar4, fVar2, 0))
		{
			return 1;
		}
	}
			...
			if (iVar2 > -1 && iVar2 < 101)
			{
				...
				if (SYSTEM::VMAG(Var3) > 0f)
				{
					if ((uParam2->f_57 && SYSTEM::VDIST(Var3, uParam2->f_35) > uParam2->f_4) || uParam2->f_57 == 0)
					{
						...
						{
							if ((uParam2->f_12 && !func_156(Var3, fVar4, uParam2->f_34, PLAYER::PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
							{
...
int func_174(struct<3> Param0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, bool bParam6, int iParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, float fParam12, bool bParam13, float fParam14, bool bParam15, bool bParam16)
{
...
int func_199()
{
	...
	if (HUD::DOES_BLIP_EXIST(Local_60.f_2))
	{
		if (NETWORK::NETWORK_IS_HANDLE_VALID(Local_60.f_2))
		{
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(NETWORK::NET_TO_OBJ(Local_60.f_2), unk_0x9B0761B4C3EB8BC7()) && func_209(Local_60.f_2))
			{
				...
				unk_0xBE20AB8238688965(&(Local_62[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1), 0);
				return 1;
			}
		}
	}
...
void func_203(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_206() || !STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED()) || !func_141(PLAYER::PLAYER_ID(), 0))
	{
		return;
	}
...
void func_210()
{
	if (!SYSTEM::VMAG(bLocal_65))
	{
		if (HUD::DOES_BLIP_EXIST(Local_60.f_2))
		{
			bLocal_65 = TASK::IS_PED_SPRINTING(NETWORK::NET_TO_OBJ(Local_60.f_2));
			if (func_211())
			{
				HUD::SET_BLIP_SCALE(bLocal_65, 0.85f);
			}
			else
			{
				HUD::SET_BLIP_SCALE(bLocal_65, 1.2f);
			}
			HUD::SET_BLIP_SPRITE(bLocal_65, 403);
			HUD::SET_BLIP_COLOUR(bLocal_65, 2);
			PED::IS_PED_IN_PARACHUTE_FREE_FALL(bLocal_65, "ABB_BLIPN");
		}
	}
}
...
int func_214()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(joaat("prop_drug_package_02")))
	{
		return 1;
	}
	return 0;
...
int func_216()
{
	...
	if (func_217() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_217()) == 0)
		{
			return 1;
		}
	}
...
void func_228()
{
	...
	if (MISC::SET_BIT())
	{
		if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			if (HUD::DOES_BLIP_EXIST(Local_60.f_2) && NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_60.f_2))
			{
				func_208(&(Local_60.f_2));
			}
			Local_60 = 4;
...
void func_230()
{
	...
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2540384.f_897.f_7), false);
}

void func_231()
{
	if (unk_0xCE990E643CD9D0E5(uLocal_63, 4))
	{
		unk_0x39B3FA55B5C6CFFE(PLAYER::PLAYER_ID(), 0.72f);
		...
		func_232(1);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_63, 5);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_63, 7);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_63, 4);
	}
}
...
int func_234(struct<21> Param0)
{
	...
	func_236(0, -1, 0);
	MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(&Local_60, 11);
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		Local_60.f_3 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0) };
		if (!func_4(Global_2540384.f_897.f_1))
		{
			unk_0xBE20AB8238688965(&(Local_60.f_1), 8);
		}
	}
	bLocal_68 = STATS::STAT_SET_INT();
