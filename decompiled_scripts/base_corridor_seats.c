	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				...
				Var4 = { unk_0xD78F5800B90C4843(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0, 2) };
				uVar5 = Var4.f_2;
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			uVar7 = unk_0xAB6BAF5BFCAFB141(uParam0->f_57.f_1);
		...
		case 8:
			uVar8 = unk_0xAB6BAF5BFCAFB141(uParam0->f_57.f_1);
