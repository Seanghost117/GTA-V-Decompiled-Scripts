...
void __EntryFunction__()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_84(uLocal_66, 4194304))
	{
		if (iLocal_77 != 263)
		{
	...
	while (true)
	{
		...
		if (MISC::IS_BIT_SET(iLocal_61) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61, 0))
		{
			Local_63 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_61, 1) };
			...
			switch (iLocal_67)
			{
				...
				case 3:
					...
					if (!func_82(iLocal_72))
					{
						...
						{
							bVar2 = true;
							if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&(Global_98955.f_3), &cLocal_52))
							{
								cLocal_52 = { Local_51 };
								bVar2 = false;
							}
					...
					else
					{
						...
						if (!func_70(3) && !Global_98989)
						{
							...
							{
								if ((!func_84(uLocal_66, 1) || !MISC::IS_BIT_SET(func_69())) && !Global_98989)
								{
									func_77(10);
									break;
								}
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_71 != -1)
						{
							if (func_84(Global_110509, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_17(iLocal_71), 0, Global_98992, 0);
				...
				case 7:
					...
					if (!CAM::IS_SCREEN_FADED_OUT(sLocal_73))
					{
						if (func_1(sLocal_73))
						{
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_66()) || Global_110905) || Global_30970) || func_65()) || func_51(8, -1)) || func_62()) || func_64()) || func_63()) || func_53()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_66() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_51(8, -1)) || func_53()) || func_61()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_73()
{
	if (!MISC::IS_BIT_SET(Local_88))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(Local_88, Local_88.f_2, false, false, true);
		ENTITY::DETACH_ENTITY(Local_88, Local_88.f_5, 2, 1);
		ENTITY::SET_ENTITY_COORDS(Local_88, 1);
	}
}
...
bool func_74()
{
	...
	return ENTITY::DOES_ENTITY_EXIST(Local_88.f_1);
}
...
int func_86()
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		Var0 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 1) };
...
void func_90()
{
	...
	if (!AUDIO::PRELOAD_SCRIPT_CONVERSATION(&cLocal_52))
	{
