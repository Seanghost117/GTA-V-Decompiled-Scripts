...
void __EntryFunction__()
{
	...
	Var0.f_1 = 5;
	Var0.f_17 = 5;
	if (MISC::IS_BIT_SET(iScriptParam_104))
	{
		Local_56 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iScriptParam_104, 1) };
		iLocal_94 = iScriptParam_104;
		Var0.f_1[0 /*3*/] = { Local_56 };
		fLocal_78 = MISC::GET_MODEL_DIMENSIONS(iLocal_94);
	}
	else
	{
		iLocal_94 = iScriptParam_104;
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_115(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
				...
				case 3:
					...
					else
					{
						...
						if (!func_99(3) && !Global_98989)
						{
							...
							{
								if ((!func_115(uLocal_58, 1) || !MISC::IS_BIT_SET(func_98())) && !Global_98989)
								{
									func_108(10);
									break;
								}
						...
						if (bVar4)
						{
							if (!unk_0xC2169C00B643278B(iLocal_53, Var0.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, 0, 1, iLocal_67))
							{
								bVar4 = false;
							}
							if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_94, 0))
							{
								iLocal_94 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_56, 2f, fLocal_78, true, false, true);
								func_85(&uLocal_58, 128);
								bVar4 = false;
							}
							else
							...
							if (MONEY::NETWORK_SPENT_REQUEST_HEIST(unk_0x9B0761B4C3EB8BC7()) != bLocal_84)
							{
								bVar4 = false;
							}
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != -1)
						{
							if (func_115(Global_110509, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_17(iLocal_63), 0, Global_98992, 0);
...
int func_23()
{
	...
	Var0 = { NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(iLocal_94, 2) };
	Local_93 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_94, 1) };
...
void func_37()
{
	...
	if (bLocal_90)
	{
		...
		if (iLocal_91 == 0)
		{
			if (fVar5 < (10f * 10f))
			{
				...
				if (!func_101(6) && !func_101(7))
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_87, 0))
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_87, 0);
					...
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_88, 0);
			...
			if (fVar5 >= (10f * 10f))
			{
				...
				if (!func_101(6) && !func_101(7))
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_87, 0))
					{
						...
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_87, 1);
						}
					}
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_88, 0))
					{
						...
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_88, 1);
						}
					}
				}
				else
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_87, 0))
					{
						unk_0x03D382CB0B44E2FC(iLocal_87, 1991.677f, 3044.957f, 46.21505f, 1, 0, 0, 1);
						TASK::TASK_STAND_STILL(iLocal_87, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_87))
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_87, 1);
					...
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_88, 0))
					{
						unk_0x03D382CB0B44E2FC(iLocal_88, 1990.37f, 3045.121f, 46.21502f, 1, 0, 0, 1);
						TASK::TASK_STAND_STILL(iLocal_88, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_88))
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_88, 1);
	...
	if (!iLocal_97)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			if (((PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::GET_PLAYER_INDEX(), 0)) || PED::IS_ANY_PED_SHOOTING_IN_AREA(937.0616f, -117.8927f, 72.9163f, 1021.849f, -120.5357f, 72.9163f, true, true)) || MISC::IS_PROJECTILE_IN_AREA(1991.473f, 3045.98f, 49.532f, 1996.906f, 3052.17f, 46.3392f, false))
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_87, 0))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_87, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
				}
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_88, 0))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_88, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
				}
				bVar3 = true;
			}
			else
			{
				...
				while (iVar2 < iVar1)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uVar0[iVar2]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(uVar0[iVar2]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uVar0[iVar2]))
						{
							if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_87, 0))
							{
								TASK::TASK_SMART_FLEE_PED(iLocal_87, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
		...
		if (!func_101(6) && !func_101(7))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_87) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_88))
			{
	...
	if (iLocal_92 == 1)
	{
		if (!unk_0x0B1B45E748AD48BA(bLocal_95))
		{
			bLocal_95 = CUTSCENE::IS_CUTSCENE_PLAYING(-573.3155f, 291.2963f, 79.5509f);
		}
		else if (bLocal_95 == MONEY::NETWORK_SPENT_REQUEST_HEIST(unk_0x9B0761B4C3EB8BC7()))
		{
			func_38(140, 3);
			func_38(139, 3);
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_87) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_88))
			{
				if (iLocal_98)
				{
					PED::_0x2208438012482A1A(iLocal_87, 0);
					PED::_0x2208438012482A1A(iLocal_88, 0);
					iLocal_98 = 0;
				}
			}
		}
		else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_87) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_88))
		{
			if (!iLocal_98)
			{
				PED::_0x2208438012482A1A(iLocal_87, 1);
				PED::_0x2208438012482A1A(iLocal_88, 1);
				iLocal_98 = 1;
			}
		}
	}
	...
	{
		if (!unk_0x0B1B45E748AD48BA(bLocal_96))
		{
			bLocal_96 = CUTSCENE::IS_CUTSCENE_PLAYING(1995.614f, 3049.877f, 46.2153f);
		}
		else if (bLocal_96 == MONEY::NETWORK_SPENT_REQUEST_HEIST(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_87) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_88))
			{
				if (iLocal_98)
...
int func_49(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				fVar0 = MISC::GET_MODEL_DIMENSIONS(func_50(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 1)));
				switch (fVar0)
				{
...
void func_51(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_52(iParam0) && INTERIOR::GET_INTERIOR_AT_COORDS(Global_89743[26 /*34*/].f_6) == 0)
			{
				Global_111858.f_7257[iParam0] = 1;
				unk_0xDC5C33A98881772F(uParam1->f_5, Global_111858.f_7257[iParam0], 1, 1);
			}
...
var func_54()
{
	...
	func_64(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_63(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_62(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_57(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_56(&uVar0, CLOCK::GET_CLOCK_YEAR());
	func_55(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
int func_70()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		while (iVar3 < func_72() + 1)
		{
			if (iVar3 > 0)
			{
				fVar2 = SYSTEM::VDIST2(Var0, func_71(iVar3));
				if (fVar1 > fVar2)
				{
					fVar1 = fVar2;
				}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_96()) || Global_110905) || Global_30970) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_96() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_81(8, -1)) || func_83()) || func_91()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_96()) || func_93()) || Global_110905) || Global_30970) || func_95()) || Global_42801) || func_81(8, -1)) || func_92()) || func_91()) || func_83()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_102()
{
	...
	if (bLocal_90)
	{
		...
		if ((fVar2 > 45f || Global_111820) && !MISC::IS_BIT_SET(iLocal_87))
		{
			if (Global_111820)
			{
				Global_111820 = 0;
			...
			fVar9 = 142.6717f;
			fVar10 = 44.8785f;
			bVar11 = CUTSCENE::IS_CUTSCENE_PLAYING(func_71(iLocal_92));
			if (unk_0x0B1B45E748AD48BA(bVar11))
			{
				INTERIOR::PIN_INTERIOR_IN_MEMORY(bVar11);
				while (!INTERIOR::IS_INTERIOR_READY(bVar11))
				{
					SYSTEM::WAIT(0);
				}
				INTERIOR::UNPIN_INTERIOR(bVar11);
			}
			iLocal_87 = PED::CREATE_PED(26, iLocal_85, func_104(iLocal_92 == 1, Var3, Var5), func_103(iLocal_92 == 1, fVar7, fVar9), true, true);
			iLocal_88 = PED::CREATE_PED(26, iLocal_86, func_104(iLocal_92 == 1, Var4, Var6), func_103(iLocal_92 == 1, fVar8, fVar10), true, true);
		...
		else
		{
			...
			else if (MISC::IS_BIT_SET(iLocal_87))
			{
			}
			iLocal_89 = 0;
		}
...
int func_105()
{
	if (bLocal_90)
	{
		return ((ENTITY::DOES_ENTITY_EXIST(iLocal_85) && ENTITY::DOES_ENTITY_EXIST(iLocal_86)) && ENTITY::DOES_ENTITY_EXIST(joaat("prop_dart_1")));
	}
	return 1;
}
...
void func_106()
{
	...
	if (bLocal_90)
	{
		...
		if (MISC::IS_BIT_SET(iLocal_87))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_87, true, false);
		}
		if (MISC::IS_BIT_SET(iLocal_88))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_88, true, false);
		}
	}
...
void func_116()
{
	...
	bLocal_84 = CUTSCENE::IS_CUTSCENE_PLAYING(Local_56);
