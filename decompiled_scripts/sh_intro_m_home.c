...
void __EntryFunction__()
{
	...
	while (true)
	{
		switch (iLocal_37)
		{
			...
			case 1:
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !LOCALIZATION::GET_CURRENT_LANGUAGE())
				{
			...
			case 3:
				if ((((unk_0x0B1B45E748AD48BA(iLocal_51) && INTERIOR::IS_INTERIOR_READY(iLocal_51)) && unk_0x0B1B45E748AD48BA(iLocal_52)) && INTERIOR::IS_INTERIOR_READY(iLocal_52)) || (MISC::GET_GAME_TIMER() - iLocal_50) > 500)
				{
					STREAMING::NEW_LOAD_SCENE_STOP();
					iLocal_50 = MISC::GET_GAME_TIMER();
					iLocal_38 = 0;
			...
			case 5:
				func_1(25);
				unk_0xBE20AB8238688965(&(Global_2621447[17]), true);
				unk_0xBE20AB8238688965(&(Global_2621447[18]), true);
				unk_0xBE20AB8238688965(&(Global_2621447[19]), true);
				func_224();
				break;
		}
		SYSTEM::WAIT(0);
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		switch (iLocal_38)
		{
			...
			case 1:
				...
				Var3 = { func_61(Var1[0 /*3*/]) };
				fVar4 = 12f;
				if (((((((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && unk_0x0B1B45E748AD48BA(iLocal_51)) && unk_0x0B1B45E748AD48BA(iLocal_52)) && INTERIOR::IS_INTERIOR_READY(iLocal_51)) && INTERIOR::IS_INTERIOR_READY(iLocal_52)) && (MISC::GET_GAME_TIMER() - iLocal_48) > iVar5) || (MISC::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, Var0[0 /*3*/], Var1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
			...
			case 5:
				if (iLocal_44 == 0)
				{
					if (CAM::_0xEE778F8C7E1142E2(NETWORK::_GET_ONLINE_VERSION()) == 4 && (MISC::GET_GAME_TIMER() - iLocal_48) >= (iVar5 - 300))
					{
...
void func_9(char* sParam0, var uParam1)
{
	...
	FILES::GET_DLC_VEHICLE_FLAGS(0, 0, 1, uParam1);
}
...
void func_10()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 305.1602f);
	}
	...
	if (MISC::IS_BIT_SET(iVar0))
	{
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			...
			if (ENTITY::GET_ENTITY_HEALTH(bVar0) < 1)
			{
				CAM::IS_AIM_CAM_ACTIVE(bVar0, 10, 0);
			}
			if (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(bVar0) < 1f)
			{
				VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bVar0, 10f);
			}
			if (VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(bVar0) < 1f)
			{
				VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(bVar0, 10f);
			}
			MISC::CLEAR_AREA(-857.1225f, 157.4701f, 63.7638f, 5f, true, false, false, false);
			unk_0x03D382CB0B44E2FC(bVar0, -857.1225f, 157.4701f, 63.7638f, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(bVar0, 352.5659f);
...
void func_11(bool bParam0, struct<3> Param1, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (MISC::IS_BIT_SET(iParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		func_47(iParam3, &Var0, Param1, bParam2, func_53(bParam0));
...
void func_13(bool bParam0, int iParam1)
{
	...
	func_55(bParam0, &(Global_111858.f_32745.f_5510));
}

int func_14(bool bParam0)
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_29(bParam0, 0, 0)) || func_29(bParam0, 1, 0)) || func_29(bParam0, 2, 0)) || func_53(bParam0) != 145) || func_28(bParam0)) || func_27(bParam0)) || func_26(bParam0)) || func_25(bParam0)) || !func_15(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_27(bParam0))
		{
		}
		...
		if (func_29(bParam0, 0, 0))
		{
		}
		if (func_29(bParam0, 1, 0))
		{
		}
		if (func_29(bParam0, 2, 0))
		{
		}
		if (func_53(bParam0) != 145)
		{
		}
		return 0;
	}
...
int func_16(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
var func_32()
{
	...
	func_42(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_41(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_40(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_35(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_34(&uVar0, CLOCK::GET_CLOCK_YEAR());
	func_33(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_38(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
void func_47(int iParam0, var uParam1, struct<3> Param2, bool bParam3, int iParam4)
{
	if (func_43(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
void func_55(bool bParam0, var uParam1)
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_57(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
int func_74(bool bParam0, int iParam1, int iParam2)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		if (iParam1 == 12)
		{
			...
			while (iVar0 <= 53)
			{
				if (func_181(bParam0, iParam1, iVar0))
				{
					return iVar0;
				}
				iVar0++;
		...
		else if (iParam1 == 13)
		{
			...
			while (iVar1 <= 19)
			{
				if (func_181(bParam0, iParam1, iVar1))
				{
					return iVar1;
				}
				iVar1++;
...
void func_109(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			bVar0 = func_112(func_121(iParam1, uParam0->f_2), Global_76644, 0);
			...
			{
				bVar0 = func_112(iVar1, Global_76644, 0);
				if (!unk_0xCE990E643CD9D0E5(bVar0, uParam0->f_1))
				{
					unk_0xBE20AB8238688965(&(uParam0->f_6), 4);
				}
...
void func_183()
{
	...
	{
		if (func_185(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
int func_199(int iParam0, float fParam1, int iParam2)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_206(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
