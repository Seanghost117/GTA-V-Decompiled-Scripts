...
void __EntryFunction__()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("ambient_tonya")) > 1)
	{
...
int func_141()
{
	return func_136(TASK::IS_PED_BEING_ARRESTED(), 0);
}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 4:
						if (((((func_155() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_153(8, -1)) || func_150()) || func_149()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
