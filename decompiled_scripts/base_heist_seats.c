...
void func_1()
{
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_1573983, true);
	func_3(&Local_47);
	func_2();
}
...
{
	func_19(&Local_47);
	if (Global_1590525 == PLAYER::PLAYER_ID() && !unk_0xCE990E643CD9D0E5(Global_1627436[STATS::_GET_PACKED_TITLE_UPDATE_BOOL_STAT_KEY() /*90*/].f_38.f_27, 5))
	{
		...
		if (func_18(&Local_47, 0, 0))
		{
			...
			if ((((((iLocal_64 == 0 && !unk_0xCE990E643CD9D0E5(Global_1627436[STATS::_GET_PACKED_TITLE_UPDATE_BOOL_STAT_KEY() /*90*/].f_38.f_27, 3)) && !func_16()) && !HUD::DISABLE_FRONTEND_THIS_FRAME()) && !func_15(0)) && !func_14()) && PAD::IS_CONTROL_JUST_PRESSED(0, 225))
			{
				func_12(&Local_47);
			}
		}
	...
	switch (iParam0->f_421.f_4)
	{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				...
				Var4 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_45(iParam0), func_44(iParam0), 0f, 2) };
				uVar5 = Var4.f_2;
				HUD::_THEFEED_DISABLE(unk_0x9B0761B4C3EB8BC7(), Var3, 1f, 500, uVar5, 0.15f);
			}
			func_58(iParam0, 5);
			break;
		...
		case 5:
			...
			if (Var2 == 3)
			{
				iVar6 = TASK::GET_SCRIPT_TASK_STATUS(unk_0x9B0761B4C3EB8BC7(), 1920390111);
			}
			else
			{
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				iParam0->f_421.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_45(iParam0), func_44(iParam0), 2, 1, 0f, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), iParam0->f_421.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_33(iParam0);
			func_26(iParam0);
			fVar7 = PED::GET_SYNCHRONIZED_SCENE_PHASE(iParam0->f_421.f_1);
			if (PED::DETACH_SYNCHRONIZED_SCENE(fVar7))
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(fVar7) >= 1f)
				{
					func_20(iParam0, 0);
					func_47(iParam0, &sVar0);
					func_46(iParam0, &sVar1);
					iParam0->f_421.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_45(iParam0), func_44(iParam0), 2, 1, 0f, 1065353216, 0, 1065353216);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), iParam0->f_421.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					unk_0xB88AF19828BF16ED(iParam0->f_421.f_1);
					func_13(&(iParam0->f_421), 8);
		...
		case 7:
			SYSTEM::POW(iParam0->f_421.f_1);
			func_58(iParam0, 8);
			break;
		
		case 8:
			fVar8 = PED::GET_SYNCHRONIZED_SCENE_PHASE(iParam0->f_421.f_1);
			if (PED::DETACH_SYNCHRONIZED_SCENE(fVar8))
			{
				if ((ENTITY::HAS_ANIM_EVENT_FIRED(fVar8) >= 1f || ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), 364629851)) || ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), 2116425869))
				{
					SYSTEM::POW(iParam0->f_421.f_1);
					func_4(iParam0, 1);
					func_58(iParam0, 0);
...
void func_20(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (iVar1 != uParam0->f_421.f_8.f_1)
		{
			if (iVar1 == 0)
			{
				bVar0 = (11 + uParam0->f_421.f_8.f_1);
			}
			else
			{
				bVar0 = (6 + iVar1);
	...
	else if (uParam0->f_421.f_8.f_2 == 5)
	{
		...
		if (bVar0 == uParam0->f_421.f_8.f_3)
		{
			bVar0 = (bVar0 + 1 % iVar2);
		}
	}
...
void func_26(var uParam0)
{
	...
	if (uParam0->f_421.f_4 == 6)
	{
		...
		if ((uParam0->f_421.f_4 == 6 && !ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), -1322051853)) && !func_8(&(uParam0->f_421), 12))
		{
			if (fVar1 >= 0.35f)
			{
				func_31(uParam0);
		...
		else
		{
			...
			if (((((!HUD::DISABLE_FRONTEND_THIS_FRAME() && !func_8(&(uParam0->f_421), 0)) && !func_8(&(uParam0->f_421), 4)) && !func_29()) && !func_27(1)) && uParam0->f_421.f_8.f_2 != 3)
			{
...
int func_28(var uParam0)
{
	...
	if (CAM::IS_FIRST_PERSON_AIM_CAM_ACTIVE())
	{
		...
		{
			MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(uParam0, &iVar0, 1);
...
void func_31(var uParam0)
{
	...
	if (((func_21(uParam0) != uParam0->f_421.f_8.f_1 && uParam0->f_421.f_8.f_2 < 6) && uParam0->f_421.f_8.f_2 != 3) && uParam0->f_421.f_8.f_2 != 4)
	{
		...
		uParam0->f_421.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_45(uParam0), func_44(uParam0), 2, 1, 0f, 1065353216, 0, 1065353216);
		NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_421.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
...
void func_32(var uParam0)
{
	...
	uParam0->f_421.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_45(uParam0), func_44(uParam0), 2, 1, 0f, 1065353216, 0, 1065353216);
	func_47(uParam0, &sVar0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_421.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	unk_0xB88AF19828BF16ED(uParam0->f_421.f_1);
	func_9(&(uParam0->f_421.f_5));
	func_58(uParam0, 8);
}
...
bool func_49(var uParam0)
{
	...
	switch (uParam0->f_421.f_8)
	{
		...
		default:
			bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, func_22(uParam0->f_421.f_8));
	}
	return bVar0;
}
...
void func_60(var uParam0)
{
	...
	else if (uParam0->f_421.f_4 > 4)
	{
		...
		PED::SET_PED_CAPSULE(unk_0x9B0761B4C3EB8BC7(), func_61(uParam0));
...
void func_62(var uParam0)
{
	...
	func_63(&(uParam0->f_421), 1, PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0));
	func_63(&(uParam0->f_421), 3, SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1));
...
int func_66()
{
	...
	if (func_67() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_67()) == 0)
		{
			return 1;
		}
	}
...
int func_78()
{
	if (Global_1590525 != func_65())
	{
		...
		NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(32, 0, Global_1590525);
		func_90(0, -1, 0);
...
bool func_81(var uParam0, int iParam1)
{
	...
	if (func_84(PLAYER::PLAYER_ID()) || unk_0xCE990E643CD9D0E5(iLocal_64, 0))
	{
		return 0;
	}
	Var0 = { uParam0->f_1 };
	...
	Var3 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(unk_0x9B0761B4C3EB8BC7()) };
