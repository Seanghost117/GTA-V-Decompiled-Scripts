	...
	switch (iParam0->f_421.f_4)
	{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				...
				Var4 = { unk_0xD78F5800B90C4843(&sVar0, &sVar1, func_45(iParam0), func_44(iParam0), 0, 2) };
				uVar5 = Var4.f_2;
				unk_0x83CAF206A9B8748C(unk_0x9B0761B4C3EB8BC7(), Var3, 1f, 500, uVar5, 0.15f);
			}
			func_58(iParam0, 5);
			break;
		...
		case 6:
			...
			func_33(iParam0);
			func_26(iParam0);
			uVar7 = unk_0xAB6BAF5BFCAFB141(iParam0->f_421.f_1);
			if (unk_0xFC5D6FB6EECB392F(uVar7))
			{
				if (unk_0x369E69441C066912(uVar7) >= 1f)
				{
					func_20(iParam0, 0);
					func_47(iParam0, &sVar0);
					func_46(iParam0, &sVar1);
		...
		case 8:
			uVar8 = unk_0xAB6BAF5BFCAFB141(iParam0->f_421.f_1);
			if (unk_0xFC5D6FB6EECB392F(uVar8))
			{
				if ((unk_0x369E69441C066912(uVar8) >= 1f || unk_0x39CABCD7925B9200(unk_0x9B0761B4C3EB8BC7(), 364629851)) || unk_0x39CABCD7925B9200(unk_0x9B0761B4C3EB8BC7(), 2116425869))
				{
					unk_0x71B9CAADD460F7CC(iParam0->f_421.f_1);
					func_4(iParam0, 1);
					func_58(iParam0, 0);
