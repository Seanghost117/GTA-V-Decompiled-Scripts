...
void func_1()
{
	...
	if (MISC::IS_BIT_SET(iLocal_269))
	{
		...
		{
			unk_0x74528AC0906CBABE(joaat("towtruck"));
			STREAMING::REMOVE_ANIM_DICT(&iLocal_269);
		}
	}
}
...
void func_2(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*iParam3 = 500;
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam1, 0))
	{
		...
		func_149(Global_111858.f_19969.f_3, &Var1, &fVar3, &uVar0, &uVar2);
		if (Global_111858.f_19969.f_3 >= 5 || uLocal_257)
		{
		...
		switch (*iParam0)
		{
			case 0:
				...
				MISC::SET_RANDOM_SEED(((CLOCK::GET_CLOCK_MINUTES() * CLOCK::GET_CLOCK_HOURS()) * CLOCK::GET_CLOCK_DAY_OF_MONTH()));
			...
			case 15:
				...
				if (func_150(iParam0, 0, 1))
				{
					...
					func_118();
					*iParam3 = 0;
					if (PAD::IS_DISABLED_CONTROL_PRESSED(0, 86) || unk_0xB9C0D9B37277621D(0, 86))
					{
						func_117();
						func_115();
			...
			case 16:
				...
				*iParam3 = 0;
				...
				if (iVar4 == 1)
				{
					if (!bParam4)
					{
						func_24(TASK::IS_PED_BEING_ARRESTED(), 0);
					}
					iLocal_70 = 1;
					*iParam0 = 17;
				}
			...
			case 17:
				if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_245))
				{
					...
					else
					{
						...
						func_144(&(Global_111858.f_19969.f_1), 8192);
						func_144(&(Global_111858.f_19969.f_1), 16384);
						if (MISC::IS_BIT_SET(iLocal_268) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_268, 0))
						{
							PED::REMOVE_PED_FROM_GROUP(iLocal_268);
						}
						if (SYSTEM::VMAG(fLocal_267))
						{
							unk_0x93370FA10F15BE44(&fLocal_267);
						}
					...
					if (Global_98989)
					{
						...
						if (Global_111858.f_19969.f_3 >= 5)
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_265))
							{
								...
								if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_269, 0))
								{
									PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), iLocal_269, -1);
									PED::SET_PED_COORDS_KEEP_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 408.8376f, -1638.952f, 28.2928f);
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || MISC::GET_MODEL_DIMENSIONS(iParam0) == func_36(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_59(int iParam0, bool bParam1)
{
	...
	iVar0 = func_46(iParam0);
	if (func_38(iVar0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		if (iParam0 == unk_0x9B0761B4C3EB8BC7())
		{
...
int func_71(var uParam0)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_94())
		{
			*uParam0 = func_77(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_77(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam1 == 6 || iParam1 == func_93(iVar0))
		{
			...
			{
				fVar1 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Param0, func_78(iVar0, 0), 1);
...
var func_95()
{
	...
	func_96(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
int func_107()
{
	...
	if (SCRIPT::HAS_SCRIPT_LOADED("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			Local_51.f_2 = 1;
			iLocal_245 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Towing", &Local_51, 9, 37500);
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_268, 0))
			{
...
float func_136(int iParam0)
{
	if (func_141(iParam0))
	{
		...
		{
			return (func_137(unk_0xCE990E643CD9D0E5(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_137(unk_0xCE990E643CD9D0E5(*iParam0, 4)) - fParam1);
	...
	if (SYSTEM::VDIST(iParam0, 0))
	{
		...
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iVar0, 0))
		{
			if (MISC::IS_MINIGAME_IN_PROGRESS(iVar0, -1, 0) == iParam0)
			{
				...
				{
					iLocal_269 = iVar0;
					if (MISC::IS_BIT_SET(iLocal_269) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_269, 0))
					{
						iLocal_265 = MISC::GET_MODEL_DIMENSIONS(iLocal_269);
					}
					return 1;
				}
			}
...
void func_146(var uParam0, int iParam1)
{
	if (!func_150(uParam0, 0, 1))
	{
		if (func_143(iParam1))
		{
			if (PAD::IS_DISABLED_CONTROL_PRESSED(0, 86) || unk_0xB9C0D9B37277621D(0, 86))
			{
				if ((((((!func_142() && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && !func_114(0)) && !func_58(6)) && !func_58(7)) && !AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) && func_106() == 1)
				{
					func_135(&uLocal_80, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
					func_135(&uLocal_80, 4, 0, "TOWDISPATCH", 0, 1);
...
void func_148(int* iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	...
	fVar0 = SYSTEM::VDIST2(Param1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1));
	switch (iLocal_71)
	{
		case 0:
			...
			if (SYSTEM::VDIST(iParam0, 0))
			{
				iVar1 = ENTITY::GET_ENTITY_MODEL(iParam0, 0);
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iVar1, 0))
				{
					fVar2 = MISC::GET_MODEL_DIMENSIONS(iVar1);
					if ((fVar2 == joaat("towtruck") || fVar2 == joaat("towtruck2")) && ENTITY::GET_ENTITY_HEALTH(iVar1) > 400)
					{
						return;
					}
				}
		...
		case 2:
			if (ENTITY::DOES_ENTITY_EXIST(joaat("towtruck")))
			{
				if (!CAM::IS_SPHERE_VISIBLE(Local_254, fLocal_255) || func_22(Global_111858.f_19969.f_1, 1073741824))
				{
					if (!MISC::IS_BIT_SET(iLocal_269))
					{
		...
		case 3:
			if (SYSTEM::VDIST(iParam0, 0))
			{
				if (ENTITY::GET_ENTITY_MODEL(iParam0, 0) == iLocal_269)
				{
					iLocal_71 = 0;
				}
			}
			if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_269, 0))
			{
				iLocal_71 = 0;
			}
			if (fVar0 > 62500f)
