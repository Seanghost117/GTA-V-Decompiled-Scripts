...
void func_1()
{
	...
	{
		if (unk_0x1D88F87079AF2FA7(iLocal_268))
		{
			unk_0x74528AC0906CBABE(joaat("a_f_y_soucent_01"));
			unk_0x586DDC617E714637(&iLocal_268);
		}
		else
		{
			unk_0x74528AC0906CBABE(joaat("a_f_y_soucent_01"));
			unk_0x2481907DEE6B85EA(&iLocal_268);
		}
	}
	if (unk_0xAE06B9E39EBDE049(iLocal_269))
	{
		if (unk_0x1D88F87079AF2FA7(iLocal_269))
		{
			unk_0x74528AC0906CBABE(joaat("towtruck"));
			if (unk_0x1758275D343D5BA3(iLocal_269))
			{
				unk_0x03A2522C845CFAC6(&iLocal_269);
			}
		}
		else
		{
			unk_0x74528AC0906CBABE(joaat("towtruck"));
			unk_0xE730EAF558C97567(&iLocal_269);
		}
	}
}
...
void func_2(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*iParam3 = 500;
	if (!unk_0xA59F96B50B97E63C(iParam1, 0))
	{
		...
		func_149(Global_111858.f_19969.f_3, &Var1, &uVar3, &uVar0, &uVar2);
		...
		switch (*iParam0)
		{
			...
			case 17:
				if (!unk_0x7FD2BDF03806FD9D(iLocal_245))
				{
					...
					else
					{
						...
						func_144(&(Global_111858.f_19969.f_1), 8192);
						func_144(&(Global_111858.f_19969.f_1), 16384);
						if (unk_0xAE06B9E39EBDE049(iLocal_268) && !unk_0xA59F96B50B97E63C(iLocal_268, 0))
						{
							unk_0x59478CBBF96AF7D1(iLocal_268);
						}
						if (unk_0x8F678487EEBD8CE4(uLocal_267))
						{
							unk_0x93370FA10F15BE44(&uLocal_267);
						}
						...
						if (Global_111858.f_19969.f_3 >= 5)
						{
							if (unk_0x7D167B9A0CCDA347(iLocal_265))
							{
								...
								if (!unk_0xAE06B9E39EBDE049(iLocal_269))
								{
									...
									iLocal_269 = unk_0xCE4780E24AFDFBF9(iLocal_265, 408.8376f, -1638.952f, 28.2928f, 230.2387f, 1, 1, 0);
									unk_0x74528AC0906CBABE(iLocal_265);
								}
								if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0) && !unk_0xA59F96B50B97E63C(iLocal_269, 0))
								{
									unk_0x13A4BD6CC31F7B8F(unk_0x9B0761B4C3EB8BC7(), iLocal_269, -1);
									unk_0xA4503BC390E6CC31(unk_0x9B0761B4C3EB8BC7(), 408.8376f, -1638.952f, 28.2928f);
									unk_0xE922BAA80E8F9324(iLocal_269, 230.2387f);
									*iParam0 = 16;
								}
							}
						}
			...
			case 19:
				if ((unk_0x578C4EF320340AF7() - *uParam2) > iLocal_249)
				{
					*uParam2 = 0;
					*iParam0 = 0;
				}
...
void func_23()
{
	...
	if (unk_0x7FD2BDF03806FD9D(iLocal_245))
	{
		unk_0x0FEA68739C1C2329(iLocal_245);
	}
...
int func_107()
{
	...
	if (unk_0x8DC2EFD1CECAA468("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			unk_0x5F82526B41A5EBCE("Towing");
			if (!unk_0xA59F96B50B97E63C(iLocal_268, 0))
			{
				unk_0xCBA6B2B569DCAFD8(iLocal_268, 1);
			}
			unk_0x2481907DEE6B85EA(&iLocal_268);
			unk_0x1082C25039B168F8("amb@world_human_smoking@male@male_a@base");
			unk_0x1082C25039B168F8("oddjobs@towingcome_here");
...
void func_118()
{
	switch (iLocal_70)
	{
		case 1:
			if (!func_142())
			{
				if (!unk_0xDABD547F0DF2906C() && !func_141(&uLocal_58))
				{
					unk_0xEAAF04956584A7A6(0);
					func_139(&uLocal_58);
				}
				else if (!unk_0xDABD547F0DF2906C() && func_141(&uLocal_58))
				{
	...
	if (unk_0x47DBF174A0CB9D55(iParam0, 0))
	{
		...
		if (!unk_0xA59F96B50B97E63C(iVar0, 0))
		{
			if (unk_0x10D3F7E169A49C44(iVar0, -1, 0) == iParam0)
			{
				...
				{
					iLocal_269 = iVar0;
					if (unk_0xAE06B9E39EBDE049(iLocal_269) && !unk_0xA59F96B50B97E63C(iLocal_269, 0))
					{
						iLocal_265 = unk_0x36FE6D3220816ADA(iLocal_269);
					}
					return 1;
				}
			}
...
void func_148(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	...
	switch (iLocal_71)
	{
		...
		case 2:
			...
			{
				if (!unk_0x9A70B1BD2A5BA09C(Local_254, fLocal_255) || func_22(Global_111858.f_19969.f_1, 1073741824))
				{
					if (!unk_0xAE06B9E39EBDE049(iLocal_269))
					{
						iLocal_269 = unk_0xCE4780E24AFDFBF9(joaat("towtruck"), Param1, uParam2, 1, 1, 0);
						unk_0x74528AC0906CBABE(joaat("towtruck"));
						iLocal_71 = 3;
					}
				}
		...
		case 3:
			if (unk_0x47DBF174A0CB9D55(iParam0, 0))
			{
				if (unk_0xA5D5B1042E8F47BD(iParam0, 0) == iLocal_269)
				{
					iLocal_71 = 0;
				}
			}
			if (unk_0xA59F96B50B97E63C(iLocal_269, 0))
			{
				iLocal_71 = 0;
			}
			if (fVar0 > 62500f)
...
int func_150(var uParam0, bool bParam1, bool bParam2)
{
	...
	if ((unk_0x578C4EF320340AF7() - iLocal_248) < iLocal_249)
	{
		return 0;
	}
	return 1;
