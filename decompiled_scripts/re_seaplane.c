	...
	switch (iLocal_46)
	{
		...
		case 1:
			switch (iLocal_54)
			{
				...
				case 6:
					if ((((((ENTITY::DOES_ENTITY_EXIST(iLocal_60) && ENTITY::DOES_ENTITY_EXIST(iLocal_59)) && ENTITY::DOES_ENTITY_EXIST(iLocal_61)) && ENTITY::DOES_ENTITY_EXIST(iLocal_63)) && ENTITY::DOES_ENTITY_EXIST(iLocal_62)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_49)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_50))
					{
...
int func_39(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		{
			iVar0 = iParam0;
			if (iVar0 >= 7 && !SYSTEM::VMAG(Local_47[iParam0 /*6*/].f_1))
			{
				return 1;
			}
		}
...
{
	if (MISC::IS_BIT_SET(Local_47[iParam0 /*6*/]))
	{
		func_43(&(Local_47[iParam0 /*6*/].f_1));
		if ((((func_199(Local_47[iParam0 /*6*/]) && ENTITY::IS_ENTITY_ATTACHED(Local_47[iParam0 /*6*/])) && !SYSTEM::VDIST(Local_47[iParam0 /*6*/], 1)) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_47[iParam0 /*6*/])) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(Local_47[iParam0 /*6*/]))
		{
			ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(Local_47[iParam0 /*6*/], 1, 1);
		}
		if (bParam1)
		{
	...
	if (!MISC::IS_BIT_SET(Local_47[iParam0 /*6*/]))
	{
		...
		switch (iParam0)
		{
			...
			case 1:
				...
				fVar1 = (ENTITY::IS_ENTITY_IN_WATER(Local_48[1 /*4*/]) + 90f);
			...
			case 3:
				...
				fVar1 = (ENTITY::IS_ENTITY_IN_WATER(Local_48[2 /*4*/]) + 90f);
				sVar68 = "WORLD_HUMAN_HANG_OUT_STREET";
				iVar3 = joaat("weapon_microsmg");
				bVar31 = true;
				bVar32 = false;
		...
		if (func_199(bVar4))
		{
			Local_47[iParam0 /*6*/] = PED::CREATE_PED_INSIDE_VEHICLE(bVar4, 26, iVar2, iVar5, true, true);
		}
		else
		{
		...
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_47[iParam0 /*6*/], 2.984766E-43f, iVar23);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_47[iParam0 /*6*/], 2.970753E-43f, iVar24);
		PED::_0x2208438012482A1A(Local_47[iParam0 /*6*/], iVar25);
		PED::SET_PED_KEEP_TASK(Local_47[iParam0 /*6*/], bVar26);
		PED::SET_PED_DIES_WHEN_INJURED(Local_47[iParam0 /*6*/], bVar27);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_47[iParam0 /*6*/], 2.634441E-43f, iVar50);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_47[iParam0 /*6*/], 5.885454E-44f, !bVar28);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*6*/], 9, bVar30);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*6*/], 3, bVar32);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_47[iParam0 /*6*/], 4.792441E-43f, bVar52);
		...
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_47[iParam0 /*6*/], 1.653532E-43f, bVar43);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_47[iParam0 /*6*/], 1.611493E-43f, bVar44);
		...
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_47[iParam0 /*6*/], 2.592402E-43f, bVar49);
		...
		ENTITY::SET_ENTITY_COORDS(Local_47[iParam0 /*6*/], iVar61);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_47[iParam0 /*6*/], 2.844636E-43f, bVar62);
		PED::_0xA9B61A329BFDCBEA(Local_47[iParam0 /*6*/], !bVar62);
		if (!bVar55)
		{
			func_58(iParam0, 2);
		}
		if (!CAM::IS_SCREEN_FADED_OUT(sVar68))
		{
		...
		if (iVar11 > 0)
		{
			...
			CAM::IS_AIM_CAM_ACTIVE(Local_47[iParam0 /*6*/], iVar11, 0);
		}
		if (iVar13 > 0)
		{
		...
		{
			OBJECT::CREATE_OBJECT_NO_OFFSET(Local_47[iParam0 /*6*/], bVar6, NaNf, Var7, Var8, 1, 1, 1, 0, 2, 1);
		...
		if (iVar9 != 0)
		{
			...
			ENTITY::SET_ENTITY_HEALTH(Local_47[iParam0 /*6*/], iVar3, 1);
		}
...
bool func_61(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_62(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_62(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
{
	unk_0xBE20AB8238688965(&bLocal_55, iParam0);
}
...
void func_80(int iParam0)
{
	...
	{
		case 0:
			fLocal_78[iParam0] = PATHFIND::SET_ROADS_IN_AREA(3054.991f, 1995.887f, -20f, 3140.817f, 2225.639f, 10.453f, false, true, 1, 1);
			break;
	}
}
...
void func_85()
{
	...
	while (iVar0 < 11)
	{
		if (MISC::IS_BIT_SET(Local_47[iVar0 /*6*/]) && SYSTEM::VMAG(Local_47[iVar0 /*6*/].f_1))
		{
			if (SYSTEM::VDIST(Local_47[iVar0 /*6*/], 0))
			{
				if (!func_89(iVar0, 0))
				{
			...
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Local_47[iVar0 /*6*/]))
			{
...
{
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_47[iParam0 /*6*/].f_2), bParam1);
}
	...
	if (func_199(Local_48[iParam0 /*4*/]) || iParam0 == 0)
	{
		switch (iParam0)
		{
			...
			case 4:
				...
				{
					case 0:
						if (((!func_199(MISC::IS_MINIGAME_IN_PROGRESS(Local_48[iParam0 /*4*/], -1, 0)) && !func_199(MISC::IS_MINIGAME_IN_PROGRESS(Local_48[iParam0 /*4*/], 0, 0))) && !func_199(MISC::IS_MINIGAME_IN_PROGRESS(Local_48[iParam0 /*4*/], 1, 0))) && !func_199(MISC::IS_MINIGAME_IN_PROGRESS(Local_48[iParam0 /*4*/], 2, 0)))
						{
...
void func_94()
{
	...
	while (iVar0 < 11)
	{
		if (MISC::IS_BIT_SET(Local_47[iVar0 /*6*/]))
		{
			func_95(iVar0);
		}
		iVar0++;
...
void func_95(int iParam0)
{
	...
	if (func_199(Local_47[iParam0 /*6*/]))
	{
		switch (iParam0)
		{
			...
			case 2:
				...
				{
					if ((SYSTEM::VDIST(Local_47[iParam0 /*6*/], 0) && func_199(ENTITY::GET_ENTITY_MODEL(Local_47[iParam0 /*6*/], 0))) && FIRE::IS_ENTITY_ON_FIRE(ENTITY::GET_ENTITY_MODEL(Local_47[iParam0 /*6*/], 0)))
					{
						func_105();
						TASK::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, true);
						TASK::TASK_LEAVE_ANY_VEHICLE(0, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(500, 1501), 4096);
				...
				switch (Local_47[iParam0 /*6*/].f_3)
				{
					case 0:
						...
						if (((func_121(1) || PED::IS_PED_IN_COMBAT(Local_47[iParam0 /*6*/], unk_0x9B0761B4C3EB8BC7())) || func_102()) || func_101())
						{
							func_100(iParam0);
							TASK::TASK_COMBAT_PED(Local_47[iParam0 /*6*/], unk_0x9B0761B4C3EB8BC7(), 0, 16);
					...
					case 2:
						...
						TASK::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sVar4, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), &iVar1);
						TASK::WAYPOINT_RECORDING_GET_NUM_POINTS(sVar4, &iVar3);
						TASK::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sVar4, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_47[iParam0 /*6*/], 1), &iVar2);
						if (iVar1 > 0 && PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()))
						{
							iVar1 = (iVar1 - 1);
						}
						...
						if (((((iParam0 == 0 && iLocal_57 != iVar1) && iVar1 > iVar2) || ((iParam0 == 2 && iLocal_58 != iVar1) && iVar1 > iVar2)) && func_199(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]))) && !PED::IS_PED_BEING_STUNNED(Local_47[iParam0 /*6*/], 0))
						{
							if (iParam0 == 0)
							{
								iLocal_57 = iVar1;
							...
							if (func_199(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/])))
							{
								VEHICLE::SET_BOAT_ANCHOR(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]), false);
								func_86(iParam0, 5);
							}
							TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_47[iParam0 /*6*/], STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]), sVar4, 786469, 0, iVar5, iVar1, -1f, false, 6f);
						}
						...
						{
							TASK::TASK_VEHICLE_SHOOT_AT_PED(Local_47[iParam0 /*6*/], unk_0x9B0761B4C3EB8BC7(), 20f);
							if (func_199(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/])) && VEHICLE::CAN_ANCHOR_BOAT_HERE(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/])))
							{
								VEHICLE::SET_BOAT_ANCHOR(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]), true);
								func_58(iParam0, 5);
							}
						}
						if (!func_89(iParam0, 4))
						{
							...
							{
								func_58(iParam0, 4);
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_47[iParam0 /*6*/]);
								if (!func_89(iParam0, 5) && VEHICLE::CAN_ANCHOR_BOAT_HERE(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/])))
								{
									VEHICLE::SET_BOAT_ANCHOR(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]), true);
								}
							}
						...
						if ((TASK::GET_SCRIPT_TASK_STATUS(Local_47[iParam0 /*6*/], -235832601) == 1 && !VEHICLE::IS_VEHICLE_STOPPED(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]))) && !TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(Local_47[iParam0 /*6*/]))
						{
							TASK::TASK_DRIVE_BY(Local_47[iParam0 /*6*/], unk_0x9B0761B4C3EB8BC7(), 0, Local_51, 500f, 100, true, -687903391);
						}
						TASK::WAYPOINT_RECORDING_GET_COORD(sVar4, (iVar3 - 1), &Var6);
						if (unk_0xC2169C00B643278B(Local_47[iParam0 /*6*/], Var6, 8f, 8f, 8f, 0, 1, 0))
						{
							PED::_0x2208438012482A1A(Local_47[iParam0 /*6*/], 1);
							TASK::TASK_BOAT_MISSION(Local_47[iParam0 /*6*/], STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]), 0, unk_0x9B0761B4C3EB8BC7(), Local_51, 7, 20f, 786469, 5f, 7);
							func_68(5);
					...
					case 3:
						if (SYSTEM::VDIST(Local_47[iParam0 /*6*/], 0) && func_199(ENTITY::GET_ENTITY_MODEL(Local_47[iParam0 /*6*/], 0)))
						{
							if (VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(ENTITY::GET_ENTITY_MODEL(Local_47[iParam0 /*6*/], 0), 3, 6000) || func_97(iParam0, 5000))
							{
					...
					case 4:
						if (!func_98(Local_47[iParam0 /*6*/], -1708676711, 1))
						{
							...
							{
								PED::_0x2208438012482A1A(Local_47[iParam0 /*6*/], 0);
								TASK::TASK_COMBAT_PED(Local_47[iParam0 /*6*/], unk_0x9B0761B4C3EB8BC7(), 0, 16);
							}
							else
							{
			...
			case 4:
				switch (Local_47[iParam0 /*6*/].f_3)
				{
					case 0:
						...
						{
							func_100(iParam0);
							Local_47[iParam0 /*6*/].f_4 = (MISC::GET_GAME_TIMER() + NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1250, 1501));
							Local_47[iParam0 /*6*/].f_3++;
						}
						break;
					...
					case 1:
						...
						{
							if ((iParam0 == 1 && func_199(Local_48[1 /*4*/])) && func_199(MISC::IS_MINIGAME_IN_PROGRESS(Local_48[1 /*4*/], -1, 0)))
							{
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_47[iParam0 /*6*/]);
								TASK::TASK_ENTER_VEHICLE(Local_47[iParam0 /*6*/], Local_48[1 /*4*/], 20000, 0, 3f, 1, 0);
								PED::_0x2208438012482A1A(Local_47[iParam0 /*6*/], 1);
							}
							if ((iParam0 == 3 && func_199(Local_48[2 /*4*/])) && func_199(MISC::IS_MINIGAME_IN_PROGRESS(Local_48[2 /*4*/], -1, 0)))
							{
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_47[iParam0 /*6*/]);
								TASK::TASK_ENTER_VEHICLE(Local_47[iParam0 /*6*/], Local_48[2 /*4*/], 20000, 0, 3f, 1, 0);
								PED::_0x2208438012482A1A(Local_47[iParam0 /*6*/], 1);
							}
							if ((iParam0 == 4 && func_199(Local_48[2 /*4*/])) && func_199(MISC::IS_MINIGAME_IN_PROGRESS(Local_48[2 /*4*/], -1, 0)))
							{
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_47[iParam0 /*6*/]);
					...
					case 2:
						...
						if (SYSTEM::VDIST(Local_47[iParam0 /*6*/], 1) || !func_199(MISC::IS_MINIGAME_IN_PROGRESS(Local_48[iVar7 /*4*/], -1, 0)))
						{
							PED::_0x2208438012482A1A(Local_47[iParam0 /*6*/], 0);
							TASK::TASK_COMBAT_PED(Local_47[iParam0 /*6*/], unk_0x9B0761B4C3EB8BC7(), 0, 16);
							Local_47[iParam0 /*6*/].f_3++;
					...
					case 3:
						if (SYSTEM::VDIST(Local_47[iParam0 /*6*/], 0) && func_199(ENTITY::GET_ENTITY_MODEL(Local_47[iParam0 /*6*/], 0)))
						{
							if (FIRE::IS_ENTITY_ON_FIRE(ENTITY::GET_ENTITY_MODEL(Local_47[iParam0 /*6*/], 0)))
							{
								func_105();
								TASK::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, true);
								TASK::TASK_LEAVE_ANY_VEHICLE(0, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(500, 1501), 4096);
							...
							{
								if ((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(ENTITY::GET_ENTITY_MODEL(Local_47[iParam0 /*6*/], 0), 3, 6000) || func_97(iParam0, 5000)) && func_121(5))
								{
								...
								else if (!func_199(MISC::IS_MINIGAME_IN_PROGRESS(ENTITY::GET_ENTITY_MODEL(Local_47[iParam0 /*6*/], 0), -1, 0)))
								{
			...
			case 7:
				...
				{
					case 0:
						if ((((func_44() && func_41(unk_0x9B0761B4C3EB8BC7(), Local_47[iParam0 /*6*/], 1) <= 125f) || ((PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()) && !NETWORK::NETWORK_IS_PLAYER_ACTIVE(unk_0x9B0761B4C3EB8BC7())) && func_41(unk_0x9B0761B4C3EB8BC7(), Local_47[iParam0 /*6*/], 1) <= 150f)) || (PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()) && !ENTITY::IS_ENTITY_OCCLUDED(Local_47[iParam0 /*6*/]))) || func_121(6))
						{
							if (func_199(Local_48[3 /*4*/]))
							{
								VEHICLE::SET_BOAT_ANCHOR(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]), false);
								bVar8 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7());
								bVar8 = func_96(bVar8, 10f, 40f);
								VEHICLE::SET_VEHICLE_FORWARD_SPEED(Local_48[3 /*4*/], bVar8);
							}
							ENTITY::SET_ENTITY_HEALTH(Local_47[iParam0 /*6*/], joaat("weapon_pistol"), 0);
							TASK::TASK_BOAT_MISSION(Local_47[iParam0 /*6*/], STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]), 0, unk_0x9B0761B4C3EB8BC7(), Local_51, 7, 20f, 786469, 5f, 7);
							PED::_0x2208438012482A1A(Local_47[iParam0 /*6*/], 1);
							Local_47[iParam0 /*6*/].f_1 = func_60(Local_47[iParam0 /*6*/], 1, 145);
							func_68(6);
				...
				switch (Local_47[iParam0 /*6*/].f_3)
				{
					case 0:
						if ((((func_44() && func_41(unk_0x9B0761B4C3EB8BC7(), Local_47[iParam0 /*6*/], 1) <= 125f) || ((PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()) && !NETWORK::NETWORK_IS_PLAYER_ACTIVE(unk_0x9B0761B4C3EB8BC7())) && func_41(unk_0x9B0761B4C3EB8BC7(), Local_47[iParam0 /*6*/], 1) <= 150f)) || (PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()) && !ENTITY::IS_ENTITY_OCCLUDED(Local_47[iParam0 /*6*/]))) || func_121(6))
						{
							...
							{
								VEHICLE::SET_BOAT_ANCHOR(STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]), false);
								bVar9 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7());
								bVar9 = func_96(bVar9, 10f, 40f);
								VEHICLE::SET_VEHICLE_FORWARD_SPEED(Local_48[4 /*4*/], bVar9);
							}
							ENTITY::SET_ENTITY_HEALTH(Local_47[iParam0 /*6*/], joaat("weapon_pistol"), 0);
							TASK::TASK_BOAT_MISSION(Local_47[iParam0 /*6*/], STATS::GET_PACKED_BOOL_STAT_KEY(Local_47[iParam0 /*6*/]), 0, unk_0x9B0761B4C3EB8BC7(), Local_51, 7, 20f, 786469, 5f, 7);
							PED::_0x2208438012482A1A(Local_47[iParam0 /*6*/], 1);
			...
			case 10:
				...
				{
					case 0:
						if (((func_44() && func_41(unk_0x9B0761B4C3EB8BC7(), Local_47[iParam0 /*6*/], 1) <= 125f) || ((PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()) && !NETWORK::NETWORK_IS_PLAYER_ACTIVE(unk_0x9B0761B4C3EB8BC7())) && func_41(unk_0x9B0761B4C3EB8BC7(), Local_47[iParam0 /*6*/], 1) <= 150f)) || (PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()) && !ENTITY::IS_ENTITY_OCCLUDED(Local_47[iParam0 /*6*/])))
						{
							Local_47[iParam0 /*6*/].f_1 = func_60(Local_47[iParam0 /*6*/], 1, 145);
					...
					case 1:
						if (SYSTEM::VDIST(Local_47[iParam0 /*6*/], 0))
						{
							if (func_199(ENTITY::GET_ENTITY_MODEL(Local_47[iParam0 /*6*/], 0)))
							{
								if (VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(ENTITY::GET_ENTITY_MODEL(Local_47[iParam0 /*6*/], 0), 3, 6000) || func_97(iParam0, 5000))
								{
									TASK::TASK_GET_OFF_BOAT(Local_47[iParam0 /*6*/], -1);
	...
	else
	{
		if (func_89(iParam0, 1))
		{
			...
			ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(Local_47[iParam0 /*6*/], 1, 0);
			func_86(iParam0, 1);
		}
...
bool func_96(bool bParam0, float fParam1, float fParam2)
{
	if (bParam0 > fParam2)
	{
		return fParam2;
...
int func_97(int iParam0, int iParam1)
{
	...
	{
		if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(Local_48[iVar0 /*4*/]))
		{
...
int func_102()
{
	...
	if (func_199(iVar0) && unk_0x1037B9D45CE6B788(iVar0, 3083.23f, 2195.516f, -3.22382f, 3096.519f, 2195.455f, 4.949678f, 15f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_103(bool bParam0)
{
	...
	AUDIO::STOP_SCRIPTED_CONVERSATION(bParam0, iLocal_244);
	TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
}

void func_104(bool bParam0)
{
	VEHICLE::IS_VEHICLE_DRIVEABLE(&bLocal_55, bParam0);
}
...
void func_106()
{
	...
	if (MISC::IS_BIT_SET(Local_48[0 /*4*/]) && !func_199(Local_48[0 /*4*/]))
	{
		bVar0 = true;
		iVar1 = 0;
		while (iVar1 <= 10)
...
int func_107()
{
	...
	{
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_115())
		{
			return 0;
		}
	}
...
{
	return unk_0xCE990E643CD9D0E5(bLocal_55, iParam0);
}
...
void func_130(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_132(fVar0, iVar1));
		iVar3 = (iVar3 - 1);
		fVar0 = SYSTEM::ROUND(func_131(SYSTEM::TO_FLOAT(fVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
int func_141()
{
	...
	func_142(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), false)) || func_159()) || Global_110905) || Global_30970) || func_158()) || func_157(8, -1)) || func_154()) || func_156()) || func_155()) || func_153()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_159() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_157(8, -1)) || func_153()) || func_152()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_168()
{
	...
	if (func_199(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if ((Var0.f_1 < 2149.042f && (PED::IS_PED_IN_FLYING_VEHICLE(unk_0x9B0761B4C3EB8BC7()) || (ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7()) && (Var0.f_2 - fVar1) >= 7.5f))) && (Var0.f_2 - fVar1) >= 3f)
		{
			return 0;
		}
		if (Var0.f_2 >= 100f && PED::IS_PED_IN_FLYING_VEHICLE(unk_0x9B0761B4C3EB8BC7()))
		{
			return 0;
		}
	}
...
{
	if (fLocal_78[iParam0] != 0)
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_78[iParam0], 0);
		fLocal_78[iParam0] = 0;
	}
}
