...
void __EntryFunction__()
{
	...
	if (func_521())
	{
		...
		switch (iVar0)
		{
			case 0:
				...
				{
					func_447(&bLocal_344, 225.012f, 2310.695f, 77.257f, 218.1301f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				else
				{
					func_447(&bLocal_344, 232.0044f, 2314.844f, 76.9871f, 173.0429f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
			...
			case 1:
				func_447(&bLocal_344, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
	...
	while (true)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			Local_337 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
			func_421();
			func_420();
			switch (iLocal_58)
			{
					...
					if (iLocal_134 > 0)
					{
						...
						while (iVar0 <= (iLocal_134 - 1))
						{
							if (func_23(Local_69[iVar0 /*20*/]))
							{
								...
								CAM::IS_AIM_CAM_ACTIVE(Local_69[iVar0 /*20*/], 0, 0);
							}
							iVar0++;
						}
					}
...
void func_121(int iParam0)
{
	if (func_23(Local_69[iParam0 /*20*/]))
	{
		...
		HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_69[iParam0 /*20*/]);
		...
		PED::SET_PED_ACCURACY(Local_69[iParam0 /*20*/], NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(10, 20));
		PED::SET_PED_SHOOT_RATE(Local_69[iParam0 /*20*/], NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(15, 20));
		PED::SET_PED_FIRING_PATTERN(Local_69[iParam0 /*20*/], 445831135);
		if (NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 2) == 0)
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iParam0 /*20*/], NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_69[iParam0 /*20*/], 1), 45f, false, false);
		}
		else
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iParam0 /*20*/], NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_69[iParam0 /*20*/], 1), 35f, false, false);
		}
		TASK::TASK_LOOK_AT_ENTITY(Local_69[iParam0 /*20*/], unk_0x9B0761B4C3EB8BC7(), 3000, 0, 2);
		TASK::TASK_COMBAT_PED(Local_69[iParam0 /*20*/], unk_0x9B0761B4C3EB8BC7(), 0, 16);
		PED::_0x2208438012482A1A(Local_69[iParam0 /*20*/], 0);
	...
	if (func_23(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				Local_342 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_68.f_9, 0) };
				...
				if (!iLocal_109)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_120(iLocal_124, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(5000, 12000)))
								{
									if (func_112(Local_68.f_9, Local_337, 30f))
									{
					...
					else
					{
						if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
						{
							if (func_364())
							{
								...
								{
									bVar3 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(bVar1);
									if (bVar3 < 1.75f && func_112(Local_68.f_9, Local_337, 8f))
									{
...
int func_367(bool bParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	if (func_23(bParam0))
	{
		...
		if (func_112(bParam0, Local_337, fParam2))
		{
...
void func_383()
{
	if (func_59(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_336, 100f))
	{
		if (!func_384())
		{
	...
	{
		if (!func_59(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_336, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
			...
			else
			{
				...
				else if (Local_68.f_10 == 24 && func_64(Local_68.f_9, -1519143300))
				{
					if (func_112(Local_68.f_9, Local_337, 25f))
					{
						...
						{
							if (func_120(iLocal_125, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(2500, 5000)))
							{
								if (func_62())
								{
									func_3();
				...
				else
				{
					...
					if (!func_62())
					{
						if (func_120(iLocal_124, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(3000, 6000)))
						{
							if (!func_112(Local_68.f_9, Local_337, 20f))
							{
...
int func_393(bool bParam0, struct<3> Param1, int iParam2, int iParam3, float fParam4)
{
	struct<3> Var0;
	var uVar1;
	char[] cVar2[8];
		...
		switch (iLocal_60)
		{
			...
			case 1:
				...
				if (!iLocal_109)
				{
					...
					{
						if (func_120(iLocal_124, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(3500, 7000)))
						{
							if (func_112(Local_68.f_9, Local_337, 30f))
							{
								if (NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 101) < 30)
			...
			switch (Local_69[iVar0 /*20*/].f_14)
			{
				...
				case 1:
					switch (iVar0)
					{
						...
						case 1:
							bVar2 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(750, 1250);
							break;
						
						case 2:
							bVar2 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1500, 2000);
							break;
						
						case 3:
							bVar2 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(2500, 3000);
							break;
						
						default:
							bVar2 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(500, 1500);
							break;
					}
					if (func_120(Local_69[iVar0 /*20*/].f_15, bVar2))
					{
						func_121(iVar0);
					}
					break;
	...
	if (!iLocal_92)
	{
		if (!func_62())
		{
			if (func_112(Local_68.f_9, Local_337, (22f + 5f)))
			{
				...
				if (CAM::IS_SCREEN_FADED_OUT(&Local_335))
				{
...
int func_410(bool bParam0, int iParam1, bool bParam2, float fParam3, float fParam4)
{
	if (func_433(bParam0))
	{
		if (!func_363(iParam1, 10))
		{
			if (bParam2)
			{
				...
				if (!func_412(bParam0, Local_337, fParam4))
				{
					return 0;
				}
			}
...
int func_412(bool bParam0, struct<3> Param1, float fParam2)
{
	struct<3> Var0;
	bool bVar1;
...
int func_424(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_433(unk_0x9B0761B4C3EB8BC7()) && func_433(bParam0))
	{
...
int func_425(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_426(bool bParam0, float fParam1)
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_427(bParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_427(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_428(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
...
int func_429(bool bParam0, float fParam1)
{
	float fVar0;
	
	if (func_433(unk_0x9B0761B4C3EB8BC7()) && func_433(bParam0))
	{
		if (func_431(bParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bParam0))
		{
...
void func_432(bool bParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
...
void func_447(bool bParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_494(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_174(Param1, 0f, 0f, 0f, 0))
		...
		{
			func_489(iParam10, 0);
			while (!func_448(bParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_448(bool bParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_484(bParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_484(bParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (MISC::GET_MODEL_DIMENSIONS(*bParam0) == joaat("bodhi2"))
...
void func_449(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if ((func_89(iParam0) && MISC::IS_BIT_SET(*bParam1)) && ENTITY::GET_ENTITY_COORDS(*bParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*bParam1) >= 0 && func_453(*bParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_452(*bParam1);
...
int func_453(bool bParam0, bool bParam1, var uParam2)
{
	void fVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	fVar0 = MISC::GET_MODEL_DIMENSIONS(bParam0);
	if ((!func_479(fVar0, bParam1, uParam2) && !func_478(PLAYER::PLAYER_ID())) && !func_461(bParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_459(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_457(bParam0)) && !bVar1) && !(func_456(MISC::GET_MODEL_DIMENSIONS(bParam0)) && func_454(PLAYER::PLAYER_ID())))
	{
...
int func_463(bool bParam0)
{
	...
	if (func_464(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		return 1;
	}
	return 0;
...
int func_465(bool bParam0, bool bParam1)
{
	switch (MISC::GET_MODEL_DIMENSIONS(bParam0))
	{
		...
		case joaat("insurgent"):
			if (func_467(MISC::GET_MODEL_DIMENSIONS(bParam0), 0))
			{
...
int func_467(void fParam0, int iParam1)
{
	if (iParam1 == 0)
	{
		if (func_475(fParam0, 0))
		{
			return 1;
		}
	}
...
int func_475(void fParam0, int iParam1)
{
	switch (fParam0)
	{
		case joaat("faction2"):
...
int func_479(void fParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_459(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fParam0)))
	{
		bVar0 = true;
	}
...
int func_484(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_475(MISC::GET_MODEL_DIMENSIONS(*iParam0), 1) && unk_0x7F8B14CBFB9813E5(*iParam0, 24) != func_487(*iParam0, ((*uParam1)[38] - 1)))
	{
...
bool func_494(struct<3> Param0, float fParam1)
{
	return func_495(&(Global_105407.f_2890), Param0, fParam1, 0);
}

bool func_495(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	bool bVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_512(uParam0))
	{
		...
		if (func_511(uParam0))
		{
			...
			if (MISC::IS_BIT_SET(bVar0))
			{
				...
				else if ((!func_497(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS(TASK::IS_PED_BEING_ARRESTED(), "startup_positioning"))
				{
					iVar4 = func_496(bVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_497(bool bParam0, struct<3> Param1, bool bParam2)
{
	void fVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (fVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_499(bParam0, uVar1[iVar3], 1) && func_498(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
void func_523()
{
	...
	while (iVar0 <= 5)
	{
		if (func_23(Local_69[iVar0 /*20*/]))
		{
			...
			{
				unk_0x92BD213E6A0E666B(Local_69[iVar0 /*20*/], Local_69[iVar0 /*20*/].f_5, -1, 1, 1);
			}
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_69[iVar0 /*20*/], 1.919779E-43f, 1);
			...
			if (iVar0 == 0)
			{
				...
				TASK::SET_SEQUENCE_TO_REPEAT(iLocal_145, true);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_145);
				AUDIO::STOP_SCRIPTED_CONVERSATION(Local_69[iVar0 /*20*/], iLocal_145);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_145);
				if (func_23(Local_69[iVar0 /*20*/]))
				{
					func_97(&uLocal_157, 4, Local_69[iVar0 /*20*/], "HILLBILLY", 0, 1);
					STATS::STAT_SLOT_IS_LOADED(Local_69[iVar0 /*20*/], 1);
				}
			}
		}
		iVar0++;
	...
	if (iLocal_134 > 0)
	{
		...
		while (iVar2 <= (iLocal_134 - 1))
		{
			if (func_54(&(Local_69[iVar2 /*20*/]), Local_69[iVar2 /*20*/].f_19, Local_69[iVar2 /*20*/].f_1, Local_69[iVar2 /*20*/].f_4, 0, 0, 0))
			{
				...
				{
					PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_69[iVar2 /*20*/], 1.849714E-43f, 1);
					iVar0++;
					iVar1++;
				}
			}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_545()) || Global_110905) || Global_30970) || func_551()) || func_95(8, -1)) || func_543()) || func_550()) || func_549()) || func_544()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_545() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_544()) || func_548()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_554(int iParam0)
{
	...
	if (!func_578())
	{
		...
		func_555(TASK::IS_PED_BEING_ARRESTED());
	}
}
...
int func_556(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_567())
	{
		...
		{
			iVar2 = func_557(TASK::IS_PED_BEING_ARRESTED());
			if (iVar2 > -1)
			{
...
int func_565(void fParam0, bool bParam1)
{
	int iVar0;
