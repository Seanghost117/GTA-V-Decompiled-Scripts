...
void func_8()
{
	switch (iLocal_1978)
	{
		...
		case 1:
			...
			{
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_53[0 /*2*/], 1), 1) > 400f && !ENTITY::IS_ENTITY_ON_SCREEN(Local_53[0 /*2*/]))
				{
					func_93(9);
				}
			}
			...
			else if (iLocal_302)
			{
				if (func_92(unk_0x9B0761B4C3EB8BC7(), Local_52, 1) > 220f)
				{
					...
					iLocal_303 = 0;
					iLocal_302 = 0;
					if (MISC::IS_BIT_SET(Local_53[3 /*2*/]))
					{
				...
				{
					if (iLocal_303 && ENTITY::DOES_ENTITY_EXIST(joaat("bison")))
					{
						if (!MISC::IS_BIT_SET(Local_53[3 /*2*/]))
						{
			...
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_53[1 /*2*/], PLAYER::GET_PLAYERS_LAST_VEHICLE()) || ((unk_0x1037B9D45CE6B788(Local_53[2 /*2*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, 1, 0) && unk_0x1037B9D45CE6B788(Local_54[3 /*10*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, 1, 0)) && unk_0x1037B9D45CE6B788(Local_53[0 /*2*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, 1, 0)))
			{
				if (func_107(Local_53[1 /*2*/]))
				{
					VEHICLE::SET_TRAILER_INVERSE_MASS_SCALE(Local_53[1 /*2*/], 0.5f);
				}
				if (SYSTEM::VMAG(Local_58.f_5))
				{
					HUD::_SET_BLIP_DISPLAY_INDICATOR_ON_BLIP(Local_58.f_5, true);
				}
				if (SYSTEM::VMAG(iLocal_243))
				{
				...
				if (func_48(&Local_58, Local_52, 0.1f, 0.1f, 2f, 1, Local_54[3 /*10*/], 0, 0, PLAYER::GET_PLAYERS_LAST_VEHICLE(), "dkp1_tk2", "DKP1_ABFLD", "", "", "", "DKP1_TRUCK", "DKP1_TRUCKBK", 0, 1, 1, -1) || (SYSTEM::VMAG(Local_58.f_5) && unk_0x1037B9D45CE6B788(PLAYER::GET_PLAYERS_LAST_VEHICLE(), -340.1324f, -2630.243f, 5.001461f, -346.5508f, -2636.808f, 12.68896f, 14.9375f, 0, 1, 0)))
				{
					PED::REMOVE_SCENARIO_BLOCKING_AREAS();
					func_46(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 7f, -1, 1056964608, 0, 1, 0);
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false);
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_53[0 /*2*/], false);
		...
		case 2:
			if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				if (func_12(&uLocal_78, "DHP1AUD", "DHP1_END", 7, 0, 0, 0))
				{
					...
					TASK::TASK_LOOK_AT_ENTITY(Local_54[3 /*10*/], unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_244);
					TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					TASK::TASK_GO_TO_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, 3f, 1f, 2f, 0);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_244);
					AUDIO::STOP_SCRIPTED_CONVERSATION(Local_54[3 /*10*/], iLocal_244);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
					iLocal_1978++;
				}
			}
		...
		case 3:
			if (!func_11())
			{
				...
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_54[3 /*10*/]);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_244);
					...
					TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, Local_53[3 /*2*/], unk_0x9B0761B4C3EB8BC7(), 8, 30f, 786468, 1000f, 10f, true);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_244);
					AUDIO::STOP_SCRIPTED_CONVERSATION(Local_54[3 /*10*/], iLocal_244);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
				}
		...
		case 4:
			if (func_10(Local_54[3 /*10*/], unk_0x9B0761B4C3EB8BC7(), 1) > 70f || (MISC::GET_GAME_TIMER() - iLocal_301) > 20000)
			{
...
void func_42(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (bVar0 < 3)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uParam0->f_17[bVar0]))
		{
			...
			if (bParam1)
			{
				if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[bVar0], func_43()) && uParam0->f_17[bVar0] != unk_0x9B0761B4C3EB8BC7())
				{
...
int func_46(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_48(var uParam0, struct<3> Param1, struct<3> Param2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, int iParam18)
{
	return func_49(uParam0, Param1, Param2, func_87(), func_87(), iParam3, 5, iParam4, iParam5, iParam6, bParam7, bParam8, bParam9, bParam10, bParam11, bParam12, bParam13, bParam15, bParam16, bParam14, 0, 0, bParam17, iParam18, 0, 0, 0, 1, 1065353216);
}
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uParam0->f_17[iVar2]))
							{
								...
								else if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_43()) || !func_54(uParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
...
int func_54(bool bParam0, int iParam1)
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		...
		else if (PED::IS_PED_GROUP_MEMBER(bParam0, func_43()))
		{
			PED::SET_GROUP_SEPARATION_RANGE(func_43(), 50f);
			return 1;
		}
		...
		while (iVar0 < 3)
		{
			if (MISC::IS_BIT_SET(uParam0->f_17[iVar0]))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uParam0->f_17[iVar0]))
				{
					...
					if ((!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_43()) && !func_75(uParam0->f_17[iVar0], bParam10)) && !func_74(uParam0->f_17[iVar0], bParam10))
					{
					...
					else if (ENTITY::GET_ENTITY_COORDS(bParam10, false))
					{
						...
						else if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_43()) && !FIRE::IS_ENTITY_ON_FIRE(bParam10))
						{
							PED::REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
						}
					}
...
int func_74(bool bParam0, bool bParam1)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		if (!PED::IS_PED_GROUP_MEMBER(bParam0, func_43()))
		{
...
float func_92(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_108(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_191(TASK::IS_PED_BEING_ARRESTED(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_184(TASK::IS_PED_BEING_ARRESTED(), 1);
			if (iVar4 != -1)
			{
		...
		func_109(iParam0, bParam1, iParam4, iParam5);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam1, ""))
		{
		}
	}
...
{
	func_110(&Global_105407, TASK::IS_PED_BEING_ARRESTED(), iParam0, uParam1, iParam3, iParam2);
}

void func_110(var uParam0, bool bParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_112(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (func_126(bParam2, &iVar0, iParam3, iParam5))
	{
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == bParam0)
			{
				...
				{
					if (iParam2 == 0 || MISC::GET_MODEL_DIMENSIONS(bParam0) == func_119(iParam1, iParam2))
					{
						return 1;
					}
				}
...
int func_126(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	bool bVar0;
...
int func_127(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_129(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		...
		while (iVar1 < 12)
		{
			func_135(bParam0, iVar1, &(uParam1->f_13[iVar1]), uParam1[iVar1], &(uParam1->f_26[iVar1]), iParam2, 145);
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 9)
		{
			func_134(bParam0, iVar1, &(uParam1->f_39[iVar1]), &(uParam1->f_49[iVar1]), iParam2, 145);
			iVar1++;
		}
		if (func_26(iVar0))
		{
...
void func_137(bool bParam0, bool bParam1)
{
	...
	if (func_26(iVar0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		if (bParam0 == unk_0x9B0761B4C3EB8BC7())
		{
			func_138(bParam0, &(Global_111858.f_2359.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_138(bool bParam0, var uParam1)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(bParam0, func_143(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
int func_148(var uParam0)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_170())
		{
			*uParam0 = func_154(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_154(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam1 == 6 || iParam1 == func_169(iVar0))
		{
			...
			{
				fVar1 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Param0, func_155(iVar0, 0), 1);
...
var func_171()
{
	...
	func_172(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
int func_192(void fParam0, bool bParam1)
{
	int iVar0;
...
void func_194()
{
	...
	switch (iLocal_1978)
	{
		case 0:
			...
			if (ENTITY::DOES_ENTITY_EXIST(joaat("packer")) && ENTITY::DOES_ENTITY_EXIST(joaat("armytrailer")))
			{
				...
				iLocal_248 = 0;
				PATHFIND::SET_ROADS_IN_AREA(289.0847f, -2980.382f, 9.24156f, 320.426f, -2931.6f, 4f, false, true, 1, 1);
				iLocal_257 = 1;
		...
		case 1:
			if (func_222())
			{
				func_221(&uLocal_309, bLocal_49);
				func_221(&uLocal_309, bLocal_50);
				iLocal_261 = -1;
				iLocal_262 = 0;
				iLocal_1978++;
			}
		...
		case 2:
			...
			{
				if ((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || PED::IS_PED_FLEEING(Local_54[6 /*10*/])) || func_10(unk_0x9B0761B4C3EB8BC7(), Local_54[6 /*10*/], 1) > 100f)
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_54[6 /*10*/]);
					func_9(&(Local_54[6 /*10*/]), 1, 0, 1);
				}
			}
			if (func_107(Local_54[7 /*10*/]))
			{
				if ((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || PED::IS_PED_FLEEING(Local_54[7 /*10*/])) || func_10(unk_0x9B0761B4C3EB8BC7(), Local_54[7 /*10*/], 1) > 100f)
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_54[7 /*10*/]);
					func_9(&(Local_54[7 /*10*/]), 1, 0, 1);
				}
			}
			if (func_107(Local_54[4 /*10*/]))
			{
				if ((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || PED::IS_PED_FLEEING(Local_54[4 /*10*/])) || func_10(unk_0x9B0761B4C3EB8BC7(), Local_54[4 /*10*/], 1) > 100f)
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_54[4 /*10*/]);
					func_9(&(Local_54[4 /*10*/]), 1, 0, 1);
				}
			}
			if (func_107(Local_54[5 /*10*/]))
			{
				if ((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || PED::IS_PED_FLEEING(Local_54[5 /*10*/])) || func_10(unk_0x9B0761B4C3EB8BC7(), Local_54[5 /*10*/], 1) > 100f)
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_54[5 /*10*/]);
					func_9(&(Local_54[5 /*10*/]), 1, 0, 1);
				}
			}
			if (func_226(&Local_58, 324.7653f, -2974.495f, -1.5f, 0.1f, 0.1f, 2f, 0, Local_53[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1) || ((SYSTEM::VMAG(Local_58.f_5) && unk_0x1037B9D45CE6B788(Local_53[0 /*2*/], 312.8557f, -2974.003f, 1.19166f, 339.1654f, -2974.348f, -6.70078f, 15f, 0, 1, 0)) && func_218(unk_0x9B0761B4C3EB8BC7(), Local_53[0 /*2*/])))
			{
			...
			else if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) == 0 && SYSTEM::VMAG(Local_58.f_5))
			{
		...
		case 5:
			if (CUTSCENE::HAS_CUTSCENE_LOADED() && ENTITY::DOES_ENTITY_EXIST(joaat("prop_tarp_strap")))
			{
				...
				CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Trevor", unk_0x9B0761B4C3EB8BC7(), 0);
		...
		case 6:
			...
			if (!MISC::IS_BIT_SET(Local_54[3 /*10*/]))
			{
				if (MISC::IS_BIT_SET(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Floyd", 0)))
				{
			...
			else if (!MISC::IS_BIT_SET(Local_57[4 /*2*/]))
			{
				if (MISC::IS_BIT_SET(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("sub_cover", joaat("prop_sub_cover_01"))))
				{
			...
			{
				if (GRAPHICS::DRAW_SCALEFORM_MOVIE() || PED::_HAS_STREAMED_PED_ASSETS_LOADED(Local_54[3 /*10*/]))
				{
					PED::SET_PED_INTO_VEHICLE(Local_54[3 /*10*/], Local_53[2 /*2*/], 0);
					PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), Local_53[2 /*2*/], -1);
					...
					OBJECT::CREATE_OBJECT_NO_OFFSET(Local_57[4 /*2*/], Local_53[1 /*2*/], -1, Local_291, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					Local_57[5 /*2*/] = OBJECT::CREATE_OBJECT(joaat("prop_tarp_strap"), -332.8449f, -2622.157f, 8.7838f, true, true, false);
					OBJECT::CREATE_OBJECT_NO_OFFSET(Local_57[5 /*2*/], Local_53[1 /*2*/], -1, Local_291, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	...
	if (func_107(unk_0x9B0761B4C3EB8BC7()) && func_107(Local_53[0 /*2*/]))
	{
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 324.7653f, -2974.495f, -1f, 1) > 2500f)
		{
			func_93(9);
		}
	}
...
int func_199()
{
	...
	switch (iLocal_275)
	{
		case 0:
			...
			unk_0x03D382CB0B44E2FC(Local_53[0 /*2*/], Local_276, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(Local_53[0 /*2*/], fLocal_277);
			ENTITY::SET_ENTITY_COORDS(Local_53[0 /*2*/], 1);
			...
			if (CLOCK::GET_CLOCK_DAY_OF_MONTH() >= 20 || CLOCK::GET_CLOCK_DAY_OF_MONTH() <= 7)
			{
		...
		case 1:
			Local_287 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_57[8 /*2*/], 1) };
			if (Local_287.f_2 <= 1f)
			{
				ENTITY::SET_ENTITY_COORDS(Local_53[0 /*2*/], 0);
				...
				OBJECT::CREATE_OBJECT_NO_OFFSET(Local_53[0 /*2*/], Local_57[8 /*2*/], -1, 2.47f, 0f, -1.96f, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1);
				iLocal_275++;
			}
			else
			{
		...
		case 3:
			if (fLocal_283 >= 40f)
			{
				...
				fLocal_283 = 80f;
				ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(Local_57[7 /*2*/], 1, 1);
				OBJECT::CREATE_OBJECT_NO_OFFSET(Local_57[7 /*2*/], Local_57[6 /*2*/], -1, Local_282, 0f, 0f, fLocal_283, 0, 0, 0, 0, 2, 1);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(Local_57[8 /*2*/], unk_0x7EC595B99EA7C4B1(Local_57[7 /*2*/], Local_285), false, false, true);
		...
		case 5:
			...
			{
				ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(Local_53[0 /*2*/], 1, 1);
				iLocal_275++;
			}
			else
			{
		...
		case 7:
			...
			{
				ENTITY::SET_ENTITY_COORDS(Local_57[8 /*2*/], 1);
				iLocal_275++;
			}
			else
			{
	...
	else if (PED::REMOVE_SCENARIO_BLOCKING_AREA())
	{
		...
		GRAPHICS::REMOVE_PARTICLE_FX_IN_RANGE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_53[0 /*2*/], 1), 30f);
		iLocal_1982 = 2;
		iLocal_1981 = 1;
	}
	return 0;
...
void func_221(var uParam0, bool bParam1)
{
	...
	if (!CAM::IS_SCREEN_FADED_OUT(bParam1))
	{
		...
		while (iVar0 < uParam0->f_273)
		{
			...
			{
				if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(uParam0->f_273[iVar0 /*5*/].f_4, bParam1))
				{
					if (uParam0->f_273[iVar0 /*5*/].f_1)
					{
						unk_0x1082C25039B168F8(bParam1);
...
int func_222()
{
	if (!MISC::IS_BIT_SET(Local_57[6 /*2*/]))
	{
		...
		ENTITY::SET_ENTITY_COORDS(Local_57[6 /*2*/], 1);
	}
	if (!MISC::IS_BIT_SET(Local_57[7 /*2*/]))
	{
		Local_57[7 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_281, unk_0x7EC595B99EA7C4B1(Local_57[6 /*2*/], Local_282), true, true, false);
	}
	if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_57[7 /*2*/], Local_57[6 /*2*/]))
	{
		OBJECT::CREATE_OBJECT_NO_OFFSET(Local_57[7 /*2*/], Local_57[6 /*2*/], -1, Local_282, 0f, 0f, fLocal_283, 0, 0, 0, 0, 2, 1);
	}
	if (!MISC::IS_BIT_SET(Local_57[8 /*2*/]))
	{
		Local_57[8 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_284, unk_0x7EC595B99EA7C4B1(Local_57[7 /*2*/], Local_285), true, true, false);
		ENTITY::_SET_ENTITY_SOMETHING(Local_57[8 /*2*/], false);
		OBJECT::CREATE_OBJECT_NO_OFFSET(Local_57[8 /*2*/], Local_57[7 /*2*/], -1, Local_285, 0f, 0f, fLocal_286, 0, 0, 0, 0, 2, 1);
		ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(Local_57[8 /*2*/], 1, 0);
		ENTITY::SET_ENTITY_COORDS(Local_57[8 /*2*/], 1);
	}
	if (!iLocal_249)
	{
		...
		{
			iLocal_290 = PHYSICS::ADD_ROPE(unk_0x7EC595B99EA7C4B1(Local_57[7 /*2*/], Local_288), 0f, 0f, 0f, 70f, 0, -1f, 4f, 1.4f, false, false, true, 1f, false, 0);
			...
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(iLocal_290, Local_57[7 /*2*/], Local_57[8 /*2*/], unk_0x7EC595B99EA7C4B1(Local_57[7 /*2*/], Local_288), unk_0x7EC595B99EA7C4B1(Local_57[8 /*2*/], Local_289), 70f, false, false, 0, 0);
			iLocal_249 = 1;
			return 1;
		}
...
int func_226(var uParam0, struct<3> Param1, struct<3> Param2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10, int iParam11)
{
	return func_49(uParam0, Param1, Param2, func_87(), func_87(), iParam3, 5, 0, 0, 0, bParam4, bParam5, func_227(), func_227(), func_227(), func_227(), bParam6, 0, bParam8, bParam7, 0, iParam9, bParam10, iParam11, 0, 0, 0, 1, 1065353216);
}
...
void func_228(var uParam0, bool bParam1)
{
	...
	while (iVar0 < uParam0->f_737)
	{
		...
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(uParam0->f_737[iVar0 /*5*/].f_4, bParam1))
			{
				if (uParam0->f_737[iVar0 /*5*/].f_1)
				{
					AUDIO::RELEASE_NAMED_SCRIPT_AUDIO_BANK(bParam1);
...
void func_229()
{
	...
	switch (iLocal_1978)
	{
		case 0:
			...
			if (func_107(Local_53[0 /*2*/]))
			{
				if (!SYSTEM::VMAG(Local_53[0 /*2*/].f_1))
				{
					Local_53[0 /*2*/].f_1 = func_38(Local_53[0 /*2*/], 0, 0);
				}
				Local_56 = { PHYSICS::GET_CGOFFSET(Local_53[0 /*2*/]) };
			}
			if (MISC::IS_BIT_SET(Local_57[2 /*2*/]) && !SYSTEM::VMAG(iLocal_243))
			{
				iLocal_243 = func_277(Local_57[2 /*2*/]);
			}
			PED::IS_PED_IN_PARACHUTE_FREE_FALL(iLocal_243, "SUBBTN_LABEL");
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
			...
			if (func_107(Local_54[4 /*10*/]))
			{
				PED::_0x2208438012482A1A(Local_54[4 /*10*/], 1);
				TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_54[4 /*10*/], false);
			}
			func_276(&uLocal_309, bLocal_51);
			...
			if (fLocal_1987[0] == -1)
			{
				fLocal_1987[0] = AUDIO::PLAY_SOUND_FROM_COORD();
			}
			if (fLocal_1987[1] == -1)
			{
				fLocal_1987[1] = AUDIO::PLAY_SOUND_FROM_COORD();
			}
			iLocal_1978++;
			break;
		...
		case 1:
			if (iLocal_248)
			{
				...
				func_270();
				if ((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1249.106f, -3007.908f, 10.84327f, 1249.962f, -3007.837f, 8.31909f, 1.68f, 0, 1, 0) && !SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1)) && !func_212(0))
				{
					if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 51))
					{
						...
						{
							TASK::TASK_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), iLocal_246, bLocal_51, "ig_1_stealth_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
						else
						{
							TASK::TASK_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), iLocal_246, bLocal_51, "ig_1_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
						ENTITY::FREEZE_ENTITY_POSITION(unk_0x9B0761B4C3EB8BC7(), false, 0);
						unk_0xD289B55B6AADBA10(1);
						bVar0 = unk_0xC2E2CC6CF95AF8A3(1249.787f, -3008.016f, 8.52751f, 5f, 0, 4);
						if (func_107(bVar0))
						{
							unk_0x03D382CB0B44E2FC(bVar0, 1250.333f, -3010.219f, 8.3191f, 1, 0, 0, 1);
							ENTITY::SET_ENTITY_HEADING(bVar0, 85.8086f);
		...
		case 2:
			if (!PED::DETACH_SYNCHRONIZED_SCENE(iLocal_246) || ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_246) == 1f)
			{
				RECORDING::_0x81CBAE94390F9F89();
				AUDIO::SET_VARIABLE_ON_SOUND(-1, "SUB_RELEASE", 1260.896f, -3006.556f, 23.4213f, "DOCKS_HEIST_PREP_1_SOUNDSET", 0, 0, 0);
			...
			else if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_246) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_246) >= 0.7f)
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(unk_0x9B0761B4C3EB8BC7(), 713668775) != 1)
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(unk_0x9B0761B4C3EB8BC7(), 1252.594f, -3008.883f, 8.3191f, 1f, -1, 0.25f, false, 40000f);
				}
			}
			break;
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - iLocal_301) > 1500)
			{
				...
				if ((MISC::GET_GAME_TIMER() - iLocal_301) > 5000 || PAD::IS_DISABLED_CONTROL_PRESSED(2, 201))
				{
					if (SYSTEM::VMAG(iLocal_243))
					{
						unk_0x93370FA10F15BE44(&iLocal_243);
		...
		case 5:
			Var1 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_53[0 /*2*/], 1) };
			if (ENTITY::GET_ENTITY_SUBMERGED_LEVEL(Local_53[0 /*2*/]) > 0f || Var1.f_2 < -0.5f)
			{
				...
				if (fLocal_1987[0] != -1)
				{
					AUDIO::STOP_SOUND(fLocal_1987[0]);
				}
				if (fLocal_1987[1] != -1)
				{
					AUDIO::STOP_SOUND(fLocal_1987[1]);
				}
			}
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_53[0 /*2*/], 0))
			{
				...
				if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0)
				{
					...
					unk_0x92BD213E6A0E666B(Local_54[6 /*10*/], joaat("weapon_pistol"), -1, 0, 1);
					PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_54[6 /*10*/], 4.624285E-43f, 1);
					PED::SET_PED_AS_COP(Local_54[6 /*10*/], true);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_244);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(false, 1252.876f, -3014.035f, 8.31909f, 2f, 20000, 0.25f, false, 40000f);
					TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_244);
					AUDIO::STOP_SCRIPTED_CONVERSATION(Local_54[6 /*10*/], iLocal_244);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
					Local_54[7 /*10*/] = PED::CREATE_PED(26, joaat("s_m_m_security_01"), 1229.557f, -3002.882f, 8.31909f, -30.33f, true, true);
					PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_54[7 /*10*/], 4.624285E-43f, 1);
					unk_0x92BD213E6A0E666B(Local_54[7 /*10*/], joaat("weapon_pistol"), -1, 0, 1);
					PED::SET_PED_AS_COP(Local_54[7 /*10*/], true);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_244);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(false, 1252.056f, -3006.94f, 8.31909f, 2f, 20000, 0.25f, false, 40000f);
					TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_244);
					AUDIO::STOP_SCRIPTED_CONVERSATION(Local_54[7 /*10*/], iLocal_244);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
				...
				else
				{
					...
					PED::_0x2208438012482A1A(Local_54[5 /*10*/], 1);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_244);
					TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2096, 2);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(false, 1252.876f, -3014.035f, 8.31909f, 2f, 20000, 0.25f, false, 40000f);
					TASK::TASK_PLAY_ANIM(0, bLocal_49, "react_big_variations_g", 1.5f, -1.5f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, bLocal_49, "react_big_variations_i", 1.5f, -1.5f, -1, 0, 0f, false, false, false);
					TASK::TASK_SMART_FLEE_COORD(0, 1252.876f, -3014.035f, 8.31909f, 300f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_244);
					AUDIO::STOP_SCRIPTED_CONVERSATION(Local_54[5 /*10*/], iLocal_244);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
					func_89(&uLocal_309, joaat("s_m_m_security_01"));
				}
				if (func_107(Local_54[4 /*10*/]))
				...
				TASK::OPEN_SEQUENCE_TASK(&iLocal_244);
				TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2096, 2);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(false, 1252.994f, -3004.134f, 9.319f, 2f, 20000, 0.25f, false, 40000f);
				TASK::TASK_PLAY_ANIM(0, bLocal_49, "react_big_variations_f", 8f, -1.5f, -1, 0, 0f, false, false, false);
				TASK::TASK_PLAY_ANIM(0, bLocal_49, "react_big_variations_g", 1.5f, -1.5f, -1, 0, 0f, false, false, false);
				TASK::TASK_PLAY_ANIM(0, bLocal_49, "react_big_variations_h", 1.5f, -1.5f, -1, 0, 0f, false, false, false);
				TASK::TASK_PLAY_ANIM(0, bLocal_49, "react_big_variations_i", 1.5f, -1.5f, -1, 0, 0f, false, false, false);
				TASK::TASK_PLAY_ANIM(0, bLocal_49, "react_big_variations_f", 1.5f, -1.5f, -1, 0, 0f, false, false, false);
				TASK::TASK_SMART_FLEE_COORD(0, 1252.994f, -3004.134f, 9.319f, 300f, -1, false, false);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_244);
				AUDIO::STOP_SCRIPTED_CONVERSATION(Local_54[4 /*10*/], iLocal_244);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
				...
				func_89(&uLocal_309, joaat("prop_sub_release"));
				func_221(&uLocal_309, bLocal_51);
				TASK::REMOVE_WAYPOINT_RECORDING("docksprep1");
				RECORDING::_0x293220DA1B46CEBC(15f, 10f, 4);
				func_195(1);
				iLocal_1978 = 0;
			}
			else if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_53[0 /*2*/], 1), 1) < 5f && !iLocal_253)
			{
	...
	if ((!iLocal_263 && func_107(Local_53[0 /*2*/])) && NETWORK::NETWORK_IS_PLAYER_ACTIVE(Local_53[0 /*2*/]))
	{
		ENTITY::GET_ENTITY_ALPHA(-1, "SUB_SPLASH", Local_53[0 /*2*/], "DOCKS_HEIST_PREP_1_SOUNDSET", 0, 0);
		iLocal_263 = 1;
	}
	if (((!iLocal_248 && MISC::IS_BIT_SET(Local_57[0 /*2*/])) && MISC::IS_BIT_SET(Local_57[1 /*2*/])) && func_107(Local_53[0 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_HAVE_PHYSICS(Local_57[0 /*2*/]) && ENTITY::DOES_ENTITY_HAVE_PHYSICS(Local_57[1 /*2*/]))
		{
			...
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_55[0 /*5*/], Local_57[0 /*2*/], Local_53[0 /*2*/], unk_0x7EC595B99EA7C4B1(Local_57[0 /*2*/], 0f, 0f, 0f), unk_0x7EC595B99EA7C4B1(Local_53[0 /*2*/], 1.8f, 1.02f, 1.11f), fLocal_1983, false, false, 0, 0);
			...
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_55[1 /*5*/], Local_57[0 /*2*/], Local_53[0 /*2*/], unk_0x7EC595B99EA7C4B1(Local_57[0 /*2*/], 0f, 0f, 0f), unk_0x7EC595B99EA7C4B1(Local_53[0 /*2*/], -1.8f, 1.02f, 1.11f), fLocal_1983, false, false, 0, 0);
			...
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_55[2 /*5*/], Local_57[1 /*2*/], Local_53[0 /*2*/], unk_0x7EC595B99EA7C4B1(Local_57[1 /*2*/], 0f, 0f, 0f), unk_0x7EC595B99EA7C4B1(Local_53[0 /*2*/], 1.8f, -3.07f, 1.11f), fLocal_1983, false, false, 0, 0);
			...
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_55[3 /*5*/], Local_57[1 /*2*/], Local_53[0 /*2*/], unk_0x7EC595B99EA7C4B1(Local_57[1 /*2*/], 0f, 0f, 0f), unk_0x7EC595B99EA7C4B1(Local_53[0 /*2*/], -1.8f, -3.07f, 1.11f), fLocal_1983, false, false, 0, 0);
			iLocal_248 = 1;
			iLocal_250 = 0;
			PHYSICS::ACTIVATE_PHYSICS(Local_53[0 /*2*/]);
	...
	if (!iLocal_251)
	{
		if (MISC::IS_BIT_SET(Local_57[3 /*2*/]))
		{
			if (ENTITY::DOES_ENTITY_HAVE_PHYSICS(Local_57[3 /*2*/]))
			{
				OBJECT::CREATE_OBJECT_NO_OFFSET(Local_57[3 /*2*/], Local_54[4 /*10*/], ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_54[4 /*10*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				iLocal_251 = 1;
			}
		}
	}
	if (MISC::IS_BIT_SET(Local_57[3 /*2*/]) && ((func_107(Local_54[4 /*10*/]) && PED::IS_PED_FLEEING(Local_54[4 /*10*/])) || !func_107(Local_54[4 /*10*/])))
	{
		if (func_107(Local_54[4 /*10*/]) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_54[4 /*10*/], bLocal_50, "cellphone_call_listen_c", 3))
		{
			TASK::STOP_ANIM_TASK(Local_54[4 /*10*/], bLocal_50, "cellphone_call_listen_c", -8f);
		}
		if (AUDIO::PLAY_SOUND_FROM_ENTITY(Local_57[3 /*2*/]))
		{
			ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(Local_57[3 /*2*/], 1, 1);
		}
	}
	if (func_24() == 2)
	{
...
void func_230(struct<3> Param0, bool bParam1, int iParam2, int iParam3)
{
	struct<3> Var0;
	var uVar1;
	...
	if (MISC::IS_BIT_SET(Global_102423.f_4))
	{
		if (ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, false))
		{
			if (func_260(24) != Global_102423.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_257(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Global_102423.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						bParam1 = uVar1;
					}
				}
				func_231(Global_102423.f_4, Param0, bParam1, 24, 0);
			}
		}
	}
}

void func_231(bool bParam0, struct<3> Param1, bool bParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (MISC::IS_BIT_SET(bParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		func_250(iParam3, &Var0, Param1, bParam2, func_117(bParam0));
		func_232(iParam3, bParam0, 0);
	}
}
...
void func_233(bool bParam0, int iParam1)
{
	...
	func_121(bParam0, &(Global_111858.f_32745.f_5510));
}

int func_234(bool bParam0)
{
	if ((((((((((!MISC::IS_BIT_SET(bParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_127(bParam0, 0, 0)) || func_127(bParam0, 1, 0)) || func_127(bParam0, 2, 0)) || func_117(bParam0) != 145) || func_248(bParam0)) || func_247(bParam0)) || func_246(bParam0)) || func_245(bParam0)) || !func_235(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_247(bParam0))
		{
		}
...
int func_235(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_236(fParam0, 0))
	{
		return 0;
	}
...
int func_236(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
void func_250(int iParam0, var uParam1, struct<3> Param2, bool bParam3, int iParam4)
{
	if (func_249(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
void func_270()
{
	...
	if (bVar1)
	{
		if (((((!PHYSICS::_0x84DE3B5FB3E666F0(&(Local_55[0 /*5*/])) && !PHYSICS::_0x84DE3B5FB3E666F0(&(Local_55[1 /*5*/]))) && (!Local_55[0 /*5*/].f_4 || !Local_55[1 /*5*/].f_4)) || ((!PHYSICS::_0x84DE3B5FB3E666F0(&(Local_55[2 /*5*/])) && !PHYSICS::_0x84DE3B5FB3E666F0(&(Local_55[3 /*5*/]))) && (!Local_55[2 /*5*/].f_4 || !Local_55[3 /*5*/].f_4))) || iVar0 == 3) && iVar0 < 4)
		{
			if (iLocal_1988 > 0)
			{
				if (fLocal_1987[(iLocal_1988 - 1)] != -1)
				{
					AUDIO::STOP_SOUND(fLocal_1987[(iLocal_1988 - 1)]);
				}
			}
			if (fLocal_1987[iLocal_1988] != -1)
			{
				AUDIO::SET_VARIABLE_ON_SOUND(fLocal_1987[iLocal_1988], "DOCKS_HEIST_PREP_1_SUB_SWING", 1260.896f, -3006.556f, 23.4213f, 0, 0, 0, 0);
				iLocal_1988++;
			}
		}
		else if (iVar0 <= 2)
		{
			AUDIO::SET_VARIABLE_ON_SOUND(-1, "DOCKS_HEIST_PREP_1_SUB_TILT", 1260.896f, -3006.556f, 23.4213f, 0, 0, 0, 0);
		}
		iLocal_247 = 0;
		while (iLocal_247 < Local_55)
		{
			if (!PHYSICS::_0x84DE3B5FB3E666F0(&(Local_55[iLocal_247 /*5*/])))
			{
				if (!Local_55[iLocal_247 /*5*/].f_4)
				{
					AUDIO::SET_VARIABLE_ON_SOUND(-1, "DOCKS_HEIST_PREP_1_CABLE_SNAP", 1260.896f, -3006.556f, 23.4213f, 0, 0, 0, 0);
				}
...
int func_275(var uParam0, bool bParam1)
{
	...
	if (iVar1 >= 0)
	{
		AUDIO::REQUEST_SCRIPT_AUDIO_BANK(bParam1, false, -1);
...
int func_276(var uParam0, bool bParam1)
{
	...
	if (iVar1 >= 0)
	{
		STREAMING::REQUEST_ANIM_DICT(bParam1);
...
void func_278()
{
	...
	{
		if (MISC::IS_BIT_SET(Local_54[iLocal_247 /*10*/]))
		{
			if (Local_54[iLocal_247 /*10*/] != Local_54[3 /*10*/])
			{
				...
				else if (SYSTEM::VMAG(Local_54[iLocal_247 /*10*/].f_2))
				{
					unk_0x93370FA10F15BE44(&(Local_54[iLocal_247 /*10*/].f_2));
				}
			}
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Local_54[iLocal_247 /*10*/]))
			{
				if (Local_54[iLocal_247 /*10*/] == Local_54[3 /*10*/])
				{
					func_93(7);
	...
	{
		if (MISC::IS_BIT_SET(Local_53[iLocal_247 /*2*/]))
		{
			if (!ENTITY::GET_ENTITY_COORDS(Local_53[iLocal_247 /*2*/], false))
			{
	...
	{
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_53[0 /*2*/], 1), 1) > 750f)
		{
			func_93(10);
		}
		else if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_53[0 /*2*/], 1), 1) > 700f)
		{
	...
	{
		HUD::SET_RADAR_AS_INTERIOR_THIS_FRAME(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("V_FakeBoatPO1SH2A"), 1240f, -2970f, 0, 0);
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
		{
		...
		if ((!ENTITY::IS_ENTITY_IN_AIR(bVar0) && !NETWORK::NETWORK_IS_PLAYER_ACTIVE(bVar0)) && (!MISC::IS_BIT_SET(Local_53[0 /*2*/]) || !ENTITY::IS_ENTITY_TOUCHING_ENTITY(bVar0, Local_53[0 /*2*/])))
		{
			if (!iLocal_256)
			{
				func_279(593);
	...
	switch (iLocal_264)
	{
		case 0:
			if (func_107(Local_54[4 /*10*/]))
			{
				if (iLocal_269)
				{
					TASK::TASK_PLAY_ANIM(Local_54[4 /*10*/], bLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0f, false, false, false);
		...
		case 1:
			if (!iLocal_269)
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_268) > 2000 || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_54[4 /*10*/], 1), 1) < 10f)
				{
					iLocal_269 = 1;
					iLocal_264 = 0;
				}
			...
			if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0))
			{
				if (func_107(Local_54[4 /*10*/]))
				{
					if (PED::CAN_PED_SEE_HATED_PED(Local_54[4 /*10*/], unk_0x9B0761B4C3EB8BC7()))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_54[4 /*10*/]);
					...
					else if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_54[4 /*10*/], 1), 1) < 12f && PLAYER::GET_PLAYER_CURRENT_STEALTH_NOISE(PLAYER::PLAYER_ID()) > 8.5f)
					{
						AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_54[4 /*10*/]);
						if (!func_283(Local_54[4 /*10*/], 1464580341, 1))
						{
							TASK::TASK_TURN_PED_TO_FACE_COORD(Local_54[4 /*10*/], NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 4000);
							TASK::TASK_PLAY_ANIM(Local_54[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 4f, -8f, -1, 49, 0f, false, false, false);
						}
					}
					else if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_54[4 /*10*/], 1), 1) < 12f && SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						if (!func_283(Local_54[4 /*10*/], 1464580341, 1))
						{
							TASK::TASK_TURN_PED_TO_FACE_COORD(Local_54[4 /*10*/], NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 4000);
					...
					else if (((WEAPON::IS_FLASH_LIGHT_ON(unk_0x9B0761B4C3EB8BC7()) && (CLOCK::GET_CLOCK_DAY_OF_MONTH() >= 19 || CLOCK::GET_CLOCK_DAY_OF_MONTH() < 6)) && func_10(unk_0x9B0761B4C3EB8BC7(), Local_54[4 /*10*/], 1) < 25f) && (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_54[4 /*10*/]) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_54[4 /*10*/])))
					{
						if (!func_283(Local_54[4 /*10*/], 1464580341, 1))
						{
							TASK::TASK_TURN_PED_TO_FACE_COORD(Local_54[4 /*10*/], NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 4000);
			...
			if (func_107(Local_54[4 /*10*/]))
			{
				if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_54[4 /*10*/]))
				{
					if (iLocal_269)
					{
						...
						{
							if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_54[4 /*10*/], bLocal_50, "cellphone_call_listen_c", 3))
							{
								TASK::TASK_PLAY_ANIM(Local_54[4 /*10*/], bLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0f, false, false, false);
							}
							if (unk_0xC2169C00B643278B(Local_54[4 /*10*/], 1228.056f, -3000.427f, 8.4424f, 2f, 2f, 2f, 0, 1, 0))
							{
								if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("docksprep1"))
								{
				...
				else
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_272) > 10000)
					{
						...
						{
							if (unk_0xC2169C00B643278B(Local_54[4 /*10*/], 1251.625f, -3003.338f, 8.31909f, 2f, 2f, 2f, 0, 1, 0))
							{
								TASK::WAYPOINT_PLAYBACK_PAUSE(Local_54[4 /*10*/], false, false);
							}
							else if (unk_0xC2169C00B643278B(Local_54[4 /*10*/], 1228.849f, -2986.284f, 8.31909f, 2f, 2f, 2f, 0, 1, 0))
							{
								TASK::WAYPOINT_PLAYBACK_PAUSE(Local_54[4 /*10*/], false, false);
							}
						}
				...
				if (((PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 124) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 125)) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 126)) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 118))
				{
					...
					TASK::TASK_HANDS_UP(Local_54[4 /*10*/], -1, unk_0x9B0761B4C3EB8BC7(), -1, true);
				}
				...
				else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_54[4 /*10*/], unk_0x9B0761B4C3EB8BC7(), true))
				{
					AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_54[4 /*10*/]);
					TASK::TASK_PLAY_ANIM(Local_54[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0f, false, false, false);
					func_224(&uLocal_78, 3, Local_54[4 /*10*/], "CONSTRUCTION2", 0, 1);
		...
		case 2:
			if (func_107(Local_54[4 /*10*/]))
			{
				if (!PED::IS_PED_HEADTRACKING_PED(Local_54[4 /*10*/], unk_0x9B0761B4C3EB8BC7()))
				{
					TASK::TASK_LOOK_AT_ENTITY(Local_54[4 /*10*/], unk_0x9B0761B4C3EB8BC7(), -1, 3104, 2);
				}
			}
			switch (iLocal_265)
			{
				case 0:
					if (func_107(Local_54[4 /*10*/]))
					{
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_244);
							TASK::TASK_GO_TO_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, 4f, 2f, 2f, 0);
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_244);
							AUDIO::STOP_SCRIPTED_CONVERSATION(Local_54[4 /*10*/], iLocal_244);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_244);
			...
			if (!unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || !func_107(Local_54[4 /*10*/]))
			{
				iLocal_264 = 0;
			}
			MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(unk_0x9B0761B4C3EB8BC7(), &iLocal_271, 1);
			if (func_107(Local_54[4 /*10*/]))
			{
				...
				{
					if (WEAPON::GET_AMMO_IN_PED_WEAPON(iLocal_271) != joaat("GROUP_MELEE") && iLocal_271 != joaat("weapon_unarmed"))
					{
						func_224(&uLocal_78, 3, Local_54[4 /*10*/], "CONSTRUCTION2", 0, 1);
						iLocal_264 = 3;
						iLocal_266 = 1;
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_54[4 /*10*/]);
						TASK::TASK_HANDS_UP(Local_54[4 /*10*/], -1, unk_0x9B0761B4C3EB8BC7(), -1, false);
					}
				}
				else if (PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 23))
				{
		...
		case 3:
			switch (iLocal_266)
			{
				...
				case 3:
					if (func_107(Local_54[4 /*10*/]))
					{
						if (unk_0xC2169C00B643278B(Local_54[4 /*10*/], 1252.558f, -3004.846f, 8.31909f, 2f, 2f, 2f, 0, 1, 0))
						{
				...
				case 4:
					if (func_107(Local_54[4 /*10*/]))
					{
						if (!MISC::IS_PC_VERSION(Local_54[4 /*10*/]) && !TASK::IS_PED_GETTING_UP(Local_54[4 /*10*/]))
						{
							if (func_12(&uLocal_78, "SOL1AUD", "SOL1_COPSIN2", 7, 0, 0, 0))
							{
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_54[4 /*10*/]);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_244);
								TASK::TASK_PLAY_ANIM(0, bLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0f, false, false, false);
								if (iLocal_270)
								{
									TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(false, 1228.775f, -2923.852f, 8.31909f, 2f, 20000, 0.25f, false, 40000f);
									TASK::TASK_SMART_FLEE_PED(0, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
								}
								else
								{
									TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(false, 1228.775f, -2923.852f, 8.31909f, 1f, 20000, 0.25f, false, 40000f);
					...
					if ((MISC::GET_GAME_TIMER() - iLocal_267) > 8000)
					{
						...
						if (func_107(Local_54[4 /*10*/]))
						{
							if (iLocal_270)
							{
								...
								{
									TASK::TASK_SMART_FLEE_PED(Local_54[4 /*10*/], unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
								}
							}
						...
						if (func_107(Local_54[4 /*10*/]))
						{
							if ((PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 124) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 125)) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 126))
							{
								...
								if (func_12(&uLocal_78, "SOL1AUD", "SOL1_ARM2", 7, 0, 0, 0))
								{
									HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_54[4 /*10*/]);
									TASK::OPEN_SEQUENCE_TASK(&iLocal_244);
									TASK::TASK_HANDS_UP(0, 3000, unk_0x9B0761B4C3EB8BC7(), -1, false);
									TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(false, 1228.775f, -2923.852f, 8.31909f, 2f, 20000, 0.25f, false, 40000f);
									TASK::TASK_SMART_FLEE_PED(0, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_244);
									AUDIO::STOP_SCRIPTED_CONVERSATION(Local_54[4 /*10*/], iLocal_244);
							...
							else if ((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_54[4 /*10*/]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_54[4 /*10*/])) && PED::IS_PED_FACING_PED(Local_54[4 /*10*/], unk_0x9B0761B4C3EB8BC7(), 160f))
							{
								if (WEAPON::GET_AMMO_IN_PED_WEAPON(iLocal_271) != joaat("GROUP_MELEE") && iLocal_271 != joaat("weapon_unarmed"))
								{
...
void func_284()
{
	switch (iLocal_308)
	{
		case 0:
			switch (iLocal_307)
			{
				case 0:
					if (func_107(Local_53[0 /*2*/]))
					{
						if ((!HUD::IS_MESSAGE_BEING_DISPLAYED() && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_53[0 /*2*/], 0)) && AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) == 0)
						{
							func_289();
							iLocal_305 = MISC::GET_GAME_TIMER();
							iLocal_307 = 1;
				...
				case 1:
					if ((MISC::GET_GAME_TIMER() - iLocal_305) > 6000 && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_53[0 /*2*/], 0))
					{
						func_224(&uLocal_78, 1, 0, "FLOYD", 0, 1);
		...
		case 2:
			...
			{
				case 0:
					if ((!HUD::IS_MESSAGE_BEING_DISPLAYED() && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_53[0 /*2*/], 0)) && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 324.7653f, -2974.495f, -1f, 1) < 110f)
					{
						func_289();
						iLocal_307 = 1;
					}
		...
		case 4:
			if (func_107(Local_53[2 /*2*/]) && func_107(Local_54[3 /*10*/]))
			{
				...
				{
					case 0:
						if (((SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && unk_0xE0B3BC41DDA88DF0(Local_54[3 /*10*/], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_53[1 /*2*/], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0))) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							func_289();
							iLocal_305 = MISC::GET_GAME_TIMER();
							iLocal_307 = 1;
					...
					case 2:
						if (func_11())
						{
							if ((SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && unk_0xE0B3BC41DDA88DF0(Local_54[3 /*10*/], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_53[1 /*2*/], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
							{
								if (func_37())
								{
									func_288(0);
				...
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_53[0 /*2*/], 1), -323.73f, -2613.702f, 5f, 1) < 60f)
				{
					func_287();
					iLocal_307 = 3;
				}
		...
		case 5:
			...
			{
				case 0:
					if ((((SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && unk_0xE0B3BC41DDA88DF0(Local_54[3 /*10*/], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_53[1 /*2*/], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0))) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -273.635f, -2558.818f, 4.751376f, -405.7218f, -2695.898f, 14.37495f, 51f, 0, 1, 0))
					{
						func_289();
						iLocal_307 = 1;
					}
		...
		case 6:
			...
			{
				case 0:
					if ((((SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && unk_0xE0B3BC41DDA88DF0(Local_54[3 /*10*/], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_53[1 /*2*/], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0))) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_53[0 /*2*/], 1), -323.73f, -2613.702f, 5f, 1) < 40f)
					{
						func_289();
						iLocal_307 = 1;
					}
...
int func_293(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
int func_300(int* iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	int iVar0;
	...
	if (!func_26(iParam1))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			...
			{
				*iParam0 = PED::CREATE_PED_INSIDE_VEHICLE(bParam2, 26, iVar0, iParam3, false, false);
...
void func_303()
{
	if (!MISC::IS_BIT_SET(Local_53[0 /*2*/]))
	{
	...
	{
		ENTITY::SET_ENTITY_COORDS(unk_0x9B0761B4C3EB8BC7(), 0);
		PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), Local_53[0 /*2*/], -1);
	}
	MISC::CLEAR_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 100f, true, false, false, false);
	iLocal_308 = 0;
	iLocal_307 = 0;
...
void func_304()
{
	...
	if (!MISC::IS_BIT_SET(Local_54[4 /*10*/]))
	{
...
void func_312()
{
	...
	while (iLocal_247 <= (8 - 1))
	{
		...
		if (MISC::IS_BIT_SET(Local_54[iLocal_247 /*10*/]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Local_54[iLocal_247 /*10*/]))
		{
			if (SYSTEM::VDIST(Local_54[iLocal_247 /*10*/], 0))
			{
				PED::SET_PED_COORDS_NO_GANG(Local_54[iLocal_247 /*10*/], NETWORK::NETWORK_ARE_HANDLES_THE_SAME(ENTITY::GET_ENTITY_MODEL(Local_54[iLocal_247 /*10*/], 0), 1) + Vector(0f, -2f, 0f));
			}
	...
	{
		if (MISC::IS_BIT_SET(Local_57[iLocal_247 /*2*/]))
		{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(unk_0x9B0761B4C3EB8BC7());
		MISC::CLEAR_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 300f, true, false, false, false);
	}
...
void func_322(var uParam0)
{
	...
	if (NETWORK::_0xC87E740D9F3872CC())
	{
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			...
			while (iVar0 < *uParam0)
			{
				if (!CAM::IS_SCREEN_FADED_OUT(uParam0[iVar0 /*82*/]))
				{
					iVar1 = 0;
					while (iVar1 < 12)
					{
...
void func_325()
{
	...
	if (!MISC::IS_BIT_SET(Local_54[4 /*10*/]))
	{
		if (MISC::IS_BIT_SET(Global_95452.f_9[0]))
		{
			...
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_54[4 /*10*/], iLocal_260);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_54[4 /*10*/], 2.914701E-43f, 1);
			PED::SET_PED_VISUAL_FIELD_CENTER_ANGLE(Local_54[4 /*10*/], 45f);
			PED::SET_PED_VISUAL_FIELD_MAX_ANGLE(Local_54[4 /*10*/], 50f);
			PED::SET_PED_VISUAL_FIELD_MIN_ANGLE(Local_54[4 /*10*/], -50f);
		}
	...
	if (!MISC::IS_BIT_SET(Local_57[2 /*2*/]))
	{
		if (MISC::IS_BIT_SET(Global_95452.f_28[2]))
		{
	...
	if (!MISC::IS_BIT_SET(Local_57[3 /*2*/]))
	{
		if (MISC::IS_BIT_SET(Global_95452.f_28[3]))
		{
	...
	HUD::HAS_ADDITIONAL_TEXT_LOADED("DOCKP1", 0);
...
void func_330()
{
	...
	if (func_107(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_107(Local_53[0 /*2*/]))
		{
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_53[0 /*2*/], 0))
			{
				PED::SET_PED_COORDS_NO_GANG(unk_0x9B0761B4C3EB8BC7(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_53[0 /*2*/], 1) + Vector(2f, 0f, 0f));
			}
		}
	}
	func_208();
	...
	while (iLocal_247 <= (8 - 1))
	{
		...
		{
			func_320(&(Local_54[iLocal_247 /*10*/].f_2));
			if (SYSTEM::VMAG(Local_54[iLocal_247 /*10*/].f_1))
			{
	...
	while (iLocal_247 <= (4 - 1))
	{
		if (SYSTEM::VMAG(Local_53[iLocal_247 /*2*/].f_1))
		{
