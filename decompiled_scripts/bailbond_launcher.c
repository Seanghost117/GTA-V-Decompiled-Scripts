					...
					if (!func_247())
					{
						if (func_225(4, 62, 2, -1, 0))
						{
							if (func_222(Local_43.f_4, Local_43.f_5))
							{
								...
								VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), 9);
					...
					else if (func_247())
					{
						if (func_155(0))
						{
							if (func_149(&(Local_43.f_6)))
							{
								...
								if (!func_146())
								{
									func_76(TASK::IS_PED_BEING_ARRESTED(), 1);
								}
						...
						else
						{
							if (unk_0xCE990E643CD9D0E5(Global_111858.f_24982, 8))
							{
								VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), 8);
							}
							SYSTEM::WAIT(2000);
						}
					}
...
void func_6(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_7(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, false, 2, AUDIO::ADD_LINE_TO_CONVERSATION(func_8(iParam1)), 0));
		}
		else
		{
			func_7(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, AUDIO::ADD_LINE_TO_CONVERSATION(func_8(iParam1)), 0));
		}
		switch (Global_19681)
		{
			case 0:
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			else
			{
				func_72(1);
				iVar0 = 4;
				VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), func_71(Local_43.f_4));
...
int func_35()
{
	...
	while (bVar0 <= (4 - 1))
	{
		if (!unk_0xCE990E643CD9D0E5(Global_111858.f_24982, bVar0))
		{
			return bVar0;
		}
		bVar0++;
...
void func_81(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	else if (MISC::IS_BIT_SET(iVar0))
	{
		...
		{
			if (VEHICLE::IS_VEHICLE_MODEL(iVar0, joaat("skylift")) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iVar0, 0))
			{
				func_82(uParam0, uParam1, iVar0, iParam4);
			}
		}
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || MISC::GET_MODEL_DIMENSIONS(iParam0) == func_88(iParam1, iParam2))
					{
						return 1;
					}
				}
...
int func_95(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (MISC::IS_BIT_SET(iParam0))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
		{
			...
			{
				*uParam1 = ENTITY::GET_ENTITY_MODEL(iParam0, 1);
			}
			if (MISC::IS_BIT_SET(*uParam1))
			{
				if (ENTITY::GET_ENTITY_COORDS(*uParam1, false))
				{
					if (iParam2 == 0 || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*uParam1, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1), 1) < 100f)
					{
						if (VEHICLE::IS_VEHICLE_MODEL(*uParam1, joaat("taxi")))
						{
							if (MISC::IS_MINIGAME_IN_PROGRESS(*uParam1, -1, 0) != iParam0 && MISC::IS_MINIGAME_IN_PROGRESS(*uParam1, -1, 0) != 0)
							{
								return 0;
							}
						}
						if (func_96(*uParam1, func_192(), 1))
						{
							...
							else if (!SYSTEM::VDIST(iParam0, 1))
							{
								return 0;
							}
						}
...
void func_110(int iParam0, bool bParam1)
{
	...
	iVar0 = func_98(iParam0);
	if (func_90(iVar0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		if (iParam0 == unk_0x9B0761B4C3EB8BC7())
		{
...
int func_122(var uParam0)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_145())
		{
			*uParam0 = func_128(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_124(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (MISC::SET_BIT())
	{
		if (func_126() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_102(func_125(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
int func_128(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam1 == 6 || iParam1 == func_144(iVar0))
		{
			...
			{
				fVar1 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Param0, func_129(iVar0, 0), 1);
...
void func_147(int iParam0)
{
	...
	iLocal_213 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&Var0, &Local_43, 8, 37500);
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 4:
						if (((((func_158() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_163(8, -1)) || func_157()) || func_161()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_158()) || func_162()) || Global_110905) || Global_30970) || func_164()) || Global_42801) || func_163(8, -1)) || func_156()) || func_161()) || func_157()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_170(bool bParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
void func_173(var uParam0, var uParam1)
{
	if (!uParam0->f_7)
	{
		if (func_31(26, func_32(uParam0->f_4), 0))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				if ((!func_191() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(unk_0x9B0761B4C3EB8BC7())) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
...
int func_201()
{
	...
	func_196(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_197(&uVar0, CLOCK::GET_CLOCK_YEAR());
	func_195(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
void func_206(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_208() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_208() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_207(bParam0));
...
var func_210(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
bool func_212(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_208() /*10931*/].f_6175.f_10, bParam0);
}
...
int func_225(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_90(iVar4))
	{
		PED::GET_PED_NEARBY_PEDS(unk_0x9B0761B4C3EB8BC7(), &uVar5, -1);
		switch (iParam1)
		{
			case 4:
				switch (iVar4)
		...
		while (iVar7 < 2)
		{
			if (iVar6[iVar7] != 0)
			{
				...
				while (iVar8 < 16)
				{
					...
					{
						if (MISC::GET_MODEL_DIMENSIONS(uVar5[iVar8]) == iVar6[iVar7])
						{
							if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uVar5[iVar8], 0))
							{
								if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
								{
									if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar5[iVar8], 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < 6400f)
									{
										return 0;
									}
								}
				...
				if (MISC::IS_BIT_SET(iVar9))
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iVar9, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < 6400f)
						{
							return 0;
						}
					}
...
int func_227(int iParam0, int iParam1, float fParam2)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0, 0))
	{
		...
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1), Var0, 1) < fVar1)
		{
			return 1;
		}
		else if (Var0.f_4 != -1)
		...
		switch (iLocal_219)
		{
			...
			case 2:
				...
				if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_214))
				{
					...
					MISC::UPDATE_ONSCREEN_KEYBOARD("BBS_MP");
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
					MISC::UPDATE_ONSCREEN_KEYBOARD(sVar0);
					HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(sLocal_218);
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
			...
			case 3:
				if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_214))
				{
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING(iLocal_214, 255, 255, 255, 255, 0);
...
void func_253()
{
	if (Global_111858.f_24982.f_1 == 0)
	{
		...
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), false);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), true);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), 2);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), 3);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), 4);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), 5);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), 6);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), 7);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), 8);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24982), 9);
			iLocal_212 = func_201();
