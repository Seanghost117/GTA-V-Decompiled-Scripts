...
int func_12()
{
	if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_271[0], 0))
	{
		return 1;
	}
	if (func_267(uLocal_300, 8192))
	{
		...
		if (unk_0xC2169C00B643278B(iLocal_271[0], 96.8033f, -1287.597f, 28.2688f, 5f, 5f, 2f, 0, 1, 1) || func_25(unk_0x9B0761B4C3EB8BC7(), 96.8033f, -1287.597f, 28.2688f, 1) > 100f)
		{
...
float func_25(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_26()
{
	...
	ENTITY::SET_ENTITY_COORDS(iLocal_271[0], 0);
	PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_271[0], 1.45735E-43f, 1);
	...
	AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_271[0], iVar0);
...
void func_38(bool bParam0)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (SYSTEM::VDIST(iLocal_271[0], 0))
		{
			bVar2 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
			if (MISC::IS_BIT_SET(bVar2) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar2, 0))
			{
				if (iLocal_305)
				{
...
int func_47()
{
	if ((NETWORK::NETWORK_SESSION_IS_IN_VOICE_SESSION() && VEHICLE::IS_THIS_MODEL_A_BIKE()) && func_48())
	{
		return 1;
	}
	return 0;
...
var func_56(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
void func_58()
{
	if (MISC::IS_BIT_SET(iLocal_271[0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_271[0], 0))
	{
...
int func_59(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_61(struct<3> Param0)
{
	...
	if (SYSTEM::VMAG(fLocal_277))
	{
		unk_0x93370FA10F15BE44(&fLocal_277);
	}
	if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		return;
	...
	if (MISC::IS_BIT_SET(iVar0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar0, 0))
	{
		if (SYSTEM::VDIST(iLocal_271[0], 0))
		{
			if (unk_0xE0B3BC41DDA88DF0(iLocal_271[0], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0))
			{
				if (!SYSTEM::VMAG(fLocal_276))
				{
					fLocal_276 = func_62(Param0, 1);
				}
			}
		}
	}
...
void func_65()
{
	if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_271[0]))
	{
		if (!MISC::IS_BIT_SET(iLocal_271[0]))
		{
		}
		else if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_271[0], 0))
		{
		}
		func_66(0);
	}
...
void func_68(char* sParam0, var uParam1)
{
...
void func_69(char* sParam0, var uParam1, int iParam2)
{
	unk_0x17751E107423AFE9(sParam0);
	HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(uParam1);
...
void func_86()
{
	...
	if (SYSTEM::VMAG(fLocal_276))
	{
		unk_0x93370FA10F15BE44(&fLocal_276);
	}
	func_87();
}
...
void func_87()
{
	...
	while (iVar0 < 1)
	{
		if (SYSTEM::VMAG(uLocal_278[iVar0]))
		{
...
void func_90()
{
	...
	switch (iLocal_77)
	{
		case 0:
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				if (SYSTEM::VDIST(iLocal_271[0], 0))
				{
					...
					if (func_105() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7()) == 0f)
					{
		...
		case 2:
			...
			{
				func_256();
				if (CLOCK::GET_CLOCK_DAY_OF_MONTH() > 20 || CLOCK::GET_CLOCK_DAY_OF_MONTH() < 4)
				{
					bLocal_303 = false;
				}
				CAM::SET_FOLLOW_PED_CAM_VIEW_MODE(fLocal_45);
				func_91(bLocal_303);
				iLocal_72 = 4;
			}
			break;
...
void func_94(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	fLocal_45 = STATS::_PLAYSTATS_ARENA_WARS_ENDED();
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1) && func_99(0, 1))
	{
		if (fLocal_45 != 4)
		{
...
char* func_100(bool bParam0, bool bParam1, int iParam2)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0, 0))
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(iVar0, false))
		{
			...
			else if (MISC::GET_MODEL_DIMENSIONS(iVar0) == joaat("vstr"))
			{
...
int func_105()
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		PED::GET_CLOSEST_PED(Var3, fVar4, true, true, &bVar0, false, false, -1);
		if (!bVar0 == 0)
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar0, 0))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bVar0, unk_0x9B0761B4C3EB8BC7(), 17))
				{
					return 0;
				}
			}
		...
		else
		{
			...
			if (!iVar1 == 0)
			{
				if (!iVar1 == iVar2)
				{
					...
					{
						bVar0 = MISC::IS_MINIGAME_IN_PROGRESS(iVar1, -1, 0);
						if (!bVar0 == 0)
						{
							return 0;
						}
		...
		fVar9 = MONEY::NETWORK_SPENT_REQUEST_HEIST(unk_0x9B0761B4C3EB8BC7());
		if (!fVar9 == 0)
		{
			return 0;
		}
...
void func_108()
{
	...
	if (!bLocal_69 && iLocal_73 >= 5)
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(iVar0, false) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iVar0, 0))
		{
			if (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("blimp2"))
			{
				bLocal_69 = false;
			}
	...
	switch (iLocal_73)
	{
		case 0:
			...
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				bLocal_307 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
				func_205(unk_0x9B0761B4C3EB8BC7(), bLocal_307);
				iLocal_73 = 1;
			}
			else
			{
		...
		case 1:
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_307, 0))
			{
				if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_307, 1), Local_287) < 2f)
				{
					func_58();
					func_203(unk_0x9B0761B4C3EB8BC7(), Local_285);
					func_203(iLocal_271[0], Local_286);
		...
		case 2:
			if (!CAM::IS_CAM_RENDERING(iLocal_279[0]))
			{
				...
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_307, 0))
				{
					if (MISC::GET_MODEL_DIMENSIONS(bLocal_307) == joaat("blimp2"))
					{
						ENTITY::SET_ENTITY_VISIBLE(bLocal_307, false, false);
					}
				}
				func_8(&iLocal_252);
				iLocal_73 = 3;
		...
		case 4:
			if (!CAM::IS_CAM_INTERPOLATING(iLocal_279[1]) && CAM::IS_CAM_RENDERING(iLocal_279[1]))
			{
				...
				{
					if (MISC::IS_BIT_SET(bLocal_307) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_307, 0))
					{
						VEHICLE::SET_VEHICLE_DOORS_SHUT(bLocal_307, true);
					}
					func_196(unk_0x9B0761B4C3EB8BC7(), func_198());
					ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), func_195());
					func_172();
			...
			if (func_200(&iLocal_252) > 1f)
			{
				if (func_145(iLocal_297, 0, sLocal_273, "", &Local_280, (func_200(&iLocal_252) * 0.2f), 0))
				{
					if (!func_171())
					{
						...
						TASK::SET_PED_PATH_AVOID_FIRE(unk_0x9B0761B4C3EB8BC7(), false);
						func_8(&iLocal_252);
						iLocal_73 = 6;
					}
				}
		...
		case 8:
			...
			if (func_200(&iLocal_252) > 6f)
			{
				...
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_307, 0))
				{
					if (MISC::GET_MODEL_DIMENSIONS(bLocal_307) == joaat("blimp2"))
					{
						ENTITY::SET_ENTITY_VISIBLE(bLocal_307, true, false);
					}
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_307, true, true);
					VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bLocal_307, 1000f);
					VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(bLocal_307, 1000f);
					VEHICLE::SET_VEHICLE_FIXED(bLocal_307);
				}
				func_8(&iLocal_252);
				iLocal_73 = 10;
			}
		...
		case 13:
			...
			{
				func_13(1, 1, 0);
				CAM::IS_AIM_CAM_ACTIVE(unk_0x9B0761B4C3EB8BC7(), PED::GET_PED_MAX_HEALTH(unk_0x9B0761B4C3EB8BC7()), 0);
				PLAYER::SPECIAL_ABILITY_CHARGE_ABSOLUTE(PLAYER::PLAYER_ID(), 30, true, 0);
				if (PED::IS_PED_MODEL(unk_0x9B0761B4C3EB8BC7(), func_82(0)))
				{
					func_141();
				}
				...
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_307, 0))
				{
					...
					if (MISC::GET_MODEL_DIMENSIONS(bLocal_307) != joaat("blimp2"))
					{
						unk_0x03D382CB0B44E2FC(bLocal_307, Local_287, 1, 0, 0, 1);
						ENTITY::SET_ENTITY_HEADING(bLocal_307, fLocal_294);
						if (VEHICLE::IS_BIG_VEHICLE(bLocal_307) && uLocal_74[0] == 5)
						{
							unk_0x03D382CB0B44E2FC(bLocal_307, -865f, 516.3f, 90f, 1, 0, 0, 1);
							ENTITY::SET_ENTITY_HEADING(bLocal_307, 15f);
						}
						else if (func_209(bLocal_307))
						{
							unk_0x03D382CB0B44E2FC(bLocal_307, Local_292, 1, 0, 0, 1);
							ENTITY::SET_ENTITY_HEADING(bLocal_307, fLocal_295);
						}
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_307, 5f);
					}
				}
...
void func_119(bool bParam0, bool bParam1, int iParam2)
{
	...
	if (bParam1)
	{
		if (!bVar0)
		{
			...
			Global_110852.f_15[bParam0] = MISC::GET_GAME_TIMER();
		}
	}
	else if (bVar0)
	{
...
void func_142()
{
	...
	{
		bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 50000);
...
int func_145(int iParam0, int iParam1, char* sParam2, char* sParam3, var uParam4, float fParam5, int iParam6)
{
	...
	switch (uParam4->f_3)
	{
		...
		case 2:
			...
			fVar3 = SYSTEM::ROUND((IntToFloat(uParam4->f_11) * fVar11));
			iVar4 = *uParam4;
			func_159(&iVar4, fVar3, 0, 0, 0, 0, 0);
			CLOCK::SET_CLOCK_TIME(func_153(iVar4), func_152(iVar4), func_151(iVar4));
			if (func_149(iVar4) != CLOCK::GET_CLOCK_MONTH())
			{
...
void func_156(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_158(fVar0, iVar1));
		iVar3 = (iVar3 - 1);
		fVar0 = SYSTEM::ROUND(func_157(SYSTEM::TO_FLOAT(fVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
void func_159(int iParam0, void fParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (((((iParam6 == 0 && iParam5 == 0) && iParam4 == 0) && bParam3 == 0) && iParam2 == 0) && fParam1 == 0)
	{
		return;
	}
	if (fParam1 < 0)
...
int func_169()
{
	...
	func_168(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_162(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_163(&uVar0, CLOCK::GET_CLOCK_YEAR());
	func_161(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
void func_173(bool bParam0, char* sParam1, int iParam2)
{
...
int func_192()
{
	if ((HUD::IS_MESSAGE_BEING_DISPLAYED() || ENTITY::IS_ENTITY_DEAD()) || Global_21005 != 0)
	{
		return 0;
	}
	return 1;
...
void func_203(bool bParam0, struct<3> Param1)
{
	...
	{
		TASK::SET_PED_PATH_AVOID_FIRE(bParam0, true);
		if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, 242628503) != 1)
		{
			...
			{
				bVar0 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), Local_285);
				bVar1 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), Local_286);
				if (bVar1 < bVar0)
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_271[0], 0);
				}
				else if (!CAM::IS_SCREEN_FADED_OUT(func_204()))
				{
			...
			if (bParam0 != unk_0x9B0761B4C3EB8BC7())
			{
				if (!CAM::IS_SCREEN_FADED_OUT(func_204()))
				{
				...
				if (func_25(bParam0, Param1, 1) > 5f)
				{
					...
					TASK::TASK_STAND_STILL(0, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(3000, 6000));
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 0);
					TASK::TASK_PLAY_ANIM(0, "gestures@f@standing@casual", "gesture_come_here_soft", 8f, -8f, -1, 0, 0f, false, false, false);
					TASK::TASK_STAND_STILL(0, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(3000, 6000));
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 0);
			...
			AUDIO::STOP_SCRIPTED_CONVERSATION(bParam0, iLocal_306);
		}
	}
}
...
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam1, 0))
	{
		TASK::TASK_VEHICLE_PARK(bParam0, bParam1, Local_287, fLocal_294, 3, 10f, false);
	}
}
...
{
	if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("blimp")))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("cargobob")))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("cargobob2")))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("cargobob3")))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("buzzard")))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("buzzard2")))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("maverick")))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("polmav")))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("annihilator")))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("frogger")))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(bParam0, joaat("frogger2")))
	{
		return 1;
	}
	return 0;
...
int func_212(var uParam0)
{
	...
	if (MISC::IS_BIT_SET(iVar0))
	{
		if (!func_144(bVar0))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && ENTITY::IS_ENTITY_AT_ENTITY(bVar0, unk_0x9B0761B4C3EB8BC7(), Local_63, false, true, 0))
			{
...
void func_215(bool bParam0)
{
	...
	unk_0xAF7D4BF357E8B79E(Local_287 + Vector(0f, 1f, 1f) * Vector(10f, 10f, 10f), Local_287 + Vector(0f, -1f, -1f) * Vector(10f, 10f, 10f), 0, 1);
	fVar1 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_271[0], 1));
	if (iLocal_75 != 9)
	{
	...
	switch (iLocal_75)
	{
		case 0:
			...
			if (func_192())
			{
				...
				{
					ENTITY::SET_ENTITY_COORDS(iLocal_271[0], 1);
		...
		case 1:
			...
			{
				bLocal_307 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
				iLocal_301 = ENTITY::GET_ENTITY_HEALTH(bLocal_307);
			}
			if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_271[0], 1), 3f, 3f, 3f, 0, 1, 0) || (ENTITY::GET_ENTITY_COORDS(bLocal_307, false) && func_239(bLocal_307, iLocal_271[0], 1) <= 10f))
			{
				ENTITY::SET_ENTITY_COORDS(iLocal_271[0], 0);
				if (MISC::IS_BIT_SET(bLocal_307) && (PED::GET_VEHICLE_PED_IS_USING(bLocal_307) < 1 || (!bParam0 && !MONEY::NETWORK_SPENT_HIRE_MERCENARY(MISC::GET_MODEL_DIMENSIONS(bLocal_307)))))
				{
				...
				{
					unk_0xD289B55B6AADBA10(1);
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_271[0]);
					func_237();
		...
		case 3:
			...
			if (!func_171())
			{
				if (func_192())
				{
					PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_287 - Vector(3f, 3f, 3f), Local_287 + Vector(3f, 3f, 3f), 0, 1);
					unk_0xAF7D4BF357E8B79E(Local_287 - Vector(3f, 3f, 3f), Local_287 + Vector(3f, 3f, 3f), 0, 1);
					MISC::CLEAR_AREA_OF_VEHICLES(Local_287, 10f, false, false, false, false, false, false);
					MISC::CLEAR_AREA_OF_PEDS(Local_287, 10f, 0);
					fLocal_284 = PATHFIND::SET_ROADS_IN_AREA(Local_287 - Vector(35f, 35f, 35f), Local_287 + Vector(35f, 35f, 35f), false, true, 1, 1);
					func_8(&iLocal_243);
					if (bParam0)
					{
						func_91(1);
		...
		case 4:
			...
			func_216();
			if ((func_4(&iLocal_255) > 45f || SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_291) > (100f * 100f)) && func_25(unk_0x9B0761B4C3EB8BC7(), Local_288, 1) > 100f)
			{
				if (uLocal_74[0] == 8)
				{
			...
			else if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_287, 3f, 3f, 2f, 1, 1, 2) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_286, 5f, 5f, 2f, 1, 1, 1))
			{
				if (func_36(1, 0, 1))
				{
					iLocal_72 = 1;
		...
		case 5:
			...
			func_216();
			func_237();
			if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_287, 1f, 1f, 2f, 1, 1, 2))
			{
				iLocal_75 = 6;
			}
			else
		...
		case 6:
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				...
				{
					if (func_59(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 3f, 2, 0.5f, 0, 1, 0))
					{
						func_58();
						func_203(iLocal_271[0], Local_286);
		...
		case 7:
			...
			if ((unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_288, 5f, 5f, 2f, 0, 1, 1) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_286, 5f, 5f, 2f, 0, 1, 1)) && PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()))
			{
				if (func_36(1, 0, 1))
				{
					iLocal_72 = 1;
		...
		case 8:
			...
			{
				if (iLocal_76 > 1 || SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_271[0], 1)) < (3f * 3f))
				{
...
void func_216()
{
	...
	{
		iVar1 = 0;
		bVar2 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_271[0], sVar0, func_95(4, 1, 1, func_98(bLocal_307)), 3);
		bVar3 = PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7());
		bVar4 = TASK::GET_SCRIPT_TASK_STATUS(iLocal_271[0], 242628503) == 7;
		bVar5 = SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0);
		bVar6 = false;
		if (bVar5)
		{
			if (MISC::IS_BIT_SET(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0))
			{
				bVar6 = (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) > 5f);
			}
		}
		if ((((!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) || func_4(&iLocal_252) > 35f) || SYSTEM::VDIST(Local_287, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < 75f) || bVar3) || bVar6)
		{
			if (!bVar4 && !bVar2)
			{
				TASK::TASK_PLAY_ANIM(iLocal_271[0], sVar0, func_95(4, 1, 1, func_98(bLocal_307)), 8f, -8f, -1, 0, 0f, false, false, false);
			}
			if (bVar3)
			{
				iLocal_302 = 2000;
		...
		if ((iVar1 && bVar4) && !bVar2)
		{
			if (!bVar3 && bVar5)
			{
				if (bVar6)
				{
					CAM::IS_AIM_CAM_ACTIVE(unk_0x9B0761B4C3EB8BC7(), (ENTITY::GET_ENTITY_HEALTH(unk_0x9B0761B4C3EB8BC7()) - SYSTEM::CEIL((IntToFloat(PED::GET_PED_MAX_HEALTH(unk_0x9B0761B4C3EB8BC7())) * 0.1f))), 0);
...
int func_217()
{
	...
	func_64(&Var0, &uVar1, 0);
	if (((SYSTEM::VDIST(Local_287, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) > (75f * 2f) && SYSTEM::VDIST(Var0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) > (75f / 2f)) && func_116(uLocal_74[0]) > 1) && func_218())
	{
		return 1;
	}
	return 0;
...
int func_218()
{
	...
	if (ENTITY::GET_ENTITY_COORDS(iVar0, false))
	{
		...
		if (func_220(fVar1, 0) && func_219(bVar0))
		{
			return 1;
		}
	}
...
int func_220(void fParam0, bool bParam1)
{
...
void func_222(float fParam0, struct<3> Param1)
{
	...
	{
		if (SYSTEM::VDIST(Param1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < 75f)
		{
			if (uLocal_74[0] == 8 || uLocal_74[0] == 9)
			{
			...
			MISC::CLEAR_AREA_OF_VEHICLES(Local_287, 5f, false, false, false, false, false, false);
		}
	}
	if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
	...
	else
	{
		...
		fVar2 = VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(bVar0);
		if (bVar1 < (fVar2 * 0.9f) || bVar1 > (fVar2 * 0.1f))
		{
			func_8(&iLocal_249);
		}
		if (!func_267(uLocal_298, 4))
...
int func_223(int iParam0, int iParam1)
{
	...
	if (ENTITY::GET_ENTITY_COORDS(iVar0, false))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(iParam0, bVar0))
		{
			if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(bVar0))
			{
				iVar1 = ENTITY::GET_ENTITY_HEALTH(bVar0);
				iVar2 = (*iParam1 - iVar1);
				*iParam1 = iVar1;
...
int func_224(bool bParam0)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0, 0))
	{
		if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(110, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 10f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(bParam0, unk_0x9B0761B4C3EB8BC7()))
		{
			return 1;
		}
	}
...
void func_225()
{
	...
	if (PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (!SYSTEM::VMAG(fLocal_277))
		{
			fLocal_277 = func_62(Local_288, 0);
		}
		func_8(&iLocal_255);
		Local_291 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_271[0], 1) };
		iLocal_75 = 4;
	}
	else
	{
...
int func_228(int iParam0, void fParam1)
{
	switch (fParam1)
	{
		case joaat("manana"):
...
void func_237()
{
	if (!PED::IS_PED_IN_GROUP(iLocal_271[0]) && SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_271[0], 1)) < 10f)
	{
...
int func_240(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;
	int iVar1;
		...
		if (func_243(iParam0, iVar1, uParam1, &uVar0, 0, 1, 0, 1, 1))
		{
			...
			if (MISC::IS_BIT_SET(iParam0))
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0))
				{
					...
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(bParam0, iLocal_70);
...
int func_243(bool bParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	bool bVar1;
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iVar0, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0, 0))
	{
		...
		if (bParam4)
		{
			if (func_244(bParam0, iParam1, 1, bParam6, bVar1, 1))
			{
				*uParam3 = 32;
				return 1;
			}
		...
		{
			if (func_244(bParam0, iParam1, 0, bParam6, bVar1, bParam8))
			{
				*uParam3 = 16;
				return 1;
			}
...
int func_244(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		...
		iLocal_61 = ENTITY::GET_ENTITY_HEALTH(bParam0);
	...
	if (func_246(unk_0x9B0761B4C3EB8BC7(), bParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (MISC::IS_PC_VERSION(bParam0) && func_245(bParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_247(bool bParam0, bool bParam1, var uParam2)
{
	if (WEAPON::IS_PED_ARMED(iParam0, 4))
	{
		...
		{
			if (unk_0xC2169C00B643278B(iParam1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), IntToFloat(uParam2->f_4), IntToFloat(uParam2->f_4), IntToFloat(uParam2->f_4), 0, 1, 0))
			{
				return 1;
			}
		}
...
int func_248(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	...
	if (WEAPON::IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(bParam0) || func_249(iVar1))
			{
				if (unk_0xC2169C00B643278B(bParam1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam1), bParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam1, bParam0, 17))
		...
		if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
		{
			if (MISC::IS_MINIGAME_IN_PROGRESS(bParam0, -1, 0) != 0)
			{
				if (MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(unk_0x9B0761B4C3EB8BC7(), &iVar0, 1))
				{
					...
					{
						if (func_239(unk_0x9B0761B4C3EB8BC7(), bParam0, 1) < 40f)
						{
							if (PLAYER::GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(PLAYER::PLAYER_ID(), &iVar1))
							{
								if ((ENTITY::IS_ENTITY_A_VEHICLE(iVar1) && ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(iVar1) == bParam0) || (ENTITY::IS_ENTITY_A_PED(iVar1) && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iVar1) == MISC::IS_MINIGAME_IN_PROGRESS(bParam0, -1, 0)))
								{
...
void func_251(int iParam0)
{
	...
	if (SYSTEM::VMAG(uLocal_278[iParam0]))
	{
	...
	PED::IS_PED_IN_PARACHUTE_FREE_FALL(uLocal_278[iParam0], &Var0);
}
...
int func_254(bool bParam0, int iParam1)
{
	...
	{
		iVar2 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
		if (PED::GET_PED_GROUP_INDEX(bParam0) == func_238())
		{
			if (ENTITY::GET_ENTITY_COORDS(iVar2, false))
			{
				if (!unk_0xE0B3BC41DDA88DF0(bParam0, bVar2, 0) && SYSTEM::VDIST(Var0, Var1) > 10f)
				{
					return 1;
				}
			}
	...
	{
		bVar3 = ENTITY::IS_ENTITY_PLAYING_ANIM((Var0.f_2 - Var1.f_2));
		if (bVar3 > 8f)
		{
			return 1;
		}
...
void func_255()
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_271[0], 0))
	{
		...
		{
			func_196(iLocal_271[0], OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7()), 0f, 2f, 0f));
			iLocal_72 = 1;
			iLocal_73 = 0;
		}
	}
...
void func_259(bool bParam0)
{
	...
	{
		iLocal_71 = func_169();
		func_159(&iLocal_71, 0, 0, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(5, 7), 0, 0, 0);
	}
	else if (bParam0)
	{
...
int func_268(var uParam0, bool bParam1)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (fLocal_296 == -1f)
		{
			fLocal_296 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Var0);
		}
		if (iLocal_299 == -1)
		{
		...
		if (!func_267(uLocal_300, 1024))
		{
			...
			PED::_0x2208438012482A1A(iLocal_271[iVar2], 1);
			PED::SET_PED_KEEP_TASK(iLocal_271[0], true);
			...
			TASK::TASK_LOOK_AT_ENTITY(iLocal_271[iVar2], unk_0x9B0761B4C3EB8BC7(), -1, 2048, 4);
			PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_271[0], 0);
		...
		if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Var0) > 100f)
		{
			if (func_192())
			{
				if (!func_267(uLocal_300, 1))
			...
			if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Var0) > (fLocal_296 + (200f * 3f)))
			{
				func_66(1);
			}
			else if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Var0) < fLocal_296)
			{
				fLocal_296 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Var0);
			}
			return 0;
...
{
	if (MISC::GET_MODEL_DIMENSIONS(iParam0) == joaat("s_f_y_stripper_02"))
	{
		func_281(bParam0, 2, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 3));
		func_280(bParam0, 2, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 3));
...
{
	if (PED::IS_PED_COMPONENT_VARIATION_VALID(iParam0, 3, iParam1, bParam2))
	{
		PED::SET_PED_COMPONENT_VARIATION(iParam0, 3, iParam1, bParam2, 0);
	}
}

void func_281(int iParam0, int iParam1, bool bParam2)
{
	if (PED::IS_PED_COMPONENT_VARIATION_VALID(iParam0, 8, iParam1, bParam2))
	{
		PED::SET_PED_COMPONENT_VARIATION(iParam0, 8, iParam1, bParam2, 0);
	}
}
...
void func_282(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		...
		bVar0 = false;
		if (MISC::GET_MODEL_DIMENSIONS(bParam0) == joaat("mp_f_stripperlite"))
		{
			bVar0 = true;
		}
		switch (iParam1)
		{
			...
			case 8:
				PED::SET_PED_COMPONENT_VARIATION(bParam0, 3, 2, false, 0);
				PED::SET_PED_COMPONENT_VARIATION(bParam0, 4, 0, true, 0);
				break;
			
			case 9:
				PED::SET_PED_COMPONENT_VARIATION(bParam0, 0, 0, true, 0);
				PED::SET_PED_COMPONENT_VARIATION(bParam0, 2, 0, true, 0);
				PED::SET_PED_COMPONENT_VARIATION(bParam0, 3, 0, false, 0);
				PED::SET_PED_COMPONENT_VARIATION(bParam0, 4, 0, true, 0);
				PED::SET_PED_COMPONENT_VARIATION(bParam0, 8, 1, false, 0);
				PED::SET_PED_COMPONENT_VARIATION(bParam0, 10, 0, false, 0);
				break;
			}
	}
}

void func_283(bool bParam0, int iParam1, bool bParam2)
{
	if (PED::IS_PED_COMPONENT_VARIATION_VALID(iParam0, 11, iParam1, iParam2))
	{
		PED::SET_PED_COMPONENT_VARIATION(iParam0, 11, iParam1, bParam2, 0);
	}
}

void func_284(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	void fVar0;
	...
	if (fVar0 == func_258(0, 0) || fVar0 == func_258(0, 1))
	{
		if (bParam1)
		{
	...
	else if (fVar0 == func_258(1, 0) || fVar0 == func_258(1, 1))
	{
		if (bParam1)
		{
			func_280(bParam0, 0, iParam2);
			func_279(bParam0, iParam3, 0);
			func_281(bParam0, 1, 0);
		}
	}
	else if (fVar0 == joaat("mp_f_stripperlite"))
	{
		if (bParam1)
		{
			func_281(bParam0, 1, 0);
...
void func_285(bool bParam0, int iParam1, bool bParam2)
{
	if (PED::IS_PED_COMPONENT_VARIATION_VALID(iParam0, 4, iParam1, iParam2))
	{
		PED::SET_PED_COMPONENT_VARIATION(iParam0, 4, iParam1, bParam2, 0);
	}
}
...
void func_286(bool bParam0, int iParam1, bool bParam2)
{
	...
	{
		PED::SET_PED_COMPONENT_VARIATION(iParam0, 2, iParam1, bParam2, 0);
	}
}
...
void func_287(bool bParam0, int iParam1, bool bParam2)
{
	...
	{
		PED::SET_PED_COMPONENT_VARIATION(iParam0, 0, iParam1, bParam2, 0);
	}
}
...
void func_303()
{
	...
	func_86();
	HUD::CLEAR_PRINTS();
	PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_284, 0);
	unk_0xAF7D4BF357E8B79E(Local_287 - Vector(3f, 3f, 3f), Local_287 + Vector(3f, 3f, 3f), 1, 1);
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(Local_287 - Vector(3f, 3f, 3f), Local_287 + Vector(3f, 3f, 3f), 15f, 1);
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
