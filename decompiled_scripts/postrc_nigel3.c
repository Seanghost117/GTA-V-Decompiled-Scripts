...
void func_1()
{
	...
	{
		case 0:
			if ((MISC::GET_GAME_TIMER() - iLocal_187) > 5000 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_188, unk_0x9B0761B4C3EB8BC7(), true))
			{
			...
			else if ((MISC::GET_GAME_TIMER() - iLocal_187) > 12000 && SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
int func_22()
{
	...
	fVar0 = 200f;
	if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_188, 1)) >= (fVar0 * fVar0) && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_188))
	{
		return 0;
	}
	return 1;
...
int func_24()
{
	...
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_188))
		{
			return 1;
		}
	}
...
int func_31()
{
	...
	if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		while (iVar2 <= (iVar1 - 1))
		{
			if (uVar0[iVar2] != 0 && MISC::IS_BIT_SET(uVar0[iVar2]))
			{
				if (MISC::GET_MODEL_DIMENSIONS(uVar0[iVar2]) == joaat("u_m_m_aldinapoli"))
				{
