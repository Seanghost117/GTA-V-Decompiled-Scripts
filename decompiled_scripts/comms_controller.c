...
int func_3(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<15> Var0;
	...
	if (iParam2 < 3)
	{
		if (unk_0xCE990E643CD9D0E5(bParam1, iParam2))
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_28(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
void func_67()
{
	...
	{
		if (func_69(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
int func_90()
{
	...
	if (iVar0 >= 0 && iVar0 < 3)
	{
		if (MISC::IS_BIT_SET(Global_94789[iVar0]))
		{
			return 0;
		}
	}
...
int func_93()
{
	if (MISC::IS_BIT_SET(Global_96433[2]))
	{
		return 0;
	}
	return 1;
...
int func_94()
{
	if (MISC::IS_BIT_SET(Global_96433[1]))
	{
		return 0;
	}
	return 1;
...
int func_95()
{
	if (MISC::IS_BIT_SET(Global_96433[0]))
	{
		return 0;
	}
	return 1;
...
int func_107()
{
	...
	{
		fVar0 = SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), func_108(212, 0));
		if (fVar0 > 22500f)
		{
			Global_93957 = -1;
			return 1;
...
int func_118()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (SYSTEM::VDIST2(func_108(181, 0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) > 40000f)
		{
			return 1;
		}
	}
	...
	if (Global_42178 != -1)
	{
		...
		else
		{
			...
			if (unk_0xCE990E643CD9D0E5(Global_111858.f_7684[Global_42178 /*15*/].f_1, 15))
			{
				...
				VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_7684[Global_42178 /*15*/].f_1), 15);
			}
			if (func_54(3))
			{
				if (!func_53(1))
...
int func_151(var uParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8, var uParam9, int iParam10)
{
	struct<14> Var0;
...
void func_160()
{
	if (iLocal_52 == 1)
	{
		if (!func_184())
		{
			AUDIO::STOP_SOUND(fLocal_57);
			DATAFILE::UGC_UPDATE_CONTENT(-1, "End_Squelch", "CB_RADIO_SFX", 1);
			iLocal_52 = 0;
		}
	...
	else if ((MISC::GET_GAME_TIMER() - iLocal_54) >= 10000 || iLocal_53 >= 1)
	{
		if (func_66() == 2)
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
			{
				...
				{
					if (AUDIO::_IS_VEHICLE_RADIO_LOUD(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
					{
						switch (iLocal_53)
						{
							case -1:
								...
								iLocal_53++;
								fLocal_57 = AUDIO::PLAY_SOUND_FROM_COORD();
								break;
...
int func_161()
{
	...
	if (bVar3)
	{
		...
		StringIntConCat(&Var2, bVar1, 16);
		func_177(&uLocal_59, 3, 0, &Var2, 0, 0);
		if (func_163(&uLocal_59, "CBRADAU", &Var0, 1, 1, 0, 0))
		{
			DATAFILE::UGC_UPDATE_CONTENT(-1, "Start_Squelch", "CB_RADIO_SFX", 1);
			DATAFILE::UGC_UPDATE_CONTENT(fLocal_57, "Background_Loop", "CB_RADIO_SFX", 1);
			return 1;
		}
	}
	else
	{
		...
		bVar1 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1, 23);
		StringIntConCat(&Var0, bVar1, 16);
		func_162(bVar1, &iVar4, &iVar5);
		StringCopy(&Var2, "CB_CHAR", 16);
...
bool func_178()
{
	...
	while (iVar2 == 0)
	{
		bVar3 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1, 44);
		switch (bVar3)
		{
			case 5:
				if (iVar1 > 19)
...
int func_181()
{
	...
	bVar1 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1, 44);
	StringIntConCat(&Var0, bVar1, 16);
	StringCopy(&Var2, "CB_CHAR", 16);
	StringIntConCat(&Var2, bVar1, 16);
	func_177(&uLocal_59, 3, 0, &Var2, 0, 0);
...
void func_194(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_195(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, false, 2, AUDIO::ADD_LINE_TO_CONVERSATION(func_196(iParam1)), 0));
		}
		else
		{
			func_195(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, AUDIO::ADD_LINE_TO_CONVERSATION(func_196(iParam1)), 0));
		}
		switch (Global_19681)
		{
			case 0:
...
int func_204(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (unk_0xCE990E643CD9D0E5(bParam4, 18))
	{
		if (!unk_0xCE990E643CD9D0E5(bParam0, func_202()))
		{
			return 0;
		}
	}
		...
		case 0:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				if (func_245(48))
				{
					...
					{
						if ((((!MISC::IS_BIT_SET(func_239(60)) && !MISC::IS_BIT_SET(func_239(61))) && Global_76829 == -1) && !func_238()) && !func_237())
						{
							if (func_66() == 0)
							{
...
int func_223()
{
	...
	while (iVar0 < 2)
	{
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Var4, Var3[iVar0 /*3*/], 1) < fVar1)
		{
			fVar1 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Var4, Var3[iVar0 /*3*/], 1);
			iVar2 = iVar0;
		}
		iVar0++;
	}
...
int func_237()
{
	...
	iVar1 = PED::GET_PED_NEARBY_VEHICLES(unk_0x9B0761B4C3EB8BC7(), &uVar0);
	iVar2 = 0;
	while (iVar2 <= (iVar1 - 1))
	{
		if (MISC::GET_MODEL_DIMENSIONS(uVar0[iVar2]) == joaat("blimp"))
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uVar0[iVar2], 0) && ENTITY::GET_ENTITY_COORDS(uVar0[iVar2], false))
			{
				return 1;
			}
		}
...
int func_238()
{
	...
	{
		if (MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 1)) == joaat("blimp"))
		{
			return 1;
		}
	}
	...
	if (func_9(func_66()))
	{
		if (unk_0xCE990E643CD9D0E5(uParam0->f_2, func_202()))
		{
			...
			else
			{
				...
				if (CAM::IS_SCREEN_FADED_OUT(&(Var3.f_8)))
				{
					cVar4 = { Var3.f_4 };
				}
				else
					...
					if (fVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[fVar0] == 0)
						{
							...
							if (Global_2462245)
							{
								if (iVar1 == 14)
								{
									func_270(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22068), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8120[fVar0] = 1;
						}
					...
					if (fVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[fVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_270(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22073), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76833)
								{
									...
									func_270(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(fVar4), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19681)
									...
									func_270(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(fVar6), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7558[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_270(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(fVar9), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_270(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8120[fVar0] = 1;
						}
					}
...
void func_270(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
