...
int func_1()
{
	if (!unk_0xE6D459F9FC002DFC(uLocal_44, "garage_decor_01"))
	{
		unk_0x705EA7257B991534(uLocal_44, "garage_decor_01");
	}
	else
	{
		unk_0x35BA1F33F01303F1(uLocal_44);
		return 1;
	}
	return 0;
}
...
int func_2()
{
	uLocal_44 = unk_0x518D695E2DBA9DB8(unk_0x9B0761B4C3EB8BC7());
	if (unk_0x0B1B45E748AD48BA(uLocal_44))
	{
		if (!iLocal_40)
		{
			unk_0x05549C0F30BB285D(uLocal_44);
			iLocal_40 = 1;
		}
		else if (unk_0xEF928B5F0219FDF7(uLocal_44))
		{
			unk_0x1F083D57FD823427(uLocal_44);
			return 1;
		}
	}
	return 0;
