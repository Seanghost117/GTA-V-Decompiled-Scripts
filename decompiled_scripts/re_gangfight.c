	...
	while (true)
	{
		...
		if (unk_0x1116855A2A7A342C())
		{
			...
			if (!func_99())
			{
				...
				switch (iLocal_44)
				{
					...
					case 1:
						...
						{
							if ((!unk_0x5AEB5DDFFAD43CA5(uLocal_58) && !unk_0x5AEB5DDFFAD43CA5(iLocal_59[0])) && !unk_0x5AEB5DDFFAD43CA5(iLocal_59[1]))
							{
								if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), 969.2191f, 3608.665f, 41.8758f, 100f, 80f, 20f, 0, 1, 0))
								{
									...
									unk_0xE346A71235BB8065(uLocal_56, 9);
									uLocal_57[0] = func_80(iLocal_59[0], 1, 145);
									uLocal_57[1] = func_80(iLocal_59[1], 1, 145);
									unk_0x3DBD102E8C35EA16(uLocal_56, 0);
									unk_0x3DBD102E8C35EA16(uLocal_57[0], 0);
									unk_0x3DBD102E8C35EA16(uLocal_57[1], 0);
									func_70(1);
								}
							}
						}
						else
						{
							...
							if (!unk_0x5AEB5DDFFAD43CA5(uLocal_58))
							{
								unk_0x8B18A80E8EB15510(uLocal_58, unk_0x9B0761B4C3EB8BC7(), 150f, -1, 0, 0);
							}
							func_69();
						}
						break;
			...
			else
			{
				...
				if (!unk_0x5AEB5DDFFAD43CA5(uLocal_58))
				{
					if (unk_0xCDF860E56BBCC6B4(uLocal_58, unk_0x9B0761B4C3EB8BC7(), 1))
					{
						unk_0x8B18A80E8EB15510(uLocal_58, unk_0x9B0761B4C3EB8BC7(), 150f, -1, 0, 0);
						func_69();
					}
					if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), uLocal_58, 150f, 150f, 50f, 0, 1, 0))
					{
						...
						switch (iLocal_45)
						{
							...
							case 1:
								if (iLocal_46 < 7 && !unk_0x5AEB5DDFFAD43CA5(uLocal_58))
								{
									if (unk_0x04055E36623F131B(unk_0x9B0761B4C3EB8BC7(), uLocal_58, 90f))
									{
										if (unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), uLocal_58) || unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), uLocal_58))
										{
											func_64();
										}
									}
				...
				{
					if (unk_0x8F678487EEBD8CE4(uLocal_56))
					{
						unk_0x93370FA10F15BE44(&uLocal_56);
					}
					...
					while (iVar2 < iLocal_59)
					{
						if (!unk_0x5AEB5DDFFAD43CA5(iLocal_59[iVar2]))
						{
							...
							unk_0xCBA6B2B569DCAFD8(iLocal_59[iVar2], 1);
						...
						else if (unk_0x8F678487EEBD8CE4(uLocal_57[iVar2]))
						{
							unk_0x93370FA10F15BE44(&(uLocal_57[iVar2]));
						}
						iVar2++;
					}
					if (iVar1 == 0)
...
void func_1()
{
	...
	if (iLocal_49 && !iLocal_54)
	{
		...
		if (!unk_0x5AEB5DDFFAD43CA5(uLocal_58))
		{
			unk_0xDAE36360F0F8C1ED(uLocal_58, 0);
			unk_0x4E65320BC9AD521C(uLocal_58, 0);
		}
		iVar0 = 0;
		while (iVar0 < iLocal_59)
		{
			if (unk_0x8F678487EEBD8CE4(uLocal_57[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(uLocal_57[iVar0]));
			}
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_59[iVar0]) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
			{
				if (iVar0 < 2)
				{
					if (!unk_0xA59F96B50B97E63C(iLocal_61[iVar0], 0))
					{
						...
						unk_0xCBA6B2B569DCAFD8(iLocal_59[iVar0], 1);
					}
					else
					{
				...
				unk_0x4E65320BC9AD521C(iLocal_59[iVar0], 0);
			}
			iVar0++;
		}
		iVar0 = 0;
	...
	if (unk_0x272784C60C397DB6(func_2(unk_0x460153A63B9477BC()), Local_48, 1) > 50f)
	{
		func_146();
	}
}
...
void func_9()
{
	...
	switch (iLocal_46)
	{
				...
				while (iVar0 < iLocal_59)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_59[iVar0]) && !unk_0xA59F96B50B97E63C(iLocal_61[iVar0], 0))
					{
						if (!unk_0x8F678487EEBD8CE4(uLocal_57[iVar0]))
						{
							...
							if (unk_0x47DBF174A0CB9D55(iLocal_59[iVar0], 0))
							{
								if (!bLocal_51)
								{
								...
								else
								{
									...
									unk_0x9B6EC2CECE1010EF(iLocal_59[iVar0], uLocal_62);
			...
			while (iVar1 < iLocal_59)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_59[iVar1]))
				{
					if (unk_0xC2169C00B643278B(iLocal_59[iVar1], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, 0, 1, 0))
					{
						...
						if (unk_0x47DBF174A0CB9D55(iLocal_59[iVar1], 0))
						{
							unk_0x9DC06E2A59C5AEBB(&uLocal_62);
							unk_0x0AB756271BADC8DF(0, 0, 0);
							unk_0x8FF9CE1C0F94F59A(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
							unk_0x19F29730874AD6F1(uLocal_62);
							unk_0x9B6EC2CECE1010EF(iLocal_59[iVar1], uLocal_62);
							unk_0x4F83FEE4454169D4(&uLocal_62);
							unk_0xCBA6B2B569DCAFD8(iLocal_59[iVar1], 1);
						}
					}
					if (!unk_0x47DBF174A0CB9D55(iLocal_59[iVar1], 0))
					{
				...
				if (unk_0x5AEB5DDFFAD43CA5(iLocal_59[iVar1]))
				{
					if (unk_0x8F678487EEBD8CE4(uLocal_57[iVar1]))
					{
						unk_0x93370FA10F15BE44(&(uLocal_57[iVar1]));
					}
				}
				iVar1++;
			}
		...
		case 2:
			...
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_58))
			{
				unk_0x9B94F6169B0DAEFD(uLocal_58);
				unk_0x9DC06E2A59C5AEBB(&uLocal_62);
				unk_0xA785552633ED203B(0, unk_0x9B0761B4C3EB8BC7(), -1, 2056, 2);
				unk_0xD08E9EAF091A1AAB(0, unk_0x9B0761B4C3EB8BC7(), -1);
				unk_0x19F29730874AD6F1(uLocal_62);
				unk_0x9B6EC2CECE1010EF(uLocal_58, uLocal_62);
				unk_0x4F83FEE4454169D4(&uLocal_62);
			}
			if (!unk_0xA59F96B50B97E63C(uLocal_60, 0))
			{
				unk_0xBB7976F6FB9C9DD2(uLocal_60);
				if (!unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), uLocal_58, 5f, 5f, 5f, 0, 1, 0))
				{
		...
		case 3:
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_58))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), uLocal_58, 6f, 6f, 6f, 0, 1, 0))
				{
					if (unk_0x04055E36623F131B(uLocal_58, unk_0x9B0761B4C3EB8BC7(), 60f))
					{
						if (!func_8())
						{
			...
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_58))
			{
				if (!unk_0x910DFF8E55ABB8EC(uLocal_58, unk_0x9B0761B4C3EB8BC7(), 120f, 120f, 120f, 0, 1, 0))
				{
					func_10();
				}
			}
			if (!unk_0xA59F96B50B97E63C(uLocal_60, 0))
			{
				if (unk_0xCDF860E56BBCC6B4(uLocal_60, unk_0x9B0761B4C3EB8BC7(), 0))
				{
					func_69();
				}
			}
		...
		case 5:
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_58) && !unk_0xA59F96B50B97E63C(uLocal_60, 0))
			{
				unk_0x9DC06E2A59C5AEBB(&uLocal_62);
				unk_0xD08E9EAF091A1AAB(0, unk_0x9B0761B4C3EB8BC7(), 1500);
				unk_0xC584E49FC3559A86(0, uLocal_60, -1, -1, 2f, 8, 0);
				unk_0xC67F9BF03C2472AB(0, 2000);
				unk_0x756D74A3EF0AB788(0, "veh@drivebystd_ds_grenades", "drop_grenade", 2f, -2f, -1, 0, 0, 0, 0, 0);
				unk_0xD8C1C38EE8BC2AC6(0, uLocal_60, 10f, 786603);
				unk_0x19F29730874AD6F1(uLocal_62);
				unk_0x9B6EC2CECE1010EF(uLocal_58, uLocal_62);
				unk_0x4F83FEE4454169D4(&uLocal_62);
				unk_0xCBA6B2B569DCAFD8(uLocal_58, 1);
				unk_0x756046956300306A(uLocal_60, 1);
				iLocal_46++;
			}
			break;
		...
		case 6:
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_58))
			{
				if (unk_0x9934470AA0A08B57(uLocal_58, "veh@drivebystd_ds_grenades", "drop_grenade", 3))
				{
					if (unk_0x4C06B15B376AA145(uLocal_58, "veh@drivebystd_ds_grenades", "drop_grenade") > 0.436f && unk_0x47DBF174A0CB9D55(uLocal_58, 0))
					{
						unk_0x8F312E3891DDE6A0(unk_0x7EC595B99EA7C4B1(unk_0xA5D5B1042E8F47BD(uLocal_58, 0), -1f, 0f, 0f), 1000, 1, 0);
						iLocal_46++;
					}
				}
			}
...
void func_59()
{
	...
	switch (iLocal_46)
	{
		...
		case 1:
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_58))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), uLocal_58, 20f, 20f, 20f, 0, 1, 0))
				{
					unk_0xA785552633ED203B(uLocal_58, unk_0x9B0761B4C3EB8BC7(), -1, 2060, 2);
		...
		case 2:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58) && !unk_0xA59F96B50B97E63C(uLocal_60, 0))
			{
				unk_0x9DC06E2A59C5AEBB(&uLocal_62);
				unk_0x3C1B180EE30D36EF(0, 916.5764f, 3602.146f, 31.9262f, 1f, 40000, 1048576000, 0, 1193033728);
				unk_0x19F29730874AD6F1(uLocal_62);
				unk_0x9B6EC2CECE1010EF(iLocal_58, uLocal_62);
				unk_0x4F83FEE4454169D4(&uLocal_62);
				iLocal_46++;
			}
			break;
		...
		case 4:
			...
			{
				if (unk_0xC2169C00B643278B(iLocal_58, 916.5764f, 3602.146f, 31.9262f, 3.3f, 3.3f, 3.3f, 0, 1, 0))
				{
			...
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_58, 8f, 8f, 8f, 0, 1, 0))
				{
					if (!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) || unk_0xE4B70EFD14220305(unk_0x9B0761B4C3EB8BC7()))
					{
						...
						{
							func_41(1000);
							if ((!unk_0x5AEB5DDFFAD43CA5(iLocal_58) && !unk_0x5AEB5DDFFAD43CA5(iLocal_59[2])) && !unk_0xA59F96B50B97E63C(uLocal_60, 0))
							{
								unk_0x9DC06E2A59C5AEBB(&uLocal_62);
								unk_0xCC1E33530DF3B29A(0, uLocal_60, -1, -1, 1f);
								...
								if ((!unk_0x5AEB5DDFFAD43CA5(iLocal_58) && !unk_0xA59F96B50B97E63C(uLocal_60, 0)) && unk_0x47DBF174A0CB9D55(iLocal_58, 0))
								{
									iLocal_46++;
								}
								else
		...
		case 7:
			if ((((!unk_0x5AEB5DDFFAD43CA5(iLocal_58) && !unk_0xA59F96B50B97E63C(uLocal_60, 0)) && !unk_0xE0B3BC41DDA88DF0(iLocal_58, uLocal_60, 0)) && !unk_0xB8DB6610D5815003(iLocal_58, 0)) && !unk_0xC4C70C30B8EC4946(iLocal_58))
			{
			}
			iVar0 = 0;
			while (iVar0 < iLocal_59)
...
int func_62()
{
	...
	if (((((((!unk_0xAE06B9E39EBDE049(iLocal_61[2]) && !unk_0xAE06B9E39EBDE049(iLocal_61[3])) && !unk_0xAE06B9E39EBDE049(iLocal_61[4])) && !unk_0xAE06B9E39EBDE049(iLocal_61[5])) && !unk_0xAE06B9E39EBDE049(iLocal_59[2])) && !unk_0xAE06B9E39EBDE049(iLocal_59[3])) && !unk_0xAE06B9E39EBDE049(iLocal_59[4])) && !unk_0xAE06B9E39EBDE049(iLocal_59[5]))
	{
		...
		{
			iLocal_61[2] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 863.4697f, 3633.5f, 31.9874f, 290.5797f, 1, 1, 0);
			iLocal_61[3] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 866.4073f, 3636.039f, 31.9514f, 270.3649f, 1, 1, 0);
			iLocal_61[4] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 866.3153f, 3631.587f, 31.9545f, 276.6327f, 1, 1, 0);
			iLocal_61[5] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 868.5937f, 3633.523f, 31.9622f, 267.0991f, 1, 1, 0);
		...
		{
			iLocal_59[2] = unk_0x6A7A2C83BD302BA4(iLocal_61[2], 22, joaat("g_m_y_lost_01"), -1, 1, 1);
			iLocal_59[3] = unk_0x6A7A2C83BD302BA4(iLocal_61[3], 22, joaat("g_m_y_lost_02"), -1, 1, 1);
			iLocal_59[4] = unk_0x6A7A2C83BD302BA4(iLocal_61[4], 22, joaat("g_m_y_lost_01"), -1, 1, 1);
			iLocal_59[5] = unk_0x6A7A2C83BD302BA4(iLocal_61[5], 22, joaat("g_m_y_lost_02"), -1, 1, 1);
			...
			while (iVar0 < iLocal_59)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_59[iVar0]) && !unk_0xA59F96B50B97E63C(iLocal_61[iVar0], 0))
				{
					...
					unk_0x694113444F21E39F(iLocal_59[iVar0], 137, 1);
					unk_0xD93D982926D0D8B3(iLocal_59[iVar0], 0);
					unk_0x73745F8F1D07995D(iLocal_59[iVar0], 2);
					unk_0x6673CC701BC8E9C1(iLocal_59[iVar0], 50, 1);
					...
					unk_0xD3D9D7C84656DAE5(iLocal_59[iVar0], uLocal_228);
					unk_0x4E65320BC9AD521C(iLocal_59[iVar0], 1);
					unk_0x911BA6A7B46C75BA(iLocal_59[iVar0], 3);
					unk_0x6A4846EF125EA7E6(iLocal_59[iVar0], 0);
					unk_0x0DC39BE87E4C5599(iLocal_59[iVar0], 1);
...
void func_64()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
	{
		...
		if (!unk_0xA59F96B50B97E63C(iLocal_59[0], 0) && !unk_0xA59F96B50B97E63C(iLocal_59[1], 0))
		{
			...
			unk_0xDAE36360F0F8C1ED(iLocal_58, 0);
	...
	switch (iLocal_46)
	{
		...
		case 4:
			...
			while (iVar0 < iLocal_59)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_59[iVar0]))
				{
					unk_0x8342E6CB98CD545C(iLocal_59[iVar0], 156, 1);
...
int func_83()
{
	...
	if (!bLocal_51)
	{
		unk_0xEFBCE8F8316F89EA(255, uLocal_228, 1862763509);
		if (!unk_0xA59F96B50B97E63C(iLocal_59[0], 0) && !unk_0xA59F96B50B97E63C(iLocal_59[1], 0))
		{
		...
		{
			if (((unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_61[0], 0) || unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_61[1], 0)) || unk_0xCDF860E56BBCC6B4(iLocal_61[0], unk_0x9B0761B4C3EB8BC7(), 1)) || unk_0xCDF860E56BBCC6B4(iLocal_61[1], unk_0x9B0761B4C3EB8BC7(), 1))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_59[0]) && !unk_0x5AEB5DDFFAD43CA5(iLocal_59[1]))
				{
					if (func_99())
		...
		if ((!unk_0x5AEB5DDFFAD43CA5(iLocal_58) && !unk_0x5AEB5DDFFAD43CA5(iLocal_59[0])) && !unk_0x5AEB5DDFFAD43CA5(iLocal_59[1]))
		{
			...
			if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_58, 12f, 12f, 2.5f, 0, 1, 0))
			{
				if (((unk_0xD5E14AF69C7C4DA9(iLocal_59[0], unk_0x9B0761B4C3EB8BC7()) || unk_0xD5E14AF69C7C4DA9(iLocal_59[1], unk_0x9B0761B4C3EB8BC7())) || unk_0x67E2125E6EC33DB7(iLocal_59[0], unk_0x9B0761B4C3EB8BC7())) || unk_0x67E2125E6EC33DB7(iLocal_59[1], unk_0x9B0761B4C3EB8BC7()))
				{
					...
					if (unk_0x8F678487EEBD8CE4(uLocal_56))
					{
						unk_0x3DBD102E8C35EA16(uLocal_56, 1);
					}
					if (unk_0x8F678487EEBD8CE4(uLocal_57[0]))
					{
						unk_0x3DBD102E8C35EA16(uLocal_57[0], 1);
					}
					if (unk_0x8F678487EEBD8CE4(uLocal_57[1]))
					{
						unk_0x3DBD102E8C35EA16(uLocal_57[1], 1);
					}
...
void func_84()
{
	if (unk_0x80FF6C016CDB0FAF(uLocal_60, 0))
	{
		if ((!unk_0xC2169C00B643278B(uLocal_60, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, 0, 1, 0) && !unk_0xE0B3BC41DDA88DF0(iLocal_58, iLocal_60, 0)) || unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_60, 1))
		{
			func_64();
		}
	}
...
int func_85()
{
	...
	if (((((!unk_0xAE06B9E39EBDE049(iLocal_58) && !unk_0xAE06B9E39EBDE049(iLocal_59[0])) && !unk_0xAE06B9E39EBDE049(iLocal_59[1])) && !unk_0xAE06B9E39EBDE049(iLocal_60)) && !unk_0xAE06B9E39EBDE049(iLocal_61[0])) && !unk_0xAE06B9E39EBDE049(iLocal_61[1]))
	{
		...
		if (((((((unk_0x7D167B9A0CCDA347(joaat("a_m_m_skidrow_01")) && unk_0x7D167B9A0CCDA347(joaat("g_m_y_lost_01"))) && unk_0x7D167B9A0CCDA347(joaat("g_m_y_lost_02"))) && unk_0x7D167B9A0CCDA347(joaat("picador"))) && unk_0x7D167B9A0CCDA347(joaat("hexer"))) && unk_0xC614DDE265D18415("random@countryside_gang_fight")) && unk_0xC614DDE265D18415("veh@drivebystd_ds_grenades")) && unk_0x4B76D36BB460A0DF("move_m@gangster@var_i"))
		{
			...
			unk_0xDE8F8016287F771F("rghLost", &uLocal_228);
			unk_0xEFBCE8F8316F89EA(5, uLocal_228, 1862763509);
			iLocal_58 = unk_0xB3116B49FE00E2F1(26, joaat("a_m_m_skidrow_01"), 973.053f, 3616.738f, 31.6181f, 110.2753f, 1, 1);
			...
			unk_0x6673CC701BC8E9C1(iLocal_58, 17, 1);
			unk_0x0DC39BE87E4C5599(iLocal_58, 0);
			unk_0xDAE36360F0F8C1ED(iLocal_58, 1);
			...
			unk_0x44225B42FE388400(iLocal_58, 1);
			...
			iLocal_60 = unk_0xCE4780E24AFDFBF9(joaat("picador"), 915.7905f, 3603.449f, 31.9111f, 111.9593f, 1, 1, 0);
			...
			iLocal_59[0] = unk_0xB3116B49FE00E2F1(22, joaat("g_m_y_lost_01"), 970.2217f, 3614.821f, 31.6909f, 297.4345f, 1, 1);
			func_63(&uLocal_63, 3, iLocal_59[0], "RECGFLost2", 0, 1);
			iLocal_59[1] = unk_0xB3116B49FE00E2F1(22, joaat("g_m_y_lost_02"), 971.504f, 3618.054f, 31.5565f, 216.9967f, 1, 1);
			func_63(&uLocal_63, 2, iLocal_59[1], "RECGFLost1", 0, 1);
			unk_0x74528AC0906CBABE(joaat("g_m_y_lost_01"));
			unk_0x74528AC0906CBABE(joaat("g_m_y_lost_02"));
			iLocal_61[0] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 968.2626f, 3611.717f, 31.7874f, 296.8978f, 1, 1, 0);
			iLocal_61[1] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 970.8362f, 3625.563f, 31.3415f, 212.3456f, 1, 1, 0);
			unk_0x74528AC0906CBABE(joaat("hexer"));
			...
			while (iVar0 < iLocal_59)
			{
				if (iVar0 < 2)
				{
					...
					unk_0xCBA6B2B569DCAFD8(iLocal_59[iVar0], 1);
					unk_0x4E65320BC9AD521C(iLocal_59[iVar0], 1);
					unk_0xA5EAD2ACE2C8BBB2(iLocal_59[iVar0], 1, 1);
				}
				iVar0++;
			}
			iLocal_55 = unk_0x578C4EF320340AF7() + 1500;
