#region Local Var
	...
	int iLocal_55 = 0;
	float fLocal_56 = 0f;
	float fLocal_57[6] = { 0f, 0f, 0f, 0f, 0f, 0f };
	bool bLocal_58 = 0;
		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			...
			if (!func_99())
			{
				...
				switch (iLocal_44)
				{
					...
					case 1:
						...
						{
							if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[0])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[1]))
							{
								if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), 969.2191f, 3608.665f, 41.8758f, 100f, 80f, 20f, 0, 1, 0))
								{
									fLocal_56 = func_80(bLocal_58, 0, 145);
									HUD::SET_BLIP_PRIORITY(fLocal_56, 9);
									fLocal_57[0] = func_80(iLocal_59[0], 1, 145);
									fLocal_57[1] = func_80(iLocal_59[1], 1, 145);
									HUD::SHOW_HEIGHT_ON_BLIP(fLocal_56, false);
									HUD::SHOW_HEIGHT_ON_BLIP(fLocal_57[0], false);
									HUD::SHOW_HEIGHT_ON_BLIP(fLocal_57[1], false);
									func_70(1);
								}
							}
						}
						else
						{
							...
							{
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[iVar0]))
								{
									TASK::TASK_SMART_FLEE_PED(iLocal_59[iVar0], unk_0x9B0761B4C3EB8BC7(), 150f, -1, false, false);
								}
								iVar0++;
							}
			...
			else
			{
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
				{
					...
					if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 150f, 150f, 50f, false, true, 0))
					{
						...
						switch (iLocal_45)
						{
							...
							case 1:
								if (iLocal_46 < 7 && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
								{
									if (PED::IS_PED_FACING_PED(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 90f))
									{
										if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_58) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_58))
										{
											func_64();
										}
									}
				...
				else
				{
					...
					if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[1])) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[0], 0)) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[1], 0))
					{
						func_69();
					}
					iVar1 = 0;
					...
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[iVar2]))
						{
							TASK::TASK_COMBAT_PED(iLocal_59[iVar2], unk_0x9B0761B4C3EB8BC7(), 0, 16);
							PED::SET_PED_KEEP_TASK(iLocal_59[iVar2], true);
							if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_59[iVar2], 150f, 150f, 50f, false, true, 0))
							{
								func_69();
							}
							iVar1 = 1;
						}
						else if (SYSTEM::VMAG(fLocal_57[iVar2]))
						{
							unk_0x93370FA10F15BE44(&(fLocal_57[iVar2]));
						}
						iVar2++;
					}
					if (iVar1 == 0)
...
void func_1()
{
	...
	if (iLocal_49 && !iLocal_54)
	{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
		{
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(bLocal_58, false);
			PED::_0x2208438012482A1A(bLocal_58, 0);
		}
		iVar0 = 0;
		while (iVar0 < iLocal_59)
		{
			if (SYSTEM::VMAG(fLocal_57[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(fLocal_57[iVar0]));
			}
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[iVar0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				if (iVar0 < 2)
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[iVar0], 0))
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_59[iVar0], iLocal_61[iVar0], unk_0x9B0761B4C3EB8BC7(), 8, 20f, 786469, 150f, 10f, true);
						PED::SET_PED_KEEP_TASK(iLocal_59[iVar0], true);
					}
					else
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_59[iVar0], unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
					}
				}
				else
				{
				...
				PED::_0x2208438012482A1A(iLocal_59[iVar0], 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_61)
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[iVar0], 0))
			{
				STREAMING::REMOVE_ANIM_DICT(&(iLocal_61[iVar0]));
	...
	if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_2(PLAYER::PLAYER_ID()), Local_48, 1) > 50f)
	{
		func_146();
	}
}
	...
	switch (iLocal_46)
	{
		case 0:
			if (SYSTEM::TIMERB() > 2000)
			{
				...
				while (iVar0 < iLocal_59)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[iVar0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[iVar0], 0))
					{
						if (!SYSTEM::VMAG(fLocal_57[iVar0]))
						{
							fLocal_57[iVar0] = func_80(iLocal_59[iVar0], 1, 145);
							if (SYSTEM::VDIST(iLocal_59[iVar0], 0))
							{
								if (!bLocal_51)
								{
									TASK::TASK_DRIVE_BY(iLocal_59[iVar0], unk_0x9B0761B4C3EB8BC7(), 0, 0f, 0f, 0f, 150f, 100, true, -753768974);
								}
								else
								{
									...
									AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_59[iVar0], iLocal_62);
		...
		case 1:
			...
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[iVar1]))
				{
					if (unk_0xC2169C00B643278B(iLocal_59[iVar1], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, 0, 1, 0))
					{
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[iVar1], 0))
						{
							AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_61[iVar1], 0f);
						}
						if (SYSTEM::VDIST(iLocal_59[iVar1], 0))
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_62);
							TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_62);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_59[iVar1], iLocal_62);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_62);
					...
					if (!SYSTEM::VDIST(iLocal_59[iVar1], 0))
					{
						TASK::TASK_COMBAT_PED(iLocal_59[iVar1], unk_0x9B0761B4C3EB8BC7(), 0, 16);
						PED::SET_PED_KEEP_TASK(iLocal_59[iVar1], true);
					}
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[iVar1], 0))
					{
				...
				if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[iVar1]))
				{
					if (SYSTEM::VMAG(fLocal_57[iVar1]))
					{
						unk_0x93370FA10F15BE44(&(fLocal_57[iVar1]));
					}
				}
				iVar1++;
			}
			if (((STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[2]) && STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[3])) && STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[4])) && STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[5]))
			{
				AUDIO::STOP_AUDIO_SCENE("RE_COUNTRYSIDE_GANG_FIGHT_SCENE");
				iLocal_46++;
			}
		...
		case 2:
			...
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
			{
				...
				TASK::OPEN_SEQUENCE_TASK(&iLocal_62);
				TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2056, 2);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_62);
				AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_58, iLocal_62);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_62);
			}
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
			{
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(bLocal_60);
				if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 5f, 5f, 5f, false, true, 0))
				{
		...
		case 3:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 6f, 6f, 6f, false, true, 0))
				{
					if (PED::IS_PED_FACING_PED(bLocal_58, unk_0x9B0761B4C3EB8BC7(), 60f))
					{
						if (!func_8())
						{
			...
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
			{
				if (!ENTITY::IS_ENTITY_AT_ENTITY(bLocal_58, unk_0x9B0761B4C3EB8BC7(), 120f, 120f, 120f, false, true, 0))
				{
					func_10();
				}
			}
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_60, unk_0x9B0761B4C3EB8BC7(), false))
				{
					func_69();
				}
			}
		...
		case 5:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_62);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 1500);
				TASK::TASK_ENTER_VEHICLE(0, bLocal_60, -1, -1, 2f, 8, 0);
				TASK::TASK_PAUSE(0, 2000);
				TASK::TASK_PLAY_ANIM(false, "veh@drivebystd_ds_grenades", "drop_grenade", 2f, -2f, -1, 0, 0f, false, false, false);
				TASK::TASK_VEHICLE_DRIVE_WANDER(0, bLocal_60, 10f, 786603);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_62);
				AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_58, iLocal_62);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_62);
				PED::SET_PED_KEEP_TASK(bLocal_58, true);
				VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(bLocal_60, true);
				iLocal_46++;
			}
			break;
		...
		case 6:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
			{
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_58, "veh@drivebystd_ds_grenades", "drop_grenade", 3))
				{
					if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_58, "veh@drivebystd_ds_grenades", "drop_grenade") > 0.436f && SYSTEM::VDIST(bLocal_58, 0))
					{
						OBJECT::CREATE_MONEY_PICKUPS(unk_0x7EC595B99EA7C4B1(ENTITY::GET_ENTITY_MODEL(bLocal_58, 0), -1f, 0f, 0f), 1000, 1, 0);
						iLocal_46++;
					}
				}
			}
...
void func_59()
{
	...
	switch (iLocal_46)
	{
		...
		case 1:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 20f, 20f, 20f, false, true, 0))
				{
					TASK::TASK_LOOK_AT_ENTITY(bLocal_58, unk_0x9B0761B4C3EB8BC7(), -1, 2060, 2);
		...
		case 4:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
			{
				if (unk_0xC2169C00B643278B(bLocal_58, 916.5764f, 3602.146f, 31.9262f, 3.3f, 3.3f, 3.3f, 0, 1, 0))
				{
					if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 8f, 8f, 8f, false, true, 0))
					{
						if (!func_8())
						{
							if (func_42(&uLocal_63, "RECGFAU", "RECGF_STASH", 4, 0, 0, 0))
							{
								TASK::TASK_TURN_PED_TO_FACE_ENTITY(bLocal_58, unk_0x9B0761B4C3EB8BC7(), -1);
								if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
								{
									ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(bLocal_60);
								}
			...
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 8f, 8f, 8f, false, true, 0))
				{
					if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) || PED::IS_PED_ON_ANY_BIKE(unk_0x9B0761B4C3EB8BC7()))
					{
						...
						{
							func_41(1000);
							if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[2])) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_62);
								TASK::TASK_OPEN_VEHICLE_DOOR(0, bLocal_60, -1, -1, 1f);
								TASK::TASK_LOOK_AT_ENTITY(false, iLocal_59[2], 2000, 0, 2);
								TASK::TASK_TURN_PED_TO_FACE_ENTITY(false, iLocal_59[2], 0);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_62);
								AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_58, iLocal_62);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_62);
								func_41(2000);
								...
								if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0)) && SYSTEM::VDIST(bLocal_58, 0))
								{
									iLocal_46++;
								}
								else
								{
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[2]))
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_62);
		...
		case 7:
			if ((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0)) && !unk_0xE0B3BC41DDA88DF0(bLocal_58, bLocal_60, 0)) && !PED::IS_PED_IN_COVER(bLocal_58, false)) && !PED::IS_PED_CLIMBING(bLocal_58))
			{
			}
			iVar0 = 0;
			while (iVar0 < iLocal_59)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[iVar0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[iVar0], 0))
				{
					if (((((PED::IS_PED_SHOOTING_IN_AREA(unk_0x9B0761B4C3EB8BC7(), (916.3351f - 100f), (3602.048f - 100f), (31.9209f - 100f), (916.3351f + 100f), (3602.048f + 100f), (31.9209f + 100f), false, true) || ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_59[iVar0], 5f, 5f, 5f, false, true, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_59[iVar0], unk_0x9B0761B4C3EB8BC7(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_61[iVar0], unk_0x9B0761B4C3EB8BC7(), true)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_59[iVar0])) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_61[iVar0]))
					{
						bLocal_51 = true;
			...
			if (unk_0xC2169C00B643278B(iLocal_59[2], 970.3641f, 3629.886f, 31.3694f, 5f, 5f, 5f, 0, 1, 0) || SYSTEM::TIMERB() > 13000)
			{
				func_41(2000);
				iVar0 = 0;
				while (iVar0 < iLocal_59)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[iVar0]))
					{
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[iVar0], 0))
						{
							if (unk_0xE0B3BC41DDA88DF0(iLocal_59[iVar0], iLocal_61[iVar0], 0))
							{
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_59[iVar0], iLocal_61[iVar0], unk_0x9B0761B4C3EB8BC7(), (iVar0 - 2) + 10, 60f, 786475, 5f, 10f, true);
							}
						}
					}
					iVar0++;
...
int func_62()
{
	...
	if (((((((!MISC::IS_BIT_SET(iLocal_61[2]) && !MISC::IS_BIT_SET(iLocal_61[3])) && !MISC::IS_BIT_SET(iLocal_61[4])) && !MISC::IS_BIT_SET(iLocal_61[5])) && !MISC::IS_BIT_SET(iLocal_59[2])) && !MISC::IS_BIT_SET(iLocal_59[3])) && !MISC::IS_BIT_SET(iLocal_59[4])) && !MISC::IS_BIT_SET(iLocal_59[5]))
	{
		...
		if ((ENTITY::DOES_ENTITY_EXIST(joaat("g_m_y_lost_01")) && ENTITY::DOES_ENTITY_EXIST(joaat("g_m_y_lost_02"))) && AUDIO::IS_AUDIO_SCENE_ACTIVE("RE_COUNTRYSIDE_GANG_FIGHT_SCENE"))
		{
			...
			while (iVar0 < iLocal_59)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[iVar0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[iVar0], 0))
				{
					...
					PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_59[iVar0], 1.919779E-43f, 1);
					...
					PED::_0x2208438012482A1A(iLocal_59[iVar0], 1);
					...
					if (iVar0 > 1 && iVar0 < 5)
					{
						unk_0x92BD213E6A0E666B(iLocal_59[iVar0], joaat("weapon_pistol"), -1, 1, 1);
					}
					else
					{
						unk_0x92BD213E6A0E666B(iLocal_59[iVar0], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
					}
					TASK::OPEN_SEQUENCE_TASK(&iLocal_62);
					...
					TASK::CLOSE_SEQUENCE_TASK(iLocal_62);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_59[2], iLocal_62);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_62);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_62);
					TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_61[3], 970.6208f, 3636.743f, 31.3666f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					TASK::TASK_LOOK_AT_COORD(0, Local_48, 5000, 0, 2);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_62);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_59[3], iLocal_62);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_62);
					...
					TASK::TASK_LOOK_AT_COORD(0, Local_48, 5000, 0, 2);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_62);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_59[4], iLocal_62);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_62);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_62);
					TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_61[5], 974.8073f, 3633.771f, 31.3818f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					TASK::TASK_LOOK_AT_COORD(0, Local_48, 5000, 0, 2);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_62);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_59[5], iLocal_62);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_62);
				}
				iVar0++;
			}
...
void func_64()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
	{
		TASK::TASK_SMART_FLEE_PED(bLocal_58, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
		PED::SET_PED_KEEP_TASK(bLocal_58, true);
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_59[0], 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_59[1], 0))
		{
			CAM::IS_AIM_CAM_ACTIVE(bLocal_58, 101, 0);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(bLocal_58, false);
			TASK::TASK_SHOOT_AT_ENTITY(iLocal_59[0], bLocal_58, 1000, 0);
			TASK::TASK_SHOOT_AT_ENTITY(iLocal_59[1], bLocal_58, 1000, 0);
		}
		else
		{
			func_4();
...
void func_65(bool bParam0, char* sParam1, int iParam2)
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(bParam0, sParam1, func_66(iParam2), 1);
}
...
void func_67()
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 45f, 45f, 20f, false, true, 0))
			{
				if (!func_8())
				{
					if (func_54() == 0)
		...
		case 1:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 40f, 40f, 20f, false, true, 0))
				{
		...
		case 3:
			if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[0])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[1]))
			{
				...
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 12f, 12f, 2.5f, false, true, 0))
					{
						if (((PED::CAN_PED_SEE_HATED_PED(iLocal_59[0], unk_0x9B0761B4C3EB8BC7()) || PED::CAN_PED_SEE_HATED_PED(iLocal_59[1], unk_0x9B0761B4C3EB8BC7())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_59[0], unk_0x9B0761B4C3EB8BC7())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_59[1], unk_0x9B0761B4C3EB8BC7()))
						{
							TASK::TASK_LOOK_AT_ENTITY(iLocal_59[0], unk_0x9B0761B4C3EB8BC7(), 4000, 2056, 4);
							TASK::TASK_LOOK_AT_ENTITY(iLocal_59[1], unk_0x9B0761B4C3EB8BC7(), 4000, 2056, 4);
							if (!iLocal_53)
							{
								func_4();
								func_41(0);
					...
					else if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_59[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 3))
					{
						if (!PED::IS_PED_FACING_PED(iLocal_59[0], bLocal_58, 10f))
						{
							TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_59[0], bLocal_58, -1, false);
						}
					}
				}
				else if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[0], 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[1], 0))
				{
					func_4();
					func_41(0);
		...
		case 4:
			...
			while (iVar0 < iLocal_59)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[iVar0]))
				{
					...
					TASK::TASK_COMBAT_PED(iLocal_59[iVar0], unk_0x9B0761B4C3EB8BC7(), 0, 16);
					PED::SET_PED_KEEP_TASK(iLocal_59[iVar0], true);
				}
				iVar0++;
			}
		...
		case 5:
			...
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[0]) && STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[1]))
			{
				iLocal_46 = 0;
				iLocal_45 = 1;
			}
...
void func_68()
{
	if (!CAM::IS_SPHERE_VISIBLE(916.4631f, 3601.261f, 31.9327f, 3f))
	{
		...
		{
			if (unk_0xC2169C00B643278B(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 916.4631f, 3601.261f, 31.9327f, 2f, 2f, 2f, 0, 1, 0))
			{
				unk_0x03D382CB0B44E2FC(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 915.6531f, 3595.061f, 32.0774f, 1, 0, 0, 1);
			}
		}
	}
}
...
float func_80(bool bParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = func_81(bParam0, !bParam1, 0);
...
bool func_81(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_82(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_82(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
int func_83()
{
	...
	if (!bLocal_51)
	{
		...
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_59[0], 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_59[1], 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_59[0], unk_0x9B0761B4C3EB8BC7(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_59[1], unk_0x9B0761B4C3EB8BC7(), true))
			{
				func_4();
				return 1;
			}
		...
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[0], 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_61[1], 0))
		{
			if (((unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_61[0], 0) || unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_61[1], 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_61[0], unk_0x9B0761B4C3EB8BC7(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_61[1], unk_0x9B0761B4C3EB8BC7(), true))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[1]))
				{
					if (func_99())
		...
		Var0 = { 15f, 15f, 15f };
		Var1 = { -15f, -15f, -15f };
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[0]))
		{
		...
		if (PED::IS_PED_SHOOTING_IN_AREA(unk_0x9B0761B4C3EB8BC7(), (973.053f - 30f), (3616.738f - 30f), (32.6181f - 30f), (973.053f + 30f), (3616.738f + 30f), (32.6181f + 30f), false, true))
		{
			func_4();
			return 1;
		}
		if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_58) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[0])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_59[1]))
		{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_58, 12f, 12f, 2.5f, false, true, 0))
			{
				if (((PED::CAN_PED_SEE_HATED_PED(iLocal_59[0], unk_0x9B0761B4C3EB8BC7()) || PED::CAN_PED_SEE_HATED_PED(iLocal_59[1], unk_0x9B0761B4C3EB8BC7())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_59[0], unk_0x9B0761B4C3EB8BC7())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_59[1], unk_0x9B0761B4C3EB8BC7()))
				{
					if (!iLocal_50)
					{
						TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_59[0], unk_0x9B0761B4C3EB8BC7(), -1, false);
						iLocal_50 = 1;
					}
					if (SYSTEM::VMAG(fLocal_56))
					{
						HUD::SHOW_HEIGHT_ON_BLIP(fLocal_56, true);
					}
					if (SYSTEM::VMAG(fLocal_57[0]))
					{
						HUD::SHOW_HEIGHT_ON_BLIP(fLocal_57[0], true);
					}
					if (SYSTEM::VMAG(fLocal_57[1]))
					{
						HUD::SHOW_HEIGHT_ON_BLIP(fLocal_57[1], true);
					}
...
void func_84()
{
	if (ENTITY::GET_ENTITY_COORDS(bLocal_60, false))
	{
		if ((!unk_0xC2169C00B643278B(bLocal_60, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, 0, 1, 0) && !unk_0xE0B3BC41DDA88DF0(bLocal_58, bLocal_60, 0)) || unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 1))
		{
			func_64();
		}
	}
...
int func_85()
{
	...
	if (((((!MISC::IS_BIT_SET(bLocal_58) && !MISC::IS_BIT_SET(iLocal_59[0])) && !MISC::IS_BIT_SET(iLocal_59[1])) && !MISC::IS_BIT_SET(bLocal_60)) && !MISC::IS_BIT_SET(iLocal_61[0])) && !MISC::IS_BIT_SET(iLocal_61[1]))
	{
		...
		if (((((((ENTITY::DOES_ENTITY_EXIST(joaat("a_m_m_skidrow_01")) && ENTITY::DOES_ENTITY_EXIST(joaat("g_m_y_lost_01"))) && ENTITY::DOES_ENTITY_EXIST(joaat("g_m_y_lost_02"))) && ENTITY::DOES_ENTITY_EXIST(joaat("picador"))) && ENTITY::DOES_ENTITY_EXIST(joaat("hexer"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@countryside_gang_fight")) && STREAMING::HAS_ANIM_DICT_LOADED("veh@drivebystd_ds_grenades")) && STREAMING::HAS_ANIM_SET_LOADED("move_m@gangster@var_i"))
		{
			...
			PATHFIND::SET_ROADS_IN_AREA(Local_48 - Vector(20f, 50f, 80f), Local_48 + Vector(20f, 50f, 70f), false, true, 1, 1);
			MISC::ENABLE_DISPATCH_SERVICE(3, false);
			MISC::ENABLE_DISPATCH_SERVICE(5, false);
			PED::ADD_RELATIONSHIP_GROUP("rghLost", &iLocal_228);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_228, 1862763509);
			bLocal_58 = PED::CREATE_PED(26, joaat("a_m_m_skidrow_01"), 973.053f, 3616.738f, 31.6181f, 110.2753f, true, true);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_58, 0, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_58, 2, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_58, 3, 1, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_58, 4, 0, 0, 0);
			...
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(bLocal_58, true);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_58, 2.592402E-43f, 1);
			PED::SET_RAGDOLL_BLOCKING_FLAGS(bLocal_58, 16);
			AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_58, "A_M_M_TRAMP_01_BLACK_MINI_01");
			func_63(&uLocal_63, 1, bLocal_58, "RECGFDealer", 0, 1);
			AUDIO::STOP_PED_SPEAKING(bLocal_58, true);
			TASK::TASK_PLAY_ANIM(bLocal_58, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1, 0f, false, false, false);
			PED::SET_PED_MOVEMENT_CLIPSET(bLocal_58, "move_m@gangster@var_i", 0.25f);
			bLocal_60 = VEHICLE::CREATE_VEHICLE(joaat("picador"), 915.7905f, 3603.449f, 31.9111f, 111.9593f, true, true, false);
			VEHICLE::SET_VEHICLE_COLOURS(bLocal_60, 37, 0);
			VEHICLE::SET_VEHICLE_EXTRA_COLOURS(bLocal_60, 4, 0);
			VEHICLE::SET_VEHICLE_PROVIDES_COVER(bLocal_60, true);
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(bLocal_60, "WDU 696");
			...
			while (iVar0 < iLocal_59)
			{
				if (iVar0 < 2)
				{
					...
					unk_0x92BD213E6A0E666B(iLocal_59[0], joaat("weapon_pistol"), -1, 1, 1);
					unk_0x92BD213E6A0E666B(iLocal_59[1], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
					PED::SET_PED_KEEP_TASK(iLocal_59[iVar0], true);
					PED::_0x2208438012482A1A(iLocal_59[iVar0], 1);
...
int func_86()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_97())
		{
			return 0;
		}
	}
...
void func_110(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_112(fVar0, iVar1));
		iVar3 = (iVar3 - 1);
		fVar0 = SYSTEM::ROUND(func_111(SYSTEM::TO_FLOAT(fVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_138()) || Global_110905) || Global_30970) || func_137()) || func_56(8, -1)) || func_134()) || func_136()) || func_135()) || func_133()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_138() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_56(8, -1)) || func_133()) || func_132()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_138()) || func_135()) || Global_110905) || Global_30970) || func_137()) || Global_42801) || func_56(8, -1)) || func_134()) || func_132()) || func_133()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
