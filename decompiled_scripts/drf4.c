	...
	while (true)
	{
		...
		switch (iLocal_48)
		{
			...
			case 3:
				...
				if (PED::IS_PED_JUMPING_OUT_OF_VEHICLE(unk_0x9B0761B4C3EB8BC7()) || NETWORK::NETWORK_IS_PLAYER_ACTIVE(unk_0x9B0761B4C3EB8BC7()))
				{
					func_57(0);
				}
				if (func_56())
...
void func_17(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_19() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_19() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_18(bParam0));
...
bool func_25(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_19() /*10931*/].f_6175.f_10, bParam0);
}
...
void func_51()
{
	...
	{
		if (func_54(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_90(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	HUD::HAS_ADDITIONAL_TEXT_LOADED("DrfAud", 6);
	...
	while (iVar4 < 47)
	{
		if (CAM::IS_SCREEN_FADED_OUT(uParam1[iVar4 /*4*/]))
		{
			iVar4 = 47;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (CAM::IS_SCREEN_FADED_OUT(uParam4[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (CAM::IS_SCREEN_FADED_OUT(uParam7[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
...
void func_91(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	...
	func_92(uParam0, uParam1, uParam4, &Var0, bVar1, iVar2, 0);
	func_92(uParam2, uParam3, uParam5, &Var0, bVar1, iVar2, 0);
}

void func_92(var uParam0, var uParam1, var uParam2, char* sParam3, bool bParam4, int iParam5, int iParam6)
{
	struct<4> Var0;
	int iVar1;
	int iVar2;
...
void func_94(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7)
{
	...
	func_92(uParam0, uParam1, uParam4, "DRF_SEX", bVar1, 1, 0);
	func_92(uParam2, uParam3, uParam5, "DRF_SEX", bVar1, 1, 0);
...
struct<4> func_95(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (func_103() <= 0)
	{
		if (!func_102())
		{
			bVar1 = func_99(1, 2, 3, 4, 12);
		}
		else if (func_98() >= 1)
		{
			bVar1 = func_99(5, 6, 7, 0, 0);
		}
		else
		{
			bVar1 = func_99(5, 7, 0, 0, 0);
		}
	}
	else if (func_103() >= 2)
	{
		bVar1 = func_99(10, 11, 0, 0, 0);
	}
	else if (!func_102())
	{
		if (iParam2 != 4)
		{
			bVar1 = func_99(8, 9, 0, 0, 0);
		}
		else
		{
			bVar1 = 9;
	...
	{
		bVar1 = func_99(8, 9, 10, 0, 0);
	}
	else
	{
		bVar1 = func_99(9, 10, 0, 0, 0);
	}
	func_97(uParam0, bVar1);
	if (bParam3)
	{
		func_96(&(Global_111858.f_19957), bVar1, 1);
	}
...
bool func_101(var uParam0, bool bParam1)
{
...
void func_104(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	...
	func_92(uParam0, uParam1, uParam4, "DRF_ACC", bVar0, 1, 0);
	func_92(uParam2, uParam3, uParam5, "DRF_DEN", bVar1, 1, 0);
}
...
void func_105(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	func_92(uParam0, uParam1, uParam2, "DRF_OPW", bVar1, 1, 0);
...
struct<4> func_106(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	else
	{
		...
		if (iVar3 <= 0)
		{
			if (iParam0 != 4)
			{
				bVar1 = func_108(7, 9, 10, 11, 0);
			}
			else
			{
				bVar1 = func_108(7, 9, 10, 0, 0);
			}
		}
		else
		{
	...
	if (bParam2)
	{
		func_107(&(Global_111858.f_19957), bVar1, 1);
	}
...
void func_112(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	Var0 = { func_118(iParam3, &bVar1, &iVar2, 1) };
	func_92(uParam0, uParam1, uParam2, &Var0, bVar1, iVar2, 0);
}
...
void func_113(var uParam0, var uParam1, var uParam2, int iParam3)
{
	if (iParam3 == 0)
	{
		func_92(uParam0, uParam1, uParam2, "DRF_OVG", NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1, 3), 1, 0);
		func_92(uParam0, uParam1, uParam2, "DRF_TMG", func_115(func_116(), 0, 2), 1, 0);
	}
	else if (iParam3 == 1)
	{
		func_92(uParam0, uParam1, uParam2, "DRF_OVO", NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1, 3), 1, 0);
...
void func_114(var uParam0, var uParam1, var uParam2, char* sParam3, int iParam4)
{
	...
	bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1, iParam4 + 1);
	...
	StringIntConCat(uParam1[*uParam2 /*4*/], bVar0, 16);
	*uParam2++;
}
...
int func_117(var uParam0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(uParam0, "DRF_SOL1"))
	{
		iVar0 = 1;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(uParam0, "DRF_EXILE"))
	{
		iVar0 = 2;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(uParam0, "DRF_SOL2"))
	{
		iVar0 = 1;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(uParam0, "DRF_MIC2"))
	{
		iVar0 = 1;
	}
	return iVar0;
