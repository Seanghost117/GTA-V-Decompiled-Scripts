...
void func_12()
{
	...
	if (iLocal_23 == 1)
	{
		...
		if ((((func_10(2, Global_19657, 0) || func_10(2, Global_19658, 0)) || iLocal_31) || iLocal_45 == 1) || iLocal_46 == 1)
		{
			...
			iLocal_27 = iLocal_18[unk_0x14E3913C604B1108(uLocal_21)];
			if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				unk_0xCBD0866751794AEE(unk_0x9B0761B4C3EB8BC7());
				SYSTEM::WAIT(100);
	...
	if (Global_19659 == 0)
	{
		if (func_10(2, Global_19650, 0))
		{
			...
			iLocal_26 = unk_0x14E3913C604B1108(uLocal_21);
			if (iLocal_26 < 0)
			{
				iLocal_26 = 0;
			}
			...
			if (iLocal_23 == 4)
			{
				...
				if (Global_76833)
				{
					...
					if (Global_4271301 == 0)
					{
						...
						{
							SYSTEM::SETTIMERA(0);
							while (!unk_0x716812D32AF6C4C0(&Var2, &uVar1) && SYSTEM::TIMERA() < 3000)
							{
								SYSTEM::WAIT(0);
...
void func_26()
{
	if (Global_19659 == 0)
	{
		if (func_10(2, Global_19650, 0))
		{
			...
			iLocal_24 = unk_0x14E3913C604B1108(uLocal_21);
