...
void func_124(int iParam0, int iParam1)
{
	...
	while (iVar0 < 32)
	{
		...
		if ((unk_0x166E920FB00B2DBB(iVar2) && iVar2 != unk_0x460153A63B9477BC()) && Global_2452679.f_3889 < iParam1)
		{
			Var1 = { func_114(iVar2) };
			if ((iParam0 || unk_0x78A7795C9C51946D(&Var1)) && iVar0 < 32)
			{
				if (iParam0 || func_125(iVar2))
				{
...
void func_202()
{
	...
	if (bVar1)
	{
		func_203(13, &Local_265, 1, "", 4, &Local_262, &uLocal_297);
	}
	else
	{
		func_203(1, "", 1, "", 4, &Local_262, &uLocal_297);
	}
}
...
int func_221()
{
	...
	{
		iVar2 = unk_0xF1110FE23C67293A(iVar0);
		if (unk_0x166E920FB00B2DBB(iVar2) && iVar2 != unk_0x460153A63B9477BC())
		{
			Var1 = { func_114(iVar2) };
...
void func_222()
{
	if (unk_0x7BCC91F3C1CF24E8(&Local_271))
	{
		return;
	}
...
void func_231()
{
	...
	if ((iLocal_277 == 0 && iLocal_295 > 0) && !bLocal_278)
	{
		if (func_2(2, Global_19650, 0))
		{
			...
			uLocal_294 = unk_0xF4712E16A4C164FE();
			while (!unk_0x654BC7395AE9BF77(uLocal_294))
			{
				SYSTEM::WAIT(0);
			}
			iLocal_288 = unk_0x14E3913C604B1108(uLocal_294);
			iLocal_255 = 3;
			Global_19681.f_1 = 8;
...
void func_232()
{
	...
	func_203(13, &Local_265, 1, "", 14, &Local_268, &uLocal_297);
}
...
void func_238()
{
	...
	if (iLocal_277 == 0 && iLocal_295 > 0)
	{
		if (func_2(2, Global_19650, 0))
		{
			...
			iLocal_284 = unk_0x14E3913C604B1108(uLocal_294);
...
void func_240()
{
	...
	if (iLocal_277 == 0 && iLocal_295 > 0)
	{
		if (func_2(2, Global_19650, 0))
		{
			...
			iLocal_283 = unk_0x14E3913C604B1108(uLocal_294);
	...
	if (iLocal_277 == 0 && func_187())
	{
		...
		while (iVar0 <= 4)
		{
			if (func_244(iVar0))
			{
				unk_0x830F007E19C63E14(Global_19662, "SET_DATA_SLOT");
				unk_0xAD291B8F75D737AD(18);
				unk_0xAD291B8F75D737AD(iLocal_296);
				unk_0xAD291B8F75D737AD(0);
...
int func_251(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	else
	{
		...
		else
		{
			...
			Var2.f_3.f_1 = 4;
			Var3.f_19.f_1 = 4;
			Var5 = { func_114(unk_0x460153A63B9477BC()) };
			Var1 = iParam0;
			...
			switch (*uParam1)
			{
				case 0:
					...
					{
						func_254(&Var4, &Var1);
						if (*uParam3 && unk_0xF8C2A806CC1DA7C7(&Var4))
						{
							if (Var4.f_3 > 0)
							{
								unk_0x8714DED49483ADC8(0, &Var3);
								if (unk_0xF005CCA4263DF67F(&(Var3.f_13), ""))
								{
									*uParam1 = 1;
									*uParam4 = 0;
								}
	...
	if (iLocal_277 == 0 && func_187())
	{
		...
		while (iVar0 <= 29)
		{
			if (func_164(iVar0))
			{
				unk_0x830F007E19C63E14(Global_19662, "SET_DATA_SLOT");
				unk_0xAD291B8F75D737AD(18);
				unk_0xAD291B8F75D737AD(iLocal_295);
				if (iVar0 == 27)
				{
