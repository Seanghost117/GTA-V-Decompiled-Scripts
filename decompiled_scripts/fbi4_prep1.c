	...
	switch (iLocal_69)
	{
		case 0:
			...
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				...
				if (func_37(bVar0) && MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("towtruck"))
				{
					func_36(bVar0, 2);
				}
			}
			if (!CAM::IS_SCREEN_FADED_OUT(sLocal_179))
			{
				func_34(sLocal_179);
			}
			else
		...
		case 1:
			if (func_17())
			{
				...
				func_2();
				MISC::CLEAR_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 30f, true, false, false, false);
				func_375();
			}
			break;
	}
...
void func_43(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_48(PLAYER::PLAYER_ID())) && !func_45(PLAYER::PLAYER_ID(), 0)) && !func_44()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_48(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
bool func_107(bool bParam0, struct<3> Param1, float fParam2)
{
...
void func_108()
{
	func_215(&bLocal_200, &iLocal_201, &iLocal_71, &iLocal_183, &iLocal_182, Local_186, Local_199, 0, 1090519040);
	func_214();
	func_155();
	switch (iLocal_69)
	{
		case 0:
			if (func_122(iLocal_68, bLocal_28))
			{
				...
				{
					if (func_37(bLocal_200))
					{
						if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_200, 0))
						{
		...
		case 1:
			...
			if (func_113(bLocal_200, Local_186, &iLocal_182, iLocal_71, iLocal_70, &iLocal_193, &iLocal_196, &iLocal_192, &iLocal_191, &iLocal_181, 1090519040))
			{
				if (!func_112())
				{
					if (func_67(&uLocal_72, &cLocal_370, &uLocal_205))
		...
		case 3:
			if (func_37(Local_199))
			{
				...
				{
					PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), Local_199, -1);
				}
				else
				{
...
int func_109(bool bParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
int func_113(bool bParam0, struct<3> Param1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10)
{
	float fVar0;
...
bool func_118(struct<3> Param0, int iParam1, bool bParam2)
{
	bool bVar0;
...
void func_124(bool bParam0, struct<3> Param1, float fParam2)
{
	if (func_341(iParam0))
	{
		HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iParam0);
	}
	func_109(bParam0, Param1, fParam2, 0, 1);
}
...
bool func_126(bool bParam0, bool bParam1, int iParam2)
{
	bool bVar0;
...
void func_129()
{
	if (!unk_0xE0B3BC41DDA88DF0(Local_45[0 /*11*/], bLocal_43, 0))
	{
		TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_45[0 /*11*/], unk_0x7EC595B99EA7C4B1(bLocal_43, func_137(1)), 1f, -1, 0.25f, false, 1193033728);
		Local_45[0 /*11*/].f_7 = 1;
	}
	else
	{
...
{
	if (!SYSTEM::VDIST2(bLocal_43, 0, 0))
	{
		func_131(bParam0);
		if (iLocal_48 != (iLocal_41 - 1))
		{
			if (iLocal_48 == 4)
			{
				TASK::TASK_VEHICLE_GOTO_NAVMESH(Local_45[0 /*11*/], bLocal_43, Local_46[iLocal_48 /*25*/], 15f, 2883755, Local_46[iLocal_48 /*25*/].f_6);
			}
			else
			{
				TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_45[0 /*11*/], bLocal_43, Local_46[iLocal_48 /*25*/], 15f, 0, 0, 2883755, Local_46[iLocal_48 /*25*/].f_6, Local_46[iLocal_48 /*25*/].f_7);
			}
		...
		{
			TASK::TASK_VEHICLE_DRIVE_WANDER(Local_45[0 /*11*/], bLocal_43, 15f, 786599);
			Local_45[0 /*11*/].f_8 = Local_45[0 /*11*/].f_7;
...
void func_131(bool bParam0)
{
	if (iLocal_48 != -1)
	{
		...
		{
			unk_0xAF7D4BF357E8B79E(Local_46[iLocal_48 /*25*/].f_11 - Local_46[iLocal_48 /*25*/].f_14, Local_46[iLocal_48 /*25*/].f_11 + Local_46[iLocal_48 /*25*/].f_14, 1, 1);
		}
	}
	if (!bParam0)
	{
	...
	if (iLocal_48 != -1)
	{
		if (!func_136(Local_46[iLocal_48 /*25*/].f_11) && !func_136(Local_46[iLocal_48 /*25*/].f_14))
		{
			unk_0xAF7D4BF357E8B79E(Local_46[iLocal_48 /*25*/].f_11 - Local_46[iLocal_48 /*25*/].f_14, Local_46[iLocal_48 /*25*/].f_11 + Local_46[iLocal_48 /*25*/].f_14, 0, 1);
		}
	}
}
...
int func_132()
{
	...
	if (func_37(bLocal_43))
	{
		Var1 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_43, 1) };
		iVar2 = 0;
		while (iVar2 <= (iLocal_41 - 1))
		{
			fVar5 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Var1, Local_46[iVar2 /*25*/], 1);
		...
		fVar7 = func_133(Local_46[iVar0 /*25*/] - Var1, ENTITY::GET_ENTITY_FORWARD_VECTOR(bLocal_43));
		iVar3 = iVar0;
		iVar8 = 0;
		while (fVar7 < 0f && iVar8 < 40)
		{
			...
			Var1 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_43, 1) };
			fVar7 = func_133(Local_46[iVar3 /*25*/] - Var1, ENTITY::GET_ENTITY_FORWARD_VECTOR(bLocal_43));
			iVar8++;
		}
		if (iVar8 >= 40)
		{
...
bool func_135()
{
	...
	bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, (iLocal_41 - 1));
	while (Local_46[bVar0 /*25*/].f_18)
	{
		bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, (iLocal_41 - 1));
	}
	return bVar0;
...
Vector3 func_137(bool bParam0)
{
	...
	if (!bParam0)
	{
		iVar1 = ENTITY::_GET_ENTITY_BONE_ROTATION_LOCAL(bLocal_43, "wheel_rf");
	}
	else
	{
		iVar1 = ENTITY::_GET_ENTITY_BONE_ROTATION_LOCAL(bLocal_43, "wheel_lf");
	}
	Var0 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(bLocal_43, iVar1) };
	Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(bLocal_43, Var0) };
	if (!bParam0)
	{
...
int func_148()
{
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (VEHICLE::IS_VEHICLE_MODEL(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), joaat("trash")))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), true, false);
			bLocal_200 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
			if (func_37(bLocal_200))
			{
				return 1;
			}
...
int func_149(int iParam0, struct<3> Param1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			HUD::HAS_ADDITIONAL_TEXT_LOADED(sLocal_180, 0);
			...
			if (MISC::IS_BIT_SET(Global_95452.f_9[0]))
			{
				if (!VEHICLE::GET_VEHICLE_MOD(Global_95452.f_9[0], 1))
				{
					...
					if (func_341(Local_197))
					{
						...
						PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_197, 2.382207E-43f, 0);
...
void func_156(int* iParam0, int iParam1)
{
	if (func_341(*iParam0))
	{
		...
		if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*iParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 3))
		{
			if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(*iParam0, "missfbi4prepp1", "_bag_drop_garbage_man") >= 0.172f)
			{
				if (func_10(Local_46[iLocal_48 /*25*/].f_17) && ENTITY::IS_ENTITY_ATTACHED(Local_46[iLocal_48 /*25*/].f_17))
				{
					...
					ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(Local_46[iLocal_48 /*25*/].f_17, 1, 0);
...
bool func_157(bool bParam0, bool bParam1, float fParam2, int* iParam3)
{
	...
	switch (iParam0->f_6)
	{
		case 5:
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_3)
			{
				...
				TASK::TASK_SMART_FLEE_PED(*iParam0, unk_0x9B0761B4C3EB8BC7(), 30f, -1, false, false);
				iParam0->f_6 = 6;
		...
		case 21:
			...
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_3)
			{
				...
				{
					TASK::TASK_PUT_PED_DIRECTLY_INTO_MELEE(*iParam0, unk_0x9B0761B4C3EB8BC7(), 8f, -1f, 10f, false);
				}
				else
				{
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_3)
			{
				...
				TASK::TASK_SMART_FLEE_PED(*iParam0, unk_0x9B0761B4C3EB8BC7(), 500f, -1, false, true);
				iParam0->f_1 = MISC::GET_GAME_TIMER();
				iParam0->f_6 = 4;
				iParam0->f_5 = 1;
			}
		...
		case 11:
			...
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > 5000)
			{
				...
				{
					if (MISC::IS_BIT_SET(Local_45[func_171(iParam0->f_10) /*11*/]))
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, Local_54, 1f, -1, 2f, false, 1193033728);
					}
				}
				iParam0->f_1 = MISC::GET_GAME_TIMER();
				iParam0->f_6 = 23;
		...
		case 18:
			if (!func_184(*iParam0, -2017877118))
			{
				...
				if (func_170(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*iParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) > 1.5f)
				{
					TASK::TASK_TURN_PED_TO_FACE_COORD(0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 0);
				}
				TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 6000, true);
				TASK::CLOSE_SEQUENCE_TASK(iVar1);
				AUDIO::STOP_SCRIPTED_CONVERSATION(*iParam0, iVar1);
		...
		case 1:
			if (!unk_0xE0B3BC41DDA88DF0(*iParam0, bLocal_43, 0))
			{
				func_168(iParam0);
			}
			break;
		...
		case 7:
			if (unk_0xE0B3BC41DDA88DF0(*iParam0, bLocal_43, 1))
			{
		...
		case 20:
			...
			{
				if (!unk_0x1037B9D45CE6B788(*iParam0, unk_0x7EC595B99EA7C4B1(bLocal_43, 5f, 0f, -2f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_43, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
				{
					func_163(iParam0);
				}
				else
...
int func_159(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_160(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_160(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(bLocal_43, 0f, 10f, -2f), unk_0x7EC595B99EA7C4B1(bLocal_43, 0f, 3f, 2f), 5f, 0, 1, 0) && PED::IS_PED_STOPPED(*iParam0))
	{
		return 1;
	}
	return 0;
...
void func_162(int* iParam0)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		if (func_37(bVar0))
		{
			if (!VEHICLE::_0x639431E895B9AA57(*iParam0, bVar0, -1, false, false))
			{
				iParam0->f_6 = 18;
				iParam0->f_1 = MISC::GET_GAME_TIMER();
			}
...
void func_163(int* iParam0)
{
	...
	switch (iParam0->f_8)
	{
		...
		case 3:
			if (!func_184(*iParam0, 242628503))
			{
				...
				if (!unk_0xE0B3BC41DDA88DF0(*iParam0, bLocal_43, 0))
				{
					if (iParam0->f_10 == 0)
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, unk_0x7EC595B99EA7C4B1(bLocal_43, func_137(1)), 1f, -1, 0.25f, false, 1193033728);
						iParam0->f_7 = 1;
					}
					else
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, unk_0x7EC595B99EA7C4B1(bLocal_43, func_137(0)), 1f, -1, 0.25f, false, 1193033728);
						iParam0->f_7 = 1;
					}
				}
			}
		...
		case 9:
			...
			else if (!unk_0xE0B3BC41DDA88DF0(*iParam0, bLocal_43, 0))
			{
				if (iParam0->f_10 == 0)
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, unk_0x7EC595B99EA7C4B1(bLocal_43, func_137(1)), 1f, -1, 0.25f, false, 1193033728);
...
void func_164(var uParam0)
{
	if (!func_184(*uParam0, -71340211))
	{
		...
		{
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_46[iLocal_48 /*25*/].f_19, 1f, 20000, -1f, false, func_165(Local_46[iLocal_48 /*25*/].f_19, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*uParam0, 1), 1));
		}
		if (func_37(bLocal_43))
		{
			VEHICLE::SET_VEHICLE_DOOR_OPEN(bLocal_43, 5, false, false);
		}
...
float func_165(struct<2> Param0, var uParam1, struct<2> Param2, bool bParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_166()
{
	if (func_37(bLocal_43) && func_341(unk_0x9B0761B4C3EB8BC7()))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_43, unk_0x9B0761B4C3EB8BC7(), true))
		{
			ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(bLocal_43);
			if (func_167() || ENTITY::GET_ENTITY_HEALTH(bLocal_43) < 851)
			{
				return 1;
			}
		}
...
int func_167()
{
	...
	while (iVar0 <= 5)
	{
		if (VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_43, iVar0, false))
		{
			iVar1++;
		}
		iVar0++;
...
float func_170(struct<2> Param0, bool bParam1, struct<2> Param2, bool bParam3)
{
...
{
	if (func_37(bLocal_43) && (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_43, 0) && !unk_0xE0B3BC41DDA88DF0(*iParam0, bLocal_43, 0)))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_43) > 0f)
		{
			iParam0->f_1 = MISC::GET_GAME_TIMER();
...
bool func_174(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_175(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
			HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
		}
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_175(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
{
	func_169(iParam0);
	if ((WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6) || iParam1) || iParam0->f_6 == 23)
	{
...
bool func_177(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	
	iVar2 = func_183(iParam0, bParam1);
	if (!func_10(iParam0) || !func_10(bParam1))
	{
		if (iVar2 != -1)
		{
	...
	if (!func_181(iParam0, bParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar2 == -1)
	...
	uVar0 = func_178(&(Local_38[iVar2 /*4*/]), Var1, bParam1, &(Local_38[iVar2 /*4*/].f_3), bParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_38[iVar2 /*4*/].f_3) < iParam4);
}

int func_178(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_179(bool bParam0, bool bParam1)
{
	bool bVar0;
...
int func_181(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_160(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_185(var uParam0)
{
	...
	{
		case 1:
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_43, 1))
			{
				func_176(uParam0, 0);
				return;
			}
		...
		case 2:
			if (PED::IS_PED_SITTING_IN_VEHICLE(*uParam0, bLocal_43))
			{
			...
			else if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_43, 1))
			{
				func_176(uParam0, 0);
				return;
			}
			...
			if (bLocal_51)
			{
				if (iLocal_48 <= 20 && iLocal_48 != -1)
				{
					if (!Local_46[iLocal_48 /*25*/].f_18)
					{
						...
						{
							if (Local_46[iLocal_48 /*25*/].f_9 && VEHICLE::IS_VEHICLE_STOPPED(bLocal_43))
							{
								func_195();
							}
						}
		...
		case 5:
			if (func_37(bLocal_43))
			{
				VEHICLE::BRING_VEHICLE_TO_HALT(bLocal_43, 25f, 10, false);
				bVar0 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_43);
				if (bVar0 < 8f)
				{
					func_194(uParam0);
				}
		...
		case 6:
			if (!func_184(*uParam0, 242628503) && VEHICLE::IS_VEHICLE_STOPPED(bLocal_43))
			{
				if (bLocal_51)
				{
					uParam0->f_8 = uParam0->f_7;
		...
		case 7:
			...
			{
				if (unk_0xE0B3BC41DDA88DF0(Local_45[1 /*11*/], bLocal_43, 0) && Local_45[1 /*11*/].f_7 == 3)
				{
					func_130(0);
				}
			}
		...
		case 8:
			if (!unk_0xE0B3BC41DDA88DF0(*uParam0, bLocal_43, 0))
			{
				func_164(uParam0);
			}
			break;
...
void func_186(var uParam0)
{
	...
	switch (uParam0->f_9)
	{
		case 1:
			...
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
				if (func_170(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*uParam0, 1), Local_46[iLocal_48 /*25*/].f_19) > 1.5f)
				{
		...
		case 2:
			...
			{
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man", 3))
				{
					if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man") >= 0.333f)
					{
						...
						if (func_10(Local_46[iLocal_48 /*25*/].f_17) && !ENTITY::IS_ENTITY_ATTACHED(Local_46[iLocal_48 /*25*/].f_17))
						{
							OBJECT::CREATE_OBJECT_NO_OFFSET(Local_46[iLocal_48 /*25*/].f_17, *uParam0, ENTITY::ATTACH_ENTITY_TO_ENTITY(*uParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
						}
					}
				}
			...
			else if (!func_184(*uParam0, 713668775))
			{
				if (func_37(bLocal_43))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, unk_0x7EC595B99EA7C4B1(bLocal_43, 0f, -4.8f, 0f), 1f, -1, 0.25f, false, ENTITY::IS_ENTITY_IN_WATER(bLocal_43));
				}
				uParam0->f_9 = 3;
			}
			PED::SET_PED_CAPSULE(*uParam0, 0.2f);
		...
		case 3:
			if (func_37(bLocal_43))
			{
				if (!func_191(unk_0x7EC595B99EA7C4B1(bLocal_43, 0f, -5.5f, 0f), bLocal_43, 1.9f, 1.9f, 8f))
				{
					if (unk_0xC2169C00B643278B(*uParam0, unk_0x7EC595B99EA7C4B1(bLocal_43, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, 0, 1, 0))
					{
						if (!func_184(*uParam0, 713668775))
						{
							TASK::OPEN_SEQUENCE_TASK(&iVar1);
							if (func_170(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*uParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_43, 1)) > 3f)
							{
								TASK::TASK_ACHIEVE_HEADING(0, ENTITY::IS_ENTITY_IN_WATER(bLocal_43), 0);
							}
							TASK::TASK_PLAY_ANIM(0, "missfbi4prepp1", "_bag_throw_garbage_man", 8f, -8f, -1, 0, 0f, false, false, false);
							TASK::CLOSE_SEQUENCE_TASK(iVar1);
							AUDIO::STOP_SCRIPTED_CONVERSATION(*uParam0, iVar1);
							TASK::CLEAR_SEQUENCE_TASK(&iVar1);
							uParam0->f_9 = 4;
						}
					}
		...
		case 4:
			if (!func_191(unk_0x7EC595B99EA7C4B1(bLocal_43, 0f, -5.5f, 0f), *uParam0, 1.9f, 1.9f, 8f))
			{
				if (func_184(*uParam0, 242628503))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man", 3))
					{
						if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0.391f)
						{
							if (func_10(Local_46[iLocal_48 /*25*/].f_17))
							{
								if (ENTITY::IS_ENTITY_ATTACHED(Local_46[iLocal_48 /*25*/].f_17))
								...
								if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_46[iLocal_48 /*25*/].f_17, bLocal_43))
								{
				...
				else
				{
					...
					if (func_37(bLocal_43))
					{
						VEHICLE::SET_VEHICLE_DOOR_SHUT(bLocal_43, 5, false);
						func_187(&(Local_46[iLocal_48 /*25*/].f_17));
					}
					func_163(uParam0);
				}
...
void func_187(var uParam0)
{
	...
	{
		if (AUDIO::PLAY_SOUND_FROM_ENTITY(*uParam0))
		{
			ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0, 1, 1);
		}
...
void func_188(var uParam0)
{
	...
	if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			TASK::TASK_PUT_PED_DIRECTLY_INTO_MELEE(*uParam0, unk_0x9B0761B4C3EB8BC7(), 8f, -1f, 10f, false);
		}
		else
		{
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
...
int func_191(struct<3> Param0, bool bParam1, struct<3> Param2)
{
	Local_42.f_2 = { Param0 };
	Local_42.f_8 = { Param2 };
	func_192(&Local_42, bParam1);
	if (Local_42.f_26)
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (ENTITY::IS_ENTITY_A_VEHICLE(Local_42.f_18))
			{
				...
				{
					if (ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(Local_42.f_18) == ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 1))
					{
						return 1;
					}
				}
		...
		else if (ENTITY::IS_ENTITY_A_PED(Local_42.f_18))
		{
			if (func_10(Local_42.f_18))
			{
				if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Local_42.f_18) == unk_0x9B0761B4C3EB8BC7())
				{
					return 1;
				}
			}
...
void func_194(var uParam0)
{
	...
	{
		TASK::OPEN_SEQUENCE_TASK(&iVar0);
		TASK::TASK_VEHICLE_DRIVE_TO_COORD(false, bLocal_43, Local_46[iLocal_48 /*25*/].f_3, 8f, 0, joaat("trash"), 786469, 10f, 15f);
		TASK::TASK_VEHICLE_PARK(0, bLocal_43, Local_46[iLocal_48 /*25*/].f_3, Local_46[iLocal_48 /*25*/].f_8, Local_46[iLocal_48 /*25*/].f_10, 5f, true);
		TASK::CLOSE_SEQUENCE_TASK(iVar0);
		AUDIO::STOP_SCRIPTED_CONVERSATION(*uParam0, iVar0);
		TASK::CLEAR_SEQUENCE_TASK(&iVar0);
		uParam0->f_7 = 6;
...
void func_196(var uParam0, bool bParam1)
{
	...
	if (func_191(unk_0x7EC595B99EA7C4B1(bLocal_43, func_137(bParam1)), bLocal_43, 1.9f, 1.9f, 8f))
	{
		if (unk_0x1037B9D45CE6B788(*uParam0, unk_0x7EC595B99EA7C4B1(bLocal_43, 5f, 0f, -2f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_43, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(bLocal_43, 5f, 0f, -2f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_43, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
		{
			func_197(uParam0);
		}
		else if (!func_184(*uParam0, 1227113341) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(bLocal_43, 5f, 0f, -2f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_43, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
		{
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(*uParam0);
			TASK::TASK_GO_TO_ENTITY(*uParam0, unk_0x9B0761B4C3EB8BC7(), -1, 4f, 1f, 2f, 0);
		}
	}
	else if (func_107(*uParam0, unk_0x7EC595B99EA7C4B1(bLocal_43, func_137(bParam1)), 5f))
	{
		iVar0 = -1;
		if (!bParam1)
		{
		...
		TASK::TASK_ENTER_VEHICLE(*uParam0, bLocal_43, -1, iVar0, 1f, 8388609, 0);
		uParam0->f_7 = 2;
	}
}
...
void func_198(var uParam0)
{
	if (uParam0->f_5 != 1)
	{
		if (func_37(bLocal_43) && SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (!func_184(*uParam0, 2104565373) && unk_0xE0B3BC41DDA88DF0(*uParam0, bLocal_43, 0))
			{
				if (func_157(unk_0x9B0761B4C3EB8BC7(), bLocal_43, 10f, 1))
				{
					if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(bLocal_43, unk_0x9B0761B4C3EB8BC7()))
					{
						TASK::TASK_DRIVE_BY(*uParam0, unk_0x9B0761B4C3EB8BC7(), 0, 0f, 0f, 0f, 10f, 100, true, -957453492);
						uParam0->f_1 = MISC::GET_GAME_TIMER();
						uParam0->f_6 = 9;
					}
				}
	...
	while (iVar0 <= (iLocal_41 - 1))
	{
		if (Local_46[iVar0 /*25*/].f_23 != 0)
		{
			if (Local_46[iVar0 /*25*/].f_24)
			{
				...
				{
					PED::GET_PED_BONE_INDEX(&(Local_46[iVar0 /*25*/].f_17));
...
void func_202(int* iParam0, int iParam1, int iParam2)
{
	if (iParam0->f_5 != 1 || iParam2)
	{
		if (!func_341(Local_45[func_171(iParam1) /*11*/]))
		{
			if (!bLocal_52)
			{
				if (MISC::IS_BIT_SET(Local_45[func_171(iParam1) /*11*/]))
				{
					...
					{
						Local_54 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_45[func_171(iParam1) /*11*/], 1) };
						iParam0->f_1 = MISC::GET_GAME_TIMER();
						iParam0->f_8 = iParam0->f_7;
						iParam0->f_5 = 1;
						iParam0->f_6 = 11;
		...
		if (iParam0->f_10 == 0 && iParam0->f_7 == 4)
		{
			if (func_161(iParam0))
			{
				if (unk_0xE0B3BC41DDA88DF0(*iParam0, bLocal_43, 0))
				{
					TASK::TASK_DRIVE_BY(*iParam0, unk_0x9B0761B4C3EB8BC7(), 0, 0f, 0f, 0f, 10f, 100, true, -957453492);
					AUDIO::_0x9D3AF56E94C9AE98(bLocal_43, 2000f);
		...
		if (func_204(*iParam0, 1, 70f, 170f, 0, 1, 0, 0) && !func_203(iParam0))
		{
			if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
			{
				if (func_37(bLocal_43))
				{
					if (unk_0xE0B3BC41DDA88DF0(*iParam0, bLocal_43, 0))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_43) > 5f)
						{
							if (iParam1 == 0)
							{
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(*iParam0, bLocal_43, unk_0x9B0761B4C3EB8BC7(), 8, 30f, 786469, 300f, 2f, true);
								iParam0->f_6 = 7;
							...
							else
							{
								TASK::TASK_COWER(*iParam0, -1);
								iParam0->f_6 = 12;
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_45[func_171(iParam1) /*11*/], bLocal_43, unk_0x9B0761B4C3EB8BC7(), 8, 30f, 786469, 300f, 2f, true);
	...
	if (iParam0->f_5 != 1)
	{
		if (func_341(Local_45[func_171(iParam1) /*11*/]))
		{
			...
			{
				func_169(iParam0);
				TASK::TASK_SMART_FLEE_PED(*iParam0, unk_0x9B0761B4C3EB8BC7(), 120f, -1, false, false);
				iParam0->f_1 = MISC::GET_GAME_TIMER();
				iParam0->f_6 = 7;
				iParam0->f_5 = 1;
			}
...
{
	if ((unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(*uParam0, 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6)) && PED::GET_PED_STEALTH_MOVEMENT(unk_0x9B0761B4C3EB8BC7()))
	{
		return 1;
	}
	return 0;
...
int func_204(bool bParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	struct<3> Var0;
	...
	if (func_10(unk_0x9B0761B4C3EB8BC7()) && func_10(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				{
					return func_208(unk_0x9B0761B4C3EB8BC7(), bParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_209(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_10(unk_0x9B0761B4C3EB8BC7()) && func_10(iParam0))
	{
		...
		else
		{
			...
			else
			{
				...
				if (func_212(bParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
			if (func_210(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_210(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_212(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
...
void func_215(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, struct<3> Param5, bool bParam6, bool bParam7, int iParam8)
{
	if (func_37(*bParam0))
	{
		switch (*iParam2)
		{
			...
			case 2:
			case 1:
				if ((!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), *bParam0, 0) && !func_220(*bParam0)) && !func_219(*bParam0))
				{
					func_7(iParam4);
					if (!unk_0xC2169C00B643278B(*bParam0, Param5, iParam8, iParam8, 2f, 0, 1, 2))
					{
						func_125(iParam3, *bParam0, 1);
					}
					*iParam2 = 0;
				}
				break;
...
void func_217(char* sParam0)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		if (bVar0 != *sParam0)
		{
			if (func_37(bVar0))
			{
				if (MISC::GET_MODEL_DIMENSIONS(bVar0) == func_218(func_77()))
				{
					func_6(sParam0);
					*sParam0 = bVar0;
					func_36(*sParam0, 1);
...
int func_219(int iParam0)
{
	...
	if ((func_341(unk_0x9B0761B4C3EB8BC7()) && SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0)) && func_37(iParam0))
	{
...
void func_221()
{
	...
	switch (iLocal_69)
	{
		case 0:
			if (func_122(iLocal_68, bLocal_28))
			{
				if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) == 0 && !func_237())
				{
		...
		case 1:
			func_120(&iLocal_182, Local_186, &iLocal_70, iLocal_71, &iLocal_181, &iLocal_195);
			func_227();
			if (func_225(bLocal_200, Local_186, &iLocal_182, iLocal_70, iLocal_71, &iLocal_181, &iLocal_196, 0, 0, 1086324736))
			{
		...
		case 3:
			if (func_37(bLocal_200))
			{
				if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_200, 0))
				{
					PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), bLocal_200, -1);
				}
				else
				{
					func_109(bLocal_200, Local_186, 146.5443f, 0, 1);
					func_40(1, 1, 1);
					iLocal_69 = 1;
				}
			}
...
int func_225(bool bParam0, struct<3> Param1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar2))
		{
			if (func_78(bVar2, 0))
			{
				if (!bVar1)
				{
					if (func_157(unk_0x9B0761B4C3EB8BC7(), bVar2, 5f, 1))
					{
						if (!func_237())
						{
							func_232(iVar0);
				...
				if (!iLocal_374[iVar0])
				{
					if (iVar0 == 0)
					{
						func_98(&uLocal_205, iVar0, bVar2, "MICHAEL", 0, 1);
					}
					else if (iVar0 == 1)
					{
						func_98(&uLocal_205, iVar0, bVar2, "FRANKLIN", 0, 1);
					}
					else if (iVar0 == 2)
					{
						func_98(&uLocal_205, iVar0, bVar2, "TREVOR", 0, 1);
					}
					iLocal_374[iVar0] = 1;
				}
			}
				...
				if (func_78(bVar2, 0))
				{
					if (func_231(bVar2) || func_229(bVar2))
					{
						if (func_228(bVar2, 0))
						{
							...
							PED::_0x2208438012482A1A(bVar2, true);
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bVar2);
						}
					}
				}
			}
			else if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(bVar2, true))
			{
				if (func_231(bVar2))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(bVar2, -1273030092) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bVar2, -1273030092) != 0)
					{
						if (PATHFIND::_ARE_PATH_NODES_LOADED_IN_AREA(623.3781f, -172.26f, 1700.732f, -2115.843f))
						{
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(bVar2, ENTITY::GET_ENTITY_MODEL(bVar2, 0), Local_186, 20f, 0, 0, 34340901, 2f, 10f);
						}
						else
						{
				...
				else if (func_229(bVar2))
				{
					if (func_37(Local_199))
					{
						if (!func_157(bVar2, Local_199, 17f, 1))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(bVar2, -1273030092) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bVar2, -1273030092) != 0)
							{
								TASK::TASK_VEHICLE_MISSION(bVar2, ENTITY::GET_ENTITY_MODEL(bVar2, 0), Local_199, 3, 20f, 786468, 2f, 0.5f, true);
							}
						}
					}
				}
...
int func_229(bool bParam0)
{
	...
	if (!func_230())
	{
		if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0)) && AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) == 0)
		{
			bVar0 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
			if (func_37(bVar0))
			{
				if (VEHICLE::IS_VEHICLE_MODEL(bVar0, joaat("trash")))
				{
					return 0;
				}
				if (unk_0xE0B3BC41DDA88DF0(bParam0, bVar0, 0) && MISC::IS_MINIGAME_IN_PROGRESS(bVar0, -1, 0) == bParam0)
				{
					return 1;
				}
			}
...
int func_231(bool bParam0)
{
	if (!func_230())
	{
		if ((MISC::IS_BIT_SET(Local_199) && ENTITY::GET_ENTITY_COORDS(Local_199, false)) && !unk_0xC2169C00B643278B(Local_199, Local_186, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_199, 0)) && AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) == 0)
			{
				if (unk_0xE0B3BC41DDA88DF0(bParam0, Local_199, 0) && MISC::IS_MINIGAME_IN_PROGRESS(Local_199, -1, 0) == bParam0)
				{
					return 1;
				}
			}
...
void func_232(int iParam0)
{
	if (iLocal_68 > 1)
	{
		if (iLocal_70 > 0)
		{
			if (!unk_0xCE990E643CD9D0E5(Local_73[iParam0 /*8*/].f_7, false) && iLocal_71 == 1)
			{
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (func_236(&uLocal_205, cLocal_204, Local_73[iParam0 /*8*/][0], 8, 0, 0, 0))
					{
						unk_0xBE20AB8238688965(&(Local_73[iParam0 /*8*/].f_7), false);
					}
				}
			}
		}
		...
		{
			if ((unk_0xCE990E643CD9D0E5(Local_73[iParam0 /*8*/].f_7, false) && !unk_0xCE990E643CD9D0E5(Local_73[iParam0 /*8*/].f_7, true)) && iLocal_71 == 1)
			{
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (func_236(&uLocal_205, cLocal_204, Local_73[iParam0 /*8*/][1], 7, 0, 0, 0))
					{
						unk_0xBE20AB8238688965(&(Local_73[iParam0 /*8*/].f_7), true);
					}
				}
			}
			if (!unk_0xCE990E643CD9D0E5(Local_73[iParam0 /*8*/].f_7, 5))
			{
				if (func_235(bLocal_200, Local_186, 1) < 15f && iLocal_71 == 1)
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
	...
	if (!unk_0xCE990E643CD9D0E5(Local_73[iParam0 /*8*/].f_7, iParam1))
	{
		if (iLocal_375 != -1)
		{
			if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
			{
				...
				{
					unk_0xBE20AB8238688965(&(Local_73[iParam0 /*8*/].f_7), bParam1);
				}
			}
		}
...
{
	if ((unk_0xCE990E643CD9D0E5(Local_73[0 /*8*/].f_7, iParam0) || unk_0xCE990E643CD9D0E5(Local_73[1 /*8*/].f_7, bParam0)) || unk_0xCE990E643CD9D0E5(Local_73[2 /*8*/].f_7, bParam0))
	{
		return 1;
	}
	return 0;
...
float func_235(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_238()
{
	if (func_107(unk_0x9B0761B4C3EB8BC7(), Local_186, 220f))
	{
		...
		{
			iLocal_203 = func_153(&sLocal_202, joaat("cavalcade2"), 1370.912f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
...
void func_242(var uParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_243(uParam0, bParam1, 0f, 0f, 0f, bParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_243(var uParam0, bool bParam1, struct<3> Param2, bool bParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	func_244(uParam0, bParam1, Param2, bParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_244(var uParam0, bool bParam1, struct<3> Param2, bool bParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	uParam0->f_6 = 2;
	func_245(uParam0, bParam1, Param2, bParam3, iParam4, bParam5, uParam6, bParam7);
}
...
void func_245(var uParam0, bool bParam1, struct<3> Param2, bool bParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_268(bParam1) && ENTITY::IS_ENTITY_VISIBLE(bParam1))
	{
		iVar1 = 0;
...
int func_250(bool bParam0)
{
	if (!func_251(1, 1, 0))
	{
		if ((!CAM::IS_SCREEN_FADED_OUT(bParam0) && func_146(bParam0)) || func_146("CMN_HINT"))
		{
			unk_0xD289B55B6AADBA10(1);
		}
		return 0;
...
int func_251(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_258() || func_257(Global_4456448.f_129348)) || func_256())
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(bVar0, iVar1) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("apc") && iVar1 != -1)) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("akula") && iVar1 != -1)) || (((MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("riot2") && iVar1 == 0) && func_254(bVar0, 10)) && unk_0x7F8B14CBFB9813E5(bVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_263(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_266(bParam1, bParam2, bParam3) || SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1) || func_264(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_284()
{
	...
	if (MISC::IS_BIT_SET(iVar0))
	{
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			func_285(bVar0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bVar0, 1), ENTITY::IS_ENTITY_IN_WATER(bVar0), 24, 0);
		}
	}
}

void func_285(bool bParam0, struct<3> Param1, bool bParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (MISC::IS_BIT_SET(iParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		func_320(iParam3, &Var0, Param1, bParam2, func_326(bParam0));
		func_286(iParam3, bParam0, 0);
	}
}
...
void func_287(bool bParam0, int iParam1)
{
	...
	func_327(bParam0, &(Global_111858.f_32745.f_5510));
}

int func_288(bool bParam0)
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_303(bParam0, 0, 0)) || func_303(bParam0, 1, 0)) || func_303(bParam0, 2, 0)) || func_326(bParam0) != 145) || func_302(bParam0)) || func_301(bParam0)) || func_300(bParam0)) || func_299(bParam0)) || !func_289(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_301(bParam0))
		{
		}
...
int func_289(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_290(fParam0, 0))
	{
		return 0;
	}
...
int func_290(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
int func_303(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
var func_306()
{
	...
	func_307(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_312(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
void func_320(int iParam0, var uParam1, struct<3> Param2, bool bParam3, int iParam4)
{
	if (func_317(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
void func_334()
{
	if (!iLocal_188)
	{
		if (func_37(bLocal_200))
		{
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_200, 0))
			{
				func_66(bLocal_200, -1);
				func_65(bLocal_200, 318);
				iLocal_188 = 1;
			}
		}
	}
...
void func_338()
{
	...
	{
		iVar1 = 0;
		if (!func_157(unk_0x9B0761B4C3EB8BC7(), bLocal_200, fVar0, 1))
		{
			iVar1++;
		}
...
int func_355(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (MISC::SET_BIT())
	{
		if (func_350() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_348(func_349(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
