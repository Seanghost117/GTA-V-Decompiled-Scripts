...
void func_51()
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				uLocal_58[iVar1] = unk_0x79CC07752E7432A1(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, 1, 1, 0);
				unk_0xCBF81D3222C77066(uLocal_58[iVar1], -335.66f, -95.24f, 46.16f, 0, 0, 1);
				unk_0xC82085403E46A869(uLocal_58[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
				break;
			
			case 2:
				uLocal_58[iVar1] = unk_0x79CC07752E7432A1(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, 1, 1, 0);
				unk_0xCBF81D3222C77066(uLocal_58[iVar1], -336.04f, -94.9f, 46.02f, 0, 0, 1);
				unk_0xC82085403E46A869(uLocal_58[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
				break;
			
			case 3:
				uLocal_58[iVar1] = unk_0x79CC07752E7432A1(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, 1, 1, 0);
				unk_0xCBF81D3222C77066(uLocal_58[iVar1], -336.34f, -95.66f, 46.02f, 0, 0, 1);
				unk_0xC82085403E46A869(uLocal_58[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
				break;
		}
		iVar0++;
	}
		...
		switch (iLocal_47)
		{
			...
			case 1:
				if (func_56())
				{
					...
					{
						if (unk_0x33DA7244053AB66E(1106247680, 31086, 1061997773, 1060320051, 1048576000, 1090519040, 1051361018, 31086, 24818) == iLocal_48)
						{
...
int func_57()
{
	...
	else
	{
		...
		{
			iLocal_48 = unk_0xB3116B49FE00E2F1(26, joaat("u_m_m_streetart_01"), Local_49, fLocal_50, 1, 1);
			unk_0x74528AC0906CBABE(joaat("u_m_m_streetart_01"));
			uLocal_58[0] = unk_0x79CC07752E7432A1(joaat("prop_cs_spray_can"), Local_59, 1, 1, 0);
			unk_0xF8A652CE310FFC53(uLocal_58[0], iLocal_48, unk_0xE6B87C42793036AA(iLocal_48, 28422), 0f, -0.01f, -0.02f, Local_66, 1, 1, 0, 0, 2, 1);
...
void func_72()
{
	...
	if (func_50(iLocal_48))
	{
		...
		Var2 = { unk_0x3E4D3CCC220BDFB1(iLocal_48, 0) };
		fVar4 = 7.5f;
		Var5 = { fVar4, fVar4, fVar4 };
		if (bVar1)
		{
			Var3 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0) };
			bVar6 = unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0);
		...
		switch (iLocal_51)
		{
			...
			case 1:
				...
				if (func_82(unk_0x9B0761B4C3EB8BC7(), iLocal_48, 35f))
				{
					...
					unk_0x9B6EC2CECE1010EF(iLocal_48, uLocal_68);
			...
			case 4:
				unk_0x6AC7395A8E313A46(iLocal_48, 8, 1);
				unk_0x6AC7395A8E313A46(iLocal_48, 32, 1);
				unk_0x9DC06E2A59C5AEBB(&uLocal_68);
			...
			case 5:
				...
				if (!unk_0xA38BFCB05DBE439D(iLocal_48) && SYSTEM::VDIST2(Var2, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0)) > 2500f)
				{
					uLocal_67 = unk_0xF898EA06B9458004(Var3, Var2, 1, 0, 7);
					iLocal_51++;
				}
				break;
			...
			case 6:
				...
				iVar13 = unk_0x0F0E6A09A9C90474(uLocal_67, &iVar9, &uVar10, &uVar11, &uVar12);
				if (iVar13 == 2)
				{
					if (iVar9 == 1)
					{
...
int func_73()
{
	...
	switch (iLocal_56)
	{
		case 0:
			...
			else if (unk_0x9934470AA0A08B57(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				...
				if (fLocal_54 != 0.2f)
				{
					...
					Local_57 = { unk_0x3E4D3CCC220BDFB1(iLocal_48, 0) - Vector(1f, 0f, 0f) };
					iLocal_56 = 1;
				}
				else
				{
		...
		case 1:
			...
			func_76(&uLocal_53);
			func_75();
			if (unk_0xAE06B9E39EBDE049(uLocal_58[0]))
			{
				unk_0x1F8106DB8796859F(uLocal_58[0], 1, 1);
			}
			iLocal_56++;
			break;
		...
		case 2:
			if (unk_0x9934470AA0A08B57(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				...
				unk_0x03D382CB0B44E2FC(iLocal_48, Var7, 0, 1, 0, 1);
				if (fVar5 == 0.161f)
				{
					unk_0x6A8F948698B360B4(iLocal_48, 0);
					return 1;
...
void func_79()
{
	if (iLocal_60 == 0)
	{
		iLocal_60 = unk_0xF245B4695C9BEF04(sLocal_61, uLocal_58[0], Local_66, Local_66, 1065353216, 0, 0, 0);
		unk_0xC313709BC7ED51D7(iLocal_60, 1f, 1f, 1f, 0);
