...
int func_32(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<14> Var0;
...
void func_49(bool bParam0, struct<3> Param1, float fParam2)
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				...
				ENTITY::DETACH_ENTITY(iLocal_58[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
				break;
			...
			case 2:
				...
				ENTITY::DETACH_ENTITY(iLocal_58[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
				break;
			...
			case 3:
				...
				ENTITY::DETACH_ENTITY(iLocal_58[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_55()
{
	...
	else if (iLocal_46 == 2)
	{
		...
		{
			if (VEHICLE::GET_VEHICLE_MOD(bLocal_48, 1))
			{
				func_150();
			}
		}
		...
		switch (iLocal_47)
		{
			...
			case 1:
				if (func_56())
				{
					...
					{
						if (CAM::GET_FOCUS_PED_ON_SCREEN(30f, 31086, 0.8f, 0.7f, 0.25f, 8f, 0.333f, 31086, 24818) == bLocal_48)
						{
...
int func_57()
{
	...
	else
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(joaat("u_m_m_streetart_01")))
		{
			bLocal_48 = PED::CREATE_PED(26, joaat("u_m_m_streetart_01"), Local_49, fLocal_50, true, true);
			...
			OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_58[0], bLocal_48, ENTITY::ATTACH_ENTITY_TO_ENTITY(bLocal_48, 28422), 0f, -0.01f, -0.02f, Local_66, 1, 1, 0, 0, 2, 1);
			PED::SET_PED_KEEP_TASK(bLocal_48, true);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_48, 5.885454E-44f, 1);
			uLocal_53 = func_68(bLocal_48, 0, 145);
			func_58(1);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_48, 1862763509);
			PED::SET_PED_LOD_MULTIPLIER(bLocal_48, 2.5f);
		}
	}
	return 0;
}
...
bool func_69(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_70(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_70(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
void func_72()
{
	...
	if (func_50(bLocal_48))
	{
		...
		Var2 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_48, 0) };
		fVar4 = 7.5f;
		Var5 = { fVar4, fVar4, fVar4 };
		if (bVar1)
		{
			Var3 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0) };
			bVar6 = SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0);
			bVar7 = PED::IS_PED_IN_ANY_HELI(unk_0x9B0761B4C3EB8BC7());
		}
		if (iLocal_51 < 3)
		{
		...
		switch (iLocal_51)
		{
			case 0:
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_62))
				{
					...
					TASK::TASK_PLAY_ANIM(bLocal_48, sLocal_62, sLocal_63, 1000f, -8f, -1, 8193, 0f, false, false, false);
					iLocal_51++;
				}
				break;
			...
			case 1:
				...
				if (func_82(unk_0x9B0761B4C3EB8BC7(), bLocal_48, 35f))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_68);
					TASK::TASK_PLAY_ANIM(false, sLocal_62, sLocal_64, 8f, -8f, -1, 8192, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(false, sLocal_62, sLocal_65, 8f, -2f, -1, 8193, 0f, false, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_68);
					AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_48, iLocal_68);
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_82(unk_0x9B0761B4C3EB8BC7(), bLocal_48, fVar8))
				{
					iLocal_51 = 3;
				}
				if (iLocal_52)
			...
			case 4:
				PED::SET_PED_FLEE_ATTRIBUTES(bLocal_48, 8, true);
				PED::SET_PED_FLEE_ATTRIBUTES(bLocal_48, 32, true);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_68);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 800);
				TASK::TASK_SMART_FLEE_PED(0, unk_0x9B0761B4C3EB8BC7(), 9999f, -1, true, false);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_68);
				AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_48, iLocal_68);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_68);
				iLocal_51++;
			...
			case 5:
				...
				if (!ENTITY::IS_ENTITY_ON_SCREEN(bLocal_48) && SYSTEM::VDIST2(Var2, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0)) > 2500f)
				{
	...
	else if (MISC::IS_BIT_SET(bLocal_48))
	{
		ENTITY::SET_ENTITY_COORDS(bLocal_48, 0);
	}
}
...
int func_73()
{
	...
	{
		case 0:
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_48, sLocal_62, sLocal_65, 3))
			{
				fLocal_54 = 0.349f;
				iLocal_55 = 900;
				Local_57 = { Var0 };
			...
			else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_48, sLocal_62, sLocal_64, 3))
			{
				fLocal_54 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_48, sLocal_62, sLocal_64);
				...
				if (fLocal_54 != 0.2f)
				{
					...
					Local_57 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_48, 0) - Vector(1f, 0f, 0f) };
					iLocal_56 = 1;
				}
				else
				{
		...
		case 1:
			...
			TASK::TASK_PLAY_ANIM(bLocal_48, sLocal_62, sLocal_64, 4f, -8f, -1, 0, fLocal_54, true, false, false);
			iLocal_69 = MISC::GET_GAME_TIMER();
			func_76(&uLocal_53);
			func_75();
			if (MISC::IS_BIT_SET(iLocal_58[0]))
			{
				ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(iLocal_58[0], 1, 1);
			}
			iLocal_56++;
			break;
		
		case 2:
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_48, sLocal_62, sLocal_64, 3))
			{
				...
				ENTITY::SET_ENTITY_ANIM_CURRENT_TIME(bLocal_48, sLocal_62, sLocal_64, fVar5);
				fVar6 = (fVar4 - 0.12f);
				fVar6 = func_77(fVar6, 0f, 0.8f);
				Var7 = { func_74(Local_57, Var1, fVar6) };
				unk_0x03D382CB0B44E2FC(bLocal_48, Var7, 0, 1, 0, 1);
				if (fVar5 == 0.161f)
				{
					ENTITY::SET_ENTITY_COORDS(bLocal_48, 0);
					return 1;
...
void func_78()
{
	...
	if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_48, sLocal_62, sLocal_64, 3))
	{
		fVar0 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_48, sLocal_62, sLocal_64);
		if (fVar0 < 0.383793f)
		{
			func_75();
		}
	...
	else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_48, sLocal_62, sLocal_65, 3))
	{
		fVar0 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_48, sLocal_62, sLocal_65);
		if (fVar0 < 0.1124f)
		{
			func_75();
		}
...
bool func_80(struct<3> Param0, struct<3> Param1)
{
	...
	bVar2 = SYSTEM::VDIST(Param0, Param1);
	fVar3 = (func_77((30f - bVar2), 0f, 30f) / 30f);
	fVar4 = (fVar1 * fVar3);
	return fVar4 > 0.25f;
}
...
int func_82(bool bParam0, bool bParam1, float fParam2)
{
	...
	if (MISC::IS_BIT_SET(iParam0) && MISC::IS_BIT_SET(bParam1))
	{
		...
		return SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam1, 0)) <= fVar0;
	}
	return 0;
}
...
int func_83(int iParam0)
{
	...
	{
		func_76(&uLocal_53);
		TASK::TASK_SMART_FLEE_PED(bLocal_48, unk_0x9B0761B4C3EB8BC7(), 9999f, -1, true, false);
		return 1;
	}
	return 0;
}
...
int func_95(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_149())
			{
				return 0;
			}
		}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_130()) || Global_110905) || Global_30970) || func_129()) || func_128(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_130() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_128(8, -1)) || func_124()) || func_123()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
