...
void __EntryFunction__()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("ob_jukebox")) > 1)
	{
		func_206(0);
	}
	...
	while (true)
	{
		...
		if (iLocal_123 != 0 && !func_169(Local_149, 0f, 0f, 0f, 0))
		{
			if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
			{
				func_168();
		...
		else if (iLocal_128 != -1 && iLocal_128 <= 126)
		{
			...
			if (iLocal_128 == 126)
			{
				iLocal_123 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_147, 2f, joaat("ch_prop_arcade_jukebox_01a"), true, false, false);
			}
			else
			{
				iLocal_123 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_147, 2f, joaat("bkr_prop_clubhouse_jukebox_01a"), true, false, false);
			}
			if (MISC::IS_BIT_SET(iLocal_123))
			{
				Local_148 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_123, 1) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_123) * Vector(0.6f, 0.6f, 0.6f) };
				Local_148.f_2 = (Local_148.f_2 + 0.5f);
				Local_149 = { unk_0x7EC595B99EA7C4B1(iLocal_123, 0f, -0.12f, -0.0315f) };
			}
		}
		else
		{
...
{
	Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_349 = uParam0;
}
...
void func_21()
{
	...
	bVar0 = func_170();
	if (Local_150.f_3 != iLocal_125)
	{
		func_175(Local_150.f_3);
		if (iLocal_124 == PLAYER::PLAYER_ID() && Local_150.f_4)
		{
			if (iLocal_128 == 126)
			{
	...
	{
		func_172(bVar0);
		if ((iLocal_124 == PLAYER::PLAYER_ID() && Local_150.f_4) && !bVar0)
		{
			if (iLocal_128 == 126)
			{
	...
	switch (iLocal_140)
	{
		case 0:
			if (func_159() && func_158())
			{
				...
				else if ((iLocal_130 != -1 && func_154(iLocal_130, 1)) && !unk_0x4D71E6F618DC5C0E(unk_0x9B0761B4C3EB8BC7()))
				{
					...
					unk_0xBE20AB8238688965(&(Local_151[PLAYER::PLAYER_ID() /*3*/]), 0);
			...
			{
				func_151(&iLocal_130);
				VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_2515369, 3);
			}
		...
		case 2:
			if (Local_150.f_2 == PLAYER::PLAYER_ID() && func_138())
			{
				iLocal_131 = 0;
				func_153(1);
				VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_151[PLAYER::PLAYER_ID() /*3*/]), false);
				unk_0xBE20AB8238688965(&(Local_151[PLAYER::PLAYER_ID() /*3*/]), 1);
				func_137(&uLocal_143);
			}
			else if (Local_150.f_2 != -1 || !func_138())
			{
				func_153(0);
				VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_151[PLAYER::PLAYER_ID() /*3*/]), false);
				VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_2515369, 4);
		...
		case 1:
			if (func_132())
			{
				...
				func_153(3);
				if (!MONEY::_NETWORK_CASINO_CAN_PURCHASE_CHIPS_WITH_PVC_2(1, 0, 0, 0, -1, 0))
				{
					iLocal_139 = 1;
				}
			}
		...
		case 3:
			if (unk_0xCE990E643CD9D0E5(uLocal_133, 4))
			{
				if (func_131())
				{
					VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_133, 4);
				}
			}
			func_42();
			break;
		...
		case 4:
			...
			{
				VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_133, 3);
				func_39(1, -1);
			}
			fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_132);
			if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), sLocal_138, "EXIT", 3))
			{
				func_30(unk_0xCE990E643CD9D0E5(uLocal_133, 5));
				if (iLocal_126 != -1)
				{
					if ((ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), sLocal_138, "INSERT_COINS", 3) && ENTITY::HAS_ANIM_EVENT_FIRED(fVar0) >= 0.82f) || !unk_0xCE990E643CD9D0E5(uLocal_133, 5))
					{
						func_29(iLocal_126);
					}
				}
			}
			else if (ENTITY::HAS_ANIM_EVENT_FIRED(fVar0) >= 0.96f)
			{
				VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_133, 5);
				VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_133, 4);
				VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_151[PLAYER::PLAYER_ID() /*3*/]), true);
				VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_151[PLAYER::PLAYER_ID() /*3*/]), 2);
				VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_151[PLAYER::PLAYER_ID() /*3*/]), 3);
				func_141(PLAYER::PLAYER_ID(), 1, 0, 0);
				VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_2515369, 4);
				iLocal_139 = 0;
				if (iLocal_128 == 126)
...
void func_29(int iParam0)
{
	...
	unk_0xBE20AB8238688965(&(Local_151[PLAYER::PLAYER_ID() /*3*/]), 2);
}
...
int func_38(char* sParam0, bool bParam1, float fParam2)
{
	float fVar0;
	...
	{
		if ((!PED::DETACH_SYNCHRONIZED_SCENE(fVar0) || ENTITY::HAS_ANIM_EVENT_FIRED(fVar0) >= 0.96f) || bParam1)
		{
			if (PED::DETACH_SYNCHRONIZED_SCENE(fLocal_132))
			{
				NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(fLocal_132);
				fLocal_132 = -1;
			}
			fLocal_132 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Local_149, NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(iLocal_123, 2), 2, 0, fParam2, 1065353216, 0, 1065353216);
			NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), fLocal_132, sLocal_138, sParam0, 4f, -2f, 5, 0, 2f, 0);
			unk_0xB88AF19828BF16ED(fLocal_132);
			return 1;
		}
	}
	return 0;
...
void func_42()
{
	if (!func_130())
	{
		...
		if (func_97("SNK_MNU", -1, 1))
		{
			...
			{
				func_86();
				VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_133, true);
			}
			else
			{
		...
		if (iVar5 == 1 && Global_22550.f_5728)
		{
			...
			else
			{
				if (Global_22550)
				{
					...
					{
						func_65(Global_22547, Global_22548, fParam5, (fVar55 - 0f), 0, 0, 0, 255);
				...
				func_65(Global_22547, (Global_22548 + fVar55), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
				...
				{
					func_64();
					func_62((((Global_22547 + fParam5) - 0.00390625f) - func_63("CM_ITEM_COUNT", Global_22550.f_5736, Global_22550.f_5737)), ((Global_22548 + fVar55) + 0.00416664f), "CM_ITEM_COUNT", Global_22550.f_5736, Global_22550.f_5737);
				}
				else if (Global_22550.f_5731 > Global_22550.f_5225)
				{
					...
					{
						func_64();
						func_62((((Global_22547 + fParam5) - 0.00390625f) - func_63("CM_ITEM_COUNT", Global_22550.f_5734, Global_22550.f_5733)), ((Global_22548 + fVar55) + 0.00416664f), "CM_ITEM_COUNT", Global_22550.f_5734, Global_22550.f_5733);
					}
				}
			}
			...
			if (Global_22550.f_5731 > Global_22550.f_5225)
			{
				...
				func_65(Global_22547, (fVar49 + 0f), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
			...
			if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Global_22550.f_4690)) != 0 && Global_22550.f_4766 != -1)
			{
				...
				func_65(Global_22547, (fVar49 - 0.00277776f), fParam5, 0.00277776f, iVar1, iVar2, iVar3, iVar4);
				...
				{
					func_75(Global_22550.f_4768, 1, 1, &fVar36, &fVar37, bParam7);
					func_60(Global_22550.f_4768, 1, &iVar45, &iVar46, &iVar47, &iVar48);
					GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4768), func_66(Global_22550.f_4768, 1), ((Global_22547 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false);
				}
			...
			if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Global_4269680.f_21)) != 0 && Global_4269680.f_65 != -1)
			{
				...
				{
					func_75(Global_4269680.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_60(Global_4269680.f_67, 1, &iVar45, &iVar46, &iVar47, &iVar48);
					GRAPHICS::DRAW_SPRITE(func_69(Global_4269680.f_67), func_66(Global_4269680.f_67, 1), ((Global_22547 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false);
				}
				fVar49 = (fVar49 + (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
						...
						switch (Global_22550.f_5056[iVar8])
						{
								...
								if (bVar33)
								{
									if (!Global_22550.f_5729)
									{
										...
										if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Global_22550.f_73[iVar24 /*6*/])) != 0)
										{
											...
											func_51(bVar32, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar53, iVar74, bVar51, bVar50);
									...
									if (bVar52)
									{
										if (func_75(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_75(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_69(26), func_66(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false);
												}
											}
										}
										if (func_75(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_75(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_69(27), func_66(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false);
												}
											}
										}
									}
									...
									if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Global_22550.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										func_51(bVar32, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar53, 0, bVar51, bVar50);
										...
										else if (Global_22550.f_2124[iVar24 /*5*/][iVar14] == 4)
										{
											if ((Global_22550.f_4433[(iVar22 + iVar28)] == 2 || Global_22550.f_4433[(iVar22 + iVar28)] == 51) || Global_22550.f_4433[(iVar22 + iVar28)] == 61)
											{
												if (func_75(Global_22550.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													{
														func_60(Global_22550.f_4433[(iVar22 + iVar28)], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
														if (iVar5 == 1)
														{
															if (Global_22550.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[(iVar22 + iVar28)]), func_66(Global_22550.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[(iVar22 + iVar28)]), func_66(Global_22550.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false);
															}
														}
									...
									if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Global_22550.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_49() && INTERIOR::GET_INTERIOR_AT_COORDS(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
													func_51(0, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar53, 0, bVar51, bVar50);
											...
											if ((Global_22550.f_4433[(iVar22 + iVar14)] != 2 && Global_22550.f_4433[(iVar22 + iVar14)] != 51) && Global_22550.f_4433[(iVar22 + iVar14)] != 61)
											{
												if (func_75(Global_22550.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														...
														{
															func_60(Global_22550.f_4433[(iVar22 + iVar14)], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
															if (Global_22550.f_4433[(iVar22 + iVar14)] == 30)
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[(iVar22 + iVar14)]), func_66(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), (Global_22547 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false);
															}
															else if (Global_22550.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[(iVar22 + iVar14)]), func_66(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[(iVar22 + iVar14)]), func_66(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false);
															}
														}
													}
							...
							case 2:
								if (bVar33)
								{
									if (!Global_22550.f_5729)
									{
										func_51(bVar32, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar53, 0, 0, 0);
										if (Global_22550.f_8413 && Global_22550.f_8414 == iVar6)
										{
											func_50(bVar32);
										}
									...
									{
										func_51(bVar32, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar53, 0, 0, 0);
										func_48((fVar34 + fVar40), fVar35, "NUMBER", Global_22550.f_3918[iVar20], 0);
									}
								}
								bVar39 = true;
								iVar20++;
							...
							case 3:
								if (bVar33)
								{
									...
									func_51(bVar32, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar53, 0, 0, 0);
									func_47((fVar34 + fVar40), fVar35, "NUMBER", Global_22550.f_4175[iVar21], Global_22550.f_4304[iVar21]);
								}
								bVar39 = true;
								iVar21++;
								break;
								...
								if (bVar33)
								{
									if (func_75(Global_22550.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											...
											{
												func_60(Global_22550.f_4433[iVar22], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
												GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[iVar22]), func_66(Global_22550.f_4433[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_46(Global_22550.f_4433[iVar22])), (fVar37 * func_46(Global_22550.f_4433[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, false);
											}
										}
									}
								}
...
void func_47(char* sParam0, float fParam1, char* sParam2, int iParam3, int iParam4)
{
...
void func_48(char* sParam0, float fParam1, char* sParam2, int iParam3, int iParam4)
{
	NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(sParam2);
...
void func_62(char* sParam0, float fParam1, char* sParam2, int iParam3, int iParam4)
{
	NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(sParam2);
...
float func_63(bool bParam0, int iParam1, int iParam2)
{
...
int func_75(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	...
	if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&cVar1) != 0)
	{
		...
		Var7.x = (Var7.x * (func_76(iParam0) / fVar4));
		Var7.f_1 = (Var7.f_1 * (func_76(iParam0) / fVar4));
		if (!bParam2)
		{
			Var7.x = (Var7.x - 2f);
...
int func_77(bool bParam0, bool bParam1)
{
	...
	if ((((((((!GRAPHICS::DRAW_SCALEFORM_MOVIE() || (func_79(8, -1) && func_78() != 65)) || (GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN() != 0 && !bParam1)) || (LOCALIZATION::GET_CURRENT_LANGUAGE() && !bParam0)) || NETWORK::IS_COMMERCE_STORE_OPEN()) || Global_77093) || Global_22550.f_8416) || CAM::IS_SCREEN_FADED_IN()) || Global_99007.f_1425)
	{
		return 0;
	}
	return 1;
...
void func_83()
{
	...
	if (iLocal_127 == Local_150.f_3 && func_170())
	{
...
void func_95(float fParam0, char* sParam1, int iParam2)
{
	char* sVar0;
...
void func_99()
{
	...
	bVar7 = (PAD::IS_DISABLED_CONTROL_PRESSED(2, 202) || PAD::IS_CONTROL_JUST_PRESSED(2, 202));
	...
	if (!unk_0xCE990E643CD9D0E5(uLocal_133, 0))
	{
		...
		{
			bVar2 = (iVar0 < 100 || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 188));
			bVar3 = (iVar0 > 150 || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 187));
			bVar4 = PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 52);
			bVar5 = PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 51);
		}
	...
	{
		func_137(&uLocal_141);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_133, false);
	}
	if (bVar3)
	{
		iLocal_127++;
...
void func_100(int iParam0)
{
	...
	if (func_5(iLocal_128, -1))
	{
		fVar0 = AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(func_115(iParam0));
	}
	else if (iLocal_128 == 126)
	{
		fVar0 = AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(func_114(iParam0));
	}
	if (MONEY::_NETWORK_CASINO_CAN_PURCHASE_CHIPS_WITH_PVC_2(1, 0, 0, 1, -1, 0))
	{
		if (func_113())
		{
			func_101(1976384368, 1, &iVar1, 0, 0, 1);
			Global_4264051[iVar1 /*85*/] = fVar0;
		}
		else
		{
			MONEY::_0x5BCDE0F640C773D2(1, fVar0, 0, 0);
		}
	}
}
...
void func_116(float fParam0)
{
	...
	unk_0xBE20AB8238688965(&(Local_151[PLAYER::PLAYER_ID() /*3*/]), 3);
}
...
{
	if (ENTITY::GET_ENTITY_HEADING() && !GRAPHICS::SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU())
	{
		if (unk_0x3430895AB97DE4F3(2))
		{
			...
			{
				MONEY::NETWORK_MONEY_CAN_BET(1, true, true);
				MONEY::NETWORK_MONEY_CAN_BET(1, 2, true);
			}
			func_124(0, 0, 0, 1);
			func_123(0, -1, 1);
		}
		...
		if (func_120(0, 0, 0) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 188))
		{
			*uParam0 = 1;
		}
		if (func_119(0, 0, 0) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 187))
		{
			*uParam1 = 1;
		}
...
int func_132()
{
	...
	switch (iLocal_131)
	{
		case 0:
			...
			if (!func_136(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Var0, 0.8f, 0))
			{
				if (!func_133(unk_0x9B0761B4C3EB8BC7(), 2106541073))
				{
					HUD::_THEFEED_DISABLE(unk_0x9B0761B4C3EB8BC7(), Var0, 1f, 4000, ENTITY::IS_ENTITY_IN_WATER(iLocal_123), 0.125f);
				}
			}
			else
			{
...
int func_136(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
	...
	else
	{
		...
		if (AUDIO::PLAY_STREAM_FROM_VEHICLE(iParam0) && (ENTITY::IS_ENTITY_AT_COORD(iParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				...
				if (!func_145(fVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(fVar27))
				{
					if (!bVar22)
					{
...
int func_158()
{
	if (func_170() || MONEY::_NETWORK_CASINO_CAN_PURCHASE_CHIPS_WITH_PVC_2(1, 0, 0, 0, -1, 0))
	{
		return 1;
	}
	return 0;
...
int func_159()
{
	...
	if ((((((((((((((!unk_0xCE990E643CD9D0E5(Global_2515369, 5) && !func_166()) && !func_36(0)) && !func_165()) && !PED::IS_PED_IN_COVER(unk_0x9B0761B4C3EB8BC7(), false)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(unk_0x9B0761B4C3EB8BC7()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_123)) && unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_148, 0.55f, 0.8f, 1.5f, 0, 1, 1)) && !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), sLocal_138, "EXIT", 3)) && !func_164(PLAYER::PLAYER_ID())) && !func_163()) && iVar0) && !unk_0xCE990E643CD9D0E5(Global_1678288.f_4, 2)) && func_160(unk_0x9B0761B4C3EB8BC7()) <= 9) && !Global_2405074.f_2674) && !MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7()))
	{
		return 1;
	}
	return 0;
...
void func_168()
{
	if (func_163())
	{
		if (unk_0xCE990E643CD9D0E5(Local_151[Local_150.f_2 /*3*/], 2))
		{
			if (Local_151[Local_150.f_2 /*3*/].f_1 == iLocal_137)
			{
				if (func_170())
				{
					Local_150 = 0;
					Local_150.f_3 = iLocal_137;
					if (iLocal_124 == Local_150.f_2)
					{
						Local_150.f_4 = 1;
					}
				}
			}
			else if (Local_150.f_3 != Local_151[Local_150.f_2 /*3*/].f_1)
			{
				Local_150.f_3 = Local_151[Local_150.f_2 /*3*/].f_1;
				if (iLocal_124 == Local_150.f_2)
				{
					Local_150.f_4 = 1;
				}
		...
		if (unk_0xCE990E643CD9D0E5(Local_151[Local_150.f_2 /*3*/], 3))
		{
			if (Local_150.f_1 != Local_151[Local_150.f_2 /*3*/].f_2)
			{
				Local_150.f_1 = Local_151[Local_150.f_2 /*3*/].f_2;
			}
		}
		if (!unk_0xCE990E643CD9D0E5(Local_151[Local_150.f_2 /*3*/], 1) && !unk_0xCE990E643CD9D0E5(Local_151[Local_150.f_2 /*3*/], 0))
		{
			Local_150.f_2 = -1;
		}
	}
	else if (unk_0xCE990E643CD9D0E5(Local_151[iLocal_129 /*3*/], 0))
	{
		if (!func_163())
		{
			Local_150.f_2 = iLocal_129;
		}
	}
	if (!func_163())
	{
		if (iLocal_128 == 126)
		{
			if (Global_1590682[iLocal_124 /*883*/].f_274.f_350 == Local_150.f_3 && (!func_170() && Global_1590682[iLocal_124 /*883*/].f_274.f_350 == iLocal_137))
			{
				Local_150.f_4 = 0;
			}
		}
		else if (Global_1590682[iLocal_124 /*883*/].f_274.f_348 == Local_150.f_3 && (!func_170() && Global_1590682[iLocal_124 /*883*/].f_274.f_348 == iLocal_137))
		{
			Local_150.f_4 = 0;
		}
	}
...
void func_172(bool bParam0)
{
	...
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_133, 6);
	}
	if (func_5(iLocal_128, -1))
	{
...
{
	SCRIPT::GET_THIS_SCRIPT_NAME("DLC_H3_Arcade_Main_Area_Music_Emitter", bParam0);
	SCRIPT::GET_THIS_SCRIPT_NAME("DLC_H3_Arcade_Planning_Room_Radio_Emitter", bParam0);
}
...
void func_174(int iParam0, bool bParam1)
{
	if (func_4(iParam0) == 97)
	{
		SCRIPT::GET_THIS_SCRIPT_NAME("SE_bkr_biker_dlc_int_02_REC", bParam1);
		SCRIPT::GET_THIS_SCRIPT_NAME("SE_bkr_biker_dlc_int_02_GRG", bParam1);
		return;
	}
	else if (func_4(iParam0) == 91)
	{
		SCRIPT::GET_THIS_SCRIPT_NAME("SE_bkr_biker_dlc_int_01_BAR", bParam1);
		SCRIPT::GET_THIS_SCRIPT_NAME("SE_bkr_biker_dlc_int_01_GRG", bParam1);
		SCRIPT::GET_THIS_SCRIPT_NAME("SE_bkr_biker_dlc_int_01_REC", bParam1);
		return;
	}
}
...
void func_191()
{
	...
	if (MISC::SET_BIT() && !unk_0xCE990E643CD9D0E5(uLocal_133, 2))
	{
		...
		NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(32, 0, uVar0);
		func_195(0, -1, 0);
		WEAPON::GET_WEAPONTYPE_GROUP(0);
		MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(&Local_150, 5);
		NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_151, 97);
		if (!func_192())
		{
			func_206(0);
		}
...
void func_200()
{
	if (iLocal_128 == 126)
	{
		...
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_2515369, true);
			func_206(0);
		}
...
void func_207()
{
	...
	{
		if (((ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), sLocal_138, "IDLE", 3) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), sLocal_138, "EXIT", 3)) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), sLocal_138, "INSERT_COINS", 3)) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), sLocal_138, "SELECT_TRACK", 3))
		{
