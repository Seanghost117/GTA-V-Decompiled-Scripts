...
void __EntryFunction__()
{
	...
	else
	{
		if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
		{
			...
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
					{
						if (!unk_0xE0B3BC41DDA88DF0(iLocal_49[iVar0], bLocal_50, 0))
						{
							TASK::TASK_ENTER_VEHICLE(iLocal_49[iVar0], bLocal_50, -1, func_248(bLocal_50), 2f, 1, 0);
						}
					}
					else
					{
	...
	func_187();
	fLocal_59 = PATHFIND::SET_ROADS_IN_AREA(Local_63 + Vector(30f, 30f, 30f), Local_63 - Vector(30f, 30f, 30f), false, true, 1, 1);
	while (true)
	{
		SYSTEM::WAIT(0);
		func_184(&uLocal_123);
		if (!func_183())
		{
			...
			switch (iLocal_298)
			{
				case 0:
					if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !func_170())
					{
						if (func_161())
						{
							if ((iLocal_44 == 3 && !(CAM::IS_SPHERE_VISIBLE(Local_63, 3f) && func_160(unk_0x9B0761B4C3EB8BC7(), Local_63, 1) < 150f)) || iLocal_44 != 3)
							{
								if (iLocal_44 == 3)
								{
								...
								func_159();
								if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && iLocal_44 == 3)
								{
									VEHICLE::SET_VEHICLE_FORWARD_SPEED(bLocal_50, 5f);
								}
								SYSTEM::SETTIMERA(0);
								iLocal_298++;
							}
				...
				case 1:
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
					{
						if (((SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1)) < 10000f || !ENTITY::IS_ENTITY_OCCLUDED(bLocal_50)) || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_49[0]))) || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_49[1])))
						{
							iLocal_298++;
						}
					}
				...
				case 2:
					...
					if (MISC::IS_BIT_SET(bLocal_50) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
					{
						if (iLocal_44 == 3)
						{
							func_148();
							if (!ENTITY::IS_ENTITY_OCCLUDED(bLocal_50) && (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < 100f || func_158()))
							{
								func_139(1);
							}
						}
						else if (((!ENTITY::IS_ENTITY_OCCLUDED(bLocal_50) && iLocal_46 == 4) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_70, Local_71, fLocal_72, 0, 1, 0)) || func_158())
						{
							func_139(1);
						}
						if ((iLocal_46 == 4 && ENTITY::IS_ENTITY_OCCLUDED(bLocal_50)) && iLocal_44 != 3)
						{
							if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1)) > 100f)
							{
								func_231();
							}
							else
			...
			if (iLocal_298 > 0)
			{
				if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && ENTITY::IS_ENTITY_OCCLUDED(bLocal_50))
				{
					if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1)) > 62500f)
					{
						func_231();
					}
					if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1)) > 10000f && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
					{
						func_231();
					}
				}
		...
		else
		{
			...
			if (!SYSTEM::VMAG(uLocal_57))
			{
				...
				if (MISC::IS_BIT_SET(bLocal_52))
				{
					if (iLocal_299 != 0)
					{
						if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_52, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < SYSTEM::POW(50f, 2f))
						{
							iLocal_299 = 0;
				...
				else if (((bLocal_79 && !OBJECT::DOES_PICKUP_EXIST(iLocal_103)) && ENTITY::GET_ENTITY_COORDS(bLocal_50, false)) && !bLocal_89)
				{
					if (iLocal_299 != 1)
					{
						if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < SYSTEM::POW(50f, 2f))
						{
							iLocal_299 = 1;
							func_135(&uLocal_111, 0, 0);
						}
				...
				else if (OBJECT::DOES_PICKUP_EXIST(iLocal_103))
				{
					if (iLocal_299 != 2)
					{
						if (SYSTEM::VDIST2(OBJECT::GET_PICKUP_COORDS(iLocal_103), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < SYSTEM::POW(50f, 2f))
						{
							iLocal_299 = 2;
							func_135(&uLocal_111, 0, 0);
						}
				...
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_50, 1))
					{
				...
				if (((!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_50, 0) && bLocal_79) && !bLocal_81) && (!func_138(0) || (WEAPON::HAS_PED_GOT_WEAPON(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_stickybomb"), false) && !func_138(1))))
				{
					switch (iLocal_100)
					{
						case 0:
							if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < 225f)
							{
						...
						case 2:
							if ((MISC::GET_GAME_TIMER() - iLocal_101) > 2000 && WEAPON::HAS_PED_GOT_WEAPON(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_stickybomb"), false))
							{
			...
			switch (iLocal_46)
			{
				...
				case 7:
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]))
					{
					...
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]))
					{
					...
					if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[0], 0)) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1])) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[1], 0))
					{
						iLocal_95 = 1;
						func_79(iLocal_49[1]);
						func_77(0, 1);
					...
					{
						if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[1], 0))
						{
							iLocal_48 = 0;
							iLocal_95 = 0;
						}
					...
					{
						if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[0], 0))
						{
							iLocal_95 = -1;
						}
						else
			...
			if ((((ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) && MISC::IS_MINIGAME_IN_PROGRESS(bLocal_50, -1, 0) == unk_0x9B0761B4C3EB8BC7()) && !bLocal_83) && iLocal_46 != 8)
			{
				if (bLocal_79)
				{
					func_68(8);
			...
			if (bLocal_81)
			{
				if ((OBJECT::DOES_PICKUP_EXIST(iLocal_103) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) && SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), OBJECT::GET_PICKUP_COORDS(iLocal_103)) > 250f)
				{
					func_68(9);
				}
			}
			...
			else
			{
				iVar1 = 1;
				iVar2 = 0;
				if (MISC::IS_BIT_SET(iLocal_49[iVar2]))
				{
					if ((!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[iVar2], 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar2])) && SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[0], 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < 10000f)
					{
						iVar1 = 0;
					}
				}
				if (MISC::IS_BIT_SET(bLocal_50))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
					{
						if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_50, 0))
						{
							iVar3 = 1;
						}
					}
					if ((SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) > 10000f && ENTITY::IS_ENTITY_OCCLUDED(bLocal_50)) || SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) > 62500f)
					{
						iVar3 = 1;
					}
				}
		...
		if (((MISC::GET_GAME_TIMER() - iLocal_93) > 10000 && AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) && !iLocal_92)
		{
			bVar4 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 3);
			if (bVar4 == 0)
			{
		...
		if (bLocal_78)
		{
			if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) || !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(func_3(), 1)) < SYSTEM::POW(50f, 2f))
				{
					...
					PLAYER::SET_PLAYER_WANTED_CENTRE_POSITION(PLAYER::PLAYER_ID(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1));
				}
			}
		}
		if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) == 0 && func_2())
		{
			PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_ID(), 2, false);
			PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), false);
		}
		...
		if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			if (VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(bLocal_50, 0) > 0f || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(bLocal_50, 1) > 0f)
			{
				if (VEHICLE::GET_VEHICLE_DOOR_LOCK_STATUS(bLocal_50) == 3)
				{
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_50, 1);
				}
			}
			if (!bLocal_82)
			{
			...
			if (!bLocal_82)
			{
				if (VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(bLocal_50, 0) == 0f && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(bLocal_50, 1) == 0f)
				{
					if (VEHICLE::GET_VEHICLE_DOOR_LOCK_STATUS(bLocal_50) == 1)
					{
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_50, 3);
					}
				}
			}
		}
		...
		if (MISC::IS_BIT_SET(bLocal_52))
		{
			...
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar5]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[iVar5], 0))
				{
					if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_52, iLocal_49[iVar5]))
					{
						if (iLocal_46 == 1)
						{
							if (!iLocal_300[iVar5])
		...
		else
		{
			...
			while (iVar5 < iLocal_49)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar5]))
				{
					if (iLocal_300[iVar5] || iLocal_301[iVar5])
					{
						iLocal_300[iVar5] = 0;
		...
		{
			if (((((MISC::IS_BIT_SET(bLocal_52) && ENTITY::IS_ENTITY_ATTACHED(bLocal_52)) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iLocal_96])) && !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_49[iLocal_96], "random@security_van", "sec_hand_override", 3)) && !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_49[iLocal_96], "random@security_van", "sec_case_into_van_panic", 3)) && !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_49[iLocal_96], "random@security_van", "sec_case_into_van_calm", 3))
			{
		...
		if (!iLocal_86)
		{
			if (MISC::IS_BIT_SET(bLocal_50))
			{
				...
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(bLocal_50);
			}
		}
	}
}
...
int func_2()
{
	...
	fVar0 = 50f;
	if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && (((ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && bLocal_84) && OBJECT::DOES_PICKUP_EXIST(iLocal_103)) || (!ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && OBJECT::DOES_PICKUP_EXIST(iLocal_103)))) && SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1)) < 20f) && SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), OBJECT::GET_PICKUP_COORDS(iLocal_103)) < 20f)
	{
		bVar1 = PED::GET_RANDOM_PED_AT_COORD(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), fVar0, fVar0, fVar0, -1);
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar1))
		{
			if (MISC::GET_MODEL_DIMENSIONS(bVar1) == joaat("s_m_y_cop_01") || MISC::GET_MODEL_DIMENSIONS(bVar1) == joaat("s_f_y_cop_01"))
			{
				return 1;
			}
		}
		...
		bVar2 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), fVar0, 0, 1024);
...
var func_3()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]))
		{
			bVar0 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[0], 1));
			iVar1 = 0;
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]))
		{
			if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[1], 1)) < bVar0)
			{
				bVar0 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[1], 1));
				iVar1 = 1;
			}
		}
	}
...
float func_27()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]))
		{
			bVar0 = SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[0], 1));
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]))
		{
			if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[1], 1)) < bVar0)
			{
				bVar0 = SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[1], 1));
			}
		}
	}
	return SYSTEM::SQRT(bVar0);
}
...
int func_28()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		{
			if (MISC::IS_BIT_SET(iLocal_49[iVar1]))
			{
				if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar1], unk_0x9B0761B4C3EB8BC7(), true)) || STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar1])) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[iVar1], 0))
				{
					iVar0 = 1;
				}
			}
		...
		if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1])) && iLocal_86)
		{
			iVar0 = 1;
		}
	}
...
void func_29()
{
	if (!bLocal_89)
	{
		if (!bLocal_79)
		{
			if (MISC::IS_BIT_SET(bLocal_52))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(bLocal_52))
				{
					PED::GET_PED_BONE_INDEX(&bLocal_52);
				...
				{
					if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iLocal_96]) || MISC::IS_PC_VERSION(iLocal_49[iLocal_96]))
					{
						ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_52, 1, 1);
			...
			{
				if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iLocal_96]) || ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iLocal_96]) && MISC::IS_PC_VERSION(iLocal_49[iLocal_96])) && !bLocal_81))
				{
					func_30(0f, 0f, 0f, 0);
				}
			}
...
void func_30(struct<3> Param0, bool bParam1)
{
	if (!bLocal_89 && !bLocal_81)
	{
		if (!bParam1)
		{
			if (bLocal_79)
			{
				Param0 = { OBJECT::GET_SAFE_PICKUP_COORDS(unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, -3.3f, 0f), 1.2f, 1.5f) };
			}
			else
			{
				Param0 = { OBJECT::GET_SAFE_PICKUP_COORDS(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[iLocal_96], 0), 1.2f, 1.5f) };
			}
		}
		...
		if (bParam1)
		{
			iLocal_103 = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_security_case"), Param0, NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(bLocal_52, 2), 0, bLocal_94, 2, true, 0);
		}
		else
		{
			iLocal_103 = OBJECT::CREATE_PICKUP(joaat("pickup_money_security_case"), Param0, iLocal_104, bLocal_94, true, 0);
		}
		if (!SYSTEM::VMAG(fLocal_58))
		{
			fLocal_58 = func_31(iLocal_103);
		}
		if (MISC::IS_BIT_SET(bLocal_52))
		{
			PED::GET_PED_BONE_INDEX(&bLocal_52);
...
bool func_32(int iParam0)
{
	...
	HUD::SET_BLIP_SCALE(bVar0, func_33(MISC::SET_BIT(), 0.7f, 0.7f));
	return bVar0;
}
...
void func_34()
{
	if (func_36())
	{
		...
		{
			VEHICLE::SET_VEHICLE_DOOR_OPEN(bLocal_50, 2, false, false);
			VEHICLE::SET_VEHICLE_DOOR_OPEN(bLocal_50, 3, false, false);
			if (MISC::IS_BIT_SET(bLocal_53))
			{
				PED::GET_PED_BONE_INDEX(&bLocal_53);
			}
		}
	}
	switch (iLocal_47)
	{
		...
		case 1:
			if (VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(bLocal_50, 2) == 0f && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(bLocal_50, 3) == 0f)
			{
				if (MISC::IS_BIT_SET(bLocal_52))
				{
					if (ENTITY::IS_ENTITY_ATTACHED(bLocal_52))
					...
					OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_52, bLocal_50, 0, Local_65, Local_66, 0, 0, 0, 0, 2, 1);
					iLocal_47 = 2;
				}
			}
			break;
		...
		case 2:
			if (!bLocal_81 && !bLocal_89)
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_50, 0))
				{
					if (((ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(bLocal_50, 2) > 0.25f) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(bLocal_50, 3) > 0.25f) || !ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
					{
						if (MISC::IS_BIT_SET(bLocal_52))
						{
							if (ENTITY::IS_ENTITY_ATTACHED(bLocal_52))
							{
								AUDIO::SET_VARIABLE_ON_SOUND(AUDIO::PLAY_SOUND_FROM_COORD(), "DOORS_BLOWN", ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(bLocal_50, 13), "RE_SECURITY_VAN_SOUNDSET", 0, 0, 0);
								ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_52, 1, 0);
								ENTITY::SET_ENTITY_COLLISION(bLocal_52, true, false);
								PHYSICS::ACTIVATE_PHYSICS(bLocal_52);
								OBJECT::SET_ACTIVATE_OBJECT_PHYSICS_AS_SOON_AS_IT_IS_UNFROZEN(bLocal_52, true);
								Local_279 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_52, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1) * Vector(1.5f, 1.5f, 1.5f) };
								...
								ENTITY::APPLY_FORCE_TO_ENTITY(bLocal_52, 1, 0f, 1f, 5f, 0f, 0f, 0f, 0, true, true, true, false, true);
								iLocal_278 = MISC::GET_GAME_TIMER();
							}
							else if (MISC::_0x7F8F6405F4777AF6(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_52, 1), unk_0x7EC595B99EA7C4B1(bLocal_50, Local_276), unk_0x7EC595B99EA7C4B1(bLocal_50, Local_277), false) >= 1f)
							{
								iLocal_47 = 3;
								iLocal_91[0] = 0;
								iLocal_91[1] = 0;
				...
				else if (MISC::IS_BIT_SET(bLocal_50))
				{
					VEHICLE::SET_VEHICLE_DOOR_OPEN(bLocal_50, 2, false, false);
					VEHICLE::SET_VEHICLE_DOOR_OPEN(bLocal_50, 3, false, false);
					func_30(unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, 2f, 0f), 0);
				}
			}
			break;
		...
		case 3:
			...
			if (MISC::IS_BIT_SET(bLocal_52) && !OBJECT::DOES_PICKUP_EXIST(iLocal_103))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_52) == 0f && (MISC::GET_GAME_TIMER() - iLocal_278) > 1000)
				{
					func_30(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_52, 1), 1);
					PED::GET_PED_BONE_INDEX(&bLocal_52);
				}
				else if ((MISC::GET_GAME_TIMER() - iLocal_278) > 5000)
				{
...
int func_36()
{
	...
	if (MISC::IS_BIT_SET(bLocal_53) && ENTITY::IS_ENTITY_ATTACHED(bLocal_53))
	{
		if (!iLocal_272)
		{
			if (MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_53, 1), joaat("weapon_stickybomb"), 0.25f, false) || OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_53, 1), 0.3f, WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_stickybomb")), false))
			{
				iLocal_272 = 1;
			}
		}
		iVar0 = 0;
		GRAPHICS::DRAW_DEBUG_SPHERE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_53, 1), 0.1f, 255, 0, 0, 255);
		if (func_37(0f, 0f, 0f, 0f, 0f, 0f, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_53, 1), 1f, 1) || (FIRE::IS_EXPLOSION_IN_SPHERE(2, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_53, 1), 0.3f) && iLocal_272))
		{
			iLocal_87 = 1;
			iVar0 = 1;
		}
		if (ENTITY::GET_ENTITY_HEALTH(bLocal_53) < iLocal_98 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_53, unk_0x9B0761B4C3EB8BC7(), false))
		{
			iLocal_99 = (iLocal_99 + (iLocal_98 - ENTITY::GET_ENTITY_HEALTH(bLocal_53)));
			ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(bLocal_53);
		}
		if ((MISC::GET_GAME_TIMER() - iLocal_273) > 200 && MISC::IS_BIT_SET(bLocal_50))
		{
			if (MISC::IS_BULLET_IN_ANGLED_AREA(unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, 0f, (1.2195f - 0.27f)), unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, fLocal_275, (1.2195f + 0.09f)), 0.45f, true))
			{
		...
		iLocal_98 = ENTITY::GET_ENTITY_HEALTH(bLocal_53);
	}
	return 0;
}
...
void func_39()
{
	...
	if (!SYSTEM::VMAG(fLocal_57))
	{
		if (!bLocal_80)
		{
			if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]) && ENTITY::GET_ENTITY_COORDS(bLocal_50, false)) && !bLocal_89)
			{
				if (!bLocal_79)
				{
					if (!SYSTEM::VMAG(uLocal_56[1]))
					{
				...
				else
				{
					...
					if (!SYSTEM::VMAG(iLocal_55))
					{
						iLocal_55 = func_40(bLocal_50, 0, 0);
					}
				}
			}
			else
		...
		{
			if (SYSTEM::VMAG(uLocal_56[0]) && HUD::GET_BLIP_HUD_COLOUR(uLocal_56[0]) != 119)
			{
				unk_0x93370FA10F15BE44(&(uLocal_56[0]));
			}
			if (SYSTEM::VMAG(uLocal_56[1]) && HUD::GET_BLIP_HUD_COLOUR(uLocal_56[1]) != 119)
			{
				unk_0x93370FA10F15BE44(&(uLocal_56[1]));
			}
			if (SYSTEM::VMAG(iLocal_55) && HUD::GET_BLIP_HUD_COLOUR(iLocal_55) != 119)
			{
				unk_0x93370FA10F15BE44(&iLocal_55);
			}
			if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
			...
			if (bVar1)
			{
				if (!SYSTEM::VMAG(iLocal_55))
				{
					iLocal_55 = func_40(bLocal_50, 1, 0);
				}
			}
			else if (SYSTEM::VMAG(iLocal_55))
			{
				unk_0x93370FA10F15BE44(&iLocal_55);
			}
			if ((ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && SYSTEM::VMAG(iLocal_55)) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_50, 0))
				{
			...
			while (iVar0 < iLocal_49)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
				{
					if (!OBJECT::DOES_PICKUP_EXIST(iLocal_103) && !SYSTEM::VDIST(iLocal_49[iVar0], 0))
					{
						if (!PED::IS_PED_FLEEING(iLocal_49[iVar0]) || SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[iVar0], 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < 30f)
						{
							iVar2[iVar0] = 1;
						}
					}
					if (iLocal_46 == 8 && !SYSTEM::VDIST(iLocal_49[iVar0], 0))
					{
						iVar2[iVar0] = 1;
					}
					if (iLocal_46 == 5)
				...
				if (iVar2[iVar0])
				{
					if (!SYSTEM::VMAG(uLocal_56[iVar0]))
					{
						uLocal_56[iVar0] = func_42(iLocal_49[iVar0], 1, 145);
					}
				}
				else if (SYSTEM::VMAG(uLocal_56[iVar0]))
				{
			...
			if (OBJECT::DOES_PICKUP_EXIST(iLocal_103) && !bLocal_89)
			{
				if (!SYSTEM::VMAG(fLocal_58))
				{
					fLocal_58 = func_32(iLocal_103);
				}
			}
			else if (SYSTEM::VMAG(fLocal_58))
			{
				unk_0x93370FA10F15BE44(&fLocal_58);
			}
		}
	}
	else if ((MISC::IS_BIT_SET(bLocal_50) && MISC::IS_BIT_SET(iLocal_49[0])) && MISC::IS_BIT_SET(iLocal_49[1]))
	{
		if ((((((!ENTITY::IS_ENTITY_OCCLUDED(bLocal_50) && ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_50, 100f, 100f, 30f, false, true, 0)) || (!ENTITY::IS_ENTITY_OCCLUDED(iLocal_49[0]) && ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_49[0], 100f, 100f, 30f, false, true, 0))) || (!ENTITY::IS_ENTITY_OCCLUDED(iLocal_49[1]) && ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_49[1], 100f, 100f, 30f, false, true, 0))) || ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_50, 50f, 50f, 20f, false, true, 0)) || ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_49[0], 50f, 50f, 20f, false, true, 0)) || ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_49[1], 50f, 50f, 20f, false, true, 0))
		{
			unk_0x93370FA10F15BE44(&fLocal_57);
		}
	}
	if (SYSTEM::VMAG(uLocal_56[0]))
	{
	...
	if (SYSTEM::VMAG(fLocal_58))
	{
		HUD::SHOW_HEIGHT_ON_BLIP(fLocal_58, bLocal_90);
	}
	if (!bLocal_90)
	{
...
bool func_41(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_33(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
...
var func_53(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
int func_69()
{
	if (!OBJECT::DOES_PICKUP_EXIST(iLocal_103))
	{
		...
		if (!bLocal_79)
		{
			if (iLocal_96 != -1)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iLocal_96]))
				{
					if (!func_70(bLocal_50))
					{
						if (iLocal_271 == -1)
		...
		if (iLocal_271 != -1)
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_271) > 3000)
			{
				...
				ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(bLocal_50, -1000f, true);
				ENTITY::SET_ENTITY_COLLISION(bLocal_50, true, false);
				STREAMING::REMOVE_ANIM_DICT(&bLocal_50);
				return 1;
			}
		}
	}
	else
	{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && SYSTEM::VDIST(OBJECT::GET_PICKUP_COORDS(iLocal_103), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) > 300f)
		{
			return 1;
		}
	}
...
{
	if (MISC::IS_BIT_SET(bParam0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1)) < 150f)
		{
			return 1;
		}
		else if (!ENTITY::IS_ENTITY_OCCLUDED(bParam0) && SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1)) < 300f)
		{
			return 1;
		}
	}
...
void func_71()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		switch (iLocal_48)
		{
			case 0:
				bLocal_80 = true;
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) || !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]))
				{
					if (func_27() < 30f && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Local_106[3 /*10*/]))
					{
				...
				while (iVar0 < iLocal_49)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]) && MISC::IS_BIT_SET(bLocal_52))
					{
						if ((iVar0 != iLocal_96 || bLocal_79) || !ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_52, iLocal_49[iVar0]))
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_49[iVar0]);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
							if (SYSTEM::VDIST(iLocal_49[iVar0], 0))
							{
								if (iLocal_87)
								{
							...
							if (iLocal_88[iVar0])
							{
								TASK::TASK_STAND_STILL(0, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1000, 3000));
							}
							TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_49[iVar0], iLocal_54);
						...
						PED::_0x2208438012482A1A(iLocal_49[iVar0], 1);
					}
					iVar0++;
				}
				if ((MISC::IS_BIT_SET(bLocal_52) && ENTITY::IS_ENTITY_ATTACHED(bLocal_52)) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iLocal_96]))
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_49[iLocal_96]);
				}
				SYSTEM::SETTIMERA(0);
				iLocal_48++;
				break;
			...
			case 1:
				if (func_76(iLocal_96))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iLocal_96]))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_49[iLocal_96]);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
						if (SYSTEM::VDIST(iLocal_49[iLocal_96], 0))
						{
							TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 256);
						}
						TASK::TASK_CLEAR_LOOK_AT(false);
						TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
						AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_49[iLocal_96], iLocal_54);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
					}
					iLocal_48++;
				}
			...
			case 2:
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) || !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]))
				{
					...
					while (iVar0 < iLocal_49)
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]))
						{
							if ((iLocal_47 == 2 && !iLocal_91[iVar0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_50, 0))
							{
								PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(iLocal_49[iVar0], bLocal_50, unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, -4f, 0f), 5f, false);
								iLocal_91[iVar0] = 1;
							}
							if (((OBJECT::DOES_PICKUP_EXIST(iLocal_103) && !iLocal_91[iVar0]) && iLocal_47 == 3) && !bLocal_89)
							{
								PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(iLocal_49[iVar0], bLocal_50, OBJECT::GET_PICKUP_COORDS(iLocal_103), 5f, false);
								iLocal_91[iVar0] = 1;
							}
							if (bLocal_89)
							{
					...
					if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
					{
						if (!bLocal_79)
						{
							if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_50, 0) && (MISC::GET_GAME_TIMER() - iLocal_295) > 5000)
							{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_282) > 250)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			while (iVar0 < iLocal_49)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]))
				{
					if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_49[iVar0], unk_0x9B0761B4C3EB8BC7(), 19) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_49[iVar0], unk_0x9B0761B4C3EB8BC7()))
					{
						iLocal_281[iVar0] = 1;
					}
					else
...
bool func_76(int iParam0)
{
	...
	if (MISC::IS_BIT_SET(bLocal_52))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iParam0]))
		{
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_52, iLocal_49[iParam0]))
			{
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_49[iParam0], "weapons@holster_1h", "holster", 3))
				{
					if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_49[iParam0], "weapons@holster_1h", "holster") > 0.9f)
					{
						ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_52, 1, 1);
						PED::GET_PED_BONE_INDEX(&bLocal_52);
					}
				...
				{
					PED::_0x2208438012482A1A(iLocal_49[iParam0], 1);
					TASK::TASK_PLAY_ANIM(iLocal_49[iParam0], "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0f, false, false, false);
				}
			}
		}
	}
	bVar0 = (!MISC::IS_BIT_SET(bLocal_52) || (MISC::IS_BIT_SET(bLocal_52) && !ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_52, iLocal_49[iParam0])));
	if (bVar0)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iParam0]))
		{
			PED::_0x2208438012482A1A(iLocal_49[iParam0], 0);
		}
	}
	return bVar0;
}
...
void func_77(int iParam0, bool bParam1)
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		Var0 = { func_35(ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(bLocal_50, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1))) };
		fVar1 = ((ENTITY::IS_ENTITY_IN_WATER(bLocal_50) + unk_0x9075769DD4F148B7(Var0.x, Var0.f_1)) + 45f);
		fVar2 = ((ENTITY::IS_ENTITY_IN_WATER(bLocal_50) + unk_0x9075769DD4F148B7(Var0.x, Var0.f_1)) - 45f);
		Var3[0 /*3*/] = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1), fVar1, 0f, 4.5f, 0f) };
		Var3[1 /*3*/] = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1), fVar2, 0f, 4.5f, 0f) };
		func_78(&fVar1);
		func_78(&fVar2);
		if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_293) > 2f)
		{
			bVar5 = true;
		}
		iVar4 = 0;
		...
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar4]))
			{
				if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[iVar4], 1), Var3[iVar4 /*3*/]) > 2f)
				{
					bVar5 = true;
				}
			}
		...
		if (bVar5)
		{
			...
			while (iVar4 < iLocal_49)
			{
				if ((((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar4]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) && SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[iVar4], 1), Var3[iVar4 /*3*/]) > 2f) && (MISC::GET_GAME_TIMER() - iLocal_294[iVar4]) > 1000) && !SYSTEM::VDIST(iLocal_49[iVar4], 0)) && !iLocal_281[iVar4]) && (iParam0 == -1 || iParam0 == iVar4))
				{
					if (bParam1)
					{
						if (func_72())
						{
							Local_293 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
						}
						TASK::OPEN_SEQUENCE_TASK(&iVar6);
						if (func_72() || func_38(Local_293))
						{
							TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var3[iVar4 /*3*/], unk_0x9B0761B4C3EB8BC7(), 2f, false, 0.5f, 4f, true, 0, false, -957453492, 20000);
							TASK::TASK_AIM_GUN_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, true);
						}
						else
						{
							TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, Var3[iVar4 /*3*/], Local_293, 2f, false, 0.5f, 4f, true, 0, false, -957453492);
							TASK::TASK_AIM_GUN_AT_COORD(0, Local_293, -1, true, false);
						}
						TASK::CLOSE_SEQUENCE_TASK(iVar6);
						AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_49[iVar4], iVar6);
...
void func_79(bool bParam0)
{
		...
		switch (iLocal_48)
		{
			case 0:
				if (!bLocal_79)
				{
					...
					Local_283 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(bLocal_50, 0) };
					Local_284 = { NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(bLocal_50, 2) };
					Local_285 = { unk_0xD7D25254A712E758("random@security_van", "sec_case_into_van_panic", Local_283, Local_284, 0, 2) };
					if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[1], 0)) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0])) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[0], 0))
					{
						if (func_27() < 20f)
						{
							if (bLocal_80)
						...
						if (OBJECT::DOES_PICKUP_EXIST(iLocal_103))
						{
							if (bLocal_80)
							{
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bParam0, OBJECT::GET_PICKUP_COORDS(iLocal_103), 2f, -1, 0.25f, false, 40000f);
							}
							else
							{
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bParam0, OBJECT::GET_PICKUP_COORDS(iLocal_103), 1f, -1, 0.25f, false, 40000f);
							}
							iLocal_48++;
						}
						else
			...
			case 1:
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0) && OBJECT::DOES_PICKUP_EXIST(iLocal_103))
				{
					if ((HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), OBJECT::GET_PICKUP_COORDS(iLocal_103), 1) < 2f && !MISC::IS_PC_VERSION(bParam0)) && (MISC::GET_GAME_TIMER() - iLocal_102) > 3000)
					{
						if (WEAPON::IS_PED_ARMED(bParam0, 4))
						{
							ENTITY::SET_ENTITY_HEALTH(bParam0, joaat("weapon_unarmed"), 1);
						}
						OBJECT::REMOVE_PICKUP(iLocal_103);
						func_85(bParam0);
						ENTITY::SET_ENTITY_HEALTH(bParam0, joaat("weapon_unarmed"), 1);
			...
			case 2:
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0) && ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, 713668775) != 1)
					{
						if (bLocal_80)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bParam0, Local_285, 2f, -1, 0.1f, 512, Local_284.f_2);
						}
						else
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bParam0, Local_285, 1f, -1, 0.1f, 512, Local_284.f_2);
						}
						iLocal_48++;
					}
				}
			...
			case 3:
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
				{
					...
					else
					{
						...
						if (SYSTEM::VDIST(Local_285, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1)) < 0.3f)
						{
							if (ENTITY::IS_ENTITY_PLAYING_ANIM((bVar0 - Local_284.f_2)) < 15f)
							{
								PED::CLEAR_PED_ALTERNATE_WALK_ANIM(bParam0, -8f);
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bParam0);
								bLocal_288 = true;
								iLocal_286 = PED::CREATE_SYNCHRONIZED_SCENE(Local_283, Local_284, 2);
								if (bLocal_80)
								{
									TASK::TASK_SYNCHRONIZED_SCENE(bParam0, iLocal_286, "random@security_van", "sec_case_into_van_panic", 4f, 4f, 3, 0, 4f, 0);
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_50, iLocal_286, "van_case_into_van_panic", "random@security_van", 4f, -1000f, 0, -1000f);
								}
								else
								{
									TASK::TASK_SYNCHRONIZED_SCENE(bParam0, iLocal_286, "random@security_van", "sec_case_into_van_calm", 4f, -4f, 3, 0, 4f, 0);
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_50, iLocal_286, "van_case_into_van_calm", "random@security_van", 4f, -1000f, 0, -1000f);
								}
								ENTITY::FREEZE_ENTITY_POSITION(bParam0, false, 0);
								iLocal_48++;
							}
						}
						else if (ENTITY::IS_ENTITY_OCCLUDED(bParam0) && !CAM::IS_SPHERE_VISIBLE(Local_283, 2f))
						{
							unk_0x03D382CB0B44E2FC(bParam0, Local_283, 1, 0, 0, 1);
						}
					}
				}
				break;
			...
			case 4:
				if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286))
				{
					if (bLocal_80)
					{
						fLocal_296 = 0.42f;
					...
					if (!bLocal_79)
					{
						if ((MISC::IS_BIT_SET(bLocal_52) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_52, bParam0)) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_286) > fLocal_296)
						{
							if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_52, bLocal_50))
							{
								ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_52, 1, 1);
								ENTITY::SET_ENTITY_COLLISION(bLocal_52, false, false);
								OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_52, bLocal_50, 0, ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(bLocal_50, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_52, 1)), 90f, 0f, 0f, 0, 0, 0, 0, 2, 1);
							}
							bLocal_79 = true;
						}
					}
					else if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_286) > fLocal_297)
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(bLocal_50, -4f, true);
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bParam0);
						if (MISC::IS_BIT_SET(bLocal_52))
						{
							iLocal_76 = 0;
							VEHICLE::SET_VEHICLE_DOOR_SHUT(bLocal_50, 2, true);
							VEHICLE::SET_VEHICLE_DOOR_SHUT(bLocal_50, 3, true);
			...
			case 5:
				if ((PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_286) > fLocal_297) || !PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286))
				{
					if (!bLocal_80)
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]))
						{
							TASK::TASK_ENTER_VEHICLE(iLocal_49[0], bLocal_50, -1, -1, 1f, 1, 0);
						}
					}
					iLocal_48++;
				}
	...
	if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) || !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!bLocal_79)
		{
			if ((((((func_27() < 10f && WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6)) && func_72()) || ((func_27() < 20f && WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6)) && PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))) || (func_27() < 5f && bLocal_80)) || (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && func_80(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))) || ((!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && MISC::IS_BIT_SET(PLAYER::GET_PLAYERS_LAST_VEHICLE())) && func_80(PLAYER::GET_PLAYERS_LAST_VEHICLE())))
			{
				func_68(8);
			}
		}
	...
	if (iLocal_46 != 7)
	{
		if (bLocal_79)
		{
			if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286))
			{
				ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(bLocal_50, -8f, true);
			}
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
		{
	...
	if ((ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && iLocal_46 != 7) && PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286))
	{
		ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(bLocal_50, -8f, true);
	}
}
...
int func_80(bool bParam0)
{
	...
	iVar0 = 0;
	if (MISC::IS_BIT_SET(bParam0) && MISC::IS_BIT_SET(bLocal_50))
	{
		uVar7 = 4;
		ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(MISC::GET_MODEL_DIMENSIONS(bParam0), &Var1, &Var2);
		Var3[0 /*3*/] = { unk_0x7EC595B99EA7C4B1(bParam0, Var1, Var2.f_1, 0f) };
		Var3[1 /*3*/] = { unk_0x7EC595B99EA7C4B1(bParam0, Var2, Var2.f_1, 0f) };
		Var3[2 /*3*/] = { unk_0x7EC595B99EA7C4B1(bParam0, Var2, Var1.f_1, 0f) };
		Var3[3 /*3*/] = { unk_0x7EC595B99EA7C4B1(bParam0, Var1, Var1.f_1, 0f) };
		fVar8 = -3.7f;
		fVar9 = 1.35f;
		Var4[0 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, (-fVar9 - 0.25f), fVar8, 0f) };
		Var4[1 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, (fVar9 + 0.25f), fVar8, 0f) };
		Var4[2 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, (fVar9 - 0.25f), (fVar8 - 1.55f), 0f) };
		Var4[3 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, (-fVar9 + 0.25f), (fVar8 - 1.55f), 0f) };
		Var5[0 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, -fVar9, 0.5f, 0f) };
		Var5[1 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, (-fVar9 - 0.75f), 0.5f, 0f) };
		Var5[2 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, (-fVar9 - 0.75f), 1.5f, 0f) };
		Var5[3 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, -fVar9, 1.5f, 0f) };
		Var6[0 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, fVar9, 0.5f, 0f) };
		Var6[1 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, (fVar9 + 0.75f), 0.5f, 0f) };
		Var6[2 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, (fVar9 + 0.75f), 1.5f, 0f) };
		Var6[3 /*3*/] = { unk_0x7EC595B99EA7C4B1(bLocal_50, fVar9, 1.5f, 0f) };
		if (!bLocal_79)
		{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && !unk_0xE0B3BC41DDA88DF0(iLocal_49[0], bLocal_50, 1))
		{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]) && !unk_0xE0B3BC41DDA88DF0(iLocal_49[1], bLocal_50, 1))
		{
...
void func_85(bool bParam0)
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		if (!MISC::IS_BIT_SET(bLocal_52))
		{
			bLocal_52 = OBJECT::CREATE_OBJECT(iLocal_75, Local_63, true, true, false);
			ENTITY::SET_ENTITY_CAN_BE_DAMAGED(bLocal_52, false);
		}
		if (MISC::IS_BIT_SET(bLocal_52))
		{
			OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_52, bParam0, ENTITY::ATTACH_ENTITY_TO_ENTITY(bParam0, 28422), Local_68, Local_69, 1, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_86()
{
	...
	switch (iLocal_48)
	{
		case 0:
			...
			if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
			{
				if (MISC::IS_BIT_SET(func_89()))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_89()))
					{
						if (MISC::IS_MINIGAME_IN_PROGRESS(bLocal_50, -1, 0) != func_89() && SYSTEM::VDIST2(bLocal_50, -1, 0))
						{
							TASK::TASK_ENTER_VEHICLE(func_89(), bLocal_50, 20000, -1, 2f, 1, 0);
						}
					}
				}
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]) && func_89() != iLocal_49[1])
				{
					if (MISC::IS_MINIGAME_IN_PROGRESS(bLocal_50, 0, 0) != iLocal_49[1] && SYSTEM::VDIST2(bLocal_50, 0, 0))
					{
						TASK::TASK_ENTER_VEHICLE(iLocal_49[1], bLocal_50, -1, 0, 2f, 1, 0);
					}
				}
				iLocal_48++;
			}
		...
		case 1:
			if (func_88())
			{
				if (MISC::IS_BIT_SET(func_89()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
				{
					TASK::TASK_VEHICLE_MISSION_PED_TARGET(func_89(), bLocal_50, unk_0x9B0761B4C3EB8BC7(), 8, 50f, 786484, 100f, 5f, true);
					iLocal_48++;
				}
			}
			break;
		...
		case 2:
			if (func_87())
			{
				if (MISC::IS_BIT_SET(func_89()))
				{
					TASK::TASK_VEHICLE_MISSION(func_89(), bLocal_50, 0, 5, 0f, 786484, 100f, 100f, true);
					iLocal_48++;
				}
			}
			break;
		...
		case 3:
			if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_50) < 2f)
				{
					func_68(8);
				}
			}
	...
	if ((MISC::IS_BIT_SET(bLocal_50) && MISC::IS_BIT_SET(MISC::IS_MINIGAME_IN_PROGRESS(bLocal_50, -1, 0))) && (PED::IS_PED_IN_ANY_POLICE_VEHICLE(MISC::IS_MINIGAME_IN_PROGRESS(bLocal_50, -1, 0), 0) || STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(MISC::IS_MINIGAME_IN_PROGRESS(bLocal_50, -1, 0))))
	{
		iVar1 = 0;
		if (MISC::IS_MINIGAME_IN_PROGRESS(bLocal_50, -1, 0) == iLocal_49[0])
		{
			iVar1 = 1;
		}
		if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) > 100f)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar1]) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_49[iVar1], 242628503) != 1)
			{
				PED::SET_PED_FLEE_ATTRIBUTES(iLocal_49[iVar1], 2, true);
				TASK::OPEN_SEQUENCE_TASK(&iVar2);
				TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, bLocal_50, 0);
				TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, bLocal_50, unk_0x9B0761B4C3EB8BC7(), 8, 50f, 786484, 100f, 5f, true);
				TASK::CLOSE_SEQUENCE_TASK(iVar2);
				AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_49[iVar1], iVar2);
	...
	if (((((((!ENTITY::GET_ENTITY_COORDS(bLocal_50, false) || OBJECT::DOES_PICKUP_EXIST(iLocal_103)) || iLocal_47 == 3) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(bLocal_50, 0, 7000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(bLocal_50, 3, 30000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(bLocal_50, 2, 30000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(bLocal_50, 1, 40000)) || (iLocal_48 > 1 && !func_88()))
	{
		if (!func_88())
		{
		}
...
int func_87()
{
	if (MISC::IS_BIT_SET(bLocal_50))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_50, 0))
		{
			if (((((ENTITY::GET_ENTITY_HEALTH(bLocal_50) < 300 || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(bLocal_50) < 200f) || (VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_50, 0, false) && VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_50, 1, false))) || (VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_50, 4, false) && VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_50, 5, false))) || (VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_50, 0, false) && VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_50, 4, false))) || (VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_50, 1, false) && VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_50, 5, false)))
			{
				return 1;
			}
		}
...
int func_88()
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[0], 0))
		{
			if (!unk_0xE0B3BC41DDA88DF0(iLocal_49[0], bLocal_50, 0))
			{
				iVar0 = 0;
			}
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[1], 0))
		{
			if (!unk_0xE0B3BC41DDA88DF0(iLocal_49[1], bLocal_50, 0))
			{
				iVar0 = 0;
			}
		}
...
void func_90()
{
	...
	switch (iLocal_48)
	{
		case 0:
			if (!bLocal_79)
			{
				if (MISC::IS_BIT_SET(bLocal_52) && ENTITY::IS_ENTITY_ATTACHED(bLocal_52))
				{
					ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_52, 1, 1);
				}
			}
			if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) || !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				while (iVar0 < iLocal_49)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]))
					{
						...
						if (SYSTEM::VDIST(iLocal_49[iVar0], 1))
						{
							TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_49[iVar0], 0, 256);
						}
						TASK::TASK_SMART_FLEE_PED(0, unk_0x9B0761B4C3EB8BC7(), 300f, -1, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iVar1);
						AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_49[iVar0], iVar1);
...
int func_91(bool bParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	bool bVar2;
			...
			if (MISC::IS_BIT_SET(bVar2))
			{
				...
				else if (bParam2)
				{
					if (PLAYER::SET_PLAYER_WANTED_LEVEL(bVar2))
					{
						...
						if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar2) && iVar3 != func_10()) && func_92(iVar3, 1, 1)) || iParam8)
						{
...
void func_94()
{
		...
		switch (iLocal_48)
		{
			case 0:
				if (func_4(&Local_106, cLocal_105, "RESEC_CAR1", 8, 0, 0, 0))
				{
					if (MISC::IS_BIT_SET(bLocal_52) && ENTITY::IS_ENTITY_ATTACHED(bLocal_52))
					{
						if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_52, iLocal_49[0]))
						{
							func_95(0);
						}
						else
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_49[0]);
						}
						if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_52, iLocal_49[1]))
						{
							func_95(1);
						}
						else
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_49[1]);
						}
						iLocal_48++;
					}
					else
	...
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_51, 0) && ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
		{
			if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_51, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1)) > 10f)
			{
				func_68(7);
			}
		}
		if ((PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_51, 0) || !ENTITY::GET_ENTITY_COORDS(bLocal_51, false)) || (!ENTITY::IS_ENTITY_UPRIGHT(bLocal_51, 90f) && !unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_51, 1)))
		{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[0], unk_0x9B0761B4C3EB8BC7(), true))
		{
			func_68(8);
		}
	}
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[1], unk_0x9B0761B4C3EB8BC7(), true))
		{
			func_68(8);
		}
	}
	...
	if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && func_72()) && WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 7))
	{
		func_68(2);
	}
	if (!ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
...
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iParam0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_49[iParam0]);
		TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
		if (SYSTEM::VDIST(iLocal_49[iParam0], 0))
		{
			TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 256);
		}
		TASK::TASK_CLEAR_LOOK_AT(false);
		...
		TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
		AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_49[iParam0], iLocal_54);
		TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
		if (iLocal_97 == 0)
		{
			iLocal_97 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(118, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[iParam0], 1), -1f);
		}
	}
}
...
void func_96()
{
	...
	switch (iLocal_48)
	{
		case 0:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]))
			{
				PED::_0x2208438012482A1A(iLocal_49[0], 1);
			}
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]))
			{
				PED::_0x2208438012482A1A(iLocal_49[1], 1);
			}
			if (func_103())
			{
			...
			else if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				if (func_102() || func_101())
				{
					func_4(&Local_106, cLocal_105, "RESEC_ENT1", 8, 0, 0, 0);
				}
				else if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 4))
				{
		...
		case 2:
			if (!func_100())
			{
				if (!func_99(bLocal_50, 1000) && SYSTEM::TIMERA() > 10000)
				{
					bVar0 = true;
				}
				...
				while (iVar1 < iLocal_49)
				{
					if (!func_99(iLocal_49[iVar1], 1000) && (func_27() < 2f && WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6)))
					{
						bVar0 = true;
					}
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[iVar1], 0))
					{
	...
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && MISC::IS_BIT_SET(iLocal_49[iVar2]))
		{
			if ((STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar2]) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[iVar2], 0)) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar2], unk_0x9B0761B4C3EB8BC7(), false))
			{
				func_68(8);
			}
		}
	...
	if ((STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) || STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1])) || bLocal_89)
	{
		func_68(8);
	}
	if ((ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) && func_72())
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_50, unk_0x9B0761B4C3EB8BC7(), true))
		{
			func_68(8);
	...
	if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6)) && PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
	{
		func_68(8);
	}
...
int func_99(bool bParam0, int iParam1)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (MISC::IS_BIT_SET(bParam0))
		{
			if ((ENTITY::IS_ENTITY_A_PED(bParam0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0))) || (ENTITY::IS_ENTITY_A_VEHICLE(bParam0) && ENTITY::GET_ENTITY_COORDS(ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(bParam0), false)))
			{
				if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1)) > bLocal_290)
				{
					iVar0 = 1;
				}
				if ((MISC::GET_GAME_TIMER() - iLocal_291) > iParam1)
				{
					bLocal_290 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1));
...
int func_100()
{
	if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_50, 20f, 20f, 5f, false, true, 0) && !PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
		{
			return 1;
		}
	}
...
int func_101()
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, 1.7532f, 0.5984f), unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, 3.3477f, 3.5984f), 2.8f, 0, 1, 0))
		{
			return 1;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_49)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]))
			{
				if ((!unk_0xE0B3BC41DDA88DF0(iLocal_49[iVar0], bLocal_50, 0) && PED::IS_PED_ON_SPECIFIC_VEHICLE(unk_0x9B0761B4C3EB8BC7(), bLocal_50)) && SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[iVar0], 1)) < 400f)
				{
					return 1;
				}
			}
...
int func_102()
{
	if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) == bLocal_50)
		{
			if (PED::IS_PED_TRYING_TO_ENTER_A_LOCKED_VEHICLE(unk_0x9B0761B4C3EB8BC7()))
			{
				return 1;
			}
		}
...
int func_103()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49[0], unk_0x9B0761B4C3EB8BC7(), 20f, 20f, 5f, false, true, 0)) || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49[1], unk_0x9B0761B4C3EB8BC7(), 20f, 20f, 5f, false, true, 0)))
		{
			if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 4) && PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
			{
				return 1;
			}
		}
...
void func_106(var uParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
	...
	else
	{
		if (!AUDIO::PRELOAD_SCRIPT_CONVERSATION(bVar0))
		{
			if (func_104(bVar0) && HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
			{
				unk_0xD289B55B6AADBA10(1);
			}
		}
...
int func_111(bool bParam0)
{
	if (!func_112(1, 1, 0))
	{
		if ((!CAM::IS_SCREEN_FADED_OUT(bParam0) && func_104(bParam0)) || func_104("CMN_HINT"))
		{
			unk_0xD289B55B6AADBA10(1);
		}
		return 0;
...
int func_112(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_118() || func_117(Global_4456448.f_129348)) || func_116())
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(bVar0, iVar1) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("apc") && iVar1 != -1)) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("akula") && iVar1 != -1)) || (((MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("riot2") && iVar1 == 0) && func_114(bVar0, 10)) && unk_0x7F8B14CBFB9813E5(bVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_122(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_125(bParam1, bParam2, bParam3) || SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1) || func_123(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_130(var uParam0, bool bParam1, struct<3> Param2, bool bParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_108(bParam1) && ENTITY::IS_ENTITY_VISIBLE(bParam1))
	{
		iVar1 = 0;
...
void func_148()
{
	...
	switch (iLocal_48)
	{
		case 0:
			if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]))
				{
					...
					PED::_0x2208438012482A1A(iLocal_49[0], 1);
					PED::_0x2208438012482A1A(iLocal_49[1], 1);
					if (unk_0xE0B3BC41DDA88DF0(iLocal_49[0], bLocal_50, 0) && unk_0xE0B3BC41DDA88DF0(iLocal_49[1], bLocal_50, 0))
					{
						if (iLocal_45 == 2)
						{
							TASK::OPEN_SEQUENCE_TASK(&iVar0);
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, bLocal_50, -574.6195f, -847.232f, 25.2925f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							TASK::TASK_VEHICLE_DRIVE_WANDER(0, bLocal_50, 10f, 786603);
							TASK::CLOSE_SEQUENCE_TASK(iVar0);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_49[0], iVar0);
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iVar1);
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, bLocal_50, -551.2968f, -1119.418f, 20.4011f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							TASK::TASK_VEHICLE_DRIVE_WANDER(0, bLocal_50, 10f, 786603);
							TASK::CLOSE_SEQUENCE_TASK(iVar1);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_49[0], iVar1);
							TASK::CLEAR_SEQUENCE_TASK(&iVar1);
							iLocal_48++;
						}
						else if (iLocal_45 == 7)
						{
							TASK::OPEN_SEQUENCE_TASK(&iVar2);
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, bLocal_50, 2786.752f, 4358.032f, 48.6794f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							TASK::TASK_VEHICLE_DRIVE_WANDER(0, bLocal_50, 10f, 786603);
							TASK::CLOSE_SEQUENCE_TASK(iVar2);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_49[0], iVar2);
							TASK::CLEAR_SEQUENCE_TASK(&iVar2);
							iLocal_48++;
						}
						else
						{
							TASK::TASK_VEHICLE_DRIVE_WANDER(iLocal_49[0], bLocal_50, 10f, 786603);
							iLocal_48++;
						}
					}
					else
					{
						if (!unk_0xE0B3BC41DDA88DF0(iLocal_49[0], bLocal_50, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_49[0], -1794415470) != 1)
						{
							TASK::TASK_ENTER_VEHICLE(iLocal_49[0], bLocal_50, -1, -1, 1f, 8388608, 0);
						}
						if (!unk_0xE0B3BC41DDA88DF0(iLocal_49[1], bLocal_50, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_49[1], -1794415470) != 1)
						{
							TASK::TASK_ENTER_VEHICLE(iLocal_49[1], bLocal_50, -1, 0, 1f, 8388608, 0);
						}
					}
				}
			}
		...
		case 1:
			...
			if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar3]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[iVar3], 0))
					{
						if (PED::IS_PED_JACKING(unk_0x9B0761B4C3EB8BC7()) && PED::IS_PED_BEING_JACKED(iLocal_49[iVar3]))
						{
							func_68(8);
						}
					}
				...
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_50, 1))
				{
					func_68(8);
				}
			}
	...
	if (iLocal_46 == 4)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(unk_0x9B0761B4C3EB8BC7(), &iVar4, 1);
			if ((iVar4 == joaat("weapon_stickybomb") || iVar4 == joaat("weapon_molotov")) || iVar4 == joaat("weapon_grenade"))
			{
				GRAPHICS::DRAW_DEBUG_TEXT("PLAYER HAS PROJECTILE WEAPON", NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 0, 0, 255, 255);
				if ((PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()) && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, -3.44f, -3f), unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, -13.44f, 3f), 2.3f, 0, 1, 0)) && SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1)) < 225f)
				{
					func_68(6);
				}
				if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, -3.44f, -3f), unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, -13.44f, 3f), 2.3f, 0, 1, 0))
				{
					GRAPHICS::DRAW_DEBUG_TEXT_2D("PLAYER IS BEHIND VAN", 0.1f, 0.8f, 0f, 0, 0, 255, 255);
				}
				if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1)) < 225f)
				{
		...
		if (((ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && func_37(0f, 0f, 0f, 0f, 0f, 0f, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1), 25f, 0)) || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[0], 1), 20f, 0))) || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[1], 1), 20f, 0)))
		{
			func_68(6);
		}
		if (iLocal_46 != 4)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]))
			{
				...
				PED::_0x2208438012482A1A(iLocal_49[0], 0);
			}
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[1], 6, false);
				PED::_0x2208438012482A1A(iLocal_49[1], 0);
			}
		}
	}
}
...
int func_149()
{
	...
	if ((ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID())) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		Var0 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1) };
		Var1 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(bLocal_50) };
		Var2 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(bLocal_50, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) };
		if (((Var2.f_1 > 1f && (((PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_50) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_50)) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_49[0])) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_49[1]))) && ENTITY::IS_ENTITY_PLAYING_ANIM(MISC::GET_ANGLE_BETWEEN_2D_VECTORS(Var1.x, Var1.f_1, Var0.x, Var0.f_1)) < 60f) && MISC::GET_ANGLE_BETWEEN_2D_VECTORS(Var1.f_2, Var1.f_1, Var0.f_2, Var0.f_1) < 30f)
		{
			return 1;
		}
	}
...
int func_150()
{
	if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if ((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(bLocal_50, 2.7f, 7f, -2f), unk_0x7EC595B99EA7C4B1(bLocal_50, 2.7f, -3.25f, 3f), 3f, 0, 1, 0) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(bLocal_50, -2.7f, 7f, -2f), unk_0x7EC595B99EA7C4B1(bLocal_50, -2.7f, -3.25f, 3f), 3f, 0, 1, 0)) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, 7f, -2f), unk_0x7EC595B99EA7C4B1(bLocal_50, 0f, 0f, 3f), 2.4f, 0, 1, 0))
		{
			if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(unk_0x9B0761B4C3EB8BC7()))
			{
				return 1;
...
int func_151()
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		else if (MISC::IS_BIT_SET(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
		{
			bVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		}
		if (MISC::IS_BIT_SET(bVar0) && MISC::IS_BIT_SET(bLocal_50))
		{
			return ((ENTITY::GET_ENTITY_COORDS(bVar0, false) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(bVar0, bLocal_50)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(bVar0) > 10f);
		}
	}
	return 0;
}
...
void func_153()
{
	...
	if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1])) && ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
	{
		switch (iLocal_48)
		{
			case 0:
				...
				bLocal_288 = false;
				iLocal_289 = 0;
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_50, 5f);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
				TASK::TASK_STAND_STILL(0, 5000);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(false, Local_285, 1f, -1, 0.1f, 512, Local_284.f_2);
				TASK::TASK_ACHIEVE_HEADING(0, Local_284.f_2, 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
				AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_49[1], iLocal_54);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
				iLocal_48++;
				break;
			...
			case 1:
				...
				Local_284 = { NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(bLocal_50, 2) };
				Local_285 = { unk_0xD7D25254A712E758("random@security_van", "sec_case_into_van_calm", Local_283, Local_284, 0, 2) };
				if (!PED::DETACH_SYNCHRONIZED_SCENE(iLocal_287))
				{
					if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_63) < 22500f && ENTITY::HAS_COLLISION_LOADED_AROUND_ENTITY(bLocal_50))
					{
				...
				bVar0 = ENTITY::IS_ENTITY_IN_WATER(iLocal_49[1]);
				if (bVar0 > 180f)
				{
					bVar0 = (bVar0 - 360f);
				}
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM((bVar0 - Local_284.f_2)) < 15f && SYSTEM::VDIST(Local_285, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[1], 1)) < 0.2f)
				{
			...
			case 2:
				if (!iLocal_76)
				{
					if (((PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_286) > 0.09f) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_286) < 0.11f) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_49[1], 20f, 20f, 5f, false, true, 0))
						{
				...
				if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286))
				{
					if (!bLocal_79)
					{
						if ((MISC::IS_BIT_SET(bLocal_52) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_52, iLocal_49[1])) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_286) > 0.3793f)
						{
							if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_52, bLocal_50))
							{
								ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_52, 1, 1);
					...
					else if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_286) > 0.546243f)
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(bLocal_50, -4f, true);
						if (MISC::IS_BIT_SET(bLocal_52))
						{
			...
			case 3:
				if (!iLocal_76)
				{
					if (((PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_286) > 0.56f) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) && ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_49[1], 20f, 20f, 5f, false, true, 0))
					{
				...
				if (!iLocal_289)
				{
					if ((PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_286) > 0.6f) || !PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286))
					{
						if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_287))
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_49[0]);
				...
				else if ((PED::DETACH_SYNCHRONIZED_SCENE(iLocal_287) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_287) >= 0.92f) || !PED::DETACH_SYNCHRONIZED_SCENE(iLocal_287))
				{
					if (!unk_0xE0B3BC41DDA88DF0(iLocal_49[0], bLocal_50, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_49[0], -1794415470) != 1)
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_49[0]);
				...
				if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286) && ENTITY::GET_ENTITY_ROTATION(iLocal_49[1], AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("ENDS_IN_WALK")))
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_49[1]);
					TASK::TASK_ENTER_VEHICLE(iLocal_49[1], bLocal_50, -1, 0, 1f, 1, 0);
					SYSTEM::SETTIMERA(0);
				}
				if ((func_88() && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(bLocal_50, 0) == 0f) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(bLocal_50, 1) == 0f)
				{
					func_68(4);
				}
				break;
			...
			case 4:
				...
				{
					VEHICLE::SET_VEHICLE_DOOR_SHUT(bLocal_50, 0, true);
					VEHICLE::SET_VEHICLE_DOOR_SHUT(bLocal_50, 1, true);
				}
				break;
		}
		if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_3()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) && SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(func_3(), 1)) < 30f) && AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) != 0)
		{
			func_68(8);
		}
	}
	...
	if (iLocal_46 != 1)
	{
		if (iLocal_46 != 4)
		{
			...
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]))
			{
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_49[0], "random@security_van", "driver_idle", 3))
				{
					if (iLocal_45 != 2)
					{
			...
			if ((ENTITY::GET_ENTITY_COORDS(bLocal_50, false) && PED::DETACH_SYNCHRONIZED_SCENE(iLocal_286)) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]))
			{
				ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(bLocal_50, -1000f, true);
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_49[1]);
			}
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				...
				{
					bLocal_51 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
					return 1;
				}
			}
		}
		else if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0))
		{
			if (func_80(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
			{
			...
			if (fLocal_280 > 3f)
			{
				bLocal_51 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
				return 1;
			}
		}
	}
...
int func_155()
{
	...
	while (iVar0 < iLocal_49)
	{
		if ((((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID())) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) && (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_49[iVar0]) || MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x9B0761B4C3EB8BC7()))) && SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[iVar0], 1)) < 9f) && !WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 7)) && func_72())
		{
			return 1;
		}
		if (MISC::IS_PC_VERSION(iLocal_49[iVar0]))
		{
			return 1;
		}
		iVar0++;
...
int func_156()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 7) || (iVar0 == joaat("weapon_petrolcan") && PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7())))
		{
			if (PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[0]))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49[0], unk_0x9B0761B4C3EB8BC7(), 12f, 12f, 5f, false, true, 0))
					{
						return 1;
					}
				}
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[1]))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49[1], unk_0x9B0761B4C3EB8BC7(), 12f, 12f, 5f, false, true, 0))
					{
						return 1;
					}
				}
...
int func_157()
{
	...
	while (iVar0 < iLocal_49)
	{
		if ((((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar0], unk_0x9B0761B4C3EB8BC7(), true)) || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]) && PED::IS_PED_IN_COMBAT(iLocal_49[iVar0], unk_0x9B0761B4C3EB8BC7()))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar0], unk_0x9B0761B4C3EB8BC7(), true)) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_50, unk_0x9B0761B4C3EB8BC7(), true) && func_72())) || STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0])) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[iVar0], 0))
		{
			return 1;
		}
		iVar0++;
	...
	if (ENTITY::GET_ENTITY_COORDS(bLocal_50, false))
	{
		...
		while (iVar0 < iLocal_49)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]))
			{
				if (PED::IS_PED_JACKING(unk_0x9B0761B4C3EB8BC7()) && PED::IS_PED_BEING_JACKED(iLocal_49[iVar0]))
				{
					return 1;
				}
			}
	...
	{
		if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_63, 25f, 25f, 20f, 0, 1, 0))
		{
			return 1;
		}
	}
...
int func_158()
{
	...
	while (iVar0 < iLocal_49)
	{
		...
		{
			if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_49[iVar0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_49[iVar0], 0)) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				if ((MISC::IS_BULLET_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[iVar0], 1), 5f, true) || func_37(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[iVar0], 1) + Vector(5f, 10f, 10f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_49[iVar0], 1) - Vector(5f, 5f, 5f), 0f, 0f, 0f, 0, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar0], unk_0x9B0761B4C3EB8BC7(), true))
				{
					bLocal_80 = true;
					return 1;
				}
...
void func_159()
{
	...
	bLocal_50 = VEHICLE::CREATE_VEHICLE(fLocal_74, Local_63, fLocal_64, true, true, false);
	bLocal_53 = OBJECT::CREATE_OBJECT(joaat("prop_security_case_01"), Local_63, true, true, false);
	OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_53, bLocal_50, 0, 0f, -2.4589f, 1.2195f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	ENTITY::SET_ENTITY_VISIBLE(bLocal_53, false, false);
	ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(bLocal_53, bLocal_50, false);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_50, 5f);
	VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_50, 3);
	ENTITY::SET_ENTITY_PROOFS(bLocal_53, false, true, true, true, true, true, false, false);
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(bLocal_50, true, 0f);
	CAM::IS_AIM_CAM_ACTIVE(bLocal_50, 700, 0);
	VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(bLocal_50, false, 0);
	ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_50, true, 1);
	VEHICLE::SET_VEHICLE_DROPS_MONEY_WHEN_BLOWN_UP(bLocal_50, false);
	VEHICLE::SET_VEHICLE_PROVIDES_COVER(bLocal_50, true);
	PATHFIND::_0x07FB139B592FA687((Local_63.x - 200f), (Local_63.f_1 - 200f), (Local_63.x + 200f), (Local_63.f_1 + 200f));
	if (iLocal_44 == 3)
	{
		iLocal_49[0] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_50, 26, iLocal_73, -1, true, true);
		iLocal_49[1] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_50, 26, iLocal_73, 0, true, true);
		VEHICLE::SET_VEHICLE_ENGINE_ON(bLocal_50, true, true, false);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_50, true, 1);
	}
	else
	{
	...
	while (iVar0 < iLocal_49)
	{
		...
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_49[iVar0], 1.653532E-43f, 0);
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_49[iVar0], 128, true);
		...
		unk_0x92BD213E6A0E666B(iLocal_49[iVar0], joaat("weapon_pistol"), -1, 0, 1);
	...
	if (func_16() == 0 && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		func_74(&Local_106, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
	}
	if (func_16() == 1 && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		func_74(&Local_106, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	}
	if (func_16() == 2 && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(fLocal_74, true);
...
float func_160(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
int func_164(bool bParam0, char* sParam1, int iParam2)
{
...
void func_168(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
...
int func_170()
{
	...
	{
		if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_43) < (75f * 75f))
		{
			return 1;
		}
...
void func_186(var uParam0, char* sParam1, int iParam2)
{
...
void func_187()
{
	...
	fLocal_74 = joaat("stockade");
	iLocal_73 = joaat("s_m_m_armoured_01");
	bLocal_94 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(3000, 8000);
	switch (iLocal_45)
	{
		case 1:
...
int func_207()
{
	...
	func_208(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 4:
						if (((((func_1() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_24(8, -1)) || func_219()) || func_218()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_231()
{
	if (func_183())
	{
		...
		if (MISC::IS_BIT_SET(bLocal_52))
		{
			if (ENTITY::IS_ENTITY_OCCLUDED(bLocal_52))
			{
				PED::GET_PED_BONE_INDEX(&bLocal_52);
			}
			else
			{
				ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&bLocal_52);
			}
		}
		unk_0x74528AC0906CBABE(fLocal_74);
		unk_0x74528AC0906CBABE(iLocal_73);
		unk_0x74528AC0906CBABE(iLocal_75);
		PLAYER::SET_ALL_RANDOM_PEDS_FLEE(PLAYER::PLAYER_ID(), false);
		PED::SET_PED_MODEL_IS_SUPPRESSED(fLocal_73, false);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(fLocal_74, false);
	}
	if (iLocal_97 != 0)
	{
		EVENT::REMOVE_SHOCKING_EVENT(iLocal_97);
	}
	PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_59, 0);
	func_135(&uLocal_111, 0, 0);
	func_237(-1);
...
void func_236(bool bParam0, char* sParam1, void fParam2)
{
...
int func_248(bool bParam0)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0, 0))
	{
		...
		if (SYSTEM::VDIST2(bParam0, 3, 0))
		{
			return 3;
		}
		if (SYSTEM::VDIST2(bParam0, 4, 0))
		{
			return 4;
		}
		if (SYSTEM::VDIST2(bParam0, 5, 0))
		{
			return 5;
		}
		if (SYSTEM::VDIST2(bParam0, 6, 0))
		{
			return 6;
		}
		if (SYSTEM::VDIST2(bParam0, 7, 0))
		{
			return 7;
		}
		if (SYSTEM::VDIST2(bParam0, 8, 0))
		{
			return 8;
		}
	}
