	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				...
				Var4 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0f, 2) };
				uVar5 = Var4.f_2;
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				uParam0->f_57.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, 1, 0f, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_57.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			fVar7 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_57.f_1);
			if (PED::DETACH_SYNCHRONIZED_SCENE(fVar7))
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(fVar7) >= 1f)
				{
					...
					func_40(uParam0, &sVar1);
					uParam0->f_57.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, 1, 0f, 1065353216, 0, 1065353216);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_57.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					unk_0xB88AF19828BF16ED(uParam0->f_57.f_1);
					func_25(&(uParam0->f_57), 8);
		...
		case 7:
			SYSTEM::POW(uParam0->f_57.f_1);
			func_52(uParam0, 8);
			break;
		
		case 8:
			fVar8 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_57.f_1);
...
void func_18(var uParam0)
{
	...
	if (uParam0->f_57.f_4 == 6)
	{
		...
		if ((uParam0->f_57.f_4 == 6 && !ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), -1322051853)) && !func_8(&(uParam0->f_57), 12))
		{
			if (fVar1 >= 0.35f)
			{
				func_23(uParam0);
		...
		else
		{
			...
			if (((((!HUD::DISABLE_FRONTEND_THIS_FRAME() && !func_8(&(uParam0->f_57), 0)) && !func_8(&(uParam0->f_57), 4)) && !func_21()) && !func_19(1)) && uParam0->f_57.f_8.f_2 != 3)
			{
...
void func_24(var uParam0)
{
	...
	uParam0->f_57.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, 1, 0f, 1065353216, 0, 1065353216);
	func_41(uParam0, &sVar0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_57.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	unk_0xB88AF19828BF16ED(uParam0->f_57.f_1);
	func_9(&(uParam0->f_57.f_5));
	func_52(uParam0, 8);
}
...
bool func_43(var uParam0)
{
	...
	switch (uParam0->f_57.f_8)
	{
		...
		default:
			bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, func_14(uParam0->f_57.f_8));
	}
	return bVar0;
}
...
void func_54(var uParam0)
{
	...
	else if (uParam0->f_57.f_4 > 4)
	{
		...
		PED::SET_PED_CAPSULE(unk_0x9B0761B4C3EB8BC7(), func_55(uParam0));
...
void func_56(var uParam0)
{
	...
	func_57(&(uParam0->f_57), 1, PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0));
	func_57(&(uParam0->f_57), 3, SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1));
