...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (Global_111858.f_20406.f_145 > 0 || Global_110498)
		{
							...
							if (func_18(func_19()))
							{
								if (unk_0xCE990E643CD9D0E5(Global_111858.f_20406[iLocal_21 /*16*/].f_11, func_12()))
								{
									if (Global_111858.f_20406[iLocal_21 /*16*/].f_12 == Global_111858.f_20406.f_146[func_12()])
									{
										...
										{
											if (MISC::GET_GAME_TIMER() > Global_111858.f_20406[iLocal_21 /*16*/].f_8)
											{
												if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&(Global_111858.f_20406[iLocal_21 /*16*/].f_4), ""))
												{
			...
			{
				if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&(Local_20.f_4), ""))
				{
					if (func_3(&Local_20))
					{
			...
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&(Global_111858.f_20406[iLocal_21 /*16*/]), &Local_20) && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&(Global_111858.f_20406[iLocal_21 /*16*/]), ""))
			{
				if (Global_111858.f_20406[iLocal_21 /*16*/].f_10 != -1)
				{
					if (MISC::GET_GAME_TIMER() > Global_111858.f_20406[iLocal_21 /*16*/].f_10)
					{
						iVar2 = iLocal_21;
