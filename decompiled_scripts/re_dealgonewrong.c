#region Local Var
	...
	float fLocal_90 = 0f;
	float fLocal_91 = 0f;
	float fLocal_92[9] = { 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f };
	float fLocal_93[4] = { 0f, 0f, 0f, 0f };
	float fLocal_94[4] = { 0f, 0f, 0f, 0f };
...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(false);
		if ((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1503.54f, 4934.923f, 114.2284f, 100f, 100f, 100f, 0, 1, 0)) || iLocal_45 == 2)
		{
			if (!func_134())
			{
				if (func_133())
				...
				case 2:
					switch (iLocal_44)
					{
						...
						case 1:
							...
							if (iLocal_46 >= 6)
							{
								if (!func_80())
								{
									...
									while (iVar0 < 4)
									{
										if (bLocal_110)
										{
											func_79(&(iLocal_83[iVar0]), &(fLocal_93[iVar0]), &(iLocal_88[iVar0]), &(uLocal_95[iVar0]));
											func_74(iLocal_88[0], STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(iLocal_88[1], STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 2f, 0f, 1000, 0f);
											func_69(&(iLocal_83[iVar0]), &(fLocal_93[iVar0]), &(iLocal_88[iVar0]), &(uLocal_95[iVar0]));
										}
										else if (bLocal_107)
										{
											func_79(&(iLocal_83[iVar0]), &(fLocal_93[iVar0]), &(iLocal_86[iVar0]), &(uLocal_95[iVar0]));
											func_74(iLocal_86[0], STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(iLocal_86[1], STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
											func_69(&(iLocal_83[iVar0]), &(fLocal_93[iVar0]), &(iLocal_86[iVar0]), &(uLocal_95[iVar0]));
										}
										else if (bLocal_108)
										{
											func_79(&(iLocal_84[iVar0]), &(fLocal_94[iVar0]), &(iLocal_87[iVar0]), &(uLocal_96[iVar0]));
											func_74(iLocal_87[0], STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(iLocal_87[1], STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), &uLocal_56, &uLocal_59, &Local_61, &fLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
											func_69(&(iLocal_84[iVar0]), &(fLocal_94[iVar0]), &(iLocal_87[iVar0]), &(uLocal_96[iVar0]));
										}
										iVar0++;
									}
								}
							...
							if (((PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()) || PED::IS_PED_IN_FLYING_VEHICLE(unk_0x9B0761B4C3EB8BC7())) && !unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_100, 100f, 100f, 100f, 0, 1, 0)) && iLocal_46 < 2)
							{
								func_46();
							}
							break;
...
void func_1()
{
	...
	if (iLocal_282 && !iLocal_105)
	{
		...
		if (SYSTEM::VMAG(fLocal_89))
		{
			unk_0x93370FA10F15BE44(&fLocal_89);
		}
		if (SYSTEM::VMAG(fLocal_90))
		{
			unk_0x93370FA10F15BE44(&fLocal_90);
		}
		iVar0 = 0;
		while (iVar0 < 4)
		{
			if (SYSTEM::VMAG(fLocal_93[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(fLocal_93[iVar0]));
			}
			if (SYSTEM::VMAG(uLocal_95[iVar0]))
			{
			...
			if (iLocal_46 >= 6)
			{
				...
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_83[iVar0], unk_0x9B0761B4C3EB8BC7(), 100f, 100f, 100f, false, true, 0))
						{
							bLocal_109 = true;
						}
					}
		...
		while (iVar0 < 4)
		{
			if (SYSTEM::VMAG(fLocal_94[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(fLocal_94[iVar0]));
			}
			if (SYSTEM::VMAG(uLocal_96[iVar0]))
			{
			...
			if (iLocal_46 >= 6)
			{
				if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_84[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_84[iVar0], unk_0x9B0761B4C3EB8BC7(), 100f, 100f, 100f, false, true, 0))
						{
							bLocal_109 = true;
						}
					}
...
void func_69(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	if (MISC::IS_BIT_SET(*uParam2))
	{
		if (ENTITY::GET_ENTITY_COORDS(*uParam2, false))
		{
			...
			if (!SYSTEM::VMAG(*uParam3))
			{
				if (iVar0 == 1)
				{
					*uParam3 = func_70(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*uParam2, 1), 0);
					HUD::SET_BLIP_COLOUR(*uParam3, 1);
					HUD::SET_BLIP_PRIORITY(*uParam3, 9);
					PED::IS_PED_IN_PARACHUTE_FREE_FALL(*uParam3, "BLIP_VEH");
				}
			}
			else
			{
				Var1 = { HUD::_0xF06EBB91A81E09E3(*uParam3) };
				Var2 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*uParam2, 1) };
...
bool func_70(struct<3> Param0, bool bParam1)
{
	bool bVar0;
	
	bVar0 = HUD::ADD_BLIP_FOR_COORD(Param0);
	HUD::SET_BLIP_SCALE(bVar0, func_71(MISC::SET_BIT(), 1f, 1f));
...
float func_72(bool bParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = func_73(bParam0, !bParam1, 0);
...
bool func_73(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_71(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
void func_74(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, float fParam5, var uParam6, struct<3> Param7, int iParam8, float fParam9)
{
	struct<3> Var0;
	
	if (MISC::IS_BIT_SET(bParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		if (((((((MISC::IS_BIT_SET(bParam1) && bParam0 != bParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(MISC::GET_MODEL_DIMENSIONS(bParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(MISC::GET_MODEL_DIMENSIONS(bParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(MISC::GET_MODEL_DIMENSIONS(bParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(MISC::GET_MODEL_DIMENSIONS(bParam1))) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(bParam1)) && func_78(bParam0))
		{
			if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam1, 1), *uParam4, 1) > 20f)
			{
				...
				*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(*uParam2, *uParam3, Param7) };
				func_77(bParam1, uParam4, fParam5);
			}
			...
			{
				if (func_76(bParam0, bParam1, 1) > fParam9 && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam1, 1), *uParam2, 1) > 20f)
				{
					if (!func_75(*uParam2))
					{
						if (!CAM::IS_SPHERE_VISIBLE(*uParam2, 3f))
						{
							...
							VEHICLE::SET_VEHICLE_FORWARD_SPEED(bParam0, 10f);
						...
						else
						{
							...
							if (!func_75(Var0))
							{
								if (!CAM::IS_SPHERE_VISIBLE(Var0, 2f))
								{
									...
									unk_0x03D382CB0B44E2FC(bParam0, Var0, 1, 0, 0, 1);
									ENTITY::SET_ENTITY_HEADING(bParam0, fLocal_60);
									VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bParam0, 5f);
									VEHICLE::SET_VEHICLE_FORWARD_SPEED(bParam0, 10f);
									VEHICLE::SET_VEHICLE_ENGINE_ON(bParam0, true, true, false);
									*uParam6 = MISC::GET_GAME_TIMER();
...
float func_76(bool bParam0, bool bParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_77(bool bParam0, var uParam1, var uParam2)
{
	if (MISC::IS_BIT_SET(bParam0))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0))
		{
			*uParam1 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1) };
			*uParam2 = ENTITY::IS_ENTITY_IN_WATER(bParam0);
		}
	}
}
...
void func_79(int* iParam0, var uParam1, char* sParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	...
	if (MISC::IS_BIT_SET(*iParam0))
	{
		...
		else
		{
			...
			else if (MISC::IS_BIT_SET(*sParam2))
			{
				if (ENTITY::GET_ENTITY_COORDS(*sParam2, false))
				{
					if (unk_0xE0B3BC41DDA88DF0(*iParam0, *sParam2, 0))
					{
						iVar1 = 1;
					}
				}
	...
	if (MISC::IS_BIT_SET(*sParam2))
	{
		if (ENTITY::GET_ENTITY_COORDS(*sParam2, false))
		{
			...
			{
				VEHICLE::REMOVE_VEHICLE_STUCK_CHECK(*sParam2);
				VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(*sParam2);
				AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(*sParam2, 0f);
				STREAMING::REMOVE_ANIM_DICT(sParam2);
				if (SYSTEM::VMAG(*uParam3))
				{
					unk_0x93370FA10F15BE44(uParam3);
				}
...
int func_80()
{
	...
	while (iVar1 < 4)
	{
		if (MISC::IS_BIT_SET(iLocal_83[iVar1]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[iVar1]))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_83[iVar1], unk_0x9B0761B4C3EB8BC7(), 200f, 200f, 200f, false, true, 0))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < 4)
	{
		if (MISC::IS_BIT_SET(iLocal_84[iVar1]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_84[iVar1]))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_84[iVar1], unk_0x9B0761B4C3EB8BC7(), 200f, 200f, 200f, false, true, 0))
				{
					iVar0 = 0;
				}
			}
...
void func_81()
{
	...
	if (bLocal_283)
	{
		...
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_86[0], 0))
			{
			}
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[1]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_86[1], 0))
			{
			}
		}
		else
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_84[0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_87[0], 0))
			{
			}
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_84[1]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_87[1], 0))
			{
			}
		}
		iVar0 = 0;
		while (iVar0 < 4)
		{
			...
			else if (!SYSTEM::VDIST(iLocal_83[iVar0], 0))
			{
				if (!SYSTEM::VMAG(fLocal_93[iVar0]))
				{
					fLocal_93[iVar0] = func_72(iLocal_83[iVar0], 1, 145);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			...
			else if (!SYSTEM::VDIST(iLocal_84[iVar0], 0))
			{
				if (!SYSTEM::VMAG(fLocal_94[iVar0]))
				{
					fLocal_94[iVar0] = func_72(iLocal_84[iVar0], 1, 145);
				}
			}
			iVar0++;
		}
	...
	{
		case 0:
			if (((PLAYER::_0x5FC472C501CCADB3(PLAYER::PLAYER_ID()) || !unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_100 + Vector(0f, 20f, 0f), 170f, 270f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, 0, 1, 0))
			{
				if (!bLocal_110)
				{
				...
				if (MISC::ABSF(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), &Local_102, 1, 1077936128, 0))
				{
		...
		case 2:
			if (bLocal_110)
			{
				...
				{
					if (((!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_88[0], 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_88[1], 0)) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[0])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[1]))
					{
			...
			if (SYSTEM::TIMERA() > 10000)
			{
				...
				{
					if (!PED::IS_PED_IN_MODEL(unk_0x9B0761B4C3EB8BC7(), joaat("rebel")))
					{
						iLocal_46 = 3;
					}
					else
		...
		case 3:
			Local_103 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
			bLocal_76 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(10, 15);
			if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, 0, 1, 0))
			{
				if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Local_103, bLocal_76, &(Local_280[0 /*3*/]), 1, 1077936128, 0))
				{
					...
					{
						if (ENTITY::GET_ENTITY_COORDS(iLocal_86[0], false))
						{
							unk_0x03D382CB0B44E2FC(iLocal_86[0], Local_280[0 /*3*/], 1, 0, 0, 1);
							func_98(iLocal_86[0], iLocal_83[0]);
						}
						if (ENTITY::GET_ENTITY_COORDS(iLocal_86[1], false))
						{
							unk_0x03D382CB0B44E2FC(iLocal_86[1], Local_280[1 /*3*/], 1, 0, 0, 1);
		...
		case 4:
			Local_103 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
			bLocal_76 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(30, 35);
			if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, 0, 1, 0))
			{
				if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Local_103, bLocal_76, &(Local_280[0 /*3*/]), 1, 1077936128, 0))
				{
					...
					if (!CAM::IS_SPHERE_VISIBLE(Local_280[0 /*3*/], 7f) && !CAM::IS_SPHERE_VISIBLE(Local_280[1 /*3*/], 7f))
					{
						if (ENTITY::GET_ENTITY_COORDS(iLocal_87[0], false))
						{
							unk_0x03D382CB0B44E2FC(iLocal_87[0], Local_280[0 /*3*/], 1, 0, 0, 1);
							func_98(iLocal_87[0], iLocal_84[0]);
						}
						if (ENTITY::GET_ENTITY_COORDS(iLocal_87[1], false))
						{
							unk_0x03D382CB0B44E2FC(iLocal_87[1], Local_280[1 /*3*/], 1, 0, 0, 1);
		...
		case 5:
			Local_103 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
			bLocal_76 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(5, 10);
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Local_103, bLocal_76, &(Local_280[0 /*3*/]), 1, 1077936128, 0))
			{
				Local_280[1 /*3*/] = { Local_280[0 /*3*/] + Vector(0f, 5f, 0f) };
				if (!CAM::IS_SPHERE_VISIBLE(Local_280[0 /*3*/], 7f) && !CAM::IS_SPHERE_VISIBLE(Local_280[1 /*3*/], 7f))
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_88[0], false))
					{
						unk_0x03D382CB0B44E2FC(iLocal_88[0], Local_280[0 /*3*/], 1, 0, 0, 1);
						func_98(iLocal_88[0], iLocal_83[0]);
					}
					if (ENTITY::GET_ENTITY_COORDS(iLocal_88[1], false))
					{
						unk_0x03D382CB0B44E2FC(iLocal_88[1], Local_280[1 /*3*/], 1, 0, 0, 1);
		...
		case 6:
			if (func_68())
			{
				...
				if (iLocal_78 < 5 && iLocal_79 < MISC::GET_GAME_TIMER())
				{
					...
					MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS((Local_50.x + fLocal_64), (Local_50.f_1 + fLocal_65), (Local_50.f_2 + fLocal_66), (Local_50.x - fLocal_64), (Local_50.f_1 - fLocal_65), Local_50.f_2, 10, false, joaat("weapon_assaultrifle"), 0, true, true, -1f);
					iLocal_79 = (MISC::GET_GAME_TIMER() + NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(200, 500));
					iLocal_78++;
				}
			}
			if (iLocal_78 > 4)
...
void func_98(bool bParam0, bool bParam1)
{
	...
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bParam0, 5f);
	Local_279 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1) };
	Local_281 = { Local_103 - Local_279 };
	ENTITY::SET_ENTITY_HEADING(bParam0, unk_0x9075769DD4F148B7(Local_281.x, Local_281.f_1));
	if (bLocal_110)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam1))
		{
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				TASK::TASK_VEHICLE_CHASE(bParam1, unk_0x9B0761B4C3EB8BC7());
				SYSTEM::WAIT(true);
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam1))
				{
					TASK::SET_TASK_VEHICLE_CHASE_BEHAVIOR_FLAG(bParam1, 32, true);
				}
			}
			else
			{
				TASK::TASK_VEHICLE_MISSION_PED_TARGET(bParam1, bParam0, unk_0x9B0761B4C3EB8BC7(), 6, 20f, 786469, -1f, -1f, true);
			}
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0))
			{
				VEHICLE::SET_VEHICLE_FORWARD_SPEED(bParam0, ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7()));
			}
		}
	}
	else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam1))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			TASK::TASK_VEHICLE_CHASE(bParam1, unk_0x9B0761B4C3EB8BC7());
		...
		{
			TASK::TASK_VEHICLE_MISSION_PED_TARGET(bParam1, bParam0, unk_0x9B0761B4C3EB8BC7(), 2, 100f, 786469, -1f, -1f, true);
		}
		VEHICLE::SET_VEHICLE_FORWARD_SPEED(bParam0, ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7()));
	}
}
...
void func_99()
{
	...
	ENTITY::SET_ENTITY_COORDS(iLocal_86[0], 1);
	...
	ENTITY::SET_ENTITY_COORDS(iLocal_86[1], 1);
	...
	ENTITY::SET_ENTITY_COORDS(iLocal_88[0], 1);
	...
	ENTITY::SET_ENTITY_COORDS(iLocal_88[1], 1);
	...
	ENTITY::SET_ENTITY_COORDS(iLocal_87[0], 1);
	...
	ENTITY::SET_ENTITY_COORDS(iLocal_87[1], 1);
	...
	while (iVar0 < 4)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[iVar0]))
		{
			...
			if (bLocal_110)
			{
				unk_0x92BD213E6A0E666B(iLocal_83[0], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[1]))
				{
					unk_0x92BD213E6A0E666B(iLocal_83[1], joaat("weapon_pistol"), -1, 1, 1);
				}
			...
			{
				unk_0x92BD213E6A0E666B(iLocal_83[iVar0], joaat("weapon_pistol"), -1, 1, 1);
	...
	while (iVar0 < 4)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[iVar0]))
		{
			...
			{
				unk_0x92BD213E6A0E666B(iLocal_84[iVar0], joaat("weapon_pistol"), -1, 1, 1);
	...
	switch (iLocal_74)
	{
		case 0:
			if (bLocal_107)
			{
				...
				while (iVar0 < 4)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_83[iVar0], 100f, 100f, 20f, false, true, 0))
						{
							iLocal_74 = 3;
						}
					}
			...
			if (bLocal_108)
			{
				...
				while (iVar1 < 4)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_84[iVar1]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_84[iVar1], 100f, 100f, 20f, false, true, 0))
						{
							iLocal_74 = 3;
						}
					}
		...
		case 3:
			...
			if (bLocal_107)
			{
				...
				while (iVar2 < 4)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_83[iVar2]))
					{
						...
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_83[iVar2]);
							TASK::TASK_COMBAT_PED(iLocal_83[iVar2], unk_0x9B0761B4C3EB8BC7(), 0, 16);
			...
			if (bLocal_108)
			{
				...
				while (iVar3 < 4)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_84[iVar3]))
					{
						...
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_84[iVar3]);
							TASK::TASK_COMBAT_PED(iLocal_84[iVar3], unk_0x9B0761B4C3EB8BC7(), 0, 16);
...
void func_102()
{
	...
	{
		case 0:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_80))
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_101, 7f, 7f, 10f, 0, 1, 0))
				{
					...
					TASK::TASK_LOOK_AT_ENTITY(bLocal_80, unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					if (!SYSTEM::VMAG(fLocal_90))
					{
						fLocal_90 = func_103(iLocal_97);
					}
					iLocal_71 = MISC::GET_GAME_TIMER();
					iLocal_72++;
				}
	...
	switch (iLocal_73)
	{
		case 1:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_80))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_80, 10f, 10f, 6f, false, true, 0))
				{
					if (!func_68())
					{
		...
		case 2:
			if (!func_68() || SYSTEM::TIMERB() > 4000)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_80))
				{
					CAM::IS_AIM_CAM_ACTIVE(bLocal_80, 0, 0);
					unk_0x93370FA10F15BE44(&fLocal_91);
				}
				if (SYSTEM::TIMERB() > 7000)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_81[6]))
					{
						CAM::IS_AIM_CAM_ACTIVE(iLocal_81[6], 0, 0);
						unk_0x93370FA10F15BE44(&(fLocal_92[6]));
					}
				}
				if (SYSTEM::TIMERB() > 9000)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_81[7]))
					{
						CAM::IS_AIM_CAM_ACTIVE(iLocal_81[7], 0, 0);
						unk_0x93370FA10F15BE44(&(fLocal_92[7]));
					}
					iLocal_73++;
				}
			}
...
void func_106()
{
	...
	else
	{
		...
		while (iVar0 < 9)
		{
			if (MISC::IS_BIT_SET(iLocal_81[iVar0]))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_81[iVar0]))
				{
					if (iVar0 == 0)
					{
					}
				}
				else if (SYSTEM::VMAG(fLocal_92[iVar0]))
				{
					unk_0x93370FA10F15BE44(&(fLocal_92[iVar0]));
				}
			}
			iVar0++;
		}
		...
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_82[iVar0]))
			{
			}
			iVar0++;
		}
		if (!func_134())
		{
			if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_48[7 /*3*/], 110f, 95f, 40f, 0, 1, 0))
			{
				...
				if ((!SYSTEM::VMAG(fLocal_91) && !SYSTEM::VMAG(fLocal_92[6])) && !SYSTEM::VMAG(fLocal_92[7]))
				{
					fLocal_91 = func_72(bLocal_80, 1, 145);
					fLocal_92[6] = func_72(iLocal_81[6], 1, 145);
					fLocal_92[7] = func_72(iLocal_81[7], 1, 145);
				}
				HUD::SHOW_HEIGHT_ON_BLIP(fLocal_91, false);
				HUD::SHOW_HEIGHT_ON_BLIP(fLocal_92[6], false);
				HUD::SHOW_HEIGHT_ON_BLIP(fLocal_92[7], false);
				func_107(1);
			}
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_81[6]))
		{
			if (((((TASK::GET_SCRIPT_TASK_STATUS(iLocal_81[6], 1785177548) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_81[6], 1785177548) != 0) || FIRE::IS_ENTITY_ON_FIRE(iLocal_81[6])) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_81[6])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_81[6])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(iLocal_81[6]))
			{
				CAM::IS_AIM_CAM_ACTIVE(iLocal_81[6], 0, 0);
			}
		}
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_80))
		{
			if (((((TASK::GET_SCRIPT_TASK_STATUS(bLocal_80, 1785177548) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bLocal_80, 1785177548) != 0) || FIRE::IS_ENTITY_ON_FIRE(bLocal_80)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_80)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(bLocal_80)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(bLocal_80))
			{
				CAM::IS_AIM_CAM_ACTIVE(bLocal_80, 0, 0);
			}
		}
	...
	switch (iLocal_75)
	{
		case 0:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_81[6]))
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_81[6], 1) + Vector(0f, 2.5f, 0f), 9f, 5f, 5f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(unk_0x9B0761B4C3EB8BC7(), iLocal_81[6]))
				{
					TASK::TASK_LOOK_AT_ENTITY(iLocal_81[6], unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_81[6], 4000, 2048, 2);
			...
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_81[7]))
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_81[7], 1) + Vector(0f, 3f, 0f), 9f, 7f, 5f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(unk_0x9B0761B4C3EB8BC7(), iLocal_81[7]))
				{
					TASK::TASK_LOOK_AT_ENTITY(iLocal_81[7], unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_81[7], 4000, 2048, 2);
					func_82(&uLocal_114, "REDGWAU", "REDGW_NDIE1", 4, 0, 0, 0);
					iLocal_71 = MISC::GET_GAME_TIMER();
					iLocal_75 = 1;
				}
			}
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_81[6]) && STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_81[7]))
			{
				iLocal_75 = 2;
			}
			break;
		...
		case 1:
			if (SYSTEM::VMAG(fLocal_91))
			{
				HUD::SHOW_HEIGHT_ON_BLIP(fLocal_91, true);
			}
			if (SYSTEM::VMAG(fLocal_92[6]))
			{
				HUD::SHOW_HEIGHT_ON_BLIP(fLocal_92[6], true);
			}
			if (SYSTEM::VMAG(fLocal_92[7]))
			{
				HUD::SHOW_HEIGHT_ON_BLIP(fLocal_92[7], true);
			}
...
void func_117()
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_85[0], 0))
	{
		if (MISC::IS_MINIGAME_IN_PROGRESS(iLocal_85[0], -1, 0) == iLocal_81[8])
		{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_80))
	{
		if (MISC::IS_PC_VERSION(bLocal_80))
		{
			CAM::IS_AIM_CAM_ACTIVE(bLocal_80, 0, 0);
		}
	}
	else if (SYSTEM::VMAG(fLocal_91))
	{
		unk_0x93370FA10F15BE44(&fLocal_91);
	}
	iVar0 = 0;
	while (iVar0 < 9)
	{
		...
		if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_81[iVar0]))
		{
			if (SYSTEM::VMAG(fLocal_92[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(fLocal_92[iVar0]));
			}
		}
...
void func_118()
{
	...
	if ((((((((ENTITY::DOES_ENTITY_EXIST(joaat("g_m_m_chigoon_02")) && ENTITY::DOES_ENTITY_EXIST(joaat("g_m_y_salvagoon_03"))) && ENTITY::DOES_ENTITY_EXIST(joaat("rebel"))) && ENTITY::DOES_ENTITY_EXIST(joaat("bobcatxl"))) && ENTITY::DOES_ENTITY_EXIST(joaat("sanchez"))) && ENTITY::DOES_ENTITY_EXIST(joaat("a_c_rottweiler"))) && ENTITY::DOES_ENTITY_EXIST(joaat("prop_security_case_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrong")) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrongdead_peds"))
	{
		PATHFIND::SET_ROADS_IN_AREA(Local_100 - Vector(150f, 150f, 150f), Local_100 + Vector(150f, 150f, 150f), false, true, 1, 1);
		...
		while (iVar1 < 6)
		{
			if (iVar1 <= 3)
			{
				...
				PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_81[iVar1], 3.180948E-43f, 1);
			}
			else
			{
		...
		while (iVar1 < iLocal_82)
		{
			...
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_82[iVar1], 3.180948E-43f, 1);
			Local_50 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_82[iVar1], 1) };
		...
		if (ENTITY::GET_ENTITY_COORDS(iLocal_85[0], false))
		{
			...
			CAM::IS_AIM_CAM_ACTIVE(iLocal_81[8], 0, 0);
		}
		if (!SYSTEM::VMAG(fLocal_89))
		{
		}
		...
		PED::_0x2208438012482A1A(iLocal_81[6], 1);
		...
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_81[6], 3.180948E-43f, 1);
		...
		PED::_0x2208438012482A1A(iLocal_81[7], 1);
		...
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_81[7], 3.180948E-43f, 1);
		bLocal_80 = PED::CREATE_PED(22, joaat("g_m_m_chigoon_02"), Local_63, fLocal_67, true, true);
		func_100(&uLocal_114, 4, bLocal_80, "REDGWChinese", 0, 1);
		PED::_0x2208438012482A1A(bLocal_80, 1);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_80, iLocal_113);
		iVar5 = PED::CREATE_SYNCHRONIZED_SCENE(Local_63, 7.5f, -12.75f, 51.5f, 0);
		TASK::TASK_SYNCHRONIZED_SCENE(bLocal_80, iVar5, "random@dealgonewrong", "idle_b", 8f, -8f, 5, 0, 1000f, 0);
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iVar5, true);
		ENTITY::DETACH_ENTITY(bLocal_80, 4f, 18f, 326.7277f, 0, 1);
		PED::SET_PED_KEEP_TASK(bLocal_80, true);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_80, 3.180948E-43f, 1);
		...
		iLocal_99[0] = GRAPHICS::ADD_DECAL(1110, -1632.953f, 4745.359f, 51.7876f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(false);
		iLocal_99[1] = GRAPHICS::ADD_DECAL(1110, -1634.87f, 4744.458f, 51.8233f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(false);
		iLocal_99[2] = GRAPHICS::ADD_DECAL(1110, -1636.971f, 4736.595f, 52.2814f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(false);
		iLocal_99[3] = GRAPHICS::ADD_DECAL(1110, -1625.561f, 4741.241f, 51.7102f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(false);
		iLocal_99[4] = GRAPHICS::ADD_DECAL(1110, -1621.533f, 4744.576f, 51.9093f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(false);
		iLocal_99[5] = GRAPHICS::ADD_DECAL(1110, -1621.963f, 4737.039f, 51.4174f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(false);
		iLocal_99[6] = GRAPHICS::ADD_DECAL(1110, -1628.517f, 4736.906f, 51.8207f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(false);
		iLocal_99[7] = GRAPHICS::ADD_DECAL(1110, -1629.324f, 4732.146f, 51.6947f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(false);
		iLocal_99[8] = GRAPHICS::ADD_DECAL(1110, -1640.287f, 4738.437f, 52.1756f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(false);
		iLocal_99[9] = GRAPHICS::ADD_DECAL(1110, -1640.055f, 4701.995f, 41.2428f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(false);
		iLocal_99[10] = GRAPHICS::ADD_DECAL(1110, -1641.924f, 4692.236f, 38.3762f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, false, false, false);
		iVar1 = 0;
		while (iVar1 < 6)
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_81[iVar1], 0))
			{
				...
				SYSTEM::WAIT(NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(100, 500));
				if (iVar1 <= 5)
				{
					if (SYSTEM::VMAG(fLocal_92[iVar1]))
					{
						unk_0x93370FA10F15BE44(&(fLocal_92[iVar1]));
					}
				}
			}
			iVar1++;
...
void func_120()
{
	...
	{
		SYSTEM::WAIT(false);
		if (MISC::IS_BIT_SET(iLocal_85[iVar0]))
		{
...
int func_121()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_132())
		{
			return 0;
		}
	}
...
int func_155()
{
	...
	func_156(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_172()) || Global_110905) || Global_30970) || func_171()) || func_95(8, -1)) || func_168()) || func_170()) || func_169()) || func_167()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_172() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_167()) || func_166()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
bool func_177(int iParam0)
{
	...
	if (bVar0 < 31)
	{
		bVar1 = unk_0xCE990E643CD9D0E5(Global_111858.f_24991, bVar0);
	}
	else
	{
		bVar0 = (bVar0 - 31);
