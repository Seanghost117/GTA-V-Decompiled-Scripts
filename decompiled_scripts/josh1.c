...
void __EntryFunction__()
{
	...
	{
		iLocal_262 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(unk_0x9B0761B4C3EB8BC7());
	}
...
void func_1()
{
	switch (iLocal_83)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh1leadinout") && ENTITY::DOES_ENTITY_EXIST(joaat("p_amb_phone_01")))
			{
				if (!MISC::IS_BIT_SET(bLocal_85))
				{
					...
					bLocal_85 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), true, false, true);
				}
				iLocal_83 = 1;
			}
			break;
		...
		case 1:
			...
			if (!iLocal_94)
			{
				if (func_294(Local_81.f_28[0]) && MISC::IS_BIT_SET(bLocal_85))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1000f);
					ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(bLocal_85);
					ENTITY::FREEZE_ENTITY_POSITION(Local_81.f_28[0], true, 0);
					func_243("Done Josh leadout anim");
					iLocal_94 = 1;
				}
			}
			else if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_87))
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_87) > 0.29f)
				{
					if (!iLocal_95)
					{
				...
				if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_87) > 0.98f)
				{
				...
				if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, 1, 0))
				{
					...
					if (func_293(Local_81.f_28[0]))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_81.f_28[0]);
						func_243("Stopping Josh?");
					}
					if (MISC::IS_BIT_SET(bLocal_85))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(bLocal_85, -8f, true);
					}
					iLocal_96 = 1;
				}
				...
				if ((STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Local_81.f_28[0]) || FIRE::IS_ENTITY_ON_FIRE(Local_81.f_28[0])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_81.f_28[0], 1), 5f))
				{
					if (func_293(Local_81.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_81.f_28[0], -8f, true);
		...
		case 2:
			...
			if (func_293(Local_81.f_28[0]))
			{
				...
				AUDIO::STOP_SCRIPTED_CONVERSATION(Local_81.f_28[0], iLocal_84);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_84);
				PED::_0x2208438012482A1A(Local_81.f_28[0], 0);
				if (iLocal_96 == 0)
				{
			...
			if (iLocal_96 == 0)
			{
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(904342475, 0f, true, true);
...
float func_215(bool bParam0, bool bParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_235(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_239(PLAYER::PLAYER_ID())) && !func_237(PLAYER::PLAYER_ID(), 0)) && !func_236()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_239(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
	...
	switch (iLocal_83)
	{
		case 0:
			if (func_260(1, 1093140480, 0))
			{
				...
				if (func_259(iVar0))
				{
					if (unk_0x1037B9D45CE6B788(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, 1, 0))
					{
		...
		case 1:
			...
			if (CUTSCENE::WAS_CUTSCENE_SKIPPED())
			{
				...
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false))
				{
					ENTITY::CREATE_MODEL_HIDE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false);
				...
				{
					ENTITY::CREATE_MODEL_HIDE(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), false);
			...
			if (!NETWORK::_0xC87E740D9F3872CC())
			{
				...
				if (!iLocal_94)
				{
					...
					if (func_294(Local_81.f_28[0]) && MISC::IS_BIT_SET(bLocal_85))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(bLocal_85);
						ENTITY::FREEZE_ENTITY_POSITION(Local_81.f_28[0], false, 0);
						iLocal_94 = 1;
					}
				}
				iLocal_83 = 2;
...
int func_245(bool bParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
	...
	if (MISC::IS_BIT_SET(iVar0))
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_254(bVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_254(bool bParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_266(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_266(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	switch (iLocal_83)
	{
		...
		case 1:
			if (!func_5(0))
			{
				if (!bLocal_90)
				{
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, 1, 0))
					{
						if (func_294(Local_81.f_28[0]) && MISC::IS_BIT_SET(bLocal_85))
						{
							...
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_85, iLocal_86, "leadin_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1000f);
							TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), Local_81.f_28[0], -1, 0, 2);
							TASK::TASK_LOOK_AT_ENTITY(Local_81.f_28[0], unk_0x9B0761B4C3EB8BC7(), 4000, 2060, 2);
				...
				else if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_86))
				{
					if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_86) > 0.15f)
					{
						if (!iLocal_91)
						{
					...
					if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_86) > 0.9f)
					{
...
void func_270()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_266(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_290(0) || Global_77102) || Global_77091 == 1) || !GRAPHICS::DRAW_SCALEFORM_MOVIE())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((OBJECT::ADD_DOOR_TO_SYSTEM() || func_275(0)) || func_289(1))
			{
			}
			else
			{
...
int func_297(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(904342475, 0f, false, false);
	...
	if (bParam1)
	{
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(-795418380, 0f, false, false);
		unk_0xDC5C33A98881772F(904342475, 4, 0, 1);
		iVar0++;
	}
	else
...
void func_298(char* sParam0, bool bParam1)
{
	...
	func_299(sParam0, iLocal_79, Var0, fVar1);
...
void func_299(char* sParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_300(sParam0);
...
void func_323(bool bParam0)
{
	...
	if (!func_340())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_324(TASK::IS_PED_BEING_ARRESTED(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_325(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_331())
	{
		...
		{
			iVar2 = func_326(TASK::IS_PED_BEING_ARRESTED());
			if (iVar2 > -1)
			{
...
int func_329(void fParam0, bool bParam1)
{
	int iVar0;
