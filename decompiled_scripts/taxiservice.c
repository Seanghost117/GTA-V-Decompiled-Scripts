...
void __EntryFunction__()
{
	...
	iLocal_105 = -1;
	iLocal_106 = -1;
	sLocal_107 = unk_0xED026A379B794F61(2, 195, 1);
...
Vector3 func_49(int iParam0)
{
	...
	{
		uVar4 = unk_0x6B251360897FB3D0(iParam0);
...
void func_66()
{
	...
	if (!func_221())
	{
		if (unk_0x95EF219D38B20CFF(uLocal_112))
		{
			if (iLocal_821 != 0)
			{
		...
		{
			uLocal_112 = unk_0x5DEA4192B46CB99B("instructional_buttons");
		}
	}
	else
	{
		unk_0x2E352DDBBF674246(&uLocal_112);
		iLocal_58 = 1;
	}
}
...
int func_76()
{
	...
	if (unk_0x40397A9A17EEC1C5(uLocal_68))
	{
		if (unk_0xC516FEEB950FFD58(uLocal_68))
		{
			return 0;
		}
	}
		...
		case 1:
			if (unk_0x03DB5C6AABF8DA46() && unk_0x306BF588BD8151E8("FADE_OUT_WORLD_250MS_SCENE"))
			{
				...
				if (unk_0xC516FEEB950FFD58(uLocal_68))
				{
					...
					Global_110906 = 0;
					unk_0x856549C07003344B(uLocal_68, 0);
					unk_0x3ED9330214992278(0, 0, 3000, 1, 0, 0);
...
void func_83()
{
	...
	switch (iLocal_816)
	{
		case 92:
			Var0 = { func_85(229, 0) };
			fVar1 = unk_0x272784C60C397DB6(Global_110896, Var0, 1);
			if (fVar1 < 100f)
			{
...
void func_122()
{
	...
	fVar0 = (((func_121(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), Global_110896) / 50f) * fLocal_73) * 2.4f);
...
void func_123()
{
	iLocal_103 = (iLocal_103 + SYSTEM::ROUND((unk_0x9E3DAF75EFC49F5B() * 1000f)));
	if (iLocal_103 > 5000)
	{
		fLocal_82 = (fLocal_82 + fLocal_73);
		iLocal_103 = 0;
	}
	if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), Local_833, 0) > 50f)
	{
		fLocal_82 = (fLocal_82 + fLocal_73);
		iLocal_103 = 0;
		Local_833 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0) };
	}
	iLocal_101 = SYSTEM::CEIL(fLocal_82);
	if (iLocal_101 != iLocal_102)
	{
		unk_0x830F007E19C63E14(uLocal_111, "SET_TAXI_PRICE");
		unk_0xAD291B8F75D737AD(iLocal_101);
		unk_0xE1FDD153F5858534();
		fLocal_83 = SYSTEM::VDIST(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), Global_110896);
	...
	if (unk_0x8F678487EEBD8CE4(*iParam0))
	{
		switch (iLocal_820)
		{
			...
			case 2:
				...
				{
					if (func_127(&Global_110889, unk_0x3E4D3CCC220BDFB1(Global_110889, 0), Local_829, uParam1, uParam2, &iLocal_88, iParam0, 1000))
					{
						iLocal_820 = 3;
						return 0;
					}
...
int func_127(var uParam0, struct<3> Param1, struct<3> Param2, var uParam3, var uParam4, int iParam5, var uParam6, int iParam7)
{
	...
	if (func_131(Local_830, Local_831))
	{
		while (!bVar13 && *iParam5 < iVar18)
		{
			...
			if (unk_0x1485BFBB1EC6FE22(Param2, *iParam5, uParam3, uParam4, &iVar6, iVar14, fVar0, fVar1))
			{
				uVar12 = unk_0xBD67304F930F21E4(*uParam3, 1, iVar14, 1077936128, 0);
				if (unk_0xB4D59BAA683CC8ED(uVar12))
				{
					if (unk_0x7F270824E67C2031(*uParam3, 1f, 1, &uVar4, &uVar3, &iVar8, &iVar7, &fVar10, iVar15))
					{
						...
						{
							*uParam3 = { unk_0x1BAE5C94E38E44FE(*uParam3, *uParam4, fVar9, 0f, 0f) };
							if (unk_0x80FF6C016CDB0FAF(*uParam0, 0))
							{
								iVar5 = *uParam0;
							}
	...
	if (!unk_0x5AEB5DDFFAD43CA5(Global_110890) && unk_0x80FF6C016CDB0FAF(Global_110889, 0))
	{
		if (unk_0xACBCFA3095C5A434(Global_110890, Global_110889))
		{
			...
			else if (!func_2(Global_110890, -272084098))
			{
				...
				uVar1 = unk_0xEF7858F25585F853(Global_110889);
				unk_0x2976DB62CAE67C30(Global_110890, Global_110889, Var0, uVar1, 3, 60f, 0);
			}
		}
	}
}
				...
				if (!unk_0x5AEB5DDFFAD43CA5(Global_110890))
				{
					...
					else if (!func_2(Global_110890, 242628503))
					{
						...
						else
						{
							...
							unk_0x9DC06E2A59C5AEBB(&uLocal_813);
							...
							unk_0x19F29730874AD6F1(uLocal_813);
							unk_0x9B6EC2CECE1010EF(Global_110890, uLocal_813);
							unk_0x4F83FEE4454169D4(&uLocal_813);
						}
					}
				}
			}
...
int func_178()
{
	...
	if (unk_0xAE06B9E39EBDE049(Global_110889))
	{
		if (unk_0x80FF6C016CDB0FAF(Global_110889, 0))
		{
			iLocal_109 = unk_0x79CC07752E7432A1(iLocal_108, unk_0x3E4D3CCC220BDFB1(Global_110889, 1), 1, 1, 0);
			...
			uLocal_93 = unk_0x2BC38EC678978375("taxi");
		}
	}
	return 0;
}
...
int func_179()
{
	...
	uLocal_111 = unk_0x5DEA4192B46CB99B("taxi_display");
	uLocal_112 = unk_0x5DEA4192B46CB99B("instructional_buttons");
	unk_0x131ED02492676000(&cLocal_824);
	if (((unk_0x7D167B9A0CCDA347(iLocal_108) && unk_0x95EF219D38B20CFF(uLocal_111)) && unk_0x95EF219D38B20CFF(uLocal_112)) && unk_0xC614DDE265D18415(&cLocal_824))
	{
		return 1;
	}
	return 0;
...
void func_180()
{
	...
	if (!unk_0x40397A9A17EEC1C5(uLocal_68))
	{
		...
		{
			uLocal_68 = unk_0x68C2E3309DCAD71E("DEFAULT_SCRIPTED_CAMERA", 0);
			unk_0x3B1D5D044BC72834(uLocal_68, Global_110889, Local_835, 1);
			func_184();
			unk_0x0473DA77B4E870C1(uLocal_68, 1);
		}
	}
	else if (!bLocal_60 || bLocal_59)
	{
		if (!func_188() && !func_187(8, -1))
		{
			if (!unk_0xC516FEEB950FFD58(uLocal_68))
			{
				...
				unk_0x0473DA77B4E870C1(uLocal_68, 1);
				func_182();
				unk_0x856549C07003344B(uLocal_68, 1);
	...
	else if (unk_0xC516FEEB950FFD58(uLocal_68))
	{
		unk_0x856549C07003344B(uLocal_68, 0);
		unk_0x4C4FC7841A5FB983(0f);
		unk_0x7965943E39128B42(0f, 1065353216);
...
void func_181()
{
	...
	unk_0x830F007E19C63E14(uLocal_111, "HIGHLIGHT_DESTINATION");
...
void func_182()
{
	...
	if (unk_0x8F678487EEBD8CE4(Local_43.x))
	{
		...
		if (unk_0x40397A9A17EEC1C5(uLocal_68) && unk_0xC516FEEB950FFD58(uLocal_68))
		{
...
void func_184()
{
	if (unk_0x40397A9A17EEC1C5(uLocal_68))
	{
		func_185(Global_110889, &uLocal_68, Local_836);
		unk_0xD64C2E5B5BA2D347(uLocal_68, fLocal_74);
		unk_0x8FFDD70F5142C6E0(uLocal_68, 0.01f);
		unk_0x32BA7619D645115E(uLocal_68, 1);
...
void func_189()
{
	...
	iVar0 = 0;
	func_194();
	unk_0x830F007E19C63E14(uLocal_111, "CLEAR_TAXI_DISPLAY");
	unk_0xE1FDD153F5858534();
	iVar0 = 0;
	while (iVar0 < iLocal_91)
	{
		...
		{
			unk_0x830F007E19C63E14(uLocal_111, "ADD_TAXI_DESTINATION");
			unk_0xAD291B8F75D737AD(iVar0);
			...
			if (unk_0x04FA724B68B59AC3(Local_819[iVar0 /*3*/]) == 2)
			{
				...
				{
					Var5 = { unk_0x3E4D3CCC220BDFB1(unk_0x9048E8838E822F21(unk_0x255EBCF840E6A9BB(Local_819[iVar0 /*3*/])), 1) };
				}
			}
			else if (unk_0x04FA724B68B59AC3(Local_819[iVar0 /*3*/]) == 1)
			{
				...
				{
					Var5 = { unk_0x3E4D3CCC220BDFB1(unk_0x255EBCF840E6A9BB(Local_819[iVar0 /*3*/]), 1) };
				}
			}
			else
			{
	...
	if (bLocal_60)
	{
		unk_0x830F007E19C63E14(uLocal_111, "SHOW_TAXI_DESTINATION");
		unk_0xE1FDD153F5858534();
		unk_0x830F007E19C63E14(uLocal_111, "HIGHLIGHT_DESTINATION");
		unk_0xAD291B8F75D737AD(iLocal_92);
		unk_0xE1FDD153F5858534();
	...
	if (SYSTEM::TIMERB() > 250)
	{
		...
		if (!bVar0)
		{
			if (iLocal_97 != -1)
			{
				...
				{
					uVar2 = unk_0xD9191A35088457A8(unk_0xE66C877C9033DBB0());
					if (unk_0x8F678487EEBD8CE4(uVar2))
					{
...
void func_214()
{
	if (iLocal_821 != 0)
	{
		unk_0xCA1F114B668562E5(uLocal_93);
		unk_0x9D15035C6653D1B1(4);
		unk_0xD8D551845E3EA730(1);
		if (unk_0x80FF6C016CDB0FAF(Global_110889, 0))
		{
			unk_0xE6A03BA84586E67B(uLocal_111, fLocal_86, fLocal_87, fLocal_84, fLocal_85, 0, 0, 0, 255, 0);
		}
	}
}
...
void func_217()
{
	...
	unk_0x830F007E19C63E14(uLocal_111, "SET_INPUT_EVENT");
...
int func_228()
{
	...
	if (unk_0x40397A9A17EEC1C5(uLocal_68))
	{
		...
		unk_0x856549C07003344B(uLocal_68, 0);
		unk_0xB8B0F7C8C1548C5B(uLocal_68, 0);
		unk_0x3ED9330214992278(0, 0, 3000, 1, 0, 0);
		unk_0xEAF342510C682548();
		unk_0x49EAC3B3479D60FE();
		unk_0x70EEA67CF09450BA(0);
...
int func_232()
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (func_236(&uVar0, func_238(), func_237()))
		{
			...
			{
				Local_832 = { unk_0x3E4D3CCC220BDFB1(Global_110889, 1) - unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1) };
				Local_832.f_2 = 0f;
