...
void __EntryFunction__()
{
	...
	fLocal_628 = 0f;
	iLocal_636 = -1;
	if (INTERIOR::GET_INTERIOR_AT_COORDS(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("appImportExport")) > 1)
	{
		func_412(1, 0);
	}
	iLocal_621 = unk_0x5DEA4192B46CB99B("IMPORT_EXPORT_WAREHOUSE");
	func_409(1);
	func_407(1);
	func_406();
	HUD::THEFEED_PAUSE();
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_621))
	{
		SYSTEM::WAIT(0);
	}
	Global_75647 = 1;
	...
	if (func_381())
	{
		unk_0xBE20AB8238688965(&uLocal_614, true);
	}
	if (func_380())
	{
	...
	while (Global_75647)
	{
		...
		switch (iLocal_638)
		{
			case 0:
				...
				if (!unk_0xCE990E643CD9D0E5(uLocal_614, true))
				{
					func_327();
				}
				if (!iLocal_610)
...
int func_1(bool bParam0)
{
	if (bParam0 != func_3())
	{
		...
		else if ((Global_1312896 && bParam0 == PLAYER::PLAYER_ID()) && func_2(bParam0, 1, 0))
		{
			return Global_2425869[bParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
int func_23(int iParam0, int iParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_61(bool bParam0, int iParam1)
{
	...
	{
		return func_62(Global_1630317[bParam0 /*595*/].f_11.f_33) == iParam1;
	}
	return 0;
}
...
int func_70(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (iParam0 == 4)
	{
		...
		if (iVar5 != 0)
		{
			...
			while (iVar0 < 4)
			{
				Global_1630317[PLAYER::PLAYER_ID() /*595*/].f_11.f_327[iVar0] = func_78(iVar5);
				iVar0++;
			}
			bVar3 = true;
		}
	...
	if (iParam0 != 4)
	{
		...
		else if (iVar4 >= iParam1)
		{
			...
			while (iVar0 < iParam1)
			{
				Global_1630317[PLAYER::PLAYER_ID() /*595*/].f_11.f_327[iVar0] = func_71(&iVar1, iVar4, &uVar8);
				iVar0++;
			}
			bVar3 = true;
		}
...
int func_71(int iParam0, int iParam1, var uParam2)
{
	...
	if (iParam1 > 0)
	{
		...
		while (iVar7 < iParam1)
		{
			...
			{
				func_72((*iParam0)[iVar7], &iVar8, &bVar9);
				if (!unk_0xCE990E643CD9D0E5((*uParam2)[iVar8], bVar9))
				{
		...
		if (iVar3 > 0)
		{
			...
			func_72(uVar2[bVar13], &iVar8, &bVar9);
			unk_0xBE20AB8238688965(uParam2[iVar8], bVar9);
			return uVar2[bVar13];
		}
		else
		{
			...
			if (iVar3 > 0)
			{
				...
				func_72(uVar2[bVar14], &iVar8, &bVar9);
				unk_0xBE20AB8238688965(uParam2[iVar8], bVar9);
				return uVar2[bVar14];
			}
			else
			{
				...
				func_72(uVar2[bVar15], &iVar8, &bVar9);
				unk_0xBE20AB8238688965(uParam2[iVar8], bVar9);
				return uVar2[bVar15];
			}
		}
...
void func_81(bool bParam0, bool bParam1)
{
	if (bParam1)
	{
		if (bParam0 != func_3())
		{
			if (!unk_0xCE990E643CD9D0E5(Global_2425869[bParam0 /*443*/].f_199, 19))
			{
				unk_0xBE20AB8238688965(&(Global_2425869[bParam0 /*443*/].f_199), 19);
			}
		}
	}
	else if (bParam0 != func_3())
	{
		if (unk_0xCE990E643CD9D0E5(Global_2425869[bParam0 /*443*/].f_199, 19))
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2425869[bParam0 /*443*/].f_199), 19);
		}
	}
}
...
int func_93(int iParam0, int iParam1)
{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (!func_94(bVar1, iParam0, 1))
			{
				if (iParam1 || !func_88(bVar1, 31))
				{
					return 1;
				}
			}
...
int func_104(int iParam0)
{
	...
	while (iVar0 < 32)
	{
		...
		if (AUDIO::PLAY_STREAM_FROM_VEHICLE(bVar1))
		{
			if ((Global_1630317[iParam0 /*595*/].f_11.f_34 != func_3() && Global_1630317[iParam0 /*595*/].f_11.f_34 == bVar1) && Global_1630317[bVar1 /*595*/].f_11.f_34 == iParam0)
			{
				return 1;
			}
		}
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_161(iParam1, iParam2, iParam3, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), iParam4);
		
		case 233:
			return func_154(iParam1, iParam2, iParam3, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(bParam5), iParam4);
		...
		case 243:
			return func_138(iParam1, iParam2, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(bParam5), iParam4);
		
		case 158:
			return func_134(iParam1, iParam2, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(bParam5), iParam4);
		
		case 181:
			return func_131(iParam1, iParam2, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(bParam5), iParam4);
...
int func_154(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (!func_159(iParam0))
	{
		if (bParam3 != func_3())
		{
			iVar0 = (iVar0 + func_156(iParam0, func_101(bParam3) + 1, bParam3, -1, iParam2));
		}
	}
	if (func_155(iParam0))
	{
...
int func_161(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (!func_171(iParam0))
	{
		if (bParam3 != func_3())
		{
			iVar0 = (iVar0 + func_163(iParam0, func_101(bParam3) + 1, bParam3, -1, iParam2));
		}
	}
	if (func_162(iParam0))
	{
...
int func_182(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_210(iParam1, iParam3, iParam4, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iParam5), 0, 0, 0);
		
		case 233:
			return func_204(iParam1, iParam3, iParam4, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(bParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_195(iParam1, iParam3, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(bParam5), 0, -1, 0, 0);
		
		case 158:
			return func_189(iParam1, iParam3, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(bParam5), 0, -1, 0, 0);
		
		case 181:
			return func_183(iParam1, iParam3, NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(bParam5), 0, -1, 0, 0);
...
int func_183(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			iVar0 = (iVar0 + func_186(func_101(bParam2) + 1, iParam0, bParam2));
		}
	}
	if (!bParam3)
	{
...
int func_189(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			iVar0 = (iVar0 + func_192(func_101(bParam2) + 1, iParam0, bParam2));
		}
	}
	if (!bParam3)
	{
...
int func_195(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam6)
	{
		...
		{
			iVar0 = (iVar0 + func_198(func_101(bParam2) + 1, iParam0));
		}
	}
	if (!bParam3)
	{
...
int func_204(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam5)
	{
		...
		if (bParam3 != func_3())
		{
			iVar0 = (iVar0 + func_209(iParam0, func_101(bParam3) + 1));
		}
	}
	if (!bParam6)
	{
		if (func_208(0, iParam1) != -1)
		{
			if (bParam3 != func_3())
			{
				iVar0 = (iVar0 + func_207(func_101(bParam3) + 1, iParam0));
			}
		}
	}
	if (!bParam4)
...
int func_210(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bParam5)
	{
		...
		if (bParam3 != func_3())
		{
			iVar0 = (iVar0 + func_215(iParam0, func_101(bParam3) + 1));
		}
	}
	if (!bParam6)
	{
		if (func_214(0, iParam1) != -1)
		{
			if (bParam3 != func_3())
			{
				iVar0 = (iVar0 + func_213(func_101(bParam3) + 1, iParam0));
			}
		}
	}
	if (!bParam4)
...
bool func_256(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2425869[bParam0 /*443*/].f_199, 19);
}
...
bool func_262(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2425869[bParam0 /*443*/].f_199, 18);
}
...
void func_263()
{
	...
	if (iLocal_624 == 2000000)
	{
		...
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "GET_CURRENT_SELECTION");
			iLocal_622 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "GET_CURRENT_TAB_ID");
			iLocal_623 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
			iLocal_624 = 1000000;
		}
	}
	if (iLocal_624 == 1000000 && (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_622) && GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_623)))
	{
		iLocal_613 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_623);
		iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_622);
		bVar1 = true;
		bVar2 = true;
		iLocal_624 = iVar0;
		if (func_321(iVar0))
		...
		else if (func_312(iVar0))
		{
			...
			{
				func_308(1, 0);
				GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(iLocal_620), -1f, -1f, -1f, -1f);
				iLocal_620 = iVar3;
				func_304(iVar3);
			}
			else
		...
		if (bVar1)
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(iVar0), -1f, -1f, -1f, -1f);
		}
		if (bVar2)
		{
			func_303(iLocal_613);
		...
		if (*iParam0 == 101)
		{
			if (iLocal_611)
			{
				...
				else
				{
					Var1 = { func_286(bVar0) };
					func_288();
					GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1f, -1f, -1f, -1f);
...
void func_284()
{
	...
	bVar7 = true;
	bVar8 = true;
	if ((iVar3 > 0 && !MONEY::_NETWORK_CASINO_CAN_PURCHASE_CHIPS_WITH_PVC_2(iVar3, 0, 1, 0, -1, 0)) || func_283(0))
	{
		bVar6 = false;
	}
	if ((iVar4 > 0 && !MONEY::_NETWORK_CASINO_CAN_PURCHASE_CHIPS_WITH_PVC_2(iVar4, 0, 1, 0, -1, 0)) || func_283(1))
	{
		bVar7 = false;
	}
	if ((iVar5 > 0 && !MONEY::_NETWORK_CASINO_CAN_PURCHASE_CHIPS_WITH_PVC_2(iVar5, 0, 1, 0, -1, 0)) || func_283(2))
	{
		bVar8 = false;
	}
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "SHOW_BUYERS");
...
void func_285()
{
	...
	while (iVar0 >= 0)
	{
		if (iLocal_616[iVar0] != 0)
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(iLocal_616[iVar0]), -1f, -1f, -1f, -1f);
			iLocal_616[iVar0] = 0;
		}
		else
		{
...
void func_288()
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "HIDE_OVERLAY");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	iLocal_637 = 0;
	if (iLocal_611)
	{
...
void func_289(bool bParam0)
{
	...
	while (iVar0 < 4)
	{
		if ((!bParam0 && iLocal_616[iVar0] != 0) || (bParam0 && iLocal_617[iVar0] != 0))
		{
			...
			Global_1572864[iVar0 /*102*/].f_100 = bLocal_618[iVar0];
		}
		else
		{
			func_300(&uVar1);
	...
	func_293(0);
	func_290(bLocal_618[0], bLocal_618[1], bLocal_618[2], bLocal_618[3], Global_1572864[0 /*102*/].f_101, Global_1572864[1 /*102*/].f_101, Global_1572864[2 /*102*/].f_101, Global_1572864[3 /*102*/].f_101, iLocal_619, bParam0);
	Global_1678254 = 1;
}
...
void func_293(bool bParam0)
{
	if (bParam0)
	{
		if (!unk_0xCE990E643CD9D0E5(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_200, 6))
		{
			unk_0xBE20AB8238688965(&(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_200), 6);
		}
	}
	else if (unk_0xCE990E643CD9D0E5(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_200, 6))
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_200), 6);
	}
}
...
void func_296(bool bParam0)
{
	if (bParam0)
	{
		if (!unk_0xCE990E643CD9D0E5(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_199, 18))
		{
			unk_0xBE20AB8238688965(&(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_199), 18);
		}
	}
	else if (unk_0xCE990E643CD9D0E5(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_199, 18))
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_199), 18);
	}
}
...
void func_302(bool bParam0)
{
	...
	while (iVar0 < 4)
	{
		if ((!bParam0 && iLocal_616[iVar0] != 0) || (bParam0 && iLocal_617[iVar0] != 0))
		{
			if (iVar0 == 0)
			{
				bLocal_618[iVar0] = PLAYER::PLAYER_ID();
			}
			else
			{
				func_300(&uVar1);
...
int func_316(bool bParam0)
{
	if (bParam0 != func_3())
	{
		if (func_2(bParam0, 1, 1))
		{
			...
			{
				return func_76(Global_2425869[bParam0 /*443*/].f_314.f_6) == 17;
			}
		}
	}
	return 0;
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "SHOW_OVERLAY");
	func_318(sParam0);
...
void func_322()
{
	...
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 205))
	{
		...
		{
			func_303(0);
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1f, -1f, -1f, -1f);
		}
	}
	...
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 206))
	{
		...
		{
			func_303(1);
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1f, -1f, -1f, -1f);
		}
	}
	PAD::ENABLE_CONTROL_ACTION(2, 207, true);
	if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 207))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(207), -1f, -1f, -1f, -1f);
	}
	if (STATS::STAT_GET_MASKED_INT(2, 207))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(207), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 208, true);
	if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 208))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(208), -1f, -1f, -1f, -1f);
	}
	if (STATS::STAT_GET_MASKED_INT(2, 208))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(208), -1f, -1f, -1f, -1f);
	}
	func_326();
	PAD::ENABLE_CONTROL_ACTION(2, 201, true);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 201))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1f, -1f, -1f, -1f);
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1f, -1f, -1f, -1f);
	}
	if (unk_0x3430895AB97DE4F3(2))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(237), -1f, -1f, -1f, -1f);
		}
		if (STATS::STAT_GET_MASKED_INT(2, 238))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(238), -1f, -1f, -1f, -1f);
		}
		func_323(0, 1);
	}
	else
...
void func_323(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		...
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "SET_ANALOG_STICK_INPUT");
			iLocal_629 = iVar0;
			iLocal_630 = iVar1;
			unk_0xF1B28F753235CE2A(true);
			NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_629);
			NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_630);
	...
	if (bParam1)
	{
		...
		if (((iVar2 != 127 || iLocal_631 != 127) || iVar3 != 127) || iLocal_632 != 127)
		{
			...
			iLocal_632 = iVar3;
			unk_0xF1B28F753235CE2A(false);
			NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_631);
			NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_632);
...
void func_324()
{
	fLocal_625 = HUD::_SET_MOUSE_CURSOR_ACTIVE_THIS_FRAME(2, 239);
	fLocal_626 = HUD::_SET_MOUSE_CURSOR_ACTIVE_THIS_FRAME(2, 240);
	if (fLocal_625 != fLocal_627 || fLocal_626 != fLocal_628)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "SET_MOUSE_INPUT");
		DLC::IS_DLC_PRESENT(fLocal_625);
		DLC::IS_DLC_PRESENT(fLocal_626);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(237), -1f, -1f, -1f, -1f);
	}
...
void func_326()
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 187, true);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 187))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 189, true);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 189))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 190, true);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 190))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_621, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1f, -1f, -1f, -1f);
	}
}
...
void func_327()
{
	...
	if (!unk_0xCE990E643CD9D0E5(uLocal_614, false) && !unk_0xCE990E643CD9D0E5(uLocal_614, 2))
	{
		if (func_332(16))
		{
			sVar0 = "IE_SEC_TUT7";
			...
			func_329(&uLocal_633, &uLocal_634, 18);
		}
		else if (func_332(17))
		{
			sVar0 = "IE_SEC_TUT8";
			...
			func_329(&uLocal_633, &uLocal_634, 21);
		}
		else if (func_332(18))
		{
			sVar0 = "IE_SEC_TUT13";
			...
			func_329(&uLocal_633, &uLocal_634, 36);
		}
		else if (func_332(19))
		{
			sVar0 = "IE_SEC_TUT9";
			...
			func_329(&uLocal_633, &uLocal_634, 24);
		}
		else if (func_332(20))
		{
			sVar0 = "IE_SEC_TUT10";
			...
			func_329(&uLocal_633, &uLocal_634, 27);
		}
		else if (func_332(21))
		{
			sVar0 = "IE_SEC_TUT11";
			...
			func_329(&uLocal_633, &uLocal_634, 30);
		}
		else if (func_332(22))
		{
			sVar0 = "IE_SEC_TUT12";
			...
			func_329(&uLocal_633, &uLocal_634, 33);
		}
	}
	if (!CAM::IS_SCREEN_FADED_OUT(sVar0) && !unk_0xCE990E643CD9D0E5(uLocal_614, false))
	{
		func_328(sVar0, iLocal_635);
		unk_0xBE20AB8238688965(&uLocal_614, false);
	}
	else if (unk_0xCE990E643CD9D0E5(uLocal_614, false))
	{
		...
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_614, false);
			iLocal_635 = 0;
			func_255(&uLocal_806);
			if (func_381())
			{
...
void func_330(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	while (iVar1 < iParam3)
	{
		...
		{
			unk_0xBE20AB8238688965(uParam0, bVar3);
		}
		iVar1++;
	}
	if (*uParam0 != 0)
...
int func_331(var uParam0, var uParam1, var uParam2)
{
	...
	while (iVar1 < 3)
	{
		...
		else if (unk_0xCE990E643CD9D0E5(uParam1, bVar4))
		{
			iVar2++;
		}
		iVar1++;
...
int func_332(int iParam0)
{
	...
	{
		case 16:
			if ((!func_334(uLocal_633, uLocal_634, 18) && !unk_0xCE990E643CD9D0E5(Global_1678136, iVar0)) && !unk_0xCE990E643CD9D0E5(uLocal_614, 4))
			{
				return 1;
			}
			break;
		...
		case 17:
			if (((!func_334(uLocal_633, uLocal_634, 21) && !unk_0xCE990E643CD9D0E5(Global_1678136, bVar0)) && !unk_0xCE990E643CD9D0E5(uLocal_614, 5)) && iLocal_613 == 2)
			{
				return 1;
			}
			break;
		...
		case 18:
			if (((!func_334(uLocal_633, uLocal_634, 24) && !unk_0xCE990E643CD9D0E5(Global_1678136, bVar0)) && !unk_0xCE990E643CD9D0E5(uLocal_614, 5)) && iLocal_613 == 2)
			{
				return 1;
			}
			break;
		...
		case 19:
			if (((!func_334(uLocal_633, uLocal_634, 27) && !unk_0xCE990E643CD9D0E5(Global_1678136, bVar0)) && !unk_0xCE990E643CD9D0E5(uLocal_614, 6)) && iLocal_613 == 1)
			{
				return 1;
			}
			break;
		...
		case 20:
			if ((((!func_334(uLocal_633, uLocal_634, 30) && !unk_0xCE990E643CD9D0E5(Global_1678136, bVar0)) && !unk_0xCE990E643CD9D0E5(uLocal_614, 6)) && iLocal_613 == 1) && func_333())
			{
				return 1;
			}
			break;
		...
		case 21:
			if ((!func_334(uLocal_633, uLocal_634, 33) && !unk_0xCE990E643CD9D0E5(Global_1678136, bVar0)) && !func_320(8))
			{
				return 1;
			}
			break;
		...
		case 22:
			if (((!func_334(uLocal_633, uLocal_634, 36) && !unk_0xCE990E643CD9D0E5(Global_1678136, bVar0)) && !unk_0xCE990E643CD9D0E5(uLocal_614, 5)) && iLocal_613 == 2)
			{
				return 1;
			}
			break;
...
void func_348()
{
	...
	{
		if (func_351(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_358()
{
	...
	else if (unk_0xCE990E643CD9D0E5(uLocal_614, 2))
	{
		...
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_614, 2);
			iLocal_635 = 0;
			func_255(&uLocal_806);
			if (func_380())
			{
...
var func_359(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
void func_363()
{
	...
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING(iLocal_621, 255, 255, 255, 255, 0);
	func_370();
	func_367(0);
	func_364(1);
}
...
int func_381()
{
	if (((((func_334(uLocal_633, uLocal_634, 18) && func_334(uLocal_633, uLocal_634, 21)) && func_334(uLocal_633, uLocal_634, 24)) && func_334(uLocal_633, uLocal_634, 27)) && func_334(uLocal_633, uLocal_634, 30)) && func_334(uLocal_633, uLocal_634, 33))
	{
		return 1;
	}
	return 0;
...
void func_382()
{
	uLocal_633 = func_10(5368, -1, 0);
	uLocal_634 = func_10(5369, -1, 0);
}
...
void func_384()
{
	...
	{
		iVar2 = func_386(8);
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "SET_COOLDOWN");
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iVar2);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
	func_385();
...
void func_385()
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "SHOW_EXPORT_SCREEN");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
void func_387(int iParam0)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "UPDATE_COLLECTION");
...
void func_390(int iParam0, bool bParam1)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_621, "UPDATE_VEHICLE");
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iParam0);
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iVar0);
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iVar1);
...
void func_391()
{
	...
	while (iVar0 < 4)
	{
		bLocal_618[iVar0] = func_3();
		iVar0++;
	}
}

void func_392(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (AUDIO::PLAY_STREAM_FROM_VEHICLE(iParam0) && (ENTITY::IS_ENTITY_AT_COORD(bParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				...
				if (!func_396(fVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(fVar27))
				{
					if (!bVar22)
					{
...
void func_412(int iParam0, bool bParam1)
{
	...
	func_407(0);
	func_260();
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_621);
	if (bParam1)
	{
		func_392(PLAYER::PLAYER_ID(), 1, 8388608, 0);
		AUDIO::STOP_AUDIO_SCENE("GTAO_Computer_Screen_Active_Scene");
	}
	if (ENTITY::GET_ENTITY_HEADING() && CUTSCENE::_0xA0FE76168A189DDB())
	{
		func_383(0, 1, 1, 1);
	}
	HUD::THEFEED_RESUME();
