	...
	if (!func_231(Local_43.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_42)
		{
			case 0:
				...
				{
					unk_0x4E65320BC9AD521C(Local_43.f_28[0], 1);
				}
				iLocal_42 = 1;
				break;
			...
			case 1:
				...
				{
					if (unk_0xFC5D6FB6EECB392F(uLocal_228))
					{
						if (unk_0x369E69441C066912(uLocal_228) >= 1f)
						{
							iLocal_42 = 2;
						}
					}
...
void func_251()
{
	switch (iLocal_42)
	{
		...
		case 1:
			...
			{
				uLocal_228 = unk_0xF341A134A5B8D4F6(Local_229, Local_230, 2);
				unk_0xDFDB9C533700BC17(Local_43.f_28[0], uLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
			...
			else if (unk_0xFC5D6FB6EECB392F(uLocal_228) && unk_0x10447A1CD8175FC0(sLocal_54, 0))
			{
				unk_0x03D382CB0B44E2FC(iLocal_46, Local_229, 0, 0, 0, 1);
				unk_0xC82085403E46A869(iLocal_46, Local_230, 2, 0);
				unk_0x1FEB07A1AF22700F(iLocal_46, uLocal_228, "leadout_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1148846080);
			...
			else if (unk_0xFC5D6FB6EECB392F(uLocal_228) && unk_0x10447A1CD8175FC0(sLocal_52, 0))
			{
				unk_0x1FEB07A1AF22700F(iLocal_47[0], uLocal_228, "leadout_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 1, 1148846080);
			...
			else if (unk_0xFC5D6FB6EECB392F(uLocal_228) && unk_0x10447A1CD8175FC0(sLocal_53, 0))
			{
				unk_0x1FEB07A1AF22700F(iLocal_47[1], uLocal_228, "leadout_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 1, 1148846080);
			...
			else if (unk_0xFC5D6FB6EECB392F(uLocal_228) && unk_0x10447A1CD8175FC0(sLocal_55, 0))
			{
				unk_0x03D382CB0B44E2FC(iLocal_45, -261.1132f, 294.1956f, 90.68612f, 0, 0, 0, 1);
...
void func_293()
{
	...
	switch (iLocal_42)
	{
		case 0:
			...
			{
				uLocal_226 = unk_0xF341A134A5B8D4F6(unk_0x3E4D3CCC220BDFB1(iLocal_46, 1), unk_0x090239DEAF625B17(iLocal_46, 2), 2);
				unk_0xDFDB9C533700BC17(Local_43.f_28[0], uLocal_226, sLocal_57, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				if (unk_0xAE06B9E39EBDE049(iLocal_46))
				{
					unk_0x1FEB07A1AF22700F(iLocal_46, uLocal_226, "leadin_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1148846080);
				}
				if (unk_0xAE06B9E39EBDE049(iLocal_47[0]))
				{
					unk_0x1FEB07A1AF22700F(iLocal_47[0], uLocal_226, "leadin_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 0, 1148846080);
				}
				if (unk_0xAE06B9E39EBDE049(iLocal_47[1]))
				{
					unk_0x1FEB07A1AF22700F(iLocal_47[1], uLocal_226, "leadin_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 0, 1148846080);
				}
				func_253(1, 1, 1, 1);
				iLocal_42 = 1;
			}
		...
		case 1:
			if (func_229(Local_43.f_28[0]) && unk_0xAE06B9E39EBDE049(iLocal_46))
			{
				if (unk_0xFC5D6FB6EECB392F(uLocal_226))
				{
					if (unk_0x369E69441C066912(uLocal_226) > 0.99f)
					{
						if (!unk_0xFC5D6FB6EECB392F(uLocal_227))
						{
							uLocal_227 = unk_0xF341A134A5B8D4F6(unk_0x3E4D3CCC220BDFB1(iLocal_46, 1), unk_0x090239DEAF625B17(iLocal_46, 2), 2);
							unk_0xDFDB9C533700BC17(Local_43.f_28[0], uLocal_227, sLocal_57, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
							unk_0x1322CA891C5DF18A(Local_43.f_28[0], 0, 0);
							if (unk_0xAE06B9E39EBDE049(iLocal_46))
							{
								unk_0x1FEB07A1AF22700F(iLocal_46, uLocal_227, "idle_01_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1148846080);
								unk_0xF0EC3EA6AC27CCAD(iLocal_46);
							}
							if (unk_0xAE06B9E39EBDE049(iLocal_47[0]))
							{
								unk_0x1FEB07A1AF22700F(iLocal_47[0], uLocal_227, "idle_01_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 0, 1148846080);
								unk_0xF0EC3EA6AC27CCAD(iLocal_47[0]);
							}
							if (unk_0xAE06B9E39EBDE049(iLocal_47[1]))
							{
								unk_0x1FEB07A1AF22700F(iLocal_47[1], uLocal_227, "idle_01_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 0, 1148846080);
								unk_0xF0EC3EA6AC27CCAD(iLocal_47[1]);
							}
						}
					}
					if (unk_0x369E69441C066912(uLocal_226) > 0.3f)
					{
						if (!bLocal_224)
						{
					...
					if (unk_0x369E69441C066912(uLocal_226) > 0.05f)
					{
						func_292();
					}
				}
...
void func_294()
{
	if (unk_0xAE06B9E39EBDE049(Local_43.f_41[3]) && !iLocal_235)
	{
		...
		if (!unk_0x046706CBB367B768(uLocal_231))
		{
			unk_0xC5E5600D1CF5CEF9(uLocal_231);
		}
		if (unk_0x8B917081F9836EDD(sLocal_233, 0, -1))
		{
			unk_0x057194D526464DC0(uLocal_231, "CAMERA", unk_0x1D5C49FCA9BC5B02(Local_43.f_28[0], 28422, Local_232), sLocal_234, 0, 0, 0);
			iLocal_235 = 1;
		}
	}
}
...
void func_304()
{
	...
	if (func_229(unk_0x9B0761B4C3EB8BC7()))
	{
		uLocal_44 = unk_0x86FB3A0D4870FE62(unk_0x9B0761B4C3EB8BC7());
	}
	if (func_229(Local_43.f_28[0]))
	{
		unk_0xD3D9D7C84656DAE5(Local_43.f_28[0], uLocal_44);
		unk_0x694113444F21E39F(Local_43.f_28[0], 132, 1);
		unk_0xCBA6B2B569DCAFD8(Local_43.f_28[0], 1);
		unk_0x4E65320BC9AD521C(Local_43.f_28[0], 1);
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_45))
	{
	...
	uLocal_231 = unk_0x5E54B0823F46079E();
	if (func_443())
	{
		switch (func_311())
		{
...
void func_308()
{
	if (func_230(Local_43.f_28[0]) && unk_0xAE06B9E39EBDE049(iLocal_46))
	{
		...
		unk_0x8430A80C3E4F5F98(uLocal_228, 0.02f);
	}
	bLocal_225 = false;
}
...
int func_414(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_416(iParam0, uVar1[iVar3], 1) && func_415(unk_0x3E4D3CCC220BDFB1(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_410(Param1, 0f, 0f, 0f, 0)) || unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(iParam0, 1), unk_0x3E4D3CCC220BDFB1(uVar1[iVar3], 1), 1) < 10f)
					{
...
int func_437(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 2:
			...
			if (bVar6)
			{
				uVar1[0] = unk_0x5BBA0055476D633A(-260.62f, 292.1391f, 90.604f, 10f, joaat("prop_cs_dumpster_01a"), 1, 0, 1);
				Var2[0 /*3*/] = { -260.614f, 292.106f, 91.127f };
				Var3[0 /*3*/] = { 7.2E-05f, -2.500116f, 89.63998f };
				uVar1[1] = unk_0x5BBA0055476D633A(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidl"), 1, 0, 1);
				Var2[1 /*3*/] = { -261.108f, 292.5062f, 92.03645f };
				Var3[1 /*3*/] = { -0.656039f, -2.50018f, 89.6114f };
				uVar1[2] = unk_0x5BBA0055476D633A(-261.5835f, 291.6671f, 92.066f, 10f, joaat("prop_cs_dumpster_lidr"), 1, 0, 1);
				Var2[2 /*3*/] = { -261.1135f, 291.6249f, 91.99765f };
				Var3[2 /*3*/] = { -0.281056f, -2.500049f, 89.62769f };
				iVar5 = 0;
				while (iVar5 <= 2)
				{
					unk_0x95178967C65CAD85(&(uVar1[iVar5]));
					iVar5++;
				}
				...
				uParam0->f_41[0] = unk_0x6E52E47D436A2C77(joaat("prop_cs_dumpster_01a"), Var2[0 /*3*/], 1, 1, 0);
				unk_0xC82085403E46A869(uParam0->f_41[0], Var3[0 /*3*/], 2, 1);
				unk_0xD901D6C8CF04EB87(uParam0->f_41[0], 0);
				uParam0->f_41[1] = unk_0x6E52E47D436A2C77(joaat("prop_cs_dumpster_lidl"), Var2[1 /*3*/], 1, 1, 0);
				unk_0xC82085403E46A869(uParam0->f_41[1], Var3[1 /*3*/], 2, 1);
				unk_0xD901D6C8CF04EB87(uParam0->f_41[1], 0);
				uParam0->f_41[2] = unk_0x6E52E47D436A2C77(joaat("prop_cs_dumpster_lidr"), Var2[2 /*3*/], 1, 1, 0);
		...
		case 3:
			...
			{
				uLocal_40 = unk_0xF341A134A5B8D4F6(unk_0x3E4D3CCC220BDFB1(uParam0->f_41[0], 1), unk_0x090239DEAF625B17(uParam0->f_41[0], 2), 2);
				unk_0x1FEB07A1AF22700F(uParam0->f_41[0], uLocal_40, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				unk_0x81493F39713559B1(uLocal_40, 1);
				if (func_230(uParam0->f_28[0]))
				{
					unk_0xDFDB9C533700BC17(uParam0->f_28[0], uLocal_40, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_230(uParam0->f_41[1]))
				{
					unk_0x1FEB07A1AF22700F(uParam0->f_41[1], uLocal_40, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_230(uParam0->f_41[2]))
				{
					unk_0x1FEB07A1AF22700F(uParam0->f_41[2], uLocal_40, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_444()
{
	...
	unk_0xADB6EEE689FE86DE(uLocal_231);
	if (unk_0xAE06B9E39EBDE049(iLocal_47[0]))
	{
		unk_0x6A8F948698B360B4(iLocal_47[0], 1);
	}
	if (unk_0xAE06B9E39EBDE049(iLocal_47[1]))
	{
		unk_0x6A8F948698B360B4(iLocal_47[1], 1);
	}
