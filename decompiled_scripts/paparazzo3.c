...
void __EntryFunction__()
{
	...
	if (func_443())
	{
		...
		func_337(&bVar0, -257.08f, 285.27f, 90.43f, 12.52f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
	...
	if (!func_231(Local_43.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_42)
		{
			case 0:
				...
				{
					PED::_0x2208438012482A1A(Local_43.f_28[0], 1);
				}
				iLocal_42 = 1;
				break;
			...
			case 1:
				...
				{
					if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_228))
					{
						if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_228) >= 1f)
						{
							iLocal_42 = 2;
						}
					}
...
int func_43(bool bParam0, void fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_50(void fParam0, int iParam1, int iParam2)
{
	switch (fParam0)
	{
		case joaat("player_zero"):
...
void func_68(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			bVar0 = func_70(func_89(iParam1, uParam0->f_2), Global_76644, 0);
...
int func_231(bool bParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	struct<3> Var0;
	
	if (func_230(unk_0x9B0761B4C3EB8BC7()) && func_230(bParam0))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bParam0, unk_0x9B0761B4C3EB8BC7(), true))
		{
			return 1;
		}
		if (func_245(bParam0, bParam1, bParam5, bParam6, bParam7))
		{
			return 1;
		}
		if (!WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				{
					return func_244(unk_0x9B0761B4C3EB8BC7(), bParam0, fParam2);
				}
			}
		}
		if (bParam4)
		...
		else if (func_232(bParam0, fParam3))
		{
			return 1;
		}
	}
...
int func_232(bool bParam0, float fParam1)
{
	float fVar0;
	
	if (func_230(unk_0x9B0761B4C3EB8BC7()) && func_230(bParam0))
	{
		if (func_243(bParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bParam0))
		{
			if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
			{
				fVar0 = 40f;
...
bool func_233(bool bParam0, float fParam1)
{
	return func_234(bParam0, unk_0x9B0761B4C3EB8BC7(), fParam1, 1, 250, 7);
}

bool func_234(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	
	iVar2 = func_242(bParam0, bParam1);
	if (!func_230(bParam0) || !func_230(bParam1))
	{
		if (iVar2 != -1)
		{
	...
	if (!func_238(bParam0, bParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar2 == -1)
	...
	uVar0 = func_235(&(Local_35[iVar2 /*4*/]), Var1, bParam1, &(Local_35[iVar2 /*4*/].f_3), bParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_235(var uParam0, struct<3> Param1, bool bParam2, var uParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_238(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_240(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1)) };
	...
	{
		Var1 = { func_240(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_244(bool bParam0, bool bParam1, float fParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_245(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_230(unk_0x9B0761B4C3EB8BC7()) && func_230(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_249(bParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_246(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_246(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_247(bool bParam0, float fParam1)
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_248(bParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_248(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_240(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_249(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
...
void func_250()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && func_230(Local_43.f_28[0]))
	{
		PED::SET_IK_TARGET(Local_43.f_28[0], 1, unk_0x9B0761B4C3EB8BC7(), 31086, 0f, 0f, 0f, 0, -1, -1);
		PED::SET_IK_TARGET(unk_0x9B0761B4C3EB8BC7(), 1, Local_43.f_28[0], 31086, 0f, 0f, 0f, 0, -1, -1);
	}
}
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_279(1, 1093140480, 0))
			{
				...
				if (func_230(unk_0x9B0761B4C3EB8BC7()))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(unk_0x9B0761B4C3EB8BC7(), sLocal_56, 0, 0, 0);
				}
				if (MISC::IS_BIT_SET(iLocal_47[0]))
				{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_45, sLocal_55, 0, iLocal_51, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_45, sLocal_55, 2, iLocal_51, 0);
				}
				if (MISC::IS_BIT_SET(bLocal_46))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_46, sLocal_54, 0, iLocal_50, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_46, sLocal_54, 2, iLocal_50, 0);
				}
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_58, 0))
			{
				...
				ENTITY::FREEZE_ENTITY_POSITION(Local_43.f_28[0], false, 0);
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_56, 0))
			{
				...
				ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 153.0417f);
				ENTITY::FREEZE_ENTITY_POSITION(unk_0x9B0761B4C3EB8BC7(), false, 0);
			}
			if (!MISC::IS_BIT_SET(bLocal_46))
			{
				if (MISC::IS_BIT_SET(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_54, iLocal_50)))
				{
					bLocal_46 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_54, iLocal_50));
				}
			}
			else if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_228) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_54, 0))
			{
				unk_0x03D382CB0B44E2FC(bLocal_46, Local_229, 0, 0, 0, 1);
				ENTITY::DETACH_ENTITY(bLocal_46, Local_230, 2, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_46, iLocal_228, "leadout_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1000f);
				ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(bLocal_46);
			}
			if (!MISC::IS_BIT_SET(iLocal_47[0]))
			{
				if (MISC::IS_BIT_SET(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_52, 0)))
				{
					iLocal_47[0] = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_52, iLocal_48));
				}
			}
			else if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_228) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_52, 0))
			{
			...
			if (!MISC::IS_BIT_SET(iLocal_47[1]))
			{
				if (MISC::IS_BIT_SET(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_53, 0)))
				{
					iLocal_47[1] = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_53, iLocal_49));
				}
			}
			else if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_228) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_53, 0))
			{
			...
			if (!MISC::IS_BIT_SET(bLocal_45))
			{
				if (MISC::IS_BIT_SET(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_55, 0)))
				{
					bLocal_45 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_55, iLocal_51));
				}
			}
			else if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_228) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_55, 0))
			{
				unk_0x03D382CB0B44E2FC(bLocal_45, -261.1132f, 294.1956f, 90.68612f, 0, 0, 0, 1);
				ENTITY::DETACH_ENTITY(bLocal_45, -0.604164f, -2.332095f, 89.8831f, 2, 0);
				ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(bLocal_45);
			}
...
void func_254(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_258(PLAYER::PLAYER_ID())) && !func_256(PLAYER::PLAYER_ID(), 0)) && !func_255()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_258(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
	...
	if (MISC::IS_BIT_SET(bVar0))
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_273(bVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_271(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_273(bool bParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_276()
{
	...
	{
		ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(MISC::GET_MODEL_DIMENSIONS(bVar2), &(Var0[0 /*3*/]), &(Var0[1 /*3*/]));
		Var1 = { func_277() };
...
int func_279(int iParam0, float fParam1, int iParam2)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_284(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_284(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_287(bool bParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_42(fVar4, func_81(iVar0), func_65(bParam0, Var2.f_13[iVar0], Var2[iVar0], func_81(iVar0)), &iVar1))
			{
				Var3 = { func_83(fVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
				iVar5 = 1;
			}
			if (func_49(fVar4, func_81(iVar0), func_65(bParam0, Var2.f_13[iVar0], Var2[iVar0], func_81(iVar0)), &iVar1))
			{
				Var3 = { func_83(fVar4, 1, uParam1->f_62, -1) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_42(fVar4, 14, func_56(bParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &iVar1))
			{
				Var3 = { func_83(fVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
			...
			if (func_49(fVar4, 14, func_56(bParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &iVar1))
			{
				Var3 = { func_83(fVar4, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var3.f_3;
				(*uParam1)[1] = Var3.f_4;
	...
	if (iVar6 || iVar5)
	{
		iVar7 = func_65(bParam0, uParam1->f_13[1], (*uParam1)[1], 1);
		iVar8 = func_65(bParam0, uParam1->f_13[2], (*uParam1)[2], 2);
		iVar9 = func_50(fVar4, iVar8, iVar7);
		if (iVar9 != -99)
		{
			Var3 = { func_83(fVar4, 0, iVar9, -1) };
...
void func_293()
{
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_229(Local_43.f_28[0]) && MISC::IS_BIT_SET(bLocal_46))
			{
				iLocal_226 = PED::CREATE_SYNCHRONIZED_SCENE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_46, 1), NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(bLocal_46, 2), 2);
				TASK::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_226, sLocal_57, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				if (MISC::IS_BIT_SET(bLocal_46))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_46, iLocal_226, "leadin_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1000f);
				}
				if (MISC::IS_BIT_SET(iLocal_47[0]))
				{
		...
		case 1:
			if (func_229(Local_43.f_28[0]) && MISC::IS_BIT_SET(bLocal_46))
			{
				if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_226))
				{
					if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_226) > 0.99f)
					{
						if (!PED::DETACH_SYNCHRONIZED_SCENE(iLocal_227))
						{
							iLocal_227 = PED::CREATE_SYNCHRONIZED_SCENE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_46, 1), NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(bLocal_46, 2), 2);
							TASK::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_227, sLocal_57, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
							ENTITY::FREEZE_ENTITY_POSITION(Local_43.f_28[0], false, 0);
							if (MISC::IS_BIT_SET(bLocal_46))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_46, iLocal_227, "idle_01_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1000f);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(bLocal_46);
							}
							if (MISC::IS_BIT_SET(iLocal_47[0]))
							{
					...
					if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_226) > 0.3f)
					{
						if (!bLocal_224)
						{
					...
					if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_226) > 0.05f)
					{
						func_292();
					}
				}
...
void func_294()
{
	if (MISC::IS_BIT_SET(Local_43.f_41[3]) && !iLocal_235)
	{
		GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_rcpap1_camera", PED::GET_PED_BONE_COORDS(Local_43.f_28[0], 28422, Local_232), NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_43.f_41[3], 2), 1f, false, false, false);
		if (!AUDIO::HAS_SOUND_FINISHED(fLocal_231))
		{
			AUDIO::STOP_SOUND(fLocal_231);
		}
		if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK(sLocal_233, false, -1))
		{
			AUDIO::SET_VARIABLE_ON_SOUND(fLocal_231, "CAMERA", PED::GET_PED_BONE_COORDS(Local_43.f_28[0], 28422, Local_232), sLocal_234, 0, 0, 0);
			iLocal_235 = 1;
		}
	}
}
...
void func_297()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_284(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_304()
{
	...
	if (func_229(unk_0x9B0761B4C3EB8BC7()))
	{
		iLocal_44 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(unk_0x9B0761B4C3EB8BC7());
	}
	if (func_229(Local_43.f_28[0]))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_43.f_28[0], iLocal_44);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_43.f_28[0], 1.849714E-43f, 1);
		PED::SET_PED_KEEP_TASK(Local_43.f_28[0], true);
		PED::_0x2208438012482A1A(Local_43.f_28[0], 1);
	}
	if (!MISC::IS_BIT_SET(bLocal_45))
	{
		bLocal_45 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-261.19f, 292.22f, 90.79f, 10f, iLocal_51, true, false, true);
		ENTITY::SET_CAN_CLIMB_ON_ENTITY(bLocal_45, false);
	}
	if (!MISC::IS_BIT_SET(bLocal_46))
	{
		func_313(&bLocal_46, &(Local_43.f_41[0]));
	}
	if (!MISC::IS_BIT_SET(iLocal_47[0]))
	{
	...
	HUD::HAS_ADDITIONAL_TEXT_LOADED("PAP3", 0);
...
int func_307(bool bParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_308()
{
	if (func_230(Local_43.f_28[0]) && MISC::IS_BIT_SET(bLocal_46))
	{
		iLocal_228 = PED::CREATE_SYNCHRONIZED_SCENE(Local_229, Local_230, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1000f, 0);
		if (MISC::IS_BIT_SET(bLocal_46))
...
void func_312(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
int func_314()
{
	...
	else if (MISC::IS_BIT_SET(Local_43.f_28[0]))
	{
		if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(Local_43.f_28[0], 0))
		{
			func_315("P3BEVDEAD");
			return 1;
		}
...
void func_316()
{
	...
	{
		case 0:
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sLocal_236, "DEFAULT"))
			{
				func_459(1);
			}
			else
			{
				func_318(bLocal_236, 1);
			}
			iLocal_42 = 1;
			break;
...
{
	if (((!func_333(0) || Global_77102) || Global_77091 == 1) || !GRAPHICS::DRAW_SCALEFORM_MOVIE())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((OBJECT::ADD_DOOR_TO_SYSTEM() || func_302(0)) || func_332(1))
			{
			}
			else
			{
...
void func_337(bool bParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_411(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		{
			func_402(iParam10, 0);
			while (!func_338(bParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_338(bool bParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_396(bParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_396(bParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (MISC::GET_MODEL_DIMENSIONS(*bParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Var2))
			{
				...
				*bParam0 = VEHICLE::CREATE_VEHICLE(Var2, Param2, fParam3, true, true, false);
				...
				func_396(bParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_339(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && MISC::IS_BIT_SET(*bParam1)) && ENTITY::GET_ENTITY_COORDS(*bParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*bParam1) >= 0 && func_344(*bParam1, 0, &uVar0))
		{
			func_343(bParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_342(*bParam1);
...
int func_344(bool bParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	fVar0 = MISC::GET_MODEL_DIMENSIONS(bParam0);
	if ((!func_372(fVar0, bParam1, uParam2) && !func_371(PLAYER::PLAYER_ID())) && !func_354(bParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_352(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_350(bParam0)) && !bVar1) && !(func_349(MISC::GET_MODEL_DIMENSIONS(bParam0)) && func_346(PLAYER::PLAYER_ID())))
	{
	...
	if (!MISC::SET_BIT())
	{
		if ((func_345(bParam0) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("sentinel2")) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_356(bool bParam0)
{
	...
	if (func_357(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		return 1;
	}
	return 0;
...
int func_358(bool bParam0, bool bParam1)
{
	switch (MISC::GET_MODEL_DIMENSIONS(bParam0))
	{
		...
		case joaat("insurgent"):
			if (func_360(MISC::GET_MODEL_DIMENSIONS(bParam0), 0))
			{
				if (Global_2540384.f_303 == bParam0)
				{
					return 1;
				}
				else if (func_359(bParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_360(void fParam0, int iParam1)
{
	if (iParam1 == 0)
	{
		if (func_368(fParam0, 0))
		{
			return 1;
		}
	}
...
int func_368(void fParam0, int iParam1)
{
	switch (fParam0)
	{
		case joaat("faction2"):
...
int func_372(void fParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_352(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fParam0)))
	{
		bVar0 = true;
	}
...
void func_374(bool bParam0, int iParam1)
{
	...
	func_375(bParam0, &(Global_111858.f_32745.f_5510));
}
...
void func_375(bool bParam0, var uParam1)
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_343(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_271(bParam0, 0, 0)) || func_271(bParam0, 1, 0)) || func_271(bParam0, 2, 0)) || func_392(bParam0) != 145) || func_391(bParam0)) || func_390(bParam0)) || func_345(bParam0)) || func_389(bParam0)) || !func_379(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_390(bParam0))
		{
		}
		...
		if (func_271(bParam0, 0, 0))
		{
		}
		if (func_271(bParam0, 1, 0))
		{
		}
		if (func_271(bParam0, 2, 0))
		{
		}
		if (func_392(bParam0) != 145)
		{
		}
		return 0;
	}
...
int func_379(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_380(fParam0, 0))
	{
		return 0;
	}
...
int func_380(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
int func_396(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_368(MISC::GET_MODEL_DIMENSIONS(*iParam0), 1) && unk_0x7F8B14CBFB9813E5(*iParam0, 24) != func_399(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_402(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || MISC::GET_MODEL_DIMENSIONS(Global_96286[iVar0]) == func_403(iParam0, iParam1))
				{
...
bool func_411(struct<3> Param0, float fParam1)
{
	return func_412(&(Global_105407.f_2890), Param0, fParam1, 0);
}

bool func_412(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	bool bVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_429(uParam0))
	{
		...
		if (func_428(uParam0))
		{
			...
			if (MISC::IS_BIT_SET(bVar0))
			{
				...
				func_417(bVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_393(bVar0, uParam0->f_11);
				}
				else if ((!func_414(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS(TASK::IS_PED_BEING_ARRESTED(), "startup_positioning"))
				{
					iVar4 = func_413(bVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_414(bool bParam0, struct<3> Param1, bool bParam2)
{
	void fVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_416(bParam0, Global_75654.f_139[38], 0))
			{
				func_405(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_416(bParam0, Global_75654.f_139[43], 1))
			{
				func_405(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_416(bParam0, uVar1[iVar3], 1) && func_415(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_410(Param1, 0f, 0f, 0f, 0)) || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 1) < 10f)
					{
...
int func_416(bool bParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_417(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::GET_ENTITY_COORDS(iParam0, false))
	{
		...
		if (((unk_0xCE990E643CD9D0E5(uParam1->f_77, 15) || func_420(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_419())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_396(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
...
int func_437(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 2:
			...
			if (func_229(uParam0->f_28[0]))
			{
				if (!MISC::IS_BIT_SET(uParam0->f_41[3]))
				{
					...
					{
						OBJECT::CREATE_OBJECT_NO_OFFSET(uParam0->f_41[3], uParam0->f_28[0], ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			...
			if (bVar6)
			{
				...
				PLAYER::PLAYER_PED_ID(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), 1);
				PLAYER::PLAYER_PED_ID(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), 1);
				PLAYER::PLAYER_PED_ID(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), 1);
				uParam0->f_41[0] = ENTITY::SET_ENTITY_ROTATION(joaat("prop_cs_dumpster_01a"), Var2[0 /*3*/], 1, true, 0);
				ENTITY::DETACH_ENTITY(uParam0->f_41[0], Var3[0 /*3*/], 2, 1);
				ENTITY::SET_CAN_CLIMB_ON_ENTITY(uParam0->f_41[0], false);
				uParam0->f_41[1] = ENTITY::SET_ENTITY_ROTATION(joaat("prop_cs_dumpster_lidl"), Var2[1 /*3*/], 1, true, 0);
				ENTITY::DETACH_ENTITY(uParam0->f_41[1], Var3[1 /*3*/], 2, 1);
				ENTITY::SET_CAN_CLIMB_ON_ENTITY(uParam0->f_41[1], false);
				uParam0->f_41[2] = ENTITY::SET_ENTITY_ROTATION(joaat("prop_cs_dumpster_lidr"), Var2[2 /*3*/], 1, true, 0);
				ENTITY::DETACH_ENTITY(uParam0->f_41[2], Var3[2 /*3*/], 2, 1);
		...
		case 3:
			...
			{
				iLocal_40 = PED::CREATE_SYNCHRONIZED_SCENE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_41[0], 1), NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uParam0->f_41[0], 2), 2);
...
void func_444()
{
	...
	AUDIO::RELEASE_SOUND_ID(fLocal_231);
	if (MISC::IS_BIT_SET(iLocal_47[0]))
	{
		ENTITY::SET_ENTITY_COORDS(iLocal_47[0], 1);
	}
	if (MISC::IS_BIT_SET(iLocal_47[1]))
	{
		ENTITY::SET_ENTITY_COORDS(iLocal_47[1], 1);
	}
	func_457(&(iLocal_47[0]), 0);
	func_457(&(iLocal_47[1]), 0);
	func_457(&bLocal_45, 0);
	func_457(&bLocal_46, 0);
...
void func_459(bool bParam0)
{
	...
	if (!func_476())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_460(TASK::IS_PED_BEING_ARRESTED(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_461(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_467())
	{
		...
		{
			iVar2 = func_462(TASK::IS_PED_BEING_ARRESTED());
			if (iVar2 > -1)
			{
...
int func_465(void fParam0, bool bParam1)
{
	int iVar0;
