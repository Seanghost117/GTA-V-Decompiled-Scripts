...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_205(Var0.f_28[0]))
		{
			if (Var0 == 2)
			{
				if (func_203(&Var0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Var0.f_28[0], 1), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_203(&Var0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Var0.f_28[0], 1), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0 == 4)
			{
				func_188(&uLocal_58, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Var0.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar2 = 0;
		if (func_187(Var0))
	...
	switch (iParam0->f_16)
	{
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (func_205(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
					{
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_186()) || Global_110905) || Global_30970) || func_185()) || func_184(8, -1)) || func_182()) || func_93()) || func_183()) || func_181()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_186() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_184(8, -1)) || func_181()) || func_180()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
float func_201(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_202(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)
{
	...
	uParam1.f_7 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, uParam1.f_6);
	TASK::OPEN_SEQUENCE_TASK(&iVar0);
	TASK::TASK_PLAY_ANIM(false, iParam0->f_48, uParam1[uParam1.f_7], 4f, -4f, -1, 0 | iVar1, 0f, false, false, false);
	TASK::TASK_PLAY_ANIM(false, iParam0->f_48, iParam0->f_48.f_1, 8f, -8f, -1, 1 | iVar1, 0f, false, false, false);
	TASK::CLOSE_SEQUENCE_TASK(iVar0);
	AUDIO::STOP_SCRIPTED_CONVERSATION(iParam0->f_28[iParam10], iVar0);
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_205(unk_0x9B0761B4C3EB8BC7()) && func_205(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_201(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_215(bool bParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_205(bParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_217(uParam1) || !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_216(iParam2) && !PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(bParam0, unk_0x9B0761B4C3EB8BC7(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_217(uParam1) && uParam1->f_4 == 0) && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_216(iParam2) || PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
bool func_228(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_229(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_229(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_232(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_234(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_234(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_241(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_234(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_244(bool bParam0)
{
	...
	if (func_205(unk_0x9B0761B4C3EB8BC7()) && func_205(bParam0))
	{
...
bool func_253(bool bParam0, struct<3> Param1, float fParam2)
{
...
void func_254(int iParam0)
{
	if (func_205(iParam0->f_28[0]))
	{
		...
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0->f_28[0], 1), 5.1f))
		{
			func_255(iParam0);
			if (func_205(iParam0->f_28[0]))
			{
...
void func_255(var uParam0)
{
	...
	if (*uParam0 == 2 || *uParam0 == 3)
	{
		...
		while (iVar0 <= 5)
		{
			if (func_205(uParam0->f_41[iVar0]))
			{
				ENTITY::SET_ENTITY_COORDS(uParam0->f_41[iVar0], 0);
			}
			iVar0++;
		}
		if (func_205(uParam0->f_28[0]))
		{
			...
			TASK::TASK_SMART_FLEE_PED(uParam0->f_28[0], unk_0x9B0761B4C3EB8BC7(), 10000f, -1, false, false);
		}
		func_220(&(uParam0->f_41[2]));
	}
}

void func_256(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!MISC::IS_BIT_SET(uParam0->f_41[0]))
			{
				...
				if (MISC::IS_BIT_SET(uParam0->f_41[0]) && MISC::IS_BIT_SET(uParam0->f_35[0]))
				{
					OBJECT::CREATE_OBJECT_NO_OFFSET(uParam0->f_41[0], uParam0->f_35[0], 0f, Var3, Var4, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar8 = false;
...
void func_264(char* sParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_265(sParam0);
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!MISC::IS_BIT_SET(uParam0->f_41[0]))
			{
				...
				if (MISC::IS_BIT_SET(uParam0->f_41[0]) && MISC::IS_BIT_SET(uParam0->f_35[0]))
				{
					OBJECT::CREATE_OBJECT_NO_OFFSET(uParam0->f_41[0], uParam0->f_35[0], 0f, Var2, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
				}
				else
				{
					bVar7 = false;
...
void func_293(int iParam0, bool bParam1)
{
	...
	if (SYSTEM::VMAG(fLocal_56))
	{
		unk_0x93370FA10F15BE44(&fLocal_56);
	}
	if (iLocal_53 != -1)
	{
