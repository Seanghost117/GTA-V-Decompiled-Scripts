...
void __EntryFunction__()
{
	...
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]))
		{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
		{
	...
	while (iVar0 != 7)
	{
		...
		if (func_204())
		{
			if (MISC::IS_BIT_SET(iLocal_258[0]))
			{
				PED::DELETE_PED(&(iLocal_258[0]));
			}
			if (MISC::IS_BIT_SET(iLocal_258[1]))
			{
		...
		if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
		{
			...
			{
				if ((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1])) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)) && unk_0xE0B3BC41DDA88DF0(iLocal_258[0], PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)) && unk_0xE0B3BC41DDA88DF0(iLocal_258[1], PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) < 0.2f)
					{
						if (iLocal_228 == -1)
						{
					...
					if (iLocal_228 != -1 && MISC::GET_GAME_TIMER() > iLocal_228 + 1000)
					{
						...
						if (iLocal_228 != -1 && MISC::GET_GAME_TIMER() > iLocal_228 + 10000)
						{
							...
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]))
							{
								...
								AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_258[0], iLocal_265);
							...
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
							{
								...
								TASK::TASK_SMART_FLEE_PED(false, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
								AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_258[1], iLocal_265);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
		...
		if ((iVar2 > 1 && iVar2 < 7) && !iLocal_253)
		{
			...
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_257, unk_0x9B0761B4C3EB8BC7(), true))
				{
					func_169();
					SYSTEM::WAIT(0);
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]))
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_258[0], unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
					}
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_258[1], unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
					}
					iVar8 = 0;
					iVar0 = 7;
					func_246(Var1, &iLocal_258, bVar4);
		...
		{
			if (MISC::IS_BIT_SET(iLocal_258[0]) && MISC::IS_BIT_SET(iLocal_258[1]))
			{
				if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]) || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_258[0], unk_0x9B0761B4C3EB8BC7(), 80f, 80f, 80f, false, true, 0))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
				...
				if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]) || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_258[1], unk_0x9B0761B4C3EB8BC7(), 80f, 80f, 80f, false, true, 0))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
		...
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_258[0], unk_0x9B0761B4C3EB8BC7(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_258[0], unk_0x9B0761B4C3EB8BC7(), true))
			{
				iLocal_253 = 1;
			}
			if (iLocal_253)
			{
				...
				if (!bLocal_249)
				{
					...
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_257, "random@getawaydriver", "idle_a", 3) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_257, "random@getawaydriver", "idle_2_hands_up", 3))
						{
							TASK::TASK_PLAY_ANIM(false, "random@getawaydriver", "hands_up_2_idle", 4f, -4f, -1, 0, 0f, false, false, false);
						}
						TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 10000, 2052, 4);
						TASK::TASK_GO_TO_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, 5f, 3f, 2f, 0);
						TASK::TASK_PLAY_ANIM(false, "random@getawaydriver", "gesture_nod_yes_soft", 8f, -8f, -1, 48, 0f, false, false, false);
						...
						TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
						AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_257, iLocal_265);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
			...
			if (bLocal_248)
			{
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_260[0]))
				{
					if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_260[0], unk_0x9B0761B4C3EB8BC7(), 4f, 4f, 4f, false, true, 0))
						{
							if (!func_185())
							{
								TASK::TASK_LOOK_AT_ENTITY(iLocal_260[0], unk_0x9B0761B4C3EB8BC7(), 1000, 2052, 4);
							...
							else
							{
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_260[0]))
								{
									PED::_0x2208438012482A1A(iLocal_260[0], 0);
								}
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_260[1]))
								{
									PED::_0x2208438012482A1A(iLocal_260[1], 0);
								}
						...
						else if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_260[0], unk_0x9B0761B4C3EB8BC7(), 120f, 120f, 120f, false, true, 0))
						{
							iVar8 = 0;
							iVar0 = 7;
							func_246(Var1, &iLocal_258, bVar4);
					...
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_260[0]);
						func_169();
						SYSTEM::WAIT(0);
						iVar8 = 0;
						iVar0 = 7;
				...
				else if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
				{
					iVar8 = 0;
					iVar0 = 7;
					func_246(Var1, &iLocal_258, bVar4);
			...
			if (bLocal_249)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(bLocal_257, unk_0x9B0761B4C3EB8BC7(), 4f, 4f, 4f, false, true, 0))
					{
						if (!func_185())
						{
							TASK::TASK_LOOK_AT_ENTITY(bLocal_257, unk_0x9B0761B4C3EB8BC7(), 3000, 2048, 2);
						...
						else
						{
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
							{
								PED::SET_PED_CAN_BE_TARGETTED(bLocal_257, true);
							}
							while (func_185())
							{
								SYSTEM::WAIT(0);
					...
					else if (!ENTITY::IS_ENTITY_AT_ENTITY(bLocal_257, unk_0x9B0761B4C3EB8BC7(), 120f, 120f, 120f, false, true, 0))
					{
						iVar8 = 0;
						iVar0 = 7;
						func_246(Var1, &iLocal_258, bVar4);
				...
				else if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_260[0]))
				{
					iVar8 = 0;
					iVar0 = 7;
					func_246(Var1, &iLocal_258, bVar4);
		...
		switch (iVar0)
		{
			...
			case 4:
				iVar8 = 0;
				unk_0xBE20AB8238688965(&uVar3, 4);
				unk_0xBE20AB8238688965(&uVar3, 1);
				unk_0xBE20AB8238688965(&uVar3, 5);
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
					{
						if (func_128())
						{
							...
							{
								if ((SYSTEM::VDIST2(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0, 0) && SYSTEM::VDIST2(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 2, 0)) && SYSTEM::VDIST2(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1, 0))
								{
									iVar0 = 5;
								}
							}
				...
				iVar0 = 5;
				PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), &uVar5, &uVar6, 1, 3f, 0);
			...
			case 5:
				if (iVar2 > 1)
				{
					if (!func_207())
					{
						...
						if (!iLocal_252)
						{
							if (PED::IS_PED_SHOOTING_IN_AREA(unk_0x9B0761B4C3EB8BC7(), Vector(28.4601f, -1565.293f, 61.5891f) - Vector(30f, 30f, 30f), Vector(28.4601f, -1565.293f, 61.5891f) + Vector(30f, 30f, 30f), false, true))
							{
								iVar9 = 0;
								while (iVar9 < iLocal_259)
								{
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_259[iVar9]))
									{
										TASK::TASK_SMART_FLEE_PED(iLocal_259[iVar9], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
								...
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
								{
									TASK::TASK_SMART_FLEE_PED(bLocal_257, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
									PED::SET_PED_KEEP_TASK(bLocal_257, true);
								}
								iLocal_252 = 1;
							}
	...
	switch (*iParam0)
	{
		...
		case 1:
			*iParam7 = 0;
			...
			if (func_119() == 0)
			{
				func_118(&uLocal_53, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
			}
			else if (func_119() == 1)
			{
				func_118(&uLocal_53, 0, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
			}
			else if (func_119() == 2)
			{
				func_118(&uLocal_53, 0, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
			}
			...
			unk_0xAF7D4BF357E8B79E(Local_232 - Vector(20f, 20f, 20f), Local_232 + Vector(20f, 20f, 20f), 0, 1);
			PATHFIND::SET_ROADS_IN_AREA(Local_232 - Vector(50f, 50f, 50f), Local_232 + Vector(50f, 50f, 50f), false, true, 1, 1);
			PATHFIND::SET_PED_PATHS_IN_AREA(Local_232 - Vector(20f, 20f, 20f), Local_232 + Vector(20f, 20f, 20f), false, 0);
			PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_232 - Vector(20f, 20f, 20f), Local_232 + Vector(20f, 20f, 20f), 0, 1);
			unk_0x78FCB2E22C41B9D5(joaat("picador"));
			unk_0x78FCB2E22C41B9D5(joaat("stanier"));
			unk_0x78FCB2E22C41B9D5(joaat("patriot"));
			while ((!ENTITY::DOES_ENTITY_EXIST(joaat("picador")) || !ENTITY::DOES_ENTITY_EXIST(joaat("stanier"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("patriot")))
			{
				SYSTEM::WAIT(0);
			}
			...
			PED::_0x2208438012482A1A((*uParam6)[0], 1);
			unk_0x74528AC0906CBABE(Param1);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH((*uParam6)[0], iLocal_266);
			unk_0x92BD213E6A0E666B((*uParam6)[0], joaat("weapon_appistol"), -1, 1, 1);
			PED::SET_PED_MONEY((*uParam6)[0], NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(800, 2000));
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER((*uParam6)[0], 2.886675E-43f, 1);
			...
			PED::_0x2208438012482A1A((*uParam6)[1], 1);
			unk_0x74528AC0906CBABE(Param1.f_1);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH((*uParam6)[1], iLocal_266);
			unk_0x92BD213E6A0E666B((*uParam6)[1], joaat("weapon_pistol"), -1, 1, 1);
			PED::SET_PED_MONEY((*uParam6)[1], NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(800, 2000));
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER((*uParam6)[1], 2.886675E-43f, 1);
			...
			bLocal_257 = PED::CREATE_PED(4, Param1.f_2, Var3, fVar4, true, true);
			unk_0x74528AC0906CBABE(Param1.f_2);
			PED::_0x2208438012482A1A(bLocal_257, 1);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_257, iLocal_267);
			AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_257, "A_M_Y_Business_01_CHINESE_MINI_01");
		...
		case 2:
			if (((((!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_257, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_259[0], 0)) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_259[2], 0)) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_259[3], 0)) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE((*uParam6)[0], 0)) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE((*uParam6)[1], 0))
			{
				if (((((PED::_HAS_STREAMED_PED_ASSETS_LOADED(bLocal_257) && PED::_HAS_STREAMED_PED_ASSETS_LOADED(iLocal_259[0])) && PED::_HAS_STREAMED_PED_ASSETS_LOADED(iLocal_259[2])) && PED::_HAS_STREAMED_PED_ASSETS_LOADED(iLocal_259[3])) && PED::_HAS_STREAMED_PED_ASSETS_LOADED((*uParam6)[0])) && PED::_HAS_STREAMED_PED_ASSETS_LOADED((*uParam6)[1]))
				{
					...
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
					{
						TASK::TASK_HANDS_UP(bLocal_257, -1, 0, -1, false);
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[0]))
						{
							TASK::TASK_PLAY_ANIM((*uParam6)[0], "random@getawaydriver@thugs", "base_a", 4f, -2f, -1, 1, 0f, false, false, false);
							TASK::TASK_LOOK_AT_ENTITY((*uParam6)[0], unk_0x9B0761B4C3EB8BC7(), -1, 2052, 4);
						}
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[1]))
						{
							TASK::TASK_PLAY_ANIM((*uParam6)[1], "random@getawaydriver@thugs", "base_b", 4f, -2f, -1, 1, 0f, false, false, false);
							TASK::TASK_LOOK_AT_ENTITY((*uParam6)[1], unk_0x9B0761B4C3EB8BC7(), -1, 2052, 4);
						}
					}
					SYSTEM::SETTIMERA(0);
					*iParam0 = 3;
		...
		case 3:
			if (SYSTEM::TIMERA() > 0)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_259[0]))
				{
			...
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_259[2]))
				{
			...
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_259[3]))
				{
			...
			if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 81.71976f, -1530.834f, 28.17651f, 26.78526f, -1595.693f, 58.29443f, 32.875f, 0, 1, 0))
			{
				if (!iLocal_252)
				{
					...
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_259[2]))
					{
						...
						TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
						AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_259[2], iLocal_265);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
					}
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_259[3]))
					{
						...
						TASK::TASK_SMART_FLEE_COORD(0, Local_232, 200f, -1, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
						AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_259[3], iLocal_265);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
					}
					iLocal_252 = 1;
				}
			...
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[1]))
				{
					TASK::TASK_SMART_FLEE_PED((*uParam6)[0], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
					TASK::TASK_SMART_FLEE_PED((*uParam6)[1], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
					func_169();
					SYSTEM::WAIT(0);
		...
		case 4:
			if (!func_185())
			{
				if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[1])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
				{
				}
				if (MISC::IS_BIT_SET(bLocal_257))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
					{
						...
						TASK::TASK_LOOK_AT_ENTITY((*uParam6)[0], unk_0x9B0761B4C3EB8BC7(), 10000, 2052, 4);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
						TASK::TASK_PLAY_ANIM(false, "random@getawaydriver", "idle_2_hands_up", 4f, -4f, -1, 0, 0.25f, false, false, false);
						TASK::TASK_PLAY_ANIM(false, "random@getawaydriver", "idle_a", 4f, -4f, -1, 1, 0f, false, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
						AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_257, iLocal_265);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
					}
			...
			if (((PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || unk_0x653A331834B72BC0(unk_0x9B0761B4C3EB8BC7())) || PED::IS_COP_PED_IN_AREA_3D(Local_232 - Vector(40f, 40f, 40f), Local_232 + Vector(40f, 40f, 40f))) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(Local_232 - Vector(40f, 40f, 40f), Local_232 + Vector(40f, 40f, 40f)))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[1]))
				{
					TASK::TASK_SMART_FLEE_PED((*uParam6)[0], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
		...
		case 5:
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[1]))
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY((*uParam6)[0], unk_0x9B0761B4C3EB8BC7(), -1);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY((*uParam6)[1], unk_0x9B0761B4C3EB8BC7(), -1);
				}
			}
			else if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_257, 242628503) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bLocal_257, 242628503) != 0)
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
				TASK::TASK_PLAY_ANIM(false, "random@getawaydriver", "idle_2_hands_up", 4f, -4f, -1, 0, 0.25f, false, false, false);
				TASK::TASK_PLAY_ANIM(false, "random@getawaydriver", "idle_a", 4f, -4f, -1, 1, 0f, false, false, false);
			...
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
			{
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && !PED::IS_PED_ON_ANY_BIKE(unk_0x9B0761B4C3EB8BC7()))
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) < 0.1f)
						{
							if (func_128() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
							{
								VEHICLE::REQUEST_VEHICLE_ASSET(MISC::GET_MODEL_DIMENSIONS(PLAYER::GET_PLAYERS_LAST_VEHICLE()), 3);
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
								{
									Local_245 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0) };
									Var11 = { unk_0x7EC595B99EA7C4B1(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), -1.5f, -1.5f, 0f) };
									Var12 = { unk_0x7EC595B99EA7C4B1(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 1.5f, 0f, 0f) };
									TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
									TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 10000, 2096, 4);
									TASK::TASK_AIM_GUN_AT_ENTITY(0, bLocal_257, 1500, false);
									TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var11, bLocal_257, 3f, false, 0.5f, 4f, true, 0, false, -957453492, 20000);
									TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 10000, 2096, 4);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
									AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_258[0], iLocal_265);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
									TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
									TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 10000, 2096, 4);
									TASK::TASK_AIM_GUN_AT_ENTITY(0, bLocal_257, 2500, false);
									TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var12, bLocal_257, 3f, false, 0.5f, 4f, true, 0, false, -957453492, 20000);
									TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 10000, 2096, 4);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
									AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_258[1], iLocal_265);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
								...
								else
								{
									...
									if (MISC::GET_MODEL_DIMENSIONS(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) == joaat("bus"))
									{
										if (!SYSTEM::VDIST2(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 1, 0))
										{
											bVar13 = MISC::IS_MINIGAME_IN_PROGRESS(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 1, 0);
											if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(bVar13))
											{
												ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bVar13, true, false);
												PED::DELETE_PED(&bVar13);
											}
										}
										if (!SYSTEM::VDIST2(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 0, 0))
										{
											bVar13 = MISC::IS_MINIGAME_IN_PROGRESS(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 0, 0);
											if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(bVar13))
											{
												ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bVar13, true, false);
												PED::DELETE_PED(&bVar13);
							...
							else if (!iLocal_250)
							{
								if (!func_185())
								{
									...
									TASK::TASK_LOOK_AT_ENTITY(iLocal_258[1], unk_0x9B0761B4C3EB8BC7(), -1, 2096, 4);
									iLocal_250 = 1;
								}
							}
						}
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), (*uParam6)[1], 10f, 10f, 10f, false, true, 0))
				{
					if (!iLocal_250)
					{
						if (!func_185())
			...
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7()) < 0.2f)
				{
					if (iLocal_228 == -1)
					{
						iLocal_228 = MISC::GET_GAME_TIMER();
			...
			if (((PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || unk_0x653A331834B72BC0(unk_0x9B0761B4C3EB8BC7())) || PED::IS_COP_PED_IN_AREA_3D(Local_232 - Vector(40f, 40f, 40f), Local_232 + Vector(40f, 40f, 40f))) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(Local_232 - Vector(40f, 40f, 40f), Local_232 + Vector(40f, 40f, 40f)))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[1]))
				{
					TASK::TASK_SMART_FLEE_PED((*uParam6)[0], unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
					TASK::TASK_SMART_FLEE_PED((*uParam6)[1], unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
					func_169();
					SYSTEM::WAIT(0);
					func_171(&uLocal_53, "REGETAU", "REAWA_POLICE", 4, 0, 0, 0);
					*iParam0 = 20;
		...
		case 7:
			*iParam7 = 0;
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				...
				{
					if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_245, 2f, 2f, 2f, 0, 1, 0))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
						{
							if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && !PED::IS_PED_ON_ANY_BIKE(unk_0x9B0761B4C3EB8BC7()))
							{
								...
								{
									VEHICLE::REQUEST_VEHICLE_ASSET(MISC::GET_MODEL_DIMENSIONS(PLAYER::GET_PLAYERS_LAST_VEHICLE()), 3);
									while (!VEHICLE::HAS_VEHICLE_ASSET_LOADED(MISC::GET_MODEL_DIMENSIONS(PLAYER::GET_PLAYERS_LAST_VEHICLE())))
									{
										SYSTEM::WAIT(0);
									}
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
									{
										...
										{
											HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_258[0]);
											HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_258[1]);
											TASK::TASK_LOOK_AT_ENTITY(iLocal_258[1], unk_0x9B0761B4C3EB8BC7(), 10000, 2052, 4);
											PED::SET_PED_AS_GROUP_MEMBER(iLocal_258[0], func_75());
											PED::SET_PED_AS_GROUP_MEMBER(iLocal_258[1], func_75());
											PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_258[0], 1);
											PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_258[1], 0);
											if (MISC::GET_MODEL_DIMENSIONS(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) == joaat("bus"))
											{
												if (!SYSTEM::VDIST2(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 1, 0))
												{
													bVar14 = MISC::IS_MINIGAME_IN_PROGRESS(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 1, 0);
													if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(bVar14))
													{
														ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bVar14, true, false);
														PED::DELETE_PED(&bVar14);
													}
												}
												if (!SYSTEM::VDIST2(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 0, 0))
												{
													bVar14 = MISC::IS_MINIGAME_IN_PROGRESS(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 0, 0);
													if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(bVar14))
													{
														ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bVar14, true, false);
														PED::DELETE_PED(&bVar14);
			...
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]))
			{
				...
				else
				{
					if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						if ((!PED::IS_PED_GETTING_INTO_A_VEHICLE(iLocal_258[0]) && !unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_245, 2f, 2f, 2f, 0, 1, 0)) && !unk_0xC2169C00B643278B(iLocal_258[0], NETWORK::NETWORK_ARE_HANDLES_THE_SAME(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1), 2.5f, 2.5f, 2.5f, 0, 1, 0))
						{
			...
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
			{
				...
				else
				{
					if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						if ((!PED::IS_PED_GETTING_INTO_A_VEHICLE(iLocal_258[1]) && !unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_245, 2f, 2f, 2f, 0, 1, 0)) && !unk_0xC2169C00B643278B(iLocal_258[1], NETWORK::NETWORK_ARE_HANDLES_THE_SAME(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1), 2.5f, 2.5f, 2.5f, 0, 1, 0))
						{
			...
			if (!bLocal_246)
			{
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if ((!PED::IS_PED_IN_ANY_POLICE_VEHICLE(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
					{
						if ((unk_0xE0B3BC41DDA88DF0(iLocal_258[0], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0) && !unk_0xE0B3BC41DDA88DF0(iLocal_258[1], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_258[1], 20f, 20f, 20f, false, true, 0))
						{
							bLocal_246 = true;
						}
						if ((unk_0xE0B3BC41DDA88DF0(iLocal_258[1], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0) && !unk_0xE0B3BC41DDA88DF0(iLocal_258[0], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_258[0], 20f, 20f, 20f, false, true, 0))
						{
							bLocal_246 = true;
						}
					}
			...
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				if (func_73(uParam6, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 120f) || bLocal_246)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
					{
						...
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
						PED::SET_PED_KEEP_TASK(bLocal_257, true);
						ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_257);
					}
					func_72();
					if (!CAM::IS_SPHERE_VISIBLE(7.3162f, -1544.838f, 28.2558f, 3f))
					{
						bLocal_263 = VEHICLE::CREATE_VEHICLE(joaat("police3"), 7.3162f, -1544.838f, 28.2558f, 251.9956f, true, true, false);
						iLocal_261[0] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_263, 6, joaat("s_m_y_cop_01"), -1, true, true);
						iLocal_261[1] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_263, 6, joaat("s_m_y_cop_01"), 0, true, true);
						unk_0x92BD213E6A0E666B(iLocal_261[0], joaat("weapon_pistol"), -1, 0, 1);
						unk_0x92BD213E6A0E666B(iLocal_261[1], joaat("weapon_pistol"), -1, 0, 1);
						PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_261[0], 0);
					}
					if (!CAM::IS_SPHERE_VISIBLE(91.6602f, -1541.899f, 28.3422f, 3f))
					{
						bLocal_263 = VEHICLE::CREATE_VEHICLE(joaat("police3"), 91.6602f, -1541.899f, 28.3422f, 127.3064f, true, true, false);
						iLocal_261[0] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_263, 6, joaat("s_m_y_cop_01"), -1, true, true);
						iLocal_261[1] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_263, 6, joaat("s_m_y_cop_01"), 0, true, true);
						unk_0x92BD213E6A0E666B(iLocal_261[0], joaat("weapon_pistol"), -1, 0, 1);
						unk_0x92BD213E6A0E666B(iLocal_261[1], joaat("weapon_pistol"), -1, 0, 1);
					...
					{
						bLocal_263 = VEHICLE::CREATE_VEHICLE(joaat("police3"), 32.8029f, -1594.4f, 28.4262f, 337.7429f, true, true, false);
						iLocal_261[0] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_263, 6, joaat("s_m_y_cop_01"), -1, true, true);
						iLocal_261[1] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_263, 6, joaat("s_m_y_cop_01"), 0, true, true);
						unk_0x92BD213E6A0E666B(iLocal_261[0], joaat("weapon_pistol"), -1, 0, 1);
						unk_0x92BD213E6A0E666B(iLocal_261[1], joaat("weapon_pistol"), -1, 0, 1);
					...
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[iVar8]))
					{
		...
		case 9:
			...
			if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) == 0)
			{
				...
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_263, 0))
				{
					STREAMING::REMOVE_ANIM_DICT(&bLocal_263);
				}
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_261[0]))
				{
					ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_261[0]));
				}
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_261[1]))
				{
			...
			while (iVar8 < *uParam6)
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[iVar8]))
				{
					if (!PED::IS_PED_SITTING_IN_VEHICLE((*uParam6)[iVar8], PLAYER::GET_PLAYERS_LAST_VEHICLE()))
					{
						if (!SYSTEM::VMAG(uLocal_255[iVar8]))
						{
		...
		case 10:
			...
			else
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("COP"), iLocal_266);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_266, joaat("COP"));
				Var9 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
				bVar6 = 9999f;
				iVar15 = 0;
				while (iVar15 < Var5.x)
				{
					if (SYSTEM::VDIST(Var9, Var5[iVar15 /*3*/]) < bVar6)
					{
						bVar6 = SYSTEM::VDIST(Var9, Var5[iVar15 /*3*/]);
						iLocal_221 = iVar15;
					}
					iVar15++;
				}
				...
				fLocal_51 = func_62(Var5[iLocal_221 /*3*/], 1);
				if (func_119() == 2 && !func_61())
				{
					if (!SYSTEM::VMAG(fLocal_256))
					{
						fLocal_256 = func_62(Local_244, 0);
						HUD::SET_BLIP_SPRITE(fLocal_256, 269);
						func_59();
					}
				}
				iLocal_222 = MISC::GET_GAME_TIMER();
		...
		case 11:
			*iParam7 = 0;
			...
			else
			{
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
				{
					if ((unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Var5[iLocal_221 /*3*/], Global_19, 1, 1, 0) && unk_0xC2169C00B643278B(iLocal_258[0], Var5[iLocal_221 /*3*/], 20f, 20f, 20f, 0, 1, 0)) && unk_0xC2169C00B643278B(iLocal_258[1], Var5[iLocal_221 /*3*/], 20f, 20f, 20f, 0, 1, 0))
					{
						func_70(fLocal_51);
						iVar8 = 0;
		...
		case 12:
			...
			if (bLocal_248)
			{
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[0]))
				{
					...
					TASK::TASK_SMART_FLEE_PED(false, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
					AUDIO::STOP_SCRIPTED_CONVERSATION((*uParam6)[0], iLocal_265);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[1]))
				{
					...
					TASK::TASK_SMART_FLEE_PED(false, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
					AUDIO::STOP_SCRIPTED_CONVERSATION((*uParam6)[1], iLocal_265);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
		...
		case 14:
			...
			while (iVar8 < *uParam6)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[0]))
				{
					TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), (*uParam6)[iVar8], 4000, 2048, 2);
					...
					AUDIO::STOP_SCRIPTED_CONVERSATION((*uParam6)[0], iVar0);
					TASK::CLEAR_SEQUENCE_TASK(&iVar0);
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[1]))
					{
						TASK::OPEN_SEQUENCE_TASK(&iVar0);
						TASK::TASK_LEAVE_ANY_VEHICLE(0, 2000, 4194816);
						TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 3000, 2052, 2);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var7[iLocal_221 /*3*/], 2f, -1, 0.25f, false, 40000f);
						TASK::TASK_SMART_FLEE_PED(false, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iVar0);
						AUDIO::STOP_SCRIPTED_CONVERSATION((*uParam6)[1], iVar0);
						TASK::CLEAR_SEQUENCE_TASK(&iVar0);
					}
					iVar0 = 0;
					PED::SET_PED_KEEP_TASK((*uParam6)[iVar8], true);
					TASK::TASK_LOOK_AT_ENTITY((*uParam6)[iVar8], unk_0x9B0761B4C3EB8BC7(), 4000, 2052, 2);
					func_169();
					SYSTEM::WAIT(0);
					if (iLocal_226 > 0)
					{
		...
		case 15:
			...
			else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam6)[1]))
			{
				if (!SYSTEM::VDIST((*uParam6)[0], 0) && !SYSTEM::VDIST((*uParam6)[1], 0))
				{
					HUD::CLEAR_PRINTS();
		...
		case 18:
			...
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[iVar16]))
				{
					if (SYSTEM::VMAG(uLocal_255[iVar16]))
					{
						unk_0x93370FA10F15BE44(&(uLocal_255[iVar16]));
						if (SYSTEM::VDIST(iLocal_258[iVar16], 0))
						{
							TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_258[iVar16], 0, 0);
						}
						if (SYSTEM::VMAG(fLocal_51))
						{
							unk_0x93370FA10F15BE44(&fLocal_51);
						}
						PED::REMOVE_PED_FROM_GROUP(iLocal_258[iVar16]);
						TASK::TASK_COMBAT_PED(iLocal_258[iVar16], unk_0x9B0761B4C3EB8BC7(), 0, 16);
			...
			else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]))
			{
			...
			if (!bLocal_249)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
				{
					PED::SET_PED_CAN_BE_TARGETTED(bLocal_257, false);
					TASK::TASK_PLAY_ANIM(bLocal_257, "random@getawaydriver", "base", 4f, -4f, -1, 1, 0f, false, false, false);
				}
			}
			iVar16 = 0;
			while (iVar16 < iLocal_259)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_259[iVar16]))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_259[iVar16], unk_0x9B0761B4C3EB8BC7(), 150f, -1, false, false);
...
void func_3(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_15(iParam0));
...
void func_8()
{
	...
	{
		if (func_12(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_18(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	func_19(func_53(iParam0), 1, iParam1, bParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_22(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_24() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_24() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_23(bParam0));
...
var func_28(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
bool func_30(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_24() /*10931*/].f_6175.f_10, bParam0);
}
...
int func_57(struct<3> Param0)
{
	if (func_119() == 2)
	{
		if (func_56() && !Global_31208)
		{
			if (bLocal_50 == -1f)
			{
				bLocal_50 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Param0);
			}
			if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Param0) > (bLocal_50 + 200f) || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(-1014.154f, 4881.411f, 245.0001f, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), 0), 1) < 400f)
			{
				Global_31208 = 1;
				return 1;
			}
...
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam0)[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam0)[1]))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY((*uParam0)[0], (*uParam0)[1], 15f, 15f, 15f, false, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY((*uParam0)[0], unk_0x9B0761B4C3EB8BC7(), 15f, 15f, 15f, false, true, 0))
		{
			switch (iLocal_225)
			{
				case 0:
...
bool func_62(struct<3> Param0, bool bParam1)
{
	...
	HUD::SET_BLIP_SCALE(bVar0, func_63(MISC::SET_BIT(), 1f, 1f));
...
int func_65()
{
	if (func_66())
	{
		if (((((((unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_236, 50f, 50f, 50f, 0, 1, 0) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_237, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_238, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_239, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_240, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_241, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_242, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_243, 50f, 50f, 50f, 0, 1, 0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) < 0.2f)
			{
				return 1;
...
int func_66()
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
			{
				if (unk_0xE0B3BC41DDA88DF0(iLocal_258[0], bVar0, 0) && unk_0xE0B3BC41DDA88DF0(iLocal_258[1], bVar0, 0))
				{
					return 1;
				}
			}
...
bool func_68(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_63(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
void func_71()
{
	...
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[iVar0]))
		{
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
			{
				if (!func_128())
				{
					PED::_0x2208438012482A1A(iLocal_258[iVar0], 1);
					...
					{
						TASK::TASK_GO_TO_ENTITY(iLocal_258[iVar0], unk_0x9B0761B4C3EB8BC7(), -1, 6f, 2f, 2f, 0);
					}
					if (SYSTEM::VDIST(iLocal_258[iVar0], 0))
					{
				...
				{
					iLocal_251 = 0;
					PED::_0x2208438012482A1A(iLocal_258[iVar0], 0);
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_258[iVar0], 1227113341) == 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_258[iVar0], 1227113341) == 0)
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_258[iVar0]);
					}
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
					{
						PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_258[0], 1);
						...
						if (MISC::GET_MODEL_DIMENSIONS(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) == joaat("bus"))
						{
							if (!SYSTEM::VDIST2(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 1, 0))
							{
								bVar1 = MISC::IS_MINIGAME_IN_PROGRESS(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 1, 0);
							...
							if (!SYSTEM::VDIST2(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 0, 0))
							{
								bVar2 = MISC::IS_MINIGAME_IN_PROGRESS(STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7()), 0, 0);
								if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(bVar2))
								{
									ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bVar2, true, false);
									PED::DELETE_PED(&bVar2);
								}
							}
						}
					}
...
int func_73(var uParam0, bool bParam1, float fParam2)
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			if (!unk_0xE0B3BC41DDA88DF0((*uParam0)[iVar0], bParam1, 0))
			{
				if (fParam2 > 0f)
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY((*uParam0)[iVar0], unk_0x9B0761B4C3EB8BC7(), fParam2, fParam2, fParam2, false, true, 0))
					{
						return 0;
					}
				}
...
void func_74(var uParam0, float fParam1)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam0)[iVar0]))
		{
			if (SYSTEM::VMAG(uLocal_255[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(uLocal_255[iVar0]));
			}
		}
		else
		{
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				...
				{
					if (unk_0xE0B3BC41DDA88DF0((*uParam0)[iVar0], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0))
					{
						if (SYSTEM::VMAG(uLocal_255[iVar0]))
						{
							unk_0x93370FA10F15BE44(&(uLocal_255[iVar0]));
					...
					else if (!SYSTEM::VMAG(uLocal_255[iVar0]))
					{
			...
			if (!ENTITY::IS_ENTITY_AT_ENTITY((*uParam0)[iVar0], unk_0x9B0761B4C3EB8BC7(), fParam1, fParam1, fParam1, false, true, 0))
			{
				if (SYSTEM::VMAG(uLocal_255[iVar0]))
				{
					unk_0x93370FA10F15BE44(&(uLocal_255[iVar0]));
...
int func_76()
{
	...
	while (iVar0 < iLocal_258)
	{
		if (MISC::IS_BIT_SET(iLocal_258[iVar0]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[iVar0]))
			{
				if (!PED::IS_PED_IN_GROUP(iLocal_258[iVar0]))
				{
					...
					{
						if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_258[iVar0], unk_0x9B0761B4C3EB8BC7()))
						{
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_258[1]))
							{
					...
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_258[iVar0], unk_0x9B0761B4C3EB8BC7(), true) && ENTITY::GET_ENTITY_HEALTH(iLocal_258[iVar0]) < 190) || (iLocal_227 != -1 && MISC::GET_GAME_TIMER() > iLocal_227 + 5000))
					{
						return 1;
					}
				}
			...
			else
			{
				...
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_258[iVar0], unk_0x9B0761B4C3EB8BC7(), true))
				{
					return 1;
				}
			}
...
int func_77(var uParam0, bool bParam1)
{
	...
	if (!iLocal_219)
	{
		...
		while (iVar0 <= (*uParam0 - 1))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam0)[iVar0]))
			{
				if ((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 121.8366f, -1503.006f, 28.0999f, 0.1367f, -1649.705f, 48.1608f, 125.8125f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED((*uParam0)[iVar0])) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 75.3661f, -1542.811f, 28.4601f, 43.7035f, -1580.28f, 33.4259f, 26f, 0, 1, 0))
				{
					if (!SYSTEM::VMAG(uLocal_255[iVar0]))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam0)[iVar0]))
						{
							if (!func_207())
							{
								func_106(1);
								func_105(1);
								if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_264, 0))
								{
									if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_264, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_264, 50f, 50f, 50f, false, true, 0))
									{
										func_80(bLocal_264, 0, 145);
									}
								}
							}
							uLocal_255[iVar0] = func_67((*uParam0)[iVar0], 0, 145);
					...
					if (!func_185())
					{
						if (iLocal_230 < MISC::GET_GAME_TIMER())
						{
							...
							iLocal_230 = (MISC::GET_GAME_TIMER() + NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(3500, 4000));
						}
					}
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 75.3661f, -1542.811f, 28.4601f, 43.7035f, -1580.28f, 33.4259f, 26f, 0, 1, 0))
					{
						...
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam1, 0))
						{
							if (!func_185())
							{
								...
								if (SYSTEM::VMAG(uLocal_255[0]))
								{
									HUD::SHOW_HEIGHT_ON_BLIP(uLocal_255[0], true);
								}
								if (SYSTEM::VMAG(uLocal_255[1]))
								{
									HUD::SHOW_HEIGHT_ON_BLIP(uLocal_255[1], true);
								}
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*uParam0)[1]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
								{
									PED::SET_PED_RESET_FLAG((*uParam0)[1], 156, true);
									TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
									TASK::TASK_PLAY_ANIM(false, "misslamar1ig_20", "stretch_call_hurry_a", 2f, -2f, -1, 0, 0f, false, false, false);
									TASK::TASK_PLAY_ANIM(false, "combat@gestures@pistol@halt", "180", 2f, -2f, -1, 0, 0f, false, false, false);
									TASK::TASK_AIM_GUN_AT_ENTITY(0, bLocal_257, -1, false);
									TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2096, 4);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
									AUDIO::STOP_SCRIPTED_CONVERSATION((*uParam0)[1], iLocal_265);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
								}
								TASK::TASK_LOOK_AT_ENTITY((*uParam0)[iVar0], unk_0x9B0761B4C3EB8BC7(), -1, 2096, 4);
							}
						}
					}
				}
...
void func_81(bool bParam0, int iParam1)
{
	...
	func_82(bParam0, &(Global_111858.f_32745.f_5510));
}
...
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_103(bParam0, 0, 0)) || func_103(bParam0, 1, 0)) || func_103(bParam0, 2, 0)) || func_102(bParam0) != 145) || func_101(bParam0)) || func_100(bParam0)) || func_99(bParam0)) || func_98(bParam0)) || !func_88(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_100(bParam0))
		{
		}
...
int func_88(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_89(fParam0, 0))
	{
		return 0;
	}
...
int func_89(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
int func_125(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (MISC::SET_BIT())
	{
		if (func_123() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_31(func_122(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
{
	if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Param0, fParam1, fParam1, fParam1, 0, 1, 0))
	{
		if (iParam2 == 0)
		{
...
int func_128()
{
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false))
		{
			if (((((!PED::IS_PED_ON_ANY_BIKE(unk_0x9B0761B4C3EB8BC7()) && !PED::IS_PED_IN_FLYING_VEHICLE(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_BOAT(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_SUB(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_TRAIN(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_MODEL(unk_0x9B0761B4C3EB8BC7(), joaat("rhino")))
			{
				if (PED::GET_VEHICLE_PED_IS_USING(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) >= 2)
				{
					return 1;
				}
			}
	...
	else if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
	{
		...
		{
			if (((((!MONEY::NETWORK_SPENT_BULL_SHARK(MISC::GET_MODEL_DIMENSIONS(PED::GET_VEHICLE_PED_IS_ENTERING(unk_0x9B0761B4C3EB8BC7()))) && !VEHICLE::IS_THIS_MODEL_A_HELI(MISC::GET_MODEL_DIMENSIONS(PED::GET_VEHICLE_PED_IS_ENTERING(unk_0x9B0761B4C3EB8BC7())))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(MISC::GET_MODEL_DIMENSIONS(PED::GET_VEHICLE_PED_IS_ENTERING(unk_0x9B0761B4C3EB8BC7())))) && !VEHICLE::IS_THIS_MODEL_A_BOAT(MISC::GET_MODEL_DIMENSIONS(PED::GET_VEHICLE_PED_IS_ENTERING(unk_0x9B0761B4C3EB8BC7())))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(MISC::GET_MODEL_DIMENSIONS(PED::GET_VEHICLE_PED_IS_ENTERING(unk_0x9B0761B4C3EB8BC7())))) && MISC::GET_MODEL_DIMENSIONS(PED::GET_VEHICLE_PED_IS_ENTERING(unk_0x9B0761B4C3EB8BC7())) != joaat("rhino"))
			{
				return 1;
			}
		}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_141()) || Global_110905) || Global_30970) || func_140()) || func_139(8, -1)) || func_136()) || func_138()) || func_137()) || func_135()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_141() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_139(8, -1)) || func_135()) || func_134()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_141()) || func_137()) || Global_110905) || Global_30970) || func_140()) || Global_42801) || func_139(8, -1)) || func_136()) || func_134()) || func_135()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_147(bool bParam0, char* sParam1, int iParam2)
{
...
int func_151(bool bParam0, char* sParam1, int iParam2)
{
	if (unk_0xCE990E643CD9D0E5(bParam0, 30))
	{
...
int func_154()
{
	...
	{
		if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_49) < (75f * 75f))
		{
			return 1;
		}
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_165())
		{
			return 0;
		}
	}
...
void func_167()
{
	if (!bLocal_248)
	{
		PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(func_186(PLAYER::PLAYER_ID()) - Vector(0f, 10f, 0f), NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(5, 15), &Local_235, 1, 1077936128, 0);
			...
			if (bLocal_247)
			{
				if (!MISC::IS_BIT_SET(iLocal_260[0]))
				{
					...
					else
					{
						PED::_0x2208438012482A1A(iLocal_260[0], 1);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
						TASK::TASK_GO_TO_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, 6f, 3f, 2f, 0);
						TASK::TASK_PLAY_ANIM(false, "random@getawaydriver", "gesture_nod_yes_hard", 8f, -8f, -1, 48, 0f, false, false, false);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 0);
						TASK::TASK_STAND_STILL(0, 3000);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
						AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_260[0], iLocal_265);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
						PED::SET_PED_KEEP_TASK(iLocal_260[0], true);
						func_118(&uLocal_53, 4, iLocal_260[0], "REGETCop", 0, 1);
					}
				}
				if (!MISC::IS_BIT_SET(iLocal_260[1]))
				{
					iLocal_260[1] = PED::CREATE_PED(6, joaat("s_m_y_cop_01"), Local_233 - Vector(0f, 5f, 0f), 0f, true, true);
					if (func_65())
					{
						unk_0x92BD213E6A0E666B(iLocal_260[0], joaat("weapon_pistol"), -1, 0, 1);
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_260[1], iLocal_268);
						PED::_0x2208438012482A1A(iLocal_260[1], 1);
				...
				if (!MISC::IS_BIT_SET(bLocal_262))
				{
					bLocal_262 = VEHICLE::CREATE_VEHICLE(joaat("police3"), Local_233, 0f, true, true, false);
					Local_234 = { func_186(PLAYER::PLAYER_ID()) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_262, 1) };
					ENTITY::SET_ENTITY_HEADING(bLocal_262, unk_0x9075769DD4F148B7(Local_234.x, Local_234.f_1));
					VEHICLE::SET_VEHICLE_SIREN(bLocal_262, true);
				}
				if (!MISC::IS_BIT_SET(iLocal_260[2]))
				{
					iLocal_260[2] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_262, 6, joaat("s_m_y_cop_01"), -1, true, true);
					if (func_65())
					{
						unk_0x92BD213E6A0E666B(iLocal_260[2], joaat("weapon_pistol"), -1, 1, 1);
						...
						PED::_0x2208438012482A1A(iLocal_260[2], 1);
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_260[2], bLocal_262, iLocal_258[1], 6, 15f, 2, -1f, -1f, true);
					...
					else
					{
						PED::_0x2208438012482A1A(iLocal_260[2], 1);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
						TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, bLocal_262, 40.2328f, -1555.753f, 28.2128f, 10f, 0, joaat("police"), 786469, 1f, -1f);
						TASK::TASK_STAND_STILL(0, 5000);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
						AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_260[2], iLocal_265);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
						PED::SET_PED_KEEP_TASK(iLocal_260[2], true);
					}
				}
...
int func_214(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_240(Global_111858.f_24991.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_227(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
void func_246(struct<9> Param0, int iParam1, bool bParam2)
{
	...
	if (iLocal_269)
	{
		...
		func_258();
		func_105(0);
		unk_0xAF7D4BF357E8B79E(Local_232 - Vector(20f, 20f, 20f), Local_232 + Vector(20f, 20f, 20f), 1, 1);
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_257))
		{
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_257, "random@getawaydriver", "idle_a", 3) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_257, "random@getawaydriver", "idle_2_hands_up", 3))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_265);
				TASK::TASK_PLAY_ANIM(false, "random@getawaydriver", "hands_up_2_idle", 4f, -4f, -1, 0, 0f, false, false, false);
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*iParam1)[0]))
				{
					TASK::TASK_SMART_FLEE_PED(false, (*iParam1)[0], 150f, -1, false, false);
				}
				else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*iParam1)[1]))
				{
					TASK::TASK_SMART_FLEE_PED(false, (*iParam1)[1], 150f, -1, false, false);
				}
				TASK::CLOSE_SEQUENCE_TASK(iLocal_265);
				AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_257, iLocal_265);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_265);
			...
			TASK::CLEAR_PED_SECONDARY_TASK(bLocal_257);
			PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_257, 17, true);
			PED::_0x2208438012482A1A(bLocal_257, 0);
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*iParam1)[0]))
		{
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER((*iParam1)[0], 4.442116E-43f, 1);
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*iParam1)[1]))
		{
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER((*iParam1)[1], 4.442116E-43f, 1);
			...
			PED::_0x2208438012482A1A((*iParam1)[1], 0);
		}
		iVar0 = 0;
		while (iVar0 < iLocal_259)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_259[iVar0]))
			{
				PED::_0x2208438012482A1A(iLocal_259[iVar0], 0);
			}
			iVar0++;
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_260[0]))
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_260[1]))
		{
			unk_0x92BD213E6A0E666B(iLocal_260[1], joaat("weapon_pistol"), -1, 0, 1);
			PED::_0x2208438012482A1A(iLocal_260[1], 0);
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_260[2]))
		{
			unk_0x92BD213E6A0E666B(iLocal_260[2], joaat("weapon_pistol"), -1, 0, 1);
			PED::_0x2208438012482A1A(iLocal_260[2], 0);
		}
		if (!bParam2)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*iParam1)[0]))
		...
		if (SYSTEM::VMAG(fLocal_256))
		{
			unk_0x93370FA10F15BE44(&fLocal_256);
		}
		func_70(fLocal_52);
		func_129(0);
		func_142(0, Param0);
