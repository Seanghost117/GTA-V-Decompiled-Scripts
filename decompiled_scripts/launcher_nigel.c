...
void func_134(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_138(PLAYER::PLAYER_ID())) && !func_136(PLAYER::PLAYER_ID(), 0)) && !func_135()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_138(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_147()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_148(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_148(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_165()
{
	return func_166(TASK::IS_PED_BEING_ARRESTED(), 0);
}
...
void func_168(int iParam0, float fParam1)
{
	...
	{
		case 0:
			*fParam1 = func_169(-1604.668f, 5239.1f, 3.01f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 42);
			break;
		
		case 1:
			*fParam1 = func_169(-1592.84f, 5214.04f, 3.01f, 0);
		...
		case 2:
		case 3:
			*fParam1 = func_169(190.26f, -956.35f, 29.63f, 0);
		...
		case 4:
			*fParam1 = func_169(414f, -761f, 29f, 0);
		...
		case 9:
			*fParam1 = func_169(-1622.89f, 4204.87f, 83.3f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*fParam1 = func_169(1835.53f, 4705.86f, 38.1f, 0);
			}
			else if (iParam0 == 12)
			{
				*fParam1 = func_169(1826.13f, 4698.88f, 38.92f, 0);
			}
			else
			{
				*fParam1 = func_169(637.02f, 119.7093f, 89.5f, 0);
			}
		...
		case 19:
			if (iParam0 == 18)
			{
				*fParam1 = func_169(-954.19f, -2760.05f, 14.64f, 0);
			}
			else
			{
				*fParam1 = func_169(-63.8f, -809.5f, 321.8f, 0);
			}
		...
		case 23:
			if (iParam0 == 21)
			{
				*fParam1 = func_169(-1877.82f, -440.649f, 45.05f, 0);
			}
			else
			{
				*fParam1 = func_169(-915.6f, 6139.2f, 5.5f, 0);
			}
		...
		case 27:
			*fParam1 = func_169(-1104.93f, 291.25f, 64.3f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 44);
			break;
		...
		case 34:
			*fParam1 = func_169(-303.82f, 6211.29f, 31.05f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 386);
			HUD::SET_BLIP_COLOUR(*fParam1, 44);
			break;
		
		case 43:
			*fParam1 = func_169(-44.75f, -1288.67f, 28.21f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 149);
			HUD::SET_BLIP_COLOUR(*fParam1, 44);
			break;
		
		case 46:
			*fParam1 = func_169(-149.75f, 285.81f, 93.67f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*fParam1 = func_169(-70.71f, 301.43f, 106.79f, 0);
			}
			else
			{
				*fParam1 = func_169(-257.22f, 292.85f, 90.63f, 0);
			}
...
int func_169(struct<3> Param0, bool bParam1)
{
	...
	HUD::SET_BLIP_SCALE(iVar0, func_170(MISC::SET_BIT(), 1f, 1f));
...
int func_173(int iParam0, int iParam1)
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					...
					{
						if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0->f_28[0], 1), 1) < 3f)
						{
							if (func_179(2))
							{
		...
		case 1:
			if (MISC::IS_BIT_SET(iParam0->f_35[0]))
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0->f_35[0], 0))
				{
					if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0->f_35[0], 1), 1) < iParam0->f_15)
					{
						if (func_179(2))
						{
							if (func_177(iParam0->f_27))
		...
		case 3:
			if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), iParam0->f_17[0 /*3*/], 1) < iParam0->f_15)
			{
				if (func_179(2))
				{
					if (func_177(iParam0->f_27))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (func_127(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
					{
						...
						{
							if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), iParam0->f_35[0]))
							{
								if (func_179(3))
								{
									return 1;
						...
						{
							if (VEHICLE::DOES_CARGOBOB_HAVE_PICK_UP_ROPE(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_CARGOBOB(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), iParam0->f_35[0]))
							{
								if (func_179(3))
								{
									return 1;
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 4:
						if (((((func_187() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_185(8, -1)) || func_182()) || func_181()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_187()) || func_184()) || Global_110905) || Global_30970) || func_186()) || Global_42801) || func_185(8, -1)) || func_183()) || func_181()) || func_182()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_188(int iParam0)
{
	...
	if (func_127(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		{
			if (MISC::IS_BIT_SET(iParam0->f_28[iVar0]))
			{
				if (func_127(iParam0->f_28[iVar0]))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0->f_28[iVar0], unk_0x9B0761B4C3EB8BC7(), true) || MISC::IS_BULLET_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0->f_28[iVar0], 1), 7.5f, true))
					{
						if (func_179(2))
						{
							func_176(iParam0->f_27, *iParam0);
...
{
	if (func_190(uParam1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)))
	{
		if (func_179(2))
		{
			if (func_177(iParam0->f_27))
...
bool func_190(var uParam0, struct<2> Param1, bool bParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		switch (*iParam0)
		{
			case 0:
				if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CAR_TRUNK_THUMPS", false, -1))
				{
					...
					iParam0->f_3 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(6000, 12000);
					*iParam0 = 1;
				}
				break;
			...
			case 1:
				...
				{
					AUDIO::SET_VARIABLE_ON_SOUND(iParam0->f_1, "TRUNK_THUMPS", unk_0x7EC595B99EA7C4B1(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
					AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_192(0), false);
					iParam0->f_4 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(3, 7);
					iParam0->f_5 = 0;
					iParam0->f_6 = MISC::GET_GAME_TIMER();
					iParam0->f_7 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(100, 250);
					*iParam0 = 2;
				}
				break;
			...
			case 2:
				...
				{
					iParam0->f_8 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(-200, -120);
					iParam0->f_9 = (0.5f * SYSTEM::TO_FLOAT(NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(-2, 3)));
					...
					{
						iParam0->f_6 = MISC::GET_GAME_TIMER();
						iParam0->f_7 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(150, 280);
					}
					else
					{
						iParam0->f_2 = MISC::GET_GAME_TIMER();
...
int func_193(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_197(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_197(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_202(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_127(bParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_204(uParam1) || !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_203(iParam2) && !PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(bParam0, unk_0x9B0761B4C3EB8BC7(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_204(uParam1) && uParam1->f_4 == 0) && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_203(iParam2) || PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (!CAM::IS_SCREEN_FADED_OUT(iParam1))
		{
			...
			else
			{
				...
				{
					case 1:
						if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(iParam1, "JOSH_1_INT_CONCAT"))
						{
...
bool func_226(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_227(&(Local_49[iVar2 /*4*/]), Var1, iParam1, &(Local_49[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_49[iVar2 /*4*/].f_3) < iParam4);
}

int func_227(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_230(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_232(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_232(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_239(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_232(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_242(bool bParam0)
{
	...
	if (func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(bParam0))
	{
...
int func_252(var uParam0, var uParam1)
{
	...
	if (MISC::IS_BIT_SET(*uParam1) && ENTITY::DOES_ENTITY_EXIST(iLocal_54))
	{
		*uParam0 = PED::CREATE_PED(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, true, true);
		...
		fVar2 = (-90f + ENTITY::IS_ENTITY_IN_WATER(*uParam1));
		Var1 = { 0f, 0f, fVar2 };
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(*uParam0, Var0, false, false, true);
		ENTITY::DETACH_ENTITY(*uParam0, Var1, 2, 1);
		OBJECT::CREATE_OBJECT_NO_OFFSET(*uParam0, *uParam1, 0, 0.2f, -1.8f, 0f, 0f, 0f, 90f, 0, 0, 0, 0, 2, 1);
...
void func_253(char* sParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_254(sParam0);
...
void func_262(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 37:
			...
			{
				PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_67, 0);
		...
		case 38:
			if (bParam1)
			{
				fLocal_67 = PATHFIND::SET_ROADS_IN_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, false, true, 1, 1);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (bParam1)
			{
				fLocal_67 = PATHFIND::SET_ROADS_IN_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, false, true, 1, 1);
		...
		case 41:
			if (bParam1)
			{
				fLocal_67 = PATHFIND::SET_ROADS_IN_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, false, true, 1, 1);
		...
		case 42:
			if (bParam1)
			{
				fLocal_67 = PATHFIND::SET_ROADS_IN_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, false, true, 1, 1);
...
void func_267(var uParam0)
{
	...
	{
		fVar1 = SYSTEM::VDIST2(uParam0->f_47, *(uParam0[bVar0 /*3*/]));
...
int func_270(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			TASK::OPEN_SEQUENCE_TASK(&iVar3);
			TASK::TASK_PLAY_ANIM(false, sVar2, "base", 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, sVar2, "dexy_stay_there", 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, sVar2, "base", 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, sVar2, "price_tag", 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, sVar2, "base", 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, sVar2, "such_a_good", 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, sVar2, "base", 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, sVar2, "this_looks", 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, sVar2, "base", 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, sVar2, "who_would", 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::SET_SEQUENCE_TO_REPEAT(iVar3, true);
			TASK::CLOSE_SEQUENCE_TASK(iVar3);
			AUDIO::STOP_SCRIPTED_CONVERSATION(uParam0->f_28[0], iVar3);
			TASK::CLEAR_SEQUENCE_TASK(&iVar3);
...
int func_271(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_127(uParam0->f_35[0]))
			{
				if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uParam0->f_35[0], sVar2, "idle_speedo", 3))
				{
			...
			if (func_126(uParam0->f_28[2]))
			{
				...
				CAM::IS_AIM_CAM_ACTIVE(uParam0->f_28[2], 160, 0);
				if (STREAMING::HAS_ANIM_DICT_LOADED(sVar2))
				{
			...
			if (func_127(uParam0->f_41[0]))
			{
				ENTITY::DETACH_ENTITY(uParam0->f_41[0], 0f, 0f, -11.27f, 2, 1);
...
void func_297(int iParam0, int iParam1, bool bParam2)
{
	...
	if (SYSTEM::VMAG(fLocal_69))
	{
		unk_0x93370FA10F15BE44(&fLocal_69);
	}
	if (bParam2)
	{
...
void func_314(var uParam0)
{
	if (PED::DETACH_SYNCHRONIZED_SCENE(uParam0->f_59))
	{
		if (func_126(uParam0->f_28[0]))
		{
			...
			{
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(uParam0->f_28[0]);
			}
