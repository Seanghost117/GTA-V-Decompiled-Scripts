...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0xCE990E643CD9D0E5(Global_7552, 1))
		{
			if (!unk_0xCE990E643CD9D0E5(Global_7551, 20))
			{
				if (unk_0x6B12213471F330A3())
				{
					...
					VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, true);
				}
			}
		}
		...
		if (((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && !unk_0xCE990E643CD9D0E5(Global_4456448.f_17, 4)) && !func_110()) && INTERIOR::GET_INTERIOR_AT_COORDS(joaat("fm_mission_controller_2020")) == 0)
		{
			if (Global_21005 != 0)
			{
...
void func_2()
{
	...
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7551, 24);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 23);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7553, false);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 9);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 31);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 17);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7553, 5);
	Global_21989 = 0;
	Global_21988 = 0;
					...
					if (fVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[fVar0] == 0)
						{
							...
							if (Global_2462245)
							{
								if (iVar1 == 14)
								{
									func_119(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22068), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8120[fVar0] = 1;
						}
					...
					if (fVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[fVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_119(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22073), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76833)
								{
									...
									func_119(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(fVar4), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19681)
									...
									func_119(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(fVar6), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7558[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_119(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(fVar9), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_119(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8120[fVar0] = 1;
						}
					}
...
void func_16()
{
	...
	if (iLocal_98 == 0)
	{
		if (func_49(2, Global_19657, 0) || PAD::IS_DISABLED_CONTROL_PRESSED(2, 181))
		{
			func_20();
			iLocal_98 = 1;
			SYSTEM::SETTIMERA(0);
		}
		if (func_49(2, Global_19658, 0) || PAD::IS_DISABLED_CONTROL_PRESSED(2, 180))
		{
			func_17();
			iLocal_98 = 1;
			SYSTEM::SETTIMERA(0);
...
void func_61()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_62() && PED::IS_PED_IN_COVER(unk_0x9B0761B4C3EB8BC7(), false))
		{
			iVar1 = 1;
		}
	}
...
void func_64()
{
	...
	else
	{
		...
		if (!Global_21018)
		{
			...
			{
				NETWORK::NETWORK_IS_SIGNED_ONLINE(Global_20624.f_368, Global_20624.f_369);
			}
		}
		func_65();
	}
...
void func_74()
{
	...
	while (iLocal_75 < Global_21001)
	{
		...
		while (iVar2 < 70 && iLocal_29 == 0)
		{
			...
			{
				StringCopy(&cLocal_46, AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_38), 64);
				bVar3 = func_88(iVar13);
				...
				{
					if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&(Global_19873[iVar2 /*6*/]), &(Global_20624.f_187[iLocal_75 /*6*/])))
					{
						if (bVar3 > 36 || iVar4 > 36)
						{
						}
						AUDIO::_0x0B568201DD99F0EB(bVar3, &cLocal_46, &(Global_19873[iVar2 /*6*/]), iVar4, uVar5, 0, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
					}
				}
				iVar1 = (iVar1 + iVar0);
			}
			...
			{
				StringCopy(&cLocal_46, AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_42), 64);
				bVar3 = func_88(0);
				iVar4 = func_87(0);
				uVar5 = func_85(0);
				uLocal_67 = func_84();
				...
				uVar10 = func_76(0);
				uVar11 = func_75(0);
				AUDIO::_0x0B568201DD99F0EB(bVar3, &cLocal_46, &(Global_20624.f_6[iLocal_75 /*6*/]), iVar4, uVar5, 1, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
	...
	if (Global_21011 == 0)
	{
		AUDIO::_0x61631F5DF50D1C34(bLocal_68);
		AUDIO::START_SCRIPT_CONVERSATION(bLocal_69);
...
int func_75(int iParam0)
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_70), iParam0 * 7 + 6, iParam0 * 7 + 7);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "0"))
	{
		return 0;
	}
	return 1;
...
int func_76(int iParam0)
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_70), iParam0 * 7 + 5, iParam0 * 7 + 6);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "0"))
	{
		return 0;
	}
...
int func_77(int iParam0)
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_70), iParam0 * 7 + 4, iParam0 * 7 + 5);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "0"))
	{
		return 0;
	}
...
int func_78(int iParam0)
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_70), iParam0 * 7 + 3, iParam0 * 7 + 4);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "0"))
	{
		return 1;
	}
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "1"))
	{
		return 1;
	}
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "2"))
	{
		return 2;
	}
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "3"))
	{
		return 3;
	}
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "4"))
	{
		return 0;
	}
	return 0;
...
int func_79(int iParam0)
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_70), iParam0 * 7 + 2, iParam0 * 7 + 3);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "0"))
	{
		return 0;
	}
...
int func_80(int iParam0)
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_70), iParam0 * 7 + 1, iParam0 * 7 + 2);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "0"))
	{
		return 0;
	}
...
int func_81(int iParam0)
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_70), iParam0 * 7, iParam0 * 7 + 1);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "0"))
	{
		return 0;
	}
...
int func_82()
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_60), 2, 3);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "0"))
	{
		return 0;
	}
...
int func_83()
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_60), 1, 2);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "0"))
	{
		return 0;
	}
...
int func_84()
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_60), 0, 1);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sVar0, "0"))
	{
		return 0;
	}
...
int func_85(int iParam0)
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_55), iParam0 * 3 + 2, iParam0 * 3 + 3);
...
int func_87(int iParam0)
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_55), iParam0 * 3 + 1, iParam0 * 3 + 2);
	return func_86(sVar0);
}
...
bool func_88(int iParam0)
{
	...
	sVar0 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_55), iParam0 * 3, iParam0 * 3 + 1);
	return func_86(sVar0);
}
...
void func_89()
{
	...
	{
		fLocal_74 = AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_70);
		if (AUDIO::PRELOAD_SCRIPT_CONVERSATION(fLocal_74))
		{
		}
	}
}
...
void func_90()
{
	...
	{
		fLocal_64 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_60), 0, 1);
		if (AUDIO::PRELOAD_SCRIPT_CONVERSATION(fLocal_64))
		{
		}
		fLocal_65 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_60), 1, 2);
		if (AUDIO::PRELOAD_SCRIPT_CONVERSATION(fLocal_65))
		{
		}
		fLocal_66 = HUD::_GET_TEXT_SUBSTRING(AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_60), 2, 3);
		if (AUDIO::PRELOAD_SCRIPT_CONVERSATION(fLocal_66))
		{
		}
	}
}
...
void func_91()
{
	...
	{
		fLocal_59 = AUDIO::ADD_LINE_TO_CONVERSATION(&cLocal_55);
		if (AUDIO::PRELOAD_SCRIPT_CONVERSATION(fLocal_59))
		{
		}
	}
}
...
void func_92()
{
	...
	if (Global_21997)
	{
		HUD::DOES_TEXT_BLOCK_EXIST(Global_20624.f_368, Global_20624.f_369, Global_20624.f_370, uLocal_67);
...
void func_93()
{
	...
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&Global_21081, "CT_AUD"))
		{
			Global_2621442 = 1;
		}
		iVar13 = 0;
		if (unk_0xDCA0815D900F27F8() || NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE())
		{
			if (Global_1573348 == 1)
			{
				iVar13 = 1;
		...
		if (func_98(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&Global_21081)))
		{
			iVar14 = 0;
			Global_2621442 = 0;
			iVar13 = 1;
		...
		if (((Global_21007 < 5 || Global_21007 == 10) || Global_21007 == 12) || Global_21007 == 13)
		{
			...
			{
				HUD::HAS_ADDITIONAL_TEXT_LOADED(&Global_21081, 7);
				while (!HUD::REQUEST_ADDITIONAL_TEXT_FOR_DLC(7))
				{
					SYSTEM::WAIT(0);
				}
			}
			...
			{
				AUDIO::CREATE_NEW_SCRIPTED_CONVERSATION(&Global_21081, 15);
		...
		{
			HUD::HAS_ADDITIONAL_TEXT_LOADED(&Global_21081, 6);
			while (!HUD::REQUEST_ADDITIONAL_TEXT_FOR_DLC(6))
			{
				SYSTEM::WAIT(0);
			}
		}
		else if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("fm_mission_controller_2020")) == 0)
		{
			AUDIO::CREATE_NEW_SCRIPTED_CONVERSATION(&Global_21081, 14);
			while (!HUD::REQUEST_ADDITIONAL_TEXT_FOR_DLC(14))
			{
				SYSTEM::WAIT(0);
			}
		}
	...
	while (iVar2 < 70 && iLocal_29 == 0)
	{
		...
		if (unk_0x3030AE9FCF1BC243(&cLocal_38))
		{
			...
			if (unk_0x3030AE9FCF1BC243(&(Global_19873[iVar2 /*6*/])))
			{
				...
				else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&(Global_19873[iVar2 /*6*/]), &Global_22003))
				{
					if (bVar3 > 36 || iVar4 > 36)
					{
					}
			...
			{
				AUDIO::_0x0B568201DD99F0EB(bVar3, &cLocal_46, &cLocal_46, iVar4, uVar5, 0, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
			}
			iVar1 = (iVar1 + iVar0);
		}
		else
		{
			if (unk_0x3030AE9FCF1BC243(&cLocal_42))
			{
				...
				uVar10 = func_76(iVar2);
				uVar11 = func_75(iVar2);
				AUDIO::_0x0B568201DD99F0EB(bVar3, &cLocal_46, &Global_20624, iVar4, uVar5, 1, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
			}
			iLocal_29 = 1;
		}
		iVar2++;
...
void func_94()
{
	...
	while (iVar0 <= 15)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_20294[iVar0 /*10*/]) || Global_20294[iVar0 /*10*/] == 0)
			{
				AUDIO::_0x33E3C6C6F2F0B506(iVar0, Global_20294[iVar0 /*10*/], &(Global_20294[iVar0 /*10*/].f_1));
			}
			if (Global_20294.f_161 == iVar0)
			{
				...
				{
					SYSTEM::WAIT(0);
					AUDIO::PRELOAD_SCRIPT_PHONE_CONVERSATION(Global_20294.f_161, Global_20294.f_162);
				}
			}
		}
		iVar0++;
	...
	if (Global_4271212 == 1)
	{
		...
		while (iVar0 <= 19)
		{
			...
			{
				if (MISC::IS_BIT_SET(Global_4271031[iVar0 /*9*/]) || Global_4271031[iVar0 /*9*/] == 0)
				{
					AUDIO::_0x33E3C6C6F2F0B506(Global_4271031[iVar0 /*9*/].f_8, Global_4271031[iVar0 /*9*/], &(Global_4271031[iVar0 /*9*/].f_1));
				}
			}
			iVar0++;
		}
...
void func_103()
{
	while (Global_19664 == 1 && INTERIOR::GET_INTERIOR_AT_COORDS(joaat("cellphone_flashhand")) > 0)
	{
		SYSTEM::WAIT(0);
	}
	Global_19664 = 0;
	...
	if (Global_21015)
	{
		if (Global_22022 == 0)
		{
			...
			{
				iLocal_34 = 5000;
				SYSTEM::SETTIMERB(Global_20624.f_368, Global_20624.f_369);
			}
			else
			{
				iLocal_34 = 0;
...
void func_119(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
