...
void __EntryFunction__()
{
	...
	if (func_113(func_115(TASK::IS_PED_BEING_ARRESTED())))
	{
		func_116(0);
	}
	if (!func_112())
	...
	iLocal_209 = 1;
	if (MISC::IS_BIT_SET(iLocal_208) && func_105(iLocal_208))
	{
	...
	while (iVar0 == 1)
	{
		...
		{
			func_100(func_115(TASK::IS_PED_BEING_ARRESTED()));
			func_116(0);
		}
		...
		{
			if (!func_92() && INTERIOR::GET_INTERIOR_AT_COORDS(joaat("director_mode")) == 0)
			{
				if (func_111())
				{
				}
		...
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_208) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_208)) && fVar12 < 25f) && func_91(unk_0x9B0761B4C3EB8BC7()) != joaat("weapon_unarmed")) && func_88(iLocal_208, unk_0x9B0761B4C3EB8BC7(), 1126825984, 0))
			{
				if (!func_92())
				{
					func_94();
		...
		if (func_87(iLocal_208, unk_0x9B0761B4C3EB8BC7(), 1) < 25f)
		{
			...
			{
				func_83(&fLocal_214, &iLocal_208, 0);
			}
		}
		...
		switch (iLocal_216)
		{
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_56(Global_111803[iLocal_217], iLocal_223, NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
		...
		if (((((((((((((iLocal_216 == 0 || iLocal_216 == 1) || iLocal_216 == 3) || iLocal_216 == 8) || iLocal_216 == 9) || iLocal_216 == 7) && func_87(iLocal_208, unk_0x9B0761B4C3EB8BC7(), 1) < 5f) && bLocal_265 == 1) && !SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1)) && iVar6 == 0) && bLocal_268 == 1) && !Global_3) && func_7()) && bVar18)
		{
			if (iLocal_224 == -1)
			{
			...
			if (func_4(iLocal_224, 1))
			{
				...
				iLocal_216 = 13;
				iVar5 = 0;
				iVar19 = func_81(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(TASK::IS_PED_BEING_ARRESTED()));
				if (func_80(iVar19))
				{
					if (!func_79(iVar19))
					{
						func_71(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(TASK::IS_PED_BEING_ARRESTED()), 0);
					}
				}
				func_2(&iLocal_224);
			}
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_208) && func_87(iLocal_208, unk_0x9B0761B4C3EB8BC7(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_116(1);
		}
		SYSTEM::WAIT(0);
...
void func_71(void fParam0, bool bParam1)
{
	int iVar0;
...
void func_83(float fParam0, int iParam1, bool bParam2)
{
	if (iLocal_276 == 1)
	{
		if (!SYSTEM::VMAG(*fParam0))
		{
			if (MISC::IS_BIT_SET(*iParam1))
			{
				...
				{
					*fParam0 = func_84(*iParam1, bParam2, 145);
					if (bParam2 == 0)
					{
...
float func_84(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = func_85(iParam0, !bParam1, 0);
...
bool func_85(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_86(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_86(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
float func_87(int iParam0, int iParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_88(int* iParam0, int* iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_90(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
...
void func_107()
{
	iLocal_277 = OBJECT::CREATE_OBJECT(joaat("prop_cs_pamphlet_01"), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_208, 1), true, true, false);
