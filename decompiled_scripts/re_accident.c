...
void func_1()
{
	if (iLocal_280 && !iLocal_281)
	{
		...
		while (iLocal_97 < 11)
		{
			if (unk_0xAE06B9E39EBDE049(uLocal_88[iLocal_97]))
			{
				unk_0x6A8F948698B360B4(uLocal_88[iLocal_97], 0);
			}
			iLocal_97++;
		}
		...
		{
			unk_0x6A8F948698B360B4(iLocal_89, 0);
		}
		...
		if (unk_0x40397A9A17EEC1C5(uLocal_275))
		{
			unk_0xB8B0F7C8C1548C5B(uLocal_275, 0);
			unk_0x3ED9330214992278(0, 0, 3000, 1, 0, 0);
		...
		if (unk_0x8F678487EEBD8CE4(uLocal_86))
		{
			unk_0x93370FA10F15BE44(&uLocal_86);
		}
	...
	if (unk_0xAE06B9E39EBDE049(uLocal_88[0]) || unk_0xAE06B9E39EBDE049(uLocal_88[1]))
	{
		if (!unk_0x9A70B1BD2A5BA09C(Local_75 + Vector(20f, 0f, 0f), 30f) && !unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_75, 80f, 80f, 80f, 0, 1, 0))
		{
			func_180();
		}
	}
...
void func_14()
{
	...
	if (iLocal_61 == 0)
	{
		if (unk_0xAEF5977F6EA0380E(&Var1, Local_68[0 /*5*/]))
		{
			...
			while (iVar0 < Local_68)
			{
				if (iVar0 > 0)
				{
					fVar2 = (fVar2 + unk_0x272784C60C397DB6(Local_68[(iVar0 - 1) /*5*/], Local_68[iVar0 /*5*/], 1));
				}
				if (Local_68[iVar0 /*5*/].f_4)
				{
					if (unk_0xAEF5977F6EA0380E(&Var1, Local_68[iVar0 /*5*/]))
					{
						fVar4 = unk_0x272784C60C397DB6(Local_68[iVar0 /*5*/], Var1, 1);
						if (fVar4 < fVar5)
						{
							fVar5 = fVar4;
							fVar6 = fVar2;
	...
	if (iLocal_61 == 1)
	{
		...
		fVar7 = (SYSTEM::TO_FLOAT((unk_0x578C4EF320340AF7() - iLocal_63)) / fLocal_69);
...
void func_16(struct<3> Param0, int iParam1)
{
	...
	Local_60[iLocal_65 /*5*/] = unk_0xF190AF7F988D9B43(Param0, uLocal_53, iParam1);
	iLocal_65++;
	if (iLocal_65 >= 31)
	{
		iLocal_65 = 0;
				...
				if (unk_0x578C4EF320340AF7() > iLocal_54)
				{
					if (!bLocal_44)
					{
						...
						while (iVar0 < Local_68)
						{
							...
							{
								fVar2 = unk_0x272784C60C397DB6(Local_57, unk_0x41A1ED9BB4ED4772(Local_68[iVar0 /*5*/].f_3), 1);
								fVar3 = unk_0x272784C60C397DB6(Local_68[iVar0 /*5*/], unk_0x41A1ED9BB4ED4772(Local_68[iVar0 /*5*/].f_3), 1);
	...
	switch (iLocal_71)
	{
		case 0:
			...
			if ((unk_0x8B917081F9836EDD("CONSTRUCTION_ACCIDENT_1", false, -1) && unk_0xC614DDE265D18415("re@construction")) && func_104(&Local_283))
			{
				...
				{
					iLocal_78 = unk_0x6A7A2C83BD302BA4(iLocal_80, 26, joaat("s_m_m_dockwork_01"), -1, 1, 1);
					...
					iLocal_90 = unk_0x79CC07752E7432A1(joaat("p_amb_phone_01"), -455.6561f, -985.8071f, 22.4868f, 1, 1, 0);
					...
					unk_0x6673CC701BC8E9C1(iLocal_78, 17, 1);
					unk_0x2CE840C9FCC03A58(iLocal_78, 1);
					unk_0x4E65320BC9AD521C(iLocal_78, 1);
					unk_0x0DC39BE87E4C5599(iLocal_78, 0);
					func_103(&uLocal_108, 3, iLocal_78, "RECONACWorker", 0, 1);
					unk_0x3A2AAE59B4681DAF(iLocal_78, "S_M_Y_GENERICWORKER_01_WHITE_01");
					uLocal_79 = unk_0xB3116B49FE00E2F1(26, joaat("s_m_m_dockwork_01"), -462.2982f, -978.3272f, 65f, 221.4041f, 1, 1);
					unk_0x4E65320BC9AD521C(uLocal_79, 1);
					unk_0xA5EAD2ACE2C8BBB2(iLocal_79, 1, 1);
					unk_0x6A8F948698B360B4(iLocal_79, 1);
					...
					iLocal_89 = unk_0x79CC07752E7432A1(joaat("prop_generator_01a"), Local_274.x, (Local_274.f_1 + 0.5f), (Local_274.f_2 - 0.25f), 1, 1, 0);
					unk_0xE922BAA80E8F9324(iLocal_89, 75f);
					unk_0x52090984B5C8A3E4(iLocal_89, 0, 1, 1, 0, 0, 0, 0, 0);
					uLocal_279 = unk_0xF245B4695C9BEF04("scr_sparking_generator", iLocal_89, 0f, 0f, 0.2f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
					unk_0x6A8F948698B360B4(iLocal_89, 1);
		...
		case 1:
			...
			if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
			{
				if (!iLocal_92)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
					{
						...
						if (unk_0xCDF860E56BBCC6B4(iLocal_78, unk_0x9B0761B4C3EB8BC7(), 1) || unk_0xCDF860E56BBCC6B4(iLocal_80, unk_0x9B0761B4C3EB8BC7(), 1))
						{
							...
							unk_0x9B6EC2CECE1010EF(iLocal_78, uLocal_107);
				...
				else
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
					{
						if (unk_0x47DBF174A0CB9D55(iLocal_78, 0))
						{
							if (!unk_0xA59F96B50B97E63C(iLocal_80, 0) && !unk_0x8F678487EEBD8CE4(uLocal_85))
							{
								uLocal_85 = func_96(iLocal_80, 0, 0);
							}
						}
						else if (!unk_0x8F678487EEBD8CE4(uLocal_84))
						{
							if (unk_0x8F678487EEBD8CE4(uLocal_85))
							{
								unk_0x93370FA10F15BE44(&uLocal_85);
					...
					if (iLocal_103 >= 3)
					{
						if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) && unk_0xE6577B0644092448(unk_0x9B0761B4C3EB8BC7(), joaat("bulldozer")))
						{
							if (unk_0x8F678487EEBD8CE4(uLocal_86))
							{
								...
								if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78) && !unk_0xA59F96B50B97E63C(iLocal_80, 0))
								{
									if (unk_0x47DBF174A0CB9D55(iLocal_78, 0) && !unk_0x8F678487EEBD8CE4(uLocal_85))
									{
										uLocal_85 = func_96(iLocal_80, 0, 0);
									}
								}
				...
				if (!unk_0xA59F96B50B97E63C(iLocal_80, 0))
				{
					if (unk_0x0922C2E075A5F18C(iLocal_80))
					{
						...
						if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
						{
							...
							{
								unk_0x4E65320BC9AD521C(iLocal_78, 1);
								unk_0x694113444F21E39F(iLocal_78, 116, 0);
								unk_0x694113444F21E39F(iLocal_78, 29, 0);
								if (!bLocal_95)
								{
									func_46();
									SYSTEM::WAIT(0);
		...
		case 2:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
			{
				if ((unk_0x578C4EF320340AF7() - iLocal_101) > 5000 && !func_23())
				{
					if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						iLocal_106 = unk_0x36FE6D3220816ADA(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0));
					}
					if (unk_0x47DBF174A0CB9D55(iLocal_78, 0))
					{
						if (unk_0x80FF6C016CDB0FAF(iLocal_81, 0))
						{
							...
							else if (!unk_0x8F678487EEBD8CE4(uLocal_86))
							{
								uLocal_86 = func_96(iLocal_81, 0, 0);
								if (unk_0x8F678487EEBD8CE4(uLocal_85))
								{
		...
		case 2:
			if ((unk_0x578C4EF320340AF7() - iLocal_105) > iLocal_73 || func_51())
			{
				...
				if (!bLocal_95)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78) && !unk_0xA59F96B50B97E63C(iLocal_80, 0))
					{
						if (!unk_0xC7C55C82599F980F(iLocal_78, iLocal_80, -1, 0, 0) && !unk_0xC7C55C82599F980F(iLocal_78, iLocal_80, 0, 0, 0))
						{
							func_46();
							SYSTEM::WAIT(0);
							func_24(&uLocal_108, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
	...
	switch (iLocal_98)
	{
		case 0:
			if (iLocal_103 >= 2)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78) && !unk_0xA59F96B50B97E63C(iLocal_80, 0))
				{
					...
					if (unk_0xC7C55C82599F980F(iLocal_78, iLocal_80, -1, 0, 0) || unk_0xC7C55C82599F980F(iLocal_78, iLocal_80, 0, 0, 0))
					{
						if (unk_0xC7C55C82599F980F(iLocal_78, iLocal_80, -1, 0, 0))
						{
							bLocal_94 = true;
							Local_77 = { unk_0x3E4D3CCC220BDFB1(iLocal_80, 0) + Vector(0f, -1f, -3f) };
						}
						else
						{
							Local_77 = { unk_0x3E4D3CCC220BDFB1(iLocal_80, 0) + Vector(0f, 1.5f, -3f) };
						}
						if (unk_0xC2169C00B643278B(unk_0xA5D3CD332CD10EE9(), Local_77, 4.2f, 4f, 5f, 0, 1, 0))
						{
							if (!bLocal_93)
							{
								func_46();
		...
		case 1:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78) && !unk_0xA59F96B50B97E63C(iLocal_80, 0))
			{
				...
				{
					unk_0x52090984B5C8A3E4(iLocal_81, 0, 1, 1, 0, 0, 0, 0, 0);
				}
				unk_0x52090984B5C8A3E4(iLocal_78, 0, 1, 0, 0, 0, 0, 0, 0);
				unk_0x6A8F948698B360B4(iLocal_80, 0);
				unk_0x9DC06E2A59C5AEBB(&uLocal_107);
				if (bLocal_94)
				{
				...
				unk_0x9B6EC2CECE1010EF(iLocal_78, uLocal_107);
				unk_0x4F83FEE4454169D4(&uLocal_107);
				unk_0xCBA6B2B569DCAFD8(iLocal_78, 1);
				iLocal_101 = unk_0x578C4EF320340AF7();
				iLocal_98++;
			}
			break;
		...
		case 2:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
			{
				if ((unk_0x578C4EF320340AF7() - iLocal_101) > 500 && !unk_0x47DBF174A0CB9D55(iLocal_78, 0))
				{
					iLocal_73 = 0;
					if (unk_0x80FF6C016CDB0FAF(iLocal_80, 0))
					{
		...
		case 3:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
			{
				if (unk_0xC2169C00B643278B(iLocal_78, -464.7217f, -989.7214f, 22.4867f, 3f, 10f, 3f, 0, 1, 0) || (unk_0x578C4EF320340AF7() - iLocal_101) > 10000)
				{
		...
		case 4:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
			{
				if (unk_0xC2169C00B643278B(iLocal_78, -472.7056f, -991.105f, 22.4867f, 3f, 30f, 3f, 0, 1, 0) || (unk_0x578C4EF320340AF7() - iLocal_101) > 10000)
				{
					if (!unk_0xA59F96B50B97E63C(iLocal_80, 0))
					{
						unk_0x6A8F948698B360B4(iLocal_80, 0);
		...
		case 5:
			if ((unk_0x578C4EF320340AF7() - iLocal_101) > 3000)
			{
				...
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
				{
					...
					if (!unk_0xA59F96B50B97E63C(iLocal_81, 0))
					{
						unk_0x52090984B5C8A3E4(iLocal_81, 0, 0, 0, 0, 0, 0, 0, 0);
					}
					unk_0x52090984B5C8A3E4(iLocal_78, 0, 0, 0, 0, 0, 0, 0, 0);
					unk_0x4478D8ED4673EF14(iLocal_78, 1);
					unk_0x0DC39BE87E4C5599(iLocal_78, 1);
					unk_0x2CE840C9FCC03A58(iLocal_78, 0);
					unk_0x4E65320BC9AD521C(iLocal_78, 0);
					...
					unk_0x62726974410B1305(uLocal_107, 1);
					unk_0x19F29730874AD6F1(uLocal_107);
					unk_0x9B6EC2CECE1010EF(iLocal_78, uLocal_107);
					unk_0x4F83FEE4454169D4(&uLocal_107);
				}
		...
		case 6:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
			{
				if ((unk_0x578C4EF320340AF7() - iLocal_101) > 6400)
				{
					...
					{
						if (unk_0xC2169C00B643278B(iLocal_83, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, 0, 1, 0))
						{
							Var0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
					...
					{
						if (unk_0xC2169C00B643278B(iLocal_81, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, 0, 1, 0))
						{
							Var0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
...
void func_97()
{
	...
	switch (iLocal_72)
	{
		case 0:
			...
			unk_0xF27E737981AFB47D(Local_75, 30f, 0, 0, 0, 0, 0, 0);
			unk_0x801B883D25479F23(Local_75, 100f, 0);
			if (!unk_0xA59F96B50B97E63C(unk_0xA5D3CD332CD10EE9(), 0))
			{
				if (unk_0xC2169C00B643278B(unk_0xA5D3CD332CD10EE9(), Local_75, 8f, 8f, 8f, 0, 1, 0))
				{
					uLocal_82 = unk_0xA5D3CD332CD10EE9();
					unk_0x4F3C4F457D44BB0F(uLocal_82, 1, 0);
			...
			uLocal_276 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, -0.1371f, -0.0346f, -29.6605f, 28f, 1, 2);
			uLocal_277 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, 69.4831f, -0.0346f, -40.8884f, 28f, 1, 2);
			unk_0x2311A669433389E8(uLocal_276, "HAND_SHAKE", 0.3f);
			unk_0x2311A669433389E8(uLocal_277, "HAND_SHAKE", 0.3f);
			func_99();
			unk_0x856549C07003344B(uLocal_276, 1);
			unk_0x3ED9330214992278(1, 0, 3000, 1, 0, 0);
			SYSTEM::WAIT(500);
			unk_0xF674D9B2033F5F86(uLocal_277, uLocal_276, 3500, 1, 1);
		...
		case 1:
			if ((unk_0x578C4EF320340AF7() - iLocal_104) > 3500)
			{
				...
				unk_0xC4CC25B68A91D144(iLocal_100, "WIND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", 1);
				unk_0xEF6C40CE5DEBAAE3(uLocal_88[0], 1);
				func_98(uLocal_276);
				func_98(uLocal_277);
				uLocal_276 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -455.4617f, -990.631f, 61.6885f, -89.0761f, -0.0146f, -49.881f, 80.5355f, 1, 2);
				uLocal_277 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -455.4543f, -990.6208f, 61.012f, -89.0759f, -0.0146f, -47.8226f, 80.5355f, 1, 2);
				unk_0x2311A669433389E8(uLocal_276, "HAND_SHAKE", 0.3f);
				unk_0x2311A669433389E8(uLocal_277, "HAND_SHAKE", 0.3f);
				unk_0xF674D9B2033F5F86(uLocal_277, uLocal_276, 4000, 1, 0);
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
				{
					unk_0x9B94F6169B0DAEFD(iLocal_78);
				...
				{
					unk_0x1F8106DB8796859F(iLocal_90, 1, 1);
					unk_0x315F7D8C33F0AB37(&iLocal_90);
				}
				iLocal_104 = unk_0x578C4EF320340AF7();
				iLocal_72 = 2;
		...
		case 3:
			...
			{
				if (unk_0xAE06B9E39EBDE049(uLocal_88[0]))
				{
					unk_0x6A8F948698B360B4(uLocal_88[0], 0);
					unk_0x8B77B020136E915A(uLocal_88[0], 0, 0f, 0f, 5f, 0f, -2f, 2f, 0, 1, 1, 1, 0, 1);
					unk_0xC69C2DB4DB243F74(uLocal_88[0], 11, 0);
					unk_0xC69C2DB4DB243F74(uLocal_88[0], 18, 0);
					unk_0xC69C2DB4DB243F74(uLocal_88[0], 19, 0);
					unk_0xC69C2DB4DB243F74(uLocal_88[0], 23, 0);
					unk_0xC69C2DB4DB243F74(uLocal_88[0], 9, 0);
					unk_0xC69C2DB4DB243F74(uLocal_88[0], 12, 0);
					unk_0xC69C2DB4DB243F74(uLocal_88[0], 17, 0);
					unk_0x07AA3B8DE21236E5("scr_reconstruct_pipefall_debris", uLocal_88[0], 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
				}
				iLocal_104 = unk_0x578C4EF320340AF7();
				iLocal_72 = 4;
			}
		...
		case 4:
			if ((unk_0x578C4EF320340AF7() - iLocal_104) > 2000)
			{
				func_98(uLocal_276);
				func_98(uLocal_277);
				uLocal_276 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 25.437f, -0.0087f, -118.3831f, 34f, 1, 2);
				uLocal_277 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 2.0695f, -0.0087f, -120.2811f, 34f, 1, 2);
				unk_0x2311A669433389E8(uLocal_276, "HAND_SHAKE", 0.3f);
				unk_0x2311A669433389E8(uLocal_277, "HAND_SHAKE", 0.3f);
				unk_0xF674D9B2033F5F86(uLocal_277, uLocal_276, 1000, 3, 3);
		...
		case 5:
			if ((unk_0x578C4EF320340AF7() - iLocal_104) > 500)
			{
				if (!unk_0xA59F96B50B97E63C(iLocal_80, 0))
				{
					...
					unk_0x756D74A3EF0AB788(iLocal_78, "re@construction", "idle_panic", 8f, -8f, -1, 16, 0f, 0, 0, 0);
					...
					if (unk_0x40397A9A17EEC1C5(uLocal_276) && unk_0x40397A9A17EEC1C5(uLocal_277))
					{
						unk_0x2311A669433389E8(uLocal_276, "HAND_SHAKE", 1.5f);
						unk_0x2311A669433389E8(uLocal_277, "HAND_SHAKE", 1.5f);
					}
					iLocal_104 = unk_0x578C4EF320340AF7();
					iLocal_72 = 6;
				}
		...
		case 6:
			if ((unk_0x578C4EF320340AF7() - iLocal_104) > 500)
			{
				func_98(uLocal_276);
				func_98(uLocal_277);
				uLocal_276 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -459.2609f, -987.5602f, 24.2611f, 0.583f, 0.2617f, -32.7532f, 49.9914f, 1, 2);
				uLocal_277 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -459.0622f, -987.2584f, 24.2661f, 5.0301f, 0.2617f, -36.7308f, 49.9914f, 1, 2);
				unk_0x2311A669433389E8(uLocal_276, "HAND_SHAKE", 0.5f);
				unk_0x2311A669433389E8(uLocal_277, "HAND_SHAKE", 0.5f);
				unk_0xF674D9B2033F5F86(uLocal_277, uLocal_276, 2500, 3, 3);
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
				{
					unk_0x439AF5D920F78274(iLocal_78, unk_0x3E4D3CCC220BDFB1(iLocal_78, 1) - Vector(10f, 0f, 2f), 30000, 2080, 2);
				}
				iLocal_104 = unk_0x578C4EF320340AF7();
				iLocal_72 = 7;
			}
		...
		case 8:
			...
			if (unk_0xAE06B9E39EBDE049(uLocal_88[0]))
			{
				unk_0x315F7D8C33F0AB37(&(uLocal_88[0]));
			}
			if (unk_0x80FF6C016CDB0FAF(iLocal_80, 0))
			{
				unk_0x0FC504FAF5EB94FB(iLocal_80, 250f);
				unk_0x03D382CB0B44E2FC(iLocal_80, Local_75, 1, 0, 0, 1);
			...
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
			{
				unk_0x9B94F6169B0DAEFD(iLocal_78);
				unk_0xE2348E4036041923(iLocal_78);
				unk_0x756D74A3EF0AB788(iLocal_78, "re@construction", "idle_panic", 8f, -8f, -1, 1, 0f, 0, 0, 0);
			}
			unk_0x856549C07003344B(uLocal_276, 0);
			unk_0x3ED9330214992278(0, 0, 3000, 1, 0, 0);
			unk_0xB8B0F7C8C1548C5B(uLocal_276, 0);
			unk_0xB8B0F7C8C1548C5B(uLocal_277, 0);
			unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), 1, 0);
			unk_0x4C4FC7841A5FB983(0f);
			unk_0x8CFF639CEFF5CF16(1);
			unk_0x644F1D0C5427A242(1);
			...
			uLocal_88[1] = unk_0x6E52E47D436A2C77(joaat("prop_ld_pipe_single_01"), -457.8815f, -988.9059f, 22.9554f, 1, 1, 0);
			unk_0xC82085403E46A869(uLocal_88[1], -0.1939f, 105.0058f, 77.3964f, 2, 1);
			uLocal_88[2] = unk_0x6E52E47D436A2C77(joaat("prop_ld_pipe_single_01"), -451.5131f, -986.8079f, 24.6947f, 1, 1, 0);
			unk_0xC82085403E46A869(uLocal_88[2], 24.3941f, 32.5423f, 80.6862f, 2, 1);
			uLocal_88[3] = unk_0x6E52E47D436A2C77(joaat("prop_ld_pipe_single_01"), -450.8099f, -985.9972f, 24.7104f, 1, 1, 0);
			unk_0xC82085403E46A869(uLocal_88[3], 24.1841f, 110.287f, 78.4357f, 2, 1);
			uLocal_88[4] = unk_0x6E52E47D436A2C77(joaat("prop_ld_pipe_single_01"), -456.6558f, -987.3979f, 22.9537f, 1, 1, 0);
			unk_0xC82085403E46A869(uLocal_88[4], -0.0264f, 29.5754f, 79.1811f, 2, 1);
			uLocal_88[5] = unk_0x6E52E47D436A2C77(joaat("prop_ld_pipe_single_01"), -456.1279f, -988.4162f, 22.9889f, 1, 1, 0);
			unk_0xC82085403E46A869(uLocal_88[5], -0.6337f, 108.4339f, 77.9539f, 2, 1);
			uLocal_88[6] = unk_0x6E52E47D436A2C77(joaat("prop_ld_pipe_single_01"), -457.0807f, -987.3059f, 23.7564f, 1, 1, 0);
			unk_0xC82085403E46A869(uLocal_88[6], 0.0929f, 74.2657f, 79.3839f, 2, 1);
			uLocal_88[7] = unk_0x6E52E47D436A2C77(joaat("prop_ld_pipe_single_01"), -456.6558f, -983.7804f, 22.9712f, 1, 1, 0);
			unk_0xC82085403E46A869(uLocal_88[7], -0.0264f, 29.5754f, 80.9061f, 2, 1);
			uLocal_88[8] = unk_0x6E52E47D436A2C77(joaat("prop_ld_pipe_single_01"), -455.3279f, -983.1712f, 22.9564f, 1, 1, 0);
			unk_0xC82085403E46A869(uLocal_88[8], -0.1087f, 109.7339f, 80.9789f, 2, 1);
			uLocal_88[9] = unk_0x6E52E47D436A2C77(joaat("prop_ld_pipe_single_01"), -456.1632f, -983.9359f, 23.7964f, 1, 1, 0);
			unk_0xC82085403E46A869(uLocal_88[9], -0.3321f, 74.1907f, 81.6089f, 2, 1);
			uLocal_88[10] = unk_0x6E52E47D436A2C77(joaat("prop_ld_pipe_single_01"), -454.644f, -994.1709f, 23.3329f, 1, 1, 0);
			unk_0xC82085403E46A869(uLocal_88[10], 5.7811f, 104.6058f, 104.6964f, 2, 1);
			iLocal_97 = 0;
			while (iLocal_97 < 11)
			{
				if (unk_0xAE06B9E39EBDE049(uLocal_88[iLocal_97]))
				{
					unk_0x9729E0DCF1C3C9A9(uLocal_88[iLocal_97], 1);
					unk_0x6A8F948698B360B4(uLocal_88[iLocal_97], 1);
				}
				iLocal_97++;
			}
			if (bLocal_282)
...
void func_115()
{
	...
	if (func_104(&Local_283))
	{
		...
		iLocal_80 = unk_0xCE4780E24AFDFBF9(joaat("utillitruck2"), Local_75, 80f, 1, 1, 0);
		unk_0xC160551F55D6365A(iLocal_80, 0, 1, 0);
		unk_0x5DC21979EC6C531F(iLocal_80, 3);
		unk_0xF242CEB863060ABC(iLocal_80, 1, 1);
		unk_0xF242CEB863060ABC(iLocal_80, 2, 1);
		unk_0xF242CEB863060ABC(iLocal_80, 3, 0);
		unk_0xF242CEB863060ABC(iLocal_80, 4, 1);
		unk_0xF242CEB863060ABC(iLocal_80, 5, 1);
		unk_0xF242CEB863060ABC(iLocal_80, 6, 0);
		unk_0xF242CEB863060ABC(iLocal_80, 7, 1);
		unk_0x6A8F948698B360B4(iLocal_80, 1);
		unk_0x52090984B5C8A3E4(iLocal_80, 0, 0, 0, 1, 0, 0, 0, 0);
		unk_0x1CCBC799127EA27B(iLocal_80, 10000);
		unk_0xE87B2E81877383B1(iLocal_80, 5f);
		iLocal_81 = unk_0xCE4780E24AFDFBF9(joaat("bulldozer"), -472.9444f, -966.671f, 22.5534f, 181.8365f, 1, 1, 0);
		unk_0x555EE41D7C7078E6(Local_75, 10f, 1, 0, 0, 0);
		uLocal_88[0] = unk_0x6E52E47D436A2C77(joaat("prop_pipe_stack_01"), -453.2f, -986.1f, 59.45f, 1, 1, 0);
		unk_0xE922BAA80E8F9324(uLocal_88[0], 90f);
		unk_0x6A8F948698B360B4(uLocal_88[0], 1);
		unk_0x52090984B5C8A3E4(uLocal_88[0], 1, 1, 1, 1, 0, 0, 0, 0);
		unk_0x1CCBC799127EA27B(uLocal_88[0], 10000000);
...
void func_180()
{
	if (iLocal_280)
	{
		if (!iLocal_281)
		{
			...
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_78))
			{
				unk_0x694113444F21E39F(iLocal_78, 317, 1);
			}
			if (!unk_0xA59F96B50B97E63C(iLocal_83, 0))
			{
				if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_83, 0) && !unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_83, 50f, 50f, 50f, 0, 1, 0))
				{
