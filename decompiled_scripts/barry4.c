...
void __EntryFunction__()
{
	...
	if (func_351())
	{
		...
		func_248(&bVar0, 236.1378f, -369.3902f, 43.2497f, 251.2f, 0, 0, 0, 1, 0, joaat("asterope"), 0, 145, 1);
		Global_77078 = 0;
	}
	while (true)
	{
...
void func_1()
{
	switch (iLocal_80)
	{
		...
		case 2:
			...
			{
				MONEY::NETWORK_MONEY_CAN_BET(0, 177, true);
			}
			break;
...
void func_221(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
{
	if (((!func_245(0) || Global_77102) || Global_77091 == 1) || !GRAPHICS::DRAW_SCALEFORM_MOVIE())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((OBJECT::ADD_DOOR_TO_SYSTEM() || func_244(0)) || func_243(1))
			{
			}
			else
			{
...
void func_248(bool bParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_324(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		{
			func_315(iParam10, 0);
			while (!func_249(bParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_249(bool bParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_309(bParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_309(bParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (MISC::GET_MODEL_DIMENSIONS(*bParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Var2))
			{
				...
				*bParam0 = VEHICLE::CREATE_VEHICLE(Var2, Param2, fParam3, true, true, false);
				...
				func_309(bParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_250(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && MISC::IS_BIT_SET(*bParam1)) && ENTITY::GET_ENTITY_COORDS(*bParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*bParam1) >= 0 && func_255(*bParam1, 0, &uVar0))
		{
			func_254(bParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_253(*bParam1);
...
int func_255(bool bParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	fVar0 = MISC::GET_MODEL_DIMENSIONS(bParam0);
	if ((!func_283(fVar0, bParam1, uParam2) && !func_282(PLAYER::PLAYER_ID())) && !func_265(bParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_263(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_261(bParam0)) && !bVar1) && !(func_260(MISC::GET_MODEL_DIMENSIONS(bParam0)) && func_257(PLAYER::PLAYER_ID())))
	{
	...
	if (!MISC::SET_BIT())
	{
		if ((func_256(bParam0) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("sentinel2")) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_267(bool bParam0)
{
	...
	if (func_268(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		return 1;
	}
	return 0;
...
int func_269(bool bParam0, bool bParam1)
{
	switch (MISC::GET_MODEL_DIMENSIONS(bParam0))
	{
		...
		case joaat("insurgent"):
			if (func_271(MISC::GET_MODEL_DIMENSIONS(bParam0), 0))
			{
				if (Global_2540384.f_303 == bParam0)
				{
					return 1;
				}
				else if (func_270(bParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_279(void fParam0, int iParam1)
{
	switch (fParam0)
	{
		case joaat("faction2"):
...
int func_283(void fParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_263(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fParam0)))
	{
		bVar0 = true;
	}
...
void func_285(bool bParam0, int iParam1)
{
	...
	func_286(bParam0, &(Global_111858.f_32745.f_5510));
}

void func_286(bool bParam0, var uParam1)
{
	int iVar0;
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_254(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_304(bParam0, 0, 0)) || func_304(bParam0, 1, 0)) || func_304(bParam0, 2, 0)) || func_303(bParam0) != 145) || func_302(bParam0)) || func_301(bParam0)) || func_256(bParam0)) || func_300(bParam0)) || !func_290(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_301(bParam0))
		{
		}
		...
		if (func_304(bParam0, 0, 0))
		{
		}
		if (func_304(bParam0, 1, 0))
		{
		}
		if (func_304(bParam0, 2, 0))
		{
		}
		if (func_303(bParam0) != 145)
		{
		}
		return 0;
	}
...
int func_290(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_291(fParam0, 0))
	{
		return 0;
	}
...
int func_291(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
int func_304(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_309(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_279(MISC::GET_MODEL_DIMENSIONS(*iParam0), 1) && unk_0x7F8B14CBFB9813E5(*iParam0, 24) != func_312(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_315(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || MISC::GET_MODEL_DIMENSIONS(Global_96286[iVar0]) == func_316(iParam0, iParam1))
				{
...
bool func_324(struct<3> Param0, float fParam1)
{
	return func_325(&(Global_105407.f_2890), Param0, fParam1, 0);
}

bool func_325(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	bool bVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_342(uParam0))
	{
		...
		if (func_341(uParam0))
		{
			...
			if (MISC::IS_BIT_SET(bVar0))
			{
				...
				func_330(bVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_306(bVar0, uParam0->f_11);
				}
				else if ((!func_327(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS(TASK::IS_PED_BEING_ARRESTED(), "startup_positioning"))
				{
					iVar4 = func_326(bVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_327(bool bParam0, struct<3> Param1, bool bParam2)
{
	void fVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_329(bParam0, Global_75654.f_139[38], 0))
			{
				func_318(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_329(bParam0, Global_75654.f_139[43], 1))
			{
				func_318(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_329(bParam0, uVar1[iVar3], 1) && func_328(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_323(Param1, 0f, 0f, 0f, 0)) || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_330(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::GET_ENTITY_COORDS(iParam0, false))
	{
		...
		if (bParam3)
		{
			func_309(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
...
void func_369(bool bParam0)
{
	...
	if (!func_390())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_370(TASK::IS_PED_BEING_ARRESTED(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_371(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_377())
	{
		...
		{
			iVar2 = func_372(TASK::IS_PED_BEING_ARRESTED());
			if (iVar2 > -1)
			{
