	...
	while (true)
	{
		switch (iLocal_51)
		{
			...
			case 1:
				if (func_144())
				{
					Local_243 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0) };
					func_112();
					if (func_111())
					{
...
void func_5()
{
	...
	{
		unk_0x72BEFB9451782F60(uLocal_63, 0);
...
void func_32()
{
	if (func_42(&Global_110889, &Global_110890, iLocal_70, iLocal_69))
	{
		if (!func_36())
		{
			...
			if (unk_0x8F678487EEBD8CE4(uLocal_63))
			{
				unk_0x9178C42B36234BF1(uLocal_63, 10000);
			}
		}
		else
		{
...
void func_50()
{
	...
	if (func_39(Global_110889))
	{
		if (!unk_0x8F678487EEBD8CE4(uLocal_63))
		{
			uLocal_63 = unk_0x2BE000892D65EA2A(Global_110889);
			unk_0xE7B8403ABCA0391D(uLocal_63, 198);
			unk_0xB023F5C66F5716C7(uLocal_63, "TXM_BLIP");
			unk_0x009A89A6CD1E6C3E(uLocal_63, 1);
			unk_0x9178C42B36234BF1(uLocal_63, 10000);
		}
	}
}
	...
	if (func_96(Local_56.f_23, Local_56.f_26))
	{
		if (!func_79(Param0, uParam1, uParam2, 1))
		{
			while (!bVar8 && *uParam3 < iVar6)
			{
				...
				if (unk_0x1485BFBB1EC6FE22(Param0, *uParam3, uParam1, uParam2, &uVar4, iVar9, fVar0, fVar1))
				{
					uVar5 = unk_0xBD67304F930F21E4(*uParam1, 1, iVar9, 1077936128, 0);
...
int func_100(var uParam0, var uParam1, struct<3> Param2, var uParam3)
{
	...
	if (unk_0x7D167B9A0CCDA347(func_146()))
	{
		...
		{
			*uParam0 = unk_0xCE4780E24AFDFBF9(func_146(), Param2, uParam3, 1, 1, 0);
			if (unk_0xAE06B9E39EBDE049(*uParam0))
			{
				if (unk_0x80FF6C016CDB0FAF(*uParam0, 0))
				{
...
int func_101(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		else if (unk_0x1485BFBB1EC6FE22(Var14, *uParam2, &Var0, &fVar3, &uVar4, iParam3, fVar8, fVar9))
		{
			while (!bVar6 && iVar7 < 5)
			{
				if (unk_0xB4A07AE91EF58820(&Var0, &Var1, &Var2, 0f, 180f, iParam4, iVar5, 1, 0))
				{
				...
				while (iVar4 <= (iVar3 - 1))
				{
					if (iVar5 < iVar0)
					{
						if (unk_0xAE06B9E39EBDE049(uVar13[iVar4]))
						{
							...
							{
								Var9 = { unk_0x3E4D3CCC220BDFB1(uVar13[iVar4], 0) };
												...
												if (unk_0x518D695E2DBA9DB8(uVar13[iVar4]) == unk_0x518D695E2DBA9DB8(unk_0x9B0761B4C3EB8BC7()))
												{
													...
													if (fVar10 < 4f)
													{
														...
														if (((Var11.x * Var12.x) + (Var11.f_1 * Var12.f_1)) / SYSTEM::VDIST(Var12, 0f, 0f, 0f)) > SYSTEM::COS(120f)
														{
															...
															if (!unk_0x1D92A4A6F3D3A021(uVar13[iVar4], 1119092736) || unk_0xE72C9284B5143451(uVar13[iVar4]))
															{
																fVar6 = 0f;
															}
															if (fVar6 > fVar7)
