...
void __EntryFunction__()
{
	...
	while (true)
	{
		switch (iLocal_45)
		{
			...
			case 2:
				unk_0x929F5F17530DE8A0(uLocal_46, "SET_MISSION_TITLE", ScriptParam_50, ScriptParam_50.f_1, 0, 0, 0);
				unk_0xC90636D3CB7D4CEF(uLocal_46, "SET_MISSION_TITLE_COLOUR", ScriptParam_50.f_2, ScriptParam_50.f_2, ScriptParam_50.f_2, -1082130432, -1082130432);
				if (ScriptParam_50.f_5.f_1 != -1f && !unk_0x211E6DB3335430B4(ScriptParam_50.f_5.f_2))
				{
					unk_0x3897B5364C6A9B4B(uLocal_46, "SET_TOTAL", SYSTEM::TO_FLOAT(ScriptParam_50.f_5), ScriptParam_50.f_5.f_1, -1f, -1f, -1f, ScriptParam_50.f_5.f_2, 0, 0, 0, 0);
				}
				unk_0xC90636D3CB7D4CEF(uLocal_46, "SET_MEDAL", SYSTEM::TO_FLOAT(ScriptParam_50.f_5), -1082130432, -1082130432, -1082130432, -1082130432);
				...
				while (iVar0 < ScriptParam_50.f_66 + 1)
				{
					...
					if (ScriptParam_50.f_9[iVar0 /*7*/].f_2 == 4)
					{
						...
						unk_0x7899A951E85F4B28(SYSTEM::FLOOR((ScriptParam_50.f_9[iVar0 /*7*/].f_3 * 1000f)), 6);
			...
			case 3:
				if (((func_2(&uLocal_47) > ScriptParam_50.f_67 && ScriptParam_50.f_67 != -1f) || unk_0x03DB5C6AABF8DA46()) || Global_31112)
				{
					func_19();
				}
				else
