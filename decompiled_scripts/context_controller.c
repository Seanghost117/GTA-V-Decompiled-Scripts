...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_76833 != iVar8)
		{
			...
			iVar2 = -1;
			iVar8 = Global_76833;
			while (LOCALIZATION::GET_CURRENT_LANGUAGE())
			{
				SYSTEM::WAIT(2000);
			}
		}
...
void func_1()
{
	...
	if (bLocal_83)
	{
		...
		else
		{
			...
			HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(&Local_86);
		}
		FILES::GET_DLC_VEHICLE_FLAGS(0, 0, iVar0, 50);
	}
	else
	{
		unk_0x17751E107423AFE9(&Local_85);
...
void func_26()
{
	if (!LOCALIZATION::GET_CURRENT_LANGUAGE() && !func_32())
	{
		if (func_31(0))
		{
			if (!CAM::IS_SCREEN_FADED_OUT(&(Global_2451787.f_782.f_12)))
			{
				func_30();
				func_27(6, 0, 0);
			}
...
void func_34(int iParam0)
{
	...
	{
		case 0:
			NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(joaat("SP0_TOTAL_CASH"), uVar0, 1);
			break;
		
		case 1:
			NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(joaat("SP1_TOTAL_CASH"), uVar0, 1);
			break;
		
		case 2:
			NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(joaat("SP2_TOTAL_CASH"), uVar0, 1);
			break;
	}
}
	...
	if (Global_1573306 != -1)
	{
		...
		else if (MISC::IS_PS3_VERSION() || unk_0xDCA0815D900F27F8())
		{
			if (func_36(Var0[0 /*13*/]))
			{
				...
				{
					case 0:
						iLocal_90 = NETWORK::_0xD66C9E72B3CC4982(&Var0, 1);
						if (iLocal_90 >= 0)
						{
							iLocal_89++;
						}
					...
					case 1:
						iVar2 = NETWORK::_0x58CC181719256197(iLocal_90, &Var1, 1);
						switch (iVar2)
						{
							case -1:
								func_37();
		...
		else
		{
			if (func_36(Var0[0 /*13*/]))
			{
				StringCopy(&(Global_2097152[func_38() /*10931*/].f_10754.f_18[Global_1573306 /*6*/]), PLAYER::GET_PLAYER_NAME(&(Var0[0 /*13*/])), 24);
			}
			func_37();
		}
	}
