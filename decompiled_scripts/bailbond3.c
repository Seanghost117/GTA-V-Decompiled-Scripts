...
void func_385()
{
	if (func_59(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_331, 100f))
	{
		if (!func_386())
		{
			unk_0x85D9FC15836825C1(&cLocal_327, 8);
			func_67();
			iLocal_113 = 1;
		}
	}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_107(Param1, 0f, 0f, 0f, 0)) || unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(iParam0, 1), unk_0x3E4D3CCC220BDFB1(uVar1[iVar3], 1), 1) < 10f)
					{
	...
	if (func_23(Local_68.f_9))
	{
		...
		if (func_23(Local_69[0 /*20*/]))
		{
			...
			if (unk_0xAE06B9E39EBDE049(Local_73[0 /*9*/]))
			{
				...
				{
					unk_0xF8A652CE310FFC53(Local_73[0 /*9*/], Local_69[0 /*20*/], unk_0xE6B87C42793036AA(Local_69[0 /*20*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					unk_0x6A8F948698B360B4(Local_73[0 /*9*/], 0);
					unk_0xA785552633ED203B(Local_69[0 /*20*/], Local_68.f_9, -1, 2060, 3);
					unk_0x756D74A3EF0AB788(Local_69[0 /*20*/], "oddjobs@bailbond_mountain", "Idle_Camman", 8f, -8f, -1, 49, 0, 0, 0, 0);
					unk_0xD08E9EAF091A1AAB(Local_69[0 /*20*/], Local_68.f_9, -1);
				}
