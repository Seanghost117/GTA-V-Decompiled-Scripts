...
void __EntryFunction__()
{
	...
	if (unk_0xAE06B9E39EBDE049(uScriptParam_8))
	{
		unk_0x6A8F948698B360B4(uScriptParam_8, 1);
		Local_2 = { unk_0x7EC595B99EA7C4B1(uScriptParam_8, 0f, 0f, 0f) };
		uLocal_3 = unk_0xEF7858F25585F853(uScriptParam_8);
		unk_0x58ADF88C51AAFDC5(uScriptParam_8, 0, 0);
	}
	while (true)
	{
		SYSTEM::WAIT(0);
		if (unk_0xAE06B9E39EBDE049(uScriptParam_8))
		{
			if (unk_0xED07D558B3EDDF8A(uScriptParam_8))
			{
				switch (iLocal_0)
				{
					case 0:
					...
					case 2:
						...
						if (func_2())
						{
							unk_0x58ADF88C51AAFDC5(uScriptParam_8, 1, 0);
							iLocal_0 = 3;
						}
						break;
...
void func_3()
{
	if (!unk_0x5AEB5DDFFAD43CA5(uLocal_1))
	{
		...
		{
			unk_0x756D74A3EF0AB788(uLocal_1, sLocal_6, sLocal_4, 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
		}
		else if (unk_0xD8E0ED6453B9EACD(uLocal_1, sLocal_6, sLocal_4, 3))
		{
			unk_0x756D74A3EF0AB788(uLocal_1, sLocal_6, sLocal_4, 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
		}
		else if (!iLocal_7)
		{
			if (unk_0x9934470AA0A08B57(uLocal_1, sLocal_6, sLocal_4, 3))
			{
				unk_0xFC4EDD7B55A807F1(uLocal_1, sLocal_6, sLocal_4, unk_0x658086F2B3C5E4E4(0, 1065353216));
				iLocal_7 = 1;
			}
		}
	}
...
void func_4()
{
	if (unk_0xA59F96B50B97E63C(uLocal_1, 0))
	{
		uLocal_1 = unk_0xB3116B49FE00E2F1(5, iLocal_5, Local_2.x, Local_2.f_1, Local_2.f_2, uLocal_3, 1, 1);
