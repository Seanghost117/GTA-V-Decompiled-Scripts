...
void __EntryFunction__()
{
	...
	if (Var0 != 49 && Var0 != 50)
	{
		unk_0x555EE41D7C7078E6(Var1, Var0.f_15, 1, 0, 0, 0);
	}
	while (true)
	{
		SYSTEM::WAIT(0);
...
int func_253(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_127(uParam0->f_41[0]))
			{
				uLocal_54 = unk_0xF341A134A5B8D4F6(unk_0x3E4D3CCC220BDFB1(uParam0->f_41[0], 1), unk_0x090239DEAF625B17(uParam0->f_41[0], 2), 2);
				unk_0x1FEB07A1AF22700F(uParam0->f_41[0], uLocal_54, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				unk_0x81493F39713559B1(uLocal_54, 1);
				if (func_127(uParam0->f_28[0]))
				{
					unk_0xDFDB9C533700BC17(uParam0->f_28[0], uLocal_54, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_127(uParam0->f_41[1]))
				{
					unk_0x1FEB07A1AF22700F(uParam0->f_41[1], uLocal_54, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_127(uParam0->f_41[2]))
				{
					unk_0x1FEB07A1AF22700F(uParam0->f_41[2], uLocal_54, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_127(uParam0->f_28[0]) && func_127(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				uLocal_54 = unk_0xF341A134A5B8D4F6(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
				unk_0x81493F39713559B1(uLocal_54, 1);
				unk_0xDFDB9C533700BC17(uParam0->f_28[0], uLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
