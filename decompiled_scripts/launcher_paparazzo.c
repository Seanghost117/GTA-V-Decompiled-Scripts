...
void func_169(int iParam0, float fParam1)
{
	...
	{
		case 0:
			*fParam1 = func_170(-1604.668f, 5239.1f, 3.01f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 42);
			break;
		
		case 1:
			*fParam1 = func_170(-1592.84f, 5214.04f, 3.01f, 0);
		...
		case 2:
		case 3:
			*fParam1 = func_170(190.26f, -956.35f, 29.63f, 0);
		...
		case 4:
			*fParam1 = func_170(414f, -761f, 29f, 0);
		...
		case 9:
			*fParam1 = func_170(-1622.89f, 4204.87f, 83.3f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*fParam1 = func_170(1835.53f, 4705.86f, 38.1f, 0);
			}
			else if (iParam0 == 12)
			{
				*fParam1 = func_170(1826.13f, 4698.88f, 38.92f, 0);
			}
			else
			{
				*fParam1 = func_170(637.02f, 119.7093f, 89.5f, 0);
			}
		...
		case 19:
			if (iParam0 == 18)
			{
				*fParam1 = func_170(-954.19f, -2760.05f, 14.64f, 0);
			}
			else
			{
				*fParam1 = func_170(-63.8f, -809.5f, 321.8f, 0);
			}
		...
		case 23:
			if (iParam0 == 21)
			{
				*fParam1 = func_170(-1877.82f, -440.649f, 45.05f, 0);
			}
			else
			{
				*fParam1 = func_170(-915.6f, 6139.2f, 5.5f, 0);
			}
		...
		case 27:
			*fParam1 = func_170(-1104.93f, 291.25f, 64.3f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 44);
			break;
		...
		case 34:
			*fParam1 = func_170(-303.82f, 6211.29f, 31.05f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 386);
			HUD::SET_BLIP_COLOUR(*fParam1, 44);
			break;
		
		case 43:
			*fParam1 = func_170(-44.75f, -1288.67f, 28.21f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 149);
			HUD::SET_BLIP_COLOUR(*fParam1, 44);
			break;
		
		case 46:
			*fParam1 = func_170(-149.75f, 285.81f, 93.67f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*fParam1 = func_170(-70.71f, 301.43f, 106.79f, 0);
			}
			else
			{
				*fParam1 = func_170(-257.22f, 292.85f, 90.63f, 0);
			}
...
int func_170(struct<3> Param0, bool bParam1)
{
	...
	HUD::SET_BLIP_SCALE(iVar0, func_171(MISC::SET_BIT(), 1f, 1f));
...
void func_188(int iParam0, bool bParam1, struct<3> Param2)
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
...
float func_192(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_192(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_200(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
bool func_215(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_216(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_216(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_219(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_221(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_221(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_228(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_221(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
float func_239()
{
	return PATHFIND::SET_ROADS_IN_AREA(-74.8392f, 300.5241f, 104f, -62.467f, 318.6961f, 109f, false, true, 1, 1);
}
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!MISC::IS_BIT_SET(uParam0->f_41[0]))
			{
				...
				if (func_127(uParam0->f_28[0]) && MISC::IS_BIT_SET(uParam0->f_41[0]))
				{
			...
			if (!MISC::IS_BIT_SET(uParam0->f_41[1]))
			{
				...
				if (func_127(uParam0->f_28[1]) && MISC::IS_BIT_SET(uParam0->f_41[1]))
				{
...
void func_243(char* sParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_244(sParam0);
...
int func_253(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_127(uParam0->f_41[0]))
			{
				iLocal_54 = PED::CREATE_SYNCHRONIZED_SCENE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_41[0], 1), NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uParam0->f_41[0], 2), 2);
		...
		case 3:
			if (func_127(uParam0->f_28[0]))
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo1beckon"))
				{
					...
					TASK::TASK_PLAY_ANIM(false, sVar4, "pap_idle_01", 8f, -8f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(false, sVar4, "pap_idle_action_01", 8f, -8f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(false, sVar4, "pap_idle_02", 8f, -8f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(false, sVar4, "pap_idle_action_02", 8f, -8f, -1, 0, 0f, false, false, false);
...
void func_270(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 47:
				...
				PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_56, 0);
				func_272(iParam0, 0, 0, 0);
				break;
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			...
			while (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("paparazzo3")) > 0)
			{
				SYSTEM::WAIT(0);
			}
		}
