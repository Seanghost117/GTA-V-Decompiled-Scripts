...
void func_1(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if ((((((((((((func_55(uParam0) || func_51(uParam0)) || func_50(uParam0)) || !func_49(uParam0)) || func_47(PLAYER::PLAYER_ID())) || SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1)) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_PERFORMING_MELEE_ACTION(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) || unk_0xCE990E643CD9D0E5(Global_1678288.f_4, 2)) || func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
				...
				else
				{
					...
					else if (PAD::IS_DISABLED_CONTROL_PRESSED(0, 51))
					{
						func_43(&(uParam0->f_6));
						func_38(uParam0);
						func_59(uParam0, 3);
						...
						{
							unk_0xBE20AB8238688965(&(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_4), 15);
							func_36(157);
						}
					}
				}
		...
		case 4:
			...
			Var3 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			uVar4 = Var3.f_2;
			fVar5 = 0.05f;
			...
			HUD::_THEFEED_DISABLE(unk_0x9B0761B4C3EB8BC7(), Var2, 1f, 500, uVar4, fVar5);
			func_29(uParam0->f_9);
			func_59(uParam0, 5);
			break;
		...
		case 5:
			...
			func_35(uParam0, &sVar0);
			func_34(uParam0, &sVar1);
			iVar6 = TASK::GET_SCRIPT_TASK_STATUS(unk_0x9B0761B4C3EB8BC7(), 2106541073);
			Var7 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			fVar8 = Var7.f_2;
			if ((iVar6 != 1 && iVar6 != 0) || func_16(ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7()), fVar8, 5f))
			{
				if (uParam0->f_1.f_1 == 3)
				{
					if (CAM::_0xEE778F8C7E1142E2(0) == 4)
				...
				MONEY::NETWORK_MONEY_CAN_BET(0, false, true);
				uParam0->f_8 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_31(uParam0), func_30(uParam0), 2, 1, 0f, 1065353216, 0, 1.12f);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_8, &sVar0, &sVar1, 2f, -1000f, 9, 0, 1148846080, 0);
		...
		case 6:
			...
			func_17(uParam0);
			func_8(uParam0);
			fVar9 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_8);
			if (func_33(&(uParam0->f_7), 13))
			{
				MONEY::NETWORK_MONEY_CAN_BET(0, false, true);
			}
			if (PED::DETACH_SYNCHRONIZED_SCENE(fVar9))
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(fVar9) >= 1f)
				{
					if (uParam0->f_1.f_1 == 3)
					{
						if (func_33(&(uParam0->f_7), 13))
					...
					func_34(uParam0, &sVar1);
					uParam0->f_8 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_31(uParam0), func_30(uParam0), 2, 1, 0f, 1065353216, 0, 1.12f);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_8, &sVar0, &sVar1, 4f, -1.5f, 9, 0, 1148846080, 0);
					unk_0xB88AF19828BF16ED(uParam0->f_8);
					func_32(&(uParam0->f_7), 8);
		...
		case 7:
			SYSTEM::POW(uParam0->f_8);
			func_59(uParam0, 8);
			break;
		
		case 8:
			fVar10 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_8);
			iVar11 = TASK::GET_SCRIPT_TASK_STATUS(unk_0x9B0761B4C3EB8BC7(), 1785177548);
			if (iVar11 == 0 || iVar11 == 1)
			{
				if (PED::DETACH_SYNCHRONIZED_SCENE(fVar10))
				{
					if ((ENTITY::HAS_ANIM_EVENT_FIRED(fVar10) >= 0.7f || ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("BREAKOUT_FINISH"))) || ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("BREAK_OUT")))
					{
						SYSTEM::POW(uParam0->f_8);
						func_29(-1);
						func_42(uParam0);
...
void func_2(var uParam0, bool bParam1)
{
	...
	else if (uParam0->f_1.f_3 == 5)
	{
		iVar1 = uParam0->f_1.f_2;
		iVar2 = 3;
		bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, iVar2);
...
void func_8(var uParam0)
{
	...
	if (uParam0->f_13 == 6)
	{
		Var0 = { SYSTEM::TIMERA(0, 218), SYSTEM::TIMERA(0, 219), 0f };
		fVar1 = SYSTEM::VMAG(Var0);
		if ((uParam0->f_13 == 6 && !ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("BLOCK_INTERRUPT"))) && !func_33(&(uParam0->f_7), 12))
		{
		...
		if (ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("BLOCK_INTERRUPT")))
		{
			func_42(uParam0);
		}
		...
		else
		{
			...
			if (((((!HUD::DISABLE_FRONTEND_THIS_FRAME() && !func_33(&(uParam0->f_7), 0)) && !func_33(&(uParam0->f_7), 4)) && !func_11()) && !func_9(1)) && uParam0->f_1.f_3 != 3)
			{
				if (uParam0->f_6 == -1)
				{
...
void func_14(var uParam0)
{
	...
	uParam0->f_8 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_31(uParam0), func_30(uParam0), 2, 1, 0f, 1065353216, 0, 1.12f);
	func_35(uParam0, &sVar0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_8, &sVar0, "exit", 4f, -4f, 9, 0, 1148846080, 0);
	unk_0xB88AF19828BF16ED(uParam0->f_8);
	func_43(&(uParam0->f_6));
	func_59(uParam0, 8);
}
...
int func_16(bool bParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
void func_17(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 6:
			...
			func_21();
			if (MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(unk_0x9B0761B4C3EB8BC7(), &iVar0, 1) && iVar0 != joaat("weapon_unarmed"))
			{
...
bool func_39(var uParam0)
{
	...
	bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, func_6(uParam0->f_1.f_1));
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_4())
		{
...
int func_50(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((MISC::IS_BIT_SET(uVar0[iVar1]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && func_57(uVar0[iVar1], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar1++;
...
int func_56(int iParam0, struct<3> Param1, int iParam2)
{
	if (MISC::IS_BIT_SET(iParam0))
	{
		...
		{
			if (func_16(ENTITY::IS_ENTITY_IN_WATER(iParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_16(ENTITY::IS_ENTITY_IN_WATER(iParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
void func_61(var uParam0)
{
	...
	{
		CAM::_0x2AED6301F67007D5(unk_0x9B0761B4C3EB8BC7());
		PED::SET_PED_CAPSULE(unk_0x9B0761B4C3EB8BC7(), func_62());
...
void func_63(var uParam0)
{
	...
	func_64(&(uParam0->f_7), 1, PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0));
	func_64(&(uParam0->f_7), 3, SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1));
...
int func_66()
{
	...
	if (func_82(PLAYER::PLAYER_ID()) && PED::REMOVE_SCENARIO_BLOCKING_AREA())
	{
		return 1;
	}
	if (func_80() != 0)
...
int func_69()
{
	...
	if (func_70() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_70()) == 0)
		{
			return 1;
		}
	}
...
void func_89(var uParam0)
{
	...
	{
		func_29(-1);
		fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_8);
	...
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_4), 15);
}
	...
	else
	{
		...
		if (AUDIO::PLAY_STREAM_FROM_VEHICLE(iParam0) && (ENTITY::IS_ENTITY_AT_COORD(iParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				...
				if (!func_94(fVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(fVar27))
				{
					if (!bVar22)
					{
...
void func_103()
{
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(32, 0, func_114());
	func_112(0, -1, 0);
	func_111();
	func_104();
	if (MISC::SET_BIT())
