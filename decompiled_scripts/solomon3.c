...
void func_1()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (iLocal_412 == 0)
			{
				bLocal_289 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
				if (MISC::IS_BIT_SET(bLocal_289))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_289, false))
					{
						func_3(bLocal_289, -1);
	...
	if (iLocal_413[0] == 0)
	{
		if (MISC::IS_BIT_SET(uLocal_267[0]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_267[0]))
			{
				iLocal_233++;
				iLocal_413[0] = 1;
			}
	...
	if (iLocal_413[1] == 0)
	{
		if (MISC::IS_BIT_SET(uLocal_267[1]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_267[1]))
			{
				iLocal_233++;
				iLocal_413[1] = 1;
			}
	...
	if (iLocal_413[2] == 0)
	{
		if (MISC::IS_BIT_SET(uLocal_267[2]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_267[2]))
			{
				iLocal_233++;
				iLocal_413[2] = 1;
			}
	...
	if (iLocal_413[3] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[0]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[0]))
			{
				iLocal_233++;
				iLocal_413[3] = 1;
			}
	...
	if (iLocal_413[4] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[1]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[1]))
			{
				iLocal_233++;
				iLocal_413[4] = 1;
			}
	...
	if (iLocal_413[5] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[2]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[2]))
			{
				iLocal_233++;
				iLocal_413[5] = 1;
			}
	...
	if (iLocal_413[6] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[3]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[3]))
			{
				iLocal_233++;
				iLocal_413[6] = 1;
			}
	...
	if (iLocal_413[7] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[4]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[4]))
			{
				iLocal_233++;
				iLocal_413[7] = 1;
			}
	...
	if (iLocal_413[8] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[5]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[5]))
			{
				iLocal_233++;
				iLocal_413[8] = 1;
			}
	...
	if (iLocal_413[9] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[6]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[6]))
			{
				iLocal_233++;
				iLocal_413[9] = 1;
			}
	...
	if (iLocal_413[10] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[7]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[7]))
			{
				iLocal_233++;
				iLocal_413[10] = 1;
			}
	...
	if (iLocal_413[11] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[8]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[8]))
			{
				iLocal_233++;
				iLocal_413[11] = 1;
			}
	...
	if (iLocal_413[12] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[9]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[9]))
			{
				iLocal_233++;
				iLocal_413[12] = 1;
			}
	...
	if (iLocal_413[13] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_268[10]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[10]))
			{
				iLocal_233++;
				iLocal_413[13] = 1;
			}
	...
	if (iLocal_413[14] == 0)
	{
		if (MISC::IS_BIT_SET(bLocal_272))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_272))
			{
				iLocal_233++;
				iLocal_413[14] = 1;
			}
	...
	if (iLocal_413[15] == 0)
	{
		if (MISC::IS_BIT_SET(bLocal_273))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_273))
			{
				iLocal_233++;
				iLocal_413[15] = 1;
			}
	...
	if (iLocal_413[16] == 0)
	{
		if (MISC::IS_BIT_SET(bLocal_274))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_274))
			{
				iLocal_233++;
				iLocal_413[16] = 1;
			}
	...
	if (iLocal_413[17] == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_275[0]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_275[0]))
			{
				iLocal_233++;
				iLocal_413[17] = 1;
			}
...
void func_5()
{
	...
	{
		if (MISC::IS_BIT_SET(bLocal_285))
		{
			VEHICLE::SET_VEHICLE_DOOR_OPEN(bLocal_285, 0, false, true);
		}
	}
	if (iLocal_223 > 0)
	{
	...
	if (iLocal_223 == 0)
	{
		...
		if (SYSTEM::VMAG(bLocal_297))
		{
			unk_0x93370FA10F15BE44(&bLocal_297);
		}
		...
		if (MISC::IS_BIT_SET(bLocal_279))
		{
			STREAMING::REMOVE_ANIM_DICT(&bLocal_279);
		}
		SYSTEM::SETTIMERA(0);
		if (PED::REMOVE_SCENARIO_BLOCKING_AREA())
		{
		...
		if (MISC::IS_BIT_SET(bLocal_266))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_266))
			{
				PED::SET_PED_CAN_BE_TARGETTED(bLocal_266, true);
				PED::_0x2208438012482A1A(bLocal_266, 0);
			}
		}
		...
		fLocal_263 = PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(-948.4f, -2992.6f, 13.3f, 6f, 5f, 4f, 60f, 0, 7);
		if (MISC::IS_BIT_SET(bLocal_284))
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_284, false))
			{
				VEHICLE::SET_VEHICLE_ACTIVE_FOR_PED_NAVIGATION(bLocal_284, false);
			}
		}
		if (MISC::IS_BIT_SET(bLocal_285))
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_285, false))
			{
				VEHICLE::SET_VEHICLE_ACTIVE_FOR_PED_NAVIGATION(bLocal_285, false);
			}
		}
		PLAYER::SET_MAX_WANTED_LEVEL(5);
		PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_ID(), 3, false);
	...
	if (iLocal_223 == 1)
	{
		if (iLocal_418 == 0)
		{
			if (!MISC::IS_BIT_SET(iLocal_293[0]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(joaat("oracle2")))
				{
		...
		if (iLocal_419 == 0)
		{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(joaat("baller2")))
				{
		...
		if (MISC::IS_BIT_SET(iLocal_293[0]))
		{
			if (ENTITY::GET_ENTITY_COORDS(iLocal_293[0], false))
			{
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_293[0], 0))
				{
			...
			if (func_16(unk_0x9B0761B4C3EB8BC7(), iLocal_293[0], 1) > 200f || unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_293[0], 0))
			{
				STREAMING::REMOVE_ANIM_DICT(&(iLocal_293[0]));
			}
		}
		if (MISC::IS_BIT_SET(iLocal_293[1]))
		{
			if (ENTITY::GET_ENTITY_COORDS(iLocal_293[1], false))
			{
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_293[1], 0))
				{
					if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_LOSE_COPS_VEHICLE"))
					{
						AUDIO::START_AUDIO_SCENE("SOL_3_LOSE_COPS_VEHICLE");
			...
			if (func_16(unk_0x9B0761B4C3EB8BC7(), iLocal_293[1], 1) > 200f || unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_293[1], 0))
			{
				STREAMING::REMOVE_ANIM_DICT(&(iLocal_293[1]));
			}
		}
		if (iLocal_398 == 0)
		{
		...
		if (iLocal_367 == 0)
		{
			...
			{
				if (ENTITY::GET_ENTITY_COORDS(iLocal_286[0], false))
				{
				...
				if (ENTITY::GET_ENTITY_COORDS(iLocal_286[1], false))
				{
		...
		else
		{
			if (ENTITY::GET_ENTITY_COORDS(iLocal_286[0], false))
			{
				...
				else if (iLocal_368 == 0)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[6]))
					{
						PED::_0x2208438012482A1A(iLocal_268[6], 0);
					}
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[7]))
					{
						PED::_0x2208438012482A1A(iLocal_268[7], 0);
					}
					iLocal_368 = 1;
				}
			}
			if (ENTITY::GET_ENTITY_COORDS(iLocal_286[1], false))
			{
				...
				else if (iLocal_369 == 0)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[8]))
					{
						PED::_0x2208438012482A1A(iLocal_268[8], 0);
					}
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[9]))
					{
						PED::_0x2208438012482A1A(iLocal_268[9], 0);
					}
					iLocal_369 = 1;
				}
			}
		...
		if (iLocal_423 == 0)
		{
			if (MISC::IS_BIT_SET(bLocal_285))
			{
				if (ENTITY::GET_ENTITY_COORDS(bLocal_285, false))
				{
					if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_285, 0))
					{
						...
						STREAMING::REMOVE_ANIM_DICT(&bLocal_285);
						iLocal_423 = 1;
					}
					else if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_285, 1) > 200f)
					{
						STREAMING::REMOVE_ANIM_DICT(&bLocal_285);
					}
				}
...
void func_12()
{
	...
	while (iLocal_231 <= 9)
	{
		if (MISC::IS_BIT_SET(iLocal_268[iLocal_231]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[iLocal_231]))
			{
				if (!SYSTEM::VDIST(iLocal_268[iLocal_231], 0))
				{
					if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						if (func_13(unk_0x9B0761B4C3EB8BC7(), iLocal_268[iLocal_231]) > 200f)
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_268[iLocal_231]);
						...
						else if (func_13(unk_0x9B0761B4C3EB8BC7(), iLocal_268[iLocal_231]) > 20f)
						{
							...
							{
								TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_268[iLocal_231], unk_0x9B0761B4C3EB8BC7(), unk_0x9B0761B4C3EB8BC7(), 2f, true, 15f, 20f, false, false, -687903391);
							}
						}
						...
						{
							TASK::TASK_COMBAT_PED(iLocal_268[iLocal_231], unk_0x9B0761B4C3EB8BC7(), 0, 16);
	...
	if (iLocal_367 == 1)
	{
		if (iLocal_344 == 0)
		{
			if (MISC::IS_BIT_SET(iLocal_286[0]))
			{
				if (ENTITY::GET_ENTITY_COORDS(iLocal_286[0], false))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_286[0]))
					...
					else
					{
						if (MISC::IS_BIT_SET(iLocal_268[6]))
						{
							...
							{
								PED::_0x2208438012482A1A(iLocal_268[6], 0);
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_268[6]);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_304);
								TASK::TASK_LEAVE_VEHICLE(false, iLocal_286[0], 256);
								TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_304);
								AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_268[6], iLocal_304);
						...
						if (MISC::IS_BIT_SET(iLocal_268[7]))
						{
							...
							{
								PED::_0x2208438012482A1A(iLocal_268[7], 0);
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_268[7]);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_304);
								TASK::TASK_LEAVE_VEHICLE(false, iLocal_286[0], 256);
								TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_304);
								AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_268[7], iLocal_304);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_304);
							}
						}
						iLocal_344 = 1;
			...
			if (MISC::IS_BIT_SET(iLocal_286[0]))
			{
				if (ENTITY::GET_ENTITY_COORDS(iLocal_286[0], false))
				{
					if (MISC::IS_BIT_SET(iLocal_268[6]))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[6]))
						{
							if (!unk_0xE0B3BC41DDA88DF0(iLocal_268[6], iLocal_286[0], 0))
							{
		...
		if (iLocal_345 == 0)
		{
			if (MISC::IS_BIT_SET(iLocal_286[1]))
			{
				if (ENTITY::GET_ENTITY_COORDS(iLocal_286[1], false))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_286[1]))
					...
					else
					{
						if (MISC::IS_BIT_SET(iLocal_268[8]))
						{
							...
							{
								PED::_0x2208438012482A1A(iLocal_268[8], 0);
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_268[8]);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_304);
								TASK::TASK_LEAVE_VEHICLE(false, iLocal_286[1], 256);
								TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_304);
								AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_268[8], iLocal_304);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_304);
							}
						}
						if (MISC::IS_BIT_SET(iLocal_268[9]))
						{
							...
							{
								PED::_0x2208438012482A1A(iLocal_268[9], 0);
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_268[9]);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_304);
								TASK::TASK_LEAVE_VEHICLE(false, iLocal_286[1], 256);
								TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_304);
								AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_268[9], iLocal_304);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_304);
							}
						}
						iLocal_345 = 1;
			...
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[10]))
			{
				...
				else if (STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3"))
				{
					if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -923.2303f, -2948.004f, 12.9451f, 2f, 2f, 2f, 0, 1, 0))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[10]))
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_268[10]);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_304);
							TASK::TASK_PLAY_ANIM(false, "misssolomon_3", "plyr_roll_left", 8f, -8f, -1, 0, 0f, false, false, false);
							TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_304);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_268[10], iLocal_304);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_304);
							iLocal_346 = 1;
						}
					}
...
{
	if (unk_0xCE990E643CD9D0E5(Global_31126, bParam0))
	{
		if (!bParam1)
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_31126, bParam0);
			StringCopy(&(Global_31127[bParam0 /*6*/]), "NULL", 24);
			Global_31182[bParam0] = bParam1;
		}
	}
}
...
void func_25(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (iParam3 == 1)
	{
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS("FinaleC2", TASK::IS_PED_BEING_ARRESTED()))
		{
		}
	}
	iVar0 = 0;
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_117(TASK::IS_PED_BEING_ARRESTED(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_110(TASK::IS_PED_BEING_ARRESTED(), 1);
			if (iVar4 != -1)
			{
				Global_111858.f_18570[iVar4 /*6*/].f_4 = 0;
				MemCopy(&uVar5, {func_109(iVar4)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar5, 0, Global_98992, iParam0);
			}
			else
			{
...
{
	func_27(&Global_105407, TASK::IS_PED_BEING_ARRESTED(), iParam0, uParam1, iParam3, bParam2);
}
...
void func_27(var uParam0, bool bParam1, var uParam2, var uParam3, int iParam4, bool bParam5)
{
	...
	*uParam0 = func_107();
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(unk_0x9B0761B4C3EB8BC7(), &(uParam0->f_2), 1);
...
void func_29(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (bParam2 == 0)
	{
		bParam2 = unk_0x9B0761B4C3EB8BC7();
	}
	if (MISC::IS_BIT_SET(bParam2))
	{
	...
	else if (MISC::IS_BIT_SET(bVar0))
	{
		...
		{
			if (VEHICLE::IS_VEHICLE_MODEL(bVar0, joaat("skylift")) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bVar0, 0))
			{
				func_30(uParam0, uParam1, bVar0, iParam4);
			}
		}
...
{
	if (ENTITY::GET_ENTITY_COORDS(bParam2, false))
	{
...
int func_31(bool bParam0)
{
	...
	while (iVar0 <= 6)
	{
		if (Global_98955.f_22[iVar0] == bParam0)
		{
			return 1;
		}
		iVar0++;
...
void func_32(var uParam0, bool bParam1, int iParam2)
{
	...
	if (iParam2 == 1)
	{
		*uParam0 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam1, 1) };
		uParam0->f_6 = ENTITY::IS_ENTITY_IN_WATER(bParam1);
		uParam0->f_3 = { ENTITY::GET_ENTITY_VELOCITY(bParam1) };
		if (unk_0x1037B9D45CE6B788(bParam1, -1154.326f, -1523.871f, 3.262189f, -1158.453f, -1517.75f, 6.374244f, 13f, 0, 1, 0))
		{
			*uParam0 = { -1160.095f, -1515.407f, 3.1496f };
			uParam0->f_6 = 305.6424f;
		}
		if (Global_76559 == bParam1)
		{
			uParam0->f_9 = 1;
		}
	}
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == bParam0)
			{
				...
				{
					if (iParam2 == 0 || MISC::GET_MODEL_DIMENSIONS(bParam0) == func_36(iParam1, iParam2))
					{
						return 1;
					}
				}
...
int func_44(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (MISC::IS_BIT_SET(bParam0))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
		{
			...
			{
				*uParam1 = ENTITY::GET_ENTITY_MODEL(bParam0, 1);
			}
			if (MISC::IS_BIT_SET(*uParam1))
			{
				if (ENTITY::GET_ENTITY_COORDS(*uParam1, false))
				{
					if (iParam2 == 0 || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*uParam1, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 1) < 100f)
					{
						if (VEHICLE::IS_VEHICLE_MODEL(*uParam1, joaat("taxi")))
						{
							if (MISC::IS_MINIGAME_IN_PROGRESS(*uParam1, -1, 0) != bParam0 && MISC::IS_MINIGAME_IN_PROGRESS(*uParam1, -1, 0) != 0)
							{
								return 0;
							}
						}
						if (func_45(*uParam1, func_107(), 1))
						{
							...
							if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bVar0, "save_anywhere"))
							{
								return 0;
							}
							else if (!SYSTEM::VDIST(bParam0, 1))
							{
								return 0;
							}
						}
...
void func_50(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		...
		else if (MISC::SET_BIT() && MISC::GET_MODEL_DIMENSIONS(bParam0) == MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
		...
		if (MISC::SET_BIT() && bParam0 == unk_0x9B0761B4C3EB8BC7())
		{
			if (func_54(161, iParam3))
			{
				uParam1->f_59 = func_51(2052, iParam3, 0);
...
void func_55(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	if (iParam1 == 0)
	{
		if ((iParam4 & 1 != 0 || iParam4 & 2 != 0) || iParam4 & 8 != 0)
		{
			if (bParam0 != 0)
			{
				if (AUDIO::GET_IS_PRELOADED_CONVERSATION_READY(bParam0) && PED::_0x451294E859ECC018(bParam0) != -1)
				{
...
void func_58()
{
	...
	if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_48(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_60(bool bParam0, bool bParam1)
{
	...
	iVar0 = func_47(bParam0);
	if (func_38(iVar0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		if (bParam0 == unk_0x9B0761B4C3EB8BC7())
		{
			...
			if (iVar0 == 0)
			{
				NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(joaat("SP0_PARACHUTE_CURRENT_TINT"), uVar3, 1);
			}
			else if (iVar0 == 1)
			{
				NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(joaat("SP1_PARACHUTE_CURRENT_TINT"), uVar3, 1);
			}
			else if (iVar0 == 2)
			{
				NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(joaat("SP2_PARACHUTE_CURRENT_TINT"), uVar3, 1);
			}
		}
	}
}
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				...
				{
					Var4.f_1 = STATS::STAT_GET_BOOL(bParam0, Var4);
				...
				if (!unk_0x14AC70FD8926649E(Var7))
				{
					...
					while (iVar1 < FILES::_GET_NUM_DLC_WEAPON_COMPONENTS_SP(iVar5))
					{
						if (FILES::_GET_DLC_WEAPON_COMPONENT_DATA_SP(iVar5, iVar1, &Var8))
						{
							if (!func_62(Var8.f_3))
							{
								if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(bParam0, Var4, Var8.f_3))
								{
...
void func_68(var uParam0, int iParam1)
{
	...
	*uParam0 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
	uParam0->f_3 = ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7());
	uParam0->f_5 = PED::GET_PED_PARACHUTE_STATE(unk_0x9B0761B4C3EB8BC7());
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		uParam0->f_4 = AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID());
	}
	...
	else if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("finale_choice")) > 0)
	{
	...
	else if (MONEY::NETWORK_SPENT_REQUEST_HEIST(unk_0x9B0761B4C3EB8BC7()) == unk_0xC519B5898C2310B1(1272.659f, -1715.467f, 53.7715f, "v_lesters"))
	{
...
int func_72(var uParam0)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_95())
		{
			*uParam0 = func_78(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_74(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (MISC::SET_BIT())
	{
		if (func_76() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_51(func_75(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
int func_78(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam1 == 6 || iParam1 == func_94(iVar0))
		{
			...
			{
				fVar1 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Param0, func_79(iVar0, 0), 1);
...
var func_96()
{
	...
	func_97(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
int func_110(bool bParam0, int iParam1)
{
	...
	while (iVar3 < 63)
	{
		...
		if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(bVar1) == fVar2)
		{
			return iVar0;
		}
		iVar3++;
...
int func_118(void fParam0, bool bParam1)
{
	int iVar0;
...
void func_121()
{
	switch (iLocal_222)
	{
		case 2:
			...
			ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 93.7701f);
			break;
		
		case 3:
			if (ENTITY::GET_ENTITY_COORDS(bLocal_279, false))
			{
				if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_279, 0))
				{
					PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), bLocal_279, -1);
				}
				CAM::IS_AIM_CAM_ACTIVE(bLocal_279, 3000, 0);
				ENTITY::SET_ENTITY_PROOFS(bLocal_279, false, true, false, false, false, false, false, false);
			}
			break;
		...
		case 5:
			...
			ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 178.466f);
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(unk_0x9B0761B4C3EB8BC7(), true, 1);
			break;
		
		case 8:
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(unk_0x9B0761B4C3EB8BC7());
			unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), -937.5466f, -2968.713f, 12.9451f, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 111.5016f);
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(unk_0x9B0761B4C3EB8BC7(), true, 1);
			break;
	}
}
...
void func_122()
{
	switch (iLocal_222)
	{
		case 2:
			...
			while ((!ENTITY::DOES_ENTITY_EXIST(joaat("rapidgt")) || !ENTITY::DOES_ENTITY_EXIST(joaat("surano"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("carbonizzare")))
			{
				SYSTEM::WAIT(0);
			}
			if (!MISC::IS_BIT_SET(bLocal_279))
			{
				...
				bLocal_279 = VEHICLE::CREATE_VEHICLE(joaat("rapidgt"), Local_306, fLocal_319, true, true, false);
				VEHICLE::SET_VEHICLE_COLOURS(bLocal_279, 112, 112);
				CAM::IS_AIM_CAM_ACTIVE(bLocal_279, 3000, 0);
				VEHICLE::SET_VEHICLE_STRONG(bLocal_279, true);
				unk_0x74528AC0906CBABE(joaat("rapidgt"));
				VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("rapidgt"), true);
				ENTITY::_SET_ENTITY_SOMETHING(bLocal_279, true);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(bLocal_279, true);
			}
			if (!MISC::IS_BIT_SET(iLocal_290))
			{
				if (ENTITY::DOES_ENTITY_EXIST(joaat("surano")))
				{
					MISC::CLEAR_AREA(-1037.398f, -491.6539f, 35.5545f, 5f, true, false, false, false);
					bLocal_290 = VEHICLE::CREATE_VEHICLE(joaat("surano"), -1037.398f, -491.6539f, 35.5545f, 208.889f, true, true, false);
					VEHICLE::SET_VEHICLE_COLOURS(bLocal_290, 0, 0);
					CAM::IS_AIM_CAM_ACTIVE(bLocal_290, 3000, 0);
					VEHICLE::SET_VEHICLE_STRONG(bLocal_290, true);
					unk_0x74528AC0906CBABE(joaat("surano"));
					VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("surano"), true);
					VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(bLocal_290, true);
				}
			}
			if (!MISC::IS_BIT_SET(iLocal_291))
			{
				if (ENTITY::DOES_ENTITY_EXIST(joaat("carbonizzare")))
				{
					MISC::CLEAR_AREA(Local_306, 5f, true, false, false, false);
					bLocal_291 = VEHICLE::CREATE_VEHICLE(joaat("carbonizzare"), -1033.938f, -489.7475f, 35.8323f, 207.1758f, true, true, false);
					VEHICLE::SET_VEHICLE_COLOURS(bLocal_291, 89, 89);
					CAM::IS_AIM_CAM_ACTIVE(bLocal_291, 3000, 0);
					VEHICLE::SET_VEHICLE_STRONG(bLocal_291, true);
					unk_0x74528AC0906CBABE(joaat("carbonizzare"));
					VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("carbonizzare"), true);
					VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(bLocal_291, true);
				}
			}
			break;
		...
		case 3:
			...
			if (!MISC::IS_BIT_SET(bLocal_278))
			{
				bLocal_278 = VEHICLE::CREATE_VEHICLE(joaat("cogcabrio"), Local_307, fLocal_320, true, true, false);
				ENTITY::SET_ENTITY_PROOFS(bLocal_278, true, true, true, true, true, false, false, false);
				VEHICLE::SET_VEHICLE_COLOURS(bLocal_278, 27, 27);
				unk_0x74528AC0906CBABE(joaat("cogcabrio"));
				AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(bLocal_278, "SOL_3_MOLLY_CAR_Group", 0f);
			}
			if (!MISC::IS_BIT_SET(bLocal_264))
			{
				bLocal_264 = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_278, 26, joaat("ig_molly"), -1, true, true);
				ENTITY::SET_ENTITY_PROOFS(bLocal_264, true, true, true, true, true, false, false, false);
				ENTITY::SET_ENTITY_INVINCIBLE(bLocal_264, true);
				PED::SET_PED_CAN_BE_TARGETTED(bLocal_264, false);
				unk_0x74528AC0906CBABE(joaat("ig_molly"));
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_264, 1862763509);
			}
			if (func_23())
			{
				if (!MISC::IS_BIT_SET(bLocal_279))
				{
					if (func_184())
					{
						...
						{
							bLocal_279 = func_143(Local_316, fLocal_323);
							unk_0x74528AC0906CBABE(func_183());
							VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(bLocal_279, true);
						}
						else
						{
							bLocal_279 = VEHICLE::CREATE_VEHICLE(joaat("rapidgt"), Local_316, fLocal_323, true, true, false);
							VEHICLE::SET_VEHICLE_COLOURS(bLocal_279, 112, 112);
						}
					}
					else
			...
			else if (!MISC::IS_BIT_SET(bLocal_279))
			{
				bLocal_279 = VEHICLE::CREATE_VEHICLE(joaat("rapidgt"), Local_316, fLocal_323, true, true, false);
				VEHICLE::SET_VEHICLE_COLOURS(bLocal_279, 112, 112);
				unk_0x74528AC0906CBABE(joaat("rapidgt"));
		...
		case 5:
			...
			STREAMING::REQUEST_ANIM_DICT("misssolomon_3");
			while (((((((((((((((!ENTITY::DOES_ENTITY_EXIST(joaat("jet")) || !ENTITY::DOES_ENTITY_EXIST(joaat("shamal"))) || !TASK::GET_IS_WAYPOINT_RECORDING_LOADED("BB_MOLLY_2")) || !ENTITY::DOES_ENTITY_EXIST(joaat("s_m_y_airworker"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("s_m_y_cop_01"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("police3"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("ig_molly"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("cogcabrio"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("rapidgt"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("prop_cs_film_reel_01"))) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(68, "BB_Chase")) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(69, "BB_Chase")) || !TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Trev4_5")) || !STREAMING::HAS_PTFX_ASSET_LOADED()) || !STREAMING::HAS_ANIM_DICT_LOADED("move_f@film_reel_arms")) || !STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3"))
			{
				SYSTEM::WAIT(0);
			}
			if (!MISC::IS_BIT_SET(bLocal_264))
			{
				bLocal_264 = PED::CREATE_PED(26, joaat("ig_molly"), -920.5093f, -2943.93f, 12.9451f, 157.6203f, true, true);
				ENTITY::SET_ENTITY_INVINCIBLE(bLocal_264, true);
				PED::SET_PED_CAN_BE_TARGETTED(bLocal_264, false);
				PED::_0x2208438012482A1A(bLocal_264, 1);
				unk_0x74528AC0906CBABE(joaat("ig_molly"));
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_264, true, 1);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_264, 1862763509);
			}
			bLocal_295 = OBJECT::CREATE_OBJECT(joaat("prop_cs_film_reel_01"), -929f, -2917f, 13f, true, true, false);
			OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_295, bLocal_264, ENTITY::ATTACH_ENTITY_TO_ENTITY(bLocal_264, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			if (!MISC::IS_BIT_SET(bLocal_284))
			{
				bLocal_284 = VEHICLE::CREATE_VEHICLE(joaat("jet"), -952.1345f, -2990.269f, 12.9451f, 240.7726f, true, true, false);
				VEHICLE::SET_VEHICLE_LIVERY(bLocal_284, 2);
				VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(bLocal_284, false);
				ENTITY::SET_ENTITY_COORDS(bLocal_284, 1);
				ENTITY::SET_ENTITY_PROOFS(bLocal_284, true, true, true, true, true, false, false, false);
				unk_0x74528AC0906CBABE(joaat("jet"));
				ENTITY::SET_ENTITY_LOD_DIST(bLocal_284, 500);
			}
			if (func_23())
			{
				if (func_184())
				...
				if (!MISC::IS_BIT_SET(bLocal_279))
				{
					if (func_184())
					{
						bLocal_279 = func_143(-918.6263f, -2926.631f, 12.9666f, 43.1705f);
						ENTITY::_SET_ENTITY_SOMETHING(bLocal_279, true);
						unk_0x74528AC0906CBABE(func_183());
						VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(bLocal_279, true);
					}
					...
					{
						bLocal_279 = VEHICLE::CREATE_VEHICLE(joaat("rapidgt"), -918.6263f, -2926.631f, 12.9666f, 43.1705f, true, true, false);
						VEHICLE::SET_VEHICLE_COLOURS(bLocal_279, 112, 112);
						ENTITY::_SET_ENTITY_SOMETHING(bLocal_279, true);
						unk_0x74528AC0906CBABE(joaat("rapidgt"));
						VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(bLocal_279, true);
			...
			if (!MISC::IS_BIT_SET(bLocal_278))
			{
				bLocal_278 = VEHICLE::CREATE_VEHICLE(joaat("cogcabrio"), -928.3279f, -2916.16f, 12.945f, 61.7688f, true, true, false);
				VEHICLE::SET_VEHICLE_COLOURS(bLocal_278, 27, 27);
				unk_0x74528AC0906CBABE(joaat("cogcabrio"));
			}
			if (!MISC::IS_BIT_SET(iLocal_281))
			{
				bLocal_281 = VEHICLE::CREATE_VEHICLE(joaat("police3"), -924.2796f, -2914.371f, 12.945f, 86.6188f, true, true, false);
			}
			if (!MISC::IS_BIT_SET(bLocal_272))
			{
				bLocal_272 = PED::CREATE_PED(6, joaat("s_m_y_cop_01"), -922.942f, -2912.509f, 12.945f, 156.2652f, true, true);
				unk_0x92BD213E6A0E666B(bLocal_272, joaat("weapon_pistol"), 1000, 1, 1);
		...
		case 8:
			...
			VEHICLE::REQUEST_VEHICLE_RECORDING(69, "BB_Chase");
			STREAMING::REQUEST_PTFX_ASSET();
			while ((((((((((!ENTITY::DOES_ENTITY_EXIST(joaat("jet")) || !ENTITY::DOES_ENTITY_EXIST(joaat("s_m_y_airworker"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("shamal"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("s_m_y_cop_01"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("police3"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("cogcabrio"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("rapidgt"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("prop_jet_bloodsplat_01"))) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(68, "BB_Chase")) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(69, "BB_Chase")) || !STREAMING::HAS_PTFX_ASSET_LOADED())
			{
				SYSTEM::WAIT(0);
			}
			func_125();
			...
			if (!MISC::IS_BIT_SET(bLocal_294))
			{
				bLocal_294 = OBJECT::CREATE_OBJECT(joaat("prop_jet_bloodsplat_01"), -946.4231f, -2979.826f, 12.9264f, true, true, false);
				ENTITY::DETACH_ENTITY(bLocal_294, 0f, 0f, -121.5948f, 2, 1);
				ENTITY::SET_ENTITY_QUATERNION(bLocal_294, 0f, 0f, 0.8729f, -0.4879f);
			...
			if (!MISC::IS_BIT_SET(bLocal_284))
			{
				...
				ENTITY::SET_ENTITY_PROOFS(bLocal_284, true, true, true, true, true, false, false, false);
				unk_0x74528AC0906CBABE(joaat("jet"));
				iLocal_672 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_damage", bLocal_284, -11.956f, 10.528f, -7.657f, 0f, 2f, 0f, 1f, false, false, false);
				ENTITY::SET_ENTITY_LOD_DIST(bLocal_284, 500);
			}
			if (!MISC::IS_BIT_SET(bLocal_266))
			{
				bLocal_266 = PED::CREATE_PED(26, joaat("s_m_y_airworker"), -933.8942f, -2965.785f, 12.9451f, 331.7339f, true, true);
				func_17(&uLocal_490, 4, bLocal_266, "HangerWorker", 0, 1);
				unk_0x74528AC0906CBABE(joaat("s_m_y_airworker"));
				PED::SET_PED_CAN_BE_TARGETTED(bLocal_266, true);
				PED::_0x2208438012482A1A(bLocal_266, 1);
				TASK::TASK_SMART_FLEE_PED(bLocal_266, unk_0x9B0761B4C3EB8BC7(), 150f, -1, false, false);
				PED::SET_PED_KEEP_TASK(bLocal_266, true);
				ENTITY::SET_ENTITY_PROOFS(bLocal_266, false, false, false, false, false, false, false, false);
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_266);
			}
...
void func_123(int iParam0)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		iVar0 = WEAPON::GET_BEST_PED_WEAPON(unk_0x9B0761B4C3EB8BC7(), false);
		if (iVar0 != joaat("weapon_unarmed"))
		{
			ENTITY::SET_ENTITY_HEALTH(unk_0x9B0761B4C3EB8BC7(), iVar0, iParam0);
		}
	}
}
...
void func_125()
{
	if (iLocal_337 == 0)
	{
		...
		if (!MISC::IS_BIT_SET(iLocal_268[10]))
		{
			...
			unk_0x92BD213E6A0E666B(iLocal_268[10], joaat("weapon_pistol"), 1000, 1, 1);
			PED::SET_PED_ACCURACY(iLocal_268[10], 20);
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_268[10], true, 1);
			PED::_0x2208438012482A1A(iLocal_268[10], 1);
...
void func_126(int iParam0, int iParam1)
{
	...
	StringCopy(&(Global_31127[iParam0 /*6*/]), TASK::IS_PED_BEING_ARRESTED(), 24);
...
int func_132(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
bool func_143(struct<3> Param0, float fParam1)
{
	return func_144(&(Global_105407.f_2890), Param0, fParam1, 0);
}

bool func_144(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	bool bVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_130(uParam0))
	{
		...
		if (func_129(uParam0))
		{
			...
			if (MISC::IS_BIT_SET(bVar0))
			{
				...
				else if ((!func_161(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS(TASK::IS_PED_BEING_ARRESTED(), "startup_positioning"))
				{
					iVar4 = func_160(bVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
void func_145(bool bParam0, int iParam1)
{
	...
	func_39(bParam0, &(Global_111858.f_32745.f_5510));
}

int func_146(bool bParam0)
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_45(bParam0, 0, 0)) || func_45(bParam0, 1, 0)) || func_45(bParam0, 2, 0)) || func_34(bParam0) != 145) || func_151(bParam0)) || func_150(bParam0)) || func_149(bParam0)) || func_148(bParam0)) || !func_147(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_150(bParam0))
		{
		}
...
int func_147(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_132(fParam0, 0))
	{
		return 0;
	}
...
int func_161(bool bParam0, struct<3> Param1, bool bParam2)
{
	void fVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_162(bParam0, Global_75654.f_139[38], 0))
			{
				func_155(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_162(bParam0, Global_75654.f_139[43], 1))
			{
				func_155(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_162(bParam0, uVar1[iVar3], 1) && func_131(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_71(Param1, 0f, 0f, 0f, 0)) || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_164(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || MISC::GET_MODEL_DIMENSIONS(Global_96286[iVar0]) == func_36(iParam0, iParam1))
				{
...
void func_165(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		if (((unk_0xCE990E643CD9D0E5(uParam1->f_77, 15) || func_173(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_172())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
int func_166(bool bParam0, var uParam1, var uParam2)
{
	...
	if (func_170(MISC::GET_MODEL_DIMENSIONS(*bParam0), 1) && unk_0x7F8B14CBFB9813E5(*bParam0, 24) != func_169(*bParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*bParam0, 24, func_169(*bParam0, ((*uParam1)[38] - 1)), false);
	}
	func_168(bParam0);
	if (func_167(*bParam0))
	{
...
int func_170(void fParam0, int iParam1)
{
	switch (fParam0)
	{
		case joaat("faction2"):
...
void func_185()
{
	...
	while (((((((!ENTITY::DOES_ENTITY_EXIST(joaat("jet")) || !ENTITY::DOES_ENTITY_EXIST(joaat("police3"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("maverick"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("bison"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("blista"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("ig_molly"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("cogcabrio"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("rapidgt")))
	{
		SYSTEM::WAIT(0);
	}
...
void func_188()
{
	...
	if (OBJECT::DOOR_SYSTEM_SET_HOLD_OPEN(iLocal_262))
	{
		OBJECT::REMOVE_DOOR_FROM_SYSTEM(iLocal_262);
	}
	if (PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(fLocal_263))
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(fLocal_263);
	}
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), -1019.579f, -484.872f, 36.0795f, 1, 0, 0, 1);
	...
	if (MISC::IS_BIT_SET(bLocal_279))
	{
		if (ENTITY::GET_ENTITY_COORDS(bLocal_279, false))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_279))
			{
				VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(bLocal_279);
			}
		}
	}
	if (MISC::IS_BIT_SET(bLocal_278))
	{
		if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
		{
			AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(bLocal_278, 0f);
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
			{
				VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(bLocal_278);
			}
		}
	}
	...
	if (MISC::IS_BIT_SET(bLocal_264))
	{
		PED::DELETE_PED(&bLocal_264);
	}
	if (MISC::IS_BIT_SET(bLocal_266))
	{
		PED::DELETE_PED(&bLocal_266);
	}
	if (MISC::IS_BIT_SET(bLocal_269))
	{
		PED::DELETE_PED(&bLocal_269);
	}
	if (MISC::IS_BIT_SET(bLocal_270))
	{
		PED::DELETE_PED(&bLocal_270);
	}
	if (MISC::IS_BIT_SET(bLocal_271))
	{
		PED::DELETE_PED(&bLocal_271);
	}
	if (MISC::IS_BIT_SET(bLocal_272))
	{
		PED::DELETE_PED(&bLocal_272);
	}
	if (MISC::IS_BIT_SET(bLocal_273))
	{
		PED::DELETE_PED(&bLocal_273);
	}
	if (MISC::IS_BIT_SET(bLocal_274))
	{
		PED::DELETE_PED(&bLocal_274);
	}
	if (MISC::IS_BIT_SET(iLocal_265[0]))
	{
		PED::DELETE_PED(&(iLocal_265[0]));
	}
	if (MISC::IS_BIT_SET(iLocal_265[1]))
	{
		PED::DELETE_PED(&(iLocal_265[1]));
	}
	if (MISC::IS_BIT_SET(iLocal_265[2]))
	{
		PED::DELETE_PED(&(iLocal_265[2]));
	}
	if (MISC::IS_BIT_SET(iLocal_265[3]))
	{
	...
	if (MISC::IS_BIT_SET(iLocal_276[0]))
	{
		PED::DELETE_PED(&(iLocal_276[0]));
	}
	if (MISC::IS_BIT_SET(iLocal_276[1]))
	{
		PED::DELETE_PED(&(iLocal_276[1]));
	}
	if (MISC::IS_BIT_SET(bLocal_278))
	{
		VEHICLE::DELETE_VEHICLE(&bLocal_278);
	}
	if (MISC::IS_BIT_SET(bLocal_279))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(bLocal_279))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_279, true, false);
		}
		VEHICLE::DELETE_VEHICLE(&bLocal_279);
	}
	if (MISC::IS_BIT_SET(bLocal_282))
	{
		VEHICLE::DELETE_VEHICLE(&bLocal_282);
	}
	if (MISC::IS_BIT_SET(bLocal_283))
	{
		VEHICLE::DELETE_VEHICLE(&bLocal_283);
	}
	if (MISC::IS_BIT_SET(bLocal_284))
	{
		VEHICLE::DELETE_VEHICLE(&bLocal_284);
	}
	if (MISC::IS_BIT_SET(bLocal_285))
	{
		VEHICLE::DELETE_VEHICLE(&bLocal_285);
	}
	if (MISC::IS_BIT_SET(bLocal_287))
	{
		VEHICLE::DELETE_VEHICLE(&bLocal_287);
	}
	if (MISC::IS_BIT_SET(bLocal_289))
	{
		VEHICLE::DELETE_VEHICLE(&bLocal_289);
	}
	if (MISC::IS_BIT_SET(iLocal_293[0]))
	{
	...
	if (MISC::IS_BIT_SET(iLocal_280[0]))
	{
	...
	if (MISC::IS_BIT_SET(iLocal_288[0]))
	{
		VEHICLE::DELETE_VEHICLE(&(iLocal_288[0]));
	}
	if (MISC::IS_BIT_SET(bLocal_281))
	{
		VEHICLE::DELETE_VEHICLE(&bLocal_281);
	}
	if (MISC::IS_BIT_SET(bLocal_294))
	{
		PED::GET_PED_BONE_INDEX(&bLocal_294);
	}
	if (MISC::IS_BIT_SET(bLocal_295))
	{
		PED::GET_PED_BONE_INDEX(&bLocal_295);
	}
	if (MISC::IS_BIT_SET(bLocal_296))
	{
		PED::GET_PED_BONE_INDEX(&bLocal_296);
	}
	...
	AUDIO::STOP_SOUND(fLocal_253);
	AUDIO::STOP_SOUND(fLocal_255);
	AUDIO::STOP_SOUND(fLocal_256);
	AUDIO::STOP_SOUND(fLocal_257);
	AUDIO::STOP_SOUND(fLocal_258);
	AUDIO::STOP_SOUND(fLocal_259);
	AUDIO::STOP_SOUND(fLocal_260);
	AUDIO::STOP_SOUND(fLocal_261);
	AUDIO::STOP_SOUND(fLocal_254);
...
{
	if (!CAM::IS_SCREEN_FADED_OUT(&cLocal_185))
	{
		iLocal_91 = 0;
		func_209();
		...
		if (!PED::REMOVE_SCENARIO_BLOCKING_AREA() && !bParam0)
		{
			func_204();
			func_203();
			func_200();
...
void func_197()
{
	...
	while (iVar0 < 35)
	{
		if (MISC::IS_BIT_SET(iLocal_204[iVar0]))
		{
			if (ENTITY::GET_ENTITY_COORDS(iLocal_204[iVar0], false))
			{
				if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[iVar0]))
				{
					VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_204[iVar0]);
				}
				bVar1 = MISC::IS_MINIGAME_IN_PROGRESS(iLocal_204[iVar0], -1, 0);
				if (MISC::IS_BIT_SET(bVar1) && bVar1 != unk_0x9B0761B4C3EB8BC7())
				{
					if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(bVar1))
					{
						PED::DELETE_PED(&bVar1);
					}
				}
			}
...
void func_199()
{
	...
	while (iVar0 < 175)
	{
		if (MISC::IS_BIT_SET(iLocal_201[iVar0]))
		{
			if (ENTITY::GET_ENTITY_COORDS(iLocal_201[iVar0], false))
			{
				if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_201[iVar0]))
				{
					VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_201[iVar0]);
				}
				bVar1 = MISC::IS_MINIGAME_IN_PROGRESS(iLocal_201[iVar0], -1, 0);
				if (MISC::IS_BIT_SET(bVar1) && bVar1 != unk_0x9B0761B4C3EB8BC7())
				{
					if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(bVar1))
					{
...
void func_202(bool bParam0)
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		bVar1 = MISC::IS_MINIGAME_IN_PROGRESS(bParam0, -1, 0);
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar1))
		{
			if (!bVar1 == unk_0x9B0761B4C3EB8BC7())
			{
				...
				TASK::TASK_VEHICLE_MISSION(bVar1, bParam0, 0, 1, bVar0, 786603, 5f, 5f, true);
				PED::SET_PED_FLEE_ATTRIBUTES(bVar1, 8192, true);
				if (bLocal_108)
				{
					PED::SET_PED_FLEE_ATTRIBUTES(bVar1, 65536, true);
					PED::SET_PED_FLEE_ATTRIBUTES(bVar1, 2, false);
				}
				PED::SET_PED_COMBAT_ATTRIBUTES(bVar1, 6, false);
			}
		}
	}
}
...
void func_203()
{
	...
	while (iVar0 < 15)
	{
		if (MISC::IS_BIT_SET(iLocal_203[iVar0]))
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_203[iVar0], 0))
			{
...
void func_204()
{
	...
	while (iVar0 < 175)
	{
		if (MISC::IS_BIT_SET(iLocal_201[iVar0]))
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_201[iVar0], 0))
			{
...
void func_216()
{
	...
	if (SYSTEM::VMAG(uLocal_298))
	{
		unk_0x93370FA10F15BE44(&bLocal_298);
	}
	if (SYSTEM::VMAG(fLocal_299))
	{
		unk_0x93370FA10F15BE44(&bLocal_299);
	}
	if (SYSTEM::VMAG(bLocal_300))
	{
		unk_0x93370FA10F15BE44(&bLocal_300);
	}
}
...
void func_217()
{
	if (iLocal_486 == 0)
	{
		if (MISC::IS_BIT_SET(bLocal_266))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_266))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_266, unk_0x9B0761B4C3EB8BC7(), false))
				{
					iLocal_486 = 1;
				}
			}
	...
	if (iLocal_486 == 0)
	{
		if (iLocal_456 == 0)
		{
			if (MISC::IS_BIT_SET(bLocal_266))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_266))
				{
					if (MISC::IS_BIT_SET(bLocal_264))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
						{
							if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(bLocal_264))
							{
								if (TASK::GET_PED_WAYPOINT_PROGRESS(bLocal_264) > 18)
								{
									if (MISC::IS_BIT_SET(bLocal_296))
									{
										if (ENTITY::IS_ENTITY_ATTACHED(bLocal_296))
										{
											ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_296, 1, 1);
										}
									}
									iLocal_252 = PED::CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
									TASK::TASK_SYNCHRONIZED_SCENE(bLocal_266, iLocal_252, "misssolomon_3", "_action", 1000f, -1000f, 4, 0, 1000f, 0);
									TASK::TASK_LOOK_AT_ENTITY(bLocal_266, unk_0x9B0761B4C3EB8BC7(), 9000, 1024, 3);
									iLocal_456 = 1;
									iLocal_457 = 0;
								}
							}
		...
		if (iLocal_456 == 1 && iLocal_458 == 0)
		{
			if (MISC::IS_BIT_SET(bLocal_266))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_266))
				{
					if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_252))
					{
						if (!iLocal_457)
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_252) > 0.25f)
							{
								func_17(&uLocal_490, 4, bLocal_266, "HangerWorker", 0, 1);
								func_218(bLocal_266, "T1M4_BCAA", "HangerWorker", 11);
								iLocal_457 = 1;
							}
						}
						if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_252) > 0.99f)
						{
							iLocal_252 = PED::CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
							TASK::TASK_SYNCHRONIZED_SCENE(bLocal_266, iLocal_252, "misssolomon_3", "_react_to_death", 1000f, -1.5f, 3, 16, 1000f, 0);
							iLocal_458 = 1;
						}
					}
				}
		...
		if (iLocal_458 == 1 && iLocal_461 == 0)
		{
			if (MISC::IS_BIT_SET(bLocal_266))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_266))
				{
					if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_252))
					{
						if (ENTITY::GET_ENTITY_ROTATION(bLocal_266, AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("ENDS_IN_RUN")))
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_304);
							TASK::TASK_FORCE_MOTION_STATE(0, -1115154469, false);
							HUD::_THEFEED_DISABLE(0, -1001.9f, -2954.3f, 13.1f, 3f, -1, 40000f, 3f);
							TASK::TASK_SMART_FLEE_PED(false, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_304);
							AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_266, iLocal_304);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_304);
							PED::FORCE_PED_MOTION_STATE(bLocal_266, -1115154469, false, 0, false);
							iLocal_461 = 1;
						}
					}
				}
...
void func_219()
{
	...
	{
		iLocal_225 = 0;
		fLocal_253 = AUDIO::PLAY_SOUND_FROM_COORD();
	...
	if (iLocal_223 == 1)
	{
		switch (iLocal_225)
		{
			case 0:
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_264, "Molly", 1, joaat("ig_molly"), 0);
				}
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_266))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_266, "Airworker_Tackle_trevor", 0, joaat("s_m_y_airworker"), 0);
				}
				if (ENTITY::GET_ENTITY_COORDS(bLocal_284, false))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_284, "JET_TRV4", 0, joaat("jet"), 0);
				}
			...
			case 1:
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("JET_TRV4", joaat("jet")))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_284, false))
					{
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_284, 0))
						{
							ENTITY::SET_ENTITY_COORDS(bLocal_284, 1);
						}
					}
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Airworker_Tackle_trevor", joaat("s_m_y_airworker")))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_266))
					{
						PED::_0x2208438012482A1A(bLocal_266, 1);
						TASK::TASK_SMART_FLEE_PED(bLocal_266, unk_0x9B0761B4C3EB8BC7(), 150f, -1, false, false);
						ENTITY::SET_ENTITY_INVINCIBLE(bLocal_266, false);
						PED::SET_PED_CAN_BE_TARGETTED(bLocal_266, true);
						ENTITY::SET_ENTITY_PROOFS(bLocal_266, false, false, false, false, false, false, false, false);
					}
				}
				...
				if (!NETWORK::_0xC87E740D9F3872CC())
				{
					...
					if (!MISC::IS_BIT_SET(bLocal_294))
					{
						if (ENTITY::DOES_ENTITY_EXIST(joaat("prop_jet_bloodsplat_01")))
						{
							bLocal_294 = OBJECT::CREATE_OBJECT(joaat("prop_jet_bloodsplat_01"), -946.4231f, -2979.826f, 12.9264f, true, true, false);
							ENTITY::DETACH_ENTITY(bLocal_294, 0f, 0f, -121.5948f, 2, 1);
							ENTITY::SET_ENTITY_QUATERNION(bLocal_294, 0f, 0f, 0.8729f, -0.4879f);
					...
					PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
					if (!WEAPON::HAS_PED_GOT_WEAPON(unk_0x9B0761B4C3EB8BC7(), 0, 2))
					{
...
void func_220(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_224(PLAYER::PLAYER_ID())) && !func_222(PLAYER::PLAYER_ID(), 0)) && !func_221()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_224(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_229()
{
	...
	else if (iLocal_446 == 0)
	{
		...
		{
			PED::SET_PED_MAX_MOVE_BLEND_RATIO(unk_0x9B0761B4C3EB8BC7(), 0f);
		}
		else
		{
			if (fLocal_324 < 1f)
			...
			PED::SET_PED_MAX_MOVE_BLEND_RATIO(unk_0x9B0761B4C3EB8BC7(), fLocal_324);
		}
	}
	if (iLocal_223 > 0)
	{
	...
	if (iLocal_223 == 0)
	{
		...
		if (MISC::IS_BIT_SET(bLocal_264))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
			{
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(bLocal_264))
				{
					TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(bLocal_264, 3f, true);
				}
			}
		}
		if (!GRAPHICS::DRAW_SCALEFORM_MOVIE())
	...
	if (iLocal_223 == 1)
	{
		...
		if (iLocal_420 == 0)
		{
			if (MISC::IS_BIT_SET(bLocal_264))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
				{
					if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(bLocal_264))
					{
						if (TASK::GET_PED_WAYPOINT_PROGRESS(bLocal_264) > 20)
						{
							if (MISC::IS_BIT_SET(bLocal_284))
							{
								if (ENTITY::GET_ENTITY_COORDS(bLocal_284, false))
								{
									func_234(&bLocal_284);
									AUDIO::SET_VARIABLE_ON_SOUND(fLocal_253, "Trevor_4_747_Jet_Engine", -937.77f, -2981.36f, 15.44f, 0, 0, 0, 0);
									VEHICLE::SET_VEHICLE_ENGINE_ON(bLocal_284, true, false, false);
									iLocal_420 = 1;
								}
							}
						}
		...
		if (iLocal_443 == 0)
		{
			if (MISC::IS_BIT_SET(bLocal_264))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
				{
					if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(bLocal_264))
					{
						if (TASK::GET_PED_WAYPOINT_PROGRESS(bLocal_264) > 23)
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_264);
							if (MISC::IS_BIT_SET(bLocal_284))
							{
								if (ENTITY::GET_ENTITY_COORDS(bLocal_284, false))
								{
									...
									PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_251, bLocal_284, ENTITY::_GET_ENTITY_BONE_ROTATION_LOCAL(bLocal_284, "chassis_Control"));
									TASK::TASK_SYNCHRONIZED_SCENE(bLocal_264, iLocal_251, "MISSSOLOMON_3", "molly_death", 1.5f, -8f, 4, 0, 1000f, 0);
		...
		if (iLocal_444 == 0)
		{
			if (MISC::IS_BIT_SET(bLocal_264))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
				{
					if (iLocal_443 == 1)
					{
						Local_318 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
						if (Local_318.f_1 < -2965f)
						{
							CAM::SET_GAMEPLAY_ENTITY_HINT(bLocal_264, 0f, 0f, 0f, true, 6000, 1000, 2000, 0);
							PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_264, 0);
							TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_264, 4000, 48, 4);
							iLocal_444 = 1;
						}
					}
				}
		...
		else if (iLocal_445 == 0)
		{
			if (!MISC::IS_BIT_SET(bLocal_264))
			{
				...
				if (MISC::IS_BIT_SET(iLocal_268[0]))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_268[0]))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_268[0]);
						PED::_0x2208438012482A1A(iLocal_268[0], 0);
					}
				}
				iLocal_445 = 1;
			}
		...
		if (iLocal_422 == 0)
		{
			if (MISC::IS_BIT_SET(bLocal_264))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
				{
					if (MISC::IS_BIT_SET(bLocal_295))
					{
						if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_295, bLocal_264))
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_264, "MISSSOLOMON_3", "molly_death", 3))
							{
								if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_251) > 0.59f)
								{
									ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_295, 1, 1);
									if (SYSTEM::VMAG(bLocal_297))
									{
										unk_0x93370FA10F15BE44(&bLocal_297);
									}
									if (!SYSTEM::VMAG(bLocal_300))
									{
										func_218(bLocal_264, "HIGH_FALL", "WAVELOAD_PAIN_FEMALE", 11);
										if (AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_ON_FOOT_CHASE"))
										{
											AUDIO::STOP_AUDIO_SCENE("SOL_3_ON_FOOT_CHASE");
										}
		...
		if (iLocal_446 == 0)
		{
			...
			{
				bLocal_300 = func_231(bLocal_295);
		...
		if (iLocal_421 == 0)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
			{
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_264, "MISSSOLOMON_3", "molly_death", 3))
				{
					if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_251) > 0.89f)
					{
						if (MISC::IS_BIT_SET(bLocal_284))
						{
							if (ENTITY::GET_ENTITY_COORDS(bLocal_284, false))
							{
								PED::DELETE_PED(&bLocal_264);
								GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_trev4_747_blood_impact", bLocal_284, -12.5793f, 12.2f, -7.09421f, 0f, 0f, 0f, 1f, false, false, false);
								iLocal_673 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_exhaust_plane_misfire", bLocal_284, -12.6323f, 8.1153f, -7.0876f, 0f, 0f, 0f, 1f, false, false, false);
								AUDIO::SET_VARIABLE_ON_SOUND(fLocal_254, "Trevor_4_747_Man_Sucked_In", -938.6f, -2984.13f, 15.47f, 0, 0, 0, 0);
			...
			if (MISC::GET_GAME_TIMER() > iLocal_234 + 574)
			{
				...
				if (iLocal_484 == 0)
				{
					if (MISC::IS_BIT_SET(bLocal_284))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_284, false))
						{
							GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_trev4_747_engine_debris", bLocal_284, -12.6286f, 6.85353f, -7.13622f, 180f, 0f, 0f, 1f, false, false, false);
							VEHICLE::SET_VEHICLE_ENGINE_ON(bLocal_284, false, false, false);
							func_230();
							AUDIO::STOP_SOUND(fLocal_253);
							iLocal_484 = 1;
						}
			...
			else if (iLocal_447[2] == 0)
			{
				if (MISC::GET_GAME_TIMER() > iLocal_234 + 3500)
				{
					...
					if (MISC::IS_BIT_SET(bLocal_284))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_284, false))
						{
							ENTITY::SET_ENTITY_PROOFS(bLocal_284, false, false, false, false, false, false, false, false);
						}
					}
					iLocal_447[2] = 1;
				}
		...
		if (iLocal_459 == 0)
		{
			if (iLocal_422 == 1)
			{
				if (iLocal_460 == 0)
				{
					if (!ENTITY::IS_ENTITY_IN_AIR(bLocal_295))
					{
				...
				{
					ENTITY::SET_ENTITY_COORDS(bLocal_295, 1);
					iLocal_459 = 1;
				}
			}
		}
		if (iLocal_464 == 0)
		{
			if (!MISC::IS_BIT_SET(bLocal_264))
			{
				if (MISC::IS_BIT_SET(bLocal_284))
				{
					ENTITY::SET_ENTITY_COORDS(bLocal_284, 0);
					iLocal_464 = 1;
				}
			}
		}
		if (MISC::IS_BIT_SET(bLocal_295))
		{
			if (SYSTEM::VMAG(bLocal_300))
			{
				if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_295, 1) < 1.5f && !SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					DATAFILE::UGC_UPDATE_CONTENT(-1, "PICK_UP", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
					unk_0x93370FA10F15BE44(&bLocal_300);
					PED::GET_PED_BONE_INDEX(&bLocal_295);
					func_125();
					iLocal_223 = 0;
...
bool func_232(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_233(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_233(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
void func_234(bool bParam0)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(*bParam0, 0))
	{
		...
		Var4 = { 180f, 0f, 0f };
		iLocal_668 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *bParam0, Var0, Var4, 1f, false, false, false);
		iLocal_669 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *bParam0, Var1, Var4, 1f, false, false, false);
		iLocal_670 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *bParam0, Var2, Var4, 1f, false, false, false);
		iLocal_671 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *bParam0, Var3, Var4, 1f, false, false, false);
	}
}
...
void func_235()
{
	if (MISC::IS_BIT_SET(bLocal_264))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
		{
			if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(bLocal_264))
			{
				if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_264, 1) < 17f)
				{
					TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(bLocal_264, 3f, true);
				}
				if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_264, 1) < 22f && func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_264, 1) > 17f)
				{
					TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(bLocal_264, 2f, true);
				}
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), -921.7f, -2946.4f, 13.4f, 1) > 8f && !ENTITY::IS_ENTITY_ON_SCREEN(bLocal_264))
				{
					if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_264, 1) > 22f)
					{
						TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(bLocal_264, 1f, true);
					}
				}
				else if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_264, 1) > 22f)
				{
					TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(bLocal_264, 2f, true);
				}
			}
	...
	if (iLocal_223 > 0)
	{
		...
		{
			unk_0x78FCB2E22C41B9D5(joaat("jet"));
			if (ENTITY::DOES_ENTITY_EXIST(joaat("jet")))
			{
				bLocal_284 = VEHICLE::CREATE_VEHICLE(joaat("jet"), -952.1345f, -2990.269f, 12.9451f, 240.7726f, true, true, false);
				VEHICLE::SET_VEHICLE_LIVERY(bLocal_284, 2);
				VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(bLocal_284, false);
		...
		if (!MISC::IS_BIT_SET(bLocal_266))
		{
			...
			if ((ENTITY::DOES_ENTITY_EXIST(joaat("s_m_y_airworker")) && STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3")) && ENTITY::DOES_ENTITY_EXIST(joaat("p_amb_clipboard_01")))
			{
				bLocal_266 = PED::CREATE_PED(26, joaat("s_m_y_airworker"), -932.1812f, -2967.947f, 12.9451f, 170.7182f, true, true);
				ENTITY::SET_ENTITY_PROOFS(bLocal_266, false, false, false, false, false, false, false, false);
				PED::SET_PED_CAN_BE_TARGETTED(bLocal_266, false);
				PED::_0x2208438012482A1A(bLocal_266, 1);
				func_17(&uLocal_490, 4, bLocal_266, "HangerWorker", 0, 1);
				bLocal_296 = OBJECT::CREATE_OBJECT(joaat("p_amb_clipboard_01"), -932.1812f, -2967.947f, 12.9451f, true, true, false);
				OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_296, bLocal_266, ENTITY::ATTACH_ENTITY_TO_ENTITY(bLocal_264, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				iLocal_252 = PED::CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
				TASK::TASK_SYNCHRONIZED_SCENE(bLocal_266, iLocal_252, "misssolomon_3", "_start_loop", 1000f, -8f, 68, 0, 1000f, 0);
				unk_0x74528AC0906CBABE(joaat("s_m_y_airworker"));
		...
		{
			unk_0x78FCB2E22C41B9D5(joaat("s_m_y_cop_01"));
			if (ENTITY::DOES_ENTITY_EXIST(joaat("s_m_y_cop_01")))
			{
				iLocal_268[0] = PED::CREATE_PED(6, joaat("s_m_y_cop_01"), -969.06f, -2955.186f, 12.945f, 241.1703f, true, true);
				unk_0x92BD213E6A0E666B(iLocal_268[0], joaat("weapon_pistol"), 1000, 1, 1);
				PED::SET_PED_ACCURACY(iLocal_268[0], 20);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_268[0], true, 1);
				PED::_0x2208438012482A1A(iLocal_268[0], 1);
				TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_268[0], unk_0x9B0761B4C3EB8BC7(), -1, true);
				func_127(iLocal_268[0], 0);
			}
		}
		...
		{
			unk_0x78FCB2E22C41B9D5(joaat("shamal"));
			if (ENTITY::DOES_ENTITY_EXIST(joaat("shamal")))
			{
				bLocal_285 = VEHICLE::CREATE_VEHICLE(joaat("shamal"), -968.3718f, -2952.298f, 12.9451f, 114.9439f, true, true, false);
				VEHICLE::SET_VEHICLE_DOOR_OPEN(bLocal_285, 0, false, true);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_285, 5f);
		...
		if (MISC::IS_BIT_SET(bLocal_285))
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_285, false))
			{
				if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_285, 1) > 5f)
				{
					VEHICLE::SET_VEHICLE_DOOR_OPEN(bLocal_285, 0, false, false);
				}
			}
		}
	}
	if (iLocal_223 == 0)
	{
		...
		{
			AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(bLocal_278, 0f);
			STREAMING::REMOVE_ANIM_DICT(&bLocal_278);
		}
		if (MISC::IS_BIT_SET(bLocal_287))
		{
			VEHICLE::DELETE_VEHICLE(&bLocal_287);
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
		{
			if (!SYSTEM::VMAG(bLocal_297))
			{
				bLocal_297 = TASK::IS_PED_SPRINTING(bLocal_264);
				HUD::SET_BLIP_AS_FRIENDLY(bLocal_297, true);
			}
		}
		AUDIO::SET_AUDIO_FLAG("PoliceScannerDisabled", true);
		if (iLocal_363[2] == 1)
		{
			if (!AUDIO::HAS_SOUND_FINISHED(fLocal_261))
			{
				AUDIO::STOP_SOUND(fLocal_261);
			}
			AUDIO::RELEASE_SOUND_ID(fLocal_261);
			iLocal_390 = 0;
			iLocal_363[2] = 0;
		}
		PLAYER::SET_MAX_WANTED_LEVEL(5);
	...
	if (iLocal_223 == 2)
	{
		...
		if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -932.1196f, -2934.317f, 12.9448f, 2f, 2f, 2f, 0, 1, 0))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
			{
				if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(bLocal_264))
				{
					TASK::TASK_FOLLOW_WAYPOINT_RECORDING(bLocal_264, "BB_MOLLY_2", 10, 4, -1);
					TASK::TASK_PLAY_ANIM(bLocal_264, "move_f@film_reel_arms", "run", 8f, -8f, -1, 49, 0f, false, false, false);
				}
			}
			SYSTEM::SETTIMERA(0);
			iLocal_223 = 3;
	...
	if (iLocal_223 == 3)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
		{
			if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(bLocal_264))
			{
				if (TASK::GET_PED_WAYPOINT_PROGRESS(bLocal_264) > 18 && iLocal_405 == 0)
				{
					iLocal_350 = 0;
					TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(bLocal_264, 3f, true);
					iLocal_223 = 0;
		...
		if (SYSTEM::TIMERA() > 50000)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
			{
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_264);
				unk_0x03D382CB0B44E2FC(bLocal_264, -932.5f, -2964.1f, 13.4f, 1, 0, 0, 1);
				TASK::TASK_FOLLOW_WAYPOINT_RECORDING(bLocal_264, "BB_MOLLY_2", 18, 4, -1);
				TASK::TASK_PLAY_ANIM(bLocal_264, "move_f@film_reel_arms", "run", 8f, -8f, -1, 49, 0f, false, false, false);
				iLocal_350 = 0;
				iLocal_223 = 0;
				iLocal_222 = 6;
...
int func_239(int iParam0)
{
	...
	if (!unk_0xCE990E643CD9D0E5(Global_89743[iVar1 /*34*/].f_15, true))
	{
		if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
		{
...
void func_247()
{
	if (!MISC::IS_BIT_SET(bLocal_284))
	{
		if (MISC::IS_BIT_SET(bLocal_278))
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
				{
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 30000f)
					{
						unk_0x78FCB2E22C41B9D5(joaat("jet"));
						if (ENTITY::DOES_ENTITY_EXIST(joaat("jet")))
						{
	...
	if (SYSTEM::VMAG(bLocal_297))
	{
		func_346(bLocal_297, bLocal_264, 300f, 0.9f, 0);
	}
	if (iLocal_223 == 0)
	{
		if (iLocal_224 < 2)
		{
			PED::SET_PED_CAN_HEAD_IK(unk_0x9B0761B4C3EB8BC7(), false);
		}
		func_345();
		func_313();
		if (iLocal_395 == 0)
		{
			if (MISC::IS_BIT_SET(iLocal_204[20]))
			{
				if (ENTITY::GET_ENTITY_COORDS(iLocal_204[20], false))
				{
		...
		if (iLocal_347 == 0)
		{
			if (MISC::IS_BIT_SET(bLocal_278))
			{
				if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
					{
						func_310(iLocal_301, bLocal_287, "BB_Chase", 1);
						iLocal_347 = 1;
					}
				}
			}
		}
		else if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
			{
				func_309(iLocal_301, bLocal_287, fLocal_321);
		...
		if (iLocal_335 == 0)
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
				{
					if ((VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 15000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 125464f) && func_301(1, 0, 0))
					{
						iLocal_350 = 1;
						if (iLocal_405 == 0)
						{
		...
		else if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
			{
				...
				{
					if (((VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 15000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 125464f) && iLocal_405 == 0) && SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						func_271();
					}
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 125464f || !SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						if (iLocal_334)
						{
							unk_0xD289B55B6AADBA10(1);
		...
		switch (iLocal_224)
		{
			case 0:
				if (iLocal_487[0] == 0)
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 44255f && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), -1187.3f, -2847.8f, 13.6f, 1) < 100f)
							{
								RECORDING::_0x293220DA1B46CEBC(10f, 2f, 3);
								iLocal_487[0] = 1;
							}
				...
				if (iLocal_487[1] == 0)
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 52875f && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), -1349f, -2720f, 14f, 1) < 50f)
							{
				...
				if (iLocal_487[2] == 0)
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 87085f && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), -1507f, -2520f, 14f, 1) < 70f)
							{
								RECORDING::_0x293220DA1B46CEBC(10f, 2f, 3);
								iLocal_487[2] = 1;
							}
				...
				if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_PLANE_ON_FIRE"))
				{
					if (MISC::IS_BIT_SET(bLocal_278))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 64280f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 72000f)
								{
									if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(-1149.6f, -2323.7f, 22.5f, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 1) < 130f)
									{
				...
				else if (MISC::IS_BIT_SET(bLocal_278))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 72500f)
							{
								AUDIO::STOP_AUDIO_SCENE("SOL_3_PLANE_ON_FIRE");
							}
						}
				...
				if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_EVENT_JET_LANDING"))
				{
					if (MISC::IS_BIT_SET(bLocal_278))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 78000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 85000f)
								{
				...
				else if (MISC::IS_BIT_SET(bLocal_278))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 85500f)
							{
								AUDIO::STOP_AUDIO_SCENE("SOL_3_EVENT_JET_LANDING");
							}
						}
				...
				if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_EVENT_PLANE_TAXIING_EXPLOSION"))
				{
					if (MISC::IS_BIT_SET(bLocal_278))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 100000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 107000f)
								{
				...
				else if (MISC::IS_BIT_SET(bLocal_278))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 107500f)
							{
								AUDIO::STOP_AUDIO_SCENE("SOL_3_EVENT_PLANE_TAXIING_EXPLOSION");
							}
						}
				...
				if (MISC::IS_BIT_SET(bLocal_278))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 10000f)
							{
								func_268();
							}
						}
				...
				if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
					{
						if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 30000f)
						{
							func_267(bLocal_278, VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278));
						}
					}
				}
				if (iLocal_408 == 0)
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 22000f)
							{
				...
				if (iLocal_341 == 0)
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (func_16(bLocal_278, unk_0x9B0761B4C3EB8BC7(), 1) < 170f && ENTITY::IS_ENTITY_ON_SCREEN(bLocal_278))
						{
							if (SYSTEM::VMAG(bLocal_299))
							{
								unk_0x93370FA10F15BE44(&bLocal_299);
							}
							if (AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_DRIVE_TO_AIRPORT"))
				...
				else if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
					{
						if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 15000f)
						{
						}
					}
				}
				if (iLocal_326 == 0)
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(joaat("jet")))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 18490f)
								{
				...
				else if (MISC::IS_BIT_SET(iLocal_280[1]))
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_280[1], false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_280[1]))
						{
							...
							{
								if (func_16(unk_0x9B0761B4C3EB8BC7(), iLocal_280[1], 1) > 200f && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_280[1]))
								{
							...
							if (MISC::IS_BIT_SET(iLocal_280[1]))
							{
								...
								{
									VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_280[1]);
									ENTITY::SET_ENTITY_COORDS(iLocal_280[1], 1);
								}
							}
						}
						else if (func_16(unk_0x9B0761B4C3EB8BC7(), iLocal_280[1], 1) > 200f && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_280[1]))
						{
							if (MISC::IS_BIT_SET(iLocal_276[1]))
							{
								PED::DELETE_PED(&(iLocal_276[1]));
				...
				if (iLocal_432 == 0)
				{
					if (!MISC::IS_BIT_SET(bLocal_283))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 23000f)
								{
									unk_0x78FCB2E22C41B9D5(joaat("tanker"));
									if (ENTITY::DOES_ENTITY_EXIST(joaat("tanker")))
									{
										bLocal_283 = VEHICLE::CREATE_VEHICLE(joaat("tanker"), -1325f, -2779f, 14f, 233.9563f, true, true, false);
										unk_0x74528AC0906CBABE(joaat("tanker"));
										VEHICLE::SET_VEHICLE_COLOURS(bLocal_283, 57, 57);
										iLocal_432 = 1;
									}
								}
							}
				...
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[1], false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[1]))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_204[1]) > 13000f)
							{
								...
								{
									fLocal_123[1] = 0.5f;
									bLocal_269 = MISC::IS_MINIGAME_IN_PROGRESS(iLocal_204[1], -1, 0);
									iLocal_370 = 1;
								}
							}
						}
				...
				if (iLocal_332 == 0)
				{
					...
					if (MISC::IS_BIT_SET(iLocal_204[1]))
					{
						...
						if (MISC::IS_BIT_SET(bLocal_283))
						{
							if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[1], 0))
							{
								if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_283, 0))
								{
									if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[1]))
									{
										VEHICLE::ATTACH_VEHICLE_TO_TRAILER(iLocal_204[1], bLocal_283, 1f);
									}
								}
							}
						}
					...
					if (MISC::IS_BIT_SET(bLocal_283))
					{
						if (MISC::IS_BIT_SET(bLocal_278))
						{
							if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
							{
								if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 41430f)
									{
										ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_283, 1, 1);
										iLocal_332 = 1;
									}
								}
							}
				...
				else if (iLocal_373 == 0)
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[1], false))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 42700f)
								{
									if (MISC::IS_BIT_SET(bLocal_269))
									{
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_269))
										{
											CAM::IS_AIM_CAM_ACTIVE(bLocal_269, 0, 0);
										}
									}
									if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[1]))
									{
				...
				if (MISC::IS_BIT_SET(bLocal_278))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (iLocal_467 == 0)
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 38000f)
								{
									if (MISC::IS_BIT_SET(iLocal_204[1]) && ENTITY::GET_ENTITY_COORDS(iLocal_204[1], false))
									{
										ENTITY::GET_ENTITY_ALPHA(-1, "Trevor_4_747_Tanker_Horn", iLocal_204[1], 0, 0, 0);
										iLocal_467 = 1;
									}
								}
							}
							if (iLocal_363[1] == 0)
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 39000f)
								{
									if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_EVENT_TANKER_CRASH"))
									{
									...
									if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
									{
										ENTITY::SET_ENTITY_PROOFS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false, true, true, false, false, false, false, false);
									}
									iLocal_363[1] = 1;
								}
							}
							if (iLocal_403 == 0)
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 41611f)
								{
									if (MISC::IS_BIT_SET(bLocal_283))
									{
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_283, 0))
										{
											if (MISC::IS_BIT_SET(iLocal_204[7]))
											{
												if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[7], 0))
												{
													ENTITY::GET_ENTITY_ALPHA(-1, "Trevor_4_747_Tanker_Explosion", bLocal_283, 0, 0, 0);
													VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_204[7]);
													VEHICLE::EXPLODE_VEHICLE(iLocal_204[7], true, false);
													VEHICLE::EXPLODE_VEHICLE(bLocal_283, true, false);
													...
													STREAMING::REMOVE_ANIM_DICT(&bLocal_283);
													STREAMING::REMOVE_ANIM_DICT(&(iLocal_204[1]));
													iLocal_403 = 1;
												}
											}
										}
							...
							if (iLocal_364[1] == 0)
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 43204f)
								{
									if (AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_EVENT_TANKER_CRASH"))
									{
										AUDIO::STOP_AUDIO_SCENE("SOL_3_EVENT_TANKER_CRASH");
				...
				if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_HELI_TAKEOFF"))
				{
					...
					{
						if (ENTITY::GET_ENTITY_COORDS(iLocal_204[0], false))
						{
							if (MISC::IS_BIT_SET(bLocal_278))
							{
								if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
								{
									if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
									{
										if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 36000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 40000f)
										{
				...
				else if (MISC::IS_BIT_SET(iLocal_204[0]))
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[0], false))
					{
						if (MISC::IS_BIT_SET(bLocal_278))
				...
				if (iLocal_325 == 0)
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 60500f)
							{
								unk_0x78FCB2E22C41B9D5(joaat("jet"));
							}
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 66500f)
							{
								if (ENTITY::DOES_ENTITY_EXIST(joaat("jet")))
								{
				...
				else if (MISC::IS_BIT_SET(iLocal_280[0]))
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_280[0], false))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_280[0]))
								{
									...
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 80000f)
									{
								...
								else if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 80000f)
								{
									if (func_16(iLocal_280[0], unk_0x9B0761B4C3EB8BC7(), 1) > 200f && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_280[0]))
									{
										if (MISC::IS_BIT_SET(iLocal_276[0]))
										{
											PED::DELETE_PED(&(iLocal_276[0]));
				...
				if (iLocal_392 == 0)
				{
					if (iLocal_391 == 0)
					{
						if (MISC::IS_BIT_SET(bLocal_278))
						{
							if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
							{
								if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 50000f)
									{
										unk_0x78FCB2E22C41B9D5(joaat("s_m_y_airworker"));
										STREAMING::REQUEST_ANIM_DICT("misstrevor4");
										if (ENTITY::DOES_ENTITY_EXIST(joaat("s_m_y_airworker")))
										{
											bLocal_270 = PED::CREATE_PED(26, joaat("s_m_y_airworker"), -1170.541f, -2507.111f, 12.9455f, 218.3035f, true, true);
											bLocal_271 = PED::CREATE_PED(26, joaat("s_m_y_airworker"), -1168.264f, -2508.715f, 12.9455f, 70.7735f, true, true);
											PED::_0x2208438012482A1A(bLocal_270, 1);
											PED::_0x2208438012482A1A(bLocal_271, 1);
											unk_0x74528AC0906CBABE(joaat("s_m_y_airworker"));
											iLocal_391 = 1;
										}
									}
					...
					else if (MISC::IS_BIT_SET(bLocal_278))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 58000f)
								{
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_270))
									{
										if (STREAMING::HAS_ANIM_DICT_LOADED("misstrevor4"))
										{
											if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_270, "misstrevor4", "dive_clear_goon1", 3))
											{
												TASK::TASK_PLAY_ANIM(bLocal_270, "misstrevor4", "dive_clear_goon1", 8f, -8f, -1, 0, 0f, false, false, false);
											}
										}
									}
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_271))
									{
										if (STREAMING::HAS_ANIM_DICT_LOADED("misstrevor4"))
										{
											if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_271, "misstrevor4", "dive_clear_goon2", 3))
											{
												TASK::TASK_PLAY_ANIM(bLocal_271, "misstrevor4", "dive_clear_goon2", 8f, -8f, -1, 0, 0f, false, false, false);
											}
										}
									}
									iLocal_392 = 1;
				...
				else if (MISC::IS_BIT_SET(bLocal_270))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_270))
					{
						if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_270, "misstrevor4", "dive_clear_goon1", 3))
							...
							if (MISC::IS_BIT_SET(bLocal_271))
							{
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_271))
								{
									if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_271, "misstrevor4", "dive_clear_goon2", 3))
									{
										...
										ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_270);
										ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_271);
									}
								}
							}
						}
				...
				if (MISC::IS_BIT_SET(iLocal_204[8]))
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[8], false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[8]))
						{
							if (MISC::IS_BIT_SET(bLocal_278))
							{
								if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
								{
									if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
									{
										if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 50200f)
										{
											if (iLocal_328 == 0)
											{
												...
												ENTITY::GET_ENTITY_ALPHA(fLocal_255, "Trevor_4_747_Flying_Car", iLocal_204[8], 0, 0, 0);
												SYSTEM::SETTIMERB(0);
												iLocal_328 = 1;
											}
										}
								...
								if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 50200f)
									{
										if (!ENTITY::IS_ENTITY_IN_AIR(iLocal_204[8]))
										{
											if (iLocal_378 == 0)
											{
												ENTITY::GET_ENTITY_ALPHA(fLocal_255, "Trevor_4_747_Carsplosion", iLocal_204[8], 0, 0, 0);
				...
				if (MISC::IS_BIT_SET(iLocal_204[11]))
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[11], false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[11]))
						{
							if (MISC::IS_BIT_SET(bLocal_278))
							{
								if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
								{
									if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
									{
										if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 82683f)
										{
											if (iLocal_329 == 0)
											{
												ENTITY::GET_ENTITY_ALPHA(fLocal_257, "Trevor_4_747_Flying_Car", iLocal_204[11], 0, 0, 0);
												iLocal_329 = 1;
												SYSTEM::SETTIMERB(0);
											}
											if (iLocal_329 == 1)
						...
						else if (iLocal_329 == 1)
						{
							if (iLocal_379 == 0)
							{
								if (!ENTITY::IS_ENTITY_IN_AIR(iLocal_204[11]))
								{
									ENTITY::GET_ENTITY_ALPHA(fLocal_257, "Trevor_4_747_Carsplosion", iLocal_204[11], 0, 0, 0);
				...
				if (MISC::IS_BIT_SET(iLocal_204[12]))
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[12], false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[12]))
						{
							if (MISC::IS_BIT_SET(bLocal_278))
							{
								if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
								{
									if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
									{
										if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 82463f)
										{
											if (iLocal_330 == 0)
											{
												ENTITY::GET_ENTITY_ALPHA(fLocal_258, "Trevor_4_747_Flying_Car", iLocal_204[12], 0, 0, 0);
												iLocal_330 = 1;
												SYSTEM::SETTIMERB(0);
											}
											if (iLocal_330 == 1)
							...
							if (iLocal_463 == 0)
							{
								if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[12]))
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_204[12]) > 22216f && func_16(bLocal_279, iLocal_204[12], 1) < 90f)
									{
										MISC::SET_TIME_SCALE(0.3f);
						...
						else if (iLocal_330 == 1)
						{
							if (iLocal_380 == 0)
							{
								if (!ENTITY::IS_ENTITY_IN_AIR(iLocal_204[12]))
								{
									ENTITY::GET_ENTITY_ALPHA(fLocal_258, "Trevor_4_747_Carsplosion", iLocal_204[12], 0, 0, 0);
				...
				if (iLocal_462 == 0 && iLocal_463 == 1)
				{
					if (MISC::IS_BIT_SET(iLocal_204[12]))
					{
						if (ENTITY::GET_ENTITY_COORDS(iLocal_204[12], false))
						{
							Local_317 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_204[12], 1) };
						}
					}
					Local_318 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
				...
				if (MISC::IS_BIT_SET(bLocal_278))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 105000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 113000f)
							{
				...
				if (MISC::IS_BIT_SET(iLocal_204[13]))
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[13], false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[13]))
						{
							if (MISC::IS_BIT_SET(bLocal_278))
							{
								if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
								{
									if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
									{
										if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 108830f)
										{
						...
						{
							CAM::IS_AIM_CAM_ACTIVE(iLocal_204[13], 0, 0);
							VEHICLE::SET_VEHICLE_UNDRIVEABLE(iLocal_204[13], true);
							CAM::IS_AIM_CAM_ACTIVE(MISC::IS_MINIGAME_IN_PROGRESS(iLocal_204[13], -1, 0), 0, 0);
						}
					}
				}
				if (iLocal_427 == 0)
				{
					...
					{
						if (ENTITY::GET_ENTITY_COORDS(iLocal_204[5], false))
						{
				...
				if (MISC::IS_BIT_SET(iLocal_204[15]))
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[15], false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[15]))
						{
							if (MISC::IS_BIT_SET(bLocal_278))
							{
								if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
								{
									if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
									{
										if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 104989f)
										{
											...
											ENTITY::GET_ENTITY_ALPHA(-1, "Trevor_4_747_Carsplosion", iLocal_204[15], 0, 0, 0);
				...
				if (MISC::IS_BIT_SET(bLocal_278))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 112000f)
							{
								TASK::REQUEST_WAYPOINT_RECORDING("BB_MOLLY_2");
								STREAMING::REQUEST_ANIM_DICT("misssolomon_3");
								STREAMING::REQUEST_ANIM_DICT("move_f@film_reel_arms");
			...
			case 1:
				...
				if (MISC::IS_BIT_SET(iLocal_288[0]))
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_288[0], false))
					{
						AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_288[0], 0f);
						STREAMING::REMOVE_ANIM_DICT(&(iLocal_288[0]));
					}
				}
				if (MISC::IS_BIT_SET(iLocal_275[0]))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_275[0]))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_275[0]);
				...
				if (iLocal_394 == 0)
				{
					if (MISC::IS_BIT_SET(bLocal_278))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 115000f)
								{
									TASK::REQUEST_WAYPOINT_RECORDING("Trev4_5");
									unk_0x78FCB2E22C41B9D5(joaat("prop_cs_film_reel_01"));
				...
				if (iLocal_405 == 0)
				{
					if (MISC::IS_BIT_SET(bLocal_278))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 120000f)
								{
									if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_ARRIVE_AT_HANGAR"))
									{
										AUDIO::START_AUDIO_SCENE("SOL_3_ARRIVE_AT_HANGAR");
									}
									VEHICLE::REQUEST_VEHICLE_HIGH_DETAIL_MODEL(bLocal_278);
								}
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 125513f)
								{
									VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(bLocal_278);
									ENTITY::SET_ENTITY_COORDS(bLocal_278, 1);
									func_264();
			...
			case 2:
				...
				if (iLocal_405 == 0)
				{
					if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_318, -930.7f, -2916.9f, 13.4f, 1) < 45f)
					{
						iLocal_224 = 3;
					}
					if (MISC::IS_BIT_SET(bLocal_278))
					{
						if (ENTITY::IS_ENTITY_ON_SCREEN(bLocal_278))
						{
							if (iLocal_439 == 1)
							{
								iLocal_224 = 3;
			...
			case 3:
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
					{
					}
				}
				if (iLocal_415 == 0)
							...
							if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3"))
								{
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
									{
										if (!MISC::IS_BIT_SET(bLocal_295))
										{
											if (ENTITY::DOES_ENTITY_EXIST(joaat("prop_cs_film_reel_01")))
											{
												bLocal_295 = OBJECT::CREATE_OBJECT(joaat("prop_cs_film_reel_01"), -929f, -2917f, 13f, true, true, false);
												OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_295, bLocal_264, ENTITY::ATTACH_ENTITY_TO_ENTITY(bLocal_264, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
											}
										...
										if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											ENTITY::SET_ENTITY_COORDS(bLocal_278, 0);
											iLocal_250 = PED::CREATE_SYNCHRONIZED_SCENE(-929.492f, -2913.472f, 14.16f, 0f, 0f, -28.96f, 2);
											ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_278, iLocal_250, "molly_escapes_car_car", "misssolomon_3", 8f, -8f, 0, 1000f);
											TASK::TASK_SYNCHRONIZED_SCENE(bLocal_264, iLocal_250, "misssolomon_3", "molly_escapes_car_mol", 1000f, -1000f, 5, 0, 1000f, 0);
				...
				if (iLocal_417 == 0)
				{
					if (iLocal_415 == 1)
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
						{
							if (unk_0x1037B9D45CE6B788(bLocal_264, -937.6656f, -2927.864f, 12.77007f, -934.8479f, -2929.484f, 14.46523f, 1.5f, 0, 1, 0))
							{
								if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
								{
									ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(bLocal_264, -1000f, true);
								}
								TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_264);
								PED::_0x2208438012482A1A(bLocal_264, 1);
								unk_0x03D382CB0B44E2FC(bLocal_264, -934.8388f, -2932.831f, 12.9649f, 1, 0, 0, 1);
								ENTITY::SET_ENTITY_HEADING(bLocal_264, 236.5739f);
								TASK::TASK_FOLLOW_WAYPOINT_RECORDING(bLocal_264, "BB_MOLLY_2", 1, 4, -1);
					...
					if (iLocal_425 == 0)
					{
						if (iLocal_424 == 0)
						{
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
							{
								if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_250) > 0.18f || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), -930.7f, -2916.9f, 13.4f, 1) < 10f)
									{
										iLocal_225 = 0;
										iLocal_424 = 1;
									}
						...
						while (iLocal_424 == 1)
						{
							...
							switch (iLocal_225)
							{
								case 0:
									...
									if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
									{
										unk_0x03D382CB0B44E2FC(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), -918.6157f, -2926.646f, 12.9667f, 1, 0, 0, 1);
										ENTITY::SET_ENTITY_HEADING(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 47.9465f);
									}
									else
									{
										unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), -918.6157f, -2926.646f, 12.9667f, 1, 0, 0, 1);
										ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 47.9465f);
									}
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
									{
										func_17(&uLocal_490, 2, bLocal_264, "MOLLY", 0, 1);
										PED::SET_FORCE_FOOTSTEP_UPDATE(bLocal_264, true);
									}
								...
								case 1:
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
									{
										if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											if (iLocal_451 == 0)
											{
												if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_250) > 0.3f)
												{
											...
											if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_250) > 0.5f)
											{
								...
								case 2:
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
									{
										if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											...
											if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_250) > 0.85f)
											{
												...
												OBJECT::DOOR_SYSTEM_GET_OPEN_RATIO(iLocal_262, joaat("v_ilev_ss_door5_r"), -935.641f, -2927.185f, 14.0945f, 1, 1, 0);
												OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_262, 1f, false, true);
												PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
												if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
												{
													TASK::TASK_LEAVE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0);
													if (CAM::_0xEE778F8C7E1142E2(1) != 4 && CAM::_0xEE778F8C7E1142E2(0) == 4)
													{
														ENTITY::FREEZE_ENTITY_POSITION(unk_0x9B0761B4C3EB8BC7(), true, 0);
													}
												}
												PED::SET_FORCE_FOOTSTEP_UPDATE(bLocal_264, false);
				...
				if (iLocal_425 == 1)
				{
					unk_0xDC5C33A98881772F(iLocal_262, 5, 0, 1);
					if (iLocal_468 == 0)
					{
						if (MISC::IS_BIT_SET(bLocal_264))
						{
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
							{
								if (unk_0xC2169C00B643278B(bLocal_264, -935.3f, -2927.3f, 13f, 1.5f, 1.5f, 2f, 0, 1, 0))
								{
									AUDIO::SET_VARIABLE_ON_SOUND(-1, "Trevor_4_747_Molly_Open_Doors", -935.1f, -2927.6f, 13.2f, 0, 0, 0, 0);
									iLocal_468 = 1;
								}
							}
						}
...
void func_248()
{
	if (iLocal_401 == 0)
	{
		if (MISC::IS_BIT_SET(iLocal_204[14]))
		{
			if (ENTITY::GET_ENTITY_COORDS(iLocal_204[14], false))
			{
				bLocal_272 = MISC::IS_MINIGAME_IN_PROGRESS(iLocal_204[14], -1, 0);
				unk_0x92BD213E6A0E666B(bLocal_272, joaat("weapon_pistol"), 1000, 1, 1);
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_272, true, false);
				PED::_0x2208438012482A1A(bLocal_272, 1);
				PED::SET_PED_ACCURACY(bLocal_272, 5);
				CAM::IS_AIM_CAM_ACTIVE(bLocal_272, 150, 0);
	...
	else if (iLocal_400 == 0)
	{
		if (MISC::IS_BIT_SET(bLocal_272))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_272))
			{
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_272);
				PED::SET_PED_SPHERE_DEFENSIVE_AREA(bLocal_272, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_272, 1), 5f, false, false);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_304);
				TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				TASK::TASK_SEEK_COVER_FROM_PED(0, unk_0x9B0761B4C3EB8BC7(), 5000, true);
				TASK::TASK_COMBAT_PED(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_304);
				AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_272, iLocal_304);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_304);
				iLocal_400 = 1;
			}
		}
	...
	else if (iLocal_434 == 0)
	{
		if (MISC::IS_BIT_SET(bLocal_272))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_272))
			{
				if (!SYSTEM::VDIST(bLocal_272, 0) && func_13(unk_0x9B0761B4C3EB8BC7(), bLocal_272) < 20f)
				{
					if (!func_262())
					{
...
void func_264()
{
	...
	if (iLocal_381 == 1)
	{
		AUDIO::RELEASE_SOUND_ID(fLocal_259);
		iLocal_389 = 0;
	}
}

void func_265(bool bParam0, struct<3> Param1, struct<3> Param2, float fParam3, bool bParam4)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0))
	{
		...
		if (bParam4)
		{
			Var0 = { unk_0x7EC595B99EA7C4B1(bParam0, Param1) };
		}
		else
		{
			Var0 = { Param1 };
		...
		ENTITY::APPLY_FORCE_TO_ENTITY(bParam0, 3, Var2, Param2, 0, false, true, true, false, true);
	}
}
...
void func_267(bool bParam0, float fParam1)
{
	...
	else if (!bLocal_106)
	{
		...
		Local_179 = { Local_181 };
		Local_180 = { Local_182 };
		PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_179, Local_180, 0, 0);
		iLocal_166 = 0;
	}
}
...
void func_269()
{
	if (iLocal_331 == 0)
	{
		if (MISC::IS_BIT_SET(bLocal_278))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
			{
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 55000f)
				{
					...
					if ((ENTITY::DOES_ENTITY_EXIST(joaat("firetruk")) && ENTITY::DOES_ENTITY_EXIST(joaat("s_m_y_fireman_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("missheist_agency3aig_lift_waitped_a"))
					{
						if (!MISC::IS_BIT_SET(bLocal_282))
						{
							MISC::CLEAR_AREA(-1129.566f, -2319.888f, 12.9445f, 10f, false, false, false, false);
							bLocal_282 = VEHICLE::CREATE_VEHICLE(joaat("firetruk"), -1129.566f, -2319.888f, 12.9445f, 16.5423f, true, true, false);
						}
						...
						if (iLocal_381 == 0)
						{
							AUDIO::SET_VARIABLE_ON_SOUND(fLocal_259, "Trevor_4_747_Loud_Fire", -1151f, -2311f, 15f, 0, 0, 0, 0);
							iLocal_381 = 1;
						}
						...
						if (!MISC::IS_BIT_SET(iLocal_265[0]))
						{
							iLocal_265[0] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_282, 21, joaat("s_m_y_fireman_01"), -1, true, true);
							PED::_0x2208438012482A1A(iLocal_265[0], 1);
						...
						if (!MISC::IS_BIT_SET(iLocal_265[1]))
						{
							...
							PED::_0x2208438012482A1A(iLocal_265[1], 1);
						...
						if (!MISC::IS_BIT_SET(iLocal_265[2]))
						{
							...
							PED::_0x2208438012482A1A(iLocal_265[2], 1);
						...
						if (!MISC::IS_BIT_SET(iLocal_265[3]))
						{
							...
							PED::_0x2208438012482A1A(iLocal_265[3], 1);
	...
	if (iLocal_331 == 1)
	{
		if (iLocal_465[0] == 0)
		{
			if (MISC::IS_BIT_SET(iLocal_265[1]))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_265[1]))
				{
					if (iLocal_466[0] == 0)
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_265[1], "missheist_agency3aig_lift_waitped_a", "idle_b", 3))
						{
							iLocal_466[0] = 1;
						}
					}
					if (iLocal_466[0] == 1)
					{
						if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_265[1], "missheist_agency3aig_lift_waitped_a", "idle_b", 3))
						{
							...
							PED::SET_PED_KEEP_TASK(iLocal_265[1], true);
							PED::_0x2208438012482A1A(iLocal_265[1], 0);
							iLocal_465[0] = 1;
						}
					}
				}
		...
		if (iLocal_465[1] == 0)
		{
			if (MISC::IS_BIT_SET(iLocal_265[2]))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_265[2]))
				{
					if (iLocal_466[1] == 0)
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_265[2], "missheist_agency3aig_lift_waitped_a", "idle_a", 3))
						{
							iLocal_466[1] = 1;
						}
					}
					if (iLocal_466[1] == 1)
					{
						if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_265[2], "missheist_agency3aig_lift_waitped_a", "idle_a", 3))
						{
							...
							PED::SET_PED_KEEP_TASK(iLocal_265[2], true);
							PED::_0x2208438012482A1A(iLocal_265[2], 0);
							iLocal_465[1] = 1;
						}
					}
				}
		...
		if (iLocal_465[2] == 0)
		{
			if (MISC::IS_BIT_SET(iLocal_265[3]))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_265[3]))
				{
					if (iLocal_466[2] == 0)
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_265[3], "missheist_agency3aig_lift_waitped_a", "idle_c", 3))
						{
							iLocal_466[2] = 1;
						}
					}
					if (iLocal_466[2] == 1)
					{
						if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_265[3], "missheist_agency3aig_lift_waitped_a", "idle_c", 3))
						{
							...
							PED::SET_PED_KEEP_TASK(iLocal_265[3], true);
							PED::_0x2208438012482A1A(iLocal_265[3], 0);
							iLocal_465[2] = 1;
						}
					}
				}
...
void func_270()
{
	if (iLocal_402 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(joaat("police3")) && ENTITY::DOES_ENTITY_EXIST(joaat("s_m_y_cop_01")))
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
				{
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 15500f)
					{
						...
						PED::_0x2208438012482A1A(iLocal_275[0], 1);
						...
						unk_0x92BD213E6A0E666B(iLocal_275[0], joaat("weapon_pistol"), 1000, 1, 1);
		...
		if (iLocal_429[0] == 0)
		{
			if (MISC::IS_BIT_SET(iLocal_288[0]))
			{
				if (ENTITY::GET_ENTITY_COORDS(iLocal_288[0], false))
				{
					...
					else if (MISC::IS_BIT_SET(iLocal_275[0]))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_275[0]))
						{
							PED::_0x2208438012482A1A(iLocal_275[0], 1);
							if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
							{
								TASK::TASK_VEHICLE_CHASE(iLocal_275[0], unk_0x9B0761B4C3EB8BC7());
								PED::SET_PED_KEEP_TASK(iLocal_275[0], true);
							}
							else
							{
								TASK::TASK_COMBAT_PED(iLocal_275[0], unk_0x9B0761B4C3EB8BC7(), 0, 16);
								PED::SET_PED_KEEP_TASK(iLocal_275[0], true);
							}
...
void func_271()
{
	...
	else if (func_286(&uLocal_28, 1, 0, 0) && iLocal_405 == 0)
	{
		...
		if (iLocal_363[2] == 0)
		{
			...
			DATAFILE::UGC_UPDATE_CONTENT(fLocal_261, "Trevor_4_747_TV", 0, 1);
			iLocal_363[2] = 1;
		}
		func_277(1, 1, 30, 5, 0);
		if (iLocal_352 == 0)
		...
		if (iLocal_353 == 0)
		{
			...
			DLC::IS_DLC_PRESENT(1f);
			DLC::IS_DLC_PRESENT(0f);
			func_276("TRV4_NEWS2");
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_305, "SET_SCROLL_TEXT");
			DLC::IS_DLC_PRESENT(0f);
			...
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_305, "SET_SCROLL_TEXT");
			DLC::IS_DLC_PRESENT(0f);
			DLC::IS_DLC_PRESENT(2f);
			func_276("TRV4_NEWS8");
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_305, "SET_SCROLL_TEXT");
			DLC::IS_DLC_PRESENT(0f);
			DLC::IS_DLC_PRESENT(3f);
			func_276("TRV4_NEWS9");
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_305, "SET_SCROLL_TEXT");
			DLC::IS_DLC_PRESENT(0f);
			DLC::IS_DLC_PRESENT(4f);
		...
		if (iLocal_354 == 0)
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
				{
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 25000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 50000f)
					{
						GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_305, "SET_SCROLL_TEXT");
						DLC::IS_DLC_PRESENT(1f);
						DLC::IS_DLC_PRESENT(1f);
		...
		if (iLocal_355 == 0)
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
				{
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 77600f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 115000f)
					{
						GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_305, "SET_SCROLL_TEXT");
						DLC::IS_DLC_PRESENT(1f);
						DLC::IS_DLC_PRESENT(2f);
		...
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING(iLocal_305, 255, 255, 255, 0, 0);
		if (iLocal_334 == 0)
		{
			func_226(1, 1, 1, 0);
		...
		MONEY::NETWORK_MONEY_CAN_BET(0, 85, true);
...
void func_275()
{
	...
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_228);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	iLocal_228++;
}
...
void func_277(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4)
{
	...
	else if (bParam0)
	{
		...
		if (iLocal_48 <= iParam2 && iLocal_43 == 0)
		{
			...
			{
				iLocal_43 = 1;
				bLocal_49 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(iParam3, iParam2);
			}
		}
		else if (iLocal_48 > 0)
		{
			if (iLocal_48 > bLocal_49)
			{
...
void func_279(bool bParam0)
{
	if (iParam0 < 32)
	{
		unk_0xBE20AB8238688965(&bLocal_54, iParam0);
	}
}

int func_280(bool bParam0)
{
	if (unk_0xCE990E643CD9D0E5(bLocal_54, iParam0))
	{
		return 1;
	}
	return 0;
...
void func_281(bool bParam0, int iParam1)
{
	...
	else if (bParam0)
	{
		...
		bLocal_45 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 4);
...
{
	if (NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 50) > 25)
	{
		bLocal_40 = true;
	}
	else
	...
	return NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, iParam0);
}
...
int func_286(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_291(bParam1, bParam2, bParam3) || SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1) || func_288(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
int func_301(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_307() || func_306(Global_4456448.f_129348)) || func_305())
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(bVar0, iVar1) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("apc") && iVar1 != -1)) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("akula") && iVar1 != -1)) || (((MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("riot2") && iVar1 == 0) && func_303(bVar0, 10)) && unk_0x7F8B14CBFB9813E5(bVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_309(int iParam0, bool bParam1, float fParam2)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam1, 0))
	{
		if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bParam1))
		{
			VEHICLE::SET_PLAYBACK_SPEED(bParam1, fParam2);
			Var0 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam1, 1) };
			Var1 = { NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(bParam1, 2) };
...
void func_310(int iParam0, bool bParam1, char* sParam2, int iParam3)
{
	struct<3> Var0;
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam1, 0))
	{
		...
		ENTITY::SET_ENTITY_PROOFS(bParam1, true, true, true, true, true, false, false, false);
		VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(bParam1, iParam3, sParam2, true);
		Var0 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam1, 1) };
		CAM::SET_CAM_COORD(iParam0, Var0);
		CAM::SET_CAM_ROT(iParam0, NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(bParam1, 2), 2);
	}
}
...
void func_311()
{
	if (fLocal_260 != -1)
	{
		if (iLocal_382 == 1)
		{
			if (iLocal_374 == 0)
			{
				AUDIO::RELEASE_SOUND_ID(fLocal_260);
				iLocal_384 = 0;
				iLocal_374 = 1;
			}
		}
	...
	if (fLocal_255 != -1)
	{
		if (iLocal_378 == 1)
		{
			if (iLocal_376 == 0)
			{
				AUDIO::RELEASE_SOUND_ID(fLocal_255);
				iLocal_385 = 0;
				iLocal_376 = 1;
			}
		}
	...
	if (fLocal_256 != -1)
	{
		if (iLocal_383 == 1)
		{
			if (iLocal_365 == 0)
			{
				AUDIO::RELEASE_SOUND_ID(fLocal_256);
				iLocal_386 = 0;
				iLocal_365 = 1;
			}
		}
	...
	if (fLocal_257 != -1)
	{
		if (iLocal_379 == 1)
		{
			if (iLocal_375 == 0)
			{
				AUDIO::RELEASE_SOUND_ID(fLocal_257);
				iLocal_387 = 0;
				iLocal_375 = 1;
			}
		}
	...
	if (fLocal_258 != -1)
	{
		if (iLocal_380 == 1)
		{
			if (iLocal_377 == 0)
			{
				AUDIO::RELEASE_SOUND_ID(fLocal_258);
				iLocal_388 = 0;
				iLocal_377 = 1;
			}
		}
...
void func_312()
{
	if (MISC::IS_BIT_SET(iLocal_204[19]))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[19], 0))
		{
	...
	if (MISC::IS_BIT_SET(iLocal_204[8]))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[8], 0))
		{
	...
	if (MISC::IS_BIT_SET(iLocal_204[9]))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[9], 0))
		{
	...
	if (MISC::IS_BIT_SET(iLocal_204[10]))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[10], 0))
		{
	...
	if (MISC::IS_BIT_SET(iLocal_204[11]))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[11], 0))
		{
	...
	if (MISC::IS_BIT_SET(iLocal_204[13]))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[13], 0))
		{
	...
	if (MISC::IS_BIT_SET(iLocal_204[14]))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[14], 0))
		{
	...
	if (MISC::IS_BIT_SET(iLocal_204[15]))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[15], 0))
		{
	...
	if (MISC::IS_BIT_SET(iLocal_204[16]))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[16], 0))
		{
	...
	if (MISC::IS_BIT_SET(iLocal_204[17]))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[17], 0))
		{
...
void func_313()
{
	...
	{
		if (VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) > 40f)
		{
			fLocal_322 = 0.85f;
		}
		else
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_278, 0))
	{
		if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
			{
				if (iLocal_357 == 0)
				{
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 10000f)
					{
						if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_278, 1) < 100f || ENTITY::IS_ENTITY_ON_SCREEN(bLocal_278))
						{
							func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 40f, 55f, 100f, 1.7f, 1f, fLocal_322, 0);
							VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
							func_314(bLocal_278, fLocal_321);
						}
						else
						{
							func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 0.6f, 40f, 50f, 60f, 1.7f, 1f, fLocal_322, 0);
							VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
							func_314(bLocal_278, fLocal_321);
						}
					}
				}
				else if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_278, 1) > 175f)
				{
					fLocal_321 = 0.6f;
					VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
					func_314(bLocal_278, fLocal_321);
				}
				else if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 10000f)
				{
					func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 25f, 40f, 180f, 1.7f, 1f, fLocal_322, 0);
					VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
					func_314(bLocal_278, fLocal_321);
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 10000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 23000f)
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[8], false))
					{
					...
					{
						func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 25f, 35f, 180f, 1.7f, 0.5f, fLocal_322, 1);
						VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
						func_314(bLocal_278, fLocal_321);
					}
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 23000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 32000f)
				{
					if (MISC::IS_BIT_SET(iLocal_204[7]))
					{
						if (ENTITY::GET_ENTITY_COORDS(iLocal_204[7], false))
						{
							func_340(iLocal_204[7], unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 20f, 30f, 100f, 1.8f, 1f, fLocal_322, 0);
							VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
							func_314(bLocal_278, fLocal_321);
						}
						else if (MISC::IS_BIT_SET(iLocal_204[8]))
						{
							if (ENTITY::GET_ENTITY_COORDS(iLocal_204[8], false))
							{
							...
							{
								func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 25f, 40f, 100f, 1.8f, 1f, fLocal_322, 0);
								VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
								func_314(bLocal_278, fLocal_321);
							}
						}
				...
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 32000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 39000f)
				{
					if (MISC::IS_BIT_SET(iLocal_204[7]))
					{
						if (ENTITY::GET_ENTITY_COORDS(iLocal_204[7], false))
						...
						{
							func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 25f, 35f, 150f, 1.8f, 0.5f, fLocal_322, 1);
							VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
							func_314(bLocal_278, fLocal_321);
						}
					}
				...
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 39000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 56000f)
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[8], false))
					{
					...
					{
						func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 25f, 35f, 150f, 1.8f, 1f, fLocal_322, 0);
						VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
						func_314(bLocal_278, fLocal_321);
					}
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 56000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 65000f)
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[11], false))
					{
					...
					{
						func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 25f, 35f, 100f, 1.8f, 1f, fLocal_322, 0);
						VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
						func_314(bLocal_278, fLocal_321);
					}
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 65000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 90000f)
				{
					if (MISC::IS_BIT_SET(iLocal_204[13]))
					{
						if (ENTITY::GET_ENTITY_COORDS(iLocal_204[13], false))
						...
						{
							func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 45f, 55f, 150f, 1.8f, 1f, fLocal_322, 0);
							VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
							func_314(bLocal_278, fLocal_321);
						}
					}
				...
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 90000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 110000f)
				{
					func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 60f, 70f, 150f, 1.5f, 0.5f, fLocal_322, 1);
					VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
					func_314(bLocal_278, fLocal_321);
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 110000f)
				{
					func_340(bLocal_278, unk_0x9B0761B4C3EB8BC7(), &fLocal_321, 1f, 100f, 120f, 150f, 1.6f, 1f, fLocal_322, 0);
					VEHICLE::SET_PLAYBACK_SPEED(bLocal_278, fLocal_321);
					func_314(bLocal_278, fLocal_321);
				}
			}
	...
	if (!bLocal_81)
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bParam0))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
				{
					if (func_338(unk_0x9B0761B4C3EB8BC7(), bParam0))
					{
						iLocal_86 = 1;
					}
					else
				...
				fLocal_130 = VEHICLE::GET_TIME_POSITION_IN_RECORDING(bParam0);
				VEHICLE::SET_PLAYBACK_SPEED(bParam0, ((fParam1 * fLocal_131) * fLocal_133));
				if (bLocal_85)
				{
					func_337(bParam0, fLocal_130);
					func_336(bParam0, fLocal_140);
					if (fLocal_135 > 1000f)
					{
						if (iLocal_172 == 0)
						{
							func_335(bParam0, fLocal_140);
						}
						fVar0 = ((fLocal_130 + 4000f) + (SYSTEM::TO_FLOAT(iLocal_172) * 2000f));
						func_334(bParam0, fVar0, bLocal_134);
						iLocal_172++;
						if (iLocal_172 > 2)
						{
							fLocal_135 = 0f;
		...
		if (fLocal_130 == 0f || PED::REMOVE_SCENARIO_BLOCKING_AREA())
		{
			iVar2 = 1;
		}
		if (iVar2 && !bLocal_93)
		{
			if (!iLocal_75)
			{
				func_331(bParam0, ((fParam1 * fLocal_131) * fLocal_133), 0);
				if (!iLocal_96)
				{
				}
				iLocal_96 = 0;
			...
			if (!iLocal_75)
			{
				func_317(bParam0, ((fParam1 * fLocal_131) * fLocal_133), 0);
			}
		}
		if (iLocal_83)
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
			{
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					bLocal_206 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
					Local_176 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_206, 1) };
					ENTITY::GET_ENTITY_QUATERNION(bLocal_206, &fLocal_114, &fLocal_115, &fLocal_116, &fLocal_117);
				}
			}
			iLocal_83 = 0;
		}
		if (iLocal_82)
		{
			if (MISC::IS_BIT_SET(bLocal_206))
			{
				func_201(bLocal_207);
				bLocal_207 = bLocal_206;
			}
			if (ENTITY::GET_ENTITY_COORDS(bLocal_207, false))
			{
				unk_0x03D382CB0B44E2FC(bLocal_207, Local_176, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_QUATERNION(bLocal_207, fLocal_114, fLocal_115, fLocal_116, fLocal_117);
			}
		...
		if (iLocal_75)
		{
			while (!func_315(&bParam0, fLocal_129))
			{
				SYSTEM::WAIT(0);
			}
			iLocal_76 = 1;
...
int func_315(bool bParam0, float fParam1)
{
	if (!iLocal_90)
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(*bParam0, false))
		{
			...
			if (!iLocal_159 == -1)
			{
				while (!func_316(bParam0, iLocal_159, fParam1, 1, 0, 0, 0, 0))
				{
					SYSTEM::WAIT(0);
				}
				if (!bLocal_80)
	...
	else
	{
		if (ENTITY::GET_ENTITY_COORDS(*bParam0, false))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(*bParam0))
			{
				VEHICLE::SET_PLAYBACK_SPEED(*bParam0, ((1f * fLocal_131) * fLocal_133));
				func_316(bParam0, iLocal_159, fParam1, 1, 0, 0, 0, 0);
			}
		}
		fLocal_130 = fParam1;
		iLocal_166 = 0;
		...
		fLocal_145 = 0f;
		fLocal_144 = 0f;
		func_317(*bParam0, ((1f * fLocal_131) * fLocal_133), 1);
		func_331(*bParam0, ((1f * fLocal_131) * fLocal_133), 1);
		func_330(*bParam0);
...
void func_317(bool bParam0, float fParam1, bool bParam2)
{
	...
	bVar9 = ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID());
	...
	if (bVar9)
	{
		...
		Var5 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
	}
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		iVar0 = iLocal_162;
		while (iVar0 < 35)
		{
			if (iLocal_153[iVar0] != 99)
			{
					...
					if (iLocal_152[iVar0] > 0)
					{
						if (!iLocal_75)
						{
							if (fLocal_130 > (fLocal_122[iVar0] - (7000f * fParam1)))
							{
								...
								{
									unk_0xBE20AB8238688965(&(iLocal_154[iVar0]), false);
								}
								else if (MONEY::NETWORK_SPENT_BULL_SHARK(iLocal_197[iVar0]))
								{
									unk_0xBE20AB8238688965(&(iLocal_154[iVar0]), 2);
								}
								VEHICLE::IS_VEHICLE_DRIVEABLE(&(iLocal_154[iVar0]), true);
								iLocal_153[iVar0]++;
								iLocal_164++;
							}
						}
				...
				else if (iLocal_153[iVar0] == 1)
				{
					...
					if (unk_0xCE990E643CD9D0E5(iLocal_154[iVar0], false))
					{
						unk_0x78FCB2E22C41B9D5(func_205());
						bVar8 = ENTITY::DOES_ENTITY_EXIST(func_205());
					}
					else if (!bLocal_102 && ((!unk_0xCE990E643CD9D0E5(iLocal_154[iVar0], 2) && bVar10) || (unk_0xCE990E643CD9D0E5(iLocal_154[iVar0], 2) && bVar11)))
					{
						bVar8 = true;
					}
					else
					{
						...
						bVar8 = ENTITY::DOES_ENTITY_EXIST(func_208());
					}
					if (bVar8)
					{
						if (!MISC::IS_BIT_SET(iLocal_204[iVar0]))
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_197[iVar0]) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_152[iVar0], &cLocal_185))
							{
								if (fLocal_130 >= (fLocal_122[iVar0] - (fLocal_143 * fParam1)))
								{
									if ((iLocal_89 || bParam2) || (!bLocal_106 && !func_327(Local_175[iVar0 /*3*/], Var5, 5f, fLocal_141)))
									{
										if (bLocal_85)
										{
											func_326(Local_175[iVar0 /*3*/], Var5, bLocal_134);
										}
										...
										if (uLocal_98 && !unk_0xCE990E643CD9D0E5(iLocal_154[iVar0], false))
										{
										...
										if (MONEY::NETWORK_SPENT_HIRE_MERCENARY(iLocal_197[iVar0]) || MONEY::NETWORK_SPENT_BULL_SHARK(iLocal_197[iVar0]))
										{
										...
										if (!unk_0xCE990E643CD9D0E5(iLocal_154[iVar0], false))
										{
											...
											if (CLOCK::GET_CLOCK_DAY_OF_MONTH() > 19 || CLOCK::GET_CLOCK_DAY_OF_MONTH() < 7)
											{
												VEHICLE::SET_VEHICLE_LIGHTS(iLocal_204[iVar0], 3);
											}
										}
										ENTITY::SET_ENTITY_COORDS(iLocal_204[iVar0], 1);
										unk_0x74528AC0906CBABE(iLocal_197[iVar0]);
						...
						else if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[iVar0], 0) && ENTITY::GET_ENTITY_COORDS(iLocal_204[iVar0], false))
						{
							ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_204[iVar0], Local_175[iVar0 /*3*/], false, false, true);
							ENTITY::SET_ENTITY_QUATERNION(iLocal_204[iVar0], fLocal_118[iVar0], fLocal_119[iVar0], fLocal_120[iVar0], fLocal_121[iVar0]);
							if (MONEY::NETWORK_SPENT_HIRE_MERCENARY(iLocal_197[iVar0]) || MONEY::NETWORK_SPENT_BULL_SHARK(iLocal_197[iVar0]))
				...
				{
					VEHICLE::REQUEST_VEHICLE_RECORDING(iLocal_152[iVar0], &cLocal_185);
					if (!unk_0xCE990E643CD9D0E5(iLocal_154[iVar0], true))
					{
						bVar8 = false;
						if (unk_0xCE990E643CD9D0E5(iLocal_154[iVar0], false))
						{
						...
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_204[iVar0], 0))
						{
							if (!bLocal_106 && SYSTEM::VDIST2(iLocal_204[iVar0], -1, 0))
							{
								if (bVar8)
								{
									if ((SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_204[iVar0], 1), Var5) < 10000f || bParam2) || iLocal_89)
									{
										func_323(&(iLocal_204[iVar0]), iVar13, 1);
										unk_0xBE20AB8238688965(&(iLocal_154[iVar0]), true);
									}
								}
							}
						}
						...
						if (fLocal_130 >= fLocal_122[iVar0])
						{
							if (14 > iLocal_157)
							{
								...
								if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_152[iVar0], &cLocal_185))
								{
									...
									{
										Var3 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_204[iVar0], 1) };
										...
										else if (((!bLocal_106 || unk_0xCE990E643CD9D0E5(iLocal_154[iVar0], true)) || iLocal_89) || bParam2)
										{
											if (func_316(&(iLocal_204[iVar0]), iLocal_152[iVar0], fVar6, 1, 0, 0, bLocal_104, bLocal_103))
											{
												...
												if (ENTITY::GET_ENTITY_COORDS(iLocal_204[iVar0], false))
												{
													if (unk_0xCE990E643CD9D0E5(iLocal_154[iVar0], false))
													{
														...
														if (!MONEY::NETWORK_SPENT_BULL_SHARK(iLocal_197[iVar0]))
														{
					...
					if (ENTITY::GET_ENTITY_COORDS(iLocal_204[iVar0], false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[iVar0]))
						{
							...
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar1))
							{
								if (bVar9)
								{
									if (((!bLocal_79 && !iLocal_76) && !bLocal_95) && (((!bLocal_104 && !bLocal_103) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_204[iVar0])) || func_322(iLocal_204[iVar0])))
									{
										if (MISC::IS_BIT_SET(bVar2))
										{
											...
											{
												bVar7 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(bVar2);
												if (bVar7 < 1f)
												{
													bVar8 = true;
												}
												else if (ENTITY::IS_ENTITY_PLAYING_ANIM((bVar7 - ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_204[iVar0]))) > 15f)
												{
													bVar8 = true;
												}
												else if (!func_321(iLocal_204[iVar0], bVar2, 45f))
												{
													bVar8 = true;
												}
												else if (func_319(bVar2, iLocal_204[iVar0], 0))
												{
													bVar8 = true;
												}
											}
				...
				else if (iLocal_153[iVar0] == 5)
				{
					if (!iLocal_204[iVar0] == iLocal_208)
					{
						if (ENTITY::GET_ENTITY_COORDS(iLocal_204[iVar0], false))
						{
							...
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar1))
							{
								iVar14 = TASK::GET_SCRIPT_TASK_STATUS(bVar1, 242628503);
								if (iVar14 == 7)
								{
									bVar7 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_204[iVar0]);
									if (bVar7 < 8f)
									{
										bVar7 = 8f;
									}
									...
									TASK::SET_DRIVE_TASK_CRUISE_SPEED(bVar1, bVar7);
								}
							}
						}
						if (!bLocal_87 && !bLocal_100)
						...
						else if (MISC::IS_BIT_SET(iLocal_204[iVar0]))
						{
							VEHICLE::DELETE_VEHICLE(&(iLocal_204[iVar0]));
						}
					}
...
void func_318(bool bParam0)
{
	...
	{
		func_202(bParam0);
		VEHICLE::SET_PLAYBACK_TO_USE_AI(bParam0, 786603);
	}
}
...
int func_319(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam1, false))
	{
		...
		if (bParam2)
		{
			Var5 = { ENTITY::GET_ENTITY_VELOCITY(bParam1) };
			Var4 = { Var5 / FtoV(SYSTEM::VMAG(Var5)) };
		}
		else
		{
			Var2 = { unk_0x7EC595B99EA7C4B1(bParam1, 0f, 5f, 0f) };
			Var4 = { Var2 - Var1 };
		}
	}
	Var3 = { Var1 - Var0 };
...
int func_321(bool bParam0, bool bParam1, float fParam2)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		Var0 = { ENTITY::GET_ENTITY_SPEED_VECTOR(bParam0, false) };
	}
	else
	{
		return 0;
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam1, false))
	{
		Var1 = { ENTITY::GET_ENTITY_SPEED_VECTOR(bParam1, false) };
	}
	else
	{
		return 0;
...
int func_322(int iParam0)
{
	...
	if (bLocal_101)
	{
		...
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar1, 0))
		{
			...
			if (fVar2 == joaat("phantom"))
			{
				if (VEHICLE::GET_VEHICLE_TRAILER_VEHICLE(bVar1))
				{
					if (unk_0xFF88B5221E8464D2(bVar1, &bVar0))
					{
						if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
						{
							if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(bVar0, iParam0))
							{
								return 1;
							}
						}
...
int func_323(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(*uParam0, 0))
	{
		if (SYSTEM::VDIST2(*uParam0, -1, 0))
		{
			if (iParam1 == 2)
			{
				bVar0 = PED::CREATE_PED_INSIDE_VEHICLE(*uParam0, 6, func_205(), -1, false, false);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(bVar0, iLocal_194);
				unk_0x74528AC0906CBABE(func_205());
			}
			else if (iParam1 == 1)
			{
				bVar0 = PED::CREATE_RANDOM_PED_AS_DRIVER(*uParam0, true);
				if (MONEY::NETWORK_SPENT_BULL_SHARK(MISC::GET_MODEL_DIMENSIONS(*uParam0)))
				{
					PED::GIVE_PED_HELMET(bVar0, true, 4096, -1);
				}
			}
			else
			{
				bVar0 = PED::CREATE_PED_INSIDE_VEHICLE(*uParam0, 4, func_208(), -1, false, false);
				if (bLocal_107)
				{
					unk_0x74528AC0906CBABE(func_208());
				}
			...
			if (bParam2)
			{
				ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(bVar0, true);
				PED::SET_PED_SUFFERS_CRITICAL_HITS(bVar0, false);
				PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bVar0, 4.484155E-44f, 0);
			}
			if (bLocal_108)
			{
				PED::SET_PED_FLEE_ATTRIBUTES(bVar0, 8192, true);
				PED::SET_PED_FLEE_ATTRIBUTES(bVar0, 65536, true);
				PED::SET_PED_FLEE_ATTRIBUTES(bVar0, 2, false);
				VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(*uParam0, true);
			}
			PED::_0x2208438012482A1A(bVar0, 1);
			func_324(bVar0);
			bLocal_106 = true;
			return 1;
		}
...
void func_325(bool bParam0)
{
	...
	bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 12);
	...
	{
		case 0:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 0, 0);
			break;
		
		case 1:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 2, 2);
			break;
		
		case 2:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 4, 4);
			break;
		
		case 3:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 27, 27);
			break;
		
		case 4:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 7, 7);
			break;
		
		case 5:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 73, 73);
			break;
		
		case 6:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 68, 68);
			break;
		
		case 7:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 62, 62);
			break;
		
		case 8:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 132, 132);
			break;
		
		case 9:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 117, 0);
			break;
		
		case 10:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 52, 52);
			break;
		
		case 11:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 88, 88);
			break;
		
		case 12:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 1, 1);
			break;
		
		case 13:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 36, 36);
			break;
		
		case 14:
			VEHICLE::SET_VEHICLE_COLOURS(bParam0, 95, 95);
			break;
...
void func_326(struct<3> Param0, struct<3> Param1, bool bParam2)
{
	bool bVar0;
	bool bVar1;
	...
	if (!bLocal_88)
	{
		if (!func_327(Param0, Param1, bParam2, 200f))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
			{
				bVar1 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar1, 0))
				{
					if (unk_0xC2169C00B643278B(bVar1, Param0, bParam2, bParam2, bParam2, 0, 1, 0))
					{
						bVar0 = false;
					}
				}
			...
			if (bVar0)
			{
				MISC::CLEAR_AREA_OF_VEHICLES(Param0, bParam2, false, false, false, false, false, false);
			}
		}
	}
}
		...
		while (iVar0 < 15)
		{
			switch (iLocal_155[iVar0])
			{
				case 0:
					if (!iLocal_196[iVar0] == 0)
					{
						if (unk_0xC2169C00B643278B(bParam0, Local_174[iVar0 /*3*/], fLocal_128, fLocal_128, fLocal_128, 0, 1, 0))
						{
							iLocal_163++;
							iLocal_155[iVar0]++;
						}
						...
						if (!MISC::IS_BIT_SET(iLocal_203[iVar0]))
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_196[iVar0]))
							{
								if ((iLocal_75 || iLocal_89) || (!bLocal_106 && !func_327(Local_174[iVar0 /*3*/], Var1, 5f, fLocal_141)))
								{
									if (bLocal_85)
									{
										func_326(Local_174[iVar0 /*3*/], Var1, bLocal_134);
									}
									...
									if (VEHICLE::IS_VEHICLE_MODEL(iLocal_203[iVar0], func_206()))
									{
										...
										if (!MONEY::NETWORK_SPENT_BULL_SHARK(iLocal_196[iVar0]))
										{
				...
				case 2:
					if (!bVar3)
					{
						if (ENTITY::GET_ENTITY_COORDS(iLocal_203[iVar0], false))
						{
							Var2 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_203[iVar0], 1) };
						}
						if (fLocal_142 == 0f || SYSTEM::VDIST2(Var1, Var2) < (fLocal_142 * fLocal_142))
						{
							if (!func_319(iLocal_203[iVar0], bParam0, 0))
							{
								if (!bLocal_77)
								{
									func_201(iLocal_203[iVar0]);
...
void func_331(bool bParam0, float fParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	bVar5 = false;
	bVar12 = ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID());
	...
	if (bVar12)
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			bVar5 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
		}
		Var8 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
	}
	iVar1 = 0;
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		while (iVar0 < 175 && !bVar17)
		{
			if (iLocal_150[iVar0] != 99)
			{
						...
						if (!iLocal_75)
						{
							if (fLocal_130 < (fLocal_113[iVar0] + 20000f))
							{
								if (fLocal_130 >= (fLocal_113[iVar0] - (7000f * fParam1)))
								{
									...
									{
										unk_0xBE20AB8238688965(&(iLocal_151[iVar0]), false);
									}
									else if (MONEY::NETWORK_SPENT_BULL_SHARK(iLocal_195[iVar0]))
									{
										unk_0xBE20AB8238688965(&(iLocal_151[iVar0]), 2);
									}
									VEHICLE::IS_VEHICLE_DRIVEABLE(&(iLocal_151[iVar0]), true);
									iLocal_165++;
									iLocal_150[iVar0]++;
								}
								else if (iVar1 > 2)
				...
				else if (iLocal_150[iVar0] == 1)
				{
					...
					bVar11 = false;
					if (unk_0xCE990E643CD9D0E5(iLocal_151[iVar0], false))
					{
						unk_0x78FCB2E22C41B9D5(func_205());
					...
					else if (!bLocal_102 && ((!unk_0xCE990E643CD9D0E5(iLocal_151[iVar0], 2) && bVar13) || (unk_0xCE990E643CD9D0E5(iLocal_151[iVar0], 2) && bVar14)))
					{
						bVar11 = true;
					}
					else
					{
						unk_0x78FCB2E22C41B9D5(func_208());
						bVar11 = ENTITY::DOES_ENTITY_EXIST(func_208());
					}
					if (!MISC::IS_BIT_SET(iLocal_201[iVar0]))
					{
						unk_0x78FCB2E22C41B9D5(iLocal_195[iVar0]);
						if ((ENTITY::DOES_ENTITY_EXIST(iLocal_195[iVar0]) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_149[iVar0], &cLocal_185)) && bVar11)
						{
							if (fLocal_130 >= (fLocal_113[iVar0] - (fLocal_143 * fParam1)))
							{
								if ((iLocal_89 || iParam2) || (!bLocal_106 && !func_327(Local_173[iVar0 /*3*/], Var8, 5f, fLocal_141)))
								{
									if (bLocal_85)
									{
										func_326(Local_173[iVar0 /*3*/], Var8, bLocal_134);
									}
									...
									if (uLocal_98 && !unk_0xCE990E643CD9D0E5(iLocal_151[iVar0], false))
									{
									...
									if (MONEY::NETWORK_SPENT_HIRE_MERCENARY(iLocal_195[iVar0]) || MONEY::NETWORK_SPENT_BULL_SHARK(iLocal_195[iVar0]))
									{
									...
									ENTITY::SET_ENTITY_COORDS(iLocal_201[iVar0], 1);
				...
				else if (iLocal_150[iVar0] == 2)
				{
					...
					{
						if (!unk_0xCE990E643CD9D0E5(iLocal_151[iVar0], true))
						{
							if (unk_0xCE990E643CD9D0E5(iLocal_151[iVar0], false))
							{
								unk_0x78FCB2E22C41B9D5(func_205());
								bVar11 = ENTITY::DOES_ENTITY_EXIST(func_205());
								iVar15 = 2;
							}
							else if (!bLocal_102 && ((!unk_0xCE990E643CD9D0E5(iLocal_151[iVar0], 2) && bVar13) || (unk_0xCE990E643CD9D0E5(iLocal_151[iVar0], 2) && bVar14)))
							{
							...
							if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_201[iVar0], 0))
							{
								if (!bLocal_106 && SYSTEM::VDIST2(iLocal_201[iVar0], -1, 0))
								{
									if (bVar11)
									{
										if ((SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_201[iVar0], 1), Var8) < 10000f || iParam2) || iLocal_89)
										{
											func_323(&(iLocal_201[iVar0]), iVar15, 0);
											unk_0xBE20AB8238688965(&(iLocal_151[iVar0]), true);
										}
									}
								}
							}
							...
							if (fLocal_130 >= fLocal_113[iVar0])
							{
								if (12 > iLocal_156)
								{
									...
									if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_149[iVar0], &cLocal_185))
									{
										...
										{
											Var6 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_201[iVar0], 1) };
											...
											else if (((!bLocal_106 || unk_0xCE990E643CD9D0E5(iLocal_151[iVar0], true)) || iLocal_89) || iParam2)
											{
				...
				else if (iLocal_150[iVar0] == 3)
				{
					if (ENTITY::GET_ENTITY_COORDS(iLocal_201[iVar0], false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_201[iVar0]))
						{
							bVar4 = MISC::IS_MINIGAME_IN_PROGRESS(iLocal_201[iVar0], -1, 0);
								...
								if (bVar12)
								{
									...
									if (!bLocal_84)
									{
										if ((!bLocal_79 && !iLocal_76) && func_322(iLocal_201[iVar0]))
										{
											...
											{
												if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar5, 0))
												{
													bVar11 = false;
													if (!func_332(iLocal_201[iVar0], bVar5) || func_319(bVar5, iLocal_201[iVar0], 0))
													{
														bVar18 = true;
													}
												}
										...
										{
											Var19 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(bParam0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_201[iVar0], 1)) };
											if (Var19.f_1 < 0f)
											{
												if (ENTITY::IS_ENTITY_PLAYING_ANIM(Var19.f_1) > ENTITY::IS_ENTITY_PLAYING_ANIM(Var19.x))
												{
													bVar18 = true;
												}
											}
				...
				else if (iLocal_150[iVar0] == 5)
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_201[iVar0], 0))
					{
						bVar10 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_201[iVar0]);
					}
					iLocal_156 = (iLocal_156 - 1);
					func_333(iVar0, bVar10);
				}
				if (iVar16 == -1)
				{
					iVar16 = iVar0;
...
void func_333(int iParam0, bool bParam1)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_201[iParam0], 0))
	{
		ENTITY::SET_ENTITY_COLLISION(iLocal_201[iParam0], true, false);
		ENTITY::SET_ENTITY_COORDS(iLocal_201[iParam0], 0);
		bVar0 = MISC::IS_MINIGAME_IN_PROGRESS(iLocal_201[iParam0], -1, 0);
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar0) && bVar0 != unk_0x9B0761B4C3EB8BC7())
		{
			PED::_0x2208438012482A1A(bVar0, 0);
			if (bParam1 < 8f)
			{
				bParam1 = 8f;
			}
			...
			TASK::TASK_VEHICLE_MISSION(bVar0, iLocal_201[iParam0], 0, 1, bParam1, 786603, 5f, 5f, true);
			PED::SET_PED_FLEE_ATTRIBUTES(bVar0, 8192, true);
			if (bLocal_108)
			{
				PED::SET_PED_FLEE_ATTRIBUTES(bVar0, 65536, true);
			...
			PED::SET_PED_COMBAT_ATTRIBUTES(bVar0, 6, false);
			TASK::SET_DRIVE_TASK_CRUISE_SPEED(bVar0, bParam1);
		}
	}
	if (!bLocal_77)
	{
	...
	else
	{
		...
		if (MISC::IS_BIT_SET(iLocal_201[iParam0]))
		{
...
void func_334(bool bParam0, float fParam1, float fParam2)
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		Var4 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
	}
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bParam0))
		{
			...
			Var2 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1) };
			Var3 = { Var2 - Var1 };
			bVar5 = SYSTEM::VMAG(Var3);
			if (bVar5 > fParam2)
			{
				bVar5 = fParam2;
			}
			func_326(Var1, Var4, bVar5);
		}
	}
}
...
void func_335(bool bParam0, float fParam1)
{
	if (!bLocal_88)
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
			{
				if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) > (fParam1 * fParam1))
				{
...
void func_337(bool bParam0, float fParam1)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0) && VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bParam0))
	{
		...
		if (fVar1 < (fParam1 + 25000f))
		{
			...
			if (fVar1 <= VEHICLE::GET_TOTAL_DURATION_OF_VEHICLE_RECORDING_ID(iVar0))
			{
				...
				else if (!bLocal_106)
				{
					...
					Local_182 = { Local_182 + Vector(fLocal_148, fLocal_148, fLocal_148) };
					PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_181, Local_182, 0, 0);
					fLocal_144 = fVar1;
					iLocal_166 = 0;
				}
			}
...
int func_338(bool bParam0, bool bParam1)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam1, 0))
		{
			if (unk_0xE0B3BC41DDA88DF0(bParam0, bParam1, 0))
			{
				return 0;
			}
		}
...
void func_340(bool bParam0, bool bParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, bool bParam10)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (bParam10)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam1))
		{
			if (SYSTEM::VDIST(bParam1, 0))
			{
				bVar9 = ENTITY::GET_ENTITY_MODEL(bParam1, 0);
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar9, 0))
				{
					fVar10 = MISC::GET_MODEL_DIMENSIONS(bVar9);
					if (MONEY::NETWORK_SPENT_HIRE_MERCENARY(fVar10) || MONEY::NETWORK_SPENT_BULL_SHARK(fVar10))
					{
						if (ENTITY::GET_ENTITY_COORDS(bVar9, false))
						{
							fVar1 = fVar4;
							if (fVar1 < fParam3)
							{
...
float func_341(bool bParam0, bool bParam1)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam1, 0))
	{
		...
		if (SYSTEM::VDIST(bParam1, 0))
		{
			bVar5 = ENTITY::GET_ENTITY_MODEL(bParam1, 0);
			Var3.x = ENTITY::GET_ENTITY_FORWARD_X(bVar5);
			Var3.f_1 = ENTITY::GET_ENTITY_FORWARD_Y(bVar5);
		}
		else
		{
			Var2 = { unk_0x7EC595B99EA7C4B1(bParam1, 0f, 5f, 0f) };
...
float func_343(bool bParam0, bool bParam1)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam1, 0))
	{
		Var3 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam1, 1) };
	}
	Var1 = { Var3 - Var2 };
...
int func_344()
{
	...
	while (iLocal_232 <= 24)
	{
		if (MISC::IS_BIT_SET(iLocal_204[iLocal_232]))
		{
			if (ENTITY::GET_ENTITY_COORDS(iLocal_204[iLocal_232], false))
			{
...
void func_345()
{
	...
	{
		if (ENTITY::GET_ENTITY_COORDS(iLocal_204[4], false))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[4]))
			{
				Local_309 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
				Var1 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_204[4], 1) };
				if (Local_309.x < (Var1.x - 10f) && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_204[4]))
				{
					VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_204[4]);
					STREAMING::REMOVE_ANIM_DICT(&(iLocal_204[4]));
				}
			}
		}
	}
		...
		if (ENTITY::GET_ENTITY_COORDS(iLocal_204[0], false))
		{
			if (MISC::IS_BIT_SET(bLocal_278))
			{
				if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
					{
						if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 50000f && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_204[0]))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[0]))
							{
								VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_204[0]);
							}
							STREAMING::REMOVE_ANIM_DICT(&(iLocal_204[0]));
						}
					}
				}
			}
	...
	if (MISC::IS_BIT_SET(bLocal_282))
	{
		if (ENTITY::GET_ENTITY_COORDS(bLocal_282, false))
		{
			if (MISC::IS_BIT_SET(bLocal_278))
			{
				if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
					{
						if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 90000f && !ENTITY::IS_ENTITY_ON_SCREEN(bLocal_282))
						{
							GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_667[0], false);
							GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_667[1], false);
							GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_667[2], false);
							...
							STREAMING::REMOVE_ANIM_DICT(&bLocal_282);
							unk_0x1082C25039B168F8("missheist_agency3aig_lift_waitped_a");
						}
					}
				}
...
void func_346(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4)
{
	void fVar0;
	void fVar1;
	float fVar2;
...
void func_347()
{
	...
	{
		if (ENTITY::GET_ENTITY_COORDS(iLocal_204[2], false))
		{
			if (MISC::IS_BIT_SET(bLocal_278))
			{
				if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
					{
						if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 50530f)
						{
	...
	if (MISC::IS_BIT_SET(iLocal_280[0]))
	{
		if (ENTITY::GET_ENTITY_COORDS(iLocal_280[0], false))
		{
			...
			if (SYSTEM::VDIST2(iLocal_280[0], -1, 0))
			{
				if (!MISC::IS_BIT_SET(iLocal_276[0]))
				{
					unk_0x78FCB2E22C41B9D5(joaat("s_m_m_gentransport"));
					if (ENTITY::DOES_ENTITY_EXIST(joaat("s_m_m_gentransport")))
					{
	...
	if (MISC::IS_BIT_SET(iLocal_280[1]))
	{
		if (ENTITY::GET_ENTITY_COORDS(iLocal_280[1], false))
		{
			...
			if (SYSTEM::VDIST2(iLocal_280[1], -1, 0))
			{
				if (!MISC::IS_BIT_SET(iLocal_276[1]))
				{
					unk_0x78FCB2E22C41B9D5(joaat("s_m_m_gentransport"));
...
void func_348()
{
	if (iLocal_223 == 0)
	{
		...
		if (iLocal_385 == 0)
		{
			fLocal_255 = AUDIO::PLAY_SOUND_FROM_COORD();
			iLocal_385 = 1;
		}
		if (iLocal_386 == 0)
		{
			fLocal_256 = AUDIO::PLAY_SOUND_FROM_COORD();
			iLocal_386 = 1;
		}
		if (iLocal_387 == 0)
		{
			fLocal_257 = AUDIO::PLAY_SOUND_FROM_COORD();
			iLocal_387 = 1;
		}
		if (iLocal_388 == 0)
		{
			fLocal_258 = AUDIO::PLAY_SOUND_FROM_COORD();
			iLocal_388 = 1;
		}
		if (iLocal_389 == 0)
		{
			fLocal_259 = AUDIO::PLAY_SOUND_FROM_COORD();
			iLocal_389 = 1;
		}
		if (iLocal_384 == 0)
		{
			fLocal_260 = AUDIO::PLAY_SOUND_FROM_COORD();
			iLocal_384 = 1;
		}
		if (iLocal_390 == 0)
		{
			fLocal_261 = AUDIO::PLAY_SOUND_FROM_COORD();
			iLocal_390 = 1;
		}
		if (iLocal_343 == 1)
		{
		...
		PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(-482f, -2118f, 6f, -1072f, -2724f, 17f, 0, 1);
		func_126(2, 1);
	...
	if (iLocal_223 == 2)
	{
		if (!MISC::IS_BIT_SET(bLocal_287))
		{
			bLocal_287 = VEHICLE::CREATE_VEHICLE(joaat("blista"), 0f, 0f, 1f, 0f, true, true, false);
		}
		...
		if (PED::REMOVE_SCENARIO_BLOCKING_AREA())
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_279, false))
			{
				VEHICLE::SET_VEHICLE_ENGINE_ON(bLocal_279, true, true, false);
				VEHICLE::SET_VEHICLE_FORWARD_SPEED(bLocal_279, 30f);
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
			}
		}
		if (MISC::IS_BIT_SET(bLocal_278))
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(bLocal_278, 45, "BB_Chase", true);
				SYSTEM::SETTIMERB(0);
				func_268();
...
void func_350(char* sParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		...
		PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_177, Local_178, 0, 0);
		if (bParam2)
		{
...
void func_351()
{
	if (iLocal_223 == 0)
	{
		...
		PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(-617f, -2274f, 0f, -406.01f, -2044f, 15f, 0, 1);
		...
		if (PED::REMOVE_SCENARIO_BLOCKING_AREA())
		{
			...
			func_21(0, -1, 1);
			STREAMING::REMOVE_ANIM_DICT(&bLocal_279);
			STREAMING::REMOVE_ANIM_DICT(&bLocal_290);
			STREAMING::REMOVE_ANIM_DICT(&bLocal_291);
		}
		if (!GRAPHICS::DRAW_SCALEFORM_MOVIE())
		{
			CAM::DO_SCREEN_FADE_IN(800);
		...
		if (!SYSTEM::VMAG(bLocal_299))
		{
			bLocal_299 = func_356(Local_308, 0);
		}
	...
	if (iLocal_223 == 1)
	{
		...
		{
			if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_308, 1) < 800f)
			{
				bLocal_229 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 2);
				if (bLocal_229 == 0)
				{
		...
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_308, 1) < 600f)
		{
			if (!MISC::IS_BIT_SET(bLocal_278))
			{
				unk_0x78FCB2E22C41B9D5(joaat("cogcabrio"));
				if (ENTITY::DOES_ENTITY_EXIST(joaat("cogcabrio")))
				{
					bLocal_278 = VEHICLE::CREATE_VEHICLE(joaat("cogcabrio"), -428.0226f, -2153.558f, 9.2992f, 90.9098f, true, true, false);
					ENTITY::SET_ENTITY_PROOFS(bLocal_278, false, true, true, true, false, false, false, false);
					VEHICLE::SET_VEHICLE_COLOURS(bLocal_278, 27, 27);
					unk_0x74528AC0906CBABE(joaat("cogcabrio"));
					AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(bLocal_278, "SOL_3_MOLLY_CAR_Group", 0f);
				}
			...
			{
				unk_0x78FCB2E22C41B9D5(joaat("ig_molly"));
				if (ENTITY::DOES_ENTITY_EXIST(joaat("ig_molly")))
				{
					if (MISC::IS_BIT_SET(bLocal_278))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
		...
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_308, 1) < 500f)
		{
			if (iLocal_360 == 0)
			{
				iLocal_305 = unk_0x5DEA4192B46CB99B("BREAKING_NEWS");
		...
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			if (!MISC::IS_BIT_SET(bLocal_279))
			{
				bLocal_279 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
				ENTITY::SET_ENTITY_PROOFS(bLocal_279, false, true, false, false, false, false, false, false);
				VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(bLocal_279);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(bLocal_279, true);
			}
		}
		else if (MISC::IS_BIT_SET(bLocal_279))
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_279, false))
			{
				if (iLocal_359 == 0)
				{
					ENTITY::SET_ENTITY_PROOFS(bLocal_279, false, false, false, false, false, false, false, false);
					iLocal_359 = 1;
				}
				if (iLocal_351 == 1)
				{
					VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(bLocal_279);
					iLocal_351 = 0;
				}
				if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(bLocal_279, true))
				{
					STREAMING::REMOVE_ANIM_DICT(&bLocal_279);
				}
			}
		...
		if ((iLocal_360 == 1 && MISC::IS_BIT_SET(bLocal_278)) && MISC::IS_BIT_SET(bLocal_264))
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				if (WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(bLocal_278, func_353(unk_0x9B0761B4C3EB8BC7()), 0))
				{
					func_352();
					iLocal_223 = 0;
					iLocal_225 = 0;
			...
			if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_278))
				{
					func_352();
					iLocal_223 = 0;
					iLocal_225 = 0;
			...
			if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_278, 1), 200f, 132f, 100f, 0, 1, 0))
				{
					iLocal_357 = 0;
					func_352();
					iLocal_223 = 0;
...
void func_352()
{
	while (((!ENTITY::DOES_ENTITY_EXIST(joaat("police3")) || !ENTITY::DOES_ENTITY_EXIST(joaat("maverick"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("bison"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("blista")))
	{
		SYSTEM::WAIT(0);
	}
	while (((((!VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(45, "BB_Chase") || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(35, "BB_Chase")) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(2, "BB_Chase")) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(54, "BB_Chase")) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(55, "BB_Chase")) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(67, "BB_Chase"))
...
var func_353(bool bParam0)
{
	...
	MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(iParam0, &uVar0, 1);
	return uVar0;
}
...
bool func_356(struct<3> Param0, bool bParam1)
{
	int iVar0;
	
	iVar0 = HUD::ADD_BLIP_FOR_COORD(Param0);
	HUD::SET_BLIP_SCALE(iVar0, func_233(MISC::SET_BIT(), 1f, 1f));
			...
			switch (iLocal_225)
			{
				case 0:
					...
					if (func_401())
					{
						...
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
						func_220(1, 1, 1, 0, 0, 0, 0);
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(unk_0x9B0761B4C3EB8BC7(), "Michael", 0, 0, 0);
						if (MISC::IS_BIT_SET(Global_95452[0]))
						{
							if (ENTITY::GET_ENTITY_COORDS(Global_95452[0], false))
							{
								ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[0], true, true);
								bLocal_279 = Global_95452[0];
							}
						}
						if (MISC::IS_BIT_SET(Global_95452[1]))
						{
							if (ENTITY::GET_ENTITY_COORDS(Global_95452[1], false))
							{
								ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[1], true, true);
								bLocal_290 = Global_95452[1];
							}
						}
						if (MISC::IS_BIT_SET(Global_95452[2]))
						{
							if (ENTITY::GET_ENTITY_COORDS(Global_95452[2], false))
							{
								ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[2], true, true);
								bLocal_291 = Global_95452[2];
							}
						}
				...
				case 1:
					if (iLocal_416 == 0)
					{
						if (NETWORK::_0xC87E740D9F3872CC())
						{
							if (iLocal_437 == 0)
							{
								if (MISC::IS_BIT_SET(bLocal_292))
								{
									if (ENTITY::GET_ENTITY_COORDS(bLocal_292, false))
									{
										if (VEHICLE::IS_THIS_MODEL_A_HELI(MISC::GET_MODEL_DIMENSIONS(bLocal_292)))
										{
											VEHICLE::CONTROL_LANDING_GEAR(bLocal_292, 2);
											unk_0x03D382CB0B44E2FC(bLocal_292, -1048.722f, -506.8387f, 35.0386f, 1, 0, 0, 1);
											ENTITY::SET_ENTITY_HEADING(bLocal_292, 357.1288f);
											VEHICLE::SET_VEHICLE_DOORS_SHUT(bLocal_292, true);
											VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_292, 5f);
											func_362(-1048.722f, -506.8387f, 35.0386f, 357.1288f, 0, 145);
											iLocal_437 = 1;
										}
										if (((MONEY::NETWORK_SPENT_HIRE_MERCENARY(MISC::GET_MODEL_DIMENSIONS(bLocal_292)) || MONEY::NETWORK_SPENT_BULL_SHARK(MISC::GET_MODEL_DIMENSIONS(bLocal_292))) || MONEY::NETWORK_SPENT_BUY_REVEAL_PLAYERS(MISC::GET_MODEL_DIMENSIONS(bLocal_292))) || MONEY::NETWORK_SPENT_BUY_OFFTHERADAR(MISC::GET_MODEL_DIMENSIONS(bLocal_292)))
										{
											if ((((((((MISC::GET_MODEL_DIMENSIONS(bLocal_292) != joaat("bus") && MISC::GET_MODEL_DIMENSIONS(bLocal_292) != joaat("pounder")) && MISC::GET_MODEL_DIMENSIONS(bLocal_292) != joaat("packer")) && MISC::GET_MODEL_DIMENSIONS(bLocal_292) != joaat("airbus")) && MISC::GET_MODEL_DIMENSIONS(bLocal_292) != joaat("ambulance")) && MISC::GET_MODEL_DIMENSIONS(bLocal_292) != joaat("barracks")) && MISC::GET_MODEL_DIMENSIONS(bLocal_292) != joaat("barracks2")) && MISC::GET_MODEL_DIMENSIONS(bLocal_292) != joaat("benson")) && MISC::GET_MODEL_DIMENSIONS(bLocal_292) != joaat("biff"))
											{
												unk_0x03D382CB0B44E2FC(bLocal_292, -1027.657f, -486.6945f, 35.9571f, 1, 0, 0, 1);
												ENTITY::SET_ENTITY_HEADING(bLocal_292, 207.7515f);
												VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_292, 5f);
												func_362(-1027.657f, -486.6945f, 35.9571f, 207.7515f, 0, 145);
												iLocal_437 = 1;
											}
										}
										if ((((!VEHICLE::IS_THIS_MODEL_A_HELI(MISC::GET_MODEL_DIMENSIONS(bLocal_292)) && !MONEY::NETWORK_SPENT_HIRE_MERCENARY(MISC::GET_MODEL_DIMENSIONS(bLocal_292))) && !MONEY::NETWORK_SPENT_BULL_SHARK(MISC::GET_MODEL_DIMENSIONS(bLocal_292))) && !MONEY::NETWORK_SPENT_BUY_REVEAL_PLAYERS(MISC::GET_MODEL_DIMENSIONS(bLocal_292))) && !MONEY::NETWORK_SPENT_BUY_OFFTHERADAR(MISC::GET_MODEL_DIMENSIONS(bLocal_292)))
										{
											VEHICLE::DELETE_VEHICLE(&bLocal_292);
											iLocal_437 = 1;
										}
									}
								}
					...
					if (iLocal_406 == 0)
					{
						...
						HUD::HAS_ADDITIONAL_TEXT_LOADED("TREV4", 0);
						iLocal_406 = 1;
					}
					if (iLocal_433 == 0)
					{
						...
						{
							PED::CLEAR_PED_WETNESS(unk_0x9B0761B4C3EB8BC7());
							PED::REVIVE_INJURED_PED(unk_0x9B0761B4C3EB8BC7());
							PED::RESET_PED_VISIBLE_DAMAGE(unk_0x9B0761B4C3EB8BC7());
					...
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
					{
						...
						ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 121.4087f);
						...
						PED::FORCE_PED_MOTION_STATE(unk_0x9B0761B4C3EB8BC7(), -530524, false, 0, false);
					}
				...
				case 2:
					...
					if (MISC::IS_BIT_SET(bLocal_290))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_290, false))
						{
							if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(bLocal_290, true))
							{
								STREAMING::REMOVE_ANIM_DICT(&bLocal_290);
							}
						}
					}
					if (MISC::IS_BIT_SET(bLocal_291))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_291, false))
						{
							if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(bLocal_291, true))
							{
								STREAMING::REMOVE_ANIM_DICT(&bLocal_291);
							}
						}
...
void func_360(var uParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (bParam7)
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			PED::REMOVE_PED_HELMET(unk_0x9B0761B4C3EB8BC7(), true);
		}
	}
	if (!bParam1 && iParam6)
	{
...
void func_362(struct<3> Param0, bool bParam1, int iParam2, int iParam3)
{
	struct<3> Var0;
	var uVar1;
	...
	if (MISC::IS_BIT_SET(Global_102423.f_4))
	{
		if (ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, false))
		{
			if (func_371(24) != Global_102423.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_368(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Global_102423.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						bParam1 = uVar1;
					}
				}
				func_363(Global_102423.f_4, Param0, bParam1, 24, 0);
			}
		}
	}
}

void func_363(bool bParam0, struct<3> Param1, bool bParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (MISC::IS_BIT_SET(iParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		func_365(iParam3, &Var0, Param1, bParam2, func_34(bParam0));
		func_364(iParam3, bParam0, 0);
	}
}
...
void func_364(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		if (Global_75654.f_555[0 /*21*/].f_4 != MISC::GET_MODEL_DIMENSIONS(iParam1))
		{
			return;
		}
	}
...
void func_365(int iParam0, var uParam1, struct<3> Param2, bool bParam3, int iParam4)
{
	if (func_159(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
int func_374(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (uParam0->f_2 == 1)
	{
		if (bParam2)
		{
			...
			func_396(&(uParam0->f_1), 0, 0, 0, CLOCK::GET_CLOCK_MONTH(), CLOCK::GET_CLOCK_YEAR(), SYSTEM::SHIFT_LEFT());
		...
		else if (!func_397(uParam0->f_7, uParam0->f_8))
		{
			if (uParam0->f_5)
			{
				...
				if (!bParam6)
				{
					...
					{
						if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(bVar2))
						{
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bVar2, true, false);
						}
				...
				func_396(&(uParam0->f_1), 0, 0, 8, CLOCK::GET_CLOCK_MONTH(), CLOCK::GET_CLOCK_YEAR(), SYSTEM::SHIFT_LEFT());
				func_360(uParam0, 1, 0, 2000, 1, 1, 0, 1);
				uParam0->f_2 = 2;
			}
			else
		...
		else if (!uParam0->f_5)
		{
			...
			if (!bParam6)
			{
				...
				if (MISC::IS_BIT_SET(iVar4))
				{
					...
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bVar4, true, false);
					}
					ENTITY::SET_ENTITY_VISIBLE(bVar4, false, false);
				}
			}
...
int func_377(int iParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, float fParam5, int iParam6, bool bParam7, float fParam8)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	switch (uParam4->f_3)
	{
		case 0:
			*uParam4 = func_96();
			...
			func_383();
			uParam4->f_10 = AUDIO::PLAY_SOUND_FROM_COORD();
			DATAFILE::UGC_UPDATE_CONTENT(uParam4->f_10, "TIME_LAPSE_MASTER", 0, 1);
		...
		case 2:
			if ((CAM::DOES_CAM_EXIST(uParam4->f_4) && CAM::IS_CAM_INTERPOLATING(uParam4->f_4)) || !(fParam5 >= 0.99f || fParam5 == -1f))
			{
				...
				if (fVar0 >= 0.5f)
				{
					if (uParam4->f_3 == 1)
					{
						if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(sParam2) != 0)
						{
							MISC::SET_WEATHER_TYPE_OVERTIME_PERSIST(bParam2, fParam8);
						}
						if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(sParam3) != 0)
						{
							MISC::_CLEAR_CLOUD_HAT();
							MISC::LOAD_CLOUD_HAT(bParam3, 0f);
						}
						uParam4->f_3 = 2;
					}
				}
			...
			fVar4 = SYSTEM::ROUND((IntToFloat(uParam4->f_11) * fVar12));
			iVar5 = *uParam4;
			func_393(&iVar5, fVar4, 0, 0, 0, 0, 0);
			CLOCK::SET_CLOCK_TIME(func_382(iVar5), func_381(iVar5), func_380(iVar5));
			if (func_378(iVar5) != CLOCK::GET_CLOCK_MONTH())
			{
...
int func_383()
{
	...
	AUDIO::SET_VEH_RADIO_STATION(bVar0, "OFF");
	return 1;
}
...
void func_391(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_100(fVar0, iVar1));
		iVar3 = (iVar3 - 1);
		fVar0 = SYSTEM::ROUND(func_392(SYSTEM::TO_FLOAT(fVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
void func_393(int iParam0, void fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (((((iParam6 == 0 && iParam5 == 0) && iParam4 == 0) && iParam3 == 0) && iParam2 == 0) && fParam1 == 0)
	{
		return;
	}
	if (fParam1 < 0)
...
{
	return func_398(CLOCK::GET_CLOCK_DAY_OF_MONTH(), iParam0, iParam1);
}
...
void func_400(int iParam0, var uParam1)
{
	...
	if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("RAIN") == MISC::GET_PREV_WEATHER_TYPE_HASH_NAME())
	{
		if (CAM::IS_SCREEN_FADED_OUT(&(uParam1->f_18)))
		{
			StringCopy(&(uParam1->f_18), "EXTRASUNNY", 16);
		}
		if (CAM::IS_SCREEN_FADED_OUT(&(uParam1->f_22)))
		{
			StringCopy(&(uParam1->f_22), "cirrocumulus", 16);
		}
	}
		...
		case 2:
			if (iLocal_223 > 0)
			{
				...
				if (iLocal_227 == 1)
				{
					if (iLocal_362 == 0)
					{
						if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_318, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 1) > 2f)
						{
							if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
					...
					if (iLocal_449 == 0)
					{
						if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_318, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 1) > 100f)
						{
							if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
							{
					...
					if (iLocal_473 == 0)
					{
						if (MISC::IS_BIT_SET(bLocal_278))
						{
							if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
							{
								if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_278, 1) < 200f && ENTITY::IS_ENTITY_ON_SCREEN(bLocal_278))
								{
									if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
									{
										if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
					...
					if (MISC::IS_BIT_SET(bLocal_278))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
							{
								if (iLocal_450[0] == 0)
								{
									if (ENTITY::GET_ENTITY_COORDS(iLocal_204[7], false) || ENTITY::GET_ENTITY_COORDS(iLocal_204[8], false))
									{
										if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 7000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 28000f)
										{
											if (!func_262())
											{
												if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_450[1] == 0)
								{
									if (ENTITY::GET_ENTITY_COORDS(iLocal_204[7], false) || ENTITY::GET_ENTITY_COORDS(iLocal_204[8], false))
									{
										if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 28000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 34500f)
										{
											if (!func_262())
											{
												if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_450[2] == 0)
								{
									if (ENTITY::GET_ENTITY_COORDS(iLocal_204[7], false) || ENTITY::GET_ENTITY_COORDS(iLocal_204[8], false))
									{
										if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 36000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 41000f)
										{
											if (!func_262())
											{
												if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_470 == 0)
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 41000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 43500f)
									{
										if (MISC::IS_BIT_SET(bLocal_283) && ENTITY::IS_ENTITY_ON_SCREEN(bLocal_283))
										{
											if (!func_262())
											{
												if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_471 == 0)
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 50509f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 50872f)
									{
										if (MISC::IS_BIT_SET(bLocal_283) && ENTITY::IS_ENTITY_ON_SCREEN(bLocal_283))
										{
											if (!func_262())
								...
								if (iLocal_450[3] == 0)
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 58000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 68000f)
									{
										if (!func_262())
										{
											if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 76000f)
									{
										if (!func_262())
										{
											if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_469 == 0)
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 80000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 82000f)
									{
										if (MISC::IS_BIT_SET(iLocal_280[0]))
										{
											if (ENTITY::GET_ENTITY_COORDS(iLocal_280[0], false))
								...
								if (iLocal_475 == 0)
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 82100f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 83500f)
									{
										if (MISC::IS_BIT_SET(iLocal_204[11]))
										{
										...
										else if (MISC::IS_BIT_SET(iLocal_204[12]))
										{
								...
								if (iLocal_478 == 0)
								{
									if ((VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 101891f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 105000f) && ENTITY::IS_ENTITY_ON_SCREEN(bLocal_278))
									{
										if (!func_262())
										{
											if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (((VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 105500f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 119000f) && MISC::GET_GAME_TIMER() > iLocal_241 + 7000) && iLocal_477 == 0)
								{
									if (!func_262())
									{
										if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (((VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 105500f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 119000f) && MISC::GET_GAME_TIMER() > iLocal_241 + 7000) && iLocal_476 == 1)
								{
									if (!func_262())
									{
										if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
				...
				if (iLocal_227 == 1)
				{
					...
					if (iLocal_454 == 0)
					{
						if (MISC::IS_BIT_SET(bLocal_264))
						{
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
							{
								if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_251))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_251) > 0.65f && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_251) < 0.835f)
									{
										if (!func_262())
										{
											if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
				...
				if (iLocal_227 == 1)
				{
					if (iLocal_483 == 0)
					{
						if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
						{
							...
							if (MISC::IS_BIT_SET(iLocal_277))
							{
								if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_277, 1) < 40f)
								{
									if (!func_262())
									{
										if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
					...
					if (iLocal_483 == 1 && MISC::GET_GAME_TIMER() > iLocal_247 + 5000)
					{
						if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
						{
							bLocal_277 = func_408(unk_0x9B0761B4C3EB8BC7(), joaat("COP"), 0, 0, 28);
							if (MISC::IS_BIT_SET(bLocal_277))
							{
								if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_277, 1) < 40f)
								{
									if (!func_262())
...
void func_411()
{
	if (((iLocal_222 == 4 || iLocal_222 == 5) || iLocal_222 == 8) || iLocal_222 == 6)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			if (func_412(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 2, 200, 0))
			{
	...
	if (iLocal_349 == 1)
	{
		...
		if (iLocal_222 == 6)
		{
			if (MISC::IS_BIT_SET(bLocal_295))
			{
				if (SYSTEM::VMAG(bLocal_300))
				{
					if (func_16(unk_0x9B0761B4C3EB8BC7(), bLocal_295, 1) > 100f)
					{
						func_236("TRV4_FAIL6");
					}
				}
		...
		if (iLocal_222 == 4)
		{
			if (MISC::IS_BIT_SET(bLocal_278))
			{
				if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
					{
						if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 62000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 77000f)
						{
							if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), -1219f, -2570f, 13f, 1) < 210f)
							{
								if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
								{
									if (ENTITY::IS_ENTITY_IN_WATER(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) < 200f && ENTITY::IS_ENTITY_IN_WATER(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) > 125f)
									{
										if (iLocal_438 == 0)
										{
		...
		{
			if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), -928.9f, -2935f, 13f, 1) < 5f && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
			{
				func_236("TRV4_FAIL1");
			}
		}
		...
		{
			if (PED::IS_PED_IN_ANY_HELI(unk_0x9B0761B4C3EB8BC7()) || PED::IS_PED_IN_ANY_PLANE(unk_0x9B0761B4C3EB8BC7()))
			{
				if (func_412(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 2, 200, 0))
				{
					func_236("TRV4_FAIL2");
		...
		if (MISC::IS_BIT_SET(bLocal_278))
		{
			if (!ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				if (MISC::IS_BIT_SET(bLocal_264))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
					{
						ENTITY::SET_ENTITY_INVINCIBLE(bLocal_264, false);
						CAM::IS_AIM_CAM_ACTIVE(bLocal_264, 0, 0);
					}
				}
			}
		}
		...
		if (iLocal_222 == 4)
		{
			if (iLocal_350 == 1)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
				{
					if (func_13(unk_0x9B0761B4C3EB8BC7(), bLocal_264) > 300f)
					{
						if (iLocal_404 == 1)
						{
							HUD::CLEAR_PRINTS();
					...
					if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) < 40000f)
							{
								if (func_13(unk_0x9B0761B4C3EB8BC7(), bLocal_264) > 400f)
								{
									func_236("TRV4_FAIL1");
								}
							}
							else if (func_13(unk_0x9B0761B4C3EB8BC7(), bLocal_264) > 350f)
							{
								func_236("TRV4_FAIL1");
							}
						}
			...
			if (iLocal_224 == 3)
			{
				if (iLocal_425 == 1)
				{
					if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), -934.4f, -2927.2f, 13.2f, 1) > 25f || MISC::GET_GAME_TIMER() > iLocal_237 + 12000)
					{
						func_236("TRV4_FAIL1");
					}
				}
		...
		if (iLocal_222 == 4)
		{
			if (ENTITY::GET_ENTITY_COORDS(bLocal_278, false))
			{
				if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(bLocal_278))
				{
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 111509f)
					{
					...
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(bLocal_278) > 122000f)
					{
						if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
						{
							if (ENTITY::IS_ENTITY_UPSIDEDOWN(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
							{
								if (iLocal_440 == 0)
								{
...
void func_418(bool bParam0)
{
	if (bParam0)
	{
		StringCopy(&Global_110914, TASK::IS_PED_BEING_ARRESTED(), 24);
		Global_110908 = 1;
	}
	else
	{
...
void func_419()
{
	...
	if (MISC::IS_BIT_SET(bLocal_264))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_264))
		{
			PED::SET_PED_KEEP_TASK(bLocal_264, true);
		}
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_264);
	}
	if (MISC::IS_BIT_SET(bLocal_266))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_266))
	...
	if (MISC::IS_BIT_SET(bLocal_269))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_269))
		{
			PED::SET_PED_KEEP_TASK(bLocal_269, true);
		}
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_269);
	}
	if (MISC::IS_BIT_SET(bLocal_270))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_270))
		{
			PED::SET_PED_KEEP_TASK(bLocal_270, true);
		}
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_270);
	}
	if (MISC::IS_BIT_SET(bLocal_271))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_271))
		{
			PED::SET_PED_KEEP_TASK(bLocal_271, true);
		}
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_271);
	}
	if (MISC::IS_BIT_SET(bLocal_272))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_272))
		{
			PED::SET_PED_KEEP_TASK(bLocal_272, true);
		}
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_272);
	}
	if (MISC::IS_BIT_SET(bLocal_273))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_273))
		{
			PED::SET_PED_KEEP_TASK(bLocal_273, true);
		}
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_273);
	}
	if (MISC::IS_BIT_SET(bLocal_274))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_274))
		{
			PED::SET_PED_KEEP_TASK(bLocal_274, true);
		}
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_274);
	}
	if (MISC::IS_BIT_SET(iLocal_265[0]))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_265[0]))
		{
			PED::SET_PED_KEEP_TASK(iLocal_265[0], true);
		}
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_265[0]));
	...
	if (MISC::IS_BIT_SET(iLocal_276[0]))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_276[0]))
		{
	...
	if (MISC::IS_BIT_SET(iLocal_276[1]))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_276[1]))
		{
	...
	if (MISC::IS_BIT_SET(bLocal_279))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(bLocal_279, false))
		{
			STREAMING::REMOVE_ANIM_DICT(&bLocal_279);
		}
	}
	...
	if (MISC::IS_BIT_SET(bLocal_284))
	{
		STREAMING::REMOVE_ANIM_DICT(&bLocal_284);
	}
	if (MISC::IS_BIT_SET(bLocal_285))
	{
		STREAMING::REMOVE_ANIM_DICT(&bLocal_285);
	...
	if (MISC::IS_BIT_SET(bLocal_287))
	{
		STREAMING::REMOVE_ANIM_DICT(&bLocal_287);
	}
	if (MISC::IS_BIT_SET(bLocal_289))
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(bLocal_289, false))
		{
			STREAMING::REMOVE_ANIM_DICT(&bLocal_289);
		}
	}
	if (MISC::IS_BIT_SET(iLocal_293[0]))
	{
	...
	if (MISC::IS_BIT_SET(iLocal_280[0]))
	{
		STREAMING::REMOVE_ANIM_DICT(&(iLocal_280[0]));
	}
	if (MISC::IS_BIT_SET(iLocal_280[1]))
	{
		STREAMING::REMOVE_ANIM_DICT(&(iLocal_280[1]));
	}
	if (MISC::IS_BIT_SET(iLocal_293[0]))
	{
		STREAMING::REMOVE_ANIM_DICT(&(iLocal_293[0]));
	...
	if (MISC::IS_BIT_SET(iLocal_286[0]))
	{
		STREAMING::REMOVE_ANIM_DICT(&(iLocal_286[0]));
	}
	if (MISC::IS_BIT_SET(iLocal_286[1]))
	{
		STREAMING::REMOVE_ANIM_DICT(&(iLocal_286[1]));
	}
	if (MISC::IS_BIT_SET(iLocal_288[0]))
	{
		STREAMING::REMOVE_ANIM_DICT(&(iLocal_288[0]));
	...
	if (MISC::IS_BIT_SET(bLocal_281))
	{
		STREAMING::REMOVE_ANIM_DICT(&bLocal_281);
	}
	...
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_305);
	GRAPHICS::SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED("digitalOverlay");
	PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(-617f, -2274f, 0f, -406.01f, -2044f, 15f, 1, 1);
	PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(-482f, -2118f, 6f, -1072f, -2724f, 17f, 1, 1);
	if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Trev4_5"))
	{
		TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("Trev4_5", false, 0.5f, 1f);
	}
...
void func_423(bool bParam0, int iParam1)
{
	...
	{
		if (MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(bParam0, &iVar0, 0))
		{
