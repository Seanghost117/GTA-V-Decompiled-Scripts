			...
			switch (iLocal_44)
			{
				...
				case 1:
					if (!bLocal_229)
					{
						...
						{
							PED::SET_PED_RESET_FLAG(bLocal_55, 247, true);
						}
					}
					else
					{
					...
					{
						PED::SET_PED_RESET_FLAG(bLocal_56, 156, true);
					}
					func_36();
					func_35();
					func_1();
...
void func_1()
{
	if (bLocal_229)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_56, 100f, 100f, 100f, false, true, 0))
			{
				func_2();
			}
		}
		else if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_56, 100f, 100f, 100f, false, true, 0))
		{
			func_3();
		}
	}
	else
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_55))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_55, unk_0x9B0761B4C3EB8BC7(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(bLocal_55))
			{
				func_2();
			}
		}
		if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_55))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_56))
			{
				...
				TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2052, 2);
...
void func_36()
{
	...
	{
		if ((func_56() || WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6)) || !unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_56, 0), 12f, 12f, 5f, 0, 1, 0))
		{
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_54, 1862763509);
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_56))
			{
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_56);
				TASK::TASK_COMBAT_PED(bLocal_56, unk_0x9B0761B4C3EB8BC7(), 0, 16);
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_56, 15f, 15f, 15f, false, true, 0))
				{
					func_54();
					SYSTEM::WAIT(0);
...
int func_56()
{
	...
	Var0 = { 30f, 30f, 30f };
	Var1 = { -30f, -30f, -30f };
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_55) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_56))
	{
		if (MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(bLocal_55, 31086, 0f, 0f, 0f), 30f, true))
		{
			return 1;
		}
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_55, 30f, 30f, 30f, false, true, 0) && WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
		{
			if (((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_55) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_56)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_55)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_56))
			{
				if (PED::CAN_PED_SEE_HATED_PED(bLocal_55, unk_0x9B0761B4C3EB8BC7()) || PED::CAN_PED_SEE_HATED_PED(bLocal_56, unk_0x9B0761B4C3EB8BC7()))
				{
					func_54();
					SYSTEM::WAIT(0);
		...
		Var0 = { Var0 + PED::GET_PED_BONE_COORDS(bLocal_55, 31086, 0f, 0f, 0f) };
		Var1 = { Var1 + PED::GET_PED_BONE_COORDS(bLocal_55, 31086, 0f, 0f, 0f) };
		...
		if (GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(PED::GET_PED_BONE_COORDS(bLocal_55, 31086, 0f, 0f, 0f), 3f))
		{
			return 1;
		}
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_55) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_56))
				{
					return 1;
				}
			}
		...
		if (PED::IS_COP_PED_IN_AREA_3D(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_55, 0) - Local_49, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_55, 0) + Local_49) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_55, 0) - Local_49, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_55, 0) + Local_49))
		{
			return 1;
		}
	}
	...
	if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_47, 15f, 15f, 15f, 0, 1, 0))
	{
	...
	if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_47, 40f, 40f, 40f, 0, 1, 0))
	{
...
void func_58()
{
	if (!bLocal_230)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_56))
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_56, 242628503) == 7 && ENTITY::IS_ENTITY_AT_ENTITY(bLocal_56, unk_0x9B0761B4C3EB8BC7(), 2.8f, 2.8f, 2.8f, false, true, 0))
			{
				if (!iLocal_231)
				{
					bLocal_236 = 500;
					func_54();
					SYSTEM::WAIT(0);
					if (func_92(func_49()) >= bLocal_236)
					{
						func_59(func_49(), 1, bLocal_236);
						iLocal_237 = bLocal_236;
					...
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_56))
					{
						PED::SET_PED_MONEY(bLocal_56, iLocal_237);
					}
					iLocal_231 = 1;
				}
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_56))
...
int func_59(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_60(func_91(iParam0), 0, iParam1, bParam2, 0);
}
...
void func_93()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_56))
	{
		if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, 0, 1, 0))
		{
			...
			{
				TASK::TASK_LOOK_AT_ENTITY(bLocal_56, unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
				PED::SET_PED_DUCKING(bLocal_56, false);
				unk_0x92BD213E6A0E666B(bLocal_56, joaat("weapon_pistol"), 200, 1, 1);
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					func_54();
					SYSTEM::WAIT(0);
				...
				else
				{
					...
					TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), unk_0x9B0761B4C3EB8BC7(), 2f, false, 2.3f, 4f, true, true, -957453492);
					TASK::TASK_AIM_GUN_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 500, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
				}
				AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_56, iLocal_61);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
				HUD::SET_BLIP_AS_FRIENDLY(bLocal_57, false);
				bLocal_58 = func_101(bLocal_56, 1, 145);
				AUDIO::TRIGGER_MUSIC_EVENT("RE35_OS");
				SYSTEM::WAIT(500);
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_55))
				{
					TASK::TASK_LOOK_AT_ENTITY(bLocal_55, unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					unk_0x92BD213E6A0E666B(bLocal_55, joaat("weapon_pistol"), 200, 1, 1);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
					TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_52, unk_0x9B0761B4C3EB8BC7(), 2f, false, 0f, 4f, true, 512, false, -957453492, 20000);
					TASK::TASK_AIM_GUN_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 5000, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
					AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_55, iLocal_61);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
				}
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
					TASK::TASK_LOOK_AT_ENTITY(false, bLocal_56, -1, 2048, 2);
					TASK::TASK_PAUSE(0, 1000);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
					AUDIO::STOP_SCRIPTED_CONVERSATION(unk_0x9B0761B4C3EB8BC7(), iLocal_61);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
					func_94(1);
				}
				func_54();
...
bool func_101(bool bParam0, bool bParam1, int iParam2)
{
	int iVar0;
...
bool func_102(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_103(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_103(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
void func_104()
{
	...
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_55, 15f, 15f, 15f, false, true, 0))
		{
			if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				if (!func_34())
				{
					if (iLocal_235 == 0)
					{
						...
						TASK::TASK_LOOK_AT_ENTITY(bLocal_55, unk_0x9B0761B4C3EB8BC7(), -1, 2052, 2);
						iLocal_235++;
						SYSTEM::SETTIMERB(0);
					}
...
void func_105()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_55))
	{
		if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6) && PED::CAN_PED_SEE_HATED_PED(bLocal_55, unk_0x9B0761B4C3EB8BC7()))
			{
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_55);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
				TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2052, 2);
				...
				else if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 2))
				{
					func_37(&uLocal_62, "lurinau", "lurin_other", 4, 0, 0, 0);
				}
				func_2();
...
void func_106()
{
	if (!func_135())
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_55, 0))
		{
			if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_47, 65f, 60f, 60f, 0, 1, 0) || Global_111853)
			{
				if (SYSTEM::VMAG(fLocal_59))
				{
					unk_0x93370FA10F15BE44(&bLocal_59);
				}
				bLocal_57 = func_101(bLocal_55, 0, 145);
	...
	if (!iLocal_227)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_55))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_55, 25f, 25f, 25f, false, true, 0) && func_135())
			{
				if (func_37(&uLocal_62, "lurinau", "lurin_help2", 4, 0, 0, 0))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
					TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2064, 2);
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_55, 0))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_55, 15f, 15f, 15f, false, true, 0) && SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			ENTITY::SET_ENTITY_HEALTH(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_unarmed"), 1);
		}
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_55, 8f, 8f, 8f, false, true, 0))
		{
			if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				iLocal_228 = 1;
				...
				{
					SYSTEM::SETTIMERB(0);
					TASK::CLEAR_PED_SECONDARY_TASK(bLocal_55);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
					TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2064, 2);
			...
			else if (!iLocal_234)
			{
				...
				if (!func_34())
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_55))
					{
						...
						TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
						TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 3076, 2);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_61);
						AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_55, iLocal_61);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
...
void func_119()
{
	...
	while ((((!ENTITY::DOES_ENTITY_EXIST(joaat("a_f_m_skidrow_01")) || !ENTITY::DOES_ENTITY_EXIST(joaat("a_m_m_tramp_01"))) || !ENTITY::DOES_ENTITY_EXIST(joaat("prop_ld_wallet_01_s"))) || !STREAMING::HAS_ANIM_DICT_LOADED("random@mugging5")) || !STREAMING::HAS_ANIM_DICT_LOADED("random@gang_intimidation@"))
	{
		SYSTEM::WAIT(0);
	}
	PATHFIND::SET_ROADS_IN_AREA(Local_47 - Vector(10f, 30f, 30f), Local_47 + Vector(10f, 30f, 30f), false, true, 1, 1);
	PED::ADD_RELATIONSHIP_GROUP("mugger", &iLocal_54);
	bLocal_55 = PED::CREATE_PED(19, joaat("a_f_m_skidrow_01"), Local_50, 79.765f, true, true);
	PED::_0x2208438012482A1A(bLocal_55, 1);
	PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_55, 2.592402E-43f, 1);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_55, 128, true);
	AUDIO::STOP_PED_SPEAKING(bLocal_55, true);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_55, iLocal_54);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_54, 1862763509);
	TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
	TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 3076, 2);
	...
	AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_55, iLocal_61);
	TASK::CLEAR_SEQUENCE_TASK(&iLocal_61);
	bLocal_56 = PED::CREATE_PED(7, joaat("a_m_m_tramp_01"), Local_48, fLocal_53, true, true);
	AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_56, "A_M_M_TRAMP_01_BLACK_MINI_01");
	PED::_0x2208438012482A1A(bLocal_56, 1);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_56, 128, true);
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(bLocal_56, true, 0f);
	AUDIO::STOP_PED_SPEAKING(bLocal_56, true);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_56, iLocal_54);
	TASK::TASK_LOOK_AT_ENTITY(bLocal_56, unk_0x9B0761B4C3EB8BC7(), -1, 2052, 2);
	func_120(&uLocal_62, 0, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	func_120(&uLocal_62, 4, bLocal_55, "HOBOFEMALE", 0, 1);
	func_120(&uLocal_62, 5, bLocal_56, "HOBOMALE", 0, 1);
	iLocal_45 = 1;
}
...
int func_122()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_133())
		{
			return 0;
		}
	}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 4:
						if (((((func_173() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_51(8, -1)) || func_168()) || func_167()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_181()
{
	if (iLocal_46)
	{
		...
		PED::GET_PED_BONE_INDEX(&uLocal_60);
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_55))
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_61);
			TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2052, 2);
