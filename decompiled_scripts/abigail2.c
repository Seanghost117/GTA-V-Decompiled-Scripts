...
void __EntryFunction__()
{
	...
	{
		bLocal_61 = Local_54.f_28[0];
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_61, true, true);
	}
	func_463();
	if (func_462())
	{
...
void func_9()
{
	switch (iLocal_60)
	{
		case 0:
			func_265();
			if (func_464(bLocal_56))
			{
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_56, 1);
			}
			iLocal_60 = 1;
			break;
		...
		case 1:
			...
			else if (func_232(unk_0x9B0761B4C3EB8BC7(), bLocal_61) > 250f)
			{
				if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::GET_PLAYER_INDEX()) == 0)
				{
					iLocal_60 = 2;
			...
			{
				if (!func_230(bLocal_61, 1805844857))
				{
					TASK::TASK_SMART_FLEE_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
				}
				if (iLocal_230 == 0)
				{
					if (((!func_229() && func_228(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 20f, 1)) && !MISC::IS_PC_VERSION(bLocal_61)) && func_211(&uLocal_65, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0))
					{
						iLocal_230 = 1;
					}
				}
				else if (((((iLocal_238 < 15 && !func_229()) && (MISC::GET_GAME_TIMER() - iLocal_235) > 10000) && func_228(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 20f, 1)) && !MISC::IS_PC_VERSION(bLocal_61)) && func_211(&uLocal_65, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
bool func_228(bool bParam0, bool bParam1, float fParam2, int* iParam3)
{
...
{
	return func_233(bParam0, bParam1, 1);
}

var func_233(bool bParam0, bool bParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_235()
{
	if (func_464(bLocal_61))
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_242) > 1000)
		{
			...
			func_236(&uLocal_42, bLocal_61, "ABGAIL2_HINT", 0, 1, 1, 1);
		}
	}
	else
	{
...
void func_236(var uParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_237(uParam0, bParam1, 0f, 0f, 0f, bParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_237(var uParam0, bool bParam1, struct<3> Param2, bool bParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	uParam0->f_6 = 2;
	func_238(uParam0, bParam1, Param2, bParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_238(var uParam0, bool bParam1, struct<3> Param2, bool bParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	bool bVar0;
	int iVar1;
	...
	if (func_263(bParam1) && ENTITY::IS_ENTITY_VISIBLE(bParam1))
	{
		iVar1 = 0;
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_254(uParam0, bParam1, Param2, iParam4);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_244(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_251() || func_250(Global_4456448.f_129348)) || func_249())
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(bVar0, iVar1) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("apc") && iVar1 != -1)) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("akula") && iVar1 != -1)) || (((MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("riot2") && iVar1 == 0) && func_247(bVar0, 10)) && unk_0x7F8B14CBFB9813E5(bVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_254(var uParam0, bool bParam1, struct<3> Param2, int iParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_258(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_261(bParam1, bParam2, bParam3) || SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1) || func_259(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_265()
{
	if (!SYSTEM::VMAG(bLocal_62) && func_464(bLocal_61))
	{
		bLocal_62 = func_266(bLocal_61, 1, 0, 5);
	}
	if (SYSTEM::VMAG(bLocal_62) && HUD::GET_BLIP_COLOUR(bLocal_62) != 1)
	{
		HUD::SET_BLIP_AS_FRIENDLY(bLocal_62, false);
		HUD::SET_BLIP_COLOUR(bLocal_62, 1);
	}
}

bool func_266(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	bool bVar0;
	bool bVar1;
...
void func_267()
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			{
				if (((iLocal_232 == 0 && !func_229()) && func_228(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 20f, 1)) && func_211(&uLocal_65, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0))
				{
					iLocal_232 = 1;
					func_265();
				}
				if (func_232(unk_0x9B0761B4C3EB8BC7(), bLocal_61) > 250f)
				{
					iLocal_60 = 2;
				}
			}
			if ((iLocal_233 == 0 && iLocal_232 == 1) && !func_229())
			{
				if (func_464(bLocal_61))
				{
					...
					PED::IS_PED_IN_VEHICLE(PLAYER::GET_PLAYER_INDEX(), 3, false);
					PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), false);
				}
...
void func_269()
{
	...
	{
		case 0:
			fLocal_243 = PATHFIND::SET_ROADS_IN_AREA(Vector(2.99f, 5194.44f, -1578.62f) - Vector(10f, 10f, 10f), Vector(2.99f, 5194.44f, -1578.62f) + Vector(10f, 10f, 10f), false, true, 1, 1);
			func_297();
			if (func_464(bLocal_61))
			{
				func_295();
				if (func_3(bLocal_56))
				{
					if (!SYSTEM::VMAG(bLocal_62))
					{
						bLocal_62 = func_266(bLocal_61, 1, 0, 5);
					}
					func_294(&bLocal_62, "", "", &iLocal_63, &iLocal_64, 1, 0);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_236);
					if (!unk_0xE0B3BC41DDA88DF0(bLocal_61, bLocal_56, 0))
					{
						...
						TASK::TASK_ENTER_VEHICLE(0, bLocal_56, 20000, -1, 1f, 1, 0);
					}
					TASK::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, bLocal_56, Local_239, 20f, 786469, 10f);
					TASK::TASK_VEHICLE_PARK(0, bLocal_56, Local_239, 49.567f, 3, 10f, false);
					TASK::TASK_LEAVE_VEHICLE(0, bLocal_56, 256);
					TASK::TASK_SMART_FLEE_PED(false, unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_236);
					AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_61, iLocal_236);
				}
				else
				{
					TASK::TASK_WANDER_STANDARD(bLocal_61, 40000f, 0);
				}
			}
		...
		case 1:
			...
			else if (unk_0xC2169C00B643278B(bLocal_61, Local_239, 5f, 5f, 5f, 0, 1, 0))
			{
				func_234(3);
			}
			else
			{
				func_270(&bLocal_62, "", "", &iLocal_63, iLocal_64, 0);
				if (iLocal_231 == 0)
				{
					if (((func_464(bLocal_56) && unk_0xE0B3BC41DDA88DF0(bLocal_61, bLocal_56, 1)) && func_228(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 20f, 1)) && func_211(&uLocal_65, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_231 = 1;
					}
					if (((((iLocal_237 < 7 && !func_229()) && (MISC::GET_GAME_TIMER() - iLocal_234) > 10000) && func_228(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 20f, 1)) && !MISC::IS_PC_VERSION(bLocal_61)) && func_211(&uLocal_65, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_234 = MISC::GET_GAME_TIMER();
						iLocal_237++;
					}
...
int func_274()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0)
	{
		return 1;
	}
	if (func_464(bLocal_56))
	{
		if (func_275(bLocal_61, 1, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			return 1;
		}
		if (PED::IS_PED_BEING_JACKED(bLocal_61))
		{
			return 1;
		}
		if (func_464(bLocal_56))
		{
			if (unk_0xE0B3BC41DDA88DF0(bLocal_61, bLocal_56, 0) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_56, unk_0x9B0761B4C3EB8BC7(), true))
			{
				return 1;
			}
			if (((VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_56, 0, false) || VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_56, 1, false)) || VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_56, 4, false)) || VEHICLE::IS_VEHICLE_TYRE_BURST(bLocal_56, 5, false))
			{
				return 1;
			}
		}
...
int func_275(bool bParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	struct<3> Var0;
	
	if (func_464(unk_0x9B0761B4C3EB8BC7()) && func_464(bParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				{
					return func_288(unk_0x9B0761B4C3EB8BC7(), bParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_276(bool bParam0, float fParam1)
{
	...
	if (func_464(unk_0x9B0761B4C3EB8BC7()) && func_464(bParam0))
	{
		if (func_287(bParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bParam0))
		{
			if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
			{
				fVar0 = 40f;
...
{
	return func_278(bParam0, unk_0x9B0761B4C3EB8BC7(), fParam1, 1, 250, 7);
}
...
bool func_278(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!func_464(bParam0) || !func_464(bParam1))
	{
		if (iVar2 != -1)
		{
	...
	uVar0 = func_279(&(Local_35[iVar2 /*4*/]), Var1, bParam1, &(Local_35[iVar2 /*4*/].f_3), bParam0, bParam5);
...
int func_282(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_284(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1)) };
	...
	{
		Var1 = { func_284(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_288(bool bParam0, bool bParam1, float fParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_292(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_284(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_295()
{
	if (func_464(bLocal_61))
	{
		PED::_0x2208438012482A1A(bLocal_61, 1);
		func_296(&uLocal_65, 3, bLocal_61, "ABIGAIL", 0, 1);
		PED::SET_PED_FLEE_ATTRIBUTES(bLocal_61, 128, true);
		PED::SET_PED_FLEE_ATTRIBUTES(bLocal_61, 4, true);
		PED::SET_PED_FLEE_ATTRIBUTES(bLocal_61, 1024, true);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_61, 3.937649E-43f, 1);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_61, 4.063766E-44f, 1);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_61, 1.625506E-43f, 1);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_61, 1.653532E-43f, 1);
		PED::SET_PED_CAN_BE_TARGETTED(bLocal_61, true);
		TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(bLocal_61, false);
		TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(bLocal_61, false);
	}
}
...
void func_297()
{
	if (!func_464(bLocal_56))
	{
		bLocal_56 = VEHICLE::CREATE_VEHICLE(iLocal_55, Local_57, fLocal_58, true, true, false);
		unk_0x74528AC0906CBABE(iLocal_55);
	}
	if (func_464(bLocal_56))
	{
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_56, 3);
		VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(bLocal_56, 1);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, true);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(bLocal_56, true);
	}
}
			...
			switch (iLocal_241)
			{
				case 0:
					if (func_353(1, 1093140480, 0))
					{
						if (func_464(bLocal_61))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_61, "ABIGAIL", 0, 0, 0);
						}
						func_352();
				...
				case 2:
					if (OBJECT::ADD_DOOR_TO_SYSTEM())
					{
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_499(16)) && func_464(bLocal_61))
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, true, 40000f);
						}
					...
					else
					{
						...
						if (iLocal_240 == 1)
						{
							if (func_464(bLocal_61))
							{
								TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_61);
								func_339(bLocal_61, -1587.11f, 5204.18f, 3.02f, 210.9196f, 0, 1);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, true, 40000f);
								ENTITY::FREEZE_ENTITY_POSITION(bLocal_61, false, 0);
							}
...
void func_303(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_305() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_305() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_304(bParam0));
		HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar1, &cVar1, true, 0, "", 0);
	}
}

char* func_304(bool bParam0)
{
	switch (bParam0)
	{
		case 0:
...
bool func_307(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_305() /*10931*/].f_6175.f_10, bParam0);
}
...
void func_331(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_335(PLAYER::PLAYER_ID())) && !func_333(PLAYER::PLAYER_ID(), 0)) && !func_332()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_335(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
int func_339(bool bParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
	...
	if (MISC::IS_BIT_SET(bVar0))
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_349(bVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_349(bool bParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
void func_360()
{
	HUD::HAS_ADDITIONAL_TEXT_LOADED("ABGAIL2", 0);
	unk_0x78FCB2E22C41B9D5(iLocal_55);
	if ((!func_229() && HUD::REQUEST_ADDITIONAL_TEXT_FOR_DLC(0)) && ENTITY::DOES_ENTITY_EXIST(iLocal_55))
	{
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, true);
		if (func_464(Local_54.f_35[0]))
		{
			bLocal_56 = Local_54.f_35[0];
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_56, true, true);
			unk_0x74528AC0906CBABE(iLocal_55);
		}
		iLocal_59 = 1;
	}
...
{
	if (((!func_381(0) || Global_77102) || Global_77091 == 1) || !GRAPHICS::DRAW_SCALEFORM_MOVIE())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((OBJECT::ADD_DOOR_TO_SYSTEM() || func_253(0)) || func_380(1))
			{
			}
			else
			{
...
void func_384(int iParam0)
{
	...
	if (!func_389())
	{
		func_387(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 1112014848, 12, 5000, 0, 0);
	}
	func_386(0, -1, 1);
	func_385(1, 1, 1);
}
...
void func_390(struct<3> Param0, float fParam1, struct<3> Param2, float fParam3, struct<3> Param4, float fParam5, struct<3> Param6, float fParam7)
{
	...
	if (func_346(Param0))
	{
		while (!func_395(&bVar0, 0, Param2, fParam3, 1, 0))
		{
			SYSTEM::WAIT(0);
		}
		PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), bVar0, -1);
		func_394(&bVar0);
	}
	else if (!func_462())
	{
	...
	unk_0x78FCB2E22C41B9D5(iLocal_55);
	while (!ENTITY::DOES_ENTITY_EXIST(iLocal_55))
	{
		SYSTEM::WAIT(0);
	}
	while (!func_391(&bLocal_61, 16, Param4, fParam5, "RC ABIGAIL 2", 1))
	{
		SYSTEM::WAIT(0);
	}
	bLocal_56 = VEHICLE::CREATE_VEHICLE(iLocal_55, Param6, fParam7, true, true, false);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, true);
	unk_0x74528AC0906CBABE(iLocal_55);
	func_297();
	if (func_346(Param4))
	{
		PED::SET_PED_INTO_VEHICLE(bLocal_61, bLocal_56, -1);
	}
}
...
int func_392(bool bParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_395(bool bParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_452(bParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_452(bParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (MISC::GET_MODEL_DIMENSIONS(*bParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Var2))
			{
				...
				*bParam0 = VEHICLE::CREATE_VEHICLE(Var2, Param2, fParam3, true, true, false);
				...
				func_452(bParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_396(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if ((func_160(iParam0) && MISC::IS_BIT_SET(*bParam1)) && ENTITY::GET_ENTITY_COORDS(*bParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*bParam1) >= 0 && func_401(*bParam1, 0, &uVar0))
		{
			func_400(bParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_399(*bParam1);
...
int func_401(bool bParam0, bool bParam1, var uParam2)
{
	void fVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	fVar0 = MISC::GET_MODEL_DIMENSIONS(bParam0);
	if ((!func_428(fVar0, bParam1, uParam2) && !func_427(PLAYER::PLAYER_ID())) && !func_410(bParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_408(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_406(bParam0)) && !bVar1) && !(func_405(MISC::GET_MODEL_DIMENSIONS(bParam0)) && func_403(PLAYER::PLAYER_ID())))
	{
	...
	if (!MISC::SET_BIT())
	{
		if ((func_402(bParam0) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("sentinel2")) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_412(bool bParam0)
{
	...
	if (func_413(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		return 1;
	}
	return 0;
...
int func_414(bool bParam0, bool bParam1)
{
	switch (MISC::GET_MODEL_DIMENSIONS(bParam0))
	{
		...
		case joaat("insurgent"):
			if (func_416(MISC::GET_MODEL_DIMENSIONS(bParam0), 0))
			{
...
int func_416(void fParam0, int iParam1)
{
	if (iParam1 == 0)
	{
		if (func_424(fParam0, 0))
		{
			return 1;
		}
	}
...
int func_424(void fParam0, int iParam1)
{
	switch (fParam0)
	{
		case joaat("faction2"):
...
int func_428(void fParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_408(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fParam0)))
	{
		bVar0 = true;
	}
...
void func_430(bool bParam0, int iParam1)
{
	...
	func_431(bParam0, &(Global_111858.f_32745.f_5510));
}
...
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_347(bParam0, 0, 0)) || func_347(bParam0, 1, 0)) || func_347(bParam0, 2, 0)) || func_448(bParam0) != 145) || func_447(bParam0)) || func_446(bParam0)) || func_402(bParam0)) || func_445(bParam0)) || !func_435(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_446(bParam0))
		{
		}
		...
		if (func_347(bParam0, 0, 0))
		{
		}
		if (func_347(bParam0, 1, 0))
		{
		}
		if (func_347(bParam0, 2, 0))
		{
		}
		if (func_448(bParam0) != 145)
		{
		}
		return 0;
	}
...
int func_435(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_436(fParam0, 0))
	{
		return 0;
	}
...
int func_436(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
int func_452(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_424(MISC::GET_MODEL_DIMENSIONS(*uParam0), 1) && unk_0x7F8B14CBFB9813E5(*uParam0, 24) != func_455(*uParam0, ((*uParam1)[38] - 1)))
	{
...
void func_465(int iParam0)
{
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_243, 0);
	if (iParam0 == 1)
	{
