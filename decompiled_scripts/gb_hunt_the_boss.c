						...
						while (iVar17 < 32)
						{
							...
							if ((func_500(iVar3) && func_496(iVar3, iParam2)) && func_5(iVar3, 0, 1))
							{
								...
								*(uParam4[iVar17 /*13*/]) = { func_161(iVar3) };
								...
								if (func_476(iParam5))
								{
									func_475(iVar3, uParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar8, iVar16, iVar15, fVar10, iVar8, iVar12, &Var22, (uParam0[iVar17 /*42*/])->f_40, iVar13, bParam6);
								}
								else
								{
									func_475(iVar3, uParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar8, iVar16, iVar15, fVar10, iVar11, iVar12, &Var22, (uParam0[iVar17 /*42*/])->f_40, iVar13, bParam6);
								}
							...
							if (func_500(iVar3))
							{
								if (func_5(unk_0xF1110FE23C67293A(iVar17), 0, 1))
								{
									...
									*(uParam4[iVar17 /*13*/]) = { func_161(iVar3) };
									...
									uParam3->f_38[iVar9 /*2*/].f_1 = iVar18;
									func_458(iVar3, unk_0x72C1D3A1AB8CAA5B(iVar3), uParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar16, iVar15);
									iVar18++;
								}
							}
							iVar17++;
	...
	if (func_21(&(uParam2->f_19)) || bParam5)
	{
		...
		else
		{
			...
			if (!unk_0xCE990E643CD9D0E5(uParam2->f_33, 0))
			{
				...
				unk_0x530DC1525CA60B00(fVar4);
				if (func_545(bVar3, uParam0, 0))
				{
					func_508(uParam0, 0, 0);
					uVar1 = func_542(iParam1, &(Global_4456448.f_82715), bParam4);
					Var0 = { func_540(iParam1) };
					if (bParam4)
					{
						func_537(uParam0, uVar1, "", 0, -1, -1, 1);
					}
					else if (iParam1 == 27)
					{
					...
					else if (iParam1 == 28)
					{
						...
						func_526(uParam0, sVar6, func_527(), -1);
					}
					else if (func_464())
					{
						uParam2->f_34 = Global_1574192;
						func_537(uParam0, uVar1, &Var0, 1, -1, Global_1574192, 1);
					}
					else if (bVar2)
					{
						iVar5 = func_521(iParam1);
						uParam2->f_34 = Global_1574192;
						func_537(uParam0, uVar1, "", 0, iVar5, Global_1574192, 1);
					}
					else
					{
						iVar5 = func_521(iParam1);
						func_537(uParam0, uVar1, &Var0, 1, iVar5, -1, 1);
					}
...
void func_613()
{
	...
	Var1 = { unk_0x3E4D3CCC220BDFB1(unk_0x1FA7B77001D60F9D(unk_0x460153A63B9477BC()), 0) };
...
void func_657()
{
	...
	if (fVar2 < 25f)
	{
		...
		unk_0x3E6F6B3156C4F772(0, 1000, SYSTEM::ROUND(fVar4));
	}
}
...
void func_706()
{
	...
	if (func_21(&(Local_109.f_12)))
	{
		...
		{
			func_714(&uLocal_107, 3, 1);
		}
		if (func_715(Local_109.f_12, (Global_262145.f_12498 - 30000), 0))
		{
			func_714(&uLocal_107, 4, 1);
		}
		if (func_715(Local_109.f_12, (Global_262145.f_12498 - 27000), 0))
		{
			func_714(&uLocal_107, 5, 1);
		}
		if (func_715(Local_109.f_12, Global_262145.f_12498, 0))
		{
			func_714(&uLocal_107, 2, 1);
		}
	}
	if (func_712(unk_0x460153A63B9477BC(), Global_262145.f_12502, &uVar1, func_714(&uLocal_107, 13, -1), 1123024896, 0))
	{
		func_714(&uLocal_107, 13, 1);
	}
	else
	{
		func_714(&uLocal_107, 13, 0);
	}
	if (bLocal_99 || (!func_710() && !func_714(&uLocal_107, 13, -1)))
	{
		iVar0 = 0;
	}
	switch (func_709(unk_0x59E2AD1A8ACEDA31()))
	{
		...
		case 1:
			if (!func_714(&uLocal_107, 12, 1))
			{
				uLocal_108 = unk_0x6CAAB7E78B5D978A();
			}
			if (iVar0 && !func_714(&uLocal_107, 3, -1))
			{
				if (!func_714(&uLocal_107, 1, -1))
				{
					uVar2 = func_708(func_710(), "BG_HUNT_BOSS_DEFEND_START", "BG_HUNT_BOSS_ATTACK_START");
					if (unk_0x1BDBFE8EFF10BC95(uVar2) && func_714(&uLocal_107, 11, -1))
					{
						unk_0x21723EF7B2FCC4CC(sVar2);
						func_714(&uLocal_107, 1, 1);
					}
					if (!func_714(&uLocal_107, 11, -1))
					{
						func_707(1);
					}
				}
			}
			else if (func_714(&uLocal_107, 1, -1) && !func_714(&uLocal_107, 3, -1))
			{
				if (unk_0x1BDBFE8EFF10BC95("BG_HUNT_STOP"))
				{
					unk_0x21723EF7B2FCC4CC("BG_HUNT_STOP");
					func_707(0);
					func_714(&uLocal_107, 1, 0);
				}
			}
			if (func_714(&uLocal_107, 3, -1))
			{
				if (func_714(&uLocal_107, 1, -1))
				{
			...
			if (func_714(&uLocal_107, 4, -1))
			{
				if ((!func_714(&uLocal_107, 7, -1) && !func_714(&uLocal_107, 5, -1)) && !(func_614() || iLocal_82 != 3))
				{
					if (unk_0x1BDBFE8EFF10BC95("APT_COUNTDOWN_30S"))
					{
						...
						func_714(&uLocal_107, 7, 1);
					}
				}
				if ((!func_714(&uLocal_107, 6, -1) && !func_714(&uLocal_107, 5, -1)) && func_714(&uLocal_107, 7, -1))
				{
					unk_0x96F763331D19ED14(0);
					func_714(&uLocal_107, 6, 1);
				}
			}
			break;
		
		case 2:
			if (!func_714(&uLocal_107, 8, -1) && func_714(&uLocal_107, 7, -1))
			{
				if (unk_0x1BDBFE8EFF10BC95("APT_FADE_IN_RADIO"))
				{
					unk_0x21723EF7B2FCC4CC("APT_FADE_IN_RADIO");
					func_714(&uLocal_107, 8, 1);
				}
			}
			if (func_714(&uLocal_107, 1, -1))
			{
			...
			if (func_714(&uLocal_107, 7, -1) && !func_714(&uLocal_107, 2, -1))
			{
				if (unk_0x1BDBFE8EFF10BC95("APT_COUNTDOWN_30S_KILL"))
				{
					func_714(&uLocal_107, 7, 0);
	...
	if (func_714(&uLocal_107, 6, -1) && (func_714(&uLocal_107, 5, -1) || func_709(unk_0x59E2AD1A8ACEDA31()) == 2))
	{
		unk_0x96F763331D19ED14(1);
		unk_0x0C0DE28672975DC3("AllowScoreAndRadio", 0);
		func_714(&uLocal_107, 6, 0);
	}
	if (func_21(&(Local_109.f_16)) && func_715(Local_109.f_16, 10000, 0))
	{
		if (!func_714(&uLocal_107, 10, -1))
		{
			iLocal_106 = unk_0x5E54B0823F46079E();
			unk_0xC4CC25B68A91D144(iLocal_106, "10s", "MP_MISSION_COUNTDOWN_SOUNDSET", 0);
			func_714(&uLocal_107, 10, 1);
		}
	}
	else if (func_714(&uLocal_107, 10, -1))
	{
		unk_0xC5E5600D1CF5CEF9(iLocal_106);
		iLocal_106 = -1;
		func_714(&uLocal_107, 10, 0);
	}
}
		...
		case 0:
			if (!func_17(Local_109.f_7))
			{
				if (func_696(unk_0x460153A63B9477BC(), func_16(), 1))
				{
					...
					{
						uLocal_92 = unk_0x6820C712C1DD618A(Local_109.f_7);
					...
					{
						uLocal_91 = unk_0x5F920D11DDA03179(Local_109.f_7, SYSTEM::TO_FLOAT((Global_262145.f_12502 - 1)));
...
void func_778()
{
	...
	{
		Local_100 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1) };
	...
	{
		if (SYSTEM::VDIST(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_100) > IntToFloat(Global_262145.f_12499))
		{
			func_8(&uLocal_102);
			if (unk_0xCE990E643CD9D0E5(Local_110[unk_0x59E2AD1A8ACEDA31() /*3*/].f_2, 4))
			{
...
void func_987(var uParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!unk_0x25DDB354A40FFCDB())
	{
		func_942();
