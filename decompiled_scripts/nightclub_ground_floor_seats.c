...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_141.f_1);
		if (PED::DETACH_SYNCHRONIZED_SCENE(fVar0))
		{
			SYSTEM::POW(uParam0->f_141.f_1);
		}
	}
}
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 5:
			...
			{
				uParam0->f_141.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, 1, 0f, 1065353216, 0, 1.12f);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_141.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1148846080, 0);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			fVar9 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_141.f_1);
			if (PED::DETACH_SYNCHRONIZED_SCENE(fVar9))
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(fVar9) >= 1f)
				{
					...
					func_49(uParam0, &sVar1);
					uParam0->f_141.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, 1, 0f, 1065353216, 0, 1.12f);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_141.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1148846080, 0);
					unk_0xB88AF19828BF16ED(uParam0->f_141.f_1);
					func_33(&(uParam0->f_141), 8);
		...
		case 8:
			fVar10 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_141.f_1);
...
void func_16(var uParam0)
{
	...
	if (uParam0->f_141.f_4 == 6)
	{
		...
		if ((uParam0->f_141.f_4 == 6 && !ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), -1322051853)) && !func_32(&(uParam0->f_141), 12))
		{
		...
		else
		{
			...
			if (((((!HUD::DISABLE_FRONTEND_THIS_FRAME() && !func_32(&(uParam0->f_141), 0)) && !func_32(&(uParam0->f_141), 4)) && !func_22()) && !func_20(1)) && uParam0->f_141.f_8.f_2 != 3)
			{
				if (uParam0->f_141.f_5 == -1)
				{
...
void func_30(var uParam0)
{
	...
	uParam0->f_141.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, 1, 0f, 1065353216, 0, 1.12f);
	func_50(uParam0, &sVar0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_141.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1148846080, 0);
	unk_0xB88AF19828BF16ED(uParam0->f_141.f_1);
	func_7(&(uParam0->f_141.f_5));
	func_65(uParam0, 8);
}
...
bool func_52(var uParam0)
{
	...
	switch (uParam0->f_141.f_8)
	{
		...
		default:
			bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, func_14(uParam0->f_141.f_8));
	}
	if (uParam0->f_141.f_8 == 1)
	{
		if (func_12())
...
int func_57(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((MISC::IS_BIT_SET(uVar0[iVar1]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && (func_63(uVar0[iVar1], uParam0[uParam0->f_141.f_2 /*14*/]) || SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar0[iVar1], 0), (uParam0[uParam0->f_141.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_141.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
...
void func_69(var uParam0)
{
	...
	func_70(&(uParam0->f_141), 1, PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0));
	func_70(&(uParam0->f_141), 3, SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1));
...
int func_72()
{
	if (PED::REMOVE_SCENARIO_BLOCKING_AREA() && !func_85())
	{
		return 1;
	}
	if (!func_84())
