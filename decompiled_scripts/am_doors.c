...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (STATS::STAT_SET_INT())
		{
			...
			{
				if (ScriptParam_163.f_16 != (50 + PLAYER::PLAYER_ID()))
				{
					func_57(2);
				}
			}
			else if (ScriptParam_163.f_16 != NETWORK::NETWORK_GET_PLAYER_TUTORIAL_SESSION_INSTANCE(PLAYER::PLAYER_ID()))
			{
				func_57(2);
			}
		}
...
void func_1()
{
	...
	while (bLocal_136 < 6)
	{
		if (func_7(NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iLocal_135), 0, 1))
		{
			if (unk_0xCE990E643CD9D0E5(Local_161[iLocal_135 /*4*/].f_2, bLocal_136))
			{
				unk_0xBE20AB8238688965(&(Local_138.f_2[bLocal_136]), iLocal_135);
			}
			else
			{
				VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_138.f_2[bLocal_136]), bLocal_135);
			}
		}
		else
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_138.f_9[bLocal_136]), bLocal_135);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_138.f_9[bLocal_136]), bLocal_135);
		}
		if (Local_138.f_9[bLocal_136] != 0)
		{
			if (Local_134[bLocal_136 /*17*/][0] != 0)
			{
				func_2(bLocal_136, Local_134[bLocal_136 /*17*/][0], 5);
			}
			if (Local_134[bLocal_136 /*17*/][1] != 0)
			{
				func_2(bLocal_136, Local_134[bLocal_136 /*17*/][1], 5);
			}
		}
		else if (Local_138.f_2[bLocal_136] != 0)
		{
			if (Local_134[bLocal_136 /*17*/][0] != 0)
			{
				func_2(bLocal_136, Local_134[bLocal_136 /*17*/][0], 0);
			}
			if (Local_134[bLocal_136 /*17*/][1] != 0)
			{
				func_2(bLocal_136, Local_134[bLocal_136 /*17*/][1], 0);
			}
		}
		else
		{
			if (Local_134[bLocal_136 /*17*/][0] != 0)
			{
				func_2(bLocal_136, Local_134[bLocal_136 /*17*/][0], 1);
			}
			if (Local_134[bLocal_136 /*17*/][1] != 0)
			{
				func_2(bLocal_136, Local_134[bLocal_136 /*17*/][1], 1);
			}
		}
		bLocal_136++;
	}
...
void func_2(bool bParam0, int iParam1, int iParam2)
{
	...
	if (iLocal_159[bParam0] == 0)
	{
		if (unk_0x930CA6B846104DC4(iParam1) == -1)
		{
			if (SYSTEM::SHIFT_RIGHT(iParam1) != iParam2)
			{
				if (unk_0x901309497223D4B4(iParam1))
				{
					unk_0xBE20AB8238688965(&(iLocal_159[bParam0]), bVar0);
					unk_0xDC5C33A98881772F(iParam1, iParam2, true, 1);
					func_56(&(Local_160[bParam0 /*2*/]), 1, 0);
				}
				else
				{
	...
	if (func_6(&(Local_160[bParam0 /*2*/])))
	{
		if (func_4(&(Local_160[bParam0 /*2*/]), 1000, 1))
		{
			func_3(&(Local_160[bParam0 /*2*/]));
			iLocal_159[bParam0] = 0;
		}
	}
}
...
void func_9()
{
	...
	bVar0 = SYSTEM::VDIST(Var1, Local_134[iLocal_137 /*17*/].f_3);
	if ((unk_0xCE990E643CD9D0E5(Global_2549478, iLocal_137) || unk_0xCE990E643CD9D0E5(Global_2549478.f_1, bLocal_137)) || unk_0xCE990E643CD9D0E5(Global_2549478.f_2, bLocal_137))
	{
		if (unk_0xCE990E643CD9D0E5(Global_2549478, bLocal_137))
		{
			unk_0xBE20AB8238688965(&(Local_161[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_137);
		}
		if (unk_0xCE990E643CD9D0E5(Global_2549478.f_1, bLocal_137))
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_161[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_137);
		}
		if (unk_0xCE990E643CD9D0E5(Global_2549478.f_2, bLocal_137))
		{
			unk_0xBE20AB8238688965(&(Local_161[PLAYER::PLAYER_ID() /*4*/].f_3), bLocal_137);
		}
	}
	else if (bVar0 <= 20f)
	{
		if (HUD::GET_BLIP_INFO_ID_TYPE(Var1, Local_134[bLocal_137 /*17*/].f_3, Local_134[bLocal_137 /*17*/].f_6, Local_134[bLocal_137 /*17*/].f_9, 0, 1))
		{
			if (!unk_0xCE990E643CD9D0E5(Local_161[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_137))
			{
				unk_0xBE20AB8238688965(&(Local_161[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_137);
			}
		}
		if ((bLocal_137 == 0 || bLocal_137 == 1) || bLocal_137 == 5)
		{
			if (Global_2463670 || !func_13())
			{
				if (HUD::GET_BLIP_INFO_ID_TYPE(Var1, Local_134[bLocal_137 /*17*/].f_10, Local_134[bLocal_137 /*17*/].f_13, Local_134[bLocal_137 /*17*/].f_16, 0, 1))
				{
					if (!unk_0xCE990E643CD9D0E5(Local_161[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_137))
					{
						unk_0xBE20AB8238688965(&(Local_161[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_137);
		...
		if ((bLocal_137 == 2 || bLocal_137 == 3) || bLocal_137 == 4)
		{
			if (func_11() >= 0)
			{
				if (func_10(29))
				...
				else if (unk_0xCE990E643CD9D0E5(Local_161[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_137) && !HUD::GET_BLIP_INFO_ID_TYPE(Var1, Local_134[bLocal_137 /*17*/].f_3, Local_134[bLocal_137 /*17*/].f_6, Local_134[bLocal_137 /*17*/].f_9, 0, 1))
				{
					VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_161[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_137);
				}
			}
	...
	else if (unk_0xCE990E643CD9D0E5(Local_161[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_137))
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_161[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_137);
	}
	bLocal_137++;
...
bool func_10(bool bParam0)
{
	if (bParam0 < 32)
	{
		return unk_0xCE990E643CD9D0E5(Global_2440049.f_502.f_1, bParam0);
	}
...
{
	return func_23(func_24(bParam0));
}
...
bool func_30(bool bParam0, bool bParam1)
{
	if (func_54() != 0)
	{
		return func_34(bParam0) != 0;
	}
	return func_31(bParam0, bParam1, 0);
}
...
void func_36()
{
	...
	{
		func_44(iVar0, &Var3);
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_35(PLAYER::PLAYER_ID()), Var3.f_1, 1) < 150f)
		{
			bVar2 = false;
			iVar1 = 0;
			while (iVar1 < 32)
			{
				bVar4 = NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iVar1);
				if (func_7(bVar4, 1, 1))
				{
					if (func_37(bVar4) && unk_0x1037B9D45CE6B788(PLAYER::GET_PLAYER_PED(bVar4), Var3.f_4[0 /*3*/], Var3.f_4[1 /*3*/], Var3.f_11, 0, 1, 0))
					{
						bVar2 = true;
						iVar1 = 32;
					}
			...
			if (bVar2)
			{
				...
				{
					fLocal_162[iVar0] = (fLocal_162[iVar0] + (Var3.f_12 * SYSTEM::TIMESTEP()));
					if (fLocal_162[iVar0] > 1f)
					{
						fLocal_162[iVar0] = 1f;
					}
					SYSTEM::TIMESTEP(Var3, 1);
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Var3, fLocal_162[iVar0], false, false);
					unk_0xDC5C33A98881772F(Var3, 0, false, 1);
				}
			}
			else if (fLocal_162[iVar0] != 0f)
			{
				...
				SYSTEM::TIMESTEP(Var3, 1);
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Var3, fLocal_162[iVar0], false, false);
				unk_0xDC5C33A98881772F(Var3, 1, false, 1);
			}
		}
		iVar0++;
	}
...
int func_49(int iParam0, int iParam1)
{
	...
	while (iVar1 < 40)
	{
		if (*iParam0 < 315)
		{
			...
			{
				if (!OBJECT::DOOR_SYSTEM_SET_HOLD_OPEN(Var0))
				{
					return 0;
				}
			}
...
void func_52(struct<15> Param0, bool bParam1)
{
	if (Param0 != 0)
	{
		OBJECT::DOOR_SYSTEM_GET_OPEN_RATIO(Param0, Param0.f_2, Param0.f_3, 0, bParam1, Param0.f_11);
		if (Param0.f_9)
		{
			OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Param0, 1);
		}
		if (Param0.f_12 != 0f)
		{
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Param0, Param0.f_12, false, bParam1);
		}
		if (!Param0.f_6)
		{
			if (Param0.f_7)
			{
				unk_0xDC5C33A98881772F(Param0, Param0.f_8, bParam1, 0);
			}
		}
		if (Param0.f_10)
		{
		...
		if (Param0.f_14 != 0f)
		{
			unk_0x39860265DAC5ADE6(Param0, Param0.f_14, bParam1, 0);
		}
		if (Param0.f_13 != 0f)
		{
			unk_0xF5F9F0152F398CDE(Param0, Param0.f_13, bParam1, 0);
		}
	}
}
...
{
	Local_161[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/] = iParam0;
}
...
int func_58()
{
	...
	if (func_59() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_59()) == 0)
		{
			return 1;
		}
	}
...
int func_74(struct<21> Param0)
{
	...
	func_76(0, -1, 0);
	MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(&Local_138, 30);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_161, 129);
	if (!func_75())
	{
		return 0;
	}
