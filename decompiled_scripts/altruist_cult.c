		...
		if (unk_0x1116855A2A7A342C() || iLocal_77)
		{
			...
			switch (iLocal_50)
			{
				...
				case 3:
					...
					{
						iLocal_94 = 0;
						unk_0xF4F95D084B662764(uLocal_270);
						unk_0x9DED7A5A35006D61(uLocal_108);
						iVar0 = 0;
						while (iVar0 < iLocal_98)
						{
						...
						if (unk_0x40397A9A17EEC1C5(uLocal_106))
						{
							unk_0x856549C07003344B(uLocal_106, 0);
						}
						if (unk_0xAE06B9E39EBDE049(uLocal_101))
						{
							unk_0x315F7D8C33F0AB37(&uLocal_101);
						}
						if (unk_0xAE06B9E39EBDE049(uLocal_101))
						{
							unk_0x315F7D8C33F0AB37(&uLocal_101);
...
void func_116()
{
	...
	switch (iLocal_94)
	{
		case 0:
			...
			uLocal_436 = func_136(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_assaultrifle"), 1, 0, 0, 0, 0, 0, 0);
			if (unk_0xAE06B9E39EBDE049(uLocal_436))
			{
			...
			unk_0x555EE41D7C7078E6(Local_53, 100f, 1, 0, 0, 0);
			...
			uLocal_108 = unk_0x094DCAA30E92994C(-1173.509f, 4924.365f, 222.21f, 277.2293f, 2, 0, 2, 1);
		...
		case 6:
			if (unk_0x59B0C38F9A3B22DB(0))
			{
				...
				if (unk_0x10447A1CD8175FC0("TREVOR", 0))
				{
					...
					unk_0xFE696539D3250000(unk_0x9B0761B4C3EB8BC7(), -1173.509f, 4924.365f, 222.21f, -1, 0, 0f, 1, 0, uLocal_108, 0);
				...
				unk_0xDE8F8016287F771F("rghCult", &uLocal_270);
				iVar1 = 0;
				while (iVar1 < iLocal_98)
				{
					...
					unk_0xD3D9D7C84656DAE5(iLocal_98[iVar1], uLocal_270);
					...
					unk_0x694113444F21E39F(iLocal_98[iVar1], 42, 1);
...
int func_136(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_140(iVar2, iVar8) != 0)
	{
		if (!unk_0xA59F96B50B97E63C(iParam0, 0))
		{
			...
			{
				unk_0xC53D054996356072(uVar1, func_140(iVar2, iVar8));
...
void func_159()
{
	switch (iLocal_93)
	{
		case 0:
			...
			if ((((unk_0x7D167B9A0CCDA347(joaat("a_m_o_acult_02")) && unk_0x7D167B9A0CCDA347(joaat("prop_anim_cash_pile_02"))) && unk_0xC614DDE265D18415("random@altruist_cult")) && unk_0x1BDBFE8EFF10BC95("AC_DELIVERED")) && unk_0x1EC187FFFA21C230(joaat("weapon_assaultrifle")))
			{
				...
				if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					...
					if (unk_0x80FF6C016CDB0FAF(uLocal_99, 0))
					{
						if (unk_0xFD7B900D58065E3B(uLocal_99))
						{
							iLocal_93++;
						}
					}
				...
				{
					uLocal_99 = unk_0xA5D3CD332CD10EE9();
		...
		case 1:
			...
			unk_0x555EE41D7C7078E6(Local_54, 12f, 1, 0, 0, 0);
			...
			if (Global_111858.f_24991.f_5 < 2)
			{
				uLocal_100 = unk_0x79CC07752E7432A1(joaat("prop_anim_cash_pile_02"), Local_53, 1, 1, 0);
				unk_0xF8A652CE310FFC53(uLocal_100, unk_0x9B0761B4C3EB8BC7(), unk_0xE6B87C42793036AA(unk_0x9B0761B4C3EB8BC7(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			}
			else if (Global_111858.f_24991.f_5 >= 2)
			{
				unk_0x92BD213E6A0E666B(iLocal_98[1], joaat("weapon_assaultrifle"), -1, 1, 1);
			}
			uLocal_106 = unk_0x68C2E3309DCAD71E("DEFAULT_ANIMATED_CAMERA", 1);
			uLocal_92 = unk_0xF341A134A5B8D4F6(-1044.636f, 4915.204f, 212.32f, 0f, 0f, 110.52f, 2);
			unk_0xDFDB9C533700BC17(unk_0x9B0761B4C3EB8BC7(), uLocal_92, "random@altruist_cult", sLocal_265, 1000f, -2f, 4, 0, 1148846080, 0);
			unk_0xDFDB9C533700BC17(iLocal_98[0], uLocal_92, "random@altruist_cult", sLocal_263, 1000f, -2f, 4, 0, 1148846080, 0);
			if (Global_111858.f_24991.f_5 >= 2)
			{
				unk_0xDFDB9C533700BC17(iLocal_98[1], uLocal_92, "random@altruist_cult", sLocal_264, 1000f, -2f, 4, 0, 1148846080, 0);
			}
			unk_0x00736EE41CC355ED(uLocal_106, uLocal_92, sLocal_268, "random@altruist_cult");
			unk_0x3ED9330214992278(1, 0, 3000, 1, 0, 0);
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_97[0]) && !unk_0x5AEB5DDFFAD43CA5(uLocal_97[1]))
			{
				unk_0xDFDB9C533700BC17(uLocal_97[0], uLocal_92, "random@altruist_cult", sLocal_266, 1000f, -2f, 4, 0, 1148846080, 0);
				unk_0xDFDB9C533700BC17(uLocal_97[1], uLocal_92, "random@altruist_cult", sLocal_267, 1000f, -2f, 4, 0, 1148846080, 0);
			}
			iLocal_93++;
			break;
		...
		case 2:
			...
			if (unk_0x369E69441C066912(uLocal_92) > fLocal_89)
			{
				iLocal_93++;
			}
			break;
		...
		case 3:
			...
			if (unk_0x369E69441C066912(uLocal_92) > fLocal_88)
			{
				iLocal_93++;
			}
			break;
...
void func_188()
{
	switch (iLocal_93)
	{
		...
		case 3:
			...
			if (Global_111858.f_24991.f_5 == 1 || Global_111858.f_24991.f_5 == 2)
			{
				if ((unk_0x369E69441C066912(uLocal_92) > 0.9742857f && !iLocal_85) && unk_0xA860C15A1C027CBB() == 4)
				{
		...
		case 4:
			if (Global_111858.f_24991.f_5 < 3)
			{
				...
				else
				{
					...
					if (unk_0xAE06B9E39EBDE049(iLocal_98[0]))
					{
						unk_0x80250B8368A4E611(iLocal_98[0], 0, 0);
					}
					if (unk_0xAE06B9E39EBDE049(iLocal_98[1]))
					{
						unk_0x80250B8368A4E611(iLocal_98[1], 0, 0);
					}
					if (unk_0xAE06B9E39EBDE049(uLocal_97[0]))
					{
						unk_0x80250B8368A4E611(uLocal_97[0], 0, 0);
					}
					iLocal_93++;
				}
				if (unk_0xAE06B9E39EBDE049(iLocal_100))
