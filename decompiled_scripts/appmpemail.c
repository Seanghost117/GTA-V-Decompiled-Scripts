	...
	if (Global_19659 == 0)
	{
		if ((func_3(2, Global_19650, 0) || Global_4271009 == 1) || Global_22065 == 1)
		{
			...
			if (iLocal_22 == iLocal_21 || iLocal_22 > iLocal_21)
			{
				...
				uLocal_33 = unk_0xF4712E16A4C164FE();
				while (!unk_0x654BC7395AE9BF77(uLocal_33) && iLocal_28 == 0)
				{
					SYSTEM::WAIT(0);
			...
			if (Global_4269759[iLocal_24 /*104*/].f_24 != 0)
			{
				...
				else
				{
					...
					{
						iLocal_29 = unk_0x14E3913C604B1108(uLocal_33);
					}
					if (iLocal_29 < 0)
					{
						iLocal_29 = 0;
...
float func_46(struct<3> Param0, struct<3> Param1, struct<3> Param2, struct<3> Param3, float fParam4, bool bParam5)
{
	...
	fVar1 = func_48((SYSTEM::TO_FLOAT((unk_0x578C4EF320340AF7() - iLocal_18)) / fParam4), 0f, 1f);
	if (fVar1 < 1f)
	{
		fVar2 = fVar1;
		if (bParam5)
