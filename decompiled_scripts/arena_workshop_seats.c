...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_43.f_1);
		if (PED::DETACH_SYNCHRONIZED_SCENE(fVar0))
		{
			SYSTEM::POW(uParam0->f_43.f_1);
		}
	}
}
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 4:
			...
			Var3 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_48(uParam0), func_47(uParam0), 0f, 2) };
			uVar4 = Var3.f_2;
			fVar5 = 0.05f;
		...
		case 5:
			...
			Var7 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_48(uParam0), func_47(uParam0), 0f, 2) };
			fVar8 = Var7.f_2;
			if ((iVar6 != 1 && iVar6 != 0) || func_34(ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7()), fVar8, 5f))
			{
				uParam0->f_43.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, 1, 0f, 1065353216, 0, 1.12f);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_43.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1148846080, 0);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			fVar9 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_43.f_1);
			if (PED::DETACH_SYNCHRONIZED_SCENE(fVar9))
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(fVar9) >= 1f)
				{
					...
					func_49(uParam0, &sVar1);
					uParam0->f_43.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, 1, 0f, 1065353216, 0, 1.12f);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_43.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1148846080, 0);
					unk_0xB88AF19828BF16ED(uParam0->f_43.f_1);
					func_33(&(uParam0->f_43), 8);
		...
		case 8:
			fVar10 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_43.f_1);
			...
			if (iVar11 == 0 || iVar11 == 1)
			{
				...
				{
					if ((ENTITY::HAS_ANIM_EVENT_FIRED(fVar10) >= 0.7f || ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), 364629851)) || ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), 2116425869))
					{
						SYSTEM::POW(uParam0->f_43.f_1);
						func_4(-1);
						func_5(uParam0, 1);
...
void func_16(var uParam0)
{
	...
	if (uParam0->f_43.f_4 == 6)
	{
		...
		if ((uParam0->f_43.f_4 == 6 && !ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), -1322051853)) && !func_32(&(uParam0->f_43), 12))
		{
		...
		if (ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), -1322051853))
		{
			func_5(uParam0, 1);
		}
		...
		else
		{
			...
			if (((((!HUD::DISABLE_FRONTEND_THIS_FRAME() && !func_32(&(uParam0->f_43), 0)) && !func_32(&(uParam0->f_43), 4)) && !func_22()) && !func_20(1)) && uParam0->f_43.f_8.f_2 != 3)
			{
				if (uParam0->f_43.f_5 == -1)
				{
				...
				if (uParam0->f_43.f_4 == 6)
				{
					...
					if (((PAD::IS_CONTROL_JUST_PRESSED(2, iVar3) && !PAD::IS_DISABLED_CONTROL_PRESSED(2, 203)) && !Global_2516798) && !Global_2516796)
					{
						func_30(uParam0);
					}
					if (((((PAD::IS_CONTROL_JUST_PRESSED(2, 203) && !PAD::IS_CONTROL_JUST_PRESSED(2, iVar3)) && func_26(func_27())) && func_25()) && func_24(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_9, 4)) && func_23(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_9))
					{
						Global_2516798 = 1;
						Global_2516796 = 1;
					}
...
void func_30(var uParam0)
{
	...
	uParam0->f_43.f_1 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, 1, 0f, 1065353216, 0, 1.12f);
	func_50(uParam0, &sVar0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_43.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1148846080, 0);
	unk_0xB88AF19828BF16ED(uParam0->f_43.f_1);
	func_7(&(uParam0->f_43.f_5));
	func_65(uParam0, 8);
}
...
bool func_52(var uParam0)
{
	...
	switch (uParam0->f_43.f_8)
	{
		...
		default:
			bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, func_14(uParam0->f_43.f_8));
	}
	if (uParam0->f_43.f_8 == 1)
	{
		if (func_12())
...
int func_57(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((MISC::IS_BIT_SET(uVar0[iVar1]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && (func_63(uVar0[iVar1], uParam0[uParam0->f_43.f_2 /*14*/]) || SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar0[iVar1], 0), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
...
int func_62(int iParam0, struct<3> Param1, int iParam2)
{
	if (MISC::IS_BIT_SET(iParam0))
	{
		if (iParam2 == 3)
		{
			if (func_34(ENTITY::IS_ENTITY_IN_WATER(iParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_34(ENTITY::IS_ENTITY_IN_WATER(iParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
void func_67(var uParam0)
{
	...
	else if (uParam0->f_43.f_4 > 4)
	{
		...
		PED::SET_PED_CAPSULE(unk_0x9B0761B4C3EB8BC7(), func_68());
...
void func_69(var uParam0)
{
	...
	func_70(&(uParam0->f_43), 1, PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0));
	func_70(&(uParam0->f_43), 3, SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1));
...
int func_72()
{
	if ((PED::REMOVE_SCENARIO_BLOCKING_AREA() && !func_85()) && !Global_2516796)
	{
		return 1;
	}
	if (!func_84())
...
int func_73()
{
	...
	if (func_74() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_74()) == 0)
		{
			return 1;
		}
	}
...
int func_86()
{
	if (Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_9 != func_19())
	{
		...
		NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(32, 0, Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_9);
		func_95(0, -1, 0);
