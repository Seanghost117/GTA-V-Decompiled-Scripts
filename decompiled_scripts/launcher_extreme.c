...
void __EntryFunction__()
{
	...
	iLocal_54 = -1;
	fLocal_56 = AUDIO::PLAY_SOUND_FROM_COORD();
	...
	if (Var0 == 17)
	{
		fLocal_57 = PATHFIND::SET_ROADS_IN_AREA(Var1 - Vector(40f, 40f, 40f), Var1 + Vector(40f, 40f, 40f), false, true, 1, 1);
		TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", false);
	}
	else if (Var0 == 18)
	{
		fLocal_57 = PATHFIND::SET_ROADS_IN_AREA(-1040f, -2870f, 0f, -910f, -2740f, 50f, false, false, 1, 1);
	}
	...
	while (true)
	{
		...
		{
			func_196(&Var0);
			if (AUDIO::HAS_SOUND_FINISHED(fLocal_56))
			{
				func_191(&Var0, Var1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_190() && func_189(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(fLocal_56)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
			{
				ENTITY::GET_ENTITY_ALPHA(fLocal_56, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_55 == 0 && func_189(unk_0x9B0761B4C3EB8BC7())) && unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Var1, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0))
			{
...
void func_146()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_147(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_147(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_164()
{
	return func_165(TASK::IS_PED_BEING_ARRESTED(), 0);
}
...
void func_167(int iParam0, float fParam1)
{
	...
	{
		case 0:
			*fParam1 = func_168(-1604.668f, 5239.1f, 3.01f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 42);
			break;
		
		case 1:
			*fParam1 = func_168(-1592.84f, 5214.04f, 3.01f, 0);
		...
		case 2:
		case 3:
			*fParam1 = func_168(190.26f, -956.35f, 29.63f, 0);
		...
		case 4:
			*fParam1 = func_168(414f, -761f, 29f, 0);
		...
		case 9:
			*fParam1 = func_168(-1622.89f, 4204.87f, 83.3f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*fParam1 = func_168(1835.53f, 4705.86f, 38.1f, 0);
			}
			else if (iParam0 == 12)
			{
				*fParam1 = func_168(1826.13f, 4698.88f, 38.92f, 0);
			}
			else
			{
				*fParam1 = func_168(637.02f, 119.7093f, 89.5f, 0);
			}
		...
		case 19:
			if (iParam0 == 18)
			{
				*fParam1 = func_168(-954.19f, -2760.05f, 14.64f, 0);
			}
			else
			{
				*fParam1 = func_168(-63.8f, -809.5f, 321.8f, 0);
			}
		...
		case 23:
			if (iParam0 == 21)
			{
				*fParam1 = func_168(-1877.82f, -440.649f, 45.05f, 0);
			}
			else
			{
				*fParam1 = func_168(-915.6f, 6139.2f, 5.5f, 0);
			}
		...
		case 27:
			*fParam1 = func_168(-1104.93f, 291.25f, 64.3f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 44);
			break;
		...
		case 34:
			*fParam1 = func_168(-303.82f, 6211.29f, 31.05f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 386);
			HUD::SET_BLIP_COLOUR(*fParam1, 44);
			break;
		
		case 43:
			*fParam1 = func_168(-44.75f, -1288.67f, 28.21f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 149);
			HUD::SET_BLIP_COLOUR(*fParam1, 44);
			break;
		
		case 46:
			*fParam1 = func_168(-149.75f, 285.81f, 93.67f, 0);
			HUD::SET_BLIP_SPRITE(*fParam1, 66);
			HUD::SET_BLIP_COLOUR(*fParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*fParam1 = func_168(-70.71f, 301.43f, 106.79f, 0);
			}
			else
			{
				*fParam1 = func_168(-257.22f, 292.85f, 90.63f, 0);
			}
...
int func_168(struct<3> Param0, bool bParam1)
{
	...
	HUD::SET_BLIP_SCALE(iVar0, func_169(MISC::SET_BIT(), 1f, 1f));
...
int func_171(var uParam0)
{
	if (*uParam0 == 18)
	{
		if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, 1, 0))
		{
			...
			else if ((!func_172(unk_0x9B0761B4C3EB8BC7(), -828834893) && func_189(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0))) && func_147(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 3f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (func_189(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
					{
...
int func_191(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_189(unk_0x9B0761B4C3EB8BC7()) && func_189(iParam0->f_28[0])) && !func_190()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_195(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_194(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
float func_195(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_206(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_189(bParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_208(uParam1) || !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_207(iParam2) && !PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(bParam0, unk_0x9B0761B4C3EB8BC7(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_207(iParam2) || PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_220(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_220(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_223(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_225(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_225(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_232(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_225(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_235(bool bParam0)
{
	...
	if (func_189(unk_0x9B0761B4C3EB8BC7()) && func_189(bParam0))
	{
		...
		case 2:
			...
			if (!MISC::IS_BIT_SET(uParam0->f_28[0]))
			{
				if (func_252(&(uParam0->f_28[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
					...
					if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
					{
						TASK::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], unk_0x9B0761B4C3EB8BC7(), -1, 48, 2);
					}
				}
				else
				{
			...
			if (!MISC::IS_BIT_SET(uParam0->f_35[2]))
			{
