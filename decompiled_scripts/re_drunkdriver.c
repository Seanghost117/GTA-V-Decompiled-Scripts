			...
			switch (iLocal_51)
			{
				...
				case 1:
					...
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
					{
						func_173();
						func_170();
						if (iLocal_52 == 1 && !MISC::IS_BIT_SET(iLocal_73[1]))
						{
							func_76();
							if (func_74() || PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
							{
								if (MISC::IS_BIT_SET(iLocal_73[0]))
								{
									if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_73[0], 0))
									{
										if (PED::IS_PED_IN_GROUP(iLocal_73[0]))
										{
											PED::REMOVE_PED_FROM_GROUP(iLocal_73[0]);
										}
										HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[0]);
										TASK::TASK_SMART_FLEE_PED(iLocal_73[0], unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
						...
						if (iLocal_52 == 2 || (iLocal_52 == 1 && MISC::IS_BIT_SET(iLocal_73[1])))
						{
							func_76();
							if (iLocal_53 != 9)
							{
								if (func_74() || PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
								{
									if (MISC::IS_BIT_SET(iLocal_73[0]))
									{
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
										{
											if (PED::IS_PED_IN_GROUP(iLocal_73[0]))
											{
												PED::REMOVE_PED_FROM_GROUP(iLocal_73[0]);
									...
									{
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
										{
											if (PED::IS_PED_IN_GROUP(iLocal_73[1]))
											{
												PED::REMOVE_PED_FROM_GROUP(iLocal_73[1]);
											}
											HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[1]);
											TASK::TASK_SMART_FLEE_PED(iLocal_73[1], unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
					...
					if ((func_65() && !func_64()) && iLocal_53 != 9)
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
						{
							if (unk_0xC2169C00B643278B(iLocal_73[0], Local_71, 5f, 5f, 5f, 0, 1, 0))
							{
								if (iLocal_52 == 2)
								{
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
...
void func_1()
{
	if (((iLocal_52 == 1 && iLocal_53 == 7) && iLocal_60 == 5) && iLocal_90)
	{
		...
		if (func_2())
		{
			...
			{
				Local_129 = { ENTITY::GET_ENTITY_SPEED_VECTOR(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false) };
			}
		}
	}
}
		...
		if (ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false))
		{
			if (iLocal_52 == 1)
			{
				if (MISC::IS_BIT_SET(iLocal_73[0]))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
					{
						if (unk_0xE0B3BC41DDA88DF0(iLocal_73[0], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0))
						{
							return 1;
						}
					}
			...
			if (iLocal_52 == 2)
			{
				if (MISC::IS_BIT_SET(iLocal_73[0]) && MISC::IS_BIT_SET(iLocal_73[1]))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
					{
						if (unk_0xE0B3BC41DDA88DF0(iLocal_73[0], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0) && unk_0xE0B3BC41DDA88DF0(iLocal_73[1], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0))
						{
							return 1;
						}
					}
...
int func_3()
{
	if (iLocal_52 == 2)
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_74, 200f, 200f, 200f, false, true, 0))
			{
				return 1;
			}
			...
			{
				if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(bLocal_74) && ENTITY::GET_ENTITY_HEALTH(bLocal_74) < iLocal_68)
				{
					iLocal_68 = ENTITY::GET_ENTITY_HEALTH(bLocal_74);
					func_5(0);
					func_68();
					SYSTEM::WAIT(0);
			...
			if (!ENTITY::GET_ENTITY_COORDS(bLocal_74, false) || VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(bLocal_74))
			{
				func_68();
				SYSTEM::WAIT(0);
				if (!func_4())
			...
			if (WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(bLocal_74, 0, 2) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_74, unk_0x9B0761B4C3EB8BC7(), false))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[0]);
...
void func_5(bool bParam0)
{
	...
	else if ((!iLocal_116 && ENTITY::IS_ENTITY_DEAD()) && !func_33("REDR1_SWV"))
	{
		cLocal_118 = { func_9() };
		Local_117 = { func_8() };
		func_6();
...
var func_46(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
int func_74()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_73[0], unk_0x9B0761B4C3EB8BC7(), true) || NETWORK::NETWORK_IS_PLAYER_ACTIVE(iLocal_73[0]))
		{
			return 1;
		}
		...
		if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
		{
			...
			{
				if (PED::CAN_PED_SEE_HATED_PED(iLocal_73[0], unk_0x9B0761B4C3EB8BC7()))
				{
					return 1;
				}
			}
	...
	if (MISC::IS_BIT_SET(iLocal_73[1]))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_73[1], unk_0x9B0761B4C3EB8BC7(), true))
			{
				return 1;
			}
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			...
			if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
			{
				...
				{
					if (PED::CAN_PED_SEE_HATED_PED(iLocal_73[1], unk_0x9B0761B4C3EB8BC7()))
					{
						return 1;
					}
				}
...
void func_76()
{
	...
	switch (iLocal_53)
	{
		case 0:
			if (iLocal_52 == 1)
			{
				if ((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1017.461f, -1259.868f, 3.9183f, -1061.891f, -1424.029f, 24.4253f, 171.75f, 0, 1, 0) && CAM::IS_SPHERE_VISIBLE(Local_125, 1f)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_125, 15f, 15f, 15f, 0, 1, 0))
				{
					if (SYSTEM::VMAG(uLocal_124))
					{
						unk_0x93370FA10F15BE44(&iLocal_124);
					}
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
					{
						if (!SYSTEM::VMAG(uLocal_126[0]))
						{
			...
			if (iLocal_52 == 2)
			{
				if ((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1820.238f, 3671.948f, 30.8437f, 1957.818f, 3751.887f, 55.4436f, 159.9375f, 0, 1, 0) && CAM::IS_SPHERE_VISIBLE(Local_125, 1f)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_125, 15f, 15f, 15f, 0, 1, 0))
				{
					func_156();
					if (!func_196())
					{
		...
		case 1:
			...
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
					TASK::TASK_LOOK_AT_ENTITY(false, iLocal_73[1], 7000, 2060, 4);
					TASK::TASK_PAUSE(0, 2500);
					TASK::TASK_ENTER_VEHICLE(0, bLocal_74, -1, -1, 1f, 1, 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_73[0], iLocal_79);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
				}
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
					TASK::TASK_LOOK_AT_ENTITY(false, iLocal_73[0], 7000, 2060, 4);
					...
					TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_73[1], iLocal_79);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
				}
				SYSTEM::SETTIMERA(0);
				iLocal_53 = 3;
			...
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 8f, 8f, 4f, false, true, 0))
				{
					if (PED::IS_PED_FACING_PED(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 80f))
					{
						bLocal_101 = true;
						SYSTEM::SETTIMERA(0);
						iLocal_53 = 4;
				...
				else if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 30f, 30f, 30f, false, true, 0))
				{
		...
		case 3:
			...
			if (iLocal_52 == 2)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 30f, 30f, 30f, false, true, 0))
					{
						func_155();
						if (func_154())
						{
				...
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_62, 15f, 15f, 15f, 0, 1, 0) && !PED::IS_PED_TRYING_TO_ENTER_A_LOCKED_VEHICLE(unk_0x9B0761B4C3EB8BC7()))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
					{
						if (PED::IS_PED_FACING_PED(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 80f))
						{
							if (PED::CAN_PED_SEE_HATED_PED(iLocal_73[0], unk_0x9B0761B4C3EB8BC7()))
							{
								...
								{
									TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
									TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2060, 4);
									TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "exit_1", 8f, -8f, -1, 0, 0f, false, false, false);
								...
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
								{
									TASK::TASK_LOOK_AT_ENTITY(iLocal_73[1], unk_0x9B0761B4C3EB8BC7(), -1, 2060, 4);
								}
								SYSTEM::SETTIMERA(0);
								iLocal_53 = 4;
							}
				...
				if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_74, 1.5f, 1.5f, 5f, false, true, 0) && PED::IS_PED_TRYING_TO_ENTER_A_LOCKED_VEHICLE(unk_0x9B0761B4C3EB8BC7()))
					{
						if (func_154())
						{
							func_62(0);
						...
						if (func_67(&uLocal_140, "REDR2AU", "REDR2_TRY", 4, 0, 0, 0))
						{
							...
							while (iLocal_59 <= 1)
							{
								if (SYSTEM::VMAG(uLocal_126[iLocal_59]))
								{
									unk_0x93370FA10F15BE44(&(uLocal_126[iLocal_59]));
								}
								iLocal_59++;
							}
							if (!SYSTEM::VMAG(iLocal_127))
							{
								iLocal_127 = func_152(bLocal_74, 0, 0);
							}
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
							{
				...
				if (iLocal_103 < MISC::GET_GAME_TIMER())
				{
					...
					{
						if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1])) && MISC::IS_BIT_SET(bLocal_74))
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
							TASK::TASK_LOOK_AT_ENTITY(false, iLocal_73[1], -1, 2060, 4);
							TASK::TASK_ENTER_VEHICLE(0, bLocal_74, -1, -1, 1f, 1, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_73[0], iLocal_79);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
							TASK::TASK_LOOK_AT_ENTITY(false, iLocal_73[0], -1, 2060, 4);
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_73[0], 0);
							TASK::TASK_ENTER_VEHICLE(0, bLocal_74, -1, 0, 1f, 1, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_73[1], iLocal_79);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
							iLocal_59 = 0;
		...
		case 4:
			if (iLocal_52 == 1)
			{
				switch (iLocal_137)
				{
					case 0:
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 8f, 8f, 4f, false, true, 0) || bLocal_101)
							{
								AUDIO::_0xB542DE8C3D1CB210(false);
								TASK::TASK_LOOK_AT_ENTITY(iLocal_73[0], unk_0x9B0761B4C3EB8BC7(), -1, 2060, 4);
								TASK::TASK_LOOK_AT_ENTITY(iLocal_73[1], unk_0x9B0761B4C3EB8BC7(), -1, 2060, 4);
								TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], -1, 2060, 4);
					...
					case 1:
						if (!func_4())
						{
							if (func_151())
							{
								...
								{
									TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
									TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_1", "drunk_breakout_dd1", 2f, -2f, -1, 0, 0f, false, false, false);
									...
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
										TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_1", "drunk_breakout_dd2", 2f, -2f, -1, 0, 0f, false, false, false);
										TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_73[0], 0);
							...
							else
							{
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
								{
									if (PED::IS_PED_FACING_PED(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 80f))
									{
										TASK::TASK_LOOK_AT_ENTITY(iLocal_73[0], unk_0x9B0761B4C3EB8BC7(), 10000, 2060, 4);
										TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 10000, 2060, 4);
										func_6();
										SYSTEM::WAIT(0);
										iLocal_137++;
									}
					...
					case 3:
						if (!iLocal_84)
						{
							if (SYSTEM::TIMERA() > 1500)
							{
								...
								{
									TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
									TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 10000, 2060, 4);
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 0);
						...
						if (!func_151())
						{
							if (!func_4())
							{
								if (func_67(&uLocal_140, "REDR1AU", "REDR1_PLS", 4, 0, 0, 0))
								{
									...
									if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false))
									{
										VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_74, 1);
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
										{
											TASK::TASK_ENTER_VEHICLE(iLocal_73[0], bLocal_74, -1, 0, 1f, 1, 0);
										}
									}
									iLocal_137++;
								}
					...
					case 5:
						if (func_151())
						{
							...
							if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
							{
								if (ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0) != bLocal_74)
								{
									if (!func_4())
									{
										if (func_22() == 0)
			...
			if (iLocal_52 == 2)
			{
				switch (iLocal_137)
				{
					case 0:
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 10f, 10f, 10f, false, true, 0))
							{
								if (PED::IS_PED_FACING_PED(iLocal_73[0], unk_0x9B0761B4C3EB8BC7(), 50f))
								{
									TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], -1, 2060, 4);
									TASK::TASK_LOOK_AT_ENTITY(iLocal_73[0], unk_0x9B0761B4C3EB8BC7(), -1, 2060, 4);
									TASK::TASK_LOOK_AT_ENTITY(iLocal_73[1], unk_0x9B0761B4C3EB8BC7(), -1, 2060, 4);
					...
					case 2:
						...
						if (!func_4())
						{
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 20f, 20f, 20f, false, true, 0) && SYSTEM::TIMERA() > 9500)
								{
						...
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
						{
							if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_74, 1))
							{
								iLocal_53 = 7;
							}
						}
			...
			if (iLocal_52 == 1)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
				{
					if (SYSTEM::TIMERA() > 50000 || MISC::IS_MINIGAME_IN_PROGRESS(bLocal_74, -1, 0) == iLocal_73[0])
					{
						if (func_67(&uLocal_140, "REDR1AU", "REDR1_FU", 4, 0, 0, 0))
						{
							if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false) && !VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(bLocal_74))
							{
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
								{
									if (SYSTEM::VDIST2(bLocal_74, -1, 0) && unk_0xE0B3BC41DDA88DF0(iLocal_73[0], bLocal_74, 0))
									{
										TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(iLocal_73[0], bLocal_74, 0);
										iLocal_53 = 2;
									}
									else if (MISC::IS_MINIGAME_IN_PROGRESS(bLocal_74, -1, 0) == iLocal_73[0])
									{
										iLocal_53 = 2;
									}
									else if (MISC::IS_MINIGAME_IN_PROGRESS(bLocal_74, -1, 0) == unk_0x9B0761B4C3EB8BC7())
									{
										iLocal_53 = 7;
									}
									else
							...
							else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
							{
								func_70(iLocal_73[0], 120000, 0);
								TASK::TASK_WANDER_STANDARD(iLocal_73[0], 40000f, 0);
								PED::SET_PED_KEEP_TASK(iLocal_73[0], true);
			...
			if (iLocal_52 == 2)
			{
				if (SYSTEM::TIMERA() > 60000)
				{
					if (func_67(&uLocal_140, "REDR2AU", "REDR2_FU", 4, 0, 0, 0))
					{
						if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false))
						{
							if (SYSTEM::VDIST2(bLocal_74, -1, 0))
							{
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
								{
									TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
		...
		case 2:
			if (iLocal_52 == 1)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
					{
						if (unk_0xE0B3BC41DDA88DF0(iLocal_73[0], bLocal_74, 0))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_73[0], 355471868) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_73[0], 355471868) != 0)
							{
								VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bLocal_74, 5f);
								VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(bLocal_74, true);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
								TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, bLocal_74, -1016.152f, -1352.855f, 4.4854f, 4, 50f, 262144, -1f, 100f, true);
								TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, bLocal_74, -1005.757f, -1353.806f, 4.4756f, 4, 50f, 262144, -1f, 100f, true);
								TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, bLocal_74, -989.2302f, -1354.278f, -7.3581f, 4, 50f, 262144, -1f, 100f, true);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
								AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_73[0], iLocal_79);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
								PED::SET_PED_KEEP_TASK(iLocal_73[0], true);
			...
			if (iLocal_52 == 2)
			{
				if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
					{
						if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_73[0], bLocal_74) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_73[1], bLocal_74))
						{
							VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(bLocal_74, true);
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[1]);
		...
		case 5:
			if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[0]);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
					TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, bLocal_74, unk_0x7EC595B99EA7C4B1(bLocal_74, 0f, 2f, 0f), 10f, 0, fLocal_78, 262144, 5f, -1f);
					TASK::TASK_VEHICLE_TEMP_ACTION(0, bLocal_74, 24, 500);
					TASK::TASK_VEHICLE_TEMP_ACTION(0, bLocal_74, 9, 1500);
					TASK::TASK_VEHICLE_TEMP_ACTION(0, bLocal_74, 24, 500);
					TASK::TASK_VEHICLE_TEMP_ACTION(0, bLocal_74, 11, 1500);
					TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, bLocal_74, 2185.817f, 3915.471f, 27.9257f, 4, 30f, 262144, 0f, 0f, true);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_73[0], iLocal_79);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
					PED::SET_PED_KEEP_TASK(iLocal_73[0], true);
		...
		case 7:
			if (iLocal_52 == 1)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
				{
					if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[1], 50f, 50f, 50f, false, true, 0))
					{
				...
				switch (iLocal_60)
				{
					...
					case 5:
						...
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
						{
							if (unk_0xC2169C00B643278B(iLocal_73[0], Local_69, Global_22, 1, 1, 0))
							{
								if (SYSTEM::VMAG(iLocal_82))
								{
				...
				switch (iLocal_60)
				{
					...
					case 1:
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
						{
							...
							TASK::TASK_ENTER_VEHICLE(iLocal_73[0], bLocal_74, 30000, 2, 2f, 1, 0);
						}
						SYSTEM::SETTIMERA(0);
						iLocal_60++;
						break;
					...
					case 2:
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
							TASK::TASK_CLEAR_LOOK_AT(false);
							TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, bLocal_74, 1.5f, -3f, 0f, 1f, 4000, 0.1f, true);
							TASK::TASK_ENTER_VEHICLE(0, bLocal_74, 30000, 1, 2f, 1, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_73[1], iLocal_79);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
						}
					...
					case 3:
						...
						if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
						{
							if (ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false))
							{
								if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_73[0], 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_73[1], 0))
								{
									if (unk_0xE0B3BC41DDA88DF0(iLocal_73[0], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0) && unk_0xE0B3BC41DDA88DF0(iLocal_73[1], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0))
									{
										PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, iLocal_80, 1862763509);
					...
					case 5:
						...
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
						{
							if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1])) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_74, 0))
							{
								if (unk_0xC2169C00B643278B(iLocal_73[0], Local_69, Global_22, 1, 1, 0) && unk_0xC2169C00B643278B(iLocal_73[1], Local_69, Global_22, 0, 1, 0))
								{
									iLocal_60++;
								}
							}
		...
		case 8:
			...
			while (iLocal_59 <= (iLocal_72 - 1))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[iLocal_59]))
				{
					PED::_0x2208438012482A1A(iLocal_73[iLocal_59], 0);
				}
				iLocal_59++;
			}
			if (iLocal_52 == 1)
...
void func_77()
{
	switch (iLocal_106)
	{
		case 0:
			...
			{
				PED::REMOVE_PED_FROM_GROUP(iLocal_73[0]);
				TASK::TASK_LOOK_AT_ENTITY(iLocal_73[1], unk_0x9B0761B4C3EB8BC7(), 10000, 2060, 4);
			}
		...
		case 2:
			if (iLocal_105 < MISC::GET_GAME_TIMER())
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
				{
					HUD::_THEFEED_DISABLE(iLocal_73[0], Local_70, 1f, -1, 1193033728, 1056964608);
...
void func_78(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	func_79(func_110(iParam0), 1, iParam1, bParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_82(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_84() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_84() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_83(bParam0));
...
bool func_88(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_84() /*10931*/].f_6175.f_10, bParam0);
}
...
void func_112()
{
	...
	switch (iLocal_106)
	{
		case 0:
			...
			if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false))
			{
				if (VEHICLE::IS_VEHICLE_STOPPED(bLocal_74))
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[0]);
							PED::REMOVE_PED_FROM_GROUP(iLocal_73[0]);
							TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 4000, 2060, 4);
						}
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[1]);
		...
		case 1:
			if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false))
			{
				...
				unk_0x03D382CB0B44E2FC(bLocal_74, 1120.551f, 2647.307f, 36.9963f, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(bLocal_74, 179.7675f);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_74, 5f);
		...
		case 3:
			if (iLocal_105 < MISC::GET_GAME_TIMER())
			{
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
				{
					unk_0x03D382CB0B44E2FC(iLocal_73[0], 1141.156f, 2643.205f, 37.1487f, 1, 0, 0, 1);
					ENTITY::SET_ENTITY_HEADING(iLocal_73[0], 262.7369f);
					unk_0x03D382CB0B44E2FC(iLocal_73[1], 1140.152f, 2644.149f, 37.1487f, 1, 0, 0, 1);
		...
		case 7:
			...
			if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false))
			{
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_74, 7);
			}
			if (iLocal_111)
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0))
				{
					...
					VEHICLE::SET_VEHICLE_DOORS_SHUT(bLocal_74, true);
...
void func_115(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_119(PLAYER::PLAYER_ID())) && !func_117(PLAYER::PLAYER_ID(), 0)) && !func_116()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_119(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
	...
	switch (iLocal_106)
	{
		...
		case 3:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
				TASK::TASK_LEAVE_ANY_VEHICLE(false, 0, 0);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 1800);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_70, 1f, -1, 0.25f, false, 40000f);
				TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_1", "drunk_fall_over", 2f, -2f, -1, 2359304, 0f, false, false, false);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
				AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_73[0], iLocal_79);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
				PED::SET_PED_KEEP_TASK(iLocal_73[0], true);
...
void func_124()
{
	...
	switch (iLocal_106)
	{
		case 0:
			...
			if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
			{
				if (VEHICLE::IS_VEHICLE_STOPPED(bVar0) && !func_4())
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[0]);
		...
		case 3:
			...
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
				TASK::TASK_LEAVE_ANY_VEHICLE(false, 0, 4194304);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 1800);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_70, 1f, -1, 0.25f, false, 40000f);
				TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_1", "drunk_fall_over", 2f, -2f, -1, 2359304, 0f, false, false, false);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
...
void func_125()
{
	switch (iLocal_106)
	{
		case 0:
			if (ENTITY::GET_ENTITY_COORDS(bLocal_74, false))
			{
				if (VEHICLE::IS_VEHICLE_STOPPED(bLocal_74) && !func_4())
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[0]);
...
void func_127()
{
	...
	if ((ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), "random@drunk_driver_2", "driver_enter_m", 3) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), "random@drunk_driver_2", "driver_idle_m", 3)) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), "random@drunk_driver_2", "driver_exit_m", 3))
	{
		iVar0 = 0;
		iVar1 = NETWORK::_GET_ONLINE_VERSION();
		if (iVar1 != 0)
		{
		...
		if ((((((((func_132(64) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 86)) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 71)) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 72)) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 76)) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 73)) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 68)) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 75)) || iVar0)
		{
	...
	switch (iLocal_309)
	{
		case 0:
			if (func_131())
			{
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
					TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "cardrunkflirt_intro_m", 2f, -2f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "cardrunkflirt_loop_m", 2f, -2f, -1, 1, 0f, false, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_73[0], iLocal_79);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
					TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "cardrunkflirt_intro_f", 2f, -2f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "cardrunkflirt_loop_f", 2f, -2f, -1, 1, 0f, false, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_73[1], iLocal_79);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
		...
		case 4:
			...
			{
				func_129();
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_intro_m", 3))
				{
					if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_intro_m") > 0.9f)
					{
			...
			else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
			{
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[0]);
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_73[1]);
				iLocal_309 = 3;
		...
		case 5:
			if (func_131())
			{
				func_129();
				func_128();
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), ENTITY::GET_ENTITY_MODEL(iLocal_73[1], 0), 0))
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_310) > 15000)
					{
						bVar3 = false;
						iVar4 = NETWORK::_GET_ONLINE_VERSION();
						if (iVar4 != 0)
						{
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
							TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "driver_enter_m", 2f, -2f, -1, 0, 0f, false, false, false);
							TASK::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "driver_idle_m", 2f, -2f, -1, 1, 0f, false, false, false);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
							AUDIO::STOP_SCRIPTED_CONVERSATION(unk_0x9B0761B4C3EB8BC7(), iLocal_79);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
						}
						if (func_22() == 0)
						{
		...
		case 6:
			...
			if ((MISC::GET_GAME_TIMER() - iLocal_310) > 5000 && func_131())
			{
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), ENTITY::GET_ENTITY_MODEL(iLocal_73[1], 0), 0))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_loop_m", 3))
					{
						if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_loop_m") > 0.9f)
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), "random@drunk_driver_2", "driver_idle_m", 3))
							{
								TASK::TASK_PLAY_ANIM(unk_0x9B0761B4C3EB8BC7(), "random@drunk_driver_2", "driver_exit_m", 2f, -2f, -1, 0, 0f, false, false, false);
							}
		...
		case 7:
			...
			if (func_131())
			{
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m", 3))
				{
					if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m") < 0.25f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m") > 0.2f)
					{
						ENTITY::APPLY_FORCE_TO_ENTITY(ENTITY::GET_ENTITY_MODEL(iLocal_73[0], 0), 0, 0f, 0f, 20f, -0.4f, 0f, 0f, 0, true, true, true, false, true);
						iLocal_310 = MISC::GET_GAME_TIMER();
						iLocal_309++;
					}
				}
		...
		case 8:
			...
			if (func_131())
			{
				if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), ENTITY::GET_ENTITY_MODEL(iLocal_73[1], 0), 0))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m", 3))
					{
						if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m") < 0.525f)
						{
							TASK::TASK_PLAY_ANIM(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_loop_m", 2f, -2f, -1, 1, 0f, false, false, false);
							TASK::TASK_PLAY_ANIM(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f", 2f, -2f, -1, 1, 0f, false, false, false);
							iLocal_309 = 6;
...
void func_128()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
	{
		if (ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(iLocal_73[0], 0), false))
		{
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f", 3))
			{
				if ((((NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.15f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.1f) || (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.35f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.3f)) || (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.65f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.6f)) || (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.9f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.85f))
				{
					ENTITY::APPLY_FORCE_TO_ENTITY(ENTITY::GET_ENTITY_MODEL(iLocal_73[0], 0), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, true, true, true, false, true);
					ENTITY::GET_ENTITY_ALPHA(-1, "SUSPENSION_SCRIPT_FORCE", ENTITY::GET_ENTITY_MODEL(iLocal_73[0], 0), 0, 0, 0);
				}
			}
		}
	}
...
int func_131()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
	{
		if (SYSTEM::VDIST(iLocal_73[1], 0))
		{
			bVar0 = ENTITY::GET_ENTITY_MODEL(iLocal_73[1], 0);
			if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
				{
					if (unk_0xE0B3BC41DDA88DF0(iLocal_73[0], bVar0, 0))
					{
						if (MISC::IS_MINIGAME_IN_PROGRESS(bVar0, 2, 0) == iLocal_73[0] && MISC::IS_MINIGAME_IN_PROGRESS(bVar0, 1, 0) == iLocal_73[1])
						{
							return 1;
						}
					}
...
void func_136()
{
	...
	{
		if ((PLAYER::GET_TIME_SINCE_PLAYER_HIT_VEHICLE(PLAYER::PLAYER_ID()) > 0 && PLAYER::GET_TIME_SINCE_PLAYER_HIT_VEHICLE(PLAYER::PLAYER_ID()) < 100) || ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
		{
...
void func_137(struct<3> Param0, int iParam1)
{
	...
	if (func_2())
	{
		if (ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false))
		{
			Var0 = { ENTITY::GET_ENTITY_SPEED_VECTOR(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false) };
		}
	}
	Var1 = { Var0 - Param0 };
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) && !func_33("REDR1_SWV"))
			{
				if (iLocal_132 == -1)
				{
...
void func_139()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
	{
		switch (iLocal_91)
		{
			...
			case 2:
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_1", sLocal_94, 3))
				{
					fVar0 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[0], "random@drunk_driver_1", sLocal_94);
					...
					if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_73[0], "random@drunk_driver_1", sLocal_94) > 0.8f)
					{
						iLocal_91++;
					}
				}
...
void func_141()
{
	if (iLocal_52 == 1)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 150f, 150f, 150f, false, true, 0))
			{
				func_66();
			}
			if (func_151() || PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7()))
			{
				if (!PED::IS_PED_IN_GROUP(iLocal_73[0]))
				{
					PED::SET_PED_AS_GROUP_MEMBER(iLocal_73[0], func_63());
			...
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				if (unk_0xE0B3BC41DDA88DF0(iLocal_73[0], ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0))
				{
					if ((!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_1", sLocal_93, 3) && !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_1", sLocal_94, 3)) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(iLocal_73[0]))
					{
						TASK::TASK_PLAY_ANIM(iLocal_73[0], "random@drunk_driver_1", sLocal_93, 2f, -4f, -1, 1, 0f, false, false, false);
					}
					if (func_154())
				...
				else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_1", sLocal_93, 3))
				{
			...
			else
			{
				if (SYSTEM::VDIST(iLocal_73[0], 0))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_1", sLocal_93, 3))
					{
						TASK::STOP_ANIM_PLAYBACK(iLocal_73[0], 0, false);
					}
				}
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 8f, 8f, 8f, false, true, 0) || PED::IS_PED_IN_ANY_TAXI(unk_0x9B0761B4C3EB8BC7()))
			{
				if (SYSTEM::VMAG(uLocal_126[0]))
				{
					unk_0x93370FA10F15BE44(&(uLocal_126[0]));
	...
	if (iLocal_52 == 2)
	{
		if ((!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_74, 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[1]))
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[0], 150f, 150f, 150f, false, true, 0) || !ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_73[1], 150f, 150f, 150f, false, true, 0))
			{
				if (MISC::IS_BIT_SET(iLocal_73[0]))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
			...
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_74, 0))
			{
				if (unk_0xE0B3BC41DDA88DF0(iLocal_73[0], bLocal_74, 0) && unk_0xE0B3BC41DDA88DF0(iLocal_73[1], bLocal_74, 0))
				{
					if (func_154())
					{
						func_62(0);
...
bool func_144(struct<3> Param0, bool bParam1)
{
	bool bVar0;
	
	bVar0 = HUD::ADD_BLIP_FOR_COORD(Param0);
	HUD::SET_BLIP_SCALE(bVar0, func_145(MISC::SET_BIT(), 1f, 1f));
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
		{
			if (!func_151())
			{
				...
				{
					TASK::TASK_GO_TO_ENTITY(iLocal_73[0], unk_0x9B0761B4C3EB8BC7(), -1, 6f, 2f, 2f, 0);
				}
				if (SYSTEM::VDIST(iLocal_73[0], 0))
				{
	...
	switch (*uParam1)
	{
		case 0:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
			{
				...
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
				AUDIO::STOP_SCRIPTED_CONVERSATION(bParam0, iLocal_79);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
				*uParam1++;
			}
			break;
...
int func_151()
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false))
		{
			if ((((((!PED::IS_PED_ON_ANY_BIKE(unk_0x9B0761B4C3EB8BC7()) && !PED::IS_PED_IN_ANY_HELI(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_PLANE(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_BOAT(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_SUB(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_TRAIN(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_MODEL(unk_0x9B0761B4C3EB8BC7(), joaat("rhino")))
			{
				if (PED::GET_VEHICLE_PED_IS_USING(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) >= iVar0)
				{
					return 1;
				}
			}
...
bool func_153(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_145(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
int func_171()
{
	...
	if (SYSTEM::VDIST(iLocal_73[0], 0))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(ENTITY::GET_ENTITY_MODEL(iLocal_73[0], 0), 0))
		{
			iVar0 = VEHICLE::GET_VEHICLE_LAYOUT_HASH(ENTITY::GET_ENTITY_MODEL(iLocal_73[0], 0));
...
void func_174()
{
	if (!iLocal_57)
	{
		...
		PATHFIND::SET_ROADS_IN_AREA(Local_62 - Vector(8f, 8f, 8f), Local_62 + Vector(8f, 8f, 8f), false, true, 1, 1);
		unk_0xAF7D4BF357E8B79E(Local_66 - Vector(10f, 15f, 15f), Local_66 + Vector(10f, 15f, 15f), 0, 1);
		unk_0xAF7D4BF357E8B79E(Local_69 - Vector(10f, 15f, 15f), Local_69 + Vector(10f, 15f, 15f), 0, 1);
		...
		bLocal_74 = VEHICLE::CREATE_VEHICLE(fLocal_78, Local_66, fLocal_67, true, true, false);
		VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(bLocal_74);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_74, 5f);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(fLocal_78, true);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_74, 3);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(bLocal_74, true);
		iLocal_68 = ENTITY::GET_ENTITY_HEALTH(bLocal_74);
		iLocal_73[0] = PED::CREATE_PED(26, iLocal_76, Local_62, fLocal_63, true, true);
		PED::_0x2208438012482A1A(iLocal_73[0], 1);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_73[0], iLocal_80);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[0], 2.592402E-43f, 1);
		...
		PED::_0x2208438012482A1A(iLocal_73[1], 1);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_73[1], iLocal_80);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[1], 2.592402E-43f, 1);
		...
		if (iLocal_52 == 1)
		{
			...
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(bLocal_74, 1);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[0], 2.886675E-43f, 1);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[0], 4.189882E-43f, 1);
		...
		if (iLocal_52 == 2)
		{
			PATHFIND::SET_ROADS_IN_AREA(Local_69 - Vector(10f, 50f, 30f), Local_69 + Vector(10f, 50f, 30f), false, true, 1, 1);
			VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(bLocal_74, true);
			...
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[0], 1.87774E-43f, 1);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[1], 1.87774E-43f, 1);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[0], 3.643376E-44f, 1);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[1], 3.643376E-44f, 1);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[0], 2.886675E-43f, 1);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[1], 2.886675E-43f, 1);
			PED::SET_PED_CAN_BE_TARGETTED(iLocal_73[0], false);
			...
			STATS::_GET_NGSTAT_INT_HASH(iLocal_73[1], 0);
			TASK::TASK_LOOK_AT_ENTITY(iLocal_73[1], iLocal_73[0], -1, 2060, 4);
...
int func_180(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (MISC::SET_BIT())
	{
		if (func_44() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_89(func_178(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
void func_181()
{
	...
	unk_0x78FCB2E22C41B9D5(fLocal_78);
	...
	if (((ENTITY::DOES_ENTITY_EXIST(iLocal_76) && ENTITY::DOES_ENTITY_EXIST(fLocal_78)) && STREAMING::HAS_ANIM_SET_LOADED("MOVE_M@DRUNK@MODERATEDRUNK")) && ENTITY::DOES_ENTITY_EXIST(fLocal_77))
	{
		if (iLocal_52 == 1)
		{
	...
	else
	{
		unk_0x78FCB2E22C41B9D5(iLocal_76);
		unk_0x78FCB2E22C41B9D5(fLocal_78);
		unk_0x78FCB2E22C41B9D5(fLocal_77);
		if (iLocal_52 == 1)
		{
			STREAMING::REQUEST_PTFX_ASSET();
			STREAMING::REQUEST_ANIM_DICT("random@drunk_driver_1");
...
void func_182()
{
	if (iLocal_52 == 1)
	{
		...
		iLocal_72 = 2;
		fLocal_76 = joaat("a_m_y_beachvesp_01");
		fLocal_77 = joaat("a_m_y_beachvesp_02");
	...
	if (iLocal_52 == 2)
	{
		...
		iLocal_72 = 2;
		fLocal_76 = joaat("a_m_y_genstreet_01");
		fLocal_77 = joaat("a_f_y_hipster_03");
...
int func_183()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_194())
		{
			return 0;
		}
	}
...
void func_205(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	func_206(func_217(), bParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_206(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	void fVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		fVar0 = SYSTEM::ROUND(func_207(SYSTEM::TO_FLOAT(fVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_214(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
bool func_217()
{
	...
	func_218(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_234()) || Global_110905) || Global_30970) || func_233()) || func_30(8, -1)) || func_230()) || func_232()) || func_231()) || func_229()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_234() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_30(8, -1)) || func_229()) || func_228()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_234()) || func_231()) || Global_110905) || Global_30970) || func_233()) || Global_42801) || func_30(8, -1)) || func_230()) || func_228()) || func_229()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_242()
{
	...
	if (iLocal_139)
	{
		...
		unk_0xAF7D4BF357E8B79E(Local_66 - Vector(10f, 15f, 15f), Local_66 + Vector(10f, 15f, 15f), 1, 1);
		unk_0xAF7D4BF357E8B79E(Local_69 - Vector(10f, 15f, 15f), Local_69 + Vector(10f, 15f, 15f), 1, 1);
		func_158(0);
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
		{
		...
		{
			if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_75, 0) && func_147(unk_0x9B0761B4C3EB8BC7(), bLocal_75, 1) > 50f)
			{
				func_254(bLocal_75, 0, 145);
			}
		}
		if (MISC::IS_BIT_SET(iLocal_73[0]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[0]))
			{
				PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[0], 4.442116E-43f, 1);
				if (!SYSTEM::VDIST(iLocal_73[0], 0))
				{
		...
		while (iLocal_59 <= (iLocal_72 - 1))
		{
			if (MISC::IS_BIT_SET(iLocal_73[iLocal_59]))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_73[iLocal_59]))
				{
					PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_73[iLocal_59], 4.442116E-43f, 1);
					if (!SYSTEM::VDIST(iLocal_73[iLocal_59], 0))
					{
...
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_276(bParam0, 0, 0)) || func_276(bParam0, 1, 0)) || func_276(bParam0, 2, 0)) || func_275(bParam0) != 145) || func_274(bParam0)) || func_273(bParam0)) || func_272(bParam0)) || func_271(bParam0)) || !func_262(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_273(bParam0))
		{
		}
...
int func_263(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
Vector3 func_280()
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		fVar0 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_306, 1);
		iLocal_305 = 1;
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_307, 1) < fVar0)
		{
			fVar0 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_307, 1);
			iLocal_305 = 2;
		}
		if (iLocal_305 == 1)
		{
