...
void func_172(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_173(&uVar1, Var0.f_3, Global_98992, iParam1, iParam2);
	}
}
		...
		case 0:
			...
			if (func_214(iLocal_85))
			{
				...
				if (func_214(iLocal_88))
				{
					...
					unk_0xC160551F55D6365A(iLocal_88, 1, 1, 0);
				}
			}
			if (func_214(unk_0x9B0761B4C3EB8BC7()))
			{
		...
		case 1:
			if (unk_0xE9159DB182CF0841())
			{
				if (unk_0x0C7F95EB5CFEFB8B())
				{
					...
					uLocal_264 = unk_0xB5B018137EBE06D3(26379945, 1966.059f, 2861.493f, 50.10657f, 5.965983f, 0f, -30.2506f, 50f, 0, 2);
					unk_0x856549C07003344B(uLocal_264, 1);
					uLocal_265 = unk_0xB5B018137EBE06D3(26379945, 1970.629f, 2872.505f, 49.44081f, 5.712656f, 0f, -160.9523f, 50f, 0, 2);
					...
					if (func_240(iLocal_85, iLocal_88, -1))
					{
						if (iLocal_263)
						{
							...
							else if (!func_222())
							{
								...
								unk_0x856549C07003344B(uLocal_265, 0);
								func_244(0);
								iLocal_83 = 2;
							}
							else if (SYSTEM::TIMERA() > 10000)
							{
								if (!unk_0xC516FEEB950FFD58(uLocal_265))
								{
									unk_0x856549C07003344B(uLocal_265, 1);
									unk_0x856549C07003344B(uLocal_264, 0);
									unk_0x3FD8029C7A771A0E(uLocal_265, 1970.766f, 2872.221f, 49.47233f, 5.712656f, 0f, -160.9523f, 50f, 5000, 3, 3, 2);
								}
							}
						}
						else if (func_214(unk_0x9B0761B4C3EB8BC7()))
						{
							if (unk_0x16BC17A8EDC701A2(unk_0x9B0761B4C3EB8BC7(), -2017877118) == 1)
							{
								...
								SYSTEM::SETTIMERA(0);
								func_217(2000, 0);
								unk_0x3FD8029C7A771A0E(uLocal_264, 1966.352f, 2861.772f, 50.31656f, 4.433831f, 0f, -30.38087f, 50f, 10000, 0, 0, 2);
							}
						}
					}
					else
...
void func_243()
{
	if (!unk_0xAE06B9E39EBDE049(iLocal_85))
	{
		iLocal_85 = unk_0xB3116B49FE00E2F1(26, iLocal_86, Local_257, 0, 1, 1);
	}
	if (func_214(iLocal_85))
	{
		unk_0xDAE36360F0F8C1ED(iLocal_85, 1);
