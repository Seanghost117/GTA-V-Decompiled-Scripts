...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0 == 25)
		{
			...
			{
				PED::SET_PED_MAX_MOVE_BLEND_RATIO(unk_0x9B0761B4C3EB8BC7(), 3f);
			}
		}
		if (func_169(&Var0, 0) && ENTITY::IS_ENTITY_PLAYING_ANIM((Var1.f_2 - Var3.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
int func_184(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_188(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_188(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_189(int iParam0, bool bParam1, struct<3> Param2)
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
...
void func_198(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_127(bParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_200(uParam1) || !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_199(iParam2) && !PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(bParam0, unk_0x9B0761B4C3EB8BC7(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_200(uParam1) && uParam1->f_4 == 0) && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_199(iParam2) || PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_209(bool bParam0, float fParam1)
{
	float fVar0;
...
bool func_211(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_212(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_212(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_213(bool bParam0, bool bParam1)
{
	bool bVar0;
...
int func_215(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_217(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_217(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_221(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0))
	{
		...
		else
		{
			...
			else
			{
				...
				if (func_225(bParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
			if (func_222(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_222(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_224(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_217(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_225(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
...
int func_236(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!MISC::IS_BIT_SET(iLocal_58))
			{
				bLocal_58 = WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_sniperrifle"), 0, Local_57, false, 1f, 0, 0, 1);
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(bLocal_58, joaat("component_at_scope_large"));
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(bLocal_58, joaat("component_at_ar_supp_02"));
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			{
				ENTITY::DETACH_ENTITY(bLocal_58, 0f, -90f, -162.64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_237(char* sParam0, struct<3> Param1, float fParam2, int iParam3)
{
	func_238(sParam0, iLocal_53, Param1, fParam2);
...
void func_238(char* sParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_239(sParam0);
