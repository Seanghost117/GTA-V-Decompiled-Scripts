...
void func_62(var uParam0, bool bParam1)
{
	...
	else if (unk_0x8F7B30F5D982073D(iVar2, "cam") == 6)
	{
		...
		{
			Global_956042.f_33[iVar3 /*88*/].f_59 = SYSTEM::TO_FLOAT(unk_0xB09B53A347BF8B9E(iVar8, "x"));
		}
		else
		{
		...
		{
			Global_956042.f_33[iVar3 /*88*/].f_59.f_1 = SYSTEM::TO_FLOAT(unk_0xB09B53A347BF8B9E(iVar8, "y"));
		}
		else
		{
		...
		{
			Global_956042.f_33[iVar3 /*88*/].f_59.f_2 = SYSTEM::TO_FLOAT(unk_0xB09B53A347BF8B9E(iVar8, "z"));
		}
		else
		{
...
Vector3 func_104(int iParam0, char* sParam1)
{
	...
	{
		uVar1 = unk_0x79248942282C8E38(iParam0, sParam1);
		if (unk_0x8F7B30F5D982073D(uVar1, "x") == 2)
		{
			Var0.x = SYSTEM::TO_FLOAT(unk_0xB09B53A347BF8B9E(iVar1, "x"));
		}
		else
		{
		...
		{
			Var0.f_1 = SYSTEM::TO_FLOAT(unk_0xB09B53A347BF8B9E(iVar1, "y"));
		}
		else
		{
		...
		{
			Var0.f_2 = SYSTEM::TO_FLOAT(unk_0xB09B53A347BF8B9E(iVar1, "z"));
		}
		else
		{
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x21A524CB091C80DE(uVar1, 7, -1, 0, -1, func_140(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_225(var uParam0, bool bParam1)
{
	...
	uVar6 = unk_0x856D5567211886A2(&(Global_794709.f_4[uParam0->f_9 /*88*/]));
