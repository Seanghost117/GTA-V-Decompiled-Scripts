...
void __EntryFunction__()
{
	...
	if (MISC::IS_BIT_SET(iScriptParam_381))
	{
		iLocal_41 = iScriptParam_381;
		iLocal_312 = Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_28;
	...
	while (true)
	{
		...
		{
			if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_374, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 1) < 3f)
			{
				switch (iLocal_307)
				{
					case 0:
					...
					case 1:
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_61())
						{
							func_1();
						}
						else
			...
			else if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_374, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 1) > (3f + 2f))
			{
				func_92();
			}
		}
...
void func_1()
{
	...
	{
		case 0:
			if (((func_56(Local_374, Var0) && !func_55()) && ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7()) > (fLocal_375 - 45f)) && ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7()) < (fLocal_375 + 45f))
			{
		...
		case 1:
			if (func_52(1, 0, 1))
			{
				if (((func_56(Local_374, Var0) && !func_55()) && ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7()) > (fLocal_375 - 45f)) && ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7()) < (fLocal_375 + 45f))
				{
					if ((!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) && PAD::IS_DISABLED_CONTROL_PRESSED(2, 51))
					{
						func_51();
						Global_1573337 = 13;
						func_43();
						...
						TASK::TASK_PED_SLIDE_TO_COORD(unk_0x9B0761B4C3EB8BC7(), Local_374, fLocal_375, 0.75f);
						iLocal_308 = 2;
					}
				}
				else
		...
		case 2:
			...
			func_19(1);
			if (TASK::GET_SCRIPT_TASK_STATUS(unk_0x9B0761B4C3EB8BC7(), 1045468327) == 7)
			{
				func_15(104, 1, -1, 1);
				fLocal_313 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Local_376, Local_377, 2, 0, 0f, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), fLocal_313, sLocal_320, sLocal_321, 4f, -2f, 1, 0, 1148846080, 0);
				if (!func_14(iLocal_318))
				{
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_318), fLocal_313, sLocal_320, sLocal_322, 4f, -2f, 1, 0, 1148846080, 0);
					PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_318), sLocal_324, sLocal_320);
				}
				if (!func_14(iLocal_319))
				{
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_319), fLocal_313, sLocal_320, sLocal_323, 4f, -2f, 1, 0, 1148846080, 0);
					PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_319), sLocal_325, sLocal_320);
				}
				unk_0xB88AF19828BF16ED(fLocal_313);
				iLocal_308 = 3;
			}
			break;
		...
		case 3:
			...
			unk_0xA86915034F55A3BF();
			func_19(1);
			fLocal_314 = PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_313);
			if (ENTITY::HAS_ANIM_EVENT_FIRED(fLocal_314) > 0.99f)
			{
		...
		case 4:
			...
			func_19(1);
			fLocal_313 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Local_376, Local_377, 2, 0, 0f, 1065353216, 0, 1065353216);
			NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), fLocal_313, sLocal_368, sLocal_369, 4f, -2f, 1, 0, 1148846080, 0);
			if (!func_14(iLocal_318))
			{
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_318), fLocal_313, sLocal_368, sLocal_370, 4f, -2f, 1, 0, 1148846080, 0);
				PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_318), sLocal_372, sLocal_368);
			}
			if (!func_14(iLocal_319))
			{
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_319), fLocal_313, sLocal_368, sLocal_371, 4f, -2f, 1, 0, 1148846080, 0);
		...
		case 5:
			...
			{
				fLocal_313 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Local_376, Local_377, 2, 0, 0f, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), fLocal_313, sLocal_344, sLocal_345, 4f, -2f, 1, 0, 1148846080, 0);
				if (!func_14(iLocal_318))
				{
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_318), fLocal_313, sLocal_344, sLocal_346, 4f, -2f, 1, 0, 1148846080, 0);
					PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_318), sLocal_348, sLocal_344);
				}
				if (!func_14(iLocal_319))
				{
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_319), fLocal_313, sLocal_344, sLocal_347, 4f, -2f, 1, 0, 1148846080, 0);
		...
		case 6:
			...
			unk_0xA86915034F55A3BF();
			func_19(1);
			if (!PED::DETACH_SYNCHRONIZED_SCENE(fLocal_313))
			{
				fLocal_313 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Local_376, Local_377, 2, 0, 1.401298E-45f, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), fLocal_313, sLocal_350, sLocal_351, 4f, -2f, 1, 0, 1148846080, 0);
				if (!func_14(iLocal_318))
				{
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_318), fLocal_313, sLocal_350, sLocal_352, 4f, -2f, 1, 0, 1148846080, 0);
					PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_318), sLocal_354, sLocal_350);
				}
				if (!func_14(iLocal_319))
				{
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_319), fLocal_313, sLocal_350, sLocal_353, 4f, -2f, 1, 0, 1148846080, 0);
		...
		case 7:
			...
			{
				if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 223))
				{
					if (func_54("SA_STRIP_MENU"))
					{
						unk_0xD289B55B6AADBA10(1);
		...
		case 8:
			...
			func_19(1);
			fLocal_313 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Local_376, Local_377, 2, 0, 0f, 1065353216, 0, 1065353216);
			NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), fLocal_313, sLocal_356, sLocal_357, 4f, -2f, 1, 0, 1148846080, 0);
			if (!func_14(iLocal_318))
			{
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_318), fLocal_313, sLocal_356, sLocal_358, 4f, -2f, 1, 0, 1148846080, 0);
				PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_318), sLocal_360, sLocal_356);
			}
			if (!func_14(iLocal_319))
			{
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_319), fLocal_313, sLocal_356, sLocal_359, 4f, -2f, 1, 0, 1148846080, 0);
		...
		case 10:
			...
			Global_1573338 = 3;
			fLocal_313 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Local_376, Local_377, 2, 0, 0f, 1065353216, 0, 1065353216);
			NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), fLocal_313, sLocal_362, sLocal_363, 4f, -2f, 1, 0, 1148846080, 0);
			if (!func_14(iLocal_318))
			{
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_318), fLocal_313, sLocal_362, sLocal_364, 4f, -2f, 1, 0, 1148846080, 0);
				PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_318), sLocal_366, sLocal_362);
			}
			if (!func_14(iLocal_319))
			{
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_319), fLocal_313, sLocal_362, sLocal_365, 4f, -2f, 1, 0, 1148846080, 0);
		...
		case 11:
			...
			func_19(1);
			fLocal_314 = PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_313);
			if (ENTITY::HAS_ANIM_EVENT_FIRED(fLocal_314) > 0.5f)
			{
				if (!func_14(iLocal_318))
				{
...
void func_23(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_27(PLAYER::PLAYER_ID())) && !func_25(PLAYER::PLAYER_ID(), 0)) && !func_24()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_27(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
int func_44(int iParam0, int iParam1, int iParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
int func_56(struct<3> Param0, float fParam1, var uParam2, var uParam3)
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if ((!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && !FIRE::IS_ENTITY_ON_FIRE(unk_0x9B0761B4C3EB8BC7())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			...
			{
				if ((((CAM::IS_GAMEPLAY_CAM_RENDERING() && !OBJECT::ADD_DOOR_TO_SYSTEM()) && !CAM::IS_CINEMATIC_CAM_RENDERING()) && !func_60(0)) && !func_59())
				{
					if ((Global_95883 && Global_95884) || func_58())
					{
						return 0;
					}
					if (func_57(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Param0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_61()
{
	...
	if (func_62() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_62()) == 0)
		{
			return 1;
		}
	}
...
int func_72()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_316) && ENTITY::DOES_ENTITY_EXIST(iLocal_317))
	{
		iLocal_310 = 1;
		return 1;
	}
