				...
				if (!func_43(74))
				{
					...
					else if (func_23(iLocal_56))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (SYSTEM::VMAG(Global_31346[iVar3 /*23*/].f_19))
								{
									HUD::SET_BLIP_FLASHES(Global_31346[iVar3 /*23*/].f_19, true);
									HUD::SET_BLIP_FLASH_TIMER(Global_31346[iVar3 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
void func_10()
{
	...
	{
		if (func_14(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_34(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_42()
{
	...
	func_39(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_37(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_38(&uVar0, CLOCK::GET_CLOCK_YEAR());
	func_36(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
float func_51(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
int func_72(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<14> Var0;
...
void func_83(int iParam0)
{
	...
	if (unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 0) && !unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 3))
	{
		if (!Global_111858.f_18570[iParam0 /*6*/].f_1)
		{
			...
			if (iParam0 == 57)
			{
				bVar2 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(3, 11);
				bVar2 *= 30;
	...
	if (unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 2) && !unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 3))
	{
		...
		if (!bVar11)
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_18570[iParam0 /*6*/]), 2);
		}
	}
	iVar12 = 1;
	...
	else if (Global_110945[iParam0 /*10*/].f_3)
	{
		...
		if (!func_120() && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), Var0.f_6, 0) > fVar13)
		{
			Global_110945[iParam0 /*10*/].f_3 = 0;
		}
		else
	...
	{
		if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Var0.f_10)) == AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(""))
		{
		...
		else if (iVar14 == 2)
		{
			...
			{
				if (!func_89() && !LOCALIZATION::GET_CURRENT_LANGUAGE())
				{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (!func_45(35))
		{
			if (unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 2) && !unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 3))
			{
				...
				{
					if (SYSTEM::VDIST2(Var0.f_6, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) < 81f)
					{
						sVar16 = "";
						...
						if (!CAM::IS_SCREEN_FADED_OUT(sVar16))
						{
...
void func_95(int iParam0)
{
	...
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_31346[iVar0 /*23*/].f_11), 8);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_31346[iVar0 /*23*/].f_11), 10);
	unk_0xBE20AB8238688965(&(Global_31346[iVar0 /*23*/].f_11), 18);
}
...
void func_97(int iParam0, char* sParam1)
{
	...
	if (SYSTEM::VMAG(Global_31346[iVar0 /*23*/].f_19))
	{
		PED::IS_PED_IN_PARACHUTE_FREE_FALL(Global_31346[iVar0 /*23*/].f_19, sParam1);
	}
}
...
void func_102(int iParam0, bool bParam1)
{
	...
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_31346[iVar0 /*23*/].f_11), 28);
	}
	if (Global_31343 == 1)
	{
		Global_31344 = 1;
...
int func_112(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				fVar0 = MISC::GET_MODEL_DIMENSIONS(func_113(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 1)));
				switch (fVar0)
				{
...
void func_114(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_115(iParam0) && INTERIOR::GET_INTERIOR_AT_COORDS(Global_89743[26 /*34*/].f_6) == 0)
			{
				Global_111858.f_7257[iParam0] = 1;
				unk_0xDC5C33A98881772F(uParam1->f_5, Global_111858.f_7257[iParam0], 1, 1);
			}
