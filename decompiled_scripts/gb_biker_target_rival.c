...
void func_3(int iParam0)
{
	...
	bVar0 = iParam0;
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2416085.f_388), bVar0);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2416085.f_389), bVar0);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2416085.f_390), bVar0);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2416085.f_392), bVar0);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2416085.f_396), bVar0);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2416085.f_391), bVar0);
}
...
int func_11()
{
	...
	if (func_7(1))
	{
		bVar0 = Global_2540384.f_5188.f_749;
		if (bVar0 != func_6())
		{
			if (func_12(bVar0))
			{
...
int func_12(bool bParam0)
{
	...
	{
		func_77(bParam0, 432, 1, 0);
		if (func_76(bParam0))
		{
			func_73(bParam0, func_74(func_75(PLAYER::PLAYER_ID())), 1, 0);
		}
		if (func_71(bParam0))
		{
			func_69(bParam0, 1, 1, 0);
		}
		func_63(bParam0, 1, 0);
...
int func_23(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_54(PLAYER::PLAYER_ID()) || (func_53() && func_52())) && !unk_0xCE990E643CD9D0E5(Global_2540384.f_4655, 31)) && !bParam4)
	{
		iVar1 = func_51();
				...
				if (VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(iVar1) != -1)
				{
					if (func_5(VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED()) && iParam1 < 4)
						{
							...
							{
								return func_35(iParam0, VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
...
int func_34()
{
	if (func_32() && STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED())
	{
		return 1;
	}
	return 0;
...
void func_63(bool bParam0, bool bParam1, bool bParam2)
{
	...
	func_64(&(Global_2416085.f_723[bParam0]), &(Global_2416085.f_1086[bParam0]), &(Global_2416085.f_393), bParam1, bParam0, bParam2, &uVar0);
}

int func_64(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, var uParam6)
{
	if (bParam5)
	{
...
int func_65(int iParam0)
{
	...
	if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(TASK::IS_PED_BEING_ARRESTED()) == func_66())
	{
		return 1;
	}
	return 0;
...
void func_69(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	var uVar0;
	...
	if (func_64(&(Global_2416085.f_822[bParam0]), &(Global_2416085.f_1185[bParam0]), &(Global_2416085.f_367), bParam1, bParam0, bParam3, &uVar0))
	{
		func_70(bParam0, bParam2);
	}
}
...
{
	return func_72(&(Global_2416085.f_822[bParam0]));
}
...
void func_73(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	var uVar0;
	...
	if (func_64(&(Global_2416085.f_624[bParam0]), &(Global_2416085.f_987[bParam0]), &(Global_2416085.f_389), bParam2, bParam0, bParam3, &uVar0))
	{
		if (bParam2)
		{
...
{
	return func_72(&(Global_2416085.f_624[bParam0]));
}
...
void func_77(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (func_64(&(Global_2416085.f_591[bParam0]), &(Global_2416085.f_954[bParam0]), &(Global_2416085.f_388), bParam2, bParam0, bParam3, &bVar0))
	{
		if (bParam2)
		{
...
int func_80()
{
	...
	if (func_66() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_66()) == 0)
		{
			return 1;
		}
	}
