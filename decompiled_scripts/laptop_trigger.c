...
void __EntryFunction__()
{
	...
	sVar1 = "tvscreen";
	bVar3 = true;
	Var4 = { unk_0x3E4D3CCC220BDFB1(iScriptParam_141, 1) - unk_0x2E6A35AC161797A7(iScriptParam_141) * Vector(0.6f, 0.6f, 0.6f) };
	Var4.f_2 = (Var4.f_2 + 0.5f);
	Local_137 = { unk_0x7EC595B99EA7C4B1(iScriptParam_141, Local_136) };
	Global_1678147 = 0;
	Global_1678143 = 0;
	Global_1678254 = 0;
	while (bVar3)
	{
		if (unk_0xAE06B9E39EBDE049(iLocal_133))
		{
			...
			if (Global_1590532)
			{
				if (!bVar0)
				{
					iVar5 = unk_0x36FE6D3220816ADA(iLocal_133);
					if (iVar5 == joaat("prop_laptop_01a"))
					{
						unk_0x4E32F872FFCBC513(unk_0x3E4D3CCC220BDFB1(iScriptParam_141, 1), 1f, joaat("prop_laptop_01a"), 0);
						Var6 = { unk_0x090239DEAF625B17(iLocal_133, 2) };
						iLocal_133 = unk_0x79CC07752E7432A1(joaat("prop_laptop_lester2"), unk_0x3E4D3CCC220BDFB1(iLocal_133, 1), 0, 1, 0);
						unk_0xC82085403E46A869(iLocal_133, Var6, 2, 1);
						bVar0 = true;
					}
				}
			}
		...
		if (((!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0) && unk_0xAE06B9E39EBDE049(iLocal_133)) && !unk_0x3EBB66F936A3436E()) && unk_0x5A228A6A51E757C8(unk_0x2639A2323BEA8CC6()))
		{
			...
			{
				bVar7 = false;
				iVar8 = unk_0x3214CDFE45D11916(unk_0x9B0761B4C3EB8BC7(), &uVar2, -1);
				iVar9 = 0;
				iVar9 = 0;
				while (iVar9 < iVar8)
				{
					if (!unk_0xA59F96B50B97E63C(uVar2[iVar9], 0))
					{
						if (unk_0x9934470AA0A08B57(uVar2[iVar9], "MP_COMMON_MISS", "HACK_INTRO", 3))
						{
							bVar7 = true;
						}
						else if (unk_0x9934470AA0A08B57(uVar2[iVar9], "MP_COMMON_MISS", "HACK_LOOP", 3))
						{
							bVar7 = true;
						}
					}
				...
				else
				{
					...
					if (unk_0xAE06B9E39EBDE049(iScriptParam_141))
					{
						if (!unk_0xED07D558B3EDDF8A(iScriptParam_141))
						{
							bVar3 = false;
						}
					}
			...
			if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				...
				if (func_4(2, &sVar0))
				{
					if (iLocal_134 != 0)
					{
						...
						iLocal_135 = unk_0xAA579EC5104BFDA9(Local_137, unk_0x090239DEAF625B17(iLocal_133, 2), 2, 0, 0, 1065353216, 0, 1065353216);
...
int func_85()
{
	...
	while (iVar0 < 7)
	{
		if (Global_1630317[unk_0x460153A63B9477BC() /*595*/].f_11.f_11[iVar0] == func_8())
		{
			...
			if (unk_0xF005CCA4263DF67F(&Var2, &uVar1))
			{
				return 0;
			}
		}
...
void func_102(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4)
{
	...
	if (func_104())
	{
		...
		if (iVar0 != 0 && iVar1 != 0)
		{
			StringCopy(&cVar2, "", 32);
			StringCopy(&cVar3, "", 32);
			iVar4 = unk_0x984EC4F65F95F1DF(sParam2);
			if (iVar4 > 0)
			{
				iVar5 = 10;
				if (iVar4 < 10)
				...
				StringCopy(&cVar2, unk_0xADEB7C420EE1C70E(sParam2, 0, iVar5, 31), 32);
				if (iVar4 > 10)
				{
					StringCopy(&cVar3, unk_0xADEB7C420EE1C70E(sParam2, 10, iVar4, 31), 32);
				}
			}
			unk_0x2C53EE932DB422DC(iVar0, &cVar2, iParam4);
			unk_0x2C53EE932DB422DC(iVar1, &cVar3, iParam4);
		}
	}
}
...
struct<16> func_107(int iParam0, int iParam1, int iParam2)
{
	...
	StringCopy(&cVar3, unk_0x277E7CF64BB97AD2(uVar1, -1), 32);
...
void func_112(bool bParam0, bool bParam1, int iParam2)
{
	...
	if (Global_1630317[unk_0x460153A63B9477BC() /*595*/].f_11 != unk_0x460153A63B9477BC())
	{
		if (bParam1)
		{
			unk_0x92D1671F8ECC07BF(iVar2);
			func_157(0);
			func_155(0);
			func_94(21);
			func_94(22);
			Global_1630317[unk_0x460153A63B9477BC() /*595*/].f_11.f_461 = iVar2;
		}
		...
		unk_0x7F177BA08E829AEA(func_63(), &uVar3, &uVar4);
		func_154(uVar3, uVar4);
		sVar5 = unk_0x72F711FF7DB52EBD(unk_0x460153A63B9477BC(), &uVar0);
		...
		{
			iVar1 = (func_151(10139, -1, 0) - 43200);
		}
		func_148(iVar1);
		...
		if (iParam2 != 1)
		{
			...
			{
				bVar7 = false;
				iVar8 = func_151(10136, -1, 0);
				if (!unk_0xCE990E643CD9D0E5(iVar8, 11))
				{
					unk_0xBE20AB8238688965(&iVar8, 11);
					func_128(10136, iVar8, -1, 1, 0);
					bVar7 = true;
				}
				func_118(82, 3, bVar7);
			}
...
void func_170()
{
	...
	{
		unk_0x69C71C91F56D82B9(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_unarmed"), 1);
		Var1 = { unk_0x7EC595B99EA7C4B1(iLocal_133, 0.0328f, -0.8f, 0.3f) };
		bVar2 = false;
		func_234(&uLocal_129);
		if (func_4(0, &sVar0))
		{
			while (!bVar2)
			{
				...
				if (!func_175(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Var1, 0.05f, 0) && !func_210(unk_0xEF7858F25585F853(unk_0x9B0761B4C3EB8BC7()), unk_0xEF7858F25585F853(iLocal_133), 5f))
				{
					if (!func_172(unk_0x9B0761B4C3EB8BC7(), 2106541073))
					{
						unk_0x83CAF206A9B8748C(unk_0x9B0761B4C3EB8BC7(), Var1, 1f, 5000, unk_0xEF7858F25585F853(iLocal_133), 0.25f);
					}
				}
				else
				{
				...
				unk_0xF749BC0D76727CBD(Var1, 0.1f, 255, 0, 0, 255);
				unk_0xEE4D6CCB848CB98B(Var1, unk_0x3E4D3CCC220BDFB1(iLocal_133, 1), 0, 255, 0, 255);
				unk_0xEE4D6CCB848CB98B(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Var1, 0, 0, 255, 255);
				SYSTEM::WAIT(0);
			}
			func_234(&uLocal_129);
			iLocal_134 = 0;
...
void func_171(int iParam0)
{
	...
	switch (iLocal_134)
	{
		case 0:
			...
			if (unk_0xC614DDE265D18415(&sVar0))
			{
				if (unk_0x16BC17A8EDC701A2(unk_0x9B0761B4C3EB8BC7(), 2106541073) == 7 && unk_0xC614DDE265D18415(&sVar0))
				{
					...
					iLocal_135 = unk_0xAA579EC5104BFDA9(Local_137, unk_0x090239DEAF625B17(iParam0, 2), 2, 0, 0, 1065353216, 0, 1065353216);
		...
		case 1:
			...
			iVar5 = unk_0xAB6BAF5BFCAFB141(iLocal_135);
			if (!iLocal_126)
			{
				if (unk_0x369E69441C066912(iVar5) >= 0.93f)
				{
					unk_0xC4CC25B68A91D144(-1, "Login", "GTAO_Exec_SecuroServ_Warehouse_PC_Sounds", 1);
					iLocal_126 = 1;
				}
			}
			if (unk_0xC614DDE265D18415(&sVar1) && (!unk_0xFC5D6FB6EECB392F(iVar5) || unk_0x369E69441C066912(iVar5) >= 0.96f))
			{
				iVar6 = unk_0x344C570D6F8700DF(0, iVar4);
				if ((((unk_0xF005CCA4263DF67F(&cLocal_138, "idle_a") && iVar6 == 0) || (unk_0xF005CCA4263DF67F(&cLocal_138, "idle_b") && iVar6 == 1)) || (unk_0xF005CCA4263DF67F(&cLocal_138, "idle_c") && iVar6 == 2)) || (unk_0xF005CCA4263DF67F(&cLocal_138, "idle_d") && iVar6 == 3))
				{
					iVar6++;
					if (iVar6 >= iVar4)
					{
				...
				iLocal_135 = unk_0xAA579EC5104BFDA9(Local_137, unk_0x090239DEAF625B17(iParam0, 2), 2, 0, 1, 1065353216, 0, 1065353216);
				switch (iVar6)
				{
					case 0:
						unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), iLocal_135, &sVar1, "idle_a", 4f, -2f, 5, 0, 1148846080, 0);
						unk_0xB88AF19828BF16ED(iLocal_135);
						StringCopy(&cLocal_138, "idle_a", 16);
						iLocal_134 = 3;
						break;
					
					case 1:
						unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), iLocal_135, &sVar1, "idle_b", 4f, -2f, 5, 0, 1148846080, 0);
						unk_0xB88AF19828BF16ED(iLocal_135);
						StringCopy(&cLocal_138, "idle_b", 16);
						iLocal_134 = 3;
						break;
					
					case 2:
						unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), iLocal_135, &sVar1, "idle_c", 4f, -2f, 5, 0, 1148846080, 0);
						unk_0xB88AF19828BF16ED(iLocal_135);
						StringCopy(&cLocal_138, "idle_c", 16);
						iLocal_134 = 3;
						break;
					
					case 3:
						unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), iLocal_135, &sVar1, "idle_d", 4f, -2f, 5, 0, 1148846080, 0);
						unk_0xB88AF19828BF16ED(iLocal_135);
						StringCopy(&cLocal_138, "idle_d", 16);
						iLocal_134 = 3;
						break;
					
					default:
						StringCopy(&cLocal_138, "idle_XXX", 16);
						break;
					}
			}
			break;
		...
		case 3:
			...
			iVar5 = unk_0xAB6BAF5BFCAFB141(iLocal_135);
			if (!unk_0xFC5D6FB6EECB392F(iLocal_135) && !unk_0xFC5D6FB6EECB392F(iVar5))
			{
				if (unk_0xFC5D6FB6EECB392F(iLocal_135))
				{
					unk_0x14C2D70A19403A5F(iLocal_135);
				...
				unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), iLocal_135, &sVar1, sVar3, 4f, -2f, 5, 0, 1148846080, 0);
				unk_0xB88AF19828BF16ED(iLocal_135);
				iLocal_134 = 3;
				return;
			}
...
int func_175(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
bool func_212(int iParam0, struct<3> Param1, float fParam2)
{
