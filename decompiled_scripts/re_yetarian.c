...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), Local_57) < (fVar0 * fVar0))
		{
			RECORDING::_DISABLE_ROCKSTAR_EDITOR_CAMERA_CHANGES();
		}
		if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), Local_59) < (fVar0 * fVar0))
		{
			RECORDING::_DISABLE_ROCKSTAR_EDITOR_CAMERA_CHANGES();
		}
		...
		else if (bLocal_72)
		{
			...
			if (func_2(bLocal_48))
			{
				if (func_1(bLocal_48, unk_0x9B0761B4C3EB8BC7(), 1) > 120f)
				{
					func_100();
				}
			}
		...
		case 1:
			...
			if (func_2(bLocal_48))
			{
				if (func_58())
				{
					if (!iLocal_66)
					{
						...
						if (!bLocal_64)
						{
							...
							AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_48, iLocal_87);
						...
						else
						{
							if (!bLocal_65)
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
								TASK::TASK_LOOK_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, 0, 2);
								if (func_1(bLocal_48, unk_0x9B0761B4C3EB8BC7(), 1) <= 4f)
								{
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 1500);
								}
								TASK::TASK_SMART_FLEE_PED(0, unk_0x9B0761B4C3EB8BC7(), 150f, -1, true, false);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
							}
							else
							{
					...
					{
						func_36();
						PED::SET_PED_MAX_MOVE_BLEND_RATIO(bLocal_48, 2f);
						if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_48, 0), 1) >= 100f && !CAM::IS_SPHERE_VISIBLE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_48, 0), 3f))
						{
							PED::DELETE_PED(&bLocal_48);
						}
				...
				else
				{
					...
					if (func_2(bLocal_48))
					{
						PED::SET_PED_RESET_FLAG(bLocal_48, 60, true);
					}
				}
			}
			else
			{
				...
				{
					if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_48, 0))
					{
						if (!iLocal_73)
						{
							iLocal_73 = 1;
...
int func_58()
{
	if (func_2(bLocal_48))
	{
		if (!bLocal_64)
		{
			if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_48, 0), 1) <= 7f || TASK::GET_SCRIPT_TASK_STATUS(bLocal_48, 242628503) == 7)
			{
				if (!iLocal_66)
				{
					if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_48, 0), 1) <= 7f)
					{
					}
					if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_48, 242628503) == 7)
					{
					}
				}
				return 1;
		...
		else if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_48, 0), 1) <= 4.5f || TASK::GET_SCRIPT_TASK_STATUS(bLocal_48, 242628503) == 7)
		{
			if (!iLocal_66)
			{
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_48, 0), 1) <= 4.5f)
				{
				}
				if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_48, 242628503) == 7)
				{
...
void func_59()
{
	if (func_2(bLocal_48))
	{
		if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_48, "cellphone@", "cellphone_call_out", 3))
		{
			if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_48, "cellphone@", "cellphone_call_out") >= 0.24f)
			{
				if (MISC::IS_BIT_SET(bLocal_52))
				{
					PED::GET_PED_BONE_INDEX(&bLocal_52);
...
int func_60()
{
	...
	bVar0 = CUTSCENE::IS_CUTSCENE_PLAYING(Local_45[0 /*20*/].f_10);
	if (bVar0 != 0)
	{
		INTERIOR::PIN_INTERIOR_IN_MEMORY(bVar0);
		if (INTERIOR::IS_INTERIOR_READY(bVar0))
		{
			return 1;
		}
	}
...
void func_61()
{
	switch (iLocal_47)
	{
		...
		case 1:
			if (func_60())
			{
				if (!OBJECT::DOOR_SYSTEM_SET_HOLD_OPEN(-1831288286))
				{
					OBJECT::DOOR_SYSTEM_GET_OPEN_RATIO(-1831288286, joaat("v_ilev_fib_door1"), -31.72f, -1101.85f, 26.57f, 1, 1, 0);
				}
				else if (unk_0x07773546A24F4560(-1831288286) < 1f)
				{
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(-1831288286, 1f, false, false);
					...
					if (func_65())
					{
						if (iLocal_71 == 0)
						{
							if (bLocal_63)
							{
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_48);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
								TASK::TASK_LOOK_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, 12, 2);
...
int func_65()
{
	...
	{
		if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(unk_0x9B0761B4C3EB8BC7()) == AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("rm_showroom"))
		{
			if (!func_129())
			{
...
void func_77(bool bParam0)
{
	if (bParam0)
	{
		if (func_2(bLocal_50))
		{
			ENTITY::SET_ENTITY_VISIBLE(bLocal_50, true, false);
			ENTITY::SET_ENTITY_COORDS(bLocal_50, 0);
			ENTITY::SET_ENTITY_CAN_BE_DAMAGED(bLocal_50, true);
			bLocal_48 = bLocal_50;
			bLocal_52 = iLocal_54;
			func_66(&bLocal_49);
			func_78(&iLocal_53);
	...
	{
		ENTITY::SET_ENTITY_VISIBLE(bLocal_49, true, false);
		ENTITY::SET_ENTITY_COORDS(bLocal_49, 0);
		ENTITY::SET_ENTITY_CAN_BE_DAMAGED(bLocal_49, true);
		bLocal_48 = bLocal_49;
		bLocal_52 = iLocal_53;
		func_66(&bLocal_50);
		func_78(&iLocal_54);
...
void func_79()
{
	switch (iLocal_47)
	{
		...
		case 1:
			if (!func_2(bLocal_49) || !func_2(bLocal_50))
			{
				func_81(&bLocal_49, 18, Local_57, fLocal_58, 1);
				if (func_2(bLocal_49))
				{
					ENTITY::SET_ENTITY_VISIBLE(bLocal_49, false, false);
					ENTITY::SET_ENTITY_CAN_BE_DAMAGED(bLocal_49, false);
					PED::SET_PED_CAN_BE_TARGETTED(bLocal_49, false);
					PED::_0x2208438012482A1A(bLocal_49, 1);
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_49, iLocal_90);
					ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(bLocal_49, true);
					unk_0x92BD213E6A0E666B(bLocal_49, joaat("weapon_pistol"), 999, 0, 0);
					ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(bLocal_49, false, iLocal_88);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_88, 1862763509);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_49, true, 1);
					PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_49, 1.45735E-43f, 1);
					iLocal_53 = OBJECT::CREATE_OBJECT(iLocal_74, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_49, 1), true, true, false);
					OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_53, bLocal_49, ENTITY::ATTACH_ENTITY_TO_ENTITY(bLocal_49, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
					...
					TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
					AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_49, iLocal_87);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
					ENTITY::SET_ENTITY_COORDS(bLocal_49, 1);
				}
				func_81(&bLocal_50, 18, Local_59, fLocal_60, 1);
				if (func_2(bLocal_50))
				{
					ENTITY::SET_ENTITY_VISIBLE(bLocal_50, false, false);
					ENTITY::SET_ENTITY_CAN_BE_DAMAGED(bLocal_50, false);
					PED::SET_PED_CAN_BE_TARGETTED(bLocal_50, false);
					PED::_0x2208438012482A1A(bLocal_50, 1);
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_50, iLocal_90);
					ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(bLocal_50, true);
					unk_0x92BD213E6A0E666B(bLocal_50, joaat("weapon_pistol"), 999, 0, 0);
					ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(bLocal_50, false, iLocal_88);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_88, 1862763509);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_50, true, 1);
					PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_50, 1.45735E-43f, 1);
					iLocal_54 = OBJECT::CREATE_OBJECT(iLocal_74, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_50, 1), true, true, false);
					OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_54, bLocal_50, ENTITY::ATTACH_ENTITY_TO_ENTITY(bLocal_50, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
					TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_b", 8f, -8f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_f", 8f, -8f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_no_a", 8f, -8f, -1, 0, 0f, false, false, false);
					...
					TASK::SET_SEQUENCE_TO_REPEAT(iLocal_87, true);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
					AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_50, iLocal_87);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
					ENTITY::SET_ENTITY_COORDS(bLocal_49, 1);
				}
			}
...
int func_81(bool bParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_84()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_95())
		{
			return 0;
		}
	}
...
int func_96()
{
	if (((((((((((ENTITY::DOES_ENTITY_EXIST(Local_45[0 /*20*/]) && ENTITY::DOES_ENTITY_EXIST(Local_45[1 /*20*/])) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_45[0 /*20*/].f_17)) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_45[1 /*20*/].f_17)) && func_60()) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@")) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@str")) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("reyetarian_simeonoffice")) && ENTITY::DOES_ENTITY_EXIST(iLocal_74)) && ENTITY::DOES_ENTITY_EXIST(joaat("bjxl"))) && ENTITY::DOES_ENTITY_EXIST(joaat("tailgater"))) && ENTITY::DOES_ENTITY_EXIST(joaat("baller2")))
	{
		return 1;
	}
	return 0;
...
void func_97(int iParam0)
{
	switch (Local_45[iParam0 /*20*/].f_18)
	{
			...
			if (!Local_45[iParam0 /*20*/].f_19)
			{
				if (!func_2(Local_45[iParam0 /*20*/].f_1))
				{
					...
					if (func_2(Local_45[iParam0 /*20*/].f_1))
					{
						...
						PED::_0x2208438012482A1A(Local_45[iParam0 /*20*/].f_1, 1);
						...
						if (func_55() == 0)
						{
							unk_0x92BD213E6A0E666B(Local_45[iParam0 /*20*/].f_1, Local_45[iParam0 /*20*/].f_17, -1, 1, 1);
						}
		...
		case 2:
			if (func_2(Local_45[iParam0 /*20*/].f_1))
			{
				if (iLocal_67)
				{
					...
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_45[iParam0 /*20*/].f_1);
					...
					TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
					AUDIO::STOP_SCRIPTED_CONVERSATION(Local_45[iParam0 /*20*/].f_1, iLocal_87);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
					Local_45[iParam0 /*20*/].f_18 = 3;
				}
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_45[iParam0 /*20*/].f_1, 0), 1) >= 250f)
				{
		...
		case 3:
			...
			{
				func_99(Local_45[iParam0 /*20*/].f_1, &(Local_45[iParam0 /*20*/].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
				if (TASK::GET_SCRIPT_TASK_STATUS(Local_45[iParam0 /*20*/].f_1, 242628503) == 7 || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_45[iParam0 /*20*/].f_1, 0), 1) <= 5f)
				{
					TASK::TASK_LOOK_AT_ENTITY(Local_45[iParam0 /*20*/].f_1, unk_0x9B0761B4C3EB8BC7(), -1, 0, 2);
					TASK::TASK_COMBAT_PED(Local_45[iParam0 /*20*/].f_1, unk_0x9B0761B4C3EB8BC7(), 0, 16);
		...
		case 4:
			...
			else
			{
				if (iLocal_70[iParam0] == 0)
				{
					...
					{
						unk_0x92BD213E6A0E666B(Local_45[iParam0 /*20*/].f_1, Local_45[iParam0 /*20*/].f_17, -1, 0, 1);
						iLocal_70[iParam0] = 1;
					}
				}
				...
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_45[iParam0 /*20*/].f_1, 0), 1) >= 75f)
				{
					Local_45[iParam0 /*20*/].f_18 = 5;
				}
			}
		...
		case 5:
			...
			if (MISC::IS_BIT_SET(Local_45[iParam0 /*20*/].f_1))
			{
...
int func_99(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_100()
{
	...
	if (MISC::IS_BIT_SET(bLocal_48))
	{
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_48);
		if (SYSTEM::VMAG(fLocal_51))
		{
			unk_0x93370FA10F15BE44(&fLocal_51);
		}
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_82, 0);
	TASK::REMOVE_ALL_COVER_BLOCKING_AREAS();
	if (iLocal_83 != -1)
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(iLocal_83);
	}
	if (iLocal_84 != -1)
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(iLocal_84);
	}
	if (iLocal_85 != -1)
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(iLocal_85);
	}
	if (fLocal_86 != -1)
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(fLocal_86);
	}
	if (TASK::DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))
	{
		if (!TASK::IS_SCENARIO_GROUP_ENABLED("DEALERSHIP"))
...
int func_125()
{
	...
	func_120(&uVar0, CLOCK::GET_CLOCK_YEAR());
	func_118(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
void func_130()
{
	...
	fLocal_82 = PATHFIND::SET_ROADS_IN_AREA(-79.95f, -1126.33f, 20.65f, -3.5f, -1081.6f, 30.67f, false, true, 1, 1);
	TASK::ADD_COVER_BLOCKING_AREA(-34.2476f, -1107.283f, 24.9621f, -24.7924f, -1102.557f, 29.8287f, true, true, true, false);
	if (fLocal_86 == -1)
	{
		fLocal_86 = PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(-29.3f, -1086.35f, 25.57f, 5.5f, 3f, 2f, -10f, 0, 7);
	}
	func_131(196, 0);
	func_131(197, 0);
	func_131(194, 0);
...
int func_136(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				fVar0 = MISC::GET_MODEL_DIMENSIONS(func_137(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 1)));
				switch (fVar0)
				{
...
void func_138(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_139(iParam0) && INTERIOR::GET_INTERIOR_AT_COORDS(Global_89743[26 /*34*/].f_6) == 0)
			{
				Global_111858.f_7257[iParam0] = 1;
				unk_0xDC5C33A98881772F(uParam1->f_5, Global_111858.f_7257[iParam0], 1, 1);
			}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_164()) || Global_110905) || Global_30970) || func_163()) || func_52(8, -1)) || func_160()) || func_162()) || func_161()) || func_159()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_164() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_52(8, -1)) || func_159()) || func_158()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_164()) || func_161()) || Global_110905) || Global_30970) || func_163()) || Global_42801) || func_52(8, -1)) || func_160()) || func_158()) || func_159()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
