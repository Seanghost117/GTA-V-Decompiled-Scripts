...
{
	func_247();
	if (unk_0x8F678487EEBD8CE4(uLocal_79))
	{
		if (func_245() || func_244())
		{
			unk_0x14C1B9C77E952C6F(uLocal_79, 0);
		}
		else
		{
			unk_0x14C1B9C77E952C6F(uLocal_79, 4);
		}
	}
...
void func_146(struct<3> Param0, int iParam1, int iParam2, char* sParam3, var uParam4)
{
	int iVar0;
	int iVar1;
...
void func_249()
{
	...
	{
		uLocal_79 = unk_0x5F920D11DDA03179(Local_75.f_2, Local_75.f_5);
		unk_0xECC9A00CF1181EC2(uLocal_79, 50);
		unk_0xB7F03636BDF7080E(uLocal_79, 220);
		unk_0x3DBD102E8C35EA16(uLocal_79, 0);
		unk_0xB023F5C66F5716C7(uLocal_79, "DCP_BLIPN");
		if (func_245())
		{
			unk_0x14C1B9C77E952C6F(uLocal_79, 0);
		}
...
void func_267()
{
	if (unk_0x8F678487EEBD8CE4(uLocal_79))
	{
		unk_0x93370FA10F15BE44(&uLocal_79);
	}
...
void func_276(var uParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!unk_0x25DDB354A40FFCDB())
	{
		func_268();
