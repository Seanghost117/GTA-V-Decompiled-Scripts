...
void __EntryFunction__()
{
	...
	if (MISC::SET_BIT() && func_278(PLAYER::PLAYER_ID(), 0, 1))
	{
...
void func_11()
{
	...
	if (Local_75 == 1)
	{
		...
		{
			bVar0 = NETWORK::NETWORK_GET_PLAYER_INDEX(PLAYER::INT_TO_PARTICIPANTINDEX(iLocal_84));
			if (func_278(bVar0, 1, 1))
			{
				if (!unk_0xCE990E643CD9D0E5(Local_75.f_1, 0))
				{
	...
	iLocal_84++;
	if (iLocal_84 == NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (iLocal_85 == 0)
		{
			if (unk_0xCE990E643CD9D0E5(Local_75.f_1, 0))
			{
				VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_75.f_1), false);
			}
		}
		else
		{
...
void func_14()
{
	...
	if (!unk_0xCE990E643CD9D0E5(bLocal_78, 1))
	{
		if ((unk_0xCE990E643CD9D0E5(Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 0) && AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) >= (Local_75.f_16 - 1)) && Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 < 10)
		{
			Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2++;
		}
		if (Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 > 0)
		{
			iVar0 = (Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 * Global_262145.f_8102);
			...
			if (unk_0xCE990E643CD9D0E5(bLocal_78, 4))
			{
				if (!unk_0xCE990E643CD9D0E5(bLocal_78, 5))
				{
					func_15(66, 1, -1);
				}
			}
		}
		unk_0xBE20AB8238688965(&bLocal_78, true);
	}
}
...
void func_28(var uParam0, int iParam1)
{
	...
	if (!Global_77101)
	{
		if (!PLAYER::IS_PLAYER_DEAD(PLAYER::GET_PLAYER_INDEX()))
		{
			if (!Global_77102)
			{
				if (PED::REMOVE_SCENARIO_BLOCKING_AREA() && !func_30(0))
				{
...
void func_38(var uParam0, bool bParam1)
{
	...
	if (bParam1 == func_75() || !func_278(bParam1, 0, 1))
	{
		return;
	}
	if (func_22(uParam0->f_1))
	{
		if (uParam0->f_71 == 1)
		{
			uParam0->f_73 = func_39(bParam1, -2, 0, 0, 0);
		}
	}
}

int func_39(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	
	if (func_71(bParam0) && !bParam4)
	{
		if (bParam2)
		{
			return 0;
	...
	if (((func_71(PLAYER::PLAYER_ID()) || (func_70() && func_69())) && !unk_0xCE990E643CD9D0E5(Global_2540384.f_4655, 31)) && !bParam4)
	{
		iVar1 = func_68();
		if (MISC::IS_BIT_SET(iVar1))
		{
			if (PLAYER::SET_PLAYER_WANTED_LEVEL(iVar1))
			{
				...
				{
					if (func_278(VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED()) && iParam1 < 4)
						{
							if (Global_4456448.f_77785[iParam1] != -1)
							{
								return func_66(iParam1, bParam0, 0);
							}
							else
							{
								return func_52(bParam0, VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED()) && iParam1 < 4)
	{
		...
		{
			return func_52(bParam0, PLAYER::PLAYER_ID(), iParam1, bParam2, bParam3);
		}
	}
	return func_52(bParam0, PLAYER::PLAYER_ID(), iParam1, bParam2, bParam3);
}
...
int func_51()
{
	if (func_49() && STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED())
	{
		return 1;
	}
	return 0;
...
int func_52(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_54(bParam1, bParam0, iVar0, 0) && !unk_0xCE990E643CD9D0E5(Global_4456448.f_15, 18)) || ((func_46(unk_0x6CC163E30ECE0790(bParam1), unk_0x6CC163E30ECE0790(bParam0), 0) && unk_0xCE990E643CD9D0E5(Global_4456448.f_15, 23)) && !unk_0xCE990E643CD9D0E5(Global_4456448.f_15, 18)))
			{
				return func_45(1);
			}
			...
			{
				return func_41(bParam1, 1, iVar0, bParam4);
			}
		}
...
bool func_54(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
int func_57(bool bParam0)
{
	if (!bParam0 == func_75())
	{
		...
		{
			return Global_2417956.f_818.f_11[func_58(bParam0)];
		}
	}
	return -1;
}
...
bool func_59(bool bParam0, bool bParam1)
{
	...
	return Global_1630317[bParam0 /*595*/].f_11 != func_75();
}
...
int func_60(bool bParam0)
{
	if (bParam0 != func_75())
	{
		if (Global_1630317[bParam0 /*595*/].f_11 != func_75())
		{
...
int func_66(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 > -1 && bParam1 != func_75())
	{
		...
		{
			iVar0 = func_41(bParam1, !bParam2, iParam0, 0);
		}
		...
		if (unk_0xCE990E643CD9D0E5(Global_4456448.f_15, 26) && !func_46(iParam0, unk_0x6CC163E30ECE0790(bParam1), 0))
		{
			iVar0 = func_53(1);
		}
	}
	...
	if (*iParam0 > 0)
	{
		if (!func_128())
		{
			if (func_127(0))
			{
				if (!func_123(0))
				{
					if (AUDIO::PLAY_STREAM_FROM_VEHICLE(func_122()))
					{
						if (func_121() == 100)
						{
							iVar0 = *iParam0;
...
void func_108(bool bParam0, int iParam1, int iParam2)
{
	...
	if (func_278(bParam0, 0, 1))
	{
		Var0 = 1596100569;
		Var0.f_1 = PLAYER::PLAYER_ID();
		Var0.f_2 = iParam1;
		Var0.f_4 = iParam2;
		Var0.f_5 = func_110(bParam0);
		func_109(&(Var0.f_6), &(Var0.f_7));
		SCRIPT::TRIGGER_SCRIPT_EVENT(1, &Var0, 8, func_102(bParam0));
	}
}
...
int func_112(char* sParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	int iVar0;
	struct<8> Var1;
	...
	if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), bParam1) || iParam5)
	{
		...
		unk_0x7006FC1051C85FCA(func_39(bParam1, -2, 1, 0, 0));
...
void func_113(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_116() || !STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED()) || !func_73(PLAYER::PLAYER_ID(), 0))
	{
		return;
	}
...
void func_129()
{
	...
	switch (Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_3)
	{
		case 0:
			...
			{
				func_221();
				unk_0xBE20AB8238688965(&(Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), false);
				unk_0xBE20AB8238688965(&(Global_2540384.f_4656), false);
...
void func_131()
{
	if (!unk_0xCE990E643CD9D0E5(bLocal_78, 5))
	{
		if (!unk_0xCE990E643CD9D0E5(bLocal_78, 4))
		{
			if (Local_75.f_17 == 0)
			{
				unk_0xBE20AB8238688965(&bLocal_78, 4);
			}
			else
			{
				unk_0xBE20AB8238688965(&bLocal_78, 5);
			}
		}
...
void func_172(int iParam0)
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar4))
		{
			...
			{
				if (unk_0x6CC163E30ECE0790(bVar5) == iVar1 || func_46(unk_0x6CC163E30ECE0790(bVar5), iVar1, 0))
				{
					iVar2++;
...
{
	return func_184(func_185(bParam0));
}
...
void func_194()
{
	...
	{
		if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) < Local_75.f_16)
		{
			PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_ID(), Local_75.f_16, false);
...
void func_195()
{
	...
	{
		func_198();
		Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_3 = 0;
	}
	else if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_75.f_2, Local_75.f_6, Local_75.f_6, 950f, 0, 1, 0))
	{
		if (!unk_0xCE990E643CD9D0E5(bLocal_78, false) && unk_0xCE990E643CD9D0E5(bLocal_78, 3))
		{
	...
	{
		if (!unk_0xCE990E643CD9D0E5(bLocal_78, 3))
		{
			unk_0xBE20AB8238688965(&bLocal_78, 3);
		}
		if (unk_0xCE990E643CD9D0E5(bLocal_78, false))
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&bLocal_78, false);
		}
	}
}
...
void func_198()
{
	...
	func_5(&uLocal_82);
	func_199();
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), false);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&bLocal_78, 3);
	unk_0xBE20AB8238688965(&(Global_2540384.f_4656), false);
	if (!unk_0xCE990E643CD9D0E5(bLocal_78, 5))
	{
		unk_0xBE20AB8238688965(&bLocal_78, 5);
...
void func_199()
{
	if (unk_0xCE990E643CD9D0E5(bLocal_78, 2))
	{
		func_200(1, 1, 0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&bLocal_78, 2);
	}
}
...
void func_207(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (unk_0xCE990E643CD9D0E5(Global_2425869[Global_2440049.f_2005.f_703.f_16 /*443*/].f_411, false) && func_208())
		{
			iParam0 = 23;
		}
	}
...
void func_221()
{
	if (!unk_0xCE990E643CD9D0E5(bLocal_78, 2))
	{
		...
		unk_0xBE20AB8238688965(&bLocal_78, 2);
	}
}
...
void func_224(struct<3> Param0, struct<3> Param1, var uParam2, int iParam3, int iParam4, var uParam5)
{
	...
	if (func_233(PLAYER::PLAYER_ID()) || uParam5)
	{
		if (Var0.f_10 == 1)
		{
...
{
	if (((func_236(bParam0, 1) || func_235(bParam0)) || func_186(bParam0, 0)) || func_234(bParam0))
	{
		return 1;
	}
	return 0;
...
bool func_236(bool bParam0, bool bParam1)
{
	if (func_240() != 0)
	{
		return func_226(bParam0) != 0;
	}
	return func_237(bParam0, bParam1, 0);
}
...
void func_247()
{
	if (!unk_0xCE990E643CD9D0E5(bLocal_78, 6))
	{
		if (((((((func_248(60000) && func_250() == 1) && Local_75.f_7 <= 1) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && !HUD::DISABLE_FRONTEND_THIS_FRAME()) && func_278(PLAYER::PLAYER_ID(), 1, 1)) && !func_197()) && Local_75.f_16 != 5)
		{
			if (!func_245())
			{
				func_196("DCP_HELP1", -1);
			}
			unk_0xBE20AB8238688965(&bLocal_78, 6);
		}
	}
}
...
void func_249()
{
	...
	{
		iLocal_79 = HUD::ADD_BLIP_FOR_RADIUS(Local_75.f_2, Local_75.f_5);
		HUD::SET_BLIP_COLOUR(iLocal_79, 50);
		HUD::SET_BLIP_ALPHA(iLocal_79, 220);
		HUD::SHOW_HEIGHT_ON_BLIP(iLocal_79, false);
		PED::IS_PED_IN_PARACHUTE_FREE_FALL(iLocal_79, "DCP_BLIPN");
		if (func_245())
		{
			HUD::SET_BLIP_DISPLAY(iLocal_79, 0);
		}
...
int func_254(bool bParam0)
{
	...
	while (iVar0 < 32)
	{
		if (func_278(NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iVar0), 0, 1))
		{
...
int func_256()
{
	...
	if (func_257() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_257()) == 0)
		{
			return 1;
		}
	}
...
void func_267()
{
	...
	if (unk_0xCE990E643CD9D0E5(Local_75.f_1, true))
	{
...
void func_270(struct<21> Param0)
{
	...
	func_274(0, -1, 0);
	MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(&Local_75, 20);
