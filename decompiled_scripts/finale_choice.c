	...
	while (func_35(23) && !func_34(134))
	{
		if (func_29() == 1)
		{
			if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				{
					if ((!PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7()) && !NETWORK::NETWORK_IS_PLAYER_ACTIVE(unk_0x9B0761B4C3EB8BC7())) && !FIRE::IS_ENTITY_ON_FIRE(unk_0x9B0761B4C3EB8BC7()))
					{
						if (!bVar0)
						{
							if (!((func_28() || LOCALIZATION::GET_CURRENT_LANGUAGE()) || func_27()))
							{
								if (func_13())
								{
									bVar0 = true;
						...
						else
						{
							...
							switch (func_12())
							{
								...
								case -1989308064:
									func_7(12, 0);
									func_6(134, 1);
									NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(joaat("SP_FINAL_DECISION"), 2, 1);
									break;
								...
								case -1060930305:
									func_7(12, 1);
									func_6(134, 1);
									NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(joaat("SP_FINAL_DECISION"), 1, 1);
									break;
								
								case -1817481777:
									func_7(12, 2);
									func_6(134, 1);
									NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(joaat("SP_FINAL_DECISION"), 3, 1);
									break;
...
int func_36(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<15> Var0;
