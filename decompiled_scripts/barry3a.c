...
void __EntryFunction__()
{
	...
	func_451();
	if (MISC::IS_BIT_SET(Local_39.f_35[0]))
	{
	...
	if (MISC::IS_BIT_SET(Local_39.f_35[1]))
	{
		func_423(&(Local_56[0 /*29*/]), &(Local_39.f_35[1]));
	}
	if (MISC::IS_BIT_SET(Local_39.f_28[0]))
	{
		func_422(&(Local_56[0 /*29*/].f_1), &(Local_39.f_28[0]));
	}
	if (MISC::IS_BIT_SET(Local_39.f_28[1]))
	{
		...
		case 0:
			...
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
			{
				if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) < 1)
				{
					iLocal_241 = 1;
					iLocal_242 = 0;
					bLocal_42 = func_213(Local_53, 5, 1);
				}
				else
				{
					iLocal_241 = 1;
					iLocal_242 = 1;
					if (VEHICLE::IS_THIS_MODEL_A_CAR(203) == 0 || !func_212())
					{
						func_210(2);
						iLocal_240 = 0;
					}
			...
			else
			{
				...
				bLocal_42 = func_208(Local_43.f_4, 1, 5);
			}
			iLocal_41 = 1;
			break;
...
bool func_208(int iParam0, bool bParam1, int iParam2)
{
	bool bVar0;
...
bool func_213(struct<3> Param0, int iParam1, bool bParam2)
{
	bool bVar0;
	...
	switch (iLocal_41)
	{
		...
		case 1:
			if (unk_0xC2169C00B643278B(Local_43.f_4, Local_53, 10f, 10f, 2f, 0, 1, 0))
			{
				...
				{
					func_217();
					if (!func_216(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 55f, 1) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_43.f_4))
					{
						iLocal_41 = 2;
					}
					else if ((iLocal_237 && func_209(5)) && (VEHICLE::IS_THIS_MODEL_A_CAR(203) == 0 || !func_212()))
					{
						func_210(5);
					}
				}
...
void func_238(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
int func_240(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_242()
{
	switch (iLocal_41)
	{
		case 0:
			func_214(&bLocal_42);
			if (!func_212() || VEHICLE::IS_THIS_MODEL_A_CAR(203) == 0)
			{
				func_210(2);
				func_253(&uLocal_254);
				iLocal_235 = 0;
		...
		case 1:
			func_248(&uLocal_254, &uLocal_63, "BAR3AAU", &sLocal_255, &bLocal_261);
...
void func_245()
{
	if (iLocal_232 && iLocal_230 < 4)
	{
		if (!func_212() && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
		{
			...
			{
				if (iLocal_230 != 2 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_43.f_4) > 10f)
				{
					if (func_235() || VEHICLE::IS_THIS_MODEL_A_CAR(203) == 0)
					{
...
int func_247()
{
	if (PED::IS_COP_PED_IN_AREA_3D(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) - Vector(70f, 70f, 70f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) + Vector(70f, 70f, 70f)))
	{
		return 1;
	}
	return 0;
...
void func_248(var uParam0, var uParam1, char* sParam2, char* sParam3, bool bParam4)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD())
			{
				...
				{
					if (func_249(uParam1, sParam2, sParam3, bParam4, 8, 1, 0))
					{
						*uParam0 = 3;
					}
				}
		...
		case 4:
			if (!ENTITY::IS_ENTITY_DEAD() && func_249(uParam1, sParam2, sParam3, bParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
bool func_249(var uParam0, char* sParam1, char* sParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_254()
{
	switch (iLocal_41)
	{
		case 0:
			func_214(&bLocal_42);
			bLocal_42 = func_208(Local_43.f_4, 1, 5);
			HUD::SET_BLIP_ROUTE(bLocal_42, true);
			if (func_209(3) && (VEHICLE::IS_THIS_MODEL_A_CAR(203) == 0 || !func_212()))
			{
				func_210(3);
				func_253(&uLocal_254);
			}
	...
	switch (iLocal_41)
	{
		case 0:
			...
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
			{
				func_214(&bLocal_42);
				bLocal_42 = func_213(Local_53, 5, 1);
				if (func_209(0) && (VEHICLE::IS_THIS_MODEL_A_CAR(203) == 0 || !func_212()))
				{
					func_210(0);
					func_253(&uLocal_254);
				}
		...
		case 1:
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4, 0))
			{
				...
				else
				{
					...
					if (PED::IS_PED_SITTING_IN_VEHICLE(unk_0x9B0761B4C3EB8BC7(), Local_43.f_4) && unk_0xC2169C00B643278B(Local_43.f_4, Local_53, 6f, 6f, 2f, 1, 1, 0))
					{
						iLocal_243 = 0;
						iLocal_41 = 2;
					}
...
void func_258(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_331(TASK::IS_PED_BEING_ARRESTED(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_201(TASK::IS_PED_BEING_ARRESTED(), 1);
			if (iVar4 != -1)
			{
		...
		func_259(iParam0, bParam1, iParam4, iParam5);
...
{
	func_260(&Global_105407, TASK::IS_PED_BEING_ARRESTED(), iParam0, uParam1, iParam3, iParam2);
}

void func_260(var uParam0, bool bParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_262(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	...
	{
		uParam1->f_5 = func_148(bParam2);
	}
	if (func_275(bParam2, &iVar0, iParam3, iParam5))
	{
	...
	else if (MISC::IS_BIT_SET(iVar0))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar0, 0))
		{
			...
			{
				func_263(uParam0, uParam1, bVar0, iParam4);
			}
		}
	}
}
...
int func_268(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == bParam0)
			{
				...
				{
					if (iParam2 == 0 || MISC::GET_MODEL_DIMENSIONS(bParam0) == func_269(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_271(bool bParam0, var uParam1)
{
	int iVar0;
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_273(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
int func_275(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	bool bVar0;
...
void func_278(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		...
		while (iVar1 < 12)
		{
			func_281(bParam0, iVar1, &(uParam1->f_13[iVar1]), uParam1[iVar1], &(uParam1->f_26[iVar1]), iParam2, 145);
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 9)
		{
			func_280(bParam0, iVar1, &(uParam1->f_39[iVar1]), &(uParam1->f_49[iVar1]), iParam2, 145);
			iVar1++;
		}
		if (func_151(iVar0))
		{
...
void func_280(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_281(bool bParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_283(bool bParam0, bool bParam1)
{
	...
	iVar0 = func_148(iParam0);
	if (func_151(iVar0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		if (bParam0 == unk_0x9B0761B4C3EB8BC7())
		{
			func_284(bParam0, &(Global_111858.f_2359.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_284(bool bParam0, var uParam1)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(bParam0, func_289(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
int func_295(var uParam0)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_316())
		{
			*uParam0 = func_300(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_297(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (MISC::SET_BIT())
	{
		if (func_7() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_69(func_298(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
int func_300(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam1 == 6 || iParam1 == func_315(iVar0))
		{
			...
			{
				fVar1 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Param0, func_301(iVar0, 0), 1);
...
var func_317()
{
	...
	func_318(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
int func_332(void fParam0, bool bParam1)
{
	int iVar0;
...
void func_335(struct<3> Param0, bool bParam1, int iParam2, int iParam3)
{
	struct<3> Var0;
	var uVar1;
	...
	if (MISC::IS_BIT_SET(Global_102423.f_4))
	{
		if (ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, false))
		{
			if (func_362(24) != Global_102423.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_359(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Global_102423.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						bParam1 = uVar1;
					}
				}
				func_336(Global_102423.f_4, Param0, bParam1, 24, 0);
			}
		}
	}
}

void func_336(bool bParam0, struct<3> Param1, bool bParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (MISC::IS_BIT_SET(iParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		func_355(iParam3, &Var0, Param1, bParam2, func_267(bParam0));
		func_337(iParam3, bParam0, 0);
	}
}
...
void func_338(bool bParam0, int iParam1)
{
	...
	func_271(bParam0, &(Global_111858.f_32745.f_5510));
}

int func_339(bool bParam0)
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_276(bParam0, 0, 0)) || func_276(bParam0, 1, 0)) || func_276(bParam0, 2, 0)) || func_267(bParam0) != 145) || func_353(bParam0)) || func_352(bParam0)) || func_351(bParam0)) || func_350(bParam0)) || !func_340(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_352(bParam0))
		{
		}
...
int func_340(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_341(fParam0, 0))
	{
		return 0;
	}
...
int func_341(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
void func_355(int iParam0, var uParam1, struct<3> Param2, bool bParam3, int iParam4)
{
	if (func_354(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
void func_367(int iParam0)
{
	...
	{
		case 0:
			if (!MISC::IS_BIT_SET(Local_56[iParam0 /*29*/].f_1))
			{
			...
			else if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(Local_56[iParam0 /*29*/].f_1, 0))
			{
				PED::SET_PED_AS_COP(Local_56[iParam0 /*29*/].f_1, true);
				PED::_0x2208438012482A1A(Local_56[iParam0 /*29*/].f_1, 1);
				...
				if (func_204(Local_56[iParam0 /*29*/].f_2))
				{
					...
					PED::_0x2208438012482A1A(Local_56[iParam0 /*29*/].f_2, 1);
		...
		case 1:
			...
			{
				if (!Local_56[iParam0 /*29*/].f_26 && MISC::IS_BIT_SET(Local_56[iParam0 /*29*/].f_1))
				{
					func_369(&(Local_56[iParam0 /*29*/].f_1));
					Local_56[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_56[iParam0 /*29*/].f_27 && MISC::IS_BIT_SET(Local_56[iParam0 /*29*/].f_2))
				{
					func_369(&(Local_56[iParam0 /*29*/].f_2));
					Local_56[iParam0 /*29*/].f_27 = 1;
				}
				if (!Local_56[iParam0 /*29*/].f_28 && MISC::IS_BIT_SET(Local_56[iParam0 /*29*/]))
				{
...
void func_370(int iParam0, int iParam1)
{
	...
	{
		PED::_0x2208438012482A1A(Local_56[iParam0 /*29*/].f_1, 0);
	...
	{
		PED::SET_PED_AS_COP(Local_56[iParam0 /*29*/].f_2, true);
		PED::_0x2208438012482A1A(Local_56[iParam0 /*29*/].f_2, 0);
...
int func_372(bool bParam0)
{
	...
	if (func_204(iParam0))
	{
		...
		if (PED::IS_PED_BEING_JACKED(bParam0) && func_216(bParam0, unk_0x9B0761B4C3EB8BC7(), 2f, 1))
		{
			return 1;
		}
		...
		else if (func_373(bParam0, 1126825984))
		{
			return 1;
		}
	}
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_376(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_376(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_379(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_381(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_381(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
	...
	switch (iLocal_41)
	{
		case 0:
			if (!func_398())
			{
				...
				if (CAM::IS_SCREEN_FADED_OUT(sLocal_253))
				{
					sLocal_253 = "DEFAULT";
				}
				if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sLocal_253, "DEFAULT"))
				{
					func_472(1);
				}
				else
				{
					func_396(bLocal_253, 1);
				}
				iLocal_41 = 1;
			}
			break;
...
void func_399()
{
	...
	if (iLocal_246)
	{
		if ((!OBJECT::ADD_DOOR_TO_SYSTEM() && !func_403(0)) && !func_398())
		{
...
{
	if (((!func_417(0) || Global_77102) || Global_77091 == 1) || !GRAPHICS::DRAW_SCALEFORM_MOVIE())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((OBJECT::ADD_DOOR_TO_SYSTEM() || func_403(0)) || func_416(1))
			{
			}
			else
			{
...
void func_429(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_433(PLAYER::PLAYER_ID())) && !func_431(PLAYER::PLAYER_ID(), 0)) && !func_430()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_433(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_437(bool bParam0)
{
	...
	else
	{
		...
		ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 28.2f);
	}
	func_426(500, 1);
}
...
void func_442(struct<3> Param0, float fParam1, bool bParam2)
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Local_43.f_5) || !ENTITY::DOES_ENTITY_EXIST(iLocal_51))
	{
		SYSTEM::WAIT(0);
	}
	if (func_204(Local_43.f_4))
	...
	OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_49, Local_43.f_4, 0f, Local_50, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
...
void func_446(bool bParam0)
{
	...
	if (bParam0)
	{
		if (!MISC::IS_BIT_SET(Local_43.f_4))
		{
...
void func_451()
{
	HUD::HAS_ADDITIONAL_TEXT_LOADED("BARR3A", 0);
	...
	bLocal_253 = "DEFAULT";
	func_452(49, 1, 0);
	fLocal_54[0] = PATHFIND::SET_ROADS_IN_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, false, true, 1, 1);
	fLocal_54[1] = PATHFIND::SET_ROADS_IN_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, false, true, 1, 1);
...
void func_463()
{
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_54[0], 0);
	PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_54[1], 0);
	MISC::SET_INSTANCE_PRIORITY_HINT(0);
...
void func_472(bool bParam0)
{
	...
	if (!func_490())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_473(TASK::IS_PED_BEING_ARRESTED(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_474(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_477())
	{
		...
		{
			iVar2 = func_328(TASK::IS_PED_BEING_ARRESTED());
			if (iVar2 > -1)
			{
