...
void __EntryFunction__()
{
	...
	uLocal_62 = unk_0x1FA7B77001D60F9D(unk_0x460153A63B9477BC());
	iLocal_68 = 0;
	...
	while (true)
	{
		...
		{
			if (unk_0xA59F96B50B97E63C(uLocal_62, 0))
			{
				func_188(1);
			}
		}
		if (unk_0xAE06B9E39EBDE049(uLocal_62) && !unk_0xA59F96B50B97E63C(iLocal_62, 0))
		{
			Local_64 = { unk_0x3E4D3CCC220BDFB1(iLocal_62, 1) };
			...
			switch (iLocal_68)
			{
				...
				case 3:
					...
					else
					{
						...
						if (bVar2)
						{
							if (!unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_86, Local_87, fLocal_88, 1, 0, iLocal_76) || (fLocal_90 > 0f && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), func_139(Local_86, Local_87, 0.5f), 0) > fLocal_90))
							{
								bVar2 = false;
							}
				...
				case 6:
					...
					{
						unk_0x9D0F8C73E396F8D9(SYSTEM::ROUND((func_11(&uLocal_80) * 1000f)), iLocal_72, 0);
						func_10(&uLocal_80);
...
void func_44(var uParam0, int iParam1, var uParam2)
{
	...
	while (iVar2 <= 8)
	{
		...
		if (uVar6[iVar2] != iVar5)
		{
			...
			{
				unk_0x89D32AE19D795B85(uParam0, iVar4, Var1.f_3, Var1.f_4);
			}
		}
		iVar2++;
	}
...
void func_169()
{
	...
	if (bLocal_93 && unk_0x7B70881748D166CD(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_92 == 1)
		{
			...
			uVar2[0] = unk_0x344C570D6F8700DF(2, 8);
			iVar3 = 1;
