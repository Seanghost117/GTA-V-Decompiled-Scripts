...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_207(329.513f, 3402.691f, 36.258f, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Var0.f_35[1], 1), 1056964608))
				{
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_191(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_191(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_196(int iParam0, bool bParam1, struct<3> Param2)
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
...
int func_207(struct<2> Param0, float fParam1, struct<2> Param2, bool bParam3, float fParam4)
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
void func_211(bool bParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_127(bParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_213(uParam1) || !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_212(iParam2) && !PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(bParam0, unk_0x9B0761B4C3EB8BC7(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_213(uParam1) && uParam1->f_4 == 0) && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_212(iParam2) || PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
int func_220(bool bParam0, float fParam1)
{
	float fVar0;
...
bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_223(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_223(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_224(bool bParam0, bool bParam1)
{
	bool bVar0;
...
int func_226(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_228(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_228(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_232(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0))
	{
		...
		else
		{
			...
			else
			{
				...
				if (func_236(bParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
			if (func_233(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_233(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_235(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_228(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_236(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
...
float func_245()
{
	return PATHFIND::SET_ROADS_IN_AREA(-309.1f, 6205.4f, 30f, -279.33f, 6217.98f, 40f, false, true, 1, 1);
}
		...
		case 2:
			...
			if (!MISC::IS_BIT_SET(uParam0->f_28[0]))
			{
				if (func_250(&(uParam0->f_28[0]), 59, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
					...
					if (func_126(unk_0x9B0761B4C3EB8BC7()))
					{
						TASK::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], unk_0x9B0761B4C3EB8BC7(), -1, 2050, 4);
					}
				}
				else
				{
			...
			if (!MISC::IS_BIT_SET(uParam0->f_41[1]))
			{
				...
				OBJECT::CREATE_OBJECT_NO_OFFSET(uParam0->f_41[1], uParam0->f_28[0], ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[0], 18905), 0.12f, 0f, 0.03f, 90f, 0f, 90f, 0, 0, 0, 0, 2, 1);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				...
				{
					if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
				...
				if (func_127(uParam0->f_28[1]))
				{
					...
					PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(uParam0->f_28[1], 2.592402E-43f, 1);
				}
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
...
void func_259(bool bParam0, int iParam1)
{
	if (MISC::IS_BIT_SET(iParam0))
	{
		VEHICLE::SET_VEHICLE_ALARM(bParam0, false);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(bParam0, 2);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iParam1, true);
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(bParam0, false, 0);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(bParam0, true);
	}
}
