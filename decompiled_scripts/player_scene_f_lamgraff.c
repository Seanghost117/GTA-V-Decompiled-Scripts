...
int func_2()
{
	...
	{
		if (MISC::IS_BIT_SET(iLocal_235))
		{
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Global_98676, &sLocal_239, &cLocal_271, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_98676))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_98676, 0, false);
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Global_98676);
					return 0;
				}
				bVar0 = ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_280);
				if (!iLocal_234)
				{
...
int func_26()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Global_98676))
	{
		if (MISC::IS_BIT_SET(iLocal_235))
		{
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Global_98676, &sLocal_239, &cLocal_255, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_98676))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_98676, 0, false);
				...
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Global_98676);
					if (!PED::DETACH_SYNCHRONIZED_SCENE(iLocal_280))
					{
						iLocal_280 = PED::CREATE_SYNCHRONIZED_SCENE(Local_237, 0f, 0f, fLocal_238, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_280, true);
					}
					TASK::TASK_SYNCHRONIZED_SCENE(Global_98676, iLocal_280, &sLocal_239, &cLocal_271, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
...
void func_37()
{
	...
	while (!MISC::IS_BIT_SET(Global_98676) || !ENTITY::DOES_ENTITY_EXIST(iLocal_236))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (MISC::IS_BIT_SET(Global_98676))
	{
		...
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_98676, 1862763509);
	}
	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_98676, true, true);
	...
	iLocal_235 = OBJECT::CREATE_OBJECT(iLocal_236, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Global_98676, 1), true, true, false);
	OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_235, Global_98676, ENTITY::ATTACH_ENTITY_TO_ENTITY(Global_98676, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
