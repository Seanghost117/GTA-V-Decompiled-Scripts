...
void __EntryFunction__()
{
	...
	if (func_110(func_112(TASK::IS_PED_BEING_ARRESTED())))
	{
		func_113(0);
	}
	if (!func_109())
	...
	if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_106())
	{
		func_113(0);
	}
	...
	while (!ENTITY::DOES_ENTITY_EXIST(iLocal_36))
	{
		SYSTEM::WAIT(0);
	}
	if (!bLocal_265)
	...
	iLocal_215 = 1;
	while ((!STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_234) || !STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_243)) || !ENTITY::DOES_ENTITY_EXIST(iLocal_36))
	{
		SYSTEM::WAIT(0);
	}
	...
	iLocal_209 = 1;
	if (MISC::IS_BIT_SET(iLocal_208) && func_102(iLocal_208))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_208, 17, true);
		PED::_0x2208438012482A1A(iLocal_208, 1);
	}
	iLocal_223 = 0;
	...
	while (iVar0 == 1)
	{
		...
		{
			func_97(func_112(TASK::IS_PED_BEING_ARRESTED()));
			func_113(0);
		}
		...
		{
			PED::SET_IK_TARGET(iLocal_208, 1, unk_0x9B0761B4C3EB8BC7(), 31086, 0f, 0f, 0f, 0, -1, -1);
		}
		if (fVar12 < 8f)
		{
			PED::SET_IK_TARGET(unk_0x9B0761B4C3EB8BC7(), 1, iLocal_208, 31086, 0f, 0f, 0f, 0, -1, -1);
		}
		if (fVar12 < 15f)
		{
		...
		Var15 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_208, 1) };
		...
		{
			if (!func_89() && INTERIOR::GET_INTERIOR_AT_COORDS(joaat("director_mode")) == 0)
			{
				if (func_108())
				{
				}
		...
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_208) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_208)) && fVar12 < 25f) && func_88(unk_0x9B0761B4C3EB8BC7()) != joaat("weapon_unarmed")) && func_85(iLocal_208, unk_0x9B0761B4C3EB8BC7(), 1126825984, 0))
			{
				if (!func_89())
				{
					func_91();
		...
		if (((((STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_208) || MISC::IS_BULLET_IN_AREA(Var15, 50f, true)) || MISC::IS_BULLET_IN_AREA(Var15, 50f, false)) || MISC::IS_PROJECTILE_IN_AREA(Var15, 20f, 20f, 20f, false)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Var15, 50f)) || GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(Var15, 1f))
		{
			if (!func_89())
			{
				func_91();
		...
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_208, unk_0x9B0761B4C3EB8BC7(), true))
		{
			func_91();
			TASK::TASK_PLAY_ANIM(iLocal_208, &cLocal_234, &Local_203, 2f, -2f, -1, 0, 0f, false, false, false);
			iLocal_216 = 24;
		...
		{
			if (!SYSTEM::VMAG(fLocal_214))
			{
				func_80(&fLocal_214, &iLocal_208, 0);
			}
		}
		else if (SYSTEM::VMAG(fLocal_214))
		{
			func_79(&fLocal_214);
		}
		if (!bLocal_268)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_208) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_208, 1)) < 16f)
				{
					fVar16 = AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(TASK::IS_PED_BEING_ARRESTED());
					iVar17 = func_78(fVar16);
					if (func_77(iVar17))
					{
						if (!func_76(iVar17))
						{
		...
		switch (iLocal_216)
		{
			...
			case 6:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_208, 713668775) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_208, 713668775) != 0)
				{
					...
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_208, false, 0);
					func_118();
					iLocal_216 = 0;
				}
				break;
			...
			case 8:
				...
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252, 3))
					{
						func_52(Global_111803[iLocal_217], iLocal_223, NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 16:
				...
				if (!func_62())
				{
					...
					{
						AUDIO::DISABLE_PED_PAIN_AUDIO(unk_0x9B0761B4C3EB8BC7(), false);
					}
					unk_0x1082C25039B168F8(&Local_264);
					func_11();
					func_101(0, 1);
		...
		bVar18 = INTERIOR::GET_INTERIOR_AT_COORDS(joaat("context_controller")) > 0;
		if (!bVar18)
		{
		}
		if (((((((((((((iLocal_216 == 0 || iLocal_216 == 1) || iLocal_216 == 3) || iLocal_216 == 8) || iLocal_216 == 9) || iLocal_216 == 7) && func_84(iLocal_208, unk_0x9B0761B4C3EB8BC7(), 1) < 5f) && bLocal_265 == 1) && !SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1)) && iVar6 == 0) && bLocal_268 == 1) && !Global_3) && func_7()) && bVar18)
		{
			if (iLocal_224 == -1)
			{
			...
			if (func_4(iLocal_224, 1))
			{
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
				{
					AUDIO::DISABLE_PED_PAIN_AUDIO(unk_0x9B0761B4C3EB8BC7(), true);
				}
				func_91();
				func_101(1, 1);
				iVar6 = 1;
				iLocal_216 = 13;
				iVar5 = 0;
				iVar19 = func_78(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(TASK::IS_PED_BEING_ARRESTED()));
				if (func_77(iVar19))
				{
					if (!func_76(iVar19))
					{
						func_67(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(TASK::IS_PED_BEING_ARRESTED()), 0);
					}
				}
				func_2(&iLocal_224);
			}
	...
	while (true)
	{
		...
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_208, unk_0x9B0761B4C3EB8BC7(), true) && !bVar20)
		{
			PED::_0x2208438012482A1A(iLocal_208, 0);
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_208);
			TASK::TASK_SMART_FLEE_PED(iLocal_208, unk_0x9B0761B4C3EB8BC7(), 100f, -1, false, false);
			PED::SET_PED_KEEP_TASK(iLocal_208, true);
			bVar20 = true;
		}
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_208) && func_84(iLocal_208, unk_0x9B0761B4C3EB8BC7(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_113(1);
		}
		SYSTEM::WAIT(0);
...
void func_1()
{
	...
	if ((MISC::IS_BIT_SET(iLocal_277) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_277, 0)) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_208, 0))
	{
		if (!iLocal_278)
		{
			if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_208, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 1) < 15f)
			{
		...
		else
		{
			...
			if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_277, 1), 377.4565f, 154.6708f, 102.0838f, 1) > 25f)
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_277);
				iLocal_279 = 1;
			}
			else if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_277, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_208, 1), 1) < 3f && iLocal_280 == 0)
			{
				iLocal_280 = 1;
			}
		}
...
void func_9()
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_208, 0))
	{
...
void func_30()
{
	bLocal_220 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, uLocal_219);
}
...
void func_67(void fParam0, bool bParam1)
{
	int iVar0;
...
void func_80(float fParam0, int iParam1, bool bParam2)
{
	if (iLocal_276 == 1)
	{
		if (!SYSTEM::VMAG(*fParam0))
		{
			if (MISC::IS_BIT_SET(*iParam1))
			{
				...
				{
					*fParam0 = func_81(*iParam1, bParam2, 145);
					if (bParam2 == 0)
					{
						HUD::SET_BLIP_PRIORITY(*fParam0, 7);
					}
					HUD::SET_BLIP_COLOUR(*fParam0, 3);
				}
			}
		}
	}
...
float func_81(int iParam0, bool bParam1, int iParam2)
{
	float fVar0;
	
	fVar0 = func_82(iParam0, !bParam1, 0);
...
float func_84(int iParam0, int iParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_90()
{
	if (iLocal_211 != -1)
	{
		...
		{
			VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(fLocal_211);
		}
		fLocal_211 = -1;
	}
}
...
void func_101(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_208) && !VEHICLE::GET_VEHICLE_MOD(iLocal_208, 1))
		{
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_208, false, 0);
		}
	}
...
void func_104()
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(joaat("a_m_m_business_01")))
	{
		SYSTEM::WAIT(0);
	}
...
int func_112(bool bParam0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_AndyMoon"))
	{
		return 1;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_Baygor"))
	{
		return 2;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_BillBinder"))
	{
		return 4;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_Clinton"))
	{
		return 8;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_Griff"))
	{
		return 16;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_Jane"))
	{
		return 64;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_Jerome"))
	{
		return 128;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_Jesse"))
	{
		return 256;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_Mani"))
	{
		return 512;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_Mime"))
	{
		return 1024;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_PamelaDrake"))
	{
		return 2048;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_Superhero"))
	{
		return 4096;
	}
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bParam0, "gpb_Zombie"))
	{
		return 8192;
	}
	return 0;
...
void func_113(int iParam0)
{
	...
	if (iLocal_209)
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&uVar0, &Local_331))
		{
			func_13();
		}
		if (iParam0 == 1)
	...
	if (!CAM::IS_SCREEN_FADED_OUT(&Local_255))
	{
		unk_0x1082C25039B168F8(&Local_255);
	}
	if (iLocal_215 == 1)
	{
		if (!CAM::IS_SCREEN_FADED_OUT(&cLocal_234))
		{
		...
		if (!CAM::IS_SCREEN_FADED_OUT(&cLocal_243))
		{
...
void func_114(float fParam0)
{
	if (SYSTEM::VMAG(*fParam0))
	{
		HUD::SET_BLIP_ROUTE(*fParam0, false);
		unk_0x93370FA10F15BE44(fParam0);
	}
}
...
void func_118()
{
	if (fLocal_211 == -1)
	{
		fLocal_211 = PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(Local_210, 2f, 2f, 2f, 0f, 0, 1);
	}
}
