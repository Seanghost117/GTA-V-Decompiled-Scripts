...
void func_1()
{
	...
	if (((func_13() && Local_22.f_66.f_2 == 1) && Local_22.f_66.f_13) && !Local_22.f_66.f_12)
	{
		if (MISC::GET_FRAME_COUNT() - Local_22.f_66.f_14) >= func_12(Local_22.f_66.f_5)
		{
			...
			else if (Local_22.f_66.f_5 != 1 && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(&(Local_22.f_66), Local_22.f_66.f_6, Local_22.f_66.f_4, Local_22.f_66.f_7, Local_22.f_66.f_1, Local_22.f_66.f_10))
			{
				iVar1 = 3;
			}
...
void func_17(int iParam0)
{
	...
	if (iVar1 || unk_0x477FAFFE21935947(1, iParam0, &Var0, 7))
	{
		...
		if (iVar3 != -1)
		{
			...
			{
				Global_4264051[iVar3 /*85*/].f_66.f_18 = MISC::GET_FRAME_COUNT();
			}
		}
		bVar5 = true;
		if (iVar3 != -1)
							...
							else if (Global_4264051[iVar3 /*85*/].f_66.f_11 & 2 != 0)
							{
								...
								if (func_23(Global_4265555) && func_13())
								{
									if (!func_22(Global_4264051[iVar3 /*85*/].f_66))
									{
										...
										Global_4265412[iVar7 /*7*/].f_4 = NETWORK::GET_NETWORK_TIME();
									}
								}
								else
								{
						...
						else if (Global_4264051[iVar3 /*85*/].f_66.f_11 & 2 != 0)
						{
							...
							if (func_23(Global_4265555) && func_13())
							{
								if (!func_22(Global_4264051[iVar3 /*85*/].f_66))
								{
									...
									Global_4265412[iVar8 /*7*/].f_4 = NETWORK::GET_NETWORK_TIME();
								}
							}
							else
							{
					...
					else if (Global_4264051[iVar3 /*85*/].f_66.f_11 & 2 != 0)
					{
						...
						if ((func_23(Global_4265555) && func_13()) && func_31(Var0.f_2))
						{
							if (!func_22(Global_4264051[iVar3 /*85*/].f_66))
							{
								...
								Global_4265412[iVar9 /*7*/].f_4 = NETWORK::GET_NETWORK_TIME();
							}
						}
						else
						{
...
void func_32(int iParam0, bool bParam1)
{
	...
	MONEY::NETWORK_BUY_HELI_STRIKE(func_28(iParam0));
	...
	{
		case 631654431:
			unk_0x0E416FA4BA813CC2(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		...
		case 68030260:
			unk_0x0204D7F7675557B4(Global_4264051[iParam0 /*85*/].f_66.f_1, Global_4264051[iParam0 /*85*/], &(Global_4264051[iParam0 /*85*/].f_14), bVar1, bVar0);
			break;
		
		case -982394051:
			unk_0xDA5C0CFF654B7342(Global_4264051[iParam0 /*85*/].f_66.f_1, Global_4264051[iParam0 /*85*/].f_1, bVar1, bVar0);
			break;
		
		case 454359403:
			unk_0xC7544FC031C4A7EF(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, Global_4264051[iParam0 /*85*/].f_2, bVar0);
			break;
		...
		case 650665123:
			unk_0x3A215CF5ED416A27(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		...
		case 1182673174:
			unk_0xF2FCC4A5CC93A0A0(Global_4264051[iParam0 /*85*/].f_66.f_1, Global_4264051[iParam0 /*85*/], Global_4264051[iParam0 /*85*/].f_1, bVar1, bVar0);
			break;
		...
		case 1940862352:
			unk_0x3DFC7C139661FF52(Global_4264051[iParam0 /*85*/].f_66.f_1, &(Global_4264051[iParam0 /*85*/].f_14.f_26), bVar1, bVar0);
			break;
		...
		case -516219046:
			unk_0x898F54E8CD0210CC(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		...
		case 2043854386:
			unk_0x848EA9B2D5BAE3BC(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		
		case 277665518:
			unk_0xEB161FC08CD320B1(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		...
		case -96593501:
			unk_0x0F3CD3A5EC108BE4(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		...
		case 634375935:
			unk_0x443A7491EAD577D9(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		...
		case 291576838:
			FILES::GET_NUM_DLC_VEHICLES(Global_4264051[iParam0 /*85*/].f_66.f_1, Global_4264051[iParam0 /*85*/], 14, 1, bVar1, &(Global_4264051[iParam0 /*85*/].f_14.f_26), 0, 0, 0, bVar0);
			break;
		
		case 1612072658:
			unk_0xB8B2EC8313B37B3F(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		...
		case -1645229221:
			unk_0x917B9C081D56FB7E(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		
		case -585718395:
			unk_0x9905590B7A60D613(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		
		case 763367758:
			unk_0xD8D628D697600E4A(Global_4264051[iParam0 /*85*/].f_66.f_1, bVar1, bVar0);
			break;
		...
		case -2129781826:
			unk_0x9120E1E01898B36E(Global_4264051[iParam0 /*85*/].f_66.f_1, Global_4264051[iParam0 /*85*/], bVar1, bVar0);
			break;
		
		case 1941570214:
			FILES::GET_DLC_VEHICLE_DATA(Global_4264051[iParam0 /*85*/].f_66.f_1, Global_4264051[iParam0 /*85*/], bVar1, bVar0);
			break;
		
		case 1869490922:
			unk_0x42783CA2EEE2A530(Global_4264051[iParam0 /*85*/].f_66.f_1, Global_4264051[iParam0 /*85*/], Global_4264051[iParam0 /*85*/].f_1, bVar1, bVar0);
			break;
		...
		case -664597565:
		case -1100963799:
			MONEY::NETWORK_SPENT_BOAT_PICKUP(Global_4264051[iParam0 /*85*/].f_66.f_1, &(Global_4264051[iParam0 /*85*/].f_14.f_40), &(Global_4264051[iParam0 /*85*/].f_14.f_44), bVar1);
			break;
		...
		case 1564537328:
			unk_0x3DFC7C139661FF52(Global_4264051[iParam0 /*85*/].f_66.f_1, "RaceToPoint", false, false);
			break;
		...
		case 283351220:
			FILES::GET_NUM_DLC_VEHICLES(Global_4264051[iParam0 /*85*/].f_66.f_1, Global_4264051[iParam0 /*85*/], Global_4264051[iParam0 /*85*/].f_5, 1, bVar1, &(Global_4264051[iParam0 /*85*/].f_14.f_40), 0, 0, 0, bVar0);
			break;
		...
		case 402505853:
			if (func_33(NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(Global_4264051[iParam0 /*85*/]), 0, 0))
			{
				unk_0xB94CF2AAC0E37C5B(NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(Global_4264051[iParam0 /*85*/]), Global_4264051[iParam0 /*85*/].f_1, Global_4264051[iParam0 /*85*/].f_66.f_1, 0, 1);
			}
			break;
		...
		case 261460130:
		case -2027658376:
			NETSHOPPING::NET_GAMESERVER_BEGIN_SERVICE(Global_4264051[iParam0 /*85*/].f_66.f_1, Global_4264051[iParam0 /*85*/]);
			break;
...
void func_36(int iParam0)
{
	...
	fVar0 = 0;
	sVar2 = "Wardrobe";
	fVar0 = AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(sVar2);
	fVar0 = (fVar0 || func_38());
	fVar0 = (fVar0 + Global_4267435);
	func_37(&uVar1);
	fVar0 = (fVar0 || uVar1);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&fVar0, 28);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&fVar0, 29);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&fVar0, 26);
	iVar3 = (Global_4269486[iParam0 /*12*/].f_9 && fVar0);
	iVar4 = (Global_4269486[iParam0 /*12*/].f_8 && fVar0);
...
int func_39()
{
	...
	if (func_40() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_40()) == 0)
		{
			return 1;
		}
	}
