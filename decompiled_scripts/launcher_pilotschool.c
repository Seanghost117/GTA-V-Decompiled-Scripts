...
void __EntryFunction__()
{
	...
	if (unk_0x7B70881748D166CD(unk_0x02406178CDC27728()) > 1 && !func_86(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar1 = 0f;
			if (unk_0xE5CC8E2D904E42CE(ScriptParam_88.f_1[0 /*3*/], &fVar1, 0, 0))
			{
				if (fVar1 != 0f)
				{
		...
		if (unk_0xAE06B9E39EBDE049(uLocal_53) && !unk_0xA59F96B50B97E63C(iLocal_53, 0))
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_72(3) && !Global_98989)
						{
							...
							{
								if ((!func_86(uLocal_58, 1) || !unk_0xAE06B9E39EBDE049(func_71())) && !Global_98989)
								{
									func_79(10);
									break;
								}
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_45(uLocal_54))
								{
									...
									else if (!func_86(uLocal_58, 2048) || !unk_0xDABD547F0DF2906C())
									{
										func_43(&iLocal_60);
				...
				case 6:
					...
					if (func_86(uLocal_58, 2097152))
					{
						if (!func_72(3) && !unk_0x7FD2BDF03806FD9D(uLocal_50))
						{
							func_79(10);
						}
					}
