		...
		if (iLocal_241 != -1)
		{
			if (!func_220())
			{
				*uParam0 = func_219(iLocal_241);
				...
				VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_18570[*uParam0 /*6*/]), 3);
...
void func_26(char[4] cParam0, int iParam1, bool bParam2)
{
	if (Global_98955 != 10 && Global_98955 != 9)
	{
		...
		func_28(&Global_102423, cParam0, 0, "Start", iParam1, bParam2);
		func_27();
		Global_93133 = 0;
	}
}
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == bParam0)
			{
				...
				{
					if (iParam2 == 0 || MISC::GET_MODEL_DIMENSIONS(bParam0) == func_37(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_59()
{
	...
	{
		if (func_49(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_61(bool bParam0, bool bParam1)
{
	...
	iVar0 = func_48(bParam0);
	if (func_39(iVar0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		if (bParam0 == unk_0x9B0761B4C3EB8BC7())
		{
...
int func_73(var uParam0)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_96())
		{
			*uParam0 = func_79(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_79(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam1 == 6 || iParam1 == func_95(iVar0))
		{
			...
			{
				fVar1 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Param0, func_80(iVar0, 0), 1);
...
var func_97()
{
	...
	func_98(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_103(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
void func_135(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_139(PLAYER::PLAYER_ID())) && !func_137(PLAYER::PLAYER_ID(), 0)) && !func_136()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_139(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_149(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_128(bParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_151(uParam1) || !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_150(iParam2) && !PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(bParam0, unk_0x9B0761B4C3EB8BC7(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_151(uParam1) && uParam1->f_4 == 0) && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_150(iParam2) || PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					if (func_72(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
	...
	if (func_128(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		while (iVar0 <= (uParam0->f_28 - 1))
		{
			if (func_127(uParam0->f_28[iVar0]))
			{
				...
				PED::_0x2208438012482A1A(uParam0->f_28[iVar0], 0);
				PED::SET_PED_KEEP_TASK(uParam0->f_28[iVar0], true);
				TASK::TASK_COMBAT_PED(uParam0->f_28[iVar0], unk_0x9B0761B4C3EB8BC7(), 0, 16);
...
int func_161(bool bParam0, float fParam1)
{
	float fVar0;
...
bool func_163(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_164(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_164(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_165(bool bParam0, bool bParam1)
{
	bool bVar0;
...
int func_167(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_169(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_169(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_173(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_128(unk_0x9B0761B4C3EB8BC7()) && func_128(iParam0))
	{
		...
		else
		{
			...
			else
			{
				...
				if (func_177(bParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
			if (func_174(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_174(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_176(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_169(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_177(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
...
void func_179(bool bParam0)
{
	...
	if (func_128(unk_0x9B0761B4C3EB8BC7()) && func_128(bParam0))
	{
...
int func_186()
{
	return func_187(TASK::IS_PED_BEING_ARRESTED(), 0);
}
...
void func_192()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_193(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_193(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
bool func_220()
{
	...
	else if ((func_223(0) || LOCALIZATION::GET_CURRENT_LANGUAGE()) || func_222())
	{
		if (func_2("RAMP_HELP_TRIG"))
		{
			if (func_223(0))
	...
	else if (func_356(108))
	{
		...
		bVar0 = !PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 51);
	}
	return bVar0;
}
...
int func_226(float fParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Var2, Var1, 1) <= fParam0 && ENTITY::IS_ENTITY_PLAYING_ANIM((Var2.f_2 - Var1.f_2)) < 1.5f)
		{
			return iVar0;
		}
		iVar0++;
...
void func_228(var* uParam0, struct<3> Param1)
{
	...
	while (true)
	{
		...
		if (*uParam0 == 52 || *uParam0 == 53)
		{
			...
			{
				if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_28[0], 1), 5.1f))
				{
					if (*uParam0 == 52)
					{
						iVar2 = 0;
						...
						{
							if (MISC::IS_BIT_SET(uParam0->f_41[iVar2]))
							{
								if ((func_128(uParam0->f_28[0]) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uParam0->f_41[iVar2], uParam0->f_28[0])) || (func_128(uParam0->f_28[1]) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uParam0->f_41[iVar2], uParam0->f_28[1])))
								{
									PED::GET_PED_BONE_INDEX(&(uParam0->f_41[iVar2]));
								}
							}
							iVar2++;
						}
			...
			if (func_128(uParam0->f_28[1]))
			{
				if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_28[1], 1), 5.1f))
				{
					if (*uParam0 == 52)
					{
						iVar2 = 0;
		...
		Local_249 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
...
void func_229(var* uParam0)
{
	...
	switch (iLocal_70)
	{
		...
		case 1:
			if (func_128(uParam0->f_28[0]))
			{
				if (func_244(uParam0->f_28[0], unk_0x9B0761B4C3EB8BC7(), 1) < 30f && ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_28[0]))
				{
		...
		case 3:
			if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_71[0]))
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_71[0]) >= 0.95f)
				{
					iLocal_70++;
				}
			}
		...
		case 5:
			if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_71[1]))
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_71[1]) >= 0.95f)
				{
					iLocal_70++;
				}
			}
...
int func_245(var* uParam0)
{
	...
	if (iLocal_69 < 0)
	{
		if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_28[1], 1)) < 25f)
		{
			return 1;
		}
		switch (*uParam0)
		{
			case 52:
				...
				TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), uParam0->f_28[0], -1, 0, 2);
			...
			case 55:
				...
				TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), uParam0->f_28[1], -1, 0, 2);
				CAM::_SET_GAMEPLAY_HINT_ANIM_CLOSEUP(true);
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (func_128(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
					{
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 4:
						if (((((func_222() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_241(8, -1)) || func_257()) || func_256()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_261(var uParam0, var uParam1)
{
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_128(unk_0x9B0761B4C3EB8BC7()))
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Trevor", unk_0x9B0761B4C3EB8BC7(), MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()));
		}
		switch (*uParam0)
		{
			case 52:
...
void func_262(int iParam0, bool bParam1, struct<3> Param2)
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
...
float func_266(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_272(var uParam0)
{
	if (*uParam0 == 52)
	{
		...
		if (MISC::IS_BIT_SET(uParam0->f_41[4]))
		{
...
int func_273(var uParam0)
{
	...
	{
		if (PED::_0x5407B7288D0478B7(unk_0x9B0761B4C3EB8BC7()) > 0)
		{
			return 1;
		}
	}
...
void func_275(var uParam0)
{
	...
	while ((!ENTITY::DOES_ENTITY_EXIST(iVar1) || !ENTITY::DOES_ENTITY_EXIST(iVar2)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar0))
	{
		SYSTEM::WAIT(0);
	}
	...
	ENTITY::SET_ENTITY_COORDS(uParam0->f_35[0], 1);
...
int func_279(int iParam0, int iParam1)
{
	...
	if (MISC::SET_BIT() && func_313())
	{
		StringCopy(&Var11, func_311(iParam1, iParam0), 16);
		func_306(&sVar10, Var11, MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()), 3, 1, func_309(iParam0), func_308(iParam0), -1, 0, 0);
		if (NETSHOPPING::_NET_GAMESERVER_CATALOG_ITEM_EXISTS(&sVar10))
		{
			iVar0 = NETSHOPPING::NET_GAMESERVER_GET_PRICE(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&sVar10), 1671640801, true);
		}
	}
	if (iVar0 > 0)
	{
...
int func_286(struct<7> Param0, struct<7> Param1, int iParam2)
{
	...
	bVar0 = func_297(Param1);
	bVar1 = func_293(Param0, iParam2);
	if (bVar1 == -15)
	{
		return 0;
	}
...
void func_306(char* sParam0, char[8] cParam1, char[4] cParam2, char[4] cParam3, void fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11)
{
...
int func_318()
{
	...
	if (STATS::STAT_GET_INT(joaat("SP_UNLOCK_EXCLUS_CONTENT"), &bVar0, -1))
	{
		...
		{
			if (unk_0xCE990E643CD9D0E5(bVar0, 1) || unk_0xCE990E643CD9D0E5(bVar0, 3))
			{
				return 1;
			}
			else
	...
	{
		bVar3 = VEHICLE::IS_THIS_MODEL_A_CAR(866);
		if (unk_0xCE990E643CD9D0E5(bVar3, 1) || unk_0xCE990E643CD9D0E5(bVar3, 3))
		{
			return 1;
		}
	}
...
int func_338()
{
	return PATHFIND::SET_ROADS_IN_AREA(-177.0628f, -1679.715f, 33.16263f, -157.0628f, -1659.715f, 37.16263f, false, true, 1, 1);
}
...
void func_339(var uParam0)
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
	{
		SYSTEM::WAIT(0);
	}
...
void func_340(var uParam0)
{
	...
	while ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_microsmg"))) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
	{
		SYSTEM::WAIT(0);
	}
...
void func_343(var uParam0)
{
	...
	func_347(&uLocal_68);
	while ((((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !ENTITY::DOES_ENTITY_EXIST(iVar1)) || !ENTITY::DOES_ENTITY_EXIST(iVar2)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar3)) || !func_346(&uLocal_68))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (MISC::IS_BIT_SET(uParam0->f_41[2]))
	{
		...
		ENTITY::DETACH_ENTITY(uParam0->f_41[2], 0f, 0f, 50f, 2, 1);
	...
	OBJECT::CREATE_OBJECT_NO_OFFSET(uParam0->f_41[1], uParam0->f_28[0], ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[0], iVar4), Var6, Var5, 1, 0, 0, 0, 2, 1);
	func_344(&uLocal_68, 0, 3);
	if (!PED::DETACH_SYNCHRONIZED_SCENE(uParam0->f_59))
	{
...
void func_344(var uParam0, bool bParam1, int iParam2)
{
	...
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
		...
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TIME(*uParam0, Global_19601, Global_19602, Global_19603, Global_19604, 255, 255, 255, 255, 0);
	}
}
...
void func_350(var uParam0)
{
	...
	STREAMING::REQUEST_ANIM_DICT(sVar1);
	WEAPON::REQUEST_WEAPON_ASSET(joaat("weapon_assaultrifle"), 31, 0);
	while ((((!ENTITY::DOES_ENTITY_EXIST(iVar5) || !ENTITY::DOES_ENTITY_EXIST(iVar6)) || !ENTITY::DOES_ENTITY_EXIST(iVar7)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1)) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_assaultrifle")))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (func_128(uParam0->f_28[0]))
	{
		...
		OBJECT::CREATE_OBJECT_NO_OFFSET(uParam0->f_41[1], uParam0->f_28[0], ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[0], iVar2), Var4, Var3, 1, 1, 0, 0, 2, 1);
	...
	if (func_128(uParam0->f_28[1]))
	{
		...
		OBJECT::CREATE_OBJECT_NO_OFFSET(uParam0->f_41[2], uParam0->f_28[1], ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[1], iVar2), Var4, Var3, 1, 1, 0, 0, 2, 1);
		OBJECT::SET_ACTIVATE_OBJECT_PHYSICS_AS_SOON_AS_IT_IS_UNFROZEN(uParam0->f_41[2], true);
		ENTITY::SET_ENTITY_COORDS(uParam0->f_28[1], 1);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(uParam0->f_28[1], 2.914701E-43f, 1);
...
void func_357(var* uParam0, bool bParam1)
{
	...
	if (iLocal_250 != 0)
	{
		...
		{
			PED::ADD_SCENARIO_BLOCKING_AREA(iLocal_250, 0);
		}
	}
	if (CAM::IS_GAMEPLAY_HINT_ACTIVE())
	{
