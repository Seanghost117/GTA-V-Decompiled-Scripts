...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			bLocal_58 = unk_0x84CA45D54D4D6BB4(uVar1);
			func_58(bLocal_58);
		}
		iVar3 = 0;
...
void func_57(int iParam0)
{
	...
	if (iLocal_61[iParam0] == 0)
	{
		...
		{
			iLocal_61[iParam0] = unk_0xFEFC406F4702C938(Local_59[iParam0 /*3*/], Local_59[iParam0 /*3*/] + Vector(1f, 0f, 0f), 2f, 2, unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 4);
		}
	}
	else
	{
		iVar0 = unk_0x0F0E6A09A9C90474(iLocal_61[iParam0], &iVar4, &uVar2, &uVar3, &uVar1);
		if (iVar0 == 2)
		{
			Local_40[iParam0 /*24*/].f_8 = 0;
			if (iVar4 > 0)
