...
void func_16()
{
	...
	else if (MISC::IS_BIT_SET(unk_0x770D3B2B4702434A(Local_227.f_1)))
	{
	...
	{
		if (NETWORK::NETWORK_IS_HANDLE_VALID(Local_227.f_1.f_3[0 /*2*/]))
		{
	...
	{
		if (NETWORK::NETWORK_IS_HANDLE_VALID(Local_227.f_1.f_3[1 /*2*/]))
		{
	...
	{
		if (NETWORK::NETWORK_IS_HANDLE_VALID(Local_227.f_1.f_3[2 /*2*/]))
		{
	...
	if (MISC::GET_PROFILE_SETTING(false, 0) != iLocal_56)
	{
	...
	if (MISC::ARE_PROFILE_SETTINGS_VALID(false, 0) != iLocal_57)
	{
	...
	if (func_37(Local_227.f_1.f_1))
	{
		if (func_37(Local_227.f_1.f_3[0 /*2*/].f_1))
		{
			if (!func_12(Local_227.f_1))
			{
				...
				{
					VEHICLE::SET_HELI_BLADES_FULL_SPEED(unk_0x770D3B2B4702434A(Local_227.f_1));
					VEHICLE::SET_VEHICLE_ENGINE_ON(unk_0x770D3B2B4702434A(Local_227.f_1), true, true, false);
					PHYSICS::ACTIVATE_PHYSICS(unk_0x770D3B2B4702434A(Local_227.f_1));
					ENTITY::SET_ENTITY_DYNAMIC(unk_0x770D3B2B4702434A(Local_227.f_1), true);
					...
					if (func_32(&(Local_227.f_1.f_3[0 /*2*/]), Local_227.f_1, 4, Local_227.f_1.f_3[0 /*2*/].f_1, -1, 1, 1, 1))
					{
						...
						Global_2440049.f_4114[0] = NETWORK::NET_TO_PED(Local_227.f_1.f_3[0 /*2*/]);
						if (func_32(&(Local_227.f_1.f_3[1 /*2*/]), Local_227.f_1, 4, Local_227.f_1.f_3[1 /*2*/].f_1, 1, 1, 1, 1))
						{
							...
							Global_2440049.f_4114[1] = NETWORK::NET_TO_PED(Local_227.f_1.f_3[1 /*2*/]);
							if (func_32(&(Local_227.f_1.f_3[2 /*2*/]), Local_227.f_1, 4, Local_227.f_1.f_3[2 /*2*/].f_1, 2, 1, 1, 1))
							{
								...
								Global_2440049.f_4114[2] = NETWORK::NET_TO_PED(Local_227.f_1.f_3[2 /*2*/]);
								return 1;
							}
						}
					}
...
int func_40(struct<3> Param0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)
{
	...
	if (iParam2 && !bParam5)
	{
		if (func_47(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!PED::REMOVE_SCENARIO_BLOCKING_AREA())
			{
				...
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_45(PLAYER::PLAYER_ID()), Param0, 1) <= (fVar2 + fParam1))
				{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (!func_42(bVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), bVar1))
			{
				if (iParam2 == 1 || (iParam2 == 0 && bVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_41(bVar1) || !bParam8) && !Global_2425869[bVar1 /*443*/].f_263)
					{
						fVar2 = fParam4;
						if (fParam7 > 0f)
						{
						...
						if (!bParam5)
						{
							...
							{
								if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_45(bVar1), Param0, 1) <= (fVar2 + fParam1))
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && PLAYER::PLAYER_ID() != bVar1) || iParam6 == 0)
		{
			if (func_47(bVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(PLAYER::GET_PLAYER_PED(bVar1)) && func_41(bVar1)))
					{
						...
						{
							if (((unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1 && uParam7) && bParam4) && func_49(bVar1))
							{
							}
							else if (MISC::IS_BIT_SET(PLAYER::GET_PLAYER_PED(bVar1)))
							{
								if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_56(bVar1), Param0, 1) < fParam1)
								{
									return 1;
								}
							}
...
{
	if (func_54(PLAYER::PLAYER_ID(), bParam0))
	{
		return 1;
	}
	Global_2515173 = { func_53(bParam0) };
	if (NETWORK::NETWORK_IS_FRIEND_HANDLE_ONLINE(&Global_2515173))
	{
		return 1;
	}
	if (func_50(PLAYER::PLAYER_ID(), bParam0))
	{
		return 1;
	}
	return 0;
	...
	switch (Local_227.f_1.f_2)
	{
		...
		case 2:
			if (func_12(Local_227.f_1))
			{
				...
				{
					bLocal_47 = TASK::IS_PED_SPRINTING(iVar1);
					HUD::SET_BLIP_SPRITE(bLocal_47, 422);
					HUD::SHOW_HEIGHT_ON_BLIP(bLocal_47, false);
					PED::IS_PED_IN_PARACHUTE_FREE_FALL(bLocal_47, "MPCT_MERRY3");
					func_86(&bLocal_47, 1);
				}
				...
				if (HUD::DOES_BLIP_EXIST(Local_227.f_1.f_3[0 /*2*/]))
				{
					...
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iVar0))
					{
							...
							if (func_85(Local_227.f_1))
							{
								if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_227.f_1.f_3[0 /*2*/]))
								{
									...
									if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
									{
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
										{
											TASK::TASK_HELI_MISSION(iVar0, iVar1, 0, unk_0x9B0761B4C3EB8BC7(), 0f, 0f, 0f, 23, 20f, 40f, -1f, SYSTEM::CEIL(fLocal_61[0]), 10, -1082130432, 0);
										}
									}
								}
							}
						...
						if (!iLocal_50)
						{
							if (SYSTEM::VDIST(func_56(PLAYER::PLAYER_ID()), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x770D3B2B4702434A(Local_227.f_1), 1)) <= 50f)
							{
				...
				if (HUD::DOES_BLIP_EXIST(Local_227.f_1.f_3[1 /*2*/]))
				{
				...
				if (HUD::DOES_BLIP_EXIST(Local_227.f_1.f_3[2 /*2*/]))
				{
...
void func_74()
{
	...
	if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_77(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
int func_100()
{
	...
	if (func_101() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_101()) == 0)
		{
			return 1;
		}
	}
...
void func_112(struct<21> Param0)
{
	...
	func_116(0, -1, 0);
	MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(&Local_227, 22);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_248, 3);
