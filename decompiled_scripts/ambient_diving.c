...
void __EntryFunction__()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("ambient_diving")) > 1)
	{
...
int func_18(var uParam0, int iParam1)
{
	...
	if (uParam0->f_11)
	{
		...
		if (!func_25(44))
		{
			...
			{
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_23(iVar4), Var3, 0) > 200f)
				{
...
int func_36(var uParam0, var uParam1, struct<3> Param2)
{
	...
	if ((uParam1[bVar0 /*11*/])->f_10)
	{
		...
		{
			if (OBJECT::HAS_PICKUP_BEEN_COLLECTED((uParam1[bVar0 /*11*/])->f_1) || func_49((uParam1[bVar0 /*11*/])->f_1))
			{
				func_39(uParam0, uParam1, bVar0);
				return 1;
			}
		}
	}
	...
	{
		if ((SYSTEM::VDIST2(Param2, OBJECT::GET_PICKUP_COORDS((uParam1[bVar0 /*11*/])->f_1)) > (60f * 60f) || func_38(13)) || func_38(14))
		{
			func_37(&((uParam1[bVar0 /*11*/])->f_1));
...
void func_39(var uParam0, var uParam1, bool bParam2)
{
	...
	func_37(&((uParam1[bParam2 /*11*/])->f_1));
	func_48(&((uParam1[bParam2 /*11*/])->f_2));
		...
		case 1:
			...
			if (!func_62())
			{
				if (func_50(iLocal_64))
				{
					...
					{
						fLocal_65 = func_56(iLocal_64, 0, 0);
					}
					VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_64, false, true, false);
					if (VEHICLE::IS_THIS_MODEL_A_BOAT(MISC::GET_MODEL_DIMENSIONS(iLocal_64)))
					{
...
float func_56(int iParam0, bool bParam1, bool bParam2)
{
...
void func_59()
{
	...
	if (func_50(iLocal_64))
	{
		...
		{
			STREAMING::REMOVE_ANIM_DICT(&iLocal_64);
		}
	}
}
...
int func_62()
{
	if (func_50(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		{
			iLocal_64 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
...
int func_63()
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (MISC::GET_MODEL_DIMENSIONS(iVar0) == joaat("dinghy") || MISC::GET_MODEL_DIMENSIONS(iVar0) == joaat("dinghy2"))
			{
				return 1;
			}
			else
...
void func_64()
{
	...
	if (func_24(&Local_42, &Local_48, Var0, &iLocal_51))
	{
		...
		fVar2 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Var1, Var0, 0);
		if (fVar2 > 200f)
		{
			func_66();
			if (!iLocal_61)
			...
			if (func_63())
			{
				...
				if (!SYSTEM::VMAG(iLocal_53))
				{
					...
					HUD::SET_BLIP_HIDDEN_ON_LEGEND(bLocal_53, false);
					PED::IS_PED_IN_PARACHUTE_FREE_FALL(bLocal_53, "B_WRE");
					HUD::SHOW_HEIGHT_ON_BLIP(bLocal_53, false);
					iLocal_54 = iLocal_51;
				}
			}
			else if (SYSTEM::VMAG(bLocal_53))
			{
				unk_0x93370FA10F15BE44(&bLocal_53);
			}
		}
		else
		{
			...
			if (func_25(42))
			{
				if (!func_25(43))
				{
					if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(unk_0x9B0761B4C3EB8BC7()) && !PED::IS_PED_SWIMMING_UNDER_WATER(unk_0x9B0761B4C3EB8BC7()))
					{
			...
			if (Local_42.f_1.f_4 < Local_42.f_1.f_3)
			{
				if (iLocal_61)
				{
					...
					if (func_63())
					{
						AUDIO::SET_VARIABLE_ON_SOUND(fLocal_63, "SINGLE_BLIP_FROM_BOAT", Var1, "ABIGAIL_SONAR_SOUNDSET", 0, 0, 0);
					}
					else
					{
						AUDIO::SET_VARIABLE_ON_SOUND(fLocal_63, "SCRIPT_TRIGGERED_FROM_PROP", Var0, "ABIGAIL_SONAR_SOUNDSET", 0, 0, 0);
					}
				}
				else
				{
					...
					{
						bLocal_55 = HUD::ADD_BLIP_FOR_RADIUS(Var1, fLocal_58);
						HUD::SET_BLIP_ALPHA(bLocal_55, 255);
						HUD::SET_BLIP_COLOUR(bLocal_55, 4);
						HUD::SET_BLIP_AS_SHORT_RANGE(bLocal_55, true);
						HUD::SET_RADIUS_BLIP_EDGE(bLocal_55, true);
						HUD::SHOW_HEIGHT_ON_BLIP(bLocal_55, false);
					}
					else
					{
						HUD::SET_BLIP_SCALE(bLocal_55, fLocal_58);
					}
					iVar3 = 0;
					if (func_63())
					{
						...
						while (iVar3 <= 3)
						{
							if (!SYSTEM::VMAG(iLocal_56[iVar3]))
							{
...
float func_65(void fParam0, float fParam1, void fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_66()
{
	...
	if (SYSTEM::VMAG(bLocal_55))
	{
		unk_0x93370FA10F15BE44(&bLocal_55);
	}
	iVar0 = 0;
	while (iVar0 <= 3)
	{
		if (SYSTEM::VMAG(iLocal_56[iVar0]))
		{
...
void func_69(int iParam0, var uParam1, var uParam2)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_29((iParam0->f_2 + bVar0), -1, -1))
		{
			iVar1++;
			func_47(iParam0, bVar0, 1);
			if (bLocal_40)
			{
			}
		}
