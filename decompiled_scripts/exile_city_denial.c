...
void __EntryFunction__()
{
	...
	iLocal_28 = -1;
	bLocal_32 = true;
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("exile_city_denial")) > 1)
	{
		Global_41596 = 0;
		...
		if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
		{
			...
			switch (PLAYER::GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP())
			{
				...
				case 1:
					...
					func_25(-2009081795);
					bLocal_29 = false;
					while (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
					{
						SYSTEM::WAIT(1000);
					}
					iLocal_31 = 0;
	...
	while (true)
	{
		...
		if (bLocal_30 != bLocal_29)
		{
			...
			if (bLocal_29 && !bVar4)
			{
				...
				if (bVar5)
				{
					...
					{
						fVar7 = MONEY::NETWORK_SPENT_REQUEST_HEIST(unk_0x9B0761B4C3EB8BC7());
						while (unk_0x0B1B45E748AD48BA(fVar7))
						{
							SYSTEM::WAIT(5000);
							STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7());
							if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
						...
						if ((!func_9(0) && !func_9(4)) && !func_9(3))
						{
							if (MISC::_GET_NUM_DISPATCHED_UNITS_FOR_PLAYER(11) < 256)
							{
								if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
								{
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
									{
										MISC::CREATE_INCIDENT_WITH_ENTITY(11, unk_0x9B0761B4C3EB8BC7(), iVar0, 0f, &iLocal_33, 0, 0);
									}
								}
							}
		...
		{
			SYSTEM::SETTIMERB(0);
			iVar0 = (iVar0 + NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1, 2));
			if (iVar0 < 8)
			{
				if (MISC::IS_INCIDENT_VALID(iLocal_33))
				{
...
void func_5(int iParam0, bool bParam1)
{
	...
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_7225.f_17[iParam0]), false);
	}
...
void func_7(int iParam0, bool bParam1)
{
	...
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_7225.f_11[iParam0]), false);
	}
