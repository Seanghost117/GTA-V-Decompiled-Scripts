	...
	switch (iLocal_81)
	{
		case 0:
			if (bLocal_214)
			{
				if (!func_29())
				{
					uLocal_211 = unk_0x5DEA4192B46CB99B("MIDSIZED_MESSAGE");
					while (!unk_0x95EF219D38B20CFF(uLocal_211))
					{
						SYSTEM::WAIT(0);
					}
					unk_0x830F007E19C63E14(uLocal_211, "SHOW_BRIDGES_KNIVES_PROGRESS");
					func_28("PW_TITLE");
		...
		case 1:
			...
			{
				unk_0x830F007E19C63E14(uLocal_211, "SHARD_ANIM_OUT");
...
void func_22()
{
	if (unk_0x95EF219D38B20CFF(uLocal_211))
	{
		unk_0x2E352DDBBF674246(&uLocal_211);
	}
}
...
void func_23()
{
	if (!func_29())
	{
		if (unk_0x95EF219D38B20CFF(uLocal_211))
		{
			unk_0xE6A03BA84586E67B(uLocal_211, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
		}
	}
}
...
void func_32()
{
	...
	if ((func_17(&uLocal_205) <= 3f && func_34(0)) && func_33(unk_0x9B0761B4C3EB8BC7()))
	{
		if ((unk_0x1BD7199394D7F19A(0, 177) || (unk_0x1BD7199394D7F19A(0, 24) && !unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))) || (func_31() && !iLocal_216))
		{
			func_36(&uLocal_205, 0f);
			func_35(&uLocal_205);
		}
...
void func_42()
{
	if (iLocal_217)
	{
		if ((func_17(&uLocal_208) > 5f && func_45() >= 1) && !unk_0xCE990E643CD9D0E5(Global_111858.f_10045.f_99, 1))
		{
			switch (iLocal_224)
			{
				case 0:
