...
void func_104()
{
	...
	iLocal_277 = OBJECT::CREATE_OBJECT(joaat("prop_cs_protest_sign_01"), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_208, 1), true, true, false);
...
void func_113(int iParam0)
{
	...
	if (iLocal_209)
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&uVar0, &Local_328))
		{
			func_13();
		}
		if (iParam0 == 1)
