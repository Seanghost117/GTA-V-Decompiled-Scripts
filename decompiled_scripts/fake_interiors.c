...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			uLocal_31 = unk_0x9B0761B4C3EB8BC7();
		}
		if (unk_0xA59F96B50B97E63C(uLocal_31, 0))
		{
		}
		func_1();
	}
...
void func_1()
{
	...
	{
		Var0 = { unk_0x3E4D3CCC220BDFB1(uLocal_31, 0) };
		...
		if (SYSTEM::VDIST2(Var1, Var0) < IntToFloat(func_18(iLocal_29)))
		{
			...
			while (iVar3 < func_17(iLocal_29))
			{
				if (!bVar2)
				{
					if (unk_0x1037B9D45CE6B788(uLocal_31, func_16(iLocal_29, iVar3), func_15(iLocal_29, iVar3), func_14(iLocal_29, iVar3), 0, 1, 0))
					{
						bVar2 = true;
					}
				}
	...
	if (unk_0x25DDB354A40FFCDB())
	{
		if (func_2())
		{
			...
			{
				unk_0xD2459066EA58CE43(&uLocal_32, 1);
			}
			...
			else if (unk_0xCE990E643CD9D0E5(uLocal_32, 0))
			{
				...
				unk_0xD2459066EA58CE43(&uLocal_32, 0);
			}
		}
