			...
			switch (iLocal_264)
			{
				...
				case 1:
					if (OBJECT::ADD_DOOR_TO_SYSTEM())
					{
						...
						{
							MISC::CLEAR_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 100f, true, true, false, false);
						}
					...
					if (!OBJECT::ADD_DOOR_TO_SYSTEM())
					{
						...
						if (func_309(Local_94.f_35[0]))
						{
							...
							if (func_309(Local_94.f_28[0]))
							{
								...
								PED::_0x2208438012482A1A(Local_94.f_28[0], 1);
							...
							if (func_309(Local_94.f_28[1]))
							{
								...
								PED::_0x2208438012482A1A(Local_94.f_28[1], 1);
...
int func_232(bool bParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
int func_233(char* sParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4)
{
	unk_0x78FCB2E22C41B9D5(iLocal_81);
	if (iParam4 == 1)
	{
		while (!ENTITY::DOES_ENTITY_EXIST(iLocal_81))
		{
			SYSTEM::WAIT(0);
		}
	}
	else if (!ENTITY::DOES_ENTITY_EXIST(iLocal_81))
	{
		return 0;
	}
	func_234(sParam0, iLocal_81, Param1, fParam2);
	if (func_309(*sParam0))
	{
...
void func_234(char* sParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_235(sParam0);
...
void func_239(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_243(PLAYER::PLAYER_ID())) && !func_241(PLAYER::PLAYER_ID(), 0)) && !func_240()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_243(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_251(struct<3> Param0, bool bParam1, int iParam2, int iParam3)
{
	struct<3> Var0;
	var uVar1;
	...
	if (MISC::IS_BIT_SET(Global_102423.f_4))
	{
		if (ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, false))
		{
			if (func_299(24) != Global_102423.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_296(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Global_102423.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						bParam1 = uVar1;
					}
				}
				func_252(Global_102423.f_4, Param0, bParam1, 24, 0);
			}
		}
	}
}

void func_252(bool bParam0, struct<3> Param1, bool bParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (MISC::IS_BIT_SET(bParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		func_286(iParam3, &Var0, Param1, bParam2, func_289(bParam0));
		func_253(iParam3, bParam0, 0);
	}
}
...
void func_254(bool bParam0, int iParam1)
{
	...
	func_291(bParam0, &(Global_111858.f_32745.f_5510));
}

int func_255(bool bParam0)
{
	if ((((((((((!MISC::IS_BIT_SET(bParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_270(bParam0, 0, 0)) || func_270(bParam0, 1, 0)) || func_270(bParam0, 2, 0)) || func_289(bParam0) != 145) || func_269(bParam0)) || func_268(bParam0)) || func_267(bParam0)) || func_266(bParam0)) || !func_256(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_268(bParam0))
		{
		}
...
int func_257(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
var func_272()
{
	...
	func_282(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_281(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_280(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_275(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_274(&uVar0, CLOCK::GET_CLOCK_YEAR());
	func_273(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
var func_277(bool bParam0)
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_278(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
void func_286(int iParam0, var uParam1, struct<3> Param2, bool bParam3, int iParam4)
{
	if (func_283(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
void func_291(bool bParam0, var uParam1)
{
	int iVar0;
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_293(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
	...
	if (MISC::IS_BIT_SET(iVar0))
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_303(bVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_303(bool bParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_310(int iParam0, float fParam1, int iParam2)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_315(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_315(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
{
	if (((!func_332(0) || Global_77102) || Global_77091 == 1) || !GRAPHICS::DRAW_SCALEFORM_MOVIE())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((OBJECT::ADD_DOOR_TO_SYSTEM() || func_331(0)) || func_330(1))
			{
			}
			else
			{
...
void func_339(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 37:
			...
			{
				PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_93, 0);
		...
		case 38:
			if (bParam1)
			{
				fLocal_93 = PATHFIND::SET_ROADS_IN_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, false, true, 1, 1);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (bParam1)
			{
				fLocal_93 = PATHFIND::SET_ROADS_IN_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, false, true, 1, 1);
		...
		case 41:
			if (bParam1)
			{
				fLocal_93 = PATHFIND::SET_ROADS_IN_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, false, true, 1, 1);
		...
		case 42:
			if (bParam1)
			{
				fLocal_93 = PATHFIND::SET_ROADS_IN_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, false, true, 1, 1);
...
void func_349()
{
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_263, 0);
	PED::CLEAR_PED_NON_CREATION_AREA();
...
void func_362(bool bParam0)
{
	...
	if (!func_383())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_363(TASK::IS_PED_BEING_ARRESTED(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_364(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_370())
	{
		...
		{
			iVar2 = func_365(TASK::IS_PED_BEING_ARRESTED());
			if (iVar2 > -1)
			{
...
int func_368(void fParam0, bool bParam1)
{
	int iVar0;
