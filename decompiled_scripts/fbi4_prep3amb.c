...
void func_175()
{
	if ((unk_0xCE990E643CD9D0E5(bLocal_49, 0) && Global_41631 == 15) && !func_207())
	{
		if (iLocal_38 == 0)
		{
			if (!unk_0xCE990E643CD9D0E5(bLocal_49, 1))
...
int func_205()
{
	if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 855.7258f, -2344.491f, 29.33145f) <= 52900f)
	{
		if (func_13())
		{
			func_69(28);
	...
	else if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 1383.21f, -2068.02f, 51.87057f) <= 160000f)
	{
		if (func_13())
		{
			func_69(29);
...
int func_220(var uParam0)
{
	...
	if (func_249(unk_0x9B0761B4C3EB8BC7()) && SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		bVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if (func_85(bVar0))
		{
...
void func_222()
{
	...
	if (((((((Global_41631 == 15 && iLocal_37 != 3) && unk_0xCE990E643CD9D0E5(bLocal_49, 5)) && !func_207()) && Global_76830 == -1) && !func_232()) && !func_84(9)) || func_103(35))
	{
		func_231();
		func_229();
		switch (iLocal_39)
