...
void __EntryFunction__()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("letterscraps")) > 1)
	{
		...
		case 1:
			...
			if (iLocal_56 < 4)
			{
				if (!iLocal_58)
				{
					...
					else if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 189))
					{
				...
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING(iLocal_55, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
...
int func_2()
{
	if ((PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 190) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 189)) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 202))
	{
		return 1;
	}
	return 0;
...
bool func_17(int iParam0, char* sParam1, var uParam2)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
...
bool func_18(int iParam0, char* sParam1, var uParam2)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
...
bool func_19(int iParam0, char* sParam1, int iParam2, var uParam3)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
...
void func_21()
{
	switch (iLocal_43)
	{
		...
		case 1:
			if (!func_60(14) && !PED::REMOVE_SCENARIO_BLOCKING_AREA())
			{
...
int func_40(var uParam0, var uParam1, struct<3> Param2)
{
	...
	if ((uParam1[bVar0 /*11*/])->f_10)
	{
		...
		{
			if (OBJECT::HAS_PICKUP_BEEN_COLLECTED((uParam1[bVar0 /*11*/])->f_1) || func_55((uParam1[bVar0 /*11*/])->f_1))
			{
				func_42(uParam0, uParam1, bVar0);
				return 1;
			}
		}
	}
	...
	{
		if ((SYSTEM::VDIST2(Param2, OBJECT::GET_PICKUP_COORDS((uParam1[bVar0 /*11*/])->f_1)) > (60f * 60f) || func_60(13)) || func_60(14))
		{
			func_41(&((uParam1[bVar0 /*11*/])->f_1));
...
void func_42(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	
	iVar0 = (func_31(*uParam0) + bParam2);
	func_41(&((uParam1[bParam2 /*11*/])->f_1));
	func_54(&((uParam1[bParam2 /*11*/])->f_2));
	(uParam1[bParam2 /*11*/])->f_1 = 0;
	(uParam1[bParam2 /*11*/])->f_10 = 0;
	func_53(&(uParam0->f_1), bParam2, 1);
	if (*uParam0 == 1 || *uParam0 == 0)
	{
		func_52(*uParam0, bParam2, 1);
	}
	PAD::SET_PAD_SHAKE(0, 200, 250);
	STATS::STAT_INCREMENT(uParam0->f_6, 1f);
	if (bLocal_41)
	{
		func_51(&(uParam0->f_1), bParam2);
	}
	else
	{
		func_49(&(uParam0->f_1));
...
void func_51(var uParam0, bool bParam1)
{
	...
	if (func_59(uParam0, bParam1))
	{
		uParam0->f_4++;
		func_50((uParam0->f_2 + bParam1), 1, -1, 1);
		if (bLocal_40)
		{
		}
	}
...
void func_62(int iParam0, var uParam1, var uParam2)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_27((iParam0->f_2 + bVar0), -1, -1))
		{
			iVar1++;
			func_53(iParam0, bVar0, 1);
			if (bLocal_40)
			{
			}
		}
