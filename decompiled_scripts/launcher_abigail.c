...
int func_188(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(uParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_192(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_193(int iParam0, var uParam1, char* sParam2)
{
	if (func_127(*uParam1) && func_127(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		{
			case 0:
				iParam0->f_166 = (MISC::GET_GAME_TIMER() + NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1000, 2000));
			...
			case 1:
				...
				{
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_52, Local_53, 8f, 0, 1, 0))
					{
				...
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_55, "outro", 3) && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(*uParam1, cLocal_55, "outro") > 0.99f)
				{
			...
			case 3:
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_55, "intro", 3) && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(*uParam1, cLocal_55, "intro") > 0.99f)
				{
					*iParam0 = 4;
				}
				break;
			...
			case 5:
				if (!func_146())
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_55, "loop_talk", 3))
					{
						if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(*uParam1, cLocal_55, "loop_talk") > 0.99f)
						{
							iParam0->f_166 = (MISC::GET_GAME_TIMER() + NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(7000, 10000));
							if (!unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_52, Local_53, 8f, 0, 1, 0))
							{
			...
			case 2:
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_55, "loop_look", 3) && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(*uParam1, cLocal_55, "loop_look") > 0.99f)
				{
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_52, Local_53, 8f, 0, 1, 0))
					{
						if (MISC::GET_GAME_TIMER() > iParam0->f_166)
...
float func_205(bool bParam0, bool bParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_254(char* sParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_255(sParam0);
...
int func_261(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!ENTITY::DOES_ENTITY_EXIST(iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
