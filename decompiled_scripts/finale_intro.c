...
void func_6()
{
	...
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, joaat("player_one"), 0);
	}
	...
	while (OBJECT::ADD_DOOR_TO_SYSTEM() || !bVar1)
	{
		RECORDING::_0x208784099002BC30("M_FinaleChoice", 0);
		...
		if (!MISC::IS_BIT_SET(bLocal_30))
		{
			bVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
			if (MISC::IS_BIT_SET(bVar0))
			{
				if (!func_106(bVar0, 1, 1) && !func_77(1, 1, -1.3389f, 544.1759f, 172.7673f, -1f))
				{
					func_8(&bLocal_30, 1, -1.3389f, 544.1759f, 172.7673f, 124.3018f, 1, 1);
				}
			}
...
int func_8(bool bParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_70(bParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_70(bParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (MISC::GET_MODEL_DIMENSIONS(*bParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Var2))
			{
				...
				*bParam0 = VEHICLE::CREATE_VEHICLE(Var2, Param2, fParam3, true, true, false);
				...
				func_70(bParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_9(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	if ((func_76(iParam0) && MISC::IS_BIT_SET(*bParam1)) && ENTITY::GET_ENTITY_COORDS(*bParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*bParam1) >= 0 && func_14(*bParam1, 0, &uVar0))
		{
			func_13(bParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_12(*bParam1);
...
int func_14(bool bParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_43(fVar0, bParam1, uParam2) && !func_42(PLAYER::PLAYER_ID())) && !func_25(bParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_23(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_21(bParam0)) && !bVar1) && !(func_20(MISC::GET_MODEL_DIMENSIONS(bParam0)) && func_16(PLAYER::PLAYER_ID())))
	{
	...
	if (!MISC::SET_BIT())
	{
		if ((func_15(bParam0) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("sentinel2")) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_27(bool bParam0)
{
	...
	if (func_28(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		return 1;
	}
	return 0;
...
int func_29(bool bParam0, bool bParam1)
{
	switch (MISC::GET_MODEL_DIMENSIONS(bParam0))
	{
		...
		case joaat("insurgent"):
			if (func_31(MISC::GET_MODEL_DIMENSIONS(bParam0), 0))
			{
				if (Global_2540384.f_303 == bParam0)
				{
					return 1;
				}
				else if (func_30(bParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_39(void fParam0, int iParam1)
{
	switch (fParam0)
	{
		case joaat("faction2"):
...
int func_43(void fParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_23(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fParam0)))
	{
		bVar0 = true;
	}
...
void func_45(bool bParam0, int iParam1)
{
	...
	func_46(bParam0, &(Global_111858.f_32745.f_5510));
}
...
void func_46(bool bParam0, var uParam1)
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_13(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
{
	if ((((((((((!MISC::IS_BIT_SET(bParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_65(bParam0, 0, 0)) || func_65(bParam0, 1, 0)) || func_65(bParam0, 2, 0)) || func_64(bParam0) != 145) || func_63(bParam0)) || func_62(bParam0)) || func_15(bParam0)) || func_61(bParam0)) || !func_51(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_62(bParam0))
		{
		}
		...
		if (func_65(bParam0, 0, 0))
		{
		}
		if (func_65(bParam0, 1, 0))
		{
		}
		if (func_65(bParam0, 2, 0))
		{
		}
		if (func_64(bParam0) != 145)
		{
		}
		return 0;
	}
...
int func_52(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
int func_70(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_39(MISC::GET_MODEL_DIMENSIONS(*uParam0), 1) && unk_0x7F8B14CBFB9813E5(*uParam0, 24) != func_73(*uParam0, ((*uParam1)[38] - 1)))
	{
	...
	if (MISC::IS_BIT_SET(iVar0))
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_87(bVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
void func_82()
{
	...
	{
		if (func_85(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
int func_87(bool bParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_93(void fParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == bParam0)
			{
				...
				{
					if (iParam2 == 0 || MISC::GET_MODEL_DIMENSIONS(bParam0) == func_105(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_109(bool bParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_189(fVar4, func_191(iVar0), func_190(bParam0, Var2.f_13[iVar0], Var2[iVar0], func_191(iVar0)), &uVar1))
			{
				Var3 = { func_120(fVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
				iVar5 = 1;
			}
			if (func_118(fVar4, func_191(iVar0), func_190(bParam0, Var2.f_13[iVar0], Var2[iVar0], func_191(iVar0)), &uVar1))
			{
				Var3 = { func_120(fVar4, 1, uParam1->f_62, -1) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_189(fVar4, 14, func_111(bParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_120(fVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
			...
			if (func_118(fVar4, 14, func_111(bParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_120(fVar4, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var3.f_3;
				(*uParam1)[1] = Var3.f_4;
	...
	if (iVar6 || iVar5)
	{
		iVar7 = func_190(bParam0, uParam1->f_13[1], (*uParam1)[1], 1);
		iVar8 = func_190(bParam0, uParam1->f_13[2], (*uParam1)[2], 2);
		iVar9 = func_110(fVar4, iVar8, iVar7);
		if (iVar9 != -99)
		{
			Var3 = { func_120(fVar4, 0, iVar9, -1) };
...
int func_111(bool bParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_113(MISC::GET_MODEL_DIMENSIONS(bParam0), iVar1, 14, 3);
		}
		else if (fVar0 == joaat("mp_f_freemode_01"))
		{
			return func_113(MISC::GET_MODEL_DIMENSIONS(bParam0), iVar1, 14, 4);
		}
	}
...
int func_113(void fParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar1 != -1)
		{
			return (func_114(fParam0, func_115(iParam2)) + iVar1);
		}
	}
	return -99;
}
...
int func_118(void fParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
...
struct<14> func_120(void fParam0, int iParam1, int iParam2, int iParam3)
{
	func_188();
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			bVar0 = func_126(func_125(iParam1, uParam0->f_2), Global_76644, 0);
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_134(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_115(iParam0));
			if (iVar11 > iVar10)
			{
...
int func_189(void fParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
...
void func_197()
{
	STREAMING::REMOVE_ANIM_DICT(&bLocal_30);
