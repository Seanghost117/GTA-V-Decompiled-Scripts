...
void __EntryFunction__()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("stock_controller")) > 1)
	{
		func_98();
	}
	Global_61701 = 1;
...
void func_1()
{
	...
	{
		func_2(89, 1);
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar1) > 5f)
		{
			func_2(90, 1);
		}
	}
...
int func_5()
{
	...
	if (!NETWORK::NETWORK_SESSION_IS_IN_VOICE_SESSION() || !VEHICLE::IS_THIS_MODEL_A_QUADBIKE())
	{
		return 1;
	}
	iVar0 = 0;
...
float func_9(int iParam0, bool bParam1)
{
	...
	iVar3 = 0;
	if (unk_0xCE990E643CD9D0E5(bParam1, 3))
	{
		iVar3++;
	}
	if (unk_0xCE990E643CD9D0E5(bParam1, 4))
	{
		iVar3 += 2;
	}
	if (unk_0xCE990E643CD9D0E5(bParam1, 5))
	{
		iVar3 += 4;
	}
	if (unk_0xCE990E643CD9D0E5(bParam1, 20))
	{
		iVar3 += 8;
	}
	...
	if (unk_0xCE990E643CD9D0E5(bParam1, 16))
	{
		fVar0 = (fVar0 - 0.5f);
	}
	if (unk_0xCE990E643CD9D0E5(bParam1, 17))
	{
		fVar0 = (fVar0 - 0.25f);
	}
	if (unk_0xCE990E643CD9D0E5(bParam1, 18))
	{
		fVar0 = (fVar0 - 0.1f);
	}
	if (unk_0xCE990E643CD9D0E5(bParam1, 19))
	{
		fVar0 = (fVar0 - 0.33f);
	}
	if (bVar1)
	...
	if (!unk_0xCE990E643CD9D0E5(bParam1, 1))
	{
		if (unk_0xCE990E643CD9D0E5(bParam1, 6))
		{
			fVar6 = 0f;
			if (unk_0xCE990E643CD9D0E5(bParam1, 8))
			{
				fVar6 = (fVar6 + 0.5f);
			}
			if (unk_0xCE990E643CD9D0E5(bParam1, 9))
			{
				fVar6 = (fVar6 + 0.25f);
			}
			if (unk_0xCE990E643CD9D0E5(bParam1, 10))
			{
				fVar6 = (fVar6 + 0.125f);
			}
			if (fVar5 < fVar6)
			{
				fVar7 = (fVar5 / fVar6);
				if (unk_0xCE990E643CD9D0E5(bParam1, 7))
				{
					fVar7 = (1f - fVar7);
					fVar7 = (fVar7 * fVar7);
					fVar7 = (1f - fVar7);
		...
		if (unk_0xCE990E643CD9D0E5(bParam1, 11))
		{
			fVar8 = 0f;
			if (unk_0xCE990E643CD9D0E5(bParam1, 13))
			{
				fVar8 = (fVar8 + 0.5f);
			}
			if (unk_0xCE990E643CD9D0E5(bParam1, 14))
			{
				fVar8 = (fVar8 + 0.25f);
			}
			if (unk_0xCE990E643CD9D0E5(bParam1, 15))
			{
				fVar8 = (fVar8 + 0.125f);
			}
			fVar9 = (1f - fVar8);
			if (fVar5 > fVar9)
			{
				...
				if (unk_0xCE990E643CD9D0E5(bParam1, 12))
				{
...
void func_47()
{
	...
	{
		fVar0 = AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::GET_PLAYER_INDEX());
		if (fVar0 == 0)
		{
			func_2(75, 1);
		}
		...
		if (SYSTEM::VDIST(iVar1, 0))
		{
			...
			if (iVar2 != 0)
			{
				if (func_58(iVar2))
				{
					fVar3 = MISC::GET_MODEL_DIMENSIONS(iVar2);
					func_56(fVar3);
				}
			}
		}
...
int func_60(int iParam0)
{
	...
	if (MISC::IS_BIT_SET(iParam0) && ENTITY::GET_ENTITY_COORDS(iParam0, false))
	{
		...
		while (iVar0 < 9)
		{
			...
			{
				if (Global_96286[iVar0] == iParam0 && MISC::GET_MODEL_DIMENSIONS(Global_96286[iVar0]) == MISC::GET_MODEL_DIMENSIONS(iParam0))
				{
					return 1;
				}
			}
...
int func_61(int iParam0, var uParam1)
{
	...
	while (iVar0 < 68)
	{
		if (Global_75654.f_484[iVar0] == iParam0)
		{
			...
			{
				if (unk_0xCE990E643CD9D0E5(Global_75654.f_555[0 /*21*/].f_9, 10) && Global_75654.f_555[0 /*21*/].f_4 == MISC::GET_MODEL_DIMENSIONS(iParam0))
				{
					*uParam1 = iVar0;
					return 1;
				}
...
void func_68()
{
	...
	{
		bVar2 = SCRIPT::GET_EVENT_DATA(0, iVar0);
		switch (bVar2)
		{
			case 142:
				...
				if (bVar4)
				{
					if (MISC::IS_BIT_SET(iVar1))
					{
						...
						else if (ENTITY::IS_ENTITY_A_VEHICLE(iVar1))
						{
							...
							func_72(MISC::GET_MODEL_DIMENSIONS(iVar1));
						}
						else if (ENTITY::IS_ENTITY_AN_OBJECT(iVar1))
						{
							switch (MISC::GET_MODEL_DIMENSIONS(iVar1))
							{
				...
				if (bVar4)
				{
					if (MISC::IS_BIT_SET(iVar1))
					{
						if (ENTITY::IS_ENTITY_A_PED(iVar1))
						{
							...
							{
								if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(iVar1, 0) || IntToFloat(ENTITY::GET_ENTITY_HEALTH(iVar1)) < (0.5f * IntToFloat(PED::GET_PED_MAX_HEALTH(iVar3))))
								{
						...
						{
							func_69(MISC::GET_MODEL_DIMENSIONS(iVar1));
							func_2(111, 1);
						}
						else if (ENTITY::IS_ENTITY_AN_OBJECT(iVar1))
						{
...
void func_74(int iParam0)
{
	...
	if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(iParam0))
	{
		...
		if (ENTITY::IS_ENTITY_A_VEHICLE(iVar1))
		{
			...
			func_77(fVar2, PED::GET_PED_TYPE(iVar0));
		}
		else
		{
			iVar3 = PED::GET_PED_CAUSE_OF_DEATH(iVar0);
			fVar4 = MISC::GET_MODEL_DIMENSIONS(iParam0);
			func_76(iVar3, PED::GET_PED_TYPE(iVar0), fVar4);
		}
	}
...
void func_76(int iParam0, int iParam1, void fParam2)
{
	int iVar0;
...
{
	MISC::IS_BIT_SET(iParam0);
	PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0, 0);
}
...
void func_80()
{
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), 0);
		if (iLocal_29 != iVar0)
		{
			Local_27 = { Local_28 };
			iLocal_29 = iVar0;
		...
		Local_27 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iVar0, 1) };
		if (iLocal_29 == 0)
		{
			Local_28 = { Local_27 };
			iLocal_29 = iVar0;
		...
		if (func_81(fVar1, HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_27, Local_28, 0)))
		{
			Local_28 = { Local_27 };
		}
	}
...
int func_81(void fParam0, void fParam1)
{
	if (fParam1 < 10f)
	{
		return 0;
	...
	while (iVar0 < 80)
	{
		if (Global_54016[iVar0 /*36*/].f_8)
		{
			...
			if (iVar1 > -1)
			{
				...
				NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(Global_56897[iVar1 /*7*/].f_3[iParam0], iVar2, 1);
			}
		}
		iVar0++;
	}
		...
		if (iVar0 < 42)
		{
			...
			if ((Global_54016[iVar1 /*36*/].f_32 > 0f && Global_54016[iVar1 /*36*/].f_31 > 0f) && Global_54016[iVar1 /*36*/].f_9 > 0f)
			{
				...
				while (iVar3 >= 0)
				{
					...
					bVar11 = func_92(bVar11, Global_54016[iVar1 /*36*/].f_14[iVar3]);
					fVar5 = (fVar5 + Global_54016[iVar1 /*36*/].f_14[iVar3]);
					iVar3 = (iVar3 + -1);
				}
				Global_54016[iVar1 /*36*/].f_32 = fVar10;
				Global_54016[iVar1 /*36*/].f_31 = bVar11;
				fVar5 = (fVar5 / 16f);
	...
	if (!Global_111858.f_20560.f_101)
	{
		...
		while (iVar1 <= 15)
		{
			...
			while (iVar0 < 80)
			{
				...
				Global_54016[iVar0 /*36*/].f_9 = func_93(func_92(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_54016[iVar0 /*36*/].f_9), 3.5f), 290f);
				iVar0++;
			}
			iVar1++;
		}
...
void func_95()
{
	...
	bVar2 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, (Global_59178 - 1));
	iVar0 = 0;
	while (iVar0 < 4)
	{
		iVar1 = 0;
		while (iVar1 < 3)
		{
			...
			while (!func_88(&(Global_59181[bVar2 /*14*/]), iVar0))
			{
				bVar2 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, (Global_59178 - 1));
				SYSTEM::WAIT(2000);
			}
			Global_59181[bVar2 /*14*/].f_10 = 0f;
			bVar2 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, (Global_59178 - 1));
			iVar1++;
		}
		iVar0++;
