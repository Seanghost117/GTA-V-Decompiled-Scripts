...
void func_10()
{
	...
	switch (iLocal_292)
	{
		case 0:
			...
			if (((!Global_108556 && unk_0x25DDB354A40FFCDB()) && func_23(3763, -1, -1)) && (!iLocal_295 || unk_0x44F29CF6A0675F4F(unk_0x624736CA66E14161(unk_0x6CAAB7E78B5D978A(), uLocal_296)) > 25000))
			{
			...
			else if (!unk_0x427E52F604B30219(iLocal_294))
			{
				switch (unk_0xA556BB9CD0915CC5(iLocal_294))
				{
					...
					default:
						...
						{
							iLocal_295 = 1;
							uLocal_296 = unk_0x6CAAB7E78B5D978A();
						}
						break;
				}
				iLocal_294 = 0;
...
void func_201(int iParam0)
{
			...
			if (func_83() == 0)
			{
				...
				if (Global_1323678[iVar25 /*141*/].f_66 == Var12)
				{
					...
					else if (iLocal_99)
					{
						...
						else if (Var12.f_27 > 0 && !unk_0x6914A85D2E17013B(Var12.f_27, 0, 1, 0, -1, 0))
						{
							Var12.f_39 = 1;
							iLocal_99 = 0;
						}
	...
	if ((!Var11.f_41 && iVar29) && Var11.f_40)
	{
		...
		func_437("spDiscount", (1f - (SYSTEM::TO_FLOAT(iVar32) / 100f)));
		func_437("mpDiscount", (1f - (SYSTEM::TO_FLOAT(iVar33) / 100f)));
		if (unk_0x0EB6C63A09FD9DF1())
		{
			func_198("playerName", unk_0x856D5567211886A2(unk_0x72C1D3A1AB8CAA5B(unk_0x460153A63B9477BC())));
			if (unk_0x25DDB354A40FFCDB())
...
int func_245(var uParam0)
{
	...
	if (iLocal_119)
	{
		if (unk_0x44F29CF6A0675F4F(unk_0x624736CA66E14161(unk_0x6CAAB7E78B5D978A(), uLocal_118)) < 1500)
		{
			return 0;
		}
	}
	...
	iLocal_119 = 1;
	uLocal_118 = unk_0x6CAAB7E78B5D978A();
	SYSTEM::SETTIMERA(0);
	return 1;
}
