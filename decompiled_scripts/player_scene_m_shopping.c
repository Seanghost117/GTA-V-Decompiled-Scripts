		...
		switch (iLocal_258)
		{
			...
			case 1:
				...
				else if (unk_0xFC5D6FB6EECB392F(Global_96285))
				{
					...
					if (!unk_0x9934470AA0A08B57(*uParam0, &cLocal_268, &cLocal_286, 2))
					{
						unk_0x9B94F6169B0DAEFD(*uParam0);
						unk_0x1CD098484842AE0B(*uParam0, -16f, 1);
						unk_0x4D1899320941DDC4(*uParam0);
						unk_0x3C1B180EE30D36EF(*uParam0, Local_264 + Local_266, 1f, -1, (fLocal_267 * 0.1f), 0, 1193033728);
				...
				else if (iLocal_67 != 151)
				{
					...
					{
						unk_0x3605DDBB702E6DDF(*uParam0, &cLocal_295, Local_264 + Local_304, (fLocal_265 + fLocal_305), 0, 0, 1);
			...
			case 3:
				...
				{
					if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(*uParam0, 1), Local_264 + Local_266) < (fLocal_267 * fLocal_267))
					{
						if (fLocal_267 == 0f)
						{
							fLocal_267 = (SYSTEM::VMAG(Local_266) * 0.75f);
						}
						unk_0x885D6EB4167FC3E8(*uParam0, Local_264 + Local_266, fLocal_267, 1077936128, 1086324736);
						func_135(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(*uParam0, 1), Local_264 + Local_266) < (fLocal_267 * fLocal_267))
				{
					...
					{
						unk_0x1AC55EB440F64E41(*uParam0, Local_264 + Local_266, fLocal_267, 0);
						unk_0x1E337EE68290597A(uLocal_307, 0);
						func_135(5, 0);
						return 1;
					}
				}
			...
			case 5:
				...
				else
				{
					...
					{
						if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(*uParam0, 1), Var5) > 100f)
						{
							unk_0x3C1B180EE30D36EF(*uParam0, Var5, 1f, -1, 0.25f, 0, 1193033728);
							Var6 = { unk_0x3E4D3CCC220BDFB1(*uParam0, 1) - Vector(2f, 2f, 2f) };
							Var7 = { unk_0x3E4D3CCC220BDFB1(*uParam0, 1) + Vector(2f, 2f, 2f) };
							uLocal_307 = unk_0xC08A186299DFDA0A(Var6, Var7, 0, 0, 1, 1);
			...
			case 7:
				...
				func_7(*uParam0);
				if (unk_0x9934470AA0A08B57(*uParam0, &cLocal_268, &cLocal_277, 2))
				{
				}
				else if (unk_0x9934470AA0A08B57(*uParam0, &cLocal_268, &cLocal_286, 2))
				{
				}
				break;
...
void func_7(var uParam0)
{
	...
	if (unk_0x5AEB5DDFFAD43CA5(uParam0))
	{
		if (!iLocal_310 && unk_0xCDF860E56BBCC6B4(uParam0, unk_0x9B0761B4C3EB8BC7(), 1))
		{
...
int func_10(var uParam0, int iParam1, var uParam2, char* sParam3, var uParam4, var uParam5, int iParam6)
{
	...
	if (!bVar5)
	{
		iVar6 = unk_0x3608BB1FB97A8C88(uParam0);
...
int func_136()
{
	...
	if (iLocal_261 != 0)
	{
		if (!unk_0xAE06B9E39EBDE049(uLocal_260))
		{
			uLocal_260 = unk_0x5BBA0055476D633A(Local_264 + Local_262, 1f, iLocal_261, 1, 0, 1);
			if (unk_0xAE06B9E39EBDE049(uLocal_260))
			{
				unk_0x03D382CB0B44E2FC(uLocal_260, Local_264 + Local_262, 1, 0, 0, 1);
				unk_0xC82085403E46A869(uLocal_260, Vector(fLocal_265, 0f, 0f) + Local_263, 2, 1);
				unk_0x6A8F948698B360B4(uLocal_260, 1);
			}
		}
	}
	return 0;
