		...
		switch (iLocal_258)
		{
			...
			case 1:
				...
				else if (PED::DETACH_SYNCHRONIZED_SCENE(Global_96285))
				{
					...
					if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*iParam0, &cLocal_268, &cLocal_286, 2))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(*iParam0);
				...
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(*iParam0);
					if (CAM::IS_SCREEN_FADED_OUT(&cLocal_295))
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, Local_264 + Local_266, 1f, -1, (fLocal_267 * 0.1f), false, 40000f);
						PED::FORCE_PED_MOTION_STATE(*iParam0, -668482597, false, 0, false);
						PED::CLEAR_RAGDOLL_BLOCKING_FLAGS(*iParam0, 2);
			...
			case 3:
				...
				{
					if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*iParam0, 1), Local_264 + Local_266) < (fLocal_267 * fLocal_267))
					{
						if (fLocal_267 == 0f)
						{
			...
			case 4:
				...
				if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*iParam0, 1), Local_264 + Local_266) < (fLocal_267 * fLocal_267))
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_264 + Local_266, fLocal_267, true))
					{
						...
						PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_307, 0);
						func_135(5, 0);
						return 1;
					}
				}
			...
			case 5:
				...
				else
				{
					...
					{
						if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*iParam0, 1), Var5) > 100f)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, Var5, 1f, -1, 0.25f, false, 40000f);
							Var6 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*iParam0, 1) - Vector(2f, 2f, 2f) };
							Var7 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*iParam0, 1) + Vector(2f, 2f, 2f) };
							fLocal_307 = PATHFIND::SET_ROADS_IN_AREA(Var6, Var7, false, false, 1, 1);
			...
			case 7:
				...
				func_7(*iParam0);
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*iParam0, &cLocal_268, &cLocal_277, 2))
				{
				}
				else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*iParam0, &cLocal_268, &cLocal_286, 2))
				{
				}
				break;
			...
			case 8:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 1805844857) != 1)
				{
					TASK::TASK_SMART_FLEE_PED(*iParam0, unk_0x9B0761B4C3EB8BC7(), 50f, 20000, true, false);
					return 1;
				}
				if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*iParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*iParam0, 1)) > (50f * 1.25f))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, Local_264 + Local_266, 1f, -1, (fLocal_267 * 0.1f), false, 40000f);
...
void func_7(int iParam0)
{
	...
	if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iParam0))
	{
		if (!iLocal_310 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, unk_0x9B0761B4C3EB8BC7(), true))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_114(75, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 0), 250f, -1);
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iParam3 == 0)
	{
		if (func_111(iVar1, iParam2, -1, &iVar4, &iVar5))
		{
			...
			if (func_107(iParam5, iVar4, iVar5, iVar0, bVar2, iParam1, iVar3, 10000, iParam6, iParam4, iVar7, iVar6, 1))
			{
				return 1;
			}
			else
...
void func_52(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_54() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_54() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_53(bParam0));
...
bool func_60(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_54() /*10931*/].f_6175.f_10, bParam0);
}
...
void func_94(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
...
int func_103(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	struct<4> Var0;
	struct<4> Var1[2];
	int iVar2;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)
{
	struct<14> Var0;
...
int func_111(int iParam0, int iParam1, bool bParam2, var uParam3, var uParam4)
{
	struct<4> Var0[2];
	int iVar1;
	...
	else
	{
		...
		*uParam4 = func_112(iParam1, bParam2);
		return 1;
	}
	return 0;
}
...
int func_132(int iParam0, bool bParam1)
{
	...
	if (PED::IS_PED_IN_COMBAT(iParam0, unk_0x9B0761B4C3EB8BC7()))
	{
		return 1;
	}
	if (bParam1)
...
int func_136()
{
	...
	if (iLocal_261 != 0)
	{
		if (!MISC::IS_BIT_SET(iLocal_260))
		{
			...
			if (MISC::IS_BIT_SET(iLocal_260))
			{
				unk_0x03D382CB0B44E2FC(iLocal_260, Local_264 + Local_262, 1, 0, 0, 1);
				ENTITY::DETACH_ENTITY(iLocal_260, Vector(fLocal_265, 0f, 0f) + Local_263, 2, 1);
				ENTITY::SET_ENTITY_COORDS(iLocal_260, 1);
			}
		}
	}
	return 0;
