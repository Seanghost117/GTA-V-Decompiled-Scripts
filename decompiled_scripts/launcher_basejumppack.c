...
void __EntryFunction__()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_132(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		if (MISC::IS_BIT_SET(fLocal_53) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(fLocal_53, 0))
		{
			Local_55 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(fLocal_53, 1) };
				...
				case 3:
					...
					else
					{
						...
						if (!func_112(3) && !Global_98989)
						{
							...
							{
								if ((!func_132(uLocal_58, 1) || !MISC::IS_BIT_SET(func_111())) && !Global_98989)
								{
									func_125(10);
									break;
								}
						...
						if (bVar2)
						{
							if (!unk_0xC2169C00B643278B(fLocal_53, ScriptParam_261.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, 0, 1, iLocal_67))
							{
								bVar2 = false;
							}
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != -1)
						{
							if (func_132(Global_110509, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_18(iLocal_63), 0, Global_98992, 0);
								func_6(func_18(iLocal_63), 0, Global_98992, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_18(iLocal_63), 0, Global_98992, 0);
								func_6(func_18(iLocal_63), 0, Global_98992, 0, 0);
							}
						}
						func_5();
						func_139(&Global_110509, 0);
...
int func_24()
{
	...
	Global_111858.f_18963 = iLocal_82;
	switch (iLocal_82)
	{
		case 4:
		case 8:
...
void func_25(bool bParam0)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		PED::SET_PED_RESET_FLAG(unk_0x9B0761B4C3EB8BC7(), 177, true);
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7()) > 0.3f)
		{
			TASK::TASK_STAND_STILL(unk_0x9B0761B4C3EB8BC7(), -1);
			while (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7()) > 0.3f)
			{
				SYSTEM::WAIT(0);
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
				{
		...
		if (MISC::IS_BIT_SET(fLocal_255))
		{
			Var4 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(fLocal_255, 0) };
			Var4.f_2 = 0f;
			bVar7 = SYSTEM::VMAG(Var4);
			TASK::OPEN_SEQUENCE_TASK(&iVar1);
			if (bVar7 > 0.8f)
			{
				Var4 = { Var4 * FtoV((0.78f / bVar7)) };
				Var5 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(fLocal_255, 0) + Var4 };
				if (iLocal_82 == 12)
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var5, 1f, 20000, 0.25f, false, func_65(Var5, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(fLocal_255, 0)));
				}
				else
				{
					HUD::_THEFEED_DISABLE(0, Var5, 1f, -1, func_65(Var5, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(fLocal_255, 0)), 1056964608);
				}
			}
			else if (bVar7 > 0.15f)
			{
				TASK::TASK_ACHIEVE_HEADING(0, func_65(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(fLocal_255, 0)), 0);
			}
	...
	func_23(&iLocal_251);
	while ((func_10(&iLocal_251) < 6f && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0)) && !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), "pickup_object", "pickup_low", 3))
	{
		PED::SET_PED_RESET_FLAG(unk_0x9B0761B4C3EB8BC7(), 177, true);
		SYSTEM::WAIT(0);
	}
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), "pickup_object", "pickup_low", 3))
	{
		ENTITY::SET_ENTITY_ANIM_SPEED(unk_0x9B0761B4C3EB8BC7(), "pickup_object", "pickup_low", 0.8f);
		bVar8 = true;
	}
	while ((func_10(&iLocal_251) < 6f && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0)) && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), "pickup_object", "pickup_low") < 0.22f)
	{
		PED::SET_PED_RESET_FLAG(unk_0x9B0761B4C3EB8BC7(), 177, true);
		if (!bVar8 && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), "pickup_object", "pickup_low", 3))
		{
			ENTITY::SET_ENTITY_ANIM_SPEED(unk_0x9B0761B4C3EB8BC7(), "pickup_object", "pickup_low", 0.8f);
			bVar8 = true;
		}
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (!bVar8 && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), "pickup_object", "pickup_low", 3))
		{
			ENTITY::SET_ENTITY_ANIM_SPEED(unk_0x9B0761B4C3EB8BC7(), "pickup_object", "pickup_low", 0.7f);
			bVar8 = true;
		}
		PED::SET_PED_RESET_FLAG(unk_0x9B0761B4C3EB8BC7(), 177, true);
	}
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_35() == 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(unk_0x9B0761B4C3EB8BC7(), 9, 5, 0, 0);
		}
		else if (func_35() == 1)
		{
			PED::SET_PED_COMPONENT_VARIATION(unk_0x9B0761B4C3EB8BC7(), 8, 1, 0, 0);
		}
		else if (func_35() == 2)
		{
			PED::SET_PED_COMPONENT_VARIATION(unk_0x9B0761B4C3EB8BC7(), 8, 3, 0, 0);
		}
	}
	if (bParam0)
	{
		if (!func_33(func_34(iLocal_82)) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(unk_0x9B0761B4C3EB8BC7());
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(unk_0x9B0761B4C3EB8BC7(), func_34(iLocal_82), 1f, -1, 0.25f, false, 40000f);
		}
		if (MISC::IS_BIT_SET(fLocal_255))
		{
			PED::GET_PED_BONE_INDEX(&fLocal_255);
		}
		iVar2 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, func_32(iLocal_82), func_31(iLocal_82), func_30(iLocal_82), true, 2);
		iVar3 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, func_29(iLocal_82), func_28(iLocal_82), func_27(iLocal_82), false, 2);
...
void func_41()
{
	...
	func_49(0, 0, 1);
	fLocal_255 = ENTITY::SET_ENTITY_ROTATION(joaat("p_parachute_s"), func_48(iLocal_82), 1, true, 0);
	ENTITY::DETACH_ENTITY(fLocal_255, func_47(iLocal_82), 2, 1);
	func_42(&Var0, &uVar1);
	Var2 = { 0f, 0f, uVar1 };
	iVar3 = PED::CREATE_SYNCHRONIZED_SCENE(Var0, Var2, 2);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(fLocal_255, iVar3, "puton_parachute_bag", "oddjobs@basejump@ig_15", 1000f, -1000f, 1, 1000f);
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(unk_0x9B0761B4C3EB8BC7());
		TASK::TASK_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), iVar3, "oddjobs@basejump@ig_15", "puton_parachute", 1000f, -1000f, 0, 0, 1000f, 0);
	}
	DATAFILE::UGC_UPDATE_CONTENT(-1, "Grab_Parachute", "BASEJUMPS_SOUNDS", 1);
	...
	CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
	while (ENTITY::HAS_ANIM_EVENT_FIRED(iVar3) < 0.6f)
	{
		SYSTEM::WAIT(0);
	}
...
void func_42(var uParam0, var uParam1)
{
	*uParam0 = { func_46(iLocal_82) };
	switch (iLocal_82)
	{
		...
		case 4:
			*uParam1 = func_45(func_65(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), *uParam0), -180f, 180f);
			if (*uParam1 > 0f)
			{
...
void func_51(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_56(PLAYER::PLAYER_ID())) && !func_53(PLAYER::PLAYER_ID(), 0)) && !func_52()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_56(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
float func_65(struct<2> Param0, bool bParam1, struct<2> Param2, bool bParam3)
{
...
int func_73(void fParam0)
{
	...
	while (iVar0 < 5)
	{
		if (Global_42562[iVar0 /*5*/].f_1 == fParam0)
		{
			return iVar0;
		}
		iVar0++;
...
int func_79(void fParam0)
{
	...
	while (iVar0 < 16)
	{
		...
		{
			if (fParam0 == Global_42588[iVar0 /*5*/].f_1)
			{
				return iVar0;
			}
		}
...
void func_85()
{
	...
	if (MISC::IS_BIT_SET(fLocal_255))
	{
		Var1 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(fLocal_255, 1) };
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_109()) || Global_110905) || Global_30970) || func_108()) || func_94(8, -1)) || func_105()) || func_107()) || func_106()) || func_96()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_109() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_94(8, -1)) || func_96()) || func_104()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_109()) || func_106()) || Global_110905) || Global_30970) || func_108()) || Global_42801) || func_94(8, -1)) || func_105()) || func_104()) || func_96()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
	...
	if (bLocal_254)
	{
		switch (iLocal_82)
		{
			...
			case 8:
				fLocal_255 = ENTITY::SET_ENTITY_ROTATION(joaat("p_parachute_s"), func_48(iLocal_82), 1, true, 0);
				ENTITY::DETACH_ENTITY(fLocal_255, func_47(iLocal_82), 2, 1);
				ENTITY::SET_ENTITY_COORDS(fLocal_255, 1);
				break;
			...
			case 12:
				fLocal_255 = ENTITY::SET_ENTITY_ROTATION(joaat("p_parachute_s"), func_48(iLocal_82), 1, true, 0);
				ENTITY::DETACH_ENTITY(fLocal_255, func_47(iLocal_82), 2, 1);
				OBJECT::PLACE_OBJECT_ON_GROUND_PROPERLY(fLocal_255);
				Var0 = { func_118(iLocal_82) };
				if (!func_33(Var0))
				{
					iLocal_256 = VEHICLE::CREATE_VEHICLE(joaat("bati"), Var0, func_117(iLocal_82), true, true, false);
