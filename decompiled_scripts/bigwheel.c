...
void func_31()
{
	...
	if (!unk_0x40397A9A17EEC1C5(uLocal_177))
	{
		uLocal_177 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, 1, 2);
		unk_0x3FD8029C7A771A0E(uLocal_177, -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, 0, 1, 1, 2);
		unk_0x856549C07003344B(uLocal_177, 1);
		unk_0x3FD8029C7A771A0E(uLocal_177, -1659.11f, -1120.752f, 12.9489f, -5.5053f, 0f, 56.0716f, 50.1098f, 7000, 1, 1, 2);
		unk_0x3ED9330214992278(1, 0, 3000, 1, 0, 0);
