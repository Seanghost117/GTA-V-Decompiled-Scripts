		...
		case 1:
			...
			if (func_236(Local_81.f_28[0]))
			{
				if (func_237())
				{
					if (iLocal_263 < 5)
					{
						if (!PED::IS_PED_HEADTRACKING_PED(Local_81.f_28[0], unk_0x9B0761B4C3EB8BC7()))
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_81.f_28[0], unk_0x9B0761B4C3EB8BC7(), -1, 0, 2);
						}
					}
				}
				else if (PED::IS_PED_HEADTRACKING_PED(Local_81.f_28[0], unk_0x9B0761B4C3EB8BC7()))
				{
					TASK::TASK_CLEAR_LOOK_AT(Local_81.f_28[0]);
				}
				if (func_238(unk_0x9B0761B4C3EB8BC7(), Local_81.f_28[0], 1) >= 100f && !CAM::IS_SPHERE_VISIBLE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_81.f_28[0], 1), 3f))
				{
					iLocal_84 = 3;
				}
				if ((((((GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_81.f_28[0], 0), 5f) || MISC::IS_BULLET_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_81.f_28[0], 0), 5f, false)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_81.f_28[0], 0), joaat("weapon_grenadelauncher"), 5f, false)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_81.f_28[0], 0), joaat("weapon_rpg"), 5f, false)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_81.f_28[0], 0), joaat("weapon_grenade"), 5f, false)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_81.f_28[0], 0), joaat("weapon_molotov"), 5f, false)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_81.f_28[0], 0), joaat("weapon_flare"), 5f, false))
				{
					...
					AUDIO::STOP_SCRIPTED_CONVERSATION(Local_81.f_28[0], iLocal_256);
					iLocal_251 = 3;
					func_314(2);
				}
				if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Local_81.f_28[0]) || MISC::IS_PC_VERSION(Local_81.f_28[0]))
				{
					AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
					AUDIO::STOP_SCRIPTED_CONVERSATION(Local_81.f_28[0], iLocal_256);
					iLocal_251 = 2;
...
void func_29()
{
	...
	{
		Global_111858.f_10045.f_104 = CLOCK::GET_CLOCK_MONTH();
	}
	STATS::STAT_GET_INT(joaat("NUM_EPSILON_STEP"), &iVar0, -1);
	if (iVar0 < 6)
	{
		NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT(joaat("NUM_EPSILON_STEP"), 6, 1);
		func_224(23, 6);
	}
...
int func_58(bool bParam0, int iParam1, int iParam2)
{
	...
	if (!func_173(bParam0, iParam1, iParam2))
	{
		return 0;
	}
	if (iParam1 == 12)
...
int func_59(bool bParam0, void fParam1, int iParam2)
{
	...
	{
		if (!func_173(bParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
int func_67(bool bParam0, int iParam1, int iParam2)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		if (iParam1 == 12)
		{
			...
			while (iVar0 <= 53)
			{
				if (func_173(bParam0, iParam1, iVar0))
				{
					return iVar0;
				}
				iVar0++;
		...
		else if (iParam1 == 13)
		{
			...
			while (iVar1 <= 19)
			{
				if (func_173(bParam0, iParam1, iVar1))
				{
					return iVar1;
				}
				iVar1++;
...
int func_100(bool bParam0, void fParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_173(bParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_173(bool bParam0, int iParam1, int iParam2)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar2 <= 14)
		{
			...
			{
				if (!func_173(bParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_173(bParam0, 14, uVar6[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar7 <= 8)
		{
			if (!func_173(bParam0, 14, uVar8[iVar7]))
			{
				return 0;
			}
			iVar7++;
...
void func_180(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_181(&uVar1, Var0.f_3, Global_98992, bParam1, bParam2);
	}
}

void func_181(var* uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
...
int func_221()
{
	return func_222(TASK::IS_PED_BEING_ARRESTED(), 0);
}
...
void func_227(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_228(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, false, 2, AUDIO::ADD_LINE_TO_CONVERSATION(func_229(iParam1)), 0));
		}
		else
		{
			func_228(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, AUDIO::ADD_LINE_TO_CONVERSATION(func_229(iParam1)), 0));
		}
		switch (Global_19681)
		{
			case 0:
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_325())
			{
				...
				HUD::HAS_ADDITIONAL_TEXT_LOADED("EPS3", 0);
				while (!CUTSCENE::HAS_CUTSCENE_LOADED() && !HUD::REQUEST_ADDITIONAL_TEXT_FOR_DLC(0))
				{
					SYSTEM::WAIT(0);
				}
				func_284(0, 0, 0);
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_85, 0))
			{
				if (func_236(Local_81.f_28[0]))
				{
					...
					ENTITY::FREEZE_ENTITY_POSITION(Local_81.f_28[0], true, 0);
				}
			}
			if (!iLocal_253)
			{
...
void func_247(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_251(PLAYER::PLAYER_ID())) && !func_249(PLAYER::PLAYER_ID(), 0)) && !func_248()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_251(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
int func_254(bool bParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
	...
	if (MISC::IS_BIT_SET(iVar0))
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_263(bVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_261(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_263(bool bParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_269(int iParam0, float fParam1, int iParam2)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_274(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_274(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_277()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_274(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_287()
{
	...
	switch (iLocal_84)
	{
		case 0:
			...
			HUD::HAS_ADDITIONAL_TEXT_LOADED("EPS3", 0);
			while (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_82) && !HUD::REQUEST_ADDITIONAL_TEXT_FOR_DLC(0))
			{
				SYSTEM::WAIT(0);
			}
			if (func_246(unk_0x9B0761B4C3EB8BC7()))
			{
				iLocal_258 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(unk_0x9B0761B4C3EB8BC7());
			}
			if (func_246(Local_81.f_28[0]))
			{
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_81.f_28[0], iLocal_258);
				PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_81.f_28[0], 1.849714E-43f, 1);
			}
			if (func_236(Local_81.f_28[0]))
			{
				PED::_0x2208438012482A1A(Local_81.f_28[0], 1);
		...
		case 1:
			if (func_236(Local_81.f_28[0]))
			{
				if (iLocal_254 == 0)
				{
					if (((func_238(unk_0x9B0761B4C3EB8BC7(), Local_81.f_28[0], 1) <= 3f && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1847.705f, 4703.014f, 36.58427f, 1844.084f, 4709.532f, 39.73755f, 5f, 0, 1, 0)) && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1842.977f, 4705.946f, 36.78089f, 1842.161f, 4707.852f, 40.10524f, 2.5f, 0, 1, 0)) && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1843.527f, 4704.969f, 36.83727f, 1844.178f, 4703.326f, 40.25331f, 2.5f, 0, 1, 0))
					{
						if (CAM::IS_GAMEPLAY_HINT_ACTIVE())
						{
						...
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(unk_0x9B0761B4C3EB8BC7(), Local_81.f_28[0], 0);
						TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), Local_81.f_28[0], 7000, 0, 2);
						iLocal_254 = 1;
					}
				}
				if (func_238(unk_0x9B0761B4C3EB8BC7(), Local_81.f_28[0], 1) >= 4f)
			...
			if (!bLocal_252)
			{
				...
				{
					TASK::TASK_LOOK_AT_ENTITY(Local_81.f_28[0], unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
...
{
	if (((!func_303(0) || Global_77102) || Global_77091 == 1) || !GRAPHICS::DRAW_SCALEFORM_MOVIE())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((OBJECT::ADD_DOOR_TO_SYSTEM() || func_282(0)) || func_302(1))
			{
			}
			else
			{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			if (!MISC::IS_BIT_SET(uParam0->f_28[0]))
			{
				...
				{
					if (MISC::IS_BIT_SET(uParam0->f_28[0]) && func_246(unk_0x9B0761B4C3EB8BC7()))
					{
...
void func_326()
{
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_257, 0);
	if (func_341())
	{
	}
...
void func_342(bool bParam0)
{
	...
	if (!func_359())
	{
		...
		{
			func_180(iVar0, 1, 0);
			func_343(TASK::IS_PED_BEING_ARRESTED(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_344(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_350())
	{
		...
		{
			iVar2 = func_345(TASK::IS_PED_BEING_ARRESTED());
			if (iVar2 > -1)
			{
...
int func_348(void fParam0, bool bParam1)
{
	int iVar0;
