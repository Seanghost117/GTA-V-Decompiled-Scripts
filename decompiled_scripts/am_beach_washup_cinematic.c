...
void func_4(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_9(PLAYER::PLAYER_ID())) && !func_6(PLAYER::PLAYER_ID(), 0)) && !func_5()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_9(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_16(var uParam0)
{
	...
	fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(uParam0->f_5);
	if (ENTITY::HAS_ANIM_EVENT_FIRED(fVar0) >= 0.9f)
	{
		SYSTEM::POW(uParam0->f_5);
...
void func_19(var uParam0)
{
	...
	uVar0 = func_20();
	uParam0->f_5 = NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(uParam0->f_1, 0f, 0f, uParam0->f_4, 2, 0, 0f, 1065353216, 0, 1065353216);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_5, uVar0, "action", 1000f, -1.5f, 0, 0, 1148846080, 0);
	unk_0xB88AF19828BF16ED(uParam0->f_5);
	PED::GET_ANIM_INITIAL_OFFSET_ROTATION(unk_0x9B0761B4C3EB8BC7(), "HS4F_IG25_BEACH", 0);
