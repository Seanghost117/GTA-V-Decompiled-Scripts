...
int func_62(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(func_63()))
	{
		return 0;
	}
...
int func_78(int iParam0, char* sParam1, int iParam2, int iParam3, void fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	void fVar0;
	int iVar1;
	...
	if (fParam4 == 0)
	{
		iVar1 = func_89(fVar0, sParam1, fParam4);
		fParam4 = AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(func_88(iVar1));
	}
...
int func_89(void fParam0, char* sParam1, int iParam2)
{
	switch (iParam2)
	{
		case 1019352240:
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		if (fVar0 == joaat("mp_m_freemode_01"))
		{
			return func_109(MISC::GET_MODEL_DIMENSIONS(iParam0), iVar1, 14, 3);
		}
		else if (fVar0 == joaat("mp_f_freemode_01"))
		{
			return func_109(MISC::GET_MODEL_DIMENSIONS(iParam0), iVar1, 14, 4);
		}
	}
...
int func_109(void fParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar1 != -1)
		{
			return (func_100(fParam0, func_101(iParam2)) + iVar1);
		}
	}
	return -99;
}
...
int func_111(int iParam0, int iParam1, int iParam2)
{
	...
	fVar0 = MISC::GET_MODEL_DIMENSIONS(iParam0);
	Global_76647[1 /*14*/] = { func_127(fVar0, iParam1, iParam2, -1) };
		...
		while (iVar7 < 7)
		{
			...
			if (uVar8[iVar4] != -99)
			{
				if (!func_111(iParam0, iVar4, uVar8[iVar4]))
				{
					...
					if (iVar4 == 13)
					{
						uVar9 = { func_120(fVar0, uVar8[iVar4]) };
						iVar5 = 0;
						while (iVar5 <= 8)
						{
							if (!func_111(iParam0, 14, uVar9[iVar5]))
							{
								...
								while (iVar6 <= 19)
								{
									Global_76647[2 /*14*/] = { func_127(fVar0, 14, iVar6, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar5)
									{
										if (func_111(iParam0, 14, iVar6))
										{
											if (!func_115(fVar0, iParam2, 14, iVar6, &uVar8, &(Global_76647[2 /*14*/])))
											{
												Global_2621444 = uVar2;
												Global_2621445 = uVar3;
												return 0;
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_127(fVar0, iVar4, iVar1, -1) };
						if (!func_115(fVar0, iParam2, iVar4, iVar1, &uVar8, &(Global_76647[2 /*14*/])))
						{
							Global_2621444 = uVar2;
							Global_2621445 = uVar3;
							return 0;
	...
	else
	{
		...
		if (iParam1 == 4)
		{
			...
			if (Global_76646 == 1)
			{
				if (func_114(fVar0, 11, func_104(iParam0, 11), -1))
				{
					if (func_113(fVar0, 4, iParam2, &uVar18))
					{
						return func_111(iParam0, 4, uVar18);
					}
				}
				else if (func_112(fVar0, 4, iParam2, &uVar18))
				{
					return func_111(iParam0, 4, uVar18);
				}
			}
...
int func_112(void fParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (iParam2 >= 256)
					{
						iVar0 = func_99(fParam0, iParam2, iParam1, 4);
						if (iVar0 != -1)
						{
							...
							while (iVar2 < iVar1)
							{
								...
								if (iVar5 == 4)
								{
									if (iVar3 != 0 && iVar3 != joaat("0"))
									{
										...
										{
											*uParam3 = func_109(fParam0, iVar3, iParam1, 4);
											return 1;
										}
									}
								}
...
int func_113(void fParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			switch (iParam1)
			{
				case 11:
					if (iParam2 >= 256)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_99(fParam0, iParam2, 11, 4);
						}
...
int func_115(void fParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar1;
	...
	if (func_119(fParam0, iParam2, iParam3))
	{
		return 1;
	}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_99(fParam0, iParam2, 14, 3);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 1) || unk_0x4D0432E34C5996D9(func_99(fParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_99(fParam0, iParam2, 1, 3);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 0) || unk_0x4D0432E34C5996D9(func_99(fParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_99(fParam0, iParam2, 14, 4);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 1) || unk_0x4D0432E34C5996D9(func_99(fParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_99(fParam0, iParam2, 1, 4);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 0) || unk_0x4D0432E34C5996D9(func_99(fParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_119(void fParam0, int iParam1, int iParam2)
{
	switch (fParam0)
	{
		case joaat("player_zero"):
...
struct<14> func_127(void fParam0, int iParam1, int iParam2, int iParam3)
{
	func_173();
	if (fParam0 == joaat("mp_m_freemode_01"))
	{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			bVar0 = func_82(func_132(iParam1, uParam0->f_2), Global_76644, 0);
...
int func_201()
{
	...
	if (func_202() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_202()) == 0)
		{
			return 1;
		}
	}
