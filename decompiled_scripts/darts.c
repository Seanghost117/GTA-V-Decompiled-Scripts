...
void __EntryFunction__()
{
	...
	if (!MISC::IS_BIT_SET(ScriptParam_228.f_4))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			if (iLocal_175 == 2)
	...
	{
		Var19 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(ScriptParam_228.f_4, 1) };
	}
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(func_498(), 0))
	{
		func_496(iLocal_170, 1);
		if (SYSTEM::VDIST(func_498(), 0))
		{
	...
	while (true)
	{
		...
		if ((STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(ScriptParam_228.f_5) && !MISC::IS_BIT_SET(func_498())) || (MISC::IS_BIT_SET(func_498()) && STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_498())))
		{
			func_469(&Var0, &Var5, &Var6);
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_138[0]))
		{
			...
			iVar14 = 0;
			while (iVar14 < PED::GET_PED_NEARBY_PEDS(unk_0x9B0761B4C3EB8BC7(), &iVar26, -1))
			{
				if (iVar26[iVar14] != iLocal_138[1])
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iVar26[iVar14]))
					{
			...
			switch (Var0)
			{
				...
				case 1:
					if (SYSTEM::TIMERA() > 500 && !MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7()))
					{
						MISC::CLEAR_AREA(ScriptParam_228, 0.5f, true, false, false, false);
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
						{
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_173);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_173);
							TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_173);
							AUDIO::STOP_SCRIPTED_CONVERSATION(unk_0x9B0761B4C3EB8BC7(), iLocal_173);
						}
						Local_42 = { Local_42 };
						Var0 = 2;
					}
				...
				case 3:
					if (func_449(&Var4, &Var5))
					{
						...
						{
							case 0:
								bLocal_219 = func_445("MICHAEL");
								if (!unk_0xCE990E643CD9D0E5(Global_111819, false))
								{
						...
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(func_498(), 0))
						{
							...
							{
								case 0:
									bLocal_220 = func_445("MICHAEL");
									break;
								
								case 1:
									bLocal_220 = func_445("FRANKLIN");
									break;
								
								case 2:
									bLocal_220 = func_445("TREVOR");
									break;
								
								case 19:
									bLocal_220 = func_445("LAMAR");
									PED::SET_PED_COMPONENT_VARIATION(func_498(), 5, 2, 0, 0);
									break;
								
								case 14:
									bLocal_220 = func_445("JIMMY");
									break;
						...
						{
							bVar12 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 200);
							if (iLocal_175 == 2)
							{
								if (bVar12 < 51)
								{
									bLocal_220 = func_445("RAYMOND");
									iLocal_221 = 954610991;
								}
								else if (bVar12 < 101)
								{
									bLocal_220 = func_445("JOHAN");
									iLocal_221 = 94453331;
								}
								else if (bVar12 < 151)
								{
									bLocal_220 = func_445("STAN");
									iLocal_221 = 1891555423;
								}
								else
								{
									bLocal_220 = func_445("VINCE");
									iLocal_221 = -1067630349;
								}
							}
							else if (bVar12 < 51)
							{
								bLocal_220 = func_445("KRISTY");
								iLocal_221 = 885327384;
							}
							else if (bVar12 < 101)
							{
								bLocal_220 = func_445("MARLENE");
								iLocal_221 = -1791000994;
							}
							else if (bVar12 < 151)
							{
								bLocal_220 = func_445("LORIE");
								iLocal_221 = 1954368234;
							}
							else
							{
								bLocal_220 = func_445("SHELLEY");
				...
				case 4:
					if (!CAM::_0x705A276EBFF3133D())
					{
						...
						func_438(&Var4, bLocal_219, bLocal_220);
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_138[1]);
						...
						func_437(&(Var0.f_257), 0, unk_0x9B0761B4C3EB8BC7(), bLocal_219, 0, 1);
						if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(func_498(), 0))
						{
							if (iLocal_175 == 2)
							{
						...
						{
							func_437(&(Var0.f_257), 3, func_498(), bLocal_220, 0, 1);
							func_435(&iVar25);
							iVar13 = 6;
						}
						if (!unk_0xCE990E643CD9D0E5(Global_111819, false))
				...
				case 5:
					if ((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_138[1]) && PED::IS_PED_ON_FOOT(iLocal_138[0])) && !SYSTEM::VDIST(iLocal_138[0], 1)) && PED::IS_PED_ON_FOOT(iLocal_138[1])) && !SYSTEM::VDIST(iLocal_138[1], 1))
					{
						...
						if (PED::REMOVE_SCENARIO_BLOCKING_AREA() && iVar13 != 9)
						{
							func_427(0);
							func_425();
							iVar13 = 9;
						...
						{
							case -1:
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_138[1]))
								{
									iLocal_168 = PED::CREATE_SYNCHRONIZED_SCENE(unk_0x7EC595B99EA7C4B1(ScriptParam_228.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (ENTITY::IS_ENTITY_IN_WATER(ScriptParam_228.f_4) - 3.783146f), 2);
							...
							case 0:
								if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_168))
								{
									if (!bVar9)
									{
									...
									switch (iLocal_31)
									{
										...
										case 1:
											if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_168) > 0.25f)
											{
												func_424(&iVar25);
										...
										case 2:
											if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_168) > 0.55f)
											{
										...
										case 3:
											if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_168) > 0.85f)
											{
												func_418("DARTS_HOW_3A", -1);
												iLocal_31++;
											}
									...
									if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_168) > 0.95f)
									{
										iLocal_158 = 1;
										iVar13++;
									}
							...
							case 1:
								if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_168) > 0.99f)
								{
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_138[1]))
									{
										...
										HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_138[0]);
										HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_138[1]);
										ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iVar27, -1000f, false);
										PED::GET_PED_BONE_INDEX(&iVar27);
				...
				case 7:
					if (!unk_0xCE990E643CD9D0E5(Global_111819, false))
					{
						...
						{
							unk_0xBE20AB8238688965(&Global_111819, false);
							Var0 = 8;
						}
					}
					else
					...
					switch (iVar13)
					{
						case 0:
							if (!MISC::IS_BIT_SET(func_498()))
							{
								...
								{
									VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_111819, 10);
								}
								func_405(&Var5);
								iVar13++;
							}
					...
					switch (iVar13)
					{
						case 0:
							if (func_423(&(Var0.f_254)) > 0.5f)
							{
								...
								CAM::SET_CAM_ACTIVE(iLocal_174, true);
								CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_138[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_138[1]))
								{
									if (Var0.f_454)
									{
										...
										DATAFILE::UGC_UPDATE_CONTENT(-1, "TENNIS_POINT_WON", "HUD_AWARDS", 1);
										...
										TASK::TASK_PLAY_ANIM(unk_0x9B0761B4C3EB8BC7(), sLocal_223, sLocal_224[NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 3)], 4f, -4f, -1, 32, 0f, false, false, false);
									}
									else
									{
										DATAFILE::UGC_UPDATE_CONTENT(-1, "OTHER_TEXT", "HUD_AWARDS", 1);
										func_238(&iLocal_138);
										...
										TASK::TASK_PLAY_ANIM(iLocal_138[1], sLocal_222, sLocal_224[NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 3)], 4f, -4f, -1, 32, 0f, false, false, false);
									}
								}
								iVar13++;
							}
...
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(func_498(), 0) || iParam2)
	{
...
void func_11(var uParam0, bool bParam1)
{
	...
	func_13(MOBILE::GET_MOBILE_PHONE_POSITION(2, 215, true));
	func_12("ES_HELP");
	if (ENTITY::GET_ENTITY_HEADING())
	{
		unk_0xF1B28F753235CE2A(true);
	...
	if (bParam1)
	{
		...
		func_13(MOBILE::GET_MOBILE_PHONE_POSITION(2, 216, true));
		func_12("ES_XPAND");
		if (ENTITY::GET_ENTITY_HEADING())
		{
			unk_0xF1B28F753235CE2A(true);
...
void func_15(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_33();
		GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(0.5f, (fVar1 - (func_37((2f - 0.5f)) - 0.001388889f)), fVar6, func_28(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
	...
	while (iVar17 < uParam0->f_56)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			func_25(uParam0, iVar17, (fVar1 + func_37(2f)), fVar9, fVar10, SYSTEM::ROUND((IntToFloat(fVar0) * fVar12)));
		}
		else
		{
			return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_14((fVar11 / (0.6f * func_37(25f))), 0f, 1f);
					func_33();
					GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(0.5f, (fVar1 + func_37((2f * 0.5f))), fVar6, func_28(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_37((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_37((25f * 0.2f)));
	...
	if (uParam0->f_549)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			{
				cVar20 = (fVar9 + ((0.119f / func_35()) / 2.5f));
				fVar21 = (fVar10 - ((0.119f / func_35()) / 2.5f));
				if (uParam0->f_556 == 1)
				{
					cVar20 = (fVar9 + (((0.119f + 0.05f) / func_35()) / 2.5f));
			...
			HUD::SET_TEXT_SCALE(1f, 0.4f);
			func_17(&(uParam0->f_550), cVar20, (fVar1 + func_37((2f * 2f))), 0, 0, 0);
			HUD::SET_TEXT_WRAP(cVar20, fVar21);
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(cVar20, (fVar1 + func_37((2f * 2f))), 0);
					break;
...
void func_17(char* sParam0, char* sParam1, float fParam2, bool bParam3, bool bParam4, int iParam5)
{
...
void func_25(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, void fParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_21(7, 0), (fParam4 - 0.006f), ((fParam2 + func_37(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, fParam5, false);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_18(5, 0, 1, &fVar5, &fVar6, 0);
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_21(5, 0), (fParam4 - 0.006f), ((fParam2 + func_37(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, fParam5, false);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_18(6, 0, 1, &fVar5, &fVar6, 0);
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_21(6, 0), (fParam4 - 0.006f), ((fParam2 + func_37(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, fParam5, false);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_26(void fParam0, void fParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	switch (iParam5)
	{
		case 11:
			NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS("PERCENTAGE");
			unk_0x42710E9E08FA375A(fParam0);
			break;
		...
		case 2:
			...
			NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS("FO_TWO_NUM");
			unk_0x42710E9E08FA375A(fParam0);
			unk_0x42710E9E08FA375A(fParam1);
			break;
		...
		case 8:
			HUD::SET_TEXT_FONT(5);
			NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS("STRING");
			NETWORK::UGC_GET_CACHED_DESCRIPTION(fParam0, 14);
			break;
		
		case 9:
			HUD::SET_TEXT_FONT(5);
			NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS("STRING");
			NETWORK::UGC_GET_CACHED_DESCRIPTION(fParam0, 6);
			break;
		
		case 10:
			HUD::SET_TEXT_FONT(5);
			NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS("STRING");
			NETWORK::UGC_GET_CACHED_DESCRIPTION(fParam0, 2055);
			break;
...
void func_41(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (iLocal_141)
	{
		...
		if (uParam1->f_680)
		{
			if (!uParam1->f_646 && !INTERIOR::IS_VALID_INTERIOR())
			{
			...
			if (bVar1)
			{
				...
				else if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 215))
				{
					iVar0 = 2;
				}
		...
		if ((PED::DETACH_SYNCHRONIZED_SCENE(iLocal_168) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_168) >= 0.995f) || !PED::DETACH_SYNCHRONIZED_SCENE(iLocal_168))
		{
			bLocal_154 = true;
			if (CAM::DOES_CAM_EXIST(iLocal_174))
			{
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_138[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_138[1]))
				{
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_138[0]);
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_138[1]);
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_138[0], false, 0);
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_138[1], false, 0);
				}
			}
			func_108();
		}
		...
		else if (((PAD::IS_DISABLED_CONTROL_PRESSED(0, 234) || PAD::IS_DISABLED_CONTROL_PRESSED(0, 235)) && uParam0->f_248 == 1) && bVar1)
		{
			uParam0->f_457 = 0;
			if (iLocal_140)
			{
				Var3 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_5[iLocal_30 /*79*/][iLocal_163 /*26*/], 1) };
				func_52(Var3, 0, iLocal_140);
				iLocal_140 = 0;
			}
			else if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 190))
			{
				iLocal_163++;
			...
			else if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 189))
			{
		...
		else if (((PAD::IS_DISABLED_CONTROL_PRESSED(0, 211) || PAD::IS_CONTROL_JUST_PRESSED(0, 211)) && bVar1) && (iLocal_159 || !INTERIOR::IS_VALID_INTERIOR()))
		{
			uParam1->f_680 = 1;
			func_120(&(uParam1->f_509), 0, 0, 1, 1);
			func_119(&(uParam1->f_509), "DARTS_CONT", 2, 215, 1, 1, 0);
	...
	else if ((MISC::GET_GAME_TIMER() - uParam1->f_671) > 400 && func_42(uParam3, 0, 0))
	{
		if (!uParam0->f_454)
		{
			DATAFILE::UGC_UPDATE_CONTENT(-1, "LOOSE_MATCH", "HUD_MINI_GAME_SOUNDSET", 1);
		}
		iLocal_141 = 1;
	}
}
...
void func_43(var uParam0)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(2);
	func_13(MOBILE::GET_MOBILE_PHONE_POSITION(2, 188, true));
	func_12("ES_HELP_TU");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(true);
	func_13(MOBILE::GET_MOBILE_PHONE_POSITION(2, 187, true));
	func_12("ES_HELP_TD");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(false);
	func_13(MOBILE::GET_MOBILE_PHONE_POSITION(2, 202, true));
	func_12("ES_HELP_AB");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_53(int iParam0, int iParam1, void fParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	func_54(func_89(iParam0), 1, iParam1, fParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_54(int iParam0, int iParam1, int iParam2, void fParam3, bool bParam4)
{
	float fVar0;
	bool bVar1;
	int iVar2;
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_87(99, 1);
					func_86(joaat("SP0_MONEY_TOTAL_SPENT"), fParam3);
					break;
				
				case 1:
					func_86(joaat("SP1_MONEY_TOTAL_SPENT"), fParam3);
					break;
				
				case 2:
					func_86(joaat("SP2_MONEY_TOTAL_SPENT"), fParam3);
					break;
			}
			func_70(0);
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_86(joaat("SP0_MONEY_SPENT_ON_TATTOOS"), fParam3);
							break;
						
						case 1:
							func_86(joaat("SP1_MONEY_SPENT_ON_TATTOOS"), fParam3);
							break;
						
						case 2:
							func_86(joaat("SP2_MONEY_SPENT_ON_TATTOOS"), fParam3);
							break;
					}
					if (func_65(1))
					{
				...
				case 21:
					...
					{
						case 0:
							func_86(joaat("SP0_MONEY_SPENT_ON_TAXIS"), fParam3);
							break;
						
						case 1:
							func_86(joaat("SP1_MONEY_SPENT_ON_TAXIS"), fParam3);
							break;
						
						case 2:
							func_86(joaat("SP2_MONEY_SPENT_ON_TAXIS"), fParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_86(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), fParam3);
							break;
						
						case 1:
							func_86(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), fParam3);
							break;
						
						case 2:
							func_86(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), fParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_86(joaat("SP0_MONEY_SPENT_PROPERTY"), fParam3);
							break;
						
						case 1:
							func_86(joaat("SP1_MONEY_SPENT_PROPERTY"), fParam3);
							break;
						
						case 2:
							func_86(joaat("SP2_MONEY_SPENT_PROPERTY"), fParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("clothes_shop_sp"):
							...
							{
								case 0:
									func_86(joaat("SP0_MONEY_SPENT_IN_CLOTHES"), fParam3);
									break;
								
								case 1:
									func_86(joaat("SP1_MONEY_SPENT_IN_CLOTHES"), fParam3);
									break;
								
								case 2:
									func_86(joaat("SP2_MONEY_SPENT_IN_CLOTHES"), fParam3);
									break;
							}
							break;
						...
						case joaat("hairdo_shop_sp"):
							...
							{
								case 0:
									func_86(joaat("SP0_MONEY_SPENT_ON_HAIRDOS"), fParam3);
									break;
								
								case 1:
									func_86(joaat("SP1_MONEY_SPENT_ON_HAIRDOS"), fParam3);
									break;
								
								case 2:
									func_86(joaat("SP2_MONEY_SPENT_ON_HAIRDOS"), fParam3);
									break;
							}
							if (func_65(0))
							{
						...
						case joaat("gunclub_shop"):
							...
							{
								case 0:
									func_86(joaat("SP0_MONEY_SPENT_IN_BUYING_GUNS"), fParam3);
									break;
								
								case 1:
									func_86(joaat("SP1_MONEY_SPENT_IN_BUYING_GUNS"), fParam3);
									break;
								
								case 2:
									func_86(joaat("SP2_MONEY_SPENT_IN_BUYING_GUNS"), fParam3);
									break;
							}
							break;
						...
						case joaat("carmod_shop"):
							...
							{
								case 0:
									func_86(joaat("SP0_MONEY_SPENT_CAR_MODS"), fParam3);
									break;
								
								case 1:
									func_86(joaat("SP1_MONEY_SPENT_CAR_MODS"), fParam3);
									break;
								
								case 2:
									func_86(joaat("SP2_MONEY_SPENT_CAR_MODS"), fParam3);
									break;
							}
							func_64(fParam3);
							break;
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_86(joaat("SP0_TOTAL_CASH_EARNED"), fParam3);
					break;
				
				case 1:
					func_86(joaat("SP1_TOTAL_CASH_EARNED"), fParam3);
					break;
				
				case 2:
					func_86(joaat("SP2_TOTAL_CASH_EARNED"), fParam3);
					break;
			}
			break;
...
void func_57(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_59() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_59() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_58(bParam0));
...
var func_63(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
bool func_65(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_59() /*10931*/].f_6175.f_10, bParam0);
}
...
void func_86(int iParam0, void fParam1)
{
	int iVar0;
...
void func_91()
{
	...
	{
		if (func_93(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
int func_109(var uParam0, bool bParam1, bool bParam2, int iParam3)
{
	if (!func_3(&(uParam0->f_666), 7))
	{
		if (!func_3(&(uParam0->f_666), 9))
		{
			...
			if (iParam3 || !INTERIOR::IS_VALID_INTERIOR())
			{
		...
		if (!HUD::DISABLE_FRONTEND_THIS_FRAME())
		{
			...
			{
				if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 216))
				{
...
void func_112(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14)
{
	...
	if (bVar0 > -1)
	{
		Global_1378744.f_1 = 1;
		func_30(3, bVar0);
		Global_1378744.f_2775[bVar0] = iParam0;
		StringCopy(&(Global_1378744.f_2775.f_11[bVar0 /*16*/]), sParam1, 64);
		Global_1378744.f_2775.f_183[bVar0] = iParam3;
		Global_1378744.f_2775.f_172[bVar0] = iParam2;
		Global_1378744.f_2775.f_205[bVar0] = iParam4;
		Global_1378744.f_2775.f_216[bVar0] = iParam5;
		StringCopy(&(Global_1378744.f_2775.f_259[bVar0 /*16*/]), sParam6, 64);
		Global_1378744.f_2775.f_420[bVar0] = iParam7;
		Global_1378744.f_2775.f_453[bVar0] = iParam8;
		Global_1378744.f_2775.f_431[bVar0] = iParam9;
		Global_1378744.f_2775.f_442[bVar0] = iParam10;
		Global_1378744.f_2775.f_464[bVar0] = iParam11;
		Global_1378744.f_2775.f_475[bVar0] = iParam12;
		Global_1378744.f_2775.f_486[bVar0] = iParam13;
		Global_1378744.f_2775.f_497[bVar0] = iParam14;
	}
}
			...
			if (bVar4)
			{
				if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "SET_DATA_SLOT"))
				{
					...
					while (iVar7 < uParam0->f_2[iVar6 /*15*/].f_14)
					{
						...
						{
							bVar3 = MOBILE::GET_MOBILE_PHONE_POSITION(iVar0, fVar1, bVar2);
						}
						else
						{
							bVar3 = MOBILE::SET_MOBILE_PHONE_POSITION(iVar0, fVar1, bVar2);
						}
	...
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
		if (((!VEHICLE::IS_THIS_MODEL_A_QUADBIKE() || !INTERIOR::IS_VALID_INTERIOR()) || (!NETWORK::NETWORK_HAVE_ONLINE_PRIVILEGES() && NETWORK::_NETWORK_HAS_AGE_RESTRICTED_PROFILE())) || Global_1835392.f_2832 != 0)
		{
			...
			if (!unk_0xCE990E643CD9D0E5(uParam1->f_42, true))
			{
				...
				if (unk_0x3030AE9FCF1BC243(&(Global_1835392.f_2780.f_1)))
				{
					if (!func_192(uParam1->f_44))
					{
						if (Global_1835392.f_2780.f_26 > 0)
						{
							...
							func_191(*uParam0, &(Global_1835392.f_2780.f_1), &fVar7, &Var6, Global_1835392.f_2780.f_25, Global_1835392.f_2780.f_26);
						}
						else
						{
							func_191(*uParam0, &(Global_1835392.f_2780.f_1), &fVar7, &(Global_1835392.f_2780.f_9), Global_1835392.f_2780.f_25, -1);
						}
					}
				...
				bVar9 = false;
				unk_0xBE20AB8238688965(&bVar9, 4);
				func_189(*uParam0, &bVar3, bVar9, 1, 1);
				bVar9 = false;
				unk_0xBE20AB8238688965(&bVar9, 5);
				func_189(*uParam0, &bVar3, bVar9, 1, 1);
				bVar9 = false;
				unk_0xBE20AB8238688965(&bVar9, 6);
				func_189(*uParam0, &bVar3, bVar9, 1, 1);
			...
			if (!func_153(uParam1))
			{
				...
				if (!unk_0xCE990E643CD9D0E5(uParam1->f_42, false))
				{
					...
					if (unk_0x3030AE9FCF1BC243(&(Global_1835392.f_2780.f_1)))
					{
						if (!func_192(uParam1->f_44))
						{
							...
							{
								Var6 = { Global_1835392.f_2780.f_9 };
								func_191(*uParam0, &(Global_1835392.f_2780.f_1), &fVar7, &Var6, 1, Global_1835392.f_2780.f_26);
							}
							else
							{
								func_191(*uParam0, &(Global_1835392.f_2780.f_1), &fVar7, &(Global_1835392.f_2780.f_9), Global_1835392.f_2780.f_25, -1);
				...
				if (Global_1835392.f_2825 == -1)
				{
					...
					while (iVar0 < 3)
					{
						if (iVar0 == 0)
						{
							bVar9 = false;
							unk_0xBE20AB8238688965(&bVar9, 4);
							func_189(*uParam0, &bVar3, bVar9, 0, 0);
						}
						else if (iVar0 == 1)
						{
							bVar9 = false;
						...
						bVar9 = false;
						unk_0xBE20AB8238688965(&bVar9, 7);
						func_152(*uParam0, bVar3, bVar9, &Var12);
						bVar3++;
						iVar0++;
					}
					Global_1835392.f_2825 = 1;
				...
				else if (func_150(&(Global_1835392.f_2823), 300, 0))
				{
					...
					while (iVar0 < 3)
					{
						...
						bVar9 = false;
						unk_0xBE20AB8238688965(&bVar9, 7);
						func_152(*uParam0, bVar3, bVar9, &Var13);
						bVar3++;
						iVar0++;
					}
						...
						while (iVar0 < 12)
						{
							...
							else if (Global_1839723[iVar0 /*100*/].f_75 == 2)
							{
								if (!iVar8[1])
								{
									...
									{
										func_189(*uParam0, &bVar3, bVar9, 1, 0);
										bVar14 = true;
									}
									else
									{
							...
							if (func_144(Global_1839723[iVar0 /*100*/].f_32))
							{
								...
								if (!bVar14)
								{
									...
									if (!Global_1835392.f_2780.f_27)
									{
										...
										{
											unk_0xBE20AB8238688965(&bVar9, true);
											if (uParam1->f_246.f_1 == -1)
											{
												bVar4 = true;
												uParam1->f_246.f_1 = iVar0;
												unk_0xBE20AB8238688965(&bVar9, 3);
											}
										}
									}
									if (func_192(uParam1->f_44))
									{
										...
										func_142(*uParam0, bVar3, bVar9, Global_1839723[iVar0 /*100*/].f_59, &Var6, &(Global_1839723[iVar0 /*100*/].f_80));
									...
									{
										func_142(*uParam0, bVar3, bVar9, Global_1839723[iVar0 /*100*/].f_59, &(Global_1839723[iVar0 /*100*/]), &(Global_1839723[iVar0 /*100*/].f_80));
										uParam1->f_246.f_6[iVar0 /*15*/] = bVar3;
										uParam1->f_246.f_6[iVar0 /*15*/].f_1 = bVar9;
										uParam1->f_246.f_6[iVar0 /*15*/].f_2 = { Global_1839723[iVar0 /*100*/].f_32 };
										uParam1->f_246.f_2++;
									...
									if (uVar2[(Global_1839723[iVar0 /*100*/].f_75 - 1)] == 2)
									{
										...
										{
											unk_0xBE20AB8238688965(&bVar9, 2);
											unk_0xBE20AB8238688965(&(uParam1->f_246.f_6[0 /*15*/].f_1), 2);
											func_131(*uParam0, (bVar3 - 1), bVar9);
										}
									}
									bVar3++;
								}
...
int func_129(var uParam0, int iParam1)
{
	...
	if (iParam1 == 188 || iParam1 == 187)
	{
		...
		if (((!PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, iParam1) && !unk_0xB9C0D9B37277621D(2, iParam1)) && (iVar1 < 75 && iVar1 > -75)) || func_150(&(uParam0->f_246.f_3), 250, 0))
		{
			return 1;
		}
	}
	else if ((!PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, iParam1) && !unk_0xB9C0D9B37277621D(2, iParam1)) || func_150(&(uParam0->f_246.f_3), 250, 0))
	{
		return 1;
	}
	return 0;
...
void func_131(int iParam0, bool bParam1, bool bParam2)
{
	...
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(bParam1);
...
void func_136(struct<30> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, void fParam15, bool bParam16, bool bParam17)
{
	struct<4> Var0;
	
	if (fParam15 == 2147483647 || fParam15 == -2147483647)
	{
		bParam16 = false;
	}
	StringCopy(&Var0, "", 16);
	switch (Param0.f_29[iParam14])
	{
		case 5:
			...
			{
				MISC::UPDATE_ONSCREEN_KEYBOARD("NUMBER");
				unk_0x42710E9E08FA375A(fParam15);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
			}
			else
			{
		...
		case 11:
			if (bParam16)
			{
				if (Param0.f_29[iParam14] == 11 && fParam15 < 0)
				{
					fParam15 = (fParam15 * -1);
				}
				if (fParam15 >= 3600000 || fParam15 <= -3600000)
				{
					MISC::UPDATE_ONSCREEN_KEYBOARD("STRING");
					NETWORK::UGC_GET_CACHED_DESCRIPTION(fParam15, 14);
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
				}
				else if (Param0.f_29[iParam14] == 9)
				{
					MISC::UPDATE_ONSCREEN_KEYBOARD("STRING");
					NETWORK::UGC_GET_CACHED_DESCRIPTION(fParam15, 6);
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
				}
				else
				{
					MISC::UPDATE_ONSCREEN_KEYBOARD("STRING");
					NETWORK::UGC_GET_CACHED_DESCRIPTION(fParam15, 2055);
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
				}
			}
			else
		...
		case 6:
			if (bParam16)
			{
				if (fParam15 == 2147483647)
				{
					MISC::UPDATE_ONSCREEN_KEYBOARD("SC_LB_EMPTY");
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
				}
				else if (fParam15 >= 3600000 || fParam15 <= -3600000)
				{
					MISC::UPDATE_ONSCREEN_KEYBOARD("STRING");
					NETWORK::UGC_GET_CACHED_DESCRIPTION(fParam15, 14);
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
		...
		case 3:
			if (bParam17)
			{
				if (STREAMING::IS_MODEL_IN_CDIMAGE(fParam15))
				{
					MISC::UPDATE_ONSCREEN_KEYBOARD("SCLB_VEH_CUST");
					HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(unk_0xBBF5A53C394969AA(fParam15));
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
				}
				else
				{
			...
			else if (STREAMING::IS_MODEL_IN_CDIMAGE(fParam15))
			{
				MISC::UPDATE_ONSCREEN_KEYBOARD(unk_0xBBF5A53C394969AA(fParam15));
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
			}
			else
			{
		...
		case 8:
			if (func_141(fParam15) != 0)
			{
				MISC::UPDATE_ONSCREEN_KEYBOARD(func_138(func_141(fParam15), 0));
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
			}
			else
			{
		...
		case 16:
			if (bParam16)
			{
				...
				if (!MISC::SHOULD_USE_METRIC_MEASUREMENTS())
				{
					...
					{
						fParam15 = SYSTEM::FLOOR(func_135(SYSTEM::TO_FLOAT(fParam15)));
					}
					else
					{
						fParam15 = SYSTEM::FLOOR(func_134(SYSTEM::TO_FLOAT(fParam15)));
					}
				}
				MISC::UPDATE_ONSCREEN_KEYBOARD("NUMBER");
				unk_0x42710E9E08FA375A(fParam15);
...
struct<4> func_137(void fParam0)
{
	struct<4> Var0;
	...
	StringIntConCat(&Var0, fParam0, 16);
	return Var0;
}
...
void func_142(int iParam0, bool bParam1, bool bParam2, void fParam3, bool bParam4, bool bParam5)
{
...
void func_152(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
	unk_0xBE20AB8238688965(&bParam2, 7);
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_SLOT");
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(bParam1);
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(bParam2);
...
int func_168(var uParam0, void fParam1, char* sParam2, int iParam3, var uParam4)
{
	int iVar0;
	struct<13> Var1[1];
	...
	else if (CAM::IS_SCREEN_FADED_OUT(fParam1))
	{
		*uParam0 = 2;
		return 1;
	}
	unk_0xBE347DE2A7F4BBD4(fParam1, &(Var1[0 /*13*/]), 13);
	switch (*uParam0)
	{
		case 0:
...
int func_169(var uParam0)
{
	...
	switch ((*uParam0)[bVar9])
	{
					...
					if (Var1.f_3 > 0)
					{
						...
						if (Var0.f_96 <= 1)
						{
							if (Global_1835392.f_2704[bVar9] < 11)
							{
								if (func_181() && iVar5 == 0)
								{
									func_177(uParam0, &(Global_1835392[bVar9 /*901*/][Global_1835392.f_2704[bVar9] /*75*/]), Var0.f_96);
						...
						while (iVar7 <= (Var1.f_3 - 1))
						{
							...
							if (Global_1835392.f_2704[bVar9] < 11 && Var0.f_96 > 1)
							{
								...
								{
									if (!func_143(&(Global_1835392[bVar9 /*901*/][0 /*75*/].f_32), &Var12))
									{
										func_177(uParam0, &(Global_1835392[bVar9 /*901*/][Global_1835392.f_2704[bVar9] /*75*/]), Var0.f_96);
								...
								{
									if (func_144(Var0) && !func_143(&Var0, &(Global_1835392[bVar9 /*901*/][0 /*75*/].f_32)))
									{
										if (func_143(&Var0, &Var12))
										{
						...
						if (bVar8)
						{
							if (Global_1835392.f_2775[bVar9] == -1 && func_181())
							{
								if (Global_1835392.f_2704[bVar9] >= 1)
								{
									func_177(uParam0, &(Global_1835392[bVar9 /*901*/][Global_1835392.f_2704[bVar9] /*75*/]), Global_1835392[bVar9 /*901*/][(Global_1835392.f_2704[bVar9] - 1) /*75*/].f_59 + 1);
								}
								else
								{
									func_177(uParam0, &(Global_1835392[bVar9 /*901*/][Global_1835392.f_2704[bVar9] /*75*/]), 1);
								}
								Global_1835392.f_2775[bVar9] = Global_1835392.f_2704[bVar9];
								Global_1835392.f_2704[bVar9]++;
							}
		...
		case 3:
			func_170(bVar9, Global_1835013.f_374);
			(*uParam0)[bVar9] = 4;
			break;
...
int func_173()
{
	if (HUD::DISABLE_FRONTEND_THIS_FRAME() && !func_195())
	{
		return 1;
	}
	return 0;
				...
				if (func_183(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &(uParam0->f_113), uParam0->f_113[0 /*66*/], bVar8, 0, 100))
				{
					...
					if (uParam0->f_5 && STATS::_0xA0F93D5465B3094D(&Var1))
					{
						...
						if (Var1.f_3 > 0)
						{
							...
							else if (func_144(Var0) && Global_1835392.f_2704[bVar9] < 11)
							{
						...
						while (iVar6 <= (Var1.f_3 - 1))
						{
							...
							if (Global_1835392.f_2704[bVar9] < 11 && Var0.f_96 > 1)
							{
								...
								{
									if (!func_143(&(Global_1835392[bVar9 /*901*/][0 /*75*/].f_32), &Var10))
									{
										func_177(uParam0, &(Global_1835392[bVar9 /*901*/][Global_1835392.f_2704[bVar9] /*75*/]), Var0.f_96);
...
int func_184(var uParam0)
{
	...
	switch ((*uParam0)[bVar10])
	{
					...
					if (Var2.f_3 > 0)
					{
						...
						if (Var1.f_96 <= 1)
						{
							if (Global_1835392.f_2704[bVar10] < 11)
							{
								if (func_181() && iVar6 == 0)
								{
									func_177(uParam0, &(Global_1835392[bVar10 /*901*/][Global_1835392.f_2704[bVar10] /*75*/]), Var1.f_96);
						...
						while (iVar8 <= (Var2.f_3 - 1))
						{
							...
							if (Global_1835392.f_2704[bVar10] < 11 && Var1.f_96 > 1)
							{
								...
								{
									if (!func_143(&(Global_1835392[bVar10 /*901*/][0 /*75*/].f_32), &Var1))
									{
										func_177(uParam0, &(Global_1835392[bVar10 /*901*/][Global_1835392.f_2704[bVar10] /*75*/]), Var1.f_96);
								...
								{
									if (func_144(Var1) && !func_143(&(Global_1835392[bVar10 /*901*/][0 /*75*/].f_32), &Var1))
									{
										if (func_143(&Var1, &Var0))
										{
						...
						if (bVar9)
						{
							if (Global_1835392.f_2775[bVar10] == -1 && func_181())
							{
								if (Global_1835392.f_2704[bVar10] >= 1)
								{
									func_177(uParam0, &(Global_1835392[bVar10 /*901*/][Global_1835392.f_2704[bVar10] /*75*/]), Global_1835392[bVar10 /*901*/][(Global_1835392.f_2704[bVar10] - 1) /*75*/].f_59 + 1);
								}
								else
								{
									func_177(uParam0, &(Global_1835392[bVar10 /*901*/][Global_1835392.f_2704[bVar10] /*75*/]), 1);
								}
								Global_1835392.f_2775[bVar10] = Global_1835392.f_2704[bVar10];
								Global_1835392.f_2704[bVar10]++;
							}
		...
		case 2:
			func_170(bVar10, Global_1835013.f_374);
			(*uParam0)[bVar10] = 3;
			break;
...
void func_189(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	*bParam1++;
	...
	{
		bVar5 = false;
		unk_0xBE20AB8238688965(&bVar5, 7);
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_SLOT");
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(*bParam1);
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(bVar5);
		if (!NETWORK::NETWORK_SESSION_IS_IN_VOICE_SESSION())
		{
			sVar0 = "SCLB_NOT_ONL";
		}
	...
	else if (bParam3)
	{
		...
		bVar7 = false;
		unk_0xBE20AB8238688965(&bVar7, 7);
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_SLOT");
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(*bParam1);
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(bVar7);
		if (bVar3)
		{
			MISC::UPDATE_ONSCREEN_KEYBOARD(sVar0);
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_KEYBOARD_DISPLAY(&Var2);
...
void func_191(int iParam0, char* sParam1, void fParam2, void fParam3, bool bParam4, void fParam5)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_MULTIPLAYER_TITLE");
	MISC::UPDATE_ONSCREEN_KEYBOARD(sParam1);
	if (!CAM::IS_SCREEN_FADED_OUT(fParam2))
	{
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(fParam2);
	}
	if (iParam5 == -1)
	{
		if (bParam4)
		{
			if (!CAM::IS_SCREEN_FADED_OUT(fParam3))
			{
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_KEYBOARD_DISPLAY(fParam3);
			}
		}
		else if (!CAM::IS_SCREEN_FADED_OUT(fParam3))
		{
			HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(fParam3);
		}
	}
	else
	{
...
{
	unk_0xBE20AB8238688965(&(Global_1377236.f_1047), bParam0);
	switch (bParam0)
	{
		case 5:
			if (iParam1 > -1)
...
int func_204(var uParam0, bool bParam1)
{
	...
	if ((unk_0xDCA0815D900F27F8() && (((bVar1 == 4 || bVar1 == 2) || bVar1 == 1) || bVar1 == 5)) || (!func_210() && NETWORK::NETWORK_SESSION_IS_IN_VOICE_SESSION()))
	{
		...
		else
		{
			...
			if (!unk_0xCE990E643CD9D0E5(*uParam0, false))
			{
				...
				{
					unk_0xBE20AB8238688965(uParam0, false);
				}
			}
	...
	{
		func_207(&(Global_1840924.f_3), func_209(&(Global_1840924.f_3)));
		if ((func_187(&(Global_1840924.f_49)) && !func_150(&(Global_1840924.f_49), 2000, 1)) && !NETWORK::NETWORK_SESSION_IS_IN_VOICE_SESSION())
		{
		...
		else if (!unk_0xCE990E643CD9D0E5(*uParam0, 3))
		{
			if (!unk_0xCE990E643CD9D0E5(*uParam0, true))
			{
				...
				unk_0xBE20AB8238688965(uParam0, true);
				StringCopy(&(Global_1840924.f_3.f_1), "", 64);
				func_205(&(Global_1840924.f_3), 0);
			}
		}
	...
	switch (Global_1835013)
	{
		case 0:
			if (func_221(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &Var3))
			{
				...
				{
					if (!func_220(uParam0->f_44, bVar4))
					{
						if (func_219(uParam0->f_44, 4, bVar4))
						{
...
void func_223(int iParam0, int iParam1, int iParam2, float fParam3, bool bParam4)
{
	...
	Global_1835013.f_142.f_36[bVar0] = iParam2;
...
void func_226(var uParam0, int iParam1, void fParam2, void fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<8> Var0;
	struct<8> Var1;
	int iVar2;
				...
				if (iParam5 > 0 && !func_235())
				{
					...
					if (!CAM::IS_SCREEN_FADED_OUT(sParam3))
					{
						if (iParam5 == 1)
						{
							...
							StringCopy(&(Global_1835392.f_2780.f_9), fParam3, 64);
						}
						else
						{
		...
		case 122:
			switch (iParam4)
			{
				...
				case 8:
					...
					if (!CAM::IS_SCREEN_FADED_OUT(fParam3))
					{
						StringCopy(&(Global_1835392.f_2780.f_1), fParam3, 32);
					}
					else
					{
...
var func_227(struct<8> Param0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	char cVar0[64];
...
int func_236(var uParam0, int iParam1)
{
	...
	{
		if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 201) || uParam0->f_8)
		{
...
void func_237(var uParam0, int iParam1)
{
	...
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(uParam0->f_9);
	DLC::IS_DLC_PRESENT(iParam1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
void func_238(int iParam0)
{
	...
	if (bVar0 < 40)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*iParam0)[1]))
		{
	...
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*iParam0)[0]))
		{
			func_4((*iParam0)[0], "GAME_LOSE_SELF", 1, 4);
		}
	}
	else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*iParam0)[1]))
	{
...
void func_241(var uParam0, void fParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	char* sVar0;
...
void func_246(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)
{
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 228) && iLocal_30 == 0)
			{
				uParam0->f_1 = 1;
			}
			if (iLocal_30 == 0)
			...
			else if (SYSTEM::TIMERA() > NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1250, 2500))
			{
				func_289(&(uParam0->f_422), &(uParam0->f_249));
				func_286(&(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]), &(uParam0->f_243), &(uParam0->f_1), &(uParam0->f_249), 0);
			}
...
void func_247(var uParam0, var uParam1)
{
	...
	while (iLocal_31 < 3 && uParam0->f_1 == 6)
	{
		...
		else if (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_24)
		{
			if (bLocal_148)
			{
				if (MISC::IS_BIT_SET(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]))
				{
					PED::GET_PED_BONE_INDEX(&(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]));
				}
			}
			else
			{
			...
			if (bLocal_148)
			{
				if (iLocal_150)
				{
					...
					ENTITY::DETACH_ENTITY(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_17, 0, 1);
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_23 = 1;
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_24 = 0;
				}
			}
				...
				if (iLocal_150)
				{
					...
					while (iVar2 < iLocal_31 + 1)
					{
						if (!uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_23)
						{
							...
							if (MISC::IS_BIT_SET(uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/]))
							{
							...
							ENTITY::DETACH_ENTITY(uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/], uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_17, 0, 1);
	...
	switch (uParam0->f_2)
	{
		...
		case 1:
			if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 190))
			{
				...
				Var0 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_5[iLocal_30 /*79*/][iLocal_163 /*26*/], 1) };
				func_50(Var0);
			}
		...
		case 2:
			if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 201) || (iLocal_149 && bLocal_148))
			{
				iLocal_139 = 1;
			}
			if ((PAD::IS_DISABLED_CONTROL_PRESSED(2, 189) || PAD::IS_DISABLED_CONTROL_PRESSED(2, 190)) && uParam0->f_248 == 1)
			{
				Var0 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_5[iLocal_30 /*79*/][iLocal_163 /*26*/], 1) };
				func_52(Var0, 1, 0);
				uParam0->f_2 = 1;
			...
			if (iLocal_139 || SYSTEM::TIMERB() > 2000)
			{
				...
				if (uParam0->f_425[iLocal_30] != uParam0->f_422[iLocal_30])
				{
					...
					AUDIO::SET_VARIABLE_ON_SOUND(-1, "DARTS_SCOREBOARD_MASTER", uParam0->f_243.f_1, 0, 0, 0, 0);
				}
...
int func_250(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	...
	bVar2 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 100);
	if (bVar2 < 85)
	{
		...
		else if (unk_0xCE990E643CD9D0E5(bVar0, 3))
		{
			if (bVar1 < 50)
			{
...
int func_251(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (bVar2 < 75)
	{
		...
		else if (unk_0xCE990E643CD9D0E5(bVar0, 2))
		{
			...
			else if (bVar1 < 68 && !MISC::IS_BIT_SET(func_498()))
			{
				func_4(*uParam1, "DARTS_PLAYING_POORLY", 0, 4);
			}
			else if (bVar1 < 86)
...
void func_253(char* sParam0, void fParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_256(char* sParam0, void fParam1, void fParam2, int iParam3, int iParam4)
{
	iParam4 = iParam4;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
	unk_0x42710E9E08FA375A(iParam1);
...
void func_270(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		AUDIO::SET_VARIABLE_ON_SOUND(-1, "DARTS_HIT_DART_MASTER", uParam1->f_1, 0, 0, 0, 0);
	}
	if (fVar0 < 0.009f)
	{
		AUDIO::SET_VARIABLE_ON_SOUND(-1, "DARTS_HIT_BULLSEYE_MASTER", uParam1->f_1, 0, 0, 0, 0);
		uParam0->f_20 = 50;
	}
	else if (fVar0 < 0.021f)
	{
		AUDIO::SET_VARIABLE_ON_SOUND(-1, "DARTS_HIT_BOARD_MASTER", uParam1->f_1, 0, 0, 0, 0);
		uParam0->f_20 = 25;
	}
	else if (fVar0 > 0.3f)
	{
		AUDIO::SET_VARIABLE_ON_SOUND(-1, "DARTS_HIT_WALL_MASTER", uParam1->f_1, 0, 0, 0, 0);
		uParam0->f_20 = 0;
	}
	...
	else
	{
		...
		{
			uParam0->f_21 = 3;
			AUDIO::SET_VARIABLE_ON_SOUND(-1, "DARTS_SCORE_TRIPLE_MASTER", uParam1->f_1, 0, 0, 0, 0);
		}
		else if (fVar0 > 0.2132f && fVar0 < 0.226f)
		{
			uParam0->f_21 = 2;
			AUDIO::SET_VARIABLE_ON_SOUND(-1, "DARTS_SCORE_DOUBLE_MASTER", uParam1->f_1, 0, 0, 0, 0);
		}
		else
		{
			uParam0->f_21 = 1;
		...
		while (iVar4 < 21)
		{
			if (fVar1 >= (fVar2 - 9f) && fVar1 < (fVar2 + 9f))
			{
				...
				{
					AUDIO::SET_VARIABLE_ON_SOUND(-1, "DARTS_HIT_WIRE_MASTER", uParam1->f_1, 0, 0, 0, 0);
				}
...
int func_273(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	ENTITY::DETACH_ENTITY(*uParam0, uParam0->f_17, 0, 1);
...
void func_286(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	{
		bVar5 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 100);
		bVar6 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(func_288(uParam3), 150);
		if (uParam3->f_2 > 140)
		{
			fVar0 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-35f, 35f);
		}
		else if (bVar5 < bVar6 && uParam3->f_4 == 2)
		{
			fVar0 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-80f, 80f);
		}
		else if (bVar5 < bVar6 && uParam3->f_2 > -140)
		{
	...
	else
	{
		...
		*uParam2 = 3;
		ENTITY::GET_ENTITY_ALPHA(-1, "DARTS_THROW_DART_MASTER", *uParam0, 0, 0, 0);
	}
}
...
int func_293(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	...
	switch (iParam6)
	{
		case 0:
			...
			{
				if (!(PAD::IS_DISABLED_CONTROL_PRESSED(2, 223) && iLocal_56) && !bParam4)
				{
					iLocal_53 = 1;
					iLocal_54 = 1;
					if (!iLocal_55)
...
int func_294(var uParam0)
{
	...
	iVar1 = SYSTEM::TIMERA(2, 220);
	iVar2 = SYSTEM::TIMERA(2, 221);
	fLocal_91 = SYSTEM::ROUND(iVar2);
	switch (iLocal_90)
	{
		case 0:
			if (fLocal_91 > 120)
		...
		case 1:
			...
			else if ((fLocal_91 < 120 && fLocal_91 > -120) && (MISC::GET_GAME_TIMER() - iLocal_92) > 500)
			{
				iLocal_90 = 0;
			}
			else if (fLocal_91 < -100)
			{
				iLocal_93 = MISC::GET_GAME_TIMER();
				if ((iLocal_93 - iLocal_92) < 500)
				{
					fLocal_96 = SYSTEM::ROUND(iVar1);
					fLocal_94 = (iLocal_93 - iLocal_92);
					iLocal_90 = 2;
				}
			}
			break;
		...
		case 2:
			if (fLocal_94 > fLocal_95)
			{
				if (fLocal_94 > 100 && fLocal_94 < 150)
				{
					fLocal_99 = 0.066477f;
				...
				{
					fLocal_98 = (SYSTEM::TO_FLOAT(fLocal_95) / SYSTEM::TO_FLOAT(fLocal_94));
			...
			if (fLocal_96 > 7)
			{
				fLocal_100 = (SYSTEM::TO_FLOAT(fLocal_96) / fLocal_105);
				fLocal_101 = (fLocal_103 * fLocal_100);
				uParam0->f_8 = (uParam0->f_8 + fLocal_101);
			}
			else if (fLocal_96 < -7)
			{
				fLocal_100 = (SYSTEM::TO_FLOAT(fLocal_96) / fLocal_104);
				fLocal_101 = (fLocal_103 * fLocal_100);
				uParam0->f_8 = (uParam0->f_8 - fLocal_101);
			}
			else
...
void func_299(var uParam0, int iParam1)
{
	...
	fVar5 = SYSTEM::TIMERA(2, 220);
	fVar6 = SYSTEM::TIMERA(2, 221);
	if (HUD::_0x5BFF36D6ED83E0AE(2))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(fVar5) > ENTITY::IS_ENTITY_PLAYING_ANIM(fVar3) || ENTITY::IS_ENTITY_PLAYING_ANIM(fVar6) > ENTITY::IS_ENTITY_PLAYING_ANIM(fVar4))
		{
			fVar3 = fVar5;
			fVar4 = fVar6;
			bVar7 = false;
		...
		else
		{
			...
			if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 227))
			{
...
void func_300()
{
	...
	if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 229))
	{
		if (bLocal_49)
		{
		...
		{
			iLocal_50 = 1;
			if (!unk_0xCE990E643CD9D0E5(Global_111819, true))
			{
				func_418("DARTS_SHT_USE", -1);
				unk_0xBE20AB8238688965(&Global_111819, true);
			}
		}
	}
	else if (bLocal_49)
...
int func_305(int iParam0, var uParam1, var uParam2, var uParam3)
{
	...
	switch (*uParam2)
	{
		...
		case 1:
			if (SYSTEM::TIMERB() > 3000 || PAD::IS_DISABLED_CONTROL_PRESSED(2, 201))
			{
				func_306();
				*uParam2 = 0;
				return 1;
...
int func_312(var uParam0)
{
	...
	{
		case 0:
			if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 228))
			{
				func_319(1);
				*uParam0 = 1;
			}
...
void func_313(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)
{
	...
	if ((HUD::_0x5BFF36D6ED83E0AE(2) && bParam2) && !uParam0->f_28)
	{
		uParam0->f_14 = Var6.x;
	...
	if (HUD::_0x5BFF36D6ED83E0AE(0) && bParam1)
	{
		if (uParam0->f_28)
		{
	...
	if (bParam1)
	{
		if (HUD::_0x5BFF36D6ED83E0AE(0))
		{
			...
			if (PAD::IS_CONTROL_JUST_PRESSED(0, iVar7))
			{
				uParam0->f_17 = (uParam0->f_17 - 5f);
				uParam0->f_27 = MISC::GET_GAME_TIMER() + 4000;
				uParam0->f_28 = 0;
			}
			else if (PAD::IS_CONTROL_JUST_PRESSED(0, iVar8))
			{
				uParam0->f_17 = (uParam0->f_17 + 5f);
				uParam0->f_27 = MISC::GET_GAME_TIMER() + 4000;
				uParam0->f_28 = 0;
...
void func_323(var uParam0)
{
	...
	{
		if ((PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 201) || PAD::IS_DISABLED_CONTROL_PRESSED(2, 223)) && iLocal_54)
		{
			*uParam0 = 6;
		}
	}
...
int func_325(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 < 8)
	{
		...
		unk_0xBE20AB8238688965(&(uParam0->f_2[iVar0 /*15*/].f_12), false);
		if (iParam4 == 1)
		{
			unk_0xBE20AB8238688965(&(uParam0->f_2[iVar0 /*15*/].f_13), false);
		}
...
void func_327(var uParam0)
{
	...
	if (!iLocal_54)
	{
		if (!PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 201) && !PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 202))
		{
			iLocal_54 = 1;
		}
		else
	...
	if (*uParam0 != 13)
	{
		...
		if (STATS::STAT_GET_MASKED_INT(2, 235) || HUD::_0x66E7CB63C97B7D20(2, 235))
		{
			if (!bLocal_147)
			{
				*uParam0 = 14;
...
int func_344(var uParam0, var uParam1, var uParam2)
{
	...
	if (!func_3(&(uParam0->f_666), 7))
	{
		...
		if (func_392(&(uParam0->f_633)) || func_391(&(uParam0->f_633), uParam0->f_660, iVar1))
		{
			...
			DATAFILE::UGC_UPDATE_CONTENT(-1, "NAV_LEFT_RIGHT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
			func_377(uParam0);
		}
		...
		if ((PAD::IS_DISABLED_CONTROL_PRESSED(2, 201) || iVar1 == 1) && uParam0->f_660 == 2)
		{
			*uParam1 = func_373(uParam0->f_662 + 1, 1);
			*uParam2 = func_373(uParam0->f_664 + 1, 0);
			DATAFILE::UGC_UPDATE_CONTENT(-1, "OK", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
			return 1;
		}
		func_347(1, -1, 1, 0, 1, -1082130432, 0, 0, -1);
		if (STATS::STAT_GET_MASKED_INT(2, 202) || func_346())
		{
			func_345(0, 0);
			func_331(&(uParam0->f_666), 8, 0);
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_22550.f_5728)
		{
			...
			if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Global_22550.f_4690)) != 0 && Global_22550.f_4766 != -1)
			{
				...
				HUD::GET_HUD_COLOUR(2, &iVar1, &iVar2, &iVar3, &fVar4);
				func_365(Global_22547, (fVar49 - 0.00277776f), fParam5, 0.00277776f, iVar1, iVar2, iVar3, fVar4);
				if (Global_22550.f_8407)
				{
					iVar1 = Global_22550.f_8403;
					iVar2 = Global_22550.f_8404;
					iVar3 = Global_22550.f_8405;
					fVar4 = Global_22550.f_8406;
				}
				else
				{
					HUD::GET_HUD_COLOUR(140, &iVar1, &iVar2, &iVar3, &fVar4);
				}
				GRAPHICS::DRAW_SPRITE("CommonMenu", "Gradient_Bgd", (Global_22547 + (fParam5 * 0.5f)), ((fVar49 + ((((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))) * 0.5f)) - 0.00138888f), fParam5, (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))), 0f, iVar1, iVar2, iVar3, fVar4, false);
				func_361(fVar40);
				...
				if (Global_22550.f_4768 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_24(Global_22550.f_4768), func_21(Global_22550.f_4768, 1), ((Global_22547 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false);
				}
			...
			if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Global_4269680.f_21)) != 0 && Global_4269680.f_65 != -1)
			{
				...
				{
					func_18(Global_4269680.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_360(Global_4269680.f_67, 1, &iVar45, &iVar46, &iVar47, &fVar48);
					GRAPHICS::DRAW_SPRITE(func_24(Global_4269680.f_67), func_21(Global_4269680.f_67, 1), ((Global_22547 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, fVar48, false);
				}
				fVar49 = (fVar49 + (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
			...
			func_355(fVar58, iParam1, iParam8, 0, 0, 0, bParam4, 1, 0);
			PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(76, 84);
			GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
		}
		if (iVar5 == 1 || !Global_22550.f_5728)
								...
								if (bVar33)
								{
									...
									if (bVar52)
									{
										if (func_18(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											{
												func_360(26, 1, &iVar45, &iVar46, &iVar47, &fVar48);
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_24(26), func_21(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, fVar48, false);
												}
											}
										}
										if (func_18(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											{
												func_360(27, 1, &iVar45, &iVar46, &iVar47, &fVar48);
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_24(27), func_21(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, fVar48, false);
												}
											}
										}
									}
										...
										else if (Global_22550.f_2124[iVar24 /*5*/][iVar14] == 4)
										{
											if ((Global_22550.f_4433[(iVar22 + iVar28)] == 2 || Global_22550.f_4433[(iVar22 + iVar28)] == 51) || Global_22550.f_4433[(iVar22 + iVar28)] == 61)
											{
												if (func_18(Global_22550.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													{
														func_360(Global_22550.f_4433[(iVar22 + iVar28)], bVar32, &iVar45, &iVar46, &iVar47, &fVar48);
														if (iVar5 == 1)
														{
															if (Global_22550.f_5083[bVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_22550.f_4433[(iVar22 + iVar28)]), func_21(Global_22550.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, fVar48, false);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_22550.f_4433[(iVar22 + iVar28)]), func_21(Global_22550.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, fVar48, false);
															}
														}
									...
									if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Global_22550.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_351() && INTERIOR::GET_INTERIOR_AT_COORDS(joaat("fm_mission_creator")) > 0)
											{
												if (bVar8 == 0)
												{
											...
											if ((Global_22550.f_4433[(iVar22 + iVar14)] != 2 && Global_22550.f_4433[(iVar22 + iVar14)] != 51) && Global_22550.f_4433[(iVar22 + iVar14)] != 61)
											{
												if (func_18(Global_22550.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														...
														{
															func_360(Global_22550.f_4433[(iVar22 + iVar14)], bVar32, &iVar45, &iVar46, &iVar47, &fVar48);
															if (Global_22550.f_4433[(iVar22 + iVar14)] == 30)
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_22550.f_4433[(iVar22 + iVar14)]), func_21(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), (Global_22547 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, fVar48, false);
															}
															else if (Global_22550.f_5083[bVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_22550.f_4433[(iVar22 + iVar14)]), func_21(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, fVar48, false);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_22550.f_4433[(iVar22 + iVar14)]), func_21(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, fVar48, false);
															}
														}
													}
								...
								if (bVar33)
								{
									if (func_18(Global_22550.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											...
											{
												func_360(Global_22550.f_4433[iVar22], bVar32, &iVar45, &iVar46, &iVar47, &fVar48);
												GRAPHICS::DRAW_SPRITE(func_24(Global_22550.f_4433[iVar22]), func_21(Global_22550.f_4433[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_348(Global_22550.f_4433[iVar22])), (fVar37 * func_348(Global_22550.f_4433[iVar22])), 0f, iVar45, iVar46, iVar47, fVar48, false);
											}
										}
									}
								}
...
void func_349(char* sParam0, float fParam1, char* sParam2, int iParam3, int iParam4)
{
...
void func_350(char* sParam0, float fParam1, char* sParam2, void fParam3, int iParam4)
{
	NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(sParam2);
	unk_0x42710E9E08FA375A(iParam3);
...
void func_355(void fParam0, int iParam1, void fParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_22550.f_4769 != 0)
	{
		if (PAD::_0x6CD79468A1E595C6(2))
		{
			...
			while (iVar1 < Global_22550.f_4769)
			{
				...
				{
					StringCopy(&(Global_22550.f_4771[iVar1 /*16*/]), MOBILE::GET_MOBILE_PHONE_POSITION(2, Global_22550.f_5026[iVar1], true), 64);
				}
				else if (Global_22550.f_5039[iVar1] != 32)
				{
					StringCopy(&(Global_22550.f_4771[iVar1 /*16*/]), MOBILE::SET_MOBILE_PHONE_POSITION(2.802597E-45f, Global_22550.f_5039[iVar1], true), 64);
				}
				iVar1++;
			}
			Global_22550.f_4770 = 0;
		...
		if (!Global_22550.f_4770)
		{
			...
			while (iVar1 < Global_22550.f_4769)
			{
				if (AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Global_22550.f_4964[iVar1 /*4*/])) != AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("PREV"))
				{
					...
					func_13(&(Global_22550.f_4771[bVar1 /*16*/]));
					iVar2 = bVar1 + 1;
					...
					{
						func_12(&(Global_22550.f_4964[bVar1 /*4*/]));
					}
					else
					{
		...
		while (bVar1 < Global_22550.f_4769)
		{
			if (Global_22550.f_5013[bVar1] != -1)
			{
				if (iParam2 > 0)
				{
					...
					{
						unk_0x42710E9E08FA375A(fParam2);
					}
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
					GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				}
		...
		if (Global_4269680.f_20 != -1)
		{
			if (fParam2 > 0)
			{
				...
				if (bParam5)
				{
					NETWORK::UGC_GET_CACHED_DESCRIPTION(fParam2, 70);
				}
				else
				{
					unk_0x42710E9E08FA375A(fParam2);
...
void func_362(char* sParam0, float fParam1, char* sParam2, void fParam3, void fParam4)
{
	NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(sParam2);
...
float func_363(bool bParam0, void fParam1, void fParam2)
{
...
void func_365(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, void fParam7)
{
...
void func_366(int iParam0, void fParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (!CAM::IS_SCREEN_FADED_OUT(sParam1) && !unk_0x3030AE9FCF1BC243(fParam1))
	{
	}
...
int func_370(bool bParam0, bool bParam1)
{
	...
	if ((((((((!GRAPHICS::DRAW_SCALEFORM_MOVIE() || (func_372(8, -1) && func_371() != 65)) || (GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN() != 0 && !bParam1)) || (LOCALIZATION::GET_CURRENT_LANGUAGE() && !bParam0)) || NETWORK::IS_COMMERCE_STORE_OPEN()) || Global_77093) || Global_22550.f_8416) || CAM::IS_SCREEN_FADED_IN()) || Global_99007.f_1425)
	{
		return 0;
	}
	return 1;
...
int func_376(int iParam0)
{
	...
	if (!HUD::_0x5BFF36D6ED83E0AE(2))
	{
		fVar0 = SYSTEM::TIMERA(2, 218);
	}
	if ((fVar0 > 0.8f || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 190)) || unk_0xB9C0D9B37277621D(2, 190))
	{
		if (!func_420(iParam0))
		{
			func_375(iParam0);
...
void func_378(int iParam0, char* sParam1, int iParam2, bool bParam3)
{
	...
	sVar0 = MOBILE::GET_MOBILE_PHONE_POSITION(2, iParam0, true);
...
float func_382(void fParam0, int iParam1)
{
	if (!unk_0x3030AE9FCF1BC243(sParam0))
	{
	}
...
float func_383(bool bParam0, void fParam1)
{
	if (!unk_0x3030AE9FCF1BC243(bParam0))
	{
		return 0f;
	}
...
int func_392(int iParam0)
{
	...
	if (fVar0 < -0.8f || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 189))
	{
		if (!func_420(iParam0))
		{
			func_375(iParam0);
...
int func_393(int iParam0)
{
	...
	if (!HUD::_0x5BFF36D6ED83E0AE(2))
	{
		fVar0 = SYSTEM::TIMERA(2, 219);
	}
	if (fVar0 > 0.8f || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 187))
	{
		if (!func_420(iParam0))
		{
			func_375(iParam0);
...
int func_394(int iParam0)
{
	...
	if (fVar0 < -0.8f || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 188))
	{
		if (!func_420(iParam0))
		{
			func_375(iParam0);
...
int func_407(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5)
{
	...
	if (PED::REMOVE_SCENARIO_BLOCKING_AREA() && *iParam0 != 8)
	{
		*iParam0 = 8;
	}
	switch (*iParam0)
			...
			switch (iLocal_31)
			{
				...
				case 1:
					...
					if (func_423(iParam5) > 5f)
					{
						func_435(iParam5);
						unk_0xD289B55B6AADBA10(1);
						DATAFILE::UGC_UPDATE_CONTENT(-1, "CAM_PAN_DARTS", "HUD_MINI_GAME_SOUNDSET", 1);
...
void func_411(var uParam0, void fParam1, void fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	char* sVar0;
...
int func_432(var uParam0)
{
	...
	if (MISC::IS_BIT_SET(iVar0))
	{
		if (!func_433(iVar0))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && ENTITY::IS_ENTITY_AT_ENTITY(iVar0, unk_0x9B0761B4C3EB8BC7(), Local_137, false, true, 0))
			{
				...
				ENTITY::SET_ENTITY_COORDS(iVar0, 1);
...
void func_437(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
	(*uParam0)[iParam1 /*10*/] = iParam2;
	StringCopy(&((uParam0[iParam1 /*10*/])->f_1), bParam3, 24);
...
void func_439(float fParam0, struct<4> Param1, var uParam2, var uParam3, int* iParam4, var uParam5)
{
	...
	if (MISC::IS_BIT_SET(func_498()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_498()))
	{
		PED::REMOVE_PED_FROM_GROUP(func_498());
	}
	else
	{
		if (MISC::IS_BIT_SET(uParam5->f_5) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uParam5->f_5))
		{
		...
		{
			bVar0 = PED::IS_PED_IN_ANY_VEHICLE(iLocal_138[1], "Darts_name");
			if (954610991 == bVar0)
			{
				bLocal_220 = func_445("RAYMOND");
				iLocal_221 = 954610991;
			}
			else if (94453331 == bVar0)
			{
				bLocal_220 = func_445("JOHAN");
				iLocal_221 = 94453331;
			}
			else if (1891555423 == bVar0)
			{
				bLocal_220 = func_445("STAN");
				iLocal_221 = 1891555423;
			}
			else if (-1067630349 == bVar0)
			{
				bLocal_220 = func_445("VINCE");
				iLocal_221 = -1067630349;
			}
			else if (885327384 == bVar0)
			{
				bLocal_220 = func_445("KRISTY");
				iLocal_221 = 885327384;
			}
			else if (-1791000994 == bVar0)
			{
				bLocal_220 = func_445("MARLENE");
				iLocal_221 = -1791000994;
			}
			else if (1954368234 == bVar0)
			{
				bLocal_220 = func_445("LORIE");
				iLocal_221 = 1954368234;
			}
			else if (-863218904 == bVar0)
			{
				bLocal_220 = func_445("SHELLEY");
				iLocal_221 = -863218904;
			}
	...
	fVar1 = MISC::GET_MODEL_DIMENSIONS(iLocal_138[1]);
	func_440(fVar1);
...
int func_441(int* iParam0)
{
	...
	iVar0 = 0;
	while (iVar0 < PED::GET_PED_NEARBY_PEDS(unk_0x9B0761B4C3EB8BC7(), iParam0, -1))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY((*iParam0)[iVar0]))
		{
			if ((((((MISC::GET_MODEL_DIMENSIONS((*iParam0)[iVar0]) == joaat("a_f_m_salton_01") || MISC::GET_MODEL_DIMENSIONS((*iParam0)[iVar0]) == joaat("a_f_o_salton_01")) || MISC::GET_MODEL_DIMENSIONS((*iParam0)[iVar0]) == joaat("a_m_y_vinewood_01")) || MISC::GET_MODEL_DIMENSIONS((*iParam0)[iVar0]) == joaat("a_m_y_stlat_01")) || MISC::GET_MODEL_DIMENSIONS((*iParam0)[iVar0]) == joaat("a_m_y_vinewood_04")) || MISC::GET_MODEL_DIMENSIONS((*iParam0)[iVar0]) == joaat("a_m_y_stwhi_02")) || MISC::GET_MODEL_DIMENSIONS((*iParam0)[iVar0]) == joaat("a_m_y_vinewood_03"))
			{
...
char* func_445(char* sParam0)
{
	...
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "MICHAEL"))
		{
			return "??????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "FRANKLIN"))
		{
			return "????????????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "TREVOR"))
		{
			return "????????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "LAMAR"))
		{
			return "??????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "JIMMY"))
		{
			return "????????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "KRISTY"))
		{
			return "????????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "MARLENE"))
		{
			return "????????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "LORIE"))
		{
			return "????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "SHELLEY"))
		{
			return "??????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "RAYMOND"))
		{
			return "??????????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "JOHAN"))
		{
			return "??????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "STAN"))
		{
			return "????????";
		}
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(sParam0, "VINCE"))
		{
			return "????????";
		}
	}
...
void func_446(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	if (MISC::IS_BIT_SET(*uParam0))
	{
		uParam0->f_4 = ENTITY::IS_ENTITY_IN_WATER(*uParam0);
	}
	if (!bParam3)
	{
...
int func_449(var uParam0, var uParam1)
{
	...
	if ((((((((((((!ENTITY::DOES_ENTITY_EXIST(iLocal_28) || !ENTITY::DOES_ENTITY_EXIST(iLocal_29)) || !ENTITY::DOES_ENTITY_EXIST(iLocal_37)) || !ENTITY::DOES_ENTITY_EXIST(iLocal_172)) || !GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0)) || !GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam1->f_645)) || !GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam1->f_57)) || !GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam1->f_62)) || !HUD::REQUEST_ADDITIONAL_TEXT_FOR_DLC(3)) || !GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("Darts")) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_222)) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_223)) || !func_450(0, -1, 0))
	{
		return 0;
	}
	return 1;
...
void func_452(var uParam0, var uParam1)
{
	...
	*uParam0 = unk_0x5DEA4192B46CB99B("darts_scoreboard");
	...
	HUD::HAS_ADDITIONAL_TEXT_LOADED("DARTS", 3);
}
...
void func_477(var uParam0, int iParam1)
{
	...
	if (!Global_77101)
	{
		if (!PLAYER::IS_PLAYER_DEAD(PLAYER::GET_PLAYER_INDEX()))
		{
			if (!Global_77102)
			{
				if (PED::REMOVE_SCENARIO_BLOCKING_AREA() && !func_472(0))
				{
...
{
	if (MISC::IS_BIT_SET(*uParam0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(*uParam0))
	{
		TASK::CLEAR_SEQUENCE_TASK(&iLocal_173);
		TASK::OPEN_SEQUENCE_TASK(&iLocal_173);
		...
		TASK::CLOSE_SEQUENCE_TASK(iLocal_173);
		AUDIO::STOP_SCRIPTED_CONVERSATION(*uParam0, iLocal_173);
...
void func_485()
{
	if (MISC::IS_BIT_SET(iLocal_36))
	{
		PED::GET_PED_BONE_INDEX(&iLocal_36);
	}
}
...
void func_486(var uParam0)
{
	...
	if (MISC::IS_BIT_SET(iVar0))
	{
		if (!func_433(iVar0))
		{
			...
			ENTITY::SET_ENTITY_COORDS(iVar0, 0);
		}
	}
}
...
{
	if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_498()))
	{
		return;
	}
	if (bParam1)
	{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_497()))
		{
