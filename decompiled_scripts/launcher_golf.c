...
void __EntryFunction__()
{
	...
	if (unk_0x7B70881748D166CD(unk_0x02406178CDC27728()) > 1 && !func_88(uLocal_66, 4194304))
	{
		if (iLocal_77 != 263)
		{
		...
		if (unk_0xAE06B9E39EBDE049(uLocal_61) && !unk_0xA59F96B50B97E63C(iLocal_61, 0))
		{
			...
			switch (iLocal_67)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_74(3) && !Global_98989)
						{
							...
							{
								if ((!func_88(uLocal_66, 1) || !unk_0xAE06B9E39EBDE049(func_73())) && !Global_98989)
								{
									func_81(10);
									break;
								}
						...
						if (bVar2)
						{
							if (unk_0x47DBF174A0CB9D55(iLocal_61, 0))
							{
								if (!unk_0xC2169C00B643278B(unk_0xA5D5B1042E8F47BD(iLocal_61, 0), ScriptParam_93.f_1[0 /*3*/], fLocal_85, fLocal_85, 20f, 0, 0, iLocal_75))
								{
									bVar2 = false;
								}
							}
							else if (!unk_0xC2169C00B643278B(iLocal_61, ScriptParam_93.f_1[0 /*3*/], fLocal_85, fLocal_85, 2f, 0, 1, iLocal_75))
							{
								bVar2 = false;
							}
							if (!unk_0xC2169C00B643278B(iLocal_61, ScriptParam_93.f_1[0 /*3*/], fLocal_85, fLocal_85, 2f, 0, 1, 0))
							{
								func_60(&uLocal_66, 128);
								bVar2 = false;
							}
							...
							if (bVar2)
							{
								...
								if (func_44(uLocal_62))
								{
									...
									else if (!func_88(uLocal_66, 2048) || !unk_0xDABD547F0DF2906C())
									{
										func_41(&iLocal_68);
				...
				case 6:
					...
					if (func_88(uLocal_66, 2097152))
					{
						if (!func_74(3) && !unk_0x7FD2BDF03806FD9D(iLocal_50))
						{
							func_81(10);
						}
					}
...
void func_23()
{
	...
	if (unk_0x3BC72261A2457EAF(-1370.625f, 56.1227f, 52.7033f, 100f, 1, 1, &uVar0, 0, 0, -1))
	{
		...
		{
			iVar2 = unk_0x3214CDFE45D11916(iVar0, &uVar1, -1);
		...
		while (iVar3 < iVar2)
		{
			...
			{
				unk_0x9B94F6169B0DAEFD(uVar1[iVar3]);
			}
			iVar3++;
		}
	}
...
void func_37()
{
	if (unk_0xC2169C00B643278B(iLocal_61, Local_64, fLocal_85, fLocal_85, 2f, 0, 1, iLocal_75))
	{
...
void func_89()
{
	...
	{
		iLocal_88 = func_91(unk_0xAE06B9E39EBDE049(func_73()));
