		...
		else if (Var0 == 11)
		{
			if (func_391(Var0.f_28[0]))
			{
				...
				if (func_371(Var0.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					...
					{
						unk_0x9DC06E2A59C5AEBB(&uLocal_227);
						...
						unk_0x19F29730874AD6F1(uLocal_227);
						unk_0x9B6EC2CECE1010EF(Var0.f_28[0], uLocal_227);
					}
					else
					{
	...
	if (func_391(iParam0->f_28[0]))
	{
		switch (iLocal_232)
		{
			...
			case 1:
				...
				{
					unk_0x3C1B180EE30D36EF(iParam0->f_28[0], Local_234[iLocal_233 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
...
void func_370()
{
	unk_0x830F007E19C63E14(uLocal_228, "SET_COLOUR");
	...
	unk_0x830F007E19C63E14(uLocal_228, "SET_DISTANCE");
	unk_0x49B9B8101B158AEE(10f);
	unk_0xE1FDD153F5858534();
	unk_0xCA1F114B668562E5(uLocal_229);
	unk_0xE6A03BA84586E67B(uLocal_228, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	if ((unk_0x578C4EF320340AF7() - iLocal_230) > 1250)
	{
		unk_0x057194D526464DC0(uLocal_231, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
...
void func_431()
{
	uLocal_228 = unk_0x5DEA4192B46CB99B("digiscanner");
	while (!unk_0x95EF219D38B20CFF(uLocal_228))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (unk_0xA9A353D835A7867C("digiscanner"))
	{
		uLocal_229 = unk_0x2BC38EC678978375("digiscanner");
	}
...
int func_437(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			unk_0xDE8F8016287F771F("gang", &uLocal_54);
			unk_0xD3D9D7C84656DAE5(uParam0->f_28[0], uLocal_54);
			unk_0xD3D9D7C84656DAE5(uParam0->f_28[1], uLocal_54);
			unk_0xD3D9D7C84656DAE5(uParam0->f_28[2], uLocal_54);
			unk_0xD3D9D7C84656DAE5(uParam0->f_28[3], uLocal_54);
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_28[1]))
			{
				...
				{
					unk_0xD3D9D7C84656DAE5(uParam0->f_28[1], uVar3);
...
void func_478(int iParam0, bool bParam1)
{
	...
	if (unk_0x8F678487EEBD8CE4(uLocal_226))
	{
		unk_0x93370FA10F15BE44(&uLocal_226);
	}
	if (iLocal_56 != -1)
	{
