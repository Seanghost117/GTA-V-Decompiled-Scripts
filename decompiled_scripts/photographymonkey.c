...
void func_106()
{
	if (bLocal_58)
	{
		if (unk_0x95EF219D38B20CFF(uLocal_57))
		{
			unk_0xE6A03BA84586E67B(uLocal_57, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
		}
		switch (iLocal_56)
		{
			case 0:
			...
			case 1:
				if (iLocal_60 < unk_0x578C4EF320340AF7())
				{
					if (!func_112())
					{
						uLocal_57 = unk_0x5DEA4192B46CB99B("MIDSIZED_MESSAGE");
			...
			case 2:
				if (unk_0x95EF219D38B20CFF(uLocal_57) || iLocal_60 < unk_0x578C4EF320340AF7())
				{
					if (iLocal_60 < unk_0x578C4EF320340AF7())
					{
						bLocal_58 = false;
			...
			case 3:
				unk_0x830F007E19C63E14(uLocal_57, "SHOW_BRIDGES_KNIVES_PROGRESS");
				func_111("PM_TITLE");
			...
			case 4:
				...
				{
					unk_0x830F007E19C63E14(uLocal_57, "SHARD_ANIM_OUT");
			...
			case 6:
				unk_0x2E352DDBBF674246(&uLocal_57);
				if (func_105())
				{
