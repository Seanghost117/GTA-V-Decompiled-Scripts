				...
				case 1:
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
					{
						...
						switch (iLocal_47)
						{
							...
							case 1:
								if ((!func_133(iLocal_52[0], &iLocal_102, &uLocal_101, bLocal_100, iLocal_103, 7f, 0) && !func_133(iLocal_52[1], &iLocal_102, &uLocal_101, bLocal_100, iLocal_103, 7f, 0)) && !func_132())
								{
									switch (iLocal_48)
									{
										case 0:
											func_131();
											if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_72, 50f, 35f, 50f, 0, 1, 0))
											{
												func_130();
											}
											if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_72, 80f, 65f, 50f, 0, 1, 0))
											{
												func_129();
											}
											if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_54, 0))
											{
												if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 281.9148f, 6816.345f, 4.3197f, 48.3924f, 6885.921f, 43.0037f, 226.5f, 0, 1, 0) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_74 - Vector(0f, 0f, 7f), 20f, 15f, 50f, 0, 1, 0))
												{
													func_128();
													if (SYSTEM::VMAG(fLocal_88))
													{
														HUD::SHOW_HEIGHT_ON_BLIP(fLocal_88, false);
													}
													iLocal_58 = 0;
													while (iLocal_58 <= 1)
													{
														if (SYSTEM::VMAG(fLocal_87[iLocal_58]))
														{
															HUD::SHOW_HEIGHT_ON_BLIP(fLocal_87[iLocal_58], false);
														}
														iLocal_58++;
													}
													if (!func_166())
							...
							case 2:
								if ((func_133(iLocal_52[0], &iLocal_102, &uLocal_101, bLocal_100, iLocal_103, 7f, 0) || func_133(iLocal_52[1], &iLocal_102, &uLocal_101, bLocal_100, iLocal_103, 7f, 0)) || iLocal_103)
								{
									iLocal_103 = 1;
									if (!func_166())
									{
									...
									if (SYSTEM::VMAG(fLocal_88))
									{
										HUD::SHOW_HEIGHT_ON_BLIP(fLocal_88, true);
									}
									iLocal_58 = 0;
									while (iLocal_58 <= 1)
									{
										if (SYSTEM::VMAG(fLocal_87[iLocal_58]))
										{
											HUD::SHOW_HEIGHT_ON_BLIP(fLocal_87[iLocal_58], true);
										}
										iLocal_58++;
									}
									switch (iLocal_102)
								...
								if (func_132())
								{
									...
									if (!func_117())
									{
										switch (iLocal_49)
										{
											...
											case 5:
												func_110();
												SYSTEM::WAIT(0);
												if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]))
												{
													func_108(iLocal_52[0], "GENERIC_WAR_CRY", 24);
												}
												else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
												{
									...
									else
									{
										...
										{
											if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[iVar0]))
											{
												AUDIO::PLAY_PAIN(iLocal_52[iVar0], 5, 0, 0);
												TASK::TASK_SMART_FLEE_PED(iLocal_52[iVar0], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
												PED::SET_PED_KEEP_TASK(iLocal_52[iVar0], true);
												if (MISC::IS_BIT_SET(bLocal_56))
												{
													if (ENTITY::IS_ENTITY_ATTACHED(bLocal_56))
													{
														ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_56, 1, 1);
													}
												}
												if (SYSTEM::VMAG(fLocal_87[iVar0]))
												{
													unk_0x93370FA10F15BE44(&(fLocal_87[iVar0]));
												}
											}
											iVar0++;
										}
							...
							case 4:
								func_91();
								if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_85, 100f, 100f, 100f, 1, 1, 0))
								{
									PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
									if (MISC::IS_BIT_SET(iLocal_52[0]) && MISC::IS_BIT_SET(iLocal_52[1]))
									{
								...
								{
									if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_113, 200f, 200f, 200f, 1, 1, 0))
									{
										unk_0x78FCB2E22C41B9D5(joaat("s_m_m_highsec_01"));
										unk_0x78FCB2E22C41B9D5(joaat("granger"));
										if (ENTITY::DOES_ENTITY_EXIST(joaat("s_m_m_highsec_01")) && ENTITY::DOES_ENTITY_EXIST(joaat("granger")))
										{
											bLocal_55 = VEHICLE::CREATE_VEHICLE(joaat("granger"), -1155.043f, 942.9685f, 197.4921f, 161.1247f, true, true, false);
											ENTITY::SET_ENTITY_LOD_DIST(bLocal_55, 200);
											VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(bLocal_55, 1.5f);
											bLocal_53 = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_55, 26, joaat("s_m_m_highsec_01"), -1, true, true);
											PED::SET_PED_COMPONENT_VARIATION(bLocal_53, 0, 0, 2, 0);
											PED::SET_PED_COMPONENT_VARIATION(bLocal_53, 3, 0, 0, 0);
											PED::SET_PED_COMPONENT_VARIATION(bLocal_53, 4, 0, 0, 0);
											unk_0x92BD213E6A0E666B(bLocal_53, joaat("weapon_pistol"), -1, 1, 1);
											PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_53, iLocal_137);
										}
									}
								}
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
								{
									...
									if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_113, Global_22, 1, 1, 0) && ENTITY::IS_ENTITY_AT_ENTITY(bLocal_51, unk_0x9B0761B4C3EB8BC7(), 10f, 10f, 10f, false, true, 0))
									{
										if (PED::IS_PED_IN_GROUP(bLocal_51))
										{
											if (SYSTEM::VMAG(fLocal_111))
											{
												unk_0x93370FA10F15BE44(&fLocal_111);
											}
											if (SYSTEM::VMAG(fLocal_112))
											{
												unk_0x93370FA10F15BE44(&fLocal_112);
											}
											if (func_70())
											{
												iLocal_47 = 5;
							...
							case 7:
								...
								if (MISC::IS_BIT_SET(bLocal_56))
								{
									if (ENTITY::IS_ENTITY_ATTACHED(bLocal_56))
									{
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]))
										{
											if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_52[0], "random@burial", "a_burial_stop", 3))
											{
												if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial_stop") > 0.355f)
												{
													ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_56, 1, 1);
												}
											}
								...
								if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]) || STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
								{
									bLocal_117 = true;
								}
								if (bLocal_117)
								{
									if (ENTITY::GET_ENTITY_COORDS(bLocal_54, false))
									{
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]))
										{
											PED::_0xF1C03A5352243A30(iLocal_52[0]);
											if (VEHICLE::_0x639431E895B9AA57(iLocal_52[0], bLocal_54, -1, false, false) || VEHICLE::_0x639431E895B9AA57(iLocal_52[0], bLocal_54, false, false, false))
											{
												if (!iLocal_124)
												{
													HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_52[0]);
													if (MISC::IS_BIT_SET(bLocal_56))
													{
														if (ENTITY::IS_ENTITY_ATTACHED(bLocal_56))
														{
													...
													TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, unk_0x7EC595B99EA7C4B1(bLocal_54, -0.5f, 0.5f, 0f), unk_0x9B0761B4C3EB8BC7(), 3f, true, 0.5f, 4f, true, 0, false, -957453492, 20000);
													TASK::TASK_ENTER_VEHICLE(0, bLocal_54, -1, -1, 3f, 9, 0);
													TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, bLocal_54, unk_0x9B0761B4C3EB8BC7(), 8, 30f, 262144, -1f, 10f, true);
													TASK::CLOSE_SEQUENCE_TASK(iLocal_59);
													AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_52[0], iLocal_59);
													TASK::CLEAR_SEQUENCE_TASK(&iLocal_59);
													PED::SET_PED_KEEP_TASK(iLocal_52[0], true);
													VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(bLocal_54, true);
													iLocal_124 = 1;
												}
												else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_52[0], 242628503) == 1)
												{
													...
													{
														if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_52[0], unk_0x9B0761B4C3EB8BC7(), 10f, 10f, 10f, false, true, 0) && !unk_0xC2169C00B643278B(iLocal_52[0], Local_74, 10f, 10f, 10f, 0, 1, 0))
														{
															ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_52[0]));
														}
													}
											...
											{
												TASK::TASK_COMBAT_PED(iLocal_52[0], unk_0x9B0761B4C3EB8BC7(), 0, 16);
												PED::SET_PED_KEEP_TASK(iLocal_52[0], true);
											}
										}
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
										{
											PED::_0xF1C03A5352243A30(iLocal_52[1]);
											if (VEHICLE::_0x639431E895B9AA57(iLocal_52[1], bLocal_54, -1, false, false) || VEHICLE::_0x639431E895B9AA57(iLocal_52[1], bLocal_54, false, false, false))
											{
												if (!iLocal_124)
												{
													HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_52[1]);
													TASK::OPEN_SEQUENCE_TASK(&iLocal_59);
													TASK::TASK_CLEAR_LOOK_AT(false);
													TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, unk_0x7EC595B99EA7C4B1(bLocal_54, -0.5f, 0.5f, 0f), unk_0x9B0761B4C3EB8BC7(), 3f, true, 0.5f, 4f, true, 0, false, -957453492, 20000);
													TASK::TASK_ENTER_VEHICLE(0, bLocal_54, -1, -1, 3f, 9, 0);
													TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, bLocal_54, unk_0x9B0761B4C3EB8BC7(), 8, 30f, 262144, -1f, 10f, true);
													TASK::CLOSE_SEQUENCE_TASK(iLocal_59);
													AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_52[1], iLocal_59);
													TASK::CLEAR_SEQUENCE_TASK(&iLocal_59);
												...
												else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_52[1], 242628503) == 1)
												{
													...
													{
														if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_52[1], unk_0x9B0761B4C3EB8BC7(), 10f, 10f, 10f, false, true, 0) && !unk_0xC2169C00B643278B(iLocal_52[1], Local_74, 10f, 10f, 10f, 0, 1, 0))
														{
															ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_52[1]));
														}
													}
											...
											{
												TASK::TASK_COMBAT_PED(iLocal_52[1], unk_0x9B0761B4C3EB8BC7(), 0, 16);
												PED::SET_PED_KEEP_TASK(iLocal_52[1], true);
											}
										}
									}
						...
						if ((func_10() && !func_9()) && iLocal_47 != 9)
						{
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
							{
								if (unk_0xC2169C00B643278B(bLocal_51, Local_114, 5f, 5f, 5f, 0, 1, 0))
								{
									func_8(0);
									SYSTEM::WAIT(0);
									func_110();
						...
						if (iLocal_47 != 3)
						{
							if (func_1())
							{
								...
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
								{
									if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_51, 20f, 20f, 20f, false, true, 1))
									{
						...
						if (((iLocal_47 == 1 || iLocal_47 == 2) || iLocal_47 == 3) || iLocal_47 == 7)
						{
							if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
							{
								if (!bLocal_104)
								{
									if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_51, 1785177548) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bLocal_51, 1785177548) != 0)
									{
										TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_51);
										iLocal_303 = PED::CREATE_SYNCHRONIZED_SCENE(Local_72, -2f, -4f, 18f, 2);
										TASK::TASK_SYNCHRONIZED_SCENE(bLocal_51, iLocal_303, "random@burial", "b_burial", 1000f, -4f, 1, 24592, 1000f, 0);
									...
									if (FIRE::IS_ENTITY_ON_FIRE(bLocal_51))
									{
										PED::SET_ENABLE_HANDCUFFS(bLocal_51, true);
										PED::SET_ENABLE_BOUND_ANKLES(bLocal_51, true);
										CAM::IS_AIM_CAM_ACTIVE(bLocal_51, 0, 0);
									}
								}
								if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(bLocal_51) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(bLocal_51)) || (iLocal_99 - ENTITY::GET_ENTITY_HEALTH(bLocal_51)) >= 50)
								{
									PED::SET_ENABLE_HANDCUFFS(bLocal_51, true);
									PED::SET_ENABLE_BOUND_ANKLES(bLocal_51, true);
									CAM::IS_AIM_CAM_ACTIVE(bLocal_51, 0, 0);
								}
								if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0))
								{
									if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) < 5f)
									{
									}
									else if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), bLocal_51))
									{
										PED::SET_ENABLE_HANDCUFFS(bLocal_51, true);
										PED::SET_ENABLE_BOUND_ANKLES(bLocal_51, true);
										CAM::IS_AIM_CAM_ACTIVE(bLocal_51, 0, 0);
								...
								if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_54, 0))
								{
									if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(bLocal_54, bLocal_51))
									{
										PED::SET_ENABLE_HANDCUFFS(bLocal_51, true);
										PED::SET_ENABLE_BOUND_ANKLES(bLocal_51, true);
										CAM::IS_AIM_CAM_ACTIVE(bLocal_51, 0, 0);
...
int func_1()
{
	if (!bLocal_104)
	{
		...
		if (MISC::IS_BIT_SET(iLocal_52[1]) && !MISC::IS_BIT_SET(iLocal_52[0]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
			{
				return 1;
...
void func_2()
{
	if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]))
	{
		if (SYSTEM::VMAG(fLocal_87[0]))
		{
			...
			func_3(&uLocal_138, 4);
			unk_0x93370FA10F15BE44(&(fLocal_87[0]));
		}
	}
	if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
	{
		if (SYSTEM::VMAG(fLocal_87[1]))
		{
			func_3(&uLocal_138, 3);
			unk_0x93370FA10F15BE44(&(fLocal_87[1]));
		}
	}
	if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
	{
		...
		{
			func_3(&uLocal_138, 5);
			unk_0x93370FA10F15BE44(&fLocal_88);
		}
	}
}
				...
				switch (iLocal_128)
				{
					case 0:
						if (iLocal_84 < MISC::GET_GAME_TIMER())
						{
							...
							{
								iLocal_84 = (MISC::GET_GAME_TIMER() + NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(3500, 5000));
								iLocal_128++;
							}
						}
						break;
...
int func_42(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	struct<15> Var0;
	int iVar1;
...
void func_47()
{
	...
	{
		case 0:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51) && ENTITY::GET_ENTITY_COORDS(bLocal_55, false))
			{
				if (PED::IS_PED_IN_GROUP(bLocal_51))
				{
					PED::REMOVE_PED_FROM_GROUP(bLocal_51);
				...
				PED::SET_PED_CAN_BE_TARGETTED(bLocal_51, true);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_59);
				TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 5000, 2048, 2);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 0);
				TASK::TASK_ENTER_VEHICLE(0, bLocal_55, -1, 0, 1f, 1, 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_59);
				AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_51, iLocal_59);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_59);
				PED::SET_PED_KEEP_TASK(bLocal_51, true);
				func_110();
				SYSTEM::WAIT(0);
		...
		case 1:
			if (ENTITY::GET_ENTITY_COORDS(bLocal_55, false))
			{
				if (unk_0xE0B3BC41DDA88DF0(bLocal_51, bLocal_55, 0))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_53))
					{
						TASK::TASK_VEHICLE_DRIVE_WANDER(bLocal_53, bLocal_54, 10f, 786599);
						PED::SET_PED_KEEP_TASK(bLocal_53, true);
					}
					VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(bLocal_55, true);
					iLocal_110++;
				}
			}
			break;
		...
		case 2:
			if (ENTITY::GET_ENTITY_COORDS(bLocal_55, false))
			{
				if (unk_0xE0B3BC41DDA88DF0(bLocal_51, bLocal_55, 0))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_53))
					{
						TASK::TASK_VEHICLE_DRIVE_WANDER(bLocal_53, bLocal_55, 10f, 786599);
						PED::SET_PED_KEEP_TASK(bLocal_53, true);
					}
					VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(bLocal_55, true);
					iLocal_110++;
...
void func_52()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
	{
		if ((((((func_56("REBU2_LV2_2") || func_56("REBU2_LV2_3")) || func_56("REBU2_LV2_4")) || func_56("REBU2_LV2_5")) || func_56("REBU2_LV2_6")) || func_56("REBU2_LV2_7")) || func_56("REBU2_LV2_8"))
		{
			...
			TASK::TASK_CLEAR_LOOK_AT(bLocal_51);
		}
		if (func_56("REBU2_LV2_9") || iLocal_66 > 1)
		{
			TASK::TASK_USE_MOBILE_PHONE(bLocal_51, 0, 1);
		}
	}
	if (func_70() && !func_12())
	{
...
void func_58()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
	{
		if (!iLocal_107)
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1) && unk_0xE0B3BC41DDA88DF0(bLocal_51, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
				{
		...
		{
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0) && unk_0xE0B3BC41DDA88DF0(bLocal_51, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				iLocal_107 = 0;
			}
		}
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
		{
			if (!func_62())
			{
				...
				{
					TASK::TASK_LEAVE_ANY_VEHICLE(bLocal_51, 0, 4194304);
				}
				if (!iLocal_106)
				{
					func_87(0);
		...
		{
			PED::SET_PED_AS_GROUP_MEMBER(bLocal_51, func_60());
...
void func_63()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
	{
		if (PED::IS_PED_ON_FOOT(bLocal_51))
		{
			if (!iLocal_130)
			{
	...
	if ((iLocal_132 - iLocal_131) > 180000)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
		{
			...
			{
				PED::REMOVE_PED_FROM_GROUP(bLocal_51);
				if (unk_0xC2169C00B643278B(bLocal_51, Local_113, 100f, 100f, 100f, 0, 1, 0))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bLocal_51, 1740.797f, 4648.756f, 42.6529f, 1f, -1, 0.25f, false, 40000f);
					PED::SET_PED_KEEP_TASK(bLocal_51, true);
				}
				func_110();
				SYSTEM::WAIT(0);
	...
	if ((iLocal_135 - iLocal_134) > 120000)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
		{
			if (PED::IS_PED_IN_GROUP(bLocal_51))
			{
				...
				if (unk_0xC2169C00B643278B(bLocal_51, Local_113, 100f, 100f, 100f, 0, 1, 0))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bLocal_51, Local_113, 1f, -1, 0.25f, false, 40000f);
					PED::SET_PED_KEEP_TASK(bLocal_51, true);
				}
				else
				{
...
void func_65()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_51, 8f, 8f, 8f, false, true, 0) || PED::IS_PED_IN_ANY_TAXI(unk_0x9B0761B4C3EB8BC7()))
		{
			if ((SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && !unk_0xE0B3BC41DDA88DF0(bLocal_51, ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0)) && !PED::IS_PED_IN_ANY_TAXI(unk_0x9B0761B4C3EB8BC7()))
			{
				if (!SYSTEM::VMAG(fLocal_88))
				{
					fLocal_88 = func_68(bLocal_51, 0, 145);
				}
				if (SYSTEM::VMAG(fLocal_111))
				{
					unk_0x93370FA10F15BE44(&fLocal_111);
			...
			else
			{
				...
				if (!SYSTEM::VMAG(fLocal_111))
				{
					fLocal_111 = func_66(Local_113, 1);
				}
			}
		}
		else if (!SYSTEM::VMAG(fLocal_88))
		{
			fLocal_88 = func_68(bLocal_51, 0, 145);
		}
		if (!PED::IS_PED_IN_GROUP(bLocal_51))
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_51, 8f, 8f, 8f, false, true, 0))
			{
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_51);
				PED::SET_PED_AS_GROUP_MEMBER(bLocal_51, func_60());
				PED::SET_PED_NEVER_LEAVES_GROUP(bLocal_51, true);
		...
		if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_51, 150f, 150f, 150f, false, true, 0))
		{
			func_4();
		}
	}
...
bool func_66(struct<3> Param0, bool bParam1)
{
	...
	HUD::SET_BLIP_SCALE(bVar0, func_67(MISC::SET_BIT(), 1f, 1f));
...
float func_68(bool bParam0, bool bParam1, int iParam2)
{
	float fVar0;
	
	fVar0 = func_69(bParam0, !bParam1, 0);
...
bool func_69(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_67(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
int func_70()
{
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		bLocal_129 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
		if (ENTITY::GET_ENTITY_COORDS(bLocal_129, false))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
			{
				if (PED::IS_PED_SITTING_IN_VEHICLE(bLocal_51, bLocal_129))
				{
					return 1;
				}
			}
...
void func_87(bool bParam0)
{
	if (bParam0)
	{
		if (iLocal_119)
		{
			if (!CAM::IS_SCREEN_FADED_OUT(&Local_121))
			{
...
void func_91()
{
	if (MISC::IS_BIT_SET(bLocal_51))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
		{
			PED::SET_PED_RESET_FLAG(bLocal_51, 394, true);
		}
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_51, unk_0x9B0761B4C3EB8BC7(), true))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
			{
				TASK::TASK_SMART_FLEE_PED(bLocal_51, unk_0x9B0761B4C3EB8BC7(), 150f, -1, false, false);
				PED::SET_PED_KEEP_TASK(bLocal_51, true);
			}
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_53))
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_137, 1862763509);
				TASK::TASK_COMBAT_PED(bLocal_53, unk_0x9B0761B4C3EB8BC7(), 0, 16);
				PED::SET_PED_KEEP_TASK(bLocal_53, true);
			}
			func_110();
			SYSTEM::WAIT(0);
...
void func_92()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
	{
		if ((ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_51, 1.2f, 1.2f, 5f, false, true, 0) && PED::IS_PED_ON_FOOT(unk_0x9B0761B4C3EB8BC7())) && !MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7()))
		{
			if (func_49(1, 0, 1))
			{
				bLocal_104 = true;
				if (!iLocal_89)
				{
					...
					if (MISC::IS_BIT_SET(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
					{
						...
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), bLocal_51, 5f, 5f, 5f, false, true, 0) || unk_0xC2169C00B643278B(PLAYER::GET_PLAYERS_LAST_VEHICLE(), Local_74, 5f, 5f, 5f, 0, 1, 0))
						{
							unk_0x03D382CB0B44E2FC(PLAYER::GET_PLAYERS_LAST_VEHICLE(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_51, 1) - Vector(0f, 3f, 5f), 0, 0, 0, 1);
							if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
							{
					...
					{
						if (FIRE::IS_ENTITY_ON_FIRE(bLocal_54))
						{
							func_98(bLocal_54);
							VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bLocal_54, 200f);
						}
						if (ENTITY::IS_ENTITY_AT_ENTITY(bLocal_54, bLocal_51, 8f, 8f, 8f, false, true, 0))
						{
							unk_0x03D382CB0B44E2FC(bLocal_54, Local_74, 0, 0, 0, 1);
							if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_54, 0))
							{
								VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_54, 5f);
							}
						}
					}
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
					{
						bLocal_129 = unk_0xC2E2CC6CF95AF8A3(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_51, 1), 5f, 0, 2);
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_129, 0))
						{
							if (FIRE::IS_ENTITY_ON_FIRE(bLocal_129))
							{
								func_98(bLocal_129);
								VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bLocal_129, 200f);
							}
							unk_0x03D382CB0B44E2FC(bLocal_129, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_51, 1) + Vector(0f, 5f, 5f), 1, 0, 0, 1);
						}
					}
					FIRE::STOP_FIRE_IN_RANGE(Local_72, 10f);
					MISC::CLEAR_AREA_OF_PROJECTILES(Local_72, 10f, 0);
					MISC::CLEAR_AREA_OF_VEHICLES(Local_72, 4.5f, false, false, false, false, false, false);
					unk_0x03D382CB0B44E2FC(bLocal_51, Local_72, 1, 0, 0, 1);
					unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), Local_72, 1, 0, 0, 1);
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
					{
					}
					iVar0 = 0;
					while (iVar0 < iLocal_52)
					{
						if (MISC::IS_BIT_SET(iLocal_52[iVar0]))
						{
							if (unk_0xC2169C00B643278B(iLocal_52[iVar0], NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_51, 0), 1.5f, 1.5f, 1.5f, 0, 1, 0))
							{
					...
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
					{
						...
						ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 18.2311f);
						CAM::IS_AIM_CAM_ACTIVE(bLocal_51, 200, 0);
						PED::SET_ENABLE_HANDCUFFS(bLocal_51, false);
						PED::SET_ENABLE_BOUND_ANKLES(bLocal_51, false);
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_51);
						TASK::TASK_SYNCHRONIZED_SCENE(bLocal_51, iLocal_303, "random@burial", "untie_ped", 1000f, -1000f, 4, 0, 1000f, 0);
						ENTITY::FREEZE_ENTITY_POSITION(bLocal_51, false, 0);
						TASK::TASK_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), iLocal_303, "random@burial", "untie_player", 1000f, -1000f, 0, 0, 1000f, 0);
	...
	if (iLocal_89 && !iLocal_91)
	{
		...
		if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_303))
		{
			if ((ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_303) > 0.115f && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_303) < 0.12f) || (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_303) > 0.355f && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_303) < 0.36f))
			{
				DATAFILE::UGC_UPDATE_CONTENT(-1, "ROPE_CUT", "ROPE_CUT_SOUNDSET", 1);
			}
			if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_303) > 0.6f)
			{
				if (!iLocal_90)
				{
					func_110();
		...
		if (((iLocal_93 - iLocal_94) > 9700 && !iLocal_97) && STATS::_PLAYSTATS_ARENA_WARS_ENDED() == 4)
		{
	...
	if (iLocal_91 && !bLocal_96)
	{
		...
		ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 256.7693f);
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
		{
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_51);
			ENTITY::FREEZE_ENTITY_POSITION(bLocal_51, false, 0);
			PED::SET_PED_CAN_RAGDOLL(bLocal_51, true);
			unk_0x03D382CB0B44E2FC(bLocal_51, 164.4963f, 6839.333f, 18.9657f, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(bLocal_51, 73.449f);
		}
		...
		if (bLocal_96)
		{
			if (!iLocal_95)
			{
				if (!func_12())
				{
					...
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 4000);
					if (ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(bLocal_51, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 20f, 20f, 20f, false, true, 0) && PED::GET_VEHICLE_PED_IS_USING(PLAYER::GET_PLAYERS_LAST_VEHICLE()) > 0)
						{
					...
					if (func_45() == 2 && !func_9())
					{
						if (!SYSTEM::VMAG(fLocal_112))
						{
							fLocal_112 = func_66(Local_114, 0);
							HUD::SET_BLIP_SPRITE(fLocal_112, 269);
							func_94();
						}
					}
					func_93();
...
void func_98(bool bParam0)
{
	if (MISC::IS_BIT_SET(bParam0))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0))
		{
			...
			{
				FIRE::STOP_ENTITY_FIRE(bParam0);
				CAM::IS_AIM_CAM_ACTIVE(bParam0, ENTITY::GET_ENTITY_HEALTH(bParam0) + 200, 0);
				VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bParam0, (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(bParam0) + 200f));
				VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(bParam0, (VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(bParam0) + 200f));
				FIRE::STOP_FIRE_IN_RANGE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 5f);
				MISC::CLEAR_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 2.5f, true, false, false, false);
			}
		}
	}
}
...
void func_99(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_103(PLAYER::PLAYER_ID())) && !func_101(PLAYER::PLAYER_ID(), 0)) && !func_100()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_103(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
		...
		switch (iLocal_128)
		{
			case 0:
				if (iLocal_84 < MISC::GET_GAME_TIMER())
				{
					if (func_71(&uLocal_138, "REBU2AU", "REBU2_HPF", 4, 0, 0, 0))
					{
						iLocal_84 = (MISC::GET_GAME_TIMER() + NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(4000, 5500));
						iLocal_128++;
					}
				}
				break;
...
void func_112()
{
	if (!iLocal_61 && unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_85, 30f, 30f, 30f, 0, 1, 0))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
		{
	...
	if (ENTITY::GET_ENTITY_COORDS(bLocal_54, false))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]))
		{
			TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_52[0], bLocal_54, unk_0x9B0761B4C3EB8BC7(), 8, 30f, 262144, -1f, 10f, true);
			PED::SET_PED_KEEP_TASK(iLocal_52[0], true);
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
		{
			TASK::TASK_ENTER_VEHICLE(iLocal_52[1], bLocal_54, -1, 0, 3f, 1, 0);
			PED::SET_PED_KEEP_TASK(iLocal_52[1], true);
		}
	}
	else
	{
		...
		while (iLocal_58 <= 1)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[iLocal_58]))
			{
				TASK::TASK_SMART_FLEE_PED(iLocal_52[iLocal_58], unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
...
void func_113()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
	{
		if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_52[0]) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_52[1]))
		{
			...
			{
				if (!PED::IS_PED_PRONE(iLocal_52[1]))
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_52[1]);
					TASK::TASK_SHOOT_AT_ENTITY(iLocal_52[1], unk_0x9B0761B4C3EB8BC7(), -1, -957453492);
				}
			}
		}
	}
...
void func_114()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
	{
		if (!iLocal_63)
		{
			...
			if (PED::IS_PED_FACING_PED(iLocal_52[1], unk_0x9B0761B4C3EB8BC7(), 90f))
			{
				func_110();
				SYSTEM::WAIT(0);
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
				{
					fVar0 = func_116(iLocal_52[0], unk_0x9B0761B4C3EB8BC7(), 1);
					if (fVar0 > 5f)
					{
						fVar0 = (fVar0 - 2f);
					}
					...
					ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_56, 0, 1);
					OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_56, iLocal_52[0], ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_52[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_52[0]);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_59);
					TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					...
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_52[0], iLocal_59);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_59);
					ENTITY::SET_ENTITY_HEALTH(iLocal_52[1], joaat("weapon_sawnoffshotgun"), 1);
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_52[1]);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_59);
					TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
					TASK::TASK_GO_TO_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, fVar0, 1f, 2f, 0);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_59);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_52[1], iLocal_59);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_59);
		...
		if (iLocal_63 && !iLocal_125)
		{
			...
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_59);
				TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), unk_0x9B0761B4C3EB8BC7(), 1f, false, 3.5f, 4f, true, false, -957453492);
		...
		if (iLocal_125 && !iLocal_126)
		{
			...
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_52[0], 30f, 30f, 30f, false, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_52[1], 30f, 30f, 30f, false, true, 0))
				{
					TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_52[0], unk_0x9B0761B4C3EB8BC7(), -1, false);
				}
				iLocal_126 = 1;
				SYSTEM::SETTIMERB(0);
			}
		...
		if (iLocal_126 && !bLocal_127)
		{
			if (SYSTEM::TIMERB() > 15000 && !func_12())
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_52[0], 30f, 30f, 30f, false, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_52[1], 30f, 30f, 30f, false, true, 0))
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_52[0], unk_0x9B0761B4C3EB8BC7(), 0);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_52[1], unk_0x9B0761B4C3EB8BC7(), 0);
					func_71(&uLocal_138, "REBU2AU", "REBU2_SHO", 4, 0, 0, 0);
					bLocal_127 = true;
				}
			}
		}
		if (((!iLocal_64 && iLocal_125) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_52[0], 30f, 30f, 30f, false, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_52[1], 30f, 30f, 30f, false, true, 0))
			{
				if (!func_12())
			...
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_59);
				TASK::TASK_GO_TO_ENTITY(false, iLocal_52[1], -1, 2f, 1f, 2f, 0);
				...
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_59);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_59);
				TASK::TASK_GO_TO_ENTITY(false, iLocal_52[0], -1, 2f, 1f, 2f, 0);
		...
		if (((PED::CAN_PED_SEE_HATED_PED(iLocal_52[0], unk_0x9B0761B4C3EB8BC7()) || PED::CAN_PED_SEE_HATED_PED(iLocal_52[1], unk_0x9B0761B4C3EB8BC7())) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_52[0])) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_52[1]))
		{
			...
			if (PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID()) || PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
			{
				func_118();
			}
		}
...
var func_116(bool bParam0, bool bParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_117()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false))
			{
				if ((((PED::IS_PED_IN_MODEL(unk_0x9B0761B4C3EB8BC7(), joaat("rhino")) || unk_0x653A331834B72BC0(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_IN_MODEL(unk_0x9B0761B4C3EB8BC7(), joaat("annihilator"))) || PED::IS_PED_IN_MODEL(unk_0x9B0761B4C3EB8BC7(), joaat("buzzard"))) || PED::IS_PED_IN_FLYING_VEHICLE(unk_0x9B0761B4C3EB8BC7()))
				{
					return 1;
				}
			}
...
void func_118()
{
	...
	if (!iLocal_115)
	{
		if (MISC::IS_BIT_SET(iLocal_52[0]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]))
			{
				...
				if (MISC::IS_BIT_SET(bLocal_56))
				{
					...
					if (ENTITY::IS_ENTITY_ATTACHED(bLocal_56))
					{
						if (!iLocal_64)
						{
							...
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_59);
							PED::SET_PED_KEEP_TASK(iLocal_52[0], true);
							ENTITY::FREEZE_ENTITY_POSITION(iLocal_52[0], false, 0);
							iLocal_115 = 1;
						}
					}
					else
	...
	if (!iLocal_116)
	{
		if (MISC::IS_BIT_SET(iLocal_52[1]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
			{
				...
				TASK::OPEN_SEQUENCE_TASK(&iLocal_59);
				TASK::TASK_CLEAR_LOOK_AT(false);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 500);
				TASK::TASK_COMBAT_PED(false, unk_0x9B0761B4C3EB8BC7(), 0, 16);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_59);
				AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_52[1], iLocal_59);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_59);
...
void func_128()
{
	if (SYSTEM::VMAG(fLocal_123))
	{
		unk_0x93370FA10F15BE44(&fLocal_123);
	}
	if (!SYSTEM::VMAG(fLocal_88))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_51, 0))
	...
	while (iLocal_58 <= 1)
	{
		if (!SYSTEM::VMAG(fLocal_87[iLocal_58]))
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_52[iLocal_58], 0))
			{
				fLocal_87[iLocal_58] = func_68(iLocal_52[iLocal_58], 1, 145);
			}
		}
		iLocal_58++;
	}
		...
		switch (iLocal_128)
		{
			case 0:
				if (iLocal_84 < MISC::GET_GAME_TIMER())
				{
					...
					{
						iLocal_84 = (MISC::GET_GAME_TIMER() + NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(4500, 6500));
						iLocal_128++;
					}
				}
				break;
	...
	if (MISC::IS_BIT_SET(bLocal_56))
	{
		if (ENTITY::IS_ENTITY_ATTACHED(bLocal_56))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]))
			{
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_52[0], "random@burial", "a_burial_stop", 3))
				{
					if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial_stop") > 0.124f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") < 0.127f)
					{
						GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_burial_dirt", bLocal_56, 0f, 0f, -0.95f, 0f, 180f, 0f, 1f, false, false, false);
					}
				}
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_52[0], "random@burial", "a_burial", 3))
				{
					if (((((NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") > 0.04f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") < 0.043f) || (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") > 0.24f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") < 0.243f)) || (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") > 0.44f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") < 0.443f)) || (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") > 0.64f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") < 0.643f)) || (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") > 0.84f && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_52[0], "random@burial", "a_burial") < 0.843f))
					{
						GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_burial_dirt", bLocal_56, 0f, 0f, -0.95f, 0f, 180f, 0f, 1f, false, false, false);
					}
				}
...
int func_132()
{
	if (!iLocal_103)
	{
		...
		if (MISC::IS_BIT_SET(bLocal_54))
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_54, 0))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_54, unk_0x9B0761B4C3EB8BC7(), true) || unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_54, 0))
				{
				...
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					...
					{
						if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), bLocal_54))
						{
							func_118();
							iLocal_49 = 3;
							return 1;
		...
		if (!iLocal_69)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[1]))
			{
				if ((((PED::CAN_PED_SEE_HATED_PED(iLocal_52[0], unk_0x9B0761B4C3EB8BC7()) || PED::CAN_PED_SEE_HATED_PED(iLocal_52[1], unk_0x9B0761B4C3EB8BC7())) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_52[0])) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_52[1])) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_74 - Vector(0f, 0f, 7f), 20f, 15f, 35f, 0, 1, 0))
				{
					if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_74 - Vector(0f, 0f, 7f), 28f, 18f, 35f, 0, 1, 0))
					{
						iLocal_49 = 1;
						return 1;
					}
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_51, unk_0x9B0761B4C3EB8BC7(), false) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(bLocal_51, joaat("weapon_stungun"), 0))
			{
				iLocal_49 = 4;
				return 1;
			}
		...
		if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_52[0], 0) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_52[1], 0))
		{
			iLocal_49 = 6;
			return 1;
		}
...
int func_133(bool bParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
void func_140()
{
	...
	func_142(43, 1);
	func_142(44, 1);
	PATHFIND::SET_ROADS_IN_AREA(Local_113 - Vector(20f, 40f, 40f), Local_113 + Vector(20f, 40f, 40f), false, true, 1, 1);
	PATHFIND::SET_ROADS_IN_AREA(Local_72 - Vector(20f, 50f, 60f), Local_72 + Vector(20f, 50f, 50f), false, true, 1, 1);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(fLocal_83, true);
	MISC::ENABLE_DISPATCH_SERVICE(5, false);
	MISC::ENABLE_DISPATCH_SERVICE(3, false);
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
	bLocal_51 = PED::CREATE_PED(26, iLocal_80, Local_72, fLocal_77, true, true);
	PED::_0x2208438012482A1A(bLocal_51, 1);
	PED::SET_PED_CAN_BE_TARGETTED(bLocal_51, false);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_51, 2, false);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_51, 128, true);
	PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_51, 1, false);
	PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_51, 6, false);
	PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_51, 2.886675E-43f, 1);
	PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_51, 4.456129E-43f, 0);
	PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_51, 1.653532E-43f, 0);
	PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_51, 2.914701E-43f, 1);
	unk_0x74528AC0906CBABE(iLocal_80);
	CAM::IS_AIM_CAM_ACTIVE(bLocal_51, iLocal_99, 0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(unk_0x9B0761B4C3EB8BC7(), false);
	PED::ADD_RELATIONSHIP_GROUP("rghKidnappers", &iLocal_136);
	PED::ADD_RELATIONSHIP_GROUP("rghVictim", &iLocal_137);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_51, iLocal_137);
	iLocal_58 = 0;
	while (iLocal_58 <= 1)
	{
		iLocal_52[iLocal_58] = PED::CREATE_PED(26, iLocal_81, Local_73[iLocal_58 /*3*/], fLocal_78[iLocal_58], true, true);
		PED::_0x2208438012482A1A(iLocal_52[iLocal_58], 1);
		...
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_52[iLocal_58], 5.885454E-44f, 1);
		...
		PED::SET_PED_MONEY(iLocal_52[iLocal_58], NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(800, 2000));
		iLocal_58++;
	}
	unk_0x74528AC0906CBABE(iLocal_82);
	...
	unk_0x92BD213E6A0E666B(iLocal_52[0], joaat("weapon_pistol"), -1, 0, 1);
	unk_0x92BD213E6A0E666B(iLocal_52[1], joaat("weapon_sawnoffshotgun"), -1, 0, 1);
	bLocal_54 = VEHICLE::CREATE_VEHICLE(fLocal_83, Local_74, fLocal_79, true, true, false);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_54, 5f);
	VEHICLE::SET_VEHICLE_LIGHTS(bLocal_54, 3);
	VEHICLE::SET_VEHICLE_DOOR_OPEN(bLocal_54, 5, false, false);
	unk_0x74528AC0906CBABE(fLocal_83);
	bLocal_56 = OBJECT::CREATE_OBJECT(joaat("prop_ld_shovel"), Local_85, true, true, false);
	...
	TASK::TASK_SYNCHRONIZED_SCENE(bLocal_51, iLocal_303, "random@burial", "b_burial", 4f, -4f, 1, 0, 1000f, 0);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_57[0], iLocal_303, "b_burial_legstie", "random@burial", 4f, -4f, 0, 1000f);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_57[1], iLocal_303, "b_burial_wristtie", "random@burial", 4f, -4f, 0, 1000f);
	PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_303, true);
	PED::SET_PED_KEEP_TASK(bLocal_51, true);
	...
	if (func_45() == 0)
	{
		func_141(&uLocal_138, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
	}
	else if (func_45() == 1)
	{
		func_141(&uLocal_138, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	}
	else if (func_45() == 2)
	{
		func_141(&uLocal_138, 2, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
	}
	...
	AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_51, "KIDNAPPEDFEMALE");
...
void func_151()
{
	unk_0x78FCB2E22C41B9D5(fLocal_80);
	unk_0x78FCB2E22C41B9D5(fLocal_82);
	unk_0x78FCB2E22C41B9D5(fLocal_81);
	unk_0x78FCB2E22C41B9D5(fLocal_83);
	...
	if (((((((((ENTITY::DOES_ENTITY_EXIST(fLocal_80) && ENTITY::DOES_ENTITY_EXIST(fLocal_82)) && ENTITY::DOES_ENTITY_EXIST(fLocal_81)) && ENTITY::DOES_ENTITY_EXIST(fLocal_83)) && ENTITY::DOES_ENTITY_EXIST(joaat("prop_ld_shovel"))) && ENTITY::DOES_ENTITY_EXIST(joaat("p_arm_bind_cut_s"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@burial")) && STREAMING::HAS_PTFX_ASSET_LOADED()) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("ROPE_CUT", false, -1)) && AUDIO::PREPARE_MUSIC_EVENT("RE6_BOTH_DEAD_OS"))
	{
		bLocal_50 = true;
	}
	else
...
void func_152()
{
	fLocal_80 = joaat("u_f_y_mistress");
	fLocal_81 = joaat("a_m_m_salton_01");
	fLocal_82 = joaat("a_m_m_salton_01");
	fLocal_83 = joaat("bison");
...
int func_153()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_164())
		{
			return 0;
		}
	}
...
int func_170(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_206(Global_111858.f_24991.f_43[iParam1]))
		{
			return 0;
		}
...
void func_176(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_178(fVar0, iVar1));
		iVar3 = (iVar3 - 1);
		fVar0 = SYSTEM::ROUND(func_177(SYSTEM::TO_FLOAT(fVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
int func_187()
{
	...
	func_188(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_204()) || Global_110905) || Global_30970) || func_203()) || func_84(8, -1)) || func_200()) || func_202()) || func_201()) || func_199()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_204() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_84(8, -1)) || func_199()) || func_198()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_204()) || func_201()) || Global_110905) || Global_30970) || func_203()) || Global_42801) || func_84(8, -1)) || func_200()) || func_198()) || func_199()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
	...
	if (iLocal_122)
	{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_51))
			{
				...
				if (!SYSTEM::VDIST(bLocal_51, 0))
				{
					PED::RESET_PED_LAST_VEHICLE(bLocal_51);
				}
				if (PED::IS_PED_IN_GROUP(bLocal_51))
				{
					PED::REMOVE_PED_FROM_GROUP(bLocal_51);
		...
		while (iVar0 < iLocal_52)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_52[iVar0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				PED::_0xF1C03A5352243A30(iLocal_52[iVar0]);
				if (iLocal_63 || iLocal_70)
				{
					TASK::TASK_COMBAT_PED(iLocal_52[iVar0], unk_0x9B0761B4C3EB8BC7(), 0, 16);
				}
				else
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_52[iVar0], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
		...
		PED::GET_PED_BONE_INDEX(&(iLocal_57[0]));
		PED::GET_PED_BONE_INDEX(&(iLocal_57[1]));
		if (MISC::IS_BIT_SET(bLocal_54))
		{
		...
		if (MISC::IS_BIT_SET(bLocal_56))
		{
			...
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&bLocal_56);
		}
		if (SYSTEM::VMAG(fLocal_123))
		{
			unk_0x93370FA10F15BE44(&fLocal_123);
		...
		while (iLocal_58 <= 1)
		{
			if (SYSTEM::VMAG(fLocal_87[iLocal_58]))
			{
				unk_0x93370FA10F15BE44(&(fLocal_87[iLocal_58]));
			}
			iLocal_58++;
		}
		if (SYSTEM::VMAG(fLocal_88))
