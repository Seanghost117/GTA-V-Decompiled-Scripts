...
void __EntryFunction__()
{
	...
	if (func_454())
	{
		...
		func_332(&bLocal_44, -1100.04f, 280.6f, 63.53f, 267.48f, 0, 0, 1, 1, 0, joaat("asterope"), 0, 145, 1);
...
void func_1()
{
	...
	switch (iLocal_46)
	{
		case 0:
			func_441(&Local_386, 0, 1);
			if (func_440(bLocal_390))
			{
				ENTITY::SET_ENTITY_PROOFS(bLocal_390, false, false, false, false, false, false, false, false);
			}
			if (func_440(bLocal_391))
			{
				ENTITY::SET_ENTITY_PROOFS(bLocal_391, false, false, false, false, false, false, false, false);
			}
			func_260("JOSH4_LOSECOPS", 7500, 1);
			PED::IS_PED_IN_VEHICLE(PLAYER::GET_PLAYER_INDEX(), 2, false);
			...
			{
				TASK::TASK_LOOK_AT_ENTITY(Local_386.f_28[0], unk_0x9B0761B4C3EB8BC7(), -1, 0, 2);
			}
		...
		case 1:
			...
			func_209();
			func_207();
			if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::GET_PLAYER_INDEX()) <= 0 && !func_206())
			{
				iVar0 = 1;
				...
				if (func_204(bLocal_390))
				{
					if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_390, 0))
					{
						func_203(777);
					}
				}
...
float func_208(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
float func_210(bool bParam0, bool bParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
	...
	switch (iLocal_49)
	{
		case 0:
			if (iLocal_48 == 3)
			{
				if (func_440(Local_386.f_28[0]))
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_386.f_28[0]);
					if (func_204(bLocal_391))
					{
						if (MISC::IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, false, true, false, false, false, bLocal_391, false))
						{
							...
							AUDIO::STOP_SCRIPTED_CONVERSATION(Local_386.f_28[0], iLocal_389);
						}
						else
						{
							...
							if (func_204(bLocal_391))
							{
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, bLocal_391, unk_0x9B0761B4C3EB8BC7(), 8, 30f, 786469, 500f, 0.1f, true);
							}
							else
							{
								TASK::TASK_SMART_FLEE_PED(0, unk_0x9B0761B4C3EB8BC7(), 500f, -1, false, false);
					...
					else
					{
						...
						if (func_204(bLocal_391))
						{
							TASK::TASK_ENTER_VEHICLE(0, bLocal_391, 20000, -1, 2f, 1, 0);
							TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, bLocal_391, unk_0x9B0761B4C3EB8BC7(), 8, 30f, 786469, 500f, 0.1f, true);
						}
						else
						{
				...
				PED::SET_PED_CONFIG_FLAG(Local_386.f_28[0], 1);
				PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(Local_386.f_28[0], 2.480298E-43f, 1);
				iLocal_49 = 1;
			}
			break;
		...
		case 1:
			if (func_440(Local_386.f_28[0]))
			{
				...
				if (func_204(bLocal_391))
				{
					if (unk_0xE0B3BC41DDA88DF0(Local_386.f_28[0], bLocal_391, 1))
					{
						if (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(bLocal_391) < 20f)
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_386.f_28[0]);
							TASK::TASK_LEAVE_ANY_VEHICLE(Local_386.f_28[0], 0, 4416);
							TASK::TASK_SMART_FLEE_PED(Local_386.f_28[0], unk_0x9B0761B4C3EB8BC7(), 510f, -1, false, false);
							func_234(&bLocal_391);
						}
					}
					if (func_440(unk_0x9B0761B4C3EB8BC7()))
					{
						if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_391, 1))
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_386.f_28[0]);
							TASK::TASK_SMART_FLEE_PED(Local_386.f_28[0], unk_0x9B0761B4C3EB8BC7(), 510f, -1, false, false);
							func_234(&bLocal_391);
			...
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_386.f_28[0], unk_0x9B0761B4C3EB8BC7(), true))
				{
...
void func_237()
{
	switch (Local_47.f_11)
	{
		case 0:
			...
			while (iLocal_393 <= 4)
			{
				if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_415[iLocal_393 /*7*/], Local_415[iLocal_393 /*7*/].f_3, Local_415[iLocal_393 /*7*/].f_6, 0, 1, 2))
				{
					...
					while ((!VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(Local_47.f_9, Local_47.f_10) || !ENTITY::DOES_ENTITY_EXIST(iLocal_43)) || !ENTITY::DOES_ENTITY_EXIST(iLocal_42))
					{
						SYSTEM::WAIT(0);
					}
		...
		case 1:
			if (!MISC::IS_BIT_SET(Local_47.f_7))
			{
				...
				unk_0x92BD213E6A0E666B(Local_47.f_8, joaat("weapon_pistol"), -1, 0, 1);
				PED::_0x2208438012482A1A(Local_47.f_8, 1);
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_47.f_8);
		...
		case 2:
			if (func_204(Local_47.f_7))
			{
				...
				{
					if (SYSTEM::VDIST(Local_47.f_8, 0))
					{
		...
		case 4:
			if (func_204(Local_47.f_7))
			{
				if (func_440(Local_47.f_8))
				{
					PED::_0x2208438012482A1A(Local_47.f_8, 0);
	...
	switch (iLocal_48)
	{
		...
		case 2:
			if ((MISC::GET_GAME_TIMER() - iLocal_394) > 20000)
			{
				...
				if (func_440(Local_386.f_28[1]))
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_386.f_28[1]);
					PED::_0x2208438012482A1A(Local_386.f_28[1], 0);
					TASK::TASK_ARREST_PED(Local_386.f_28[1], unk_0x9B0761B4C3EB8BC7());
				}
				iLocal_48 = 4;
				iLocal_394 = MISC::GET_GAME_TIMER();
			}
		...
		case 3:
			...
			if (!iLocal_399)
			{
				...
				while (iVar0 <= (Local_386.f_28 - 1))
				{
					if (func_440(Local_386.f_28[iVar0]))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_386.f_28[iVar0]);
						PED::_0x2208438012482A1A(Local_386.f_28[iVar0], 0);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
						TASK::TASK_SHOOT_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, -687903391);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_389);
						AUDIO::STOP_SCRIPTED_CONVERSATION(Local_386.f_28[iVar0], iLocal_389);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_389);
					}
					iVar0++;
				}
		...
		while (iVar0 <= (Local_386.f_28 - 1))
		{
			if (func_440(Local_386.f_28[iVar0]))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_386.f_28[iVar0]))
				{
					...
					if (!MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(unk_0x9B0761B4C3EB8BC7(), &iVar2, 1))
					{
	...
	if (func_440(unk_0x9B0761B4C3EB8BC7()) && func_440(bParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				{
					return func_253(unk_0x9B0761B4C3EB8BC7(), bParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
{
	return func_243(bParam0, unk_0x9B0761B4C3EB8BC7(), fParam1, 1, 250, 7);
}

bool func_243(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	
	iVar2 = func_251(bParam0, bParam1);
	...
	uVar0 = func_244(&(Local_35[iVar2 /*4*/]), Var1, bParam1, &(Local_35[iVar2 /*4*/].f_3), bParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_244(var uParam0, struct<3> Param1, bool bParam2, var uParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_245(bool bParam0, bool bParam1)
{
	bool bVar0;
...
bool func_253(bool bParam0, bool bParam1, float fParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_256(bool bParam0, float fParam1)
{
	...
	{
		if (func_257(bParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_257(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
void func_262()
{
	...
	{
		case 0:
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bLocal_41, ""))
			{
				if (iLocal_400 == 0)
				{
					func_298(bLocal_41, 0);
				}
				iLocal_408 = 0;
				iLocal_46 = 1;
			}
		...
		case 1:
			switch (iLocal_408)
			{
				case 0:
					if (func_290(1, 1093140480, 0))
					{
						...
						if (func_204(bVar0))
						{
							...
							else if (unk_0x1037B9D45CE6B788(bVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, 1, 0))
							{
						...
						if (func_204(bLocal_390))
						{
							unk_0x03D382CB0B44E2FC(bLocal_390, -1107.5f, 280.33f, 64.01f, 1, 0, 0, 1);
							ENTITY::SET_ENTITY_HEADING(bLocal_390, 97.97f);
							VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_390, 5f);
						}
						iLocal_408++;
					}
					break;
				...
				case 2:
					if (((STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh4") && STREAMING::HAS_ANIM_DICT_LOADED("combat@gestures@pistol@halt")) && STREAMING::HAS_ANIM_DICT_LOADED("combat@gestures@pistol@glances")) && ENTITY::DOES_ENTITY_EXIST(iLocal_392))
					{
						iLocal_408++;
					}
					break;
...
void func_273()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_440(Local_386.f_28[0]))
		{
			...
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK::TASK_LOOK_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, 2, 2);
	...
	{
		if (func_440(bLocal_387) && func_440(Local_386.f_28[1]))
		{
			WEAPON::GIVE_WEAPON_OBJECT_TO_PED(bLocal_387, Local_386.f_28[1]);
			func_488("*** Gave idle cop gun");
		}
	}
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("FBI_Agent_1_Gun", 0))
	{
		if (func_440(bLocal_388) && func_440(Local_386.f_28[2]))
		{
			WEAPON::GIVE_WEAPON_OBJECT_TO_PED(bLocal_388, Local_386.f_28[2]);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (func_440(Local_386.f_28[1]))
		{
			...
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK::TASK_LOOK_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, 1026, 2);
			...
			TASK::CLOSE_SEQUENCE_TASK(iLocal_389);
			AUDIO::STOP_SCRIPTED_CONVERSATION(Local_386.f_28[1], iLocal_389);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_389);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0))
	{
		if (func_440(Local_386.f_28[2]))
		{
			...
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK::TASK_LOOK_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, 1026, 2);
			TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1103.72f, 289.46f, 63.23f, unk_0x9B0761B4C3EB8BC7(), 1f, false, 0.1f, 4f, true, 0, true, -957453492, 20000);
			TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1106.08f, 288.55f, 63.31f, unk_0x9B0761B4C3EB8BC7(), 1f, false, 0.1f, 4f, true, 0, true, -957453492, 20000);
			TASK::TASK_AIM_GUN_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, true);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_389);
			AUDIO::STOP_SCRIPTED_CONVERSATION(Local_386.f_28[2], iLocal_389);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_389);
	...
	if (MISC::IS_BIT_SET(bVar0))
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_285(bVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_285(bool bParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
void func_289()
{
	if (func_440(unk_0x9B0761B4C3EB8BC7()))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(unk_0x9B0761B4C3EB8BC7(), "Trevor", 0, 0, 0);
	...
	if (func_440(Local_386.f_28[1]))
	{
		bLocal_387 = WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_pistol"), -1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_386.f_28[1], 1), true, 1f, 0, 0, 1);
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_386.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_488("*** Registered Cop standing");
	}
	if (func_440(Local_386.f_28[2]))
	{
		bLocal_388 = WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_pistol"), -1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_386.f_28[2], 1), true, 1f, 0, 0, 1);
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_386.f_28[2], "Cop_with_notepad", 0, 0, 0);
		func_488("*** Registered Cop with notepad");
	}
	if (func_440(bLocal_387))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_387, "Security_guard_pistol", 0, 0, 0);
		func_488("*** Registered idle cop gun");
	}
	if (func_440(bLocal_388))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_388, "FBI_Agent_1_Gun", 0, 0, 0);
...
int func_290(int iParam0, float fParam1, int iParam2)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_294(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_294(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_297(int iParam0)
{
	...
	STREAMING::REQUEST_ANIM_DICT("combat@gestures@pistol@glances");
	unk_0x78FCB2E22C41B9D5(iLocal_392);
	while ((!STREAMING::HAS_ANIM_DICT_LOADED("combat@gestures@pistol@halt") || !STREAMING::HAS_ANIM_DICT_LOADED("combat@gestures@pistol@glances")) || !ENTITY::DOES_ENTITY_EXIST(iLocal_392))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (func_440(Local_386.f_28[0]))
	{
		if (iParam0 == 1)
		{
			unk_0x03D382CB0B44E2FC(Local_386.f_28[0], -1103.962f, 291.3401f, 63.367f, 1, 0, 0, 1);
	...
	if (iParam0 == 1)
	{
		if (func_440(Local_386.f_28[2]))
		{
			unk_0x92BD213E6A0E666B(Local_386.f_28[2], joaat("weapon_pistol"), -1, 1, 1);
			unk_0x03D382CB0B44E2FC(Local_386.f_28[2], -1106.08f, 288.55f, 63.31f, 1, 0, 0, 1);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK::TASK_AIM_GUN_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, true);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_389);
			AUDIO::STOP_SCRIPTED_CONVERSATION(Local_386.f_28[2], iLocal_389);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_389);
			PED::_0x2208438012482A1A(Local_386.f_28[2], 1);
		}
	}
	if (iParam0 == 1)
	{
		if (func_440(Local_386.f_28[1]))
		{
			unk_0x92BD213E6A0E666B(Local_386.f_28[1], joaat("weapon_pistol"), -1, 1, 1);
			unk_0x03D382CB0B44E2FC(Local_386.f_28[1], -1102.41f, 289.73f, 63.18f, 1, 0, 0, 1);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK::TASK_AIM_GUN_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, true);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_389);
			AUDIO::STOP_SCRIPTED_CONVERSATION(Local_386.f_28[1], iLocal_389);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_389);
			PED::_0x2208438012482A1A(Local_386.f_28[1], 1);
		}
	}
	if (func_440(Local_386.f_28[1]))
	{
...
{
	func_278(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(bParam0, 8);
}
		...
		case 1:
			if (!func_5(0) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
				if (func_440(unk_0x9B0761B4C3EB8BC7()) && func_264(Local_386.f_28[0]))
				{
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, 1, 0))
					{
						if (!func_300())
						{
							...
							{
								TASK::TASK_TURN_PED_TO_FACE_ENTITY(unk_0x9B0761B4C3EB8BC7(), Local_386.f_28[0], 0);
							}
						}
						else
						{
							func_292();
							MONEY::NETWORK_MONEY_CAN_BET(0, 30, true);
							MONEY::NETWORK_MONEY_CAN_BET(0, 31, true);
				...
				if (!iLocal_400)
				{
					...
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_386.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_206())
						{
				...
				else
				{
					...
					if (func_264(Local_386.f_28[0]))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.276f)
							{
								if (iLocal_401 == 0)
								{
							...
							if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.98f)
							{
								func_296(1);
							}
...
void func_302()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_294(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_322(0) || Global_77102) || Global_77091 == 1) || !GRAPHICS::DRAW_SCALEFORM_MOVIE())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((OBJECT::ADD_DOOR_TO_SYSTEM() || func_307(0)) || func_321(1))
			{
			}
			else
			{
...
void func_325()
{
	...
	func_297(1);
	unk_0x78FCB2E22C41B9D5(iLocal_392);
	while (!ENTITY::DOES_ENTITY_EXIST(iLocal_392))
	{
		SYSTEM::WAIT(0);
	}
	func_296(2);
...
void func_327(bool bParam0, int iParam1, int iParam2)
{
...
int func_328(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(-1502457334, 0f, false, false);
	...
	if (bParam1)
	{
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(-1994188940, 0f, false, false);
...
int func_329(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		...
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(904342475, 1f, false, false);
	...
	if (bParam1)
	{
		...
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(-795418380, -0.9f, false, false);
...
int func_330(bool bParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_332(bool bParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_406(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		{
			func_397(iParam10, 0);
			while (!func_333(bParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_333(bool bParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_391(bParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_391(bParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (MISC::GET_MODEL_DIMENSIONS(*bParam0) == joaat("bodhi2"))
...
void func_334(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	if ((func_152(iParam0) && MISC::IS_BIT_SET(*bParam1)) && ENTITY::GET_ENTITY_COORDS(*bParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*bParam1) >= 0 && func_339(*bParam1, 0, &uVar0))
		{
			func_338(bParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_337(*bParam1);
...
int func_339(bool bParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	fVar0 = MISC::GET_MODEL_DIMENSIONS(bParam0);
	if ((!func_367(fVar0, bParam1, uParam2) && !func_366(PLAYER::PLAYER_ID())) && !func_349(bParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_347(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_345(bParam0)) && !bVar1) && !(func_344(MISC::GET_MODEL_DIMENSIONS(bParam0)) && func_341(PLAYER::PLAYER_ID())))
	{
	...
	if (!MISC::SET_BIT())
	{
		if ((func_340(bParam0) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("sentinel2")) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_351(bool bParam0)
{
	...
	if (func_352(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		return 1;
	}
	return 0;
...
int func_353(bool bParam0, bool bParam1)
{
	switch (MISC::GET_MODEL_DIMENSIONS(bParam0))
	{
		...
		case joaat("insurgent"):
			if (func_355(MISC::GET_MODEL_DIMENSIONS(bParam0), 0))
			{
				if (Global_2540384.f_303 == bParam0)
				{
					return 1;
				}
				else if (func_354(bParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_355(void fParam0, int iParam1)
{
	if (iParam1 == 0)
	{
		if (func_363(fParam0, 0))
		{
			return 1;
		}
	}
...
int func_367(void fParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_347(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fParam0)))
	{
		bVar0 = true;
	}
...
void func_369(bool bParam0, int iParam1)
{
	...
	func_370(bParam0, &(Global_111858.f_32745.f_5510));
}
...
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_283(bParam0, 0, 0)) || func_283(bParam0, 1, 0)) || func_283(bParam0, 2, 0)) || func_387(bParam0) != 145) || func_386(bParam0)) || func_385(bParam0)) || func_340(bParam0)) || func_384(bParam0)) || !func_374(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_385(bParam0))
		{
		}
		...
		if (func_283(bParam0, 0, 0))
		{
		}
		if (func_283(bParam0, 1, 0))
		{
		}
		if (func_283(bParam0, 2, 0))
		{
		}
...
int func_374(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_375(fParam0, 0))
	{
		return 0;
	}
...
int func_375(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
int func_391(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_363(MISC::GET_MODEL_DIMENSIONS(*iParam0), 1) && unk_0x7F8B14CBFB9813E5(*iParam0, 24) != func_394(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_397(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || MISC::GET_MODEL_DIMENSIONS(Global_96286[iVar0]) == func_398(iParam0, iParam1))
				{
...
bool func_406(struct<3> Param0, float fParam1)
{
	return func_407(&(Global_105407.f_2890), Param0, fParam1, 0);
}

bool func_407(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	bool bVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_424(uParam0))
	{
		...
		if (func_423(uParam0))
		{
			...
			if (MISC::IS_BIT_SET(bVar0))
			{
				...
				func_412(bVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
				...
				else if ((!func_409(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS(TASK::IS_PED_BEING_ARRESTED(), "startup_positioning"))
				{
					iVar4 = func_408(bVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_409(bool bParam0, struct<3> Param1, bool bParam2)
{
	void fVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_411(bParam0, Global_75654.f_139[38], 0))
			{
				func_400(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_411(bParam0, Global_75654.f_139[43], 1))
			{
				func_400(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_411(bParam0, uVar1[iVar3], 1) && func_410(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_405(Param1, 0f, 0f, 0f, 0)) || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&bParam0);
						return 1;
					}
...
void func_412(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::GET_ENTITY_COORDS(iParam0, false))
	{
		...
		if (((unk_0xCE990E643CD9D0E5(uParam1->f_77, 15) || func_415(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_414())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_439()
{
	...
	HUD::HAS_ADDITIONAL_TEXT_LOADED("JOSH4", 0);
		...
		case 2:
			...
			if (!MISC::IS_BIT_SET(uParam0->f_28[2]))
			{
				...
				if (func_440(uParam0->f_28[2]))
				{
					...
					if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(uParam0->f_28[2]);
...
void func_443(char* sParam0, bool bParam1)
{
	...
	func_444(sParam0, iLocal_39, Var0, fVar1);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*sParam0, 4);
	VEHICLE::SET_VEHICLE_DOORS_LOCKED(*sParam0, 3);
	VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(*sParam0, false, 0);
	VEHICLE::SET_VEHICLE_DISABLE_TOWING(*sParam0, true);
}

void func_444(char* sParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_232(sParam0);
