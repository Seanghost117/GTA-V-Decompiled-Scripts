...
int func_113(int iParam0)
{
	...
	{
		if (!CAM::IS_SCREEN_FADED_OUT(&(iParam0->f_9)))
		{
			func_133(1);
...
void func_148()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_149(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_149(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_166()
{
	return func_167(TASK::IS_PED_BEING_ARRESTED(), 0);
}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_183()) || Global_110905) || Global_30970) || func_182()) || func_181(8, -1)) || func_179()) || func_93()) || func_180()) || func_178()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_183() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_181(8, -1)) || func_178()) || func_177()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_184(var uParam0)
{
	...
	if (func_178() || LOCALIZATION::GET_CURRENT_LANGUAGE())
	{
		unk_0xBE4122AC23440E7D(0);
		return;
	}
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		fVar0 = SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_52);
			...
			switch (iLocal_57)
			{
				case 0:
					if (!func_146())
					{
						...
						if (*uParam0 == 58)
						{
							...
							if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_5@franklin_5a", "hey_franklin_0", 2f, -4f, -1, 262144, 0f, false, false, false);
								TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_5@franklin_5b", "hey_franklin_1", 4f, -4f, -1, 262144, 0f, false, false, false);
								TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_5@franklin_5c", "hey_franklin_2", 4f, -4f, -1, 262144, 0f, false, false, false);
								TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0f, false, false, false);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
								AUDIO::STOP_SCRIPTED_CONVERSATION(uParam0->f_28[0], iLocal_54);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
							}
						}
						else if (*uParam0 == 59)
						{
							...
							if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
							{
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
								TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_5@franklin_5a", "hey_franklin_0", 4f, -4f, -1, 262144, 0f, false, false, false);
								TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_5@franklin_5b", "hey_franklin_1", 4f, -4f, -1, 262144, 0f, false, false, false);
								TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_5@franklin_5c", "hey_franklin_2", 4f, -4f, -1, 262144, 0f, false, false, false);
								TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0f, false, false, false);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
								AUDIO::STOP_SCRIPTED_CONVERSATION(uParam0->f_28[0], iLocal_54);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
							}
				...
				case 1:
					if (!func_146())
					{
						if (func_191(&iLocal_223))
						{
							if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
							{
								TASK::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], unk_0x9B0761B4C3EB8BC7(), -1, 0, 4);
							}
							func_188(&iLocal_223);
							iLocal_57 = 2;
						}
								...
								case 1:
									if (*uParam0 == 58)
									{
										...
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_4@franklin_4a", "whats_wrong_with_you_0", 2f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_4@franklin_4b", "whats_wrong_with_you_1", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_4@franklin_4c", "whats_wrong_with_you_2", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0f, false, false, false);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
											AUDIO::STOP_SCRIPTED_CONVERSATION(uParam0->f_28[0], iLocal_54);
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_4@franklin_4a", "whats_wrong_with_you_0", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_4@franklin_4b", "whats_wrong_with_you_1", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_4@franklin_4c", "whats_wrong_with_you_2", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0f, false, false, false);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
								...
								case 2:
									if (*uParam0 == 58)
									{
										...
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_1@franklin_1a", "seriously_franklin_get_your_fat_0", 2f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_1@franklin_1b", "seriously_franklin_get_your_fat_1", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_1@franklin_1c", "seriously_franklin_get_your_fat_2", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0f, false, false, false);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
											AUDIO::STOP_SCRIPTED_CONVERSATION(uParam0->f_28[0], iLocal_54);
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_1@franklin_1a", "seriously_franklin_get_your_fat_0", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_1@franklin_1b", "seriously_franklin_get_your_fat_1", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_1@franklin_1c", "seriously_franklin_get_your_fat_2", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0f, false, false, false);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
								...
								case 3:
									if (*uParam0 == 58)
									{
										...
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_3@franklin_3a", "dont_be_actin_like_you_dont_know_me_0", 2f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_3@franklin_3b", "dont_be_actin_like_you_dont_know_me_1", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0f, false, false, false);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
											AUDIO::STOP_SCRIPTED_CONVERSATION(uParam0->f_28[0], iLocal_54);
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_3@franklin_3a", "dont_be_actin_like_you_dont_know_me_0", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_3@franklin_3b", "dont_be_actin_like_you_dont_know_me_1", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0f, false, false, false);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
											AUDIO::STOP_SCRIPTED_CONVERSATION(uParam0->f_28[0], iLocal_54);
								...
								case 4:
									if (*uParam0 == 58)
									{
										...
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_2@franklin_2a", "seriously_franklin_im_tonya_0", 2f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_2@franklin_2b", "seriously_franklin_im_tonya_1", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_2@franklin_2c", "seriously_franklin_im_tonya_2", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0f, false, false, false);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
											AUDIO::STOP_SCRIPTED_CONVERSATION(uParam0->f_28[0], iLocal_54);
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_28[0], 0))
										{
											TASK::CLEAR_SEQUENCE_TASK(&iLocal_54);
											TASK::OPEN_SEQUENCE_TASK(&iLocal_54);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_2@franklin_2a", "seriously_franklin_im_tonya_0", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_2@franklin_2b", "seriously_franklin_im_tonya_1", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@franklin_2@franklin_2c", "seriously_franklin_im_tonya_2", 4f, -4f, -1, 262144, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0f, false, false, false);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_54);
...
void func_205(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_206(int iParam0, bool bParam1, struct<3> Param2)
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
...
float func_210(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_216(bool bParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_127(bParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_218(uParam1) || !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_217(iParam2) && !PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(bParam0, unk_0x9B0761B4C3EB8BC7(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_218(uParam1) && uParam1->f_4 == 0) && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_217(iParam2) || PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
bool func_229(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_230(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_230(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_233(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_235(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_235(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_239(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0))
	{
		...
		else
		{
			...
			else
			{
				...
				if (func_243(bParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
			if (func_240(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_240(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_242(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_235(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_243(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
...
int func_253(int iParam0)
{
	...
	fLocal_53 = PATHFIND::SET_ROADS_IN_AREA(Local_52 - Vector(10f, 10f, 10f), Local_52 + Vector(10f, 10f, 10f), false, true, 1, 1);
	iLocal_55 = 1;
...
int func_254(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_127(uParam0->f_28[0]) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
			{
				TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				TASK::OPEN_SEQUENCE_TASK(&iVar1);
				TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@intro", "idle_intro", 4f, -4f, -1, 262144, 0f, false, false, false);
				TASK::TASK_PLAY_ANIM(false, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0f, false, false, false);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1);
				TASK::CLOSE_SEQUENCE_TASK(iVar1);
				AUDIO::STOP_SCRIPTED_CONVERSATION(uParam0->f_28[0], iVar1);
				TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				TASK::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], unk_0x9B0761B4C3EB8BC7(), -1, 0, 4);
			}
...
void func_268(int iParam0, bool bParam1)
{
	...
	if (iLocal_55)
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_53, 0);
	}
	func_284("SCRIPT TERMINATED");
	ENTITY::STOP_ENTITY_ANIM();
}
