...
int func_9(int iParam0, var uParam1)
{
	...
	fVar6 = (200f * 200f);
	iVar8 = iParam0;
	uVar9 = unk_0x1FA7B77001D60F9D(iVar8);
	if (iVar3 > -1)
	{
		if (iVar3 != iParam0)
		{
						...
						if (func_12(iVar1))
						{
							...
							if (iVar12 != -1)
							{
								if (Global_2425698.f_87[iVar12] == 0)
								{
									if (!unk_0xCE990E643CD9D0E5(*uParam1, iVar1))
									{
										if (!unk_0x5AEB5DDFFAD43CA5(uVar9))
										{
											if (!unk_0x5AEB5DDFFAD43CA5(uVar11))
											{
												Var7 = { func_10(iVar1) };
												fVar4 = SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(uVar9, 1), Var7);
												if (fVar4 > fVar6)
												{
													fVar5 = SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(uVar11, 1), Var7);
													if (fVar5 > fVar6)
													{
														iVar2 = iVar1;
														bVar0 = true;
				...
				if (unk_0xCE990E643CD9D0E5(Global_1590682[iVar3 /*883*/].f_146, 0))
				{
					...
					if (unk_0xCE990E643CD9D0E5(Global_1655114, 1))
					{
						...
						if (iVar1 > -1)
						{
							...
							func_288(1);
							func_24(8, 1);
							uVar6 = func_144(1190, -1, 0);
							unk_0xD2459066EA58CE43(&uVar6, 1);
							unk_0xD2459066EA58CE43(&uVar6, 2);
							unk_0xD2459066EA58CE43(&uVar6, 3);
							unk_0xD2459066EA58CE43(&uVar6, 5);
							unk_0xD2459066EA58CE43(&uVar6, 6);
							*uParam0 = 1;
							func_143(1190, uVar6, -1, 1, 0);
			...
			else
			{
				...
				else
				{
					if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
					{
						if (!unk_0xCE990E643CD9D0E5(uParam0->f_1, 2))
						{
							if ((!unk_0xCE990E643CD9D0E5(iLocal_165, 18) && SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), func_10(iVar1)) > (35f * 35f)) || (unk_0xCE990E643CD9D0E5(iLocal_165, 18) && SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), func_10(iVar1)) > (90f * 90f)))
							{
								unk_0xD2459066EA58CE43(&(uParam0->f_1), 0);
								unk_0xD2459066EA58CE43(&(Global_1590682[iVar3 /*883*/].f_146), 2);
				...
				if (!unk_0xCE990E643CD9D0E5(iLocal_165, 5) || (unk_0xCE990E643CD9D0E5(iLocal_165, 5) && func_19(&uLocal_161, 60000, 0)))
				{
					if (func_280())
					{
						...
						else
						{
							...
							if (func_269(&uLocal_166, 19, "FM_1AU", "FM_HOLD", uVar0, 0))
							{
...
int func_166(int iParam0, char* sParam1, char* sParam2, bool bParam3, int iParam4, char* sParam5, char* sParam6, bool bParam7, var uParam8)
{
	...
	return func_167(&uVar0, iParam0, func_266(), sParam1, iVar1, 3, uParam8, sParam2, bParam3, iParam4, sParam5, sParam6, -1);
}
...
void func_317(var uParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!unk_0x25DDB354A40FFCDB())
	{
		func_300();
