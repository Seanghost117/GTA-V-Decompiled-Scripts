		...
		if (unk_0xAE06B9E39EBDE049(uLocal_53) && !unk_0xA59F96B50B97E63C(iLocal_53, 0))
		{
			...
			switch (iLocal_59)
			{
				...
				case 6:
					...
					if (func_87(uLocal_58, 2097152))
					{
						if (!func_73(3) && !unk_0x7FD2BDF03806FD9D(uLocal_50))
						{
							func_80(10);
						}
					}
...
void func_38()
{
	...
	if ((unk_0xAE06B9E39EBDE049(iLocal_84) && !unk_0xA59F96B50B97E63C(iLocal_84, 0)) && !unk_0x0922C2E075A5F18C(iLocal_84))
	{
		...
		unk_0x74172B5AFD503628(iLocal_84, 0, 0);
		unk_0x1AB8D7ECA49F6A6C(iLocal_84, 1);
		uLocal_82 = iLocal_84;
		if (unk_0xAE06B9E39EBDE049(iLocal_83) && !unk_0xA59F96B50B97E63C(iLocal_83, 0))
		{
			unk_0x1515637D39F697C4(iLocal_83, 1);
			unk_0x1AB8D7ECA49F6A6C(iLocal_83, 1);
			unk_0x74172B5AFD503628(iLocal_83, 0, 0);
...
void func_77()
{
	if (bLocal_85)
	{
		...
		if (!iLocal_87)
		{
			...
			if (!unk_0xAE06B9E39EBDE049(iLocal_83))
			{
				iLocal_83 = unk_0xCE4780E24AFDFBF9(joaat("blazer"), -1707.434f, 4666.563f, 22.1095f, 323.2491f, 1, 1, 0);
			}
			if (!unk_0xAE06B9E39EBDE049(iLocal_84))
			{
				iLocal_84 = unk_0xCE4780E24AFDFBF9(joaat("journey"), -1702.695f, 4666.941f, 22.7091f, 80.03f, 1, 1, 0);
				unk_0x494ACC4552B7881B(iLocal_84, 1);
			}
			iLocal_87 = 1;
		}
	}
