...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_173())
		{
			...
			{
				fLocal_31 = SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_32);
			}
			func_171(&iVar1);
			func_31(&iVar2);
			if (iLocal_39 > 3)
...
void func_4(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, int iParam5)
{
	bool bVar0;
	...
	if (func_19(bParam2, &bVar0, iParam3, iParam5))
	{
		func_5(uParam0, uParam1, bVar0, iParam4);
	}
...
int func_5(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	...
	{
		func_7(uParam0, bParam2, iParam3);
		uParam1->f_4 = bParam2;
		if (func_6(bParam2))
		{
			uParam1->f_3 = 1;
...
void func_7(var uParam0, bool bParam1, int iParam2)
{
	func_14(bParam1, &(uParam0->f_12));
	uParam0->f_7 = func_10(bParam1, 145, 0);
	uParam0->f_11 = func_9(bParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
			uParam0->f_10 = func_8(bParam1);
		}
	}
	if (iParam2 == 1)
	{
...
int func_10(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == bParam0)
			{
				...
				{
					if (iParam2 == 0 || MISC::GET_MODEL_DIMENSIONS(bParam0) == func_11(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_14(bool bParam0, var uParam1)
{
	int iVar0;
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_16(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
int func_19(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	bool bVar0;
...
void func_31(int iParam0)
{
	...
	switch (iLocal_43)
	{
		...
		case 3:
			if (ENTITY::DOES_ENTITY_EXIST(joaat("dune")))
			{
				MISC::CLEAR_AREA_OF_VEHICLES(Local_45, 4f, false, false, false, false, false, false);
				if (MISC::IS_BIT_SET(bLocal_44))
				{
					VEHICLE::DELETE_VEHICLE(&bLocal_44);
				}
				bLocal_44 = VEHICLE::CREATE_VEHICLE(func_162(), Local_45, fLocal_46, true, true, false);
				AUDIO::SET_VEHICLE_RADIO_ENABLED(bLocal_44, false);
				unk_0x74528AC0906CBABE(func_162());
				if (MISC::IS_BIT_SET(bLocal_44))
				{
					if (VEHICLE::DOES_EXTRA_EXIST(bLocal_44, 1))
					{
						VEHICLE::SET_VEHICLE_EXTRA(bLocal_44, 1, true);
					}
					if (VEHICLE::DOES_EXTRA_EXIST(bLocal_44, 2))
					{
						VEHICLE::SET_VEHICLE_EXTRA(bLocal_44, 2, false);
					}
					if (VEHICLE::DOES_EXTRA_EXIST(bLocal_44, 3))
					{
						VEHICLE::SET_VEHICLE_EXTRA(bLocal_44, 3, false);
					}
					VEHICLE::SET_VEHICLE_COLOURS(bLocal_44, 0, 0);
				}
				iLocal_43 = 4;
			}
			break;
		...
		case 4:
			...
			if (!bVar0 && !*iParam0)
			{
				...
				if (!iLocal_47)
				{
					if (SYSTEM::VDIST(bLocal_28, 0))
					{
						iVar1 = STATS::GET_PACKED_BOOL_STAT_KEY(bLocal_28);
						if (iVar1 == bLocal_44)
						{
							iLocal_47 = 1;
							STREAMING::REMOVE_ANIM_DICT(&bLocal_44);
							iLocal_43 = 9;
						}
					}
				}
			...
			if (*iParam0)
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_44, 0))
				{
					PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), bLocal_44, -1);
				}
			}
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_44, 0))
			{
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_44, 1))
				{
					func_160();
				}
			}
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_44, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					...
					if (iVar2 == bLocal_44)
					{
						if (SYSTEM::VDIST2(Local_45, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_28, 1)) < 100f)
						{
							SCRIPT::REQUEST_SCRIPT("Traffick_Ground");
							if (MISC::IS_BIT_SET(bLocal_29) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_29, 0))
							{
								if (MISC::GET_MODEL_DIMENSIONS(bLocal_29) != joaat("dune") && MISC::GET_MODEL_DIMENSIONS(bLocal_29) != joaat("cuban800"))
								{
									func_133(bLocal_29, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
								}
								else if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
								{
									VEHICLE::SET_PLAYERS_LAST_VEHICLE(bLocal_29);
								}
							}
							iLocal_43 = 6;
						}
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				if (iVar3 == 1)
				{
					...
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_44, true, false);
					STREAMING::REMOVE_ANIM_DICT(&bLocal_44);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_30))
			{
				...
				else
				{
					...
					Global_111858.f_19979.f_12 = bVar5;
					func_1(106, 0, 0);
					Global_111858.f_19979.f_13 = 0;
				}
				*iParam0 = 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_40(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
void func_45(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	iVar2 = func_37(*bParam0);
	iVar3 = func_36(*bParam0);
	iVar4 = func_35(*bParam0);
	...
	iVar0 = (iVar0 + iParam6);
	func_46(bParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
bool func_53()
{
	...
	func_50(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_48(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_49(&uVar0, CLOCK::GET_CLOCK_YEAR());
	func_47(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
{
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_98955.f_20), 17);
	func_83(bParam0, iParam1, 0);
}

void func_83(char[4] cParam0, int iParam1, bool bParam2)
{
	if (Global_98955 != 10 && Global_98955 != 9)
	{
		StringCopy(&Global_102415, cParam0, 32);
		func_85(&Global_102423, cParam0, 0, "Start", iParam1, bParam2);
		func_84();
		Global_93133 = 0;
	}
}
...
void func_85(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_22();
	...
	if (iParam4 == 1)
	{
		func_4(&(uParam0->f_2890), uParam0, bParam5, 1, 1, 0);
	}
...
void func_87(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		...
		while (iVar1 < 12)
		{
			func_93(bParam0, iVar1, &(uParam1->f_13[iVar1]), uParam1[iVar1], &(uParam1->f_26[iVar1]), iParam2, 145);
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 9)
		{
			func_92(bParam0, iVar1, &(uParam1->f_39[iVar1]), &(uParam1->f_49[iVar1]), iParam2, 145);
			iVar1++;
		}
		if (func_13(iVar0))
		{
...
void func_92(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_93(bool bParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_95(bool bParam0, bool bParam1)
{
	...
	if (func_13(iVar0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		if (bParam0 == unk_0x9B0761B4C3EB8BC7())
		{
			func_96(bParam0, &(Global_111858.f_2359.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_96(bool bParam0, var uParam1)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(bParam0, func_101(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_98(Var7.f_1)) && iVar9 < 51)
			{
...
int func_107(var uParam0)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_130())
		{
			*uParam0 = func_113(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_113(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam1 == 6 || iParam1 == func_129(iVar0))
		{
			...
			{
				fVar1 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Param0, func_114(iVar0, 0), 1);
...
void func_133(bool bParam0, struct<3> Param1, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (MISC::IS_BIT_SET(bParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		func_153(iParam3, &Var0, Param1, bParam2, func_9(bParam0));
...
void func_135(bool bParam0, int iParam1)
{
	...
	func_14(bParam0, &(Global_111858.f_32745.f_5510));
}

int func_136(bool bParam0)
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_20(bParam0, 0, 0)) || func_20(bParam0, 1, 0)) || func_20(bParam0, 2, 0)) || func_9(bParam0) != 145) || func_150(bParam0)) || func_149(bParam0)) || func_148(bParam0)) || func_147(bParam0)) || !func_137(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_149(bParam0))
		{
		}
		...
		if (func_20(bParam0, 0, 0))
		{
		}
		if (func_20(bParam0, 1, 0))
		{
		}
		if (func_20(bParam0, 2, 0))
		{
		}
		if (func_9(bParam0) != 145)
		{
		}
		return 0;
	}
...
void func_153(int iParam0, var uParam1, struct<3> Param2, bool bParam3, int iParam4)
{
	if (func_152(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
void func_161()
{
	...
	if (!MISC::IS_BIT_SET(bLocal_29))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_32) < 2500f)
			{
				bLocal_29 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
				if (MISC::IS_BIT_SET(bLocal_29))
				{
					fVar0 = MISC::GET_MODEL_DIMENSIONS(bLocal_29);
					if (fVar0 == joaat("dune"))
					{
					}
				}
...
int func_164()
{
	if (func_28(9))
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("trevor2")) == 1)
		{
			if (!iLocal_36[0])
			{
				iLocal_36[0] = 1;
		...
		if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("finale_heist2b")) == 1)
		{
			if (!iLocal_36[1])
			{
				iLocal_36[1] = 1;
		...
		if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("traffick_air")) == 1)
		{
			if (!iLocal_36[2])
			{
				iLocal_36[2] = 1;
		...
		if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("traffick_ground")) == 1)
		{
			if (!iLocal_36[3])
			{
				iLocal_36[3] = 1;
...
void func_168(bool bParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
void func_171(int iParam0)
{
	...
	switch (iLocal_39)
	{
		...
		case 3:
			unk_0x78FCB2E22C41B9D5(joaat("cuban800"));
			if (ENTITY::DOES_ENTITY_EXIST(joaat("cuban800")))
			{
				if (!MISC::IS_BIT_SET(iLocal_40))
				{
					MISC::CLEAR_AREA_OF_VEHICLES(Local_42, 8f, false, false, false, false, false, false);
					bLocal_40 = VEHICLE::CREATE_VEHICLE(joaat("cuban800"), Local_42, 25.29f, true, true, false);
					unk_0x74528AC0906CBABE(joaat("cuban800"));
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(bLocal_40, 2);
		...
		case 4:
			...
			{
				if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_40, 0) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					iLocal_39 = 9;
					return;
				}
			...
			if (func_28(9))
			{
				if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("traffick_ground")) == 1)
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_40, 0))
					{
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_40, 2);
						return;
					}
				}
			}
			else if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("traffick_ground")) == 0)
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_40, 0))
				{
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_40, 1);
				}
			}
			if (!bLocal_35)
			{
			...
			if (!bVar0 && !*iParam0)
			{
				if (!iLocal_41)
				{
					if (SYSTEM::VDIST(bLocal_28, 0))
					{
						...
						{
							iLocal_41 = 1;
							STREAMING::REMOVE_ANIM_DICT(&bLocal_40);
							iLocal_39 = 9;
						}
					}
				}
			...
			if (*iParam0)
			{
				PED::SET_PED_INTO_VEHICLE(bLocal_28, bLocal_40, -1);
			}
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_40, 0))
			{
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_40, 1))
				{
					func_160();
				}
			}
				...
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					...
					if (iVar2 == bLocal_40)
					{
						...
						if (MISC::IS_BIT_SET(bLocal_29) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_29, 0))
						{
							if (MISC::GET_MODEL_DIMENSIONS(bLocal_29) != joaat("dune") && MISC::GET_MODEL_DIMENSIONS(bLocal_29) != joaat("cuban800"))
							{
								if (!unk_0x1037B9D45CE6B788(bLocal_29, 2137.12f, 4799.97f, 39.67854f, 2116.64f, 4790.417f, 45.45295f, 25f, 0, 1, 0))
								{
									func_133(bLocal_29, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
								}
							}
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Air"))
			{
				...
				if (iVar3 == 1)
				{
					...
					if (!*iParam0)
					{
						func_82(TASK::IS_PED_BEING_ARRESTED(), 0);
					}
...
void func_172(bool bParam0)
{
	...
	if (MISC::IS_BIT_SET(bLocal_40))
	{
		if (bParam0)
		{
			VEHICLE::DELETE_VEHICLE(&bLocal_40);
		}
		else
		{
			STREAMING::REMOVE_ANIM_DICT(&bLocal_40);
...
int func_173()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("traffick_ground")) == 1 || INTERIOR::GET_INTERIOR_AT_COORDS(joaat("traffick_air")) == 1)
	{
		return 1;
	}
	bLocal_28 = unk_0x9B0761B4C3EB8BC7();
	if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_28, 0))
	{
	}
	if (func_183())
	{
	...
	if (!func_177(6))
	{
		...
		if (PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0))
		{
		}
		if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()))
		{
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_182()) || Global_110905) || Global_30970) || func_176()) || func_175(8, -1)) || func_174()) || func_130()) || func_181()) || func_180()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_182() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_175(8, -1)) || func_180()) || func_179()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_182()) || func_181()) || Global_110905) || Global_30970) || func_176()) || Global_42801) || func_175(8, -1)) || func_174()) || func_179()) || func_180()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_187()
{
	if (!iLocal_58)
	{
		fLocal_57 = PATHFIND::SET_ROADS_IN_AREA(Vector(40.073f, 4788.559f, 2157.109f) - Vector(25f, 25f, 25f), Vector(40.073f, 4788.559f, 2157.109f) + Vector(25f, 25f, 25f), false, true, 1, 1);
		iLocal_58 = 1;
	}
}
...
void func_192()
{
	...
	while (iVar0 < 5)
	{
		...
		if (MISC::IS_BIT_SET(uLocal_49[iVar0]))
		{
			PED::GET_PED_BONE_INDEX(&(uLocal_49[iVar0]));
		}
		iVar0++;
	}
}
