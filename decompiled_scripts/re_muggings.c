				...
				case 1:
						...
						switch (iLocal_46)
						{
							...
							case 2:
								...
								switch (iLocal_47)
								{
									case 0:
										...
										if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_61, unk_0x9B0761B4C3EB8BC7(), false))
										{
											bVar0 = STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60);
											if (!OBJECT::DOES_PICKUP_EXIST(iLocal_151))
											{
											}
											if (bVar0 == 0 && iLocal_80 == 1)
											{
												PED::SET_PED_TO_RAGDOLL(bLocal_60, 500, 1000, 0, false, false, false);
												TASK::TASK_SMART_FLEE_PED(bLocal_60, unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
												PED::SET_PED_KEEP_TASK(bLocal_60, true);
												func_204(1);
												func_199();
											}
										}
									...
									case 4:
										...
										if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_60, 242628503) == 7)
										{
											TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
											TASK::TASK_LOOK_AT_ENTITY(false, bLocal_61, 5000, 0, 2);
											TASK::TASK_TURN_PED_TO_FACE_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 5000);
											TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_a", 4f, -4f, -1, 0, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_b", 8f, -4f, -1, 0, 0f, false, false, false);
											TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 0, 0f, false, false, false);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
											AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
									...
									case 5:
										func_162();
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
										{
											if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_60, 242628503) == 7)
											{
												TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
												TASK::TASK_TURN_PED_TO_FACE_ENTITY(false, bLocal_61, 0);
												TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_a", 8f, -4f, -1, 0, 0f, false, false, false);
												TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_b", 8f, -4f, -1, 0, 0f, false, false, false);
												TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 0, 0f, false, false, false);
												TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
												AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
								...
								if (iLocal_47 == 0)
								{
									if (func_158())
									{
										if (iLocal_119 == 4)
										{
											if (SYSTEM::VMAG(bLocal_64))
											{
												unk_0x93370FA10F15BE44(&bLocal_64);
											}
											if (SYSTEM::VMAG(bLocal_63))
											{
												unk_0x93370FA10F15BE44(&bLocal_63);
											}
											if (!SYSTEM::VMAG(iLocal_65))
											{
												bLocal_65 = func_156(iLocal_151);
											}
											iLocal_46 = 4;
										}
										else
								...
								if (func_153())
								{
									func_152();
									func_151();
									if (unk_0xC2169C00B643278B(bLocal_60, Local_146, 7f, 7f, 7f, 0, 1, 0))
									{
										iLocal_119 = 2;
										iLocal_46 = 3;
									}
								...
								if (bLocal_123)
								{
									if (!PED::IS_PED_IN_COMBAT(bLocal_61, 0))
									{
										func_149(bLocal_64, &uLocal_118);
									}
									else if (SYSTEM::VMAG(bLocal_64))
									{
										if (HUD::GET_BLIP_COLOUR(bLocal_64) == 1)
										{
										}
										else
										{
											HUD::SET_BLIP_AS_FRIENDLY(bLocal_64, false);
											HUD::SET_BLIP_COLOUR(bLocal_64, 1);
										}
									}
								}
								if (func_148())
							...
							case 5:
								...
								if (!bLocal_126)
								{
									...
									if (func_126(func_127()) < bLocal_152)
									{
										iLocal_46 = 12;
									}
								}
							...
							case 8:
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
								{
									if (ENTITY::IS_ENTITY_AT_ENTITY(bLocal_60, unk_0x9B0761B4C3EB8BC7(), 20f, 20f, 20f, false, true, 0))
									{
										iLocal_46 = 6;
									}
									else
							...
							case 9:
								GRAPHICS::DRAW_DEBUG_TEXT_2D("ABLE_TO_RETRIEVE_DROPPED_BAG", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
								if (MISC::IS_BIT_SET(bLocal_61))
								{
									if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
									{
										if (SYSTEM::VMAG(bLocal_64))
										{
											unk_0x93370FA10F15BE44(&bLocal_64);
										}
										if (!MISC::IS_BIT_SET(bLocal_60))
										{
											if (MISC::IS_BIT_SET(bLocal_62))
											{
												PED::GET_PED_BONE_INDEX(&bLocal_62);
											}
											func_40();
											iLocal_54 = 1;
											func_139();
					...
					if (bLocal_58)
					{
						if (OBJECT::DOES_PICKUP_EXIST(iLocal_151))
						{
							...
							{
								if (SYSTEM::VDIST(Local_146, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)) > 150f)
								{
									func_280();
								}
							}
					...
					else if (bLocal_123)
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
						{
							if (iLocal_46 != 6)
							{
								if (func_38(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 1) > 150f && (!ENTITY::IS_ENTITY_ON_SCREEN(bLocal_61) || ENTITY::IS_ENTITY_OCCLUDED(bLocal_61)))
								{
					...
					if (MISC::IS_BIT_SET(bLocal_60))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
						{
							if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_60, unk_0x9B0761B4C3EB8BC7(), true))
							{
								if (MISC::IS_BIT_SET(bLocal_62))
								{
									if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_62, bLocal_60))
									{
										ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_62, 1, 1);
									}
								}
							}
						}
					...
					if (iLocal_124)
					{
						if (!iLocal_137)
						{
							if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_61, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
							{
								if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_61, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_60, 1), 1) > 100f && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_61, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 1) < 100f)
								{
									TASK::TASK_SMART_FLEE_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
									iLocal_137 = 1;
								}
							}
						}
					...
					if (bLocal_123 && !iLocal_124)
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
						{
							if (iLocal_80 == 3)
							{
								if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_61, 1805844857) != 1)
								{
									TASK::CLEAR_PED_SECONDARY_TASK(bLocal_61);
									TASK::TASK_SMART_FLEE_PED(bLocal_61, bLocal_60, 200f, -1, false, false);
									PED::FORCE_PED_MOTION_STATE(bLocal_61, -530524, true, 0, false);
									iLocal_124 = 1;
								}
							}
							else if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_61, 1805844857) != 1)
							{
								TASK::CLEAR_PED_SECONDARY_TASK(bLocal_61);
								TASK::TASK_SMART_FLEE_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
								PED::FORCE_PED_MOTION_STATE(bLocal_61, -530524, true, 0, false);
							...
							if (ENTITY::GET_ENTITY_ROTATION(bLocal_61, -2134635134))
							{
								TASK::TASK_SMART_FLEE_PED(bLocal_61, bLocal_60, 200f, -1, false, false);
								PED::FORCE_PED_MOTION_STATE(bLocal_61, -530524, true, 0, false);
								iLocal_124 = 1;
							...
							{
								if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_61, cLocal_319, sLocal_329, 3))
								{
									if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_61, cLocal_319, sLocal_329) >= 0.922f)
									{
										TASK::TASK_SMART_FLEE_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
										PED::FORCE_PED_MOTION_STATE(bLocal_61, -530524, true, 0, false);
										iLocal_124 = 1;
								...
								if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_61, cLocal_319, sLocal_327, 3))
								{
									if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_61, cLocal_319, sLocal_327) >= 0.922f)
									{
										TASK::TASK_SMART_FLEE_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 200f, -1, false, false);
										PED::FORCE_PED_MOTION_STATE(bLocal_61, -530524, true, 0, false);
										iLocal_124 = 1;
...
void func_4()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61) || !bLocal_109)
	{
...
int func_13(bool bParam0)
{
	if (!func_14(1, 1, 0))
	{
		if ((!CAM::IS_SCREEN_FADED_OUT(bParam0) && func_36(bParam0)) || func_36("CMN_HINT"))
		{
			unk_0xD289B55B6AADBA10(1);
		}
		return 0;
...
int func_14(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_22() || func_21(Global_4456448.f_129348)) || func_20())
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(bVar0, iVar1) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("apc") && iVar1 != -1)) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("akula") && iVar1 != -1)) || (((MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("riot2") && iVar1 == 0) && func_18(bVar0, 10)) && unk_0x7F8B14CBFB9813E5(bVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_29(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_32(bParam1, bParam2, bParam3) || SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1) || func_30(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_40()
{
	if (!OBJECT::DOES_PICKUP_EXIST(iLocal_151))
	{
		if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
		{
			Local_146 = { PED::GET_DEAD_PED_PICKUP_COORDS(bLocal_61, 1.2f, 1.5f) };
		}
		else
		{
			Local_146 = { OBJECT::GET_SAFE_PICKUP_COORDS(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_61, 1), 1.2f, 1.5f) };
		}
		iLocal_151 = OBJECT::CREATE_PICKUP(joaat("pickup_money_wallet"), Local_146, iLocal_120, bLocal_152, true, iLocal_77);
		bLocal_65 = func_156(iLocal_151);
		func_37(&uLocal_336, 0, 0);
		bLocal_58 = true;
	}
...
void func_41()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_319, "flee_backward_loop_shopkeeper", 3))
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "flee_backward_outro_shopkeeper", 8f, -4f, -1, 8, 0f, false, false, false);
			TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
		}
		else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_319, "flee_forward_loop_shopkeeper", 3))
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "flee_forward_outro_shopkeeper", 8f, -4f, -1, 8, 0f, false, false, false);
			TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
...
void func_58()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_60);
		TASK::TASK_SMART_FLEE_PED(bLocal_60, unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
		PED::SET_PED_KEEP_TASK(bLocal_60, true);
		if (MISC::IS_BIT_SET(bLocal_62))
		{
		...
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_60);
	}
	if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61) || STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		if (SYSTEM::VMAG(bLocal_64))
		{
			unk_0x93370FA10F15BE44(&bLocal_64);
...
void func_59()
{
	...
	if (iLocal_119 == 1)
	{
		if (!iLocal_49)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
			{
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_61);
				TASK::TASK_COMBAT_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 0, 16);
				PED::SET_PED_KEEP_TASK(bLocal_61, true);
			}
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
			{
				if (OBJECT::DOES_PICKUP_EXIST(iLocal_151))
	...
	if (iLocal_119 == 2)
	{
		if (!iLocal_49)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
			{
				...
				TASK::TASK_COMBAT_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 0, 16);
				PED::SET_PED_KEEP_TASK(bLocal_61, true);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_61, false, 1);
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_61);
			}
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
			{
				if (OBJECT::DOES_PICKUP_EXIST(iLocal_151))
				{
					if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
					{
						if (unk_0xC2169C00B643278B(bLocal_60, OBJECT::GET_PICKUP_COORDS(iLocal_151), 10f, 10f, 10f, 0, 1, 0))
						{
							if (iLocal_80 == 3)
							{
								if ((!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_319, "handsup_standing_enter", 3) && !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_319, "handsup_standing_base", 3)) && !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_319, "handsup_standing_exit", 3))
								{
									HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_60);
									TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
									TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(iLocal_151), 1f, 20000, 0.25f, false, 40000f);
							...
							else if ((!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_319, sLocal_330, 3) && !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_319, sLocal_326, 3)) && !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_319, sLocal_328, 3))
							{
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_60);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(iLocal_151), 1f, 20000, 0.25f, false, 40000f);
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
		{
			if (iLocal_49)
			{
				if (OBJECT::DOES_PICKUP_EXIST(iLocal_151))
				{
					if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_320, "pickup_low", 3))
						{
							if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_60, cLocal_320, "pickup_low") > 0.5f)
							{
								if (OBJECT::DOES_PICKUP_EXIST(iLocal_151))
								{
									if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
						...
						else if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_60, 242628503) == 7)
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_60);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
							TASK::TASK_PLAY_ANIM(false, cLocal_320, "pickup_low", 8f, -8f, -1, 0, 0f, false, false, false);
					...
					{
						PED::SET_PED_MONEY(bLocal_60, bLocal_152);
						ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_60);
						func_204(3);
						func_199();
					}
...
void func_61()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		if (!bLocal_126)
		{
			if (iLocal_127)
			{
				Var7 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
				iVar8 = 1;
				if (iLocal_80 == 1)
				{
					if (Var7.f_2 > 33.5f)
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 5f, 5f, 5f, false, true, 0) && iVar8 == 1)
				{
					if (func_124(2))
					{
						unk_0xD289B55B6AADBA10(1);
						...
						if (func_123(1, 0, 1))
						{
							if (!func_122())
							{
								if (!MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7()))
								{
									...
									if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
									{
										while (!func_112(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), fLocal_71, 1, 1056964608, 0, 1, 0) || func_167())
										{
									...
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
									{
										PED::SET_PED_CAN_RAGDOLL(bLocal_60, false);
									}
									unk_0xA86915034F55A3BF();
				...
				{
					func_108(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_60, 1), &uLocal_70, &fLocal_71);
				}
			}
			else if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 15f, 15f, 15f, false, true, 0))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
				...
				if (iLocal_45 == 2)
				{
					TASK::TASK_PLAY_ANIM(false, cLocal_333, "RETURNING_FRONT_A", 8f, -1000f, -1, 0, 0f, false, false, false);
				}
				TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
				AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
				PED::FORCE_PED_MOTION_STATE(bLocal_60, -668482597, false, 0, false);
				iLocal_127 = 1;
			}
		}
		if (bLocal_126)
			...
			switch (iLocal_125)
			{
				case 0:
					...
					if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
						{
							func_105(bLocal_60, &Local_105, &Local_106, cLocal_321, sLocal_323);
							if (iLocal_80 == 1)
							{
						...
						if (ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
						{
							if (!ENTITY::GET_ENTITY_COORDS(bVar0, false))
							{
								...
								ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(MISC::GET_MODEL_DIMENSIONS(bVar0), &uVar2, &Var3);
								if (unk_0xC2169C00B643278B(bVar0, Local_105, (Var3.f_1 + 1.5f), (Var3.f_1 + 1.5f), 3f, 0, 1, 0) || unk_0xC2169C00B643278B(bVar0, unk_0xD7D25254A712E758(cLocal_321, sLocal_323, Local_105, Local_106, 0, 2), (Var3.f_1 + 1f), (Var3.f_1 + 1f), 3f, 0, 1, 0))
								{
									if (iLocal_80 == 1)
									{
									...
									{
										bLocal_73 = ENTITY::IS_ENTITY_IN_WATER(bVar0);
										Local_74 = { func_103(Local_105, unk_0xD7D25254A712E758(cLocal_321, sLocal_323, Local_105, Local_106, 0, 2)) };
									}
									if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
									{
										unk_0x03D382CB0B44E2FC(bVar0, Local_74, 1, 0, 0, 1);
										ENTITY::SET_ENTITY_HEADING(bVar0, bLocal_73);
						...
						bLocal_62 = OBJECT::CREATE_OBJECT(iLocal_77, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), true, true, false);
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
						{
							OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_62, unk_0x9B0761B4C3EB8BC7(), ENTITY::ATTACH_ENTITY_TO_ENTITY(unk_0x9B0761B4C3EB8BC7(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						}
						...
						TASK::TASK_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), iLocal_107, cLocal_321, sLocal_322, 1000f, -8f, 0, 0, 1000f, 0);
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
						{
							TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_60);
							TASK::TASK_SYNCHRONIZED_SCENE(bLocal_60, iLocal_107, cLocal_321, sLocal_323, 1000f, -8f, 0, 0, 1000f, 0);
						}
				...
				case 1:
					if ((PED::DETACH_SYNCHRONIZED_SCENE(iLocal_107) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_107) > 0.9f) || func_101(1000))
					{
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
						...
						{
							TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_60);
							PED::SET_PED_MONEY(bLocal_60, (bLocal_152 - (bLocal_152 / 10)));
							Var1 = { unk_0xD7D25254A712E758(cLocal_321, sLocal_323, Local_105, Local_106, 1f, 2) };
							MISC::GET_GROUND_Z_FOR_3D_COORD(Var1, &(Var1.f_2), false, false);
							unk_0x03D382CB0B44E2FC(bLocal_60, Var1, 1, 0, 0, 1);
							PED::_0x2208438012482A1A(bLocal_60, 0);
							Var1 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_321, sLocal_323, Local_105, Local_106, 1f, 2) };
							ENTITY::SET_ENTITY_HEADING(bLocal_60, Var1.f_2);
							if (iLocal_80 == 4)
							{
								if (func_99(Var1.f_2, 0f, 90f))
								{
									...
									TASK::TASK_WANDER_STANDARD(0, ENTITY::IS_ENTITY_IN_WATER(bLocal_60), 1);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
									AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
								}
							...
							PED::SET_PED_MOVEMENT_CLIPSET(bLocal_60, cLocal_334, 0.25f);
							PED::FORCE_PED_MOTION_STATE(bLocal_60, -668482597, true, 0, false);
							PED::SET_PED_KEEP_TASK(bLocal_60, true);
						}
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
						{
						...
						{
							PED::SET_PED_MONEY(bLocal_60, (bLocal_152 - (bLocal_152 / 10)));
							PED::SET_PED_CAN_RAGDOLL(bLocal_60, true);
						}
						bVar9 = (bLocal_152 / 100);
						bVar9 *= 90;
						SYSTEM::WAIT(0);
						CAM::_RENDER_FIRST_PERSON_CAM(false, 0f, 3, 0);
						func_64(func_127(), 1, bVar9);
						func_63(joaat("RC_WALLETS_RETURNED"), 1);
						func_204(3);
						func_199();
					}
					else if (ENTITY::GET_ENTITY_ROTATION(unk_0x9B0761B4C3EB8BC7(), -3856156))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
						{
							if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_62, unk_0x9B0761B4C3EB8BC7()))
							{
								ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_62, 0, 1);
								if (PED::IS_PED_MALE(bLocal_60))
								{
									OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_62, bLocal_60, ENTITY::ATTACH_ENTITY_TO_ENTITY(bLocal_60, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								}
								else
								{
									OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_62, bLocal_60, ENTITY::ATTACH_ENTITY_TO_ENTITY(bLocal_60, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								}
								if (!iLocal_59)
								{
...
void func_105(bool bParam0, var uParam1, var uParam2, char* sParam3, char* sParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*uParam1 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0) };
	uParam2->f_2 = func_107(bParam0, unk_0x9B0761B4C3EB8BC7(), 1);
	fVar3 = func_107(bParam0, unk_0x9B0761B4C3EB8BC7(), 1);
	fVar4 = func_107(bParam0, unk_0x9B0761B4C3EB8BC7(), 1);
	...
	while (iVar0 < 2)
	{
		switch (iVar0)
		{
			case 0:
				if (iVar1 > 20)
				{
					uParam2->f_2 = func_106(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 0), *uParam1, 1);
...
float func_106(struct<2> Param0, bool bParam1, struct<2> Param2, var uParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_108(struct<3> Param0, var uParam1, float fParam2)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		if (func_109(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), fVar2, 15f))
		{
			bVar0 = true;
		}
...
int func_109(bool bParam0, float fParam1, float fParam2)
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
int func_112(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_114(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_118(PLAYER::PLAYER_ID())) && !func_116(PLAYER::PLAYER_ID(), 0)) && !func_115()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_118(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_128()
{
	...
	{
		if (func_131(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_133()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		TASK::TASK_SMART_FLEE_PED(bLocal_60, unk_0x9B0761B4C3EB8BC7(), 150f, -1, false, false);
		PED::SET_PED_KEEP_TASK(bLocal_60, true);
		SYSTEM::WAIT(0);
	}
}
...
int func_134()
{
	...
	else
	{
		...
		if (MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(bLocal_60, 31086, 0f, 0f, 0f), 5f, true))
		{
			return 1;
		}
		Var0 = { Var0 + PED::GET_PED_BONE_COORDS(bLocal_60, 31086, 0f, 0f, 0f) };
		Var1 = { Var1 + PED::GET_PED_BONE_COORDS(bLocal_60, 31086, 0f, 0f, 0f) };
		...
		if (GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(PED::GET_PED_BONE_COORDS(bLocal_60, 31086, 0f, 0f, 0f), 3f))
		{
			return 1;
		}
	}
...
void func_135()
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
	{
		if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_60, 1)) > (bLocal_139 + 50f))
		{
			func_199();
		}
		else if (func_126(func_127()) < bLocal_152)
		{
			func_199();
		}
	}
...
void func_136()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, Global_19, false, true, 0))
		{
			TASK::TASK_LOOK_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 3000, 0, 2);
			TASK::TASK_LOOK_AT_ENTITY(bLocal_60, unk_0x9B0761B4C3EB8BC7(), 3000, 0, 2);
		}
	}
}
...
void func_137()
{
	...
	if (iLocal_80 == 1 || iLocal_80 == 4)
	{
		if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_140, Local_141, fVar0, 0, 1, 0))
		{
			if (!iLocal_131)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(bLocal_60, unk_0x9B0761B4C3EB8BC7(), 0);
					iLocal_131 = 1;
					iLocal_132 = 0;
				}
			}
		}
		if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_142, Local_143, fVar0, 0, 1, 0))
		{
			if (!iLocal_132)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
		...
		if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_144, Local_145, fVar0, 0, 1, 0))
		{
			if (!iLocal_133)
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	...
	if (!iLocal_134)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(bLocal_60, unk_0x9B0761B4C3EB8BC7(), 25f, 25f, 5f, false, true, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bLocal_60, unk_0x9B0761B4C3EB8BC7(), 17))
			{
				if (func_42(&uLocal_154, cLocal_85, sLocal_90, 4, 0, 0, 0) || func_62())
				{
					if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_319, "flee_forward_outro_shopkeeper", 3))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 0);
						if (iLocal_45 == 2)
						{
							TASK::TASK_PLAY_ANIM(false, cLocal_333, "RETURNING_FRONT_A", 8f, -4f, -1, 0, 0f, false, false, false);
						}
						TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
						AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
	...
	switch (*uParam1)
	{
		case 0:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
			{
				...
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
				AUDIO::STOP_SCRIPTED_CONVERSATION(bParam0, iLocal_103);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
				SYSTEM::SETTIMERA(0);
				*uParam1++;
			}
		...
		case 1:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
			{
				if (PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), fVar0))
				{
					*uParam1++;
				}
			}
...
void func_139()
{
	if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_151))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
		{
			bLocal_139 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_60, 1));
		}
		...
		if (MISC::IS_BIT_SET(bLocal_60))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
			{
				PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(bLocal_60, false);
			}
		}
		func_147(0);
		OBJECT::REMOVE_PICKUP(iLocal_151);
...
void func_142()
{
	...
	if (!SYSTEM::VMAG(bLocal_63))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
		{
			bLocal_63 = func_143(bLocal_60, 0, 0);
		}
	}
}

float func_143(bool bParam0, bool bParam1, int iParam2)
{
	iParam2 = iParam2;
	return func_144(bParam0, bParam1, 145);
}

bool func_144(bool bParam0, bool bParam1, int iParam2)
{
	int iVar0;
...
bool func_145(bool bParam0, bool bParam1, bool bParam2)
{
	bool bVar0;
	...
	if (ENTITY::IS_ENTITY_A_VEHICLE(bParam0))
	{
		HUD::SET_BLIP_SCALE(bVar0, func_146(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_146(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
	else if (ENTITY::IS_ENTITY_AN_OBJECT(bParam0))
	{
...
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60) && iLocal_80 == 4)
	{
		if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_60, cLocal_319, "flee_forward_loop_shopkeeper", 3))
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "flee_forward_outro_shopkeeper", 8f, -4f, -1, 8, 0f, false, false, false);
			TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 0, 2);
			if (bParam0)
			{
				...
				TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_a", 8f, -4f, -1, 0, 0f, false, false, false);
				TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_b", 8f, -4f, -1, 0, 0f, false, false, false);
				TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 1, 0f, false, false, false);
			}
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_60);
			AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
...
int func_148()
{
	if (MISC::IS_BIT_SET(bLocal_62))
	{
		if (ENTITY::IS_ENTITY_ATTACHED(bLocal_62))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
			{
				if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(bLocal_62, bLocal_60))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 18f, 18f, 18f, false, true, 0))
					{
...
{
	return unk_0xCE990E643CD9D0E5(Global_111854, bParam0);
}
...
void func_151()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 8f, 8f, 18f, false, true, 0) || ENTITY::IS_ENTITY_ON_SCREEN(bLocal_60))
		{
			HUD::CLEAR_PRINTS();
		}
	}
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
	{
		if (func_42(&uLocal_154, cLocal_85, sLocal_89, 4, 0, 0, 0) || func_62())
		{
			if (iLocal_45 == 2)
			{
				...
				PED::SET_PED_FLEE_ATTRIBUTES(bLocal_61, 2, true);
				PED::SET_PED_FLEE_ATTRIBUTES(bLocal_61, 1, false);
				TASK::TASK_SMART_FLEE_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
			}
			PED::SET_PED_KEEP_TASK(bLocal_61, true);
		}
...
int func_153()
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_61, 0))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_61, unk_0x9B0761B4C3EB8BC7(), true))
		{
			if (bLocal_123)
			{
				return 1;
...
void func_154()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
	{
		...
		TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
		AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_61, iLocal_103);
		TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
		PED::SET_PED_KEEP_TASK(bLocal_61, true);
		SYSTEM::WAIT(0);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_61, false, 1);
...
int func_155()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		if (MISC::IS_PC_VERSION(bLocal_60))
		{
			return 1;
		}
	}
		...
		if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
		{
			if (MISC::IS_BIT_SET(bLocal_61))
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_61, 0))
				{
					if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 18f, 18f, 18f, false, true, 0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_61, unk_0x9B0761B4C3EB8BC7(), true))
						{
							SYSTEM::SETTIMERB(0);
							iLocal_119 = 1;
							return 1;
				...
				else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_61, unk_0x9B0761B4C3EB8BC7(), true))
				{
					SYSTEM::SETTIMERB(0);
					iLocal_119 = 2;
					if (MISC::IS_BIT_SET(bLocal_60))
			...
			if (MISC::IS_BIT_SET(bLocal_60))
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 5.3f, 5.3f, 6f, false, true, 0))
					{
						if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
						{
							if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_60) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_60))
							{
								SYSTEM::SETTIMERB(0);
								iLocal_119 = 3;
								return 1;
...
int func_159()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
	{
		if (PED::CAN_PED_SEE_HATED_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7()) && ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 20f, 20f, 20f, false, true, 0))
		{
			if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
			{
				if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_61) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_61))
				{
					return 1;
				}
			}
		...
		if (MISC::IS_PC_VERSION(bLocal_61))
		{
			return 1;
		}
	}
...
void func_160()
{
	if (iLocal_56)
	{
		if (!iLocal_57)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
			{
				if (WEAPON::IS_PED_ARMED(bLocal_61, 4))
				{
...
int func_161()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 20f, 20f, 20f, false, true, 0))
			{
				if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_60) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_60))
				{
					return 1;
		...
		if (MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(unk_0x9B0761B4C3EB8BC7(), &iVar0, 1))
		{
			...
			{
				if (WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(bLocal_60, joaat("weapon_stungun"), 0))
				{
					return 1;
				}
			}
	...
	if (MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(bLocal_60, 31086, 0f, 0f, 0f), 3f, true))
	{
		return 1;
	}
	return 0;
...
void func_162()
{
	...
	if (!func_167())
	{
		if (SYSTEM::TIMERA() > 10000)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
			{
				if (!AUDIO::IS_ANY_SPEECH_PLAYING(bLocal_60))
				{
					func_163(bLocal_60, "GENERIC_CURSE_MED", 24);
					SYSTEM::SETTIMERA(0);
				}
			}
		}
	...
	if (!bLocal_58)
	{
		if (func_38(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 1) > 200f)
		{
			if (!ENTITY::IS_ENTITY_ON_SCREEN(bLocal_61) || ENTITY::IS_ENTITY_OCCLUDED(bLocal_61))
			{
				iLocal_46 = 8;
			}
		}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(bParam0, sParam1, func_164(iParam2), 1);
}
...
void func_165()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		...
		if (bLocal_51)
		{
			if (!iLocal_112)
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 7f, 7f, 7f, false, true, 0))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_60, 242628503) == 1)
					{
						if (TASK::GET_SEQUENCE_PROGRESS(bLocal_60) == iLocal_138)
						{
							TASK::TASK_LOOK_AT_ENTITY(bLocal_60, unk_0x9B0761B4C3EB8BC7(), 9000, 0, 2);
					...
					{
						AUDIO::STOP_PED_SPEAKING(bLocal_60, true);
						func_42(&uLocal_154, cLocal_85, sLocal_88, 4, 0, 0, 0);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
						TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 7000, 0, 2);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 7000);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
						AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
						SYSTEM::SETTIMERA(0);
...
int func_166()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 12f, 12f, 5f, false, true, 0))
		{
			return 1;
		}
	}
...
void func_169()
{
	...
	if (!bLocal_53)
	{
		...
		if (iLocal_80 != 2)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
			{
				if (!func_196())
				{
					if (func_183())
				...
				if (func_182())
				{
					if (!SYSTEM::VMAG(fLocal_66))
					{
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_61, 0))
						{
							bLocal_66 = func_143(bLocal_61, 1, 0);
						}
						func_174(1);
					}
				}
				if (func_173())
				{
					...
					if (iLocal_80 == 3)
					{
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
							TASK::TASK_LOOK_AT_ENTITY(false, bLocal_61, 16000, 0, 2);
						...
						TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
						TASK::TASK_LOOK_AT_ENTITY(false, bLocal_60, -1, 0, 2);
						TASK::TASK_PLAY_ANIM(false, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@EXIT", "exit_forward", 1000f, -1000f, -1, 512, 0f, false, false, false);
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_79, bLocal_60, 1f, false, 1.5f, 4f, true, 0, false, -957453492, 20000);
						TASK::TASK_AIM_GUN_AT_ENTITY(0, bLocal_60, -1, true);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
						AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_61, iLocal_103);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
						SYSTEM::SETTIMERA(0);
	...
	if (bLocal_53)
	{
		if (!iLocal_111)
		{
			...
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 60f, 60f, 50f, false, true, 0))
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_60, 0))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(bLocal_60, bLocal_61, 0);
					}
					iLocal_111 = 1;
				}
				else
		...
		if (iLocal_111 && !bLocal_109)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
			{
				if (func_42(&uLocal_154, cLocal_85, sLocal_86, 4, 0, 0, 0) || func_62())
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_60);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
					TASK::TASK_PLAY_ANIM(false, cLocal_319, "handsup_standing_enter", 8f, -4f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(false, cLocal_319, "handsup_standing_base", 8f, -4f, 7000, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(false, cLocal_319, "handsup_standing_exit", 8f, -4f, -1, 0, 0f, false, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
					AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
					func_172();
					iLocal_151 = OBJECT::CREATE_PICKUP(joaat("pickup_money_purse"), OBJECT::GET_SAFE_PICKUP_COORDS(unk_0x7EC595B99EA7C4B1(bLocal_60, 0f, 2.5f, 0f), 1.2f, 1.5f), iLocal_120, bLocal_152, true, iLocal_77);
					bLocal_109 = true;
				}
			}
		}
				...
				switch (iLocal_623)
				{
					case 0:
						...
						if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_61);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
							TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_626, bLocal_60, 2f, false, 0.1f, 4f, true, 0, false, -957453492, 20000);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
							AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_61, iLocal_103);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
					...
					case 1:
						if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_61, 242628503) == 7)
						{
							Local_626 = { OBJECT::GET_PICKUP_COORDS(iLocal_151) - Vector(0f, 0f, 0.75f) };
							if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
							{
								if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_61, 1), Local_626, 1) > 1f)
								{
									iLocal_625 = 1;
									iLocal_623 = 4;
								}
								else
								{
									HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_61);
									TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
									TASK::TASK_PLAY_ANIM(false, cLocal_320, "pickup_low", 8f, -4f, -1, 8224, 0f, false, false, false);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
									AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_61, iLocal_103);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
									iLocal_623 = 2;
					...
					case 2:
						if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_61, cLocal_320, "pickup_low") > 0.5f)
						{
							if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_151))
							{
								OBJECT::REMOVE_PICKUP(iLocal_151);
					...
					case 3:
						if ((ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_61, cLocal_320, "pickup_low", 3) && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_61, cLocal_320, "pickup_low") > 0.58f) || !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_61, cLocal_320, "pickup_low", 3))
						{
							iLocal_623 = 4;
						}
						break;
					...
					case 4:
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_61, true, 1);
						TASK::TASK_SMART_FLEE_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 50f, -1, false, false);
...
void func_171()
{
	...
	if (PED::IS_PED_FACING_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 90f))
	{
		TASK::TASK_PLAY_ANIM(bLocal_61, cLocal_319, sLocal_327, 1000f, -1000f, -1, 8, 0f, false, false, false);
		if (iLocal_45 == 2)
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, sLocal_328, 8f, -8f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_A", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_B", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_C", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_A", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_B", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_C", 8f, -4f, -1, 1, 0f, false, false, false);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
		}
		...
		{
			fLocal_335 = PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(39.7889f, -1014.392f, 28.4847f, 4f, 4f, 4f, 0f, 0, 4);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "flee_backward_intro_shopkeeper", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "flee_backward_loop_shopkeeper", 8f, -4f, -1, 9, 0f, false, false, false);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
		}
		...
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, sLocal_328, 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_a", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_b", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 1, 0f, false, false, false);
	...
	{
		TASK::TASK_PLAY_ANIM(bLocal_61, cLocal_319, sLocal_329, 1000f, -1000f, -1, 8, 0f, false, false, false);
		if (iLocal_45 == 2)
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, sLocal_330, 8f, -8f, -1, 8, 0.1f, false, false, false);
			...
			TASK::TASK_PLAY_ANIM(false, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_B", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_C", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_A", 8f, -4f, -1, 1, 0f, false, false, false);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
		}
		...
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "flee_forward_intro_shopkeeper", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "flee_forward_loop_shopkeeper", 8f, -4f, -1, 9, 0f, false, false, false);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
			AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
		}
		...
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, sLocal_330, 8f, -4f, -1, 8, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_a", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_b", 8f, -4f, -1, 0, 0f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, cLocal_319, "agitated_loop_c", 8f, -4f, -1, 1, 0f, false, false, false);
...
void func_172()
{
	if (SYSTEM::VMAG(bLocal_66))
	{
		unk_0x93370FA10F15BE44(&bLocal_66);
	}
	if (!SYSTEM::VMAG(bLocal_64))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_61, 0))
		{
			bLocal_64 = func_143(bLocal_61, 1, 0);
		}
	}
}
...
int func_173()
{
	...
	{
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_61, 1), 1) < 30f)
		{
			iVar0 = 1;
		}
	}
	...
	else if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), -325.7037f, -829.31f, 30.5812f, 1) < 95f)
	{
		iVar0 = 1;
	}
	return iVar0;
...
int func_182()
{
	...
	{
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), -325.7037f, -829.31f, 30.5812f, 1) < 105f)
		{
			iVar0 = 1;
		}
	}
...
int func_183()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_191())
		{
			return 0;
		}
	}
...
void func_205()
{
	switch (iLocal_116)
	{
		case 0:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
			{
				TASK::TASK_PLAY_ANIM(bLocal_61, cLocal_319, "IG_1_guy_stickup_loop", 8f, -4f, -1, 1, 0f, false, false, false);
			}
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
			{
				TASK::TASK_PLAY_ANIM(bLocal_60, cLocal_321, "ortega_stand_loop_ort", 8f, -4f, -1, 1, 0f, false, false, false);
			}
			iLocal_116++;
			break;
		...
		case 1:
			if (MISC::IS_BIT_SET(bLocal_61))
			{
				...
				else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
				{
					TASK::TASK_SMART_FLEE_COORD(bLocal_60, Local_121, 250f, -1, false, false);
					PED::SET_PED_KEEP_TASK(bLocal_60, true);
					SYSTEM::WAIT(0);
					func_211();
				}
		...
		case 2:
			if (MISC::IS_BIT_SET(bLocal_61))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 6f, 6f, 15f, false, true, 0))
					{
						if (PED::CAN_PED_SEE_HATED_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7()) || ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 3f, 3f, 15f, false, true, 0))
						{
							if (PED::IS_PED_FACING_PED(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 65f))
							{
								iLocal_149 = MISC::GET_GAME_TIMER();
								TASK::TASK_LOOK_AT_ENTITY(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 7000, 0, 2);
								func_42(&uLocal_154, cLocal_85, sLocal_94, 4, 0, 0, 0);
								SYSTEM::SETTIMERB(0);
								iLocal_116++;
							}
		...
		case 10:
			if (MISC::IS_BIT_SET(bLocal_61))
			{
				if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61) || func_38(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 1) > 100f)
				{
					func_206();
					func_211();
				}
			...
			if (MISC::IS_BIT_SET(bLocal_60))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
				{
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_60, unk_0x9B0761B4C3EB8BC7(), true))
					{
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
							TASK::TASK_SMART_FLEE_COORD(false, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_61, 0), 150f, -1, false, false);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
							AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
							PED::SET_PED_KEEP_TASK(bLocal_60, true);
		...
		case 5:
			if (SYSTEM::TIMERB() > 250)
			{
				if (MISC::IS_BIT_SET(bLocal_61))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
					{
						PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_61, 17, true);
						PED::SET_PED_RESET_FLAG(bLocal_61, 156, true);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
						TASK::TASK_SMART_FLEE_PED(false, unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
						AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_61, iLocal_103);
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
				{
					if (MISC::IS_BIT_SET(bLocal_60))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_60);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
							TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 10000, 0, 2);
							TASK::TASK_SMART_FLEE_PED(false, unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
							AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
		...
		case 9:
			if (MISC::IS_BIT_SET(bLocal_61))
			{
				...
				{
					PED::SET_PED_RESET_FLAG(bLocal_61, 156, true);
					TASK::TASK_COMBAT_HATED_TARGETS_AROUND_PED(bLocal_61, 50f, 0);
					if (ENTITY::IS_ENTITY_DEAD())
					{
						func_110();
					}
			...
			if (MISC::IS_BIT_SET(bLocal_60))
			{
				...
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_60);
					TASK::TASK_COWER(bLocal_60, 2000);
					iLocal_122 = 1;
				}
			}
			break;
	...
	{
		if (MISC::IS_BIT_SET(bLocal_61) && MISC::IS_BIT_SET(bLocal_61))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
			{
				if ((((iLocal_148 - iLocal_147) > 12000 && !ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 3f, 3f, 35f, false, true, 0)) && ENTITY::IS_ENTITY_ON_SCREEN(bLocal_61)) && !func_167())
				{
					if ((func_42(&uLocal_154, cLocal_85, "REMG2_FKIT", 4, 0, 0, 0) || func_62()) || func_62())
					{
						PED::SET_PED_RESET_FLAG(bLocal_61, 156, true);
						PED::SET_PED_SHOOTS_AT_COORD(bLocal_61, PED::GET_PED_BONE_COORDS(bLocal_60, 31086, 0f, 0f, 0f), false);
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_60);
						CAM::IS_AIM_CAM_ACTIVE(bLocal_60, 99, 0);
						TASK::TASK_SMART_FLEE_COORD(bLocal_61, Local_121, 250f, -1, false, false);
						PED::SET_PED_KEEP_TASK(bLocal_61, true);
						func_280();
					}
				}
...
int func_207()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
	{
		if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_61) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60))
		{
			return 1;
		}
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_61, 2f, 2f, 2f, false, true, 0))
		{
		}
	}
	return 0;
...
int func_209()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_60, 5.3f, 5.3f, 6f, false, true, 0))
		{
			if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bLocal_60, unk_0x9B0761B4C3EB8BC7(), 17))
			{
				if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6) && !PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
					{
						if (!PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_61))
						{
							if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_60) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_60))
							{
								SYSTEM::SETTIMERB(0);
					...
					else if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_60) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_60))
					{
						SYSTEM::SETTIMERB(0);
						return 1;
					}
...
void func_211()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
	{
		if (!MISC::IS_PC_VERSION(bLocal_60))
		{
			if (func_196())
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_60, 242628503) == 7 || TASK::GET_SCRIPT_TASK_STATUS(bLocal_60, 474215631) == 7)
				{
					if (ENTITY::IS_ENTITY_DEAD())
					{
						func_110();
					...
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
					{
						if (!PED::IS_PED_FLEEING(bLocal_60))
						{
							TASK::TASK_SMART_FLEE_PED(bLocal_60, bLocal_61, 150f, -1, false, false);
						}
					}
					else if (iLocal_45 == 3)
					{
						if (!PED::IS_PED_FLEEING(bLocal_60))
						{
							TASK::TASK_SMART_FLEE_COORD(bLocal_60, Local_104, 150f, -1, false, false);
						}
					}
					PED::SET_PED_KEEP_TASK(bLocal_60, true);
					SYSTEM::WAIT(0);
					...
					if (bLocal_152 > 0)
					{
						PED::SET_PED_MONEY(unk_0x9B0761B4C3EB8BC7(), (bLocal_152 / 100) * 90);
						func_64(func_127(), 1, bLocal_152);
						SYSTEM::WAIT(0);
						func_212(func_127(), 1, (bLocal_152 / 10), 0, 1);
					}
					func_204(3);
					func_199();
				}
...
void func_215()
{
	bLocal_60 = PED::CREATE_PED(26, iLocal_75, Local_67, fLocal_69, true, true);
	PED::_0x2208438012482A1A(bLocal_60, 1);
	PED::SET_PED_CAN_BE_TARGETTED(bLocal_60, false);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_60, 8, true);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_60, 128, true);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_60, 512, true);
	AUDIO::STOP_PED_SPEAKING(bLocal_60, true);
	PED::SET_PED_INCREASED_AVOIDANCE_RADIUS(bLocal_60);
	PED::SET_PED_MONEY(bLocal_60, false);
	ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(bLocal_60, true);
	if (iLocal_75 == joaat("a_m_y_genstreet_01"))
	{
		PED::SET_PED_COMPONENT_VARIATION(bLocal_60, 0, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(bLocal_60, 3, 0, 3, 0);
		PED::SET_PED_COMPONENT_VARIATION(bLocal_60, 4, 0, 2, 0);
	}
	if (iLocal_75 == joaat("a_m_y_business_02"))
	{
		PED::SET_PED_COMPONENT_VARIATION(bLocal_60, 0, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(bLocal_60, 2, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(bLocal_60, 3, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(bLocal_60, 4, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(bLocal_60, 8, 0, 0, 0);
	}
	PED::ADD_RELATIONSHIP_GROUP("theAssailant", &iLocal_78);
	bLocal_61 = PED::CREATE_PED(26, iLocal_76, Local_68, fLocal_72, true, true);
	ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_61, true, 1);
	PED::_0x2208438012482A1A(bLocal_61, 1);
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(bLocal_61, true, 0f);
	unk_0x92BD213E6A0E666B(bLocal_61, joaat("weapon_pistol"), -1, 1, 1);
	PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_61, 13, false);
	PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_61, 17, false);
	PED::SET_PED_DIES_WHEN_INJURED(bLocal_61, true);
	PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_61, 5.885454E-44f, 1);
	PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_61, 1.919779E-43f, 1);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_61, 128, true);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_61, 2, false);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_61, iLocal_78);
	AUDIO::STOP_PED_SPEAKING(bLocal_61, true);
	if (!AUDIO::PRELOAD_SCRIPT_CONVERSATION(bLocal_102))
	{
		AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_60, bLocal_102);
	}
	AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_61, bLocal_101);
	...
	func_217(&uLocal_154, 1, bLocal_61, sLocal_100, 0, 1);
	func_217(&uLocal_154, 2, bLocal_60, sLocal_99, 0, 1);
	if (iLocal_45 == 2)
	{
		PED::SET_PED_FLEE_ATTRIBUTES(bLocal_61, 1, false);
	}
	...
	if (iLocal_80 == 3)
	{
		...
		iLocal_107 = PED::CREATE_SYNCHRONIZED_SCENE(Local_105, Local_106, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(bLocal_61, iLocal_107, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@BASE", "base", 1000f, -1000f, 0, 0, 1000f, 0);
	}
	if (iLocal_80 == 4)
	{
...
void func_216()
{
	...
	ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bLocal_61, unk_0xD7D25254A712E758(cLocal_319, sLocal_325, Local_331, Local_332, 0, 2), false, false, true);
	Var0 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_319, sLocal_325, Local_331, Local_332, 0f, 2) };
	if (Var0.f_2 < 0f)
	{
		Var0.f_2 = (Var0.f_2 + 360f);
	}
	ENTITY::SET_ENTITY_HEADING(bLocal_61, Var0.f_2);
	ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bLocal_60, unk_0xD7D25254A712E758(cLocal_319, sLocal_326, Local_331, Local_332, 0, 2), false, false, true);
	Var0 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_319, sLocal_326, Local_331, Local_332, 0f, 2) };
	if (Var0.f_2 < 0f)
	{
		Var0.f_2 = (Var0.f_2 + 360f);
	}
	ENTITY::SET_ENTITY_HEADING(bLocal_60, Var0.f_2);
	TASK::TASK_PLAY_ANIM(bLocal_61, cLocal_319, sLocal_325, 1000f, -1000f, -1, 9, 0f, false, false, false);
	TASK::TASK_PLAY_ANIM(bLocal_60, cLocal_319, sLocal_326, 1000f, -1000f, -1, 9, 0f, false, false, false);
}
...
int func_220(bool bParam0, char* sParam1, int iParam2)
{
...
void func_223(var uParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
...
void func_225()
{
	...
	unk_0xBE20AB8238688965(&iLocal_120, true);
	if (iLocal_80 == 1)
	{
...
void func_228(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
...
void func_240(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_242(fVar0, iVar1));
		iVar3 = (iVar3 - 1);
		fVar0 = SYSTEM::ROUND(func_241(SYSTEM::TO_FLOAT(fVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
int func_251()
{
	...
	func_252(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_268()) || Global_110905) || Global_30970) || func_267()) || func_55(8, -1)) || func_264()) || func_266()) || func_265()) || func_263()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_268() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_55(8, -1)) || func_263()) || func_262()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_280()
{
	if (iLocal_130)
	{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_61))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				TASK::TASK_SMART_FLEE_PED(bLocal_61, unk_0x9B0761B4C3EB8BC7(), 150f, -1, false, false);
			}
			PED::SET_PED_KEEP_TASK(bLocal_61, true);
			if (!bLocal_58)
			{
				PED::SET_PED_MONEY(bLocal_61, bLocal_152);
			}
		}
		if (MISC::IS_BIT_SET(bLocal_60))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_60))
			{
				PED::SET_PED_CAN_BE_TARGETTED(bLocal_60, true);
				if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_60, -1146898486) == 7 && TASK::GET_SCRIPT_TASK_STATUS(bLocal_60, 242628503) == 7)
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
					if (PED::IS_PED_DUCKING(bLocal_60))
					{
						TASK::TASK_TOGGLE_DUCK(false, false);
					}
					TASK::TASK_LOOK_AT_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), 9000, 0, 2);
					TASK::TASK_SMART_FLEE_COORD(false, Local_104, 250f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
					AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_60, iLocal_103);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
					PED::SET_PED_KEEP_TASK(bLocal_60, true);
		...
		if (MISC::IS_BIT_SET(bLocal_62))
		{
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&bLocal_62);
		}
		if (SYSTEM::VMAG(bLocal_65))
		{
			unk_0x93370FA10F15BE44(&bLocal_65);
		}
	}
	if (fLocal_335 != -1)
	{
		if (PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(fLocal_335))
		{
			VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(fLocal_335);
		}
		fLocal_335 = -1;
	}
	if (func_196())
...
void func_285(bool bParam0, char* sParam1, int iParam2)
{
...
void func_305(bool bParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
