		...
		if (MISC::SET_BIT())
		{
			...
			switch (func_82(NETWORK::PARTICIPANT_ID_TO_INT()))
			{
				case 0:
					if (func_81() > 0)
					{
						iLocal_96[NETWORK::PARTICIPANT_ID_TO_INT()] = 2;
					}
					break;
				...
				case 2:
					...
					if (func_81() == 3)
					{
						iLocal_96[NETWORK::PARTICIPANT_ID_TO_INT()] = 3;
					}
					break;
...
void func_18()
{
	...
	else if (MISC::IS_BIT_SET(unk_0x770D3B2B4702434A(Local_77.f_1)))
	{
	...
	{
		if (NETWORK::NETWORK_IS_HANDLE_VALID(Local_77.f_1.f_3[0 /*2*/]))
		{
	...
	if (func_11(Local_77.f_1.f_3[1 /*2*/]))
	{
		if (NETWORK::NETWORK_IS_HANDLE_VALID(Local_77.f_1.f_3[1 /*2*/]))
		{
	...
	if (MISC::GET_PROFILE_SETTING(false, 0) != iLocal_66)
	{
	...
	if (MISC::ARE_PROFILE_SETTINGS_VALID(false, 0) != iLocal_67)
	{
		...
		if (func_39(Local_77.f_1.f_3[1 /*2*/].f_1) && func_39(iVar0))
		{
			if (!func_12(Local_77.f_1))
			{
				if (func_36(&(Local_77.f_1), Local_77.f_1.f_1, Local_77.f_1.f_8, 0f, 1, 1, 1, 0, 0, 1, 0, 0, 0, 0))
				{
					...
					CAM::IS_AIM_CAM_ACTIVE(iVar1, Global_262145.f_10619, 0);
					if (func_34(&(Local_77.f_1.f_3[0 /*2*/]), Local_77.f_1, 4, iVar0, -1, 1, 1, 1))
					{
						...
						if (func_34(&(Local_77.f_1.f_3[1 /*2*/]), Local_77.f_1, 4, Local_77.f_1.f_3[1 /*2*/].f_1, 1, 1, 1, 1))
						{
							...
							NETWORK::_0x0EDE326D47CD0F3E(NETWORK::NET_TO_PED(Local_77.f_1.f_3[1 /*2*/]), PLAYER::PLAYER_ID());
							func_35(NETWORK::NET_TO_PED(Local_77.f_1.f_3[1 /*2*/]), 4);
							Global_2440049.f_4120.f_1[1] = NETWORK::NET_TO_PED(Local_77.f_1.f_3[1 /*2*/]);
...
void func_28(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (!bParam2)
	{
		if (bParam3)
		{
			...
			CAM::IS_AIM_CAM_ACTIVE(iParam0, 250, 0);
...
void func_29(int iParam0)
{
	...
	{
		iVar0 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(unk_0x9B0761B4C3EB8BC7());
	}
	...
	if (iParam2 && !bParam5)
	{
		if (func_49(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!PED::REMOVE_SCENARIO_BLOCKING_AREA())
			{
				...
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_47(PLAYER::PLAYER_ID()), Param0, 1) <= (fVar2 + fParam1))
				{
				...
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_43(iVar1) || !bParam8) && !Global_2425869[iVar1 /*443*/].f_263)
					{
						...
						if (!bParam5)
						{
							...
							{
								if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_47(iVar1), Param0, 1) <= (fVar2 + fParam1))
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && PLAYER::PLAYER_ID() != iVar1) || iParam6 == 0)
		{
			if (func_49(iVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(PLAYER::GET_PLAYER_PED(iVar1)) && func_43(iVar1)))
					{
						...
						{
							if (((unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1 && uParam7) && bParam4) && func_51(iVar1))
							{
							}
							else if (MISC::IS_BIT_SET(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_58(iVar1), Param0, 1) < fParam1)
								{
									return 1;
								}
							}
...
void func_63()
{
	if (SYSTEM::VMAG(bLocal_61))
	{
		unk_0x93370FA10F15BE44(&bLocal_61);
	}
}
...
void func_64()
{
	...
	if (!SYSTEM::VMAG(bLocal_61) && MISC::IS_BIT_SET(iVar0))
	{
		bLocal_61 = TASK::IS_PED_SPRINTING(iVar0);
		HUD::SET_BLIP_SPRITE(bLocal_61, 422);
		HUD::SHOW_HEIGHT_ON_BLIP(bLocal_61, false);
		PED::IS_PED_IN_PARACHUTE_FREE_FALL(bLocal_61, "MPCT_MERRY3");
		func_65(&bLocal_61, 1);
	}
}
	...
	switch (Local_77.f_1.f_2)
	{
		...
		case 2:
			if (func_12(Local_77.f_1))
			{
				...
				func_69();
				if (HUD::DOES_BLIP_EXIST(Local_77.f_1.f_3[0 /*2*/]))
				{
							...
							if (func_80(Local_77.f_1))
							{
								if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_77.f_1.f_3[0 /*2*/]))
								{
									...
									if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
									{
										if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
										{
											TASK::TASK_HELI_MISSION(iVar0, iVar1, 0, unk_0x9B0761B4C3EB8BC7(), 0f, 0f, 0f, iLocal_72, 20f, 40f, -1f, SYSTEM::CEIL(fLocal_71[0]), 10, -1082130432, 0);
										}
									}
								}
							}
				...
				if (HUD::DOES_BLIP_EXIST(Local_77.f_1.f_3[1 /*2*/]))
				{
						...
						if (func_80(Local_77.f_1))
						{
							if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_77.f_1.f_3[0 /*2*/]))
							{
								...
								if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
								{
									if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
									{
										TASK::TASK_HELI_MISSION(iVar0, iVar1, 0, unk_0x9B0761B4C3EB8BC7(), 0f, 0f, 0f, 8, 20f, 500f, -1f, 40, 10, -1082130432, 0);
...
void func_69()
{
	...
	if (!func_6(&uLocal_73))
	{
		...
		{
			if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iVar1, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iVar0, 1), 0) > 50f)
			{
				return;
			}
		}
...
void func_71()
{
	...
	if (func_77(iVar6))
	{
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iVar6, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iVar2, 1), 0) > Global_1689721)
		{
			return;
		}
	}
	...
	{
		TASK::TASK_HELI_MISSION(iVar3, iVar4, 0, iVar2, 0f, 0f, 0f, iLocal_72, 20f, 40f, -1f, SYSTEM::CEIL(fLocal_71[0]), 10, -1082130432, 0);
		iLocal_75 = iVar0;
	}
}
...
int func_79()
{
	if (CLOCK::GET_CLOCK_DAY_OF_MONTH() >= 22)
	{
		return 1;
	}
	if (CLOCK::GET_CLOCK_DAY_OF_MONTH() <= 6 && CLOCK::GET_CLOCK_DAY_OF_MONTH() >= 0)
	{
		return 1;
	}
	return 0;
...
void func_83()
{
	...
	if (bVar0)
	{
		...
		fLocal_68 = PATHFIND::_GET_HEIGHTMAP_TOP_Z_FOR_POSITION(Var1.x, Var1.f_1);
...
int func_86()
{
	...
	if (func_87() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_87()) == 0)
		{
			return 1;
		}
	}
...
void func_98(struct<21> Param0)
{
	...
	func_100(0, -1, 0);
	MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(&Local_77, 20);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_96, 33);
	...
	iLocal_96[NETWORK::PARTICIPANT_ID_TO_INT()] = 0;
}
