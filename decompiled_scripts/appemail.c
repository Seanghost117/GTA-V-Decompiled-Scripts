...
void __EntryFunction__()
{
	...
	iLocal_51 = func_78();
	HUD::HAS_ADDITIONAL_TEXT_LOADED("email", 1);
...
void func_13(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
...
void func_17()
{
	...
	if (!iLocal_60)
	{
		if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 172) || PAD::IS_DISABLED_CONTROL_PRESSED(2, 181))
		{
			iLocal_60 = 1;
	...
	else if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 172) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 181))
	{
	...
	if (!iLocal_61)
	{
		if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 173) || PAD::IS_DISABLED_CONTROL_PRESSED(2, 180))
		{
			iLocal_61 = 1;
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_19662, "SET_INPUT_EVENT");
	...
	else if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 173) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 180))
	{
	...
	else if (!PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 174))
	{
		iLocal_62 = 0;
	}
	if (!iLocal_63)
	...
	else if (!PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 175))
	{
		iLocal_63 = 0;
	}
	if (!iLocal_59)
	{
		if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 176) && SYSTEM::TIMERB() > 100)
		{
			if (iLocal_56 == -1)
			{
	...
	if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 179))
	{
		if (iLocal_64)
		{
			if (func_48("AM_H_FLINK") == 0)
...
int func_18(int iParam0, bool bParam1, int iParam2)
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("appsecuroserv")) > 0)
	{
		if (bVar0)
		{
		}
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("appbikerbusiness")) > 0)
	{
		if (bVar1)
		{
		}
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("appimportexport")) > 0)
	{
		if (bVar2)
		{
		}
...
void func_28(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_29(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, false, 2, AUDIO::ADD_LINE_TO_CONVERSATION(func_30(iParam1)), 0));
		}
		else
		{
			func_29(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, AUDIO::ADD_LINE_TO_CONVERSATION(func_30(iParam1)), 0));
		}
		switch (Global_19681)
		{
			case 0:
...
void func_56(int iParam0, int iParam1, int iParam2)
{
	...
	if (!bVar5)
	{
		...
		if (Global_46145[iVar2 /*46*/].f_42 > 1)
		{
			...
			while (iVar11 < iVar9)
			{
				...
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
				NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(9);
				NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iVar11 + 1);
	...
	else
	{
		...
		else
		{
			...
			bVar19 = false;
			bVar19 = func_57(iParam0, Global_52120[iVar13 /*203*/].f_1, iVar3, iVar16);
			if (!bVar19)
			{
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
				NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(9);
				...
				{
					MISC::UPDATE_ONSCREEN_KEYBOARD(&Var18);
					iVar20 = 0;
					iVar20 = 0;
					while (iVar20 < Global_52120[iVar13 /*203*/].f_10[iVar3 /*48*/].f_6)
					{
						HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(&(Global_52120[iVar13 /*203*/].f_10[iVar3 /*48*/].f_7[iVar20 /*4*/]));
						iVar20++;
					}
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT();
				}
...
int func_57(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	while (iVar5 < 16)
	{
		...
		if (bVar7)
		{
			...
			NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(9);
			NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iVar2);
			MISC::UPDATE_ONSCREEN_KEYBOARD("PROPR_INCEMAIL4");
			HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(sVar8);
