...
void __EntryFunction__()
{
	...
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
		{
			if (PED::IS_PED_IN_GROUP(bLocal_64))
			{
				PED::REMOVE_PED_FROM_GROUP(bLocal_64);
			}
		}
		func_176();
	}
								...
								switch (iLocal_53)
								{
									...
									case 1:
										if (iLocal_54 == 0)
										{
											if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
											{
												if ((ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 100f, 100f, 100f, false, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED(bLocal_64)) || ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 20f, 20f, 8f, false, true, 0))
												{
													func_107();
													if (!func_130())
													{
												...
												if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 20f, 20f, 8f, false, true, 0))
												{
													if (SYSTEM::VMAG(bLocal_89))
													{
														HUD::SHOW_HEIGHT_ON_BLIP(bLocal_89, true);
													}
													func_95();
													if (!func_94())
													{
														if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_64, "random@prisoner_lift", "arms_waving", 3) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_64, "random@prisoner_lift", "loop2_idlelook2", 3))
														{
															HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_64);
														}
														func_93(&uLocal_91);
													}
												}
										...
										else if (iLocal_54 == 1)
										{
											if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
											{
												if ((ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 105f, 105f, 105f, false, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED(bLocal_64)) || ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 20f, 20f, 8f, false, true, 0))
												{
													func_107();
													if (!func_130())
													{
												...
												if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_64, 0))
												{
													if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 20f, 20f, 8f, false, true, 0))
													{
														if (SYSTEM::VMAG(bLocal_89))
												...
												if (bLocal_83)
												{
													...
													{
														TASK::CLEAR_PED_SECONDARY_TASK(bLocal_64);
													}
												...
												if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
												{
													if (ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
													{
														...
														{
															if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), bLocal_64, 40f, 40f, 20f, false, true, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bLocal_64, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 17))
															{
																HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_64);
																...
																TASK::TASK_VEHICLE_MISSION_PED_TARGET(bLocal_64, PLAYER::GET_PLAYERS_LAST_VEHICLE(), unk_0x9B0761B4C3EB8BC7(), 8, 22f, 786469, 1f, 1f, true);
																PED::SET_PED_KEEP_TASK(bLocal_64, true);
																iLocal_53 = 13;
															}
															else if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 20f, 20f, 8f, false, true, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bLocal_64, unk_0x9B0761B4C3EB8BC7(), 17))
															{
												...
												if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
												{
													...
													{
														if (((unk_0x653A331834B72BC0(unk_0x9B0761B4C3EB8BC7()) || PED::IS_PED_IN_MODEL(unk_0x9B0761B4C3EB8BC7(), joaat("rhino"))) || PED::IS_PED_IN_ANY_HELI(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_IN_ANY_PLANE(unk_0x9B0761B4C3EB8BC7()))
														{
															func_73(&uLocal_114, "PRI2AU", "PRI2_FLEE", 4, 0, 0, 0);
															func_92();
														}
											...
											if (func_71())
											{
												if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_64, 0))
												{
													if (!PED::IS_PED_IN_MODEL(unk_0x9B0761B4C3EB8BC7(), joaat("bus")))
													{
														if (func_70(unk_0x9B0761B4C3EB8BC7(), bLocal_64) < 2.5f)
														{
															if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_67) < 1f)
															{
																func_69();
															}
														}
													}
													else if (func_70(unk_0x9B0761B4C3EB8BC7(), bLocal_64) < 10f)
													{
														if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_67) < 1f)
														{
															func_69();
										...
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
										{
											PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(bLocal_64, false);
										}
										break;
									...
									case 6:
										if (!iLocal_88 && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
										{
											...
											AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_64, iLocal_66);
										...
										if (func_65())
										{
											if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
											{
												...
												TASK::TASK_SMART_FLEE_COORD(bLocal_64, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 300f, -1, false, false);
												PED::SET_PED_KEEP_TASK(bLocal_64, true);
												SYSTEM::WAIT(0);
											}
											func_92();
									...
									case 10:
										...
										{
											if (!SYSTEM::VMAG(iLocal_62))
											{
												bLocal_62 = func_6(Local_74, 1);
											}
										...
										if (bLocal_84)
										{
											...
											{
												if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || func_5(unk_0x9B0761B4C3EB8BC7(), bLocal_73, 1) > 200f)
												{
									...
									case 11:
										...
										if (ENTITY::GET_ENTITY_COORDS(bLocal_67, false))
										{
											if (!func_72(bLocal_67))
											{
												if (!iLocal_85)
												{
													if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && !SYSTEM::VDIST(bLocal_64, 0))
													{
														if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
														{
															if (!iLocal_87)
															...
															TASK::TASK_ENTER_VEHICLE(bLocal_64, bLocal_67, -1, -1, 2f, 1, 0);
															PED::SET_PED_KEEP_TASK(bLocal_64, true);
															iLocal_53 = 12;
														}
													}
													if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
													{
														if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_64, unk_0x9B0761B4C3EB8BC7(), true) || (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_64) && WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))) || (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_64) && WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))) || (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_67) > 2.5f && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_67, 0)))
														{
															TASK::TASK_COMBAT_PED(bLocal_64, unk_0x9B0761B4C3EB8BC7(), 0, 16);
															func_52();
															iLocal_85 = 1;
														}
													}
											...
											else
											{
												if (SYSTEM::VMAG(bLocal_89))
												{
													unk_0x93370FA10F15BE44(&bLocal_89);
												}
												if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
												{
													TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
													TASK::TASK_SMART_FLEE_COORD(false, 1449.05f, 2507.258f, 44.8843f, 1000f, -1, false, false);
													TASK::TASK_SMART_FLEE_COORD(false, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 300f, -1, false, false);
													TASK::CLOSE_SEQUENCE_TASK(iLocal_66);
													AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_64, iLocal_66);
													TASK::CLEAR_SEQUENCE_TASK(&iLocal_66);
													PED::SET_PED_KEEP_TASK(bLocal_64, true);
										...
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
										{
											if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 150f, 150f, 150f, false, true, 0))
											{
												TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
												TASK::TASK_SMART_FLEE_COORD(false, 1449.05f, 2507.258f, 44.8843f, 1000f, -1, false, false);
												TASK::TASK_SMART_FLEE_COORD(false, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 300f, -1, false, false);
									...
									case 12:
										...
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
										{
											if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_64, unk_0x9B0761B4C3EB8BC7(), true))
											{
												if (SYSTEM::VMAG(bLocal_89))
												{
													HUD::SET_BLIP_AS_FRIENDLY(bLocal_89, false);
													ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(bLocal_64);
												}
											}
											if (ENTITY::GET_ENTITY_COORDS(bLocal_67, false))
											{
												if (!func_72(bLocal_67))
												{
													if (unk_0xE0B3BC41DDA88DF0(bLocal_64, bLocal_67, 0))
													{
														if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(bLocal_67))
														{
															ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_67, true, false);
														}
														TASK::TASK_VEHICLE_MISSION_PED_TARGET(bLocal_64, bLocal_67, unk_0x9B0761B4C3EB8BC7(), 8, 22f, 786469, 1f, 1f, true);
														PED::SET_PED_KEEP_TASK(bLocal_64, true);
														iLocal_53 = 13;
													}
													else if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_67, 0))
													{
														if (bLocal_94)
														{
															TASK::TASK_COMBAT_PED(bLocal_64, unk_0x9B0761B4C3EB8BC7(), 0, 16);
													...
													else if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_64, -1794415470) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bLocal_64, -1794415470) != 0)
													{
														if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_64, 780511057) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bLocal_64, 780511057) != 0)
														{
														}
														else
														{
									...
									case 13:
										...
										if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
										{
											if (PED::IS_PED_BEING_JACKED(bLocal_64))
											{
												func_52();
											}
											if (SYSTEM::VDIST(bLocal_64, 0))
											{
												if (SYSTEM::VMAG(bLocal_89))
												{
													HUD::SET_BLIP_AS_FRIENDLY(bLocal_89, false);
												}
												if (VEHICLE::IS_VEHICLE_MODEL(ENTITY::GET_ENTITY_MODEL(bLocal_64, 0), joaat("towtruck")) || VEHICLE::IS_VEHICLE_MODEL(ENTITY::GET_ENTITY_MODEL(bLocal_64, 0), joaat("towtruck2")))
												{
													iLocal_71 = VEHICLE::GET_ENTITY_ATTACHED_TO_TOW_TRUCK(ENTITY::GET_ENTITY_MODEL(bLocal_64, 0));
													if (MISC::IS_BIT_SET(iLocal_71))
													{
														bLocal_70 = ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(bLocal_71);
														if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(ENTITY::GET_ENTITY_MODEL(bLocal_64, 0), 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_70, 0))
														{
															if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(ENTITY::GET_ENTITY_MODEL(bLocal_64, 0), bLocal_70))
															{
																VEHICLE::DETACH_VEHICLE_FROM_TOW_TRUCK(ENTITY::GET_ENTITY_MODEL(bLocal_64, 0), bLocal_70);
															}
														}
													}
												}
												if (PED::IS_PED_ON_SPECIFIC_VEHICLE(unk_0x9B0761B4C3EB8BC7(), ENTITY::GET_ENTITY_MODEL(bLocal_64, 0)))
												{
													TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
												...
												if (!iLocal_97)
												{
													if ((func_1(ENTITY::GET_ENTITY_MODEL(bLocal_64, 0)) || !ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(bLocal_64, 0), false)) || func_72(ENTITY::GET_ENTITY_MODEL(bLocal_64, 0)))
													{
														if (SYSTEM::VMAG(bLocal_89))
														{
															HUD::SET_BLIP_AS_FRIENDLY(bLocal_89, false);
												...
												if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 245f, 245f, 245f, false, true, 0))
												{
													func_92();
												}
											}
											else if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_64, 242628503) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bLocal_64, 242628503) != 0)
											{
												iLocal_53 = 11;
											}
											else if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 200f, 200f, 200f, false, true, 0))
											{
												func_16();
											}
										}
...
int func_1(bool bParam0)
{
	...
	if ((func_4(unk_0x9B0761B4C3EB8BC7()) && SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0)) && func_2(bParam0))
	{
...
bool func_6(struct<3> Param0, bool bParam1)
{
	bool bVar0;
	
	bVar0 = HUD::ADD_BLIP_FOR_COORD(Param0);
	HUD::SET_BLIP_SCALE(bVar0, func_7(MISC::SET_BIT(), 1f, 1f));
...
void func_8()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (!func_94())
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_64, 1227113341) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bLocal_64, 1227113341) != 0)
				{
					TASK::TASK_GO_TO_ENTITY(bLocal_64, unk_0x9B0761B4C3EB8BC7(), -1, 6f, 2f, 2f, 0);
				}
				if (SYSTEM::VDIST(bLocal_64, 0))
				{
					TASK::TASK_LEAVE_ANY_VEHICLE(bLocal_64, 0, 0);
				}
				if (!iLocal_95)
				{
					if (!func_89())
...
void func_10()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 8f, 8f, 8f, false, true, 0))
		{
			if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (unk_0xE0B3BC41DDA88DF0(bLocal_64, ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 0))
					{
						if (SYSTEM::VMAG(bLocal_89))
						{
							unk_0x93370FA10F15BE44(&bLocal_89);
			...
			else if (SYSTEM::VMAG(bLocal_62))
			{
				unk_0x93370FA10F15BE44(&bLocal_62);
			}
		}
		else
		{
			if (!SYSTEM::VMAG(bLocal_89))
			{
				bLocal_89 = func_11(bLocal_64, 0, 145);
			}
			if (SYSTEM::VMAG(bLocal_62))
			{
				unk_0x93370FA10F15BE44(&bLocal_62);
...
bool func_11(bool bParam0, bool bParam1, int iParam2)
{
	int iVar0;
...
bool func_12(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_7(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
void func_13()
{
	switch (iLocal_90)
	{
		...
		case 1:
			if (func_14())
			{
				if (SYSTEM::TIMERA() > 500)
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_67, false))
					{
						VEHICLE::SET_VEHICLE_STEER_BIAS(bLocal_67, -1f);
						if (SYSTEM::VMAG(bLocal_62))
						{
							unk_0x93370FA10F15BE44(&bLocal_62);
						}
			...
			if (func_14())
			{
				if (SYSTEM::TIMERA() > 2000)
				{
					if (ENTITY::GET_ENTITY_COORDS(bLocal_67, false))
					{
						...
						TASK::TASK_VEHICLE_TEMP_ACTION(unk_0x9B0761B4C3EB8BC7(), bLocal_67, 24, 2000);
						iLocal_90++;
					}
				}
			}
			...
			if (func_14())
			{
				if (SYSTEM::TIMERA() > 4000)
				{
					...
					if (ENTITY::GET_ENTITY_COORDS(bLocal_67, false))
					{
						...
						{
							PED::REMOVE_PED_FROM_GROUP(bLocal_64);
							VEHICLE::SET_VEHICLE_STEER_BIAS(bLocal_67, 0f);
							TASK::TASK_LEAVE_VEHICLE(bLocal_64, bLocal_67, 320);
							if (!SYSTEM::VMAG(bLocal_89))
							{
								bLocal_89 = func_11(bLocal_64, 1, 145);
							}
							iLocal_90++;
						}
					}
		...
		case 4:
			if (ENTITY::GET_ENTITY_COORDS(bLocal_67, false))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64) && !unk_0xE0B3BC41DDA88DF0(bLocal_64, bLocal_67, 0))
				{
					TASK::TASK_SMART_FLEE_COORD(bLocal_64, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 300f, -1, false, false);
					PED::SET_PED_KEEP_TASK(bLocal_64, true);
					func_52();
...
int func_14()
{
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		bLocal_67 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
		if (ENTITY::GET_ENTITY_COORDS(bLocal_67, false))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
			{
				if (PED::IS_PED_SITTING_IN_VEHICLE(bLocal_64, bLocal_67))
				{
					return 1;
				}
			}
...
void func_15()
{
	if ((!iLocal_88 && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64)) && ENTITY::GET_ENTITY_COORDS(bLocal_67, false))
	{
		PED::REMOVE_PED_FROM_GROUP(bLocal_64);
		TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
		TASK::TASK_LOOK_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 5000, 2048, 2);
...
void func_16()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
	{
		PED::_0x2208438012482A1A(bLocal_64, 0);
	}
	while (!func_51())
	{
		SYSTEM::WAIT(0);
...
var func_26(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
void func_35()
{
	...
	{
		if (func_39(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_54()
{
	if (SYSTEM::VMAG(bLocal_62))
	{
		HUD::SET_BLIP_ROUTE(bLocal_62, false);
		unk_0x93370FA10F15BE44(&bLocal_62);
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
		{
			HUD::CLEAR_PRINTS();
...
void func_55()
{
	...
	if (func_60(unk_0x9B0761B4C3EB8BC7(), Local_57, 1) > 200f)
	{
		if (!bLocal_84)
		{
			Var0[0 /*3*/] = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) - Vector(0f, 9f, 0f) };
			PATHFIND::GET_SAFE_COORD_FOR_PED(Var0[0 /*3*/], false, &(Var0[0 /*3*/]), 0);
			Var0[1 /*3*/] = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) + Vector(0f, 9f, 0f) };
			PATHFIND::GET_SAFE_COORD_FOR_PED(Var0[1 /*3*/], false, &(Var0[1 /*3*/]), 0);
			Var0[2 /*3*/] = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) - Vector(0f, 0f, 9f) };
			PATHFIND::GET_SAFE_COORD_FOR_PED(Var0[2 /*3*/], false, &(Var0[2 /*3*/]), 0);
			Var0[3 /*3*/] = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) + Vector(0f, 0f, 9f) };
			PATHFIND::GET_SAFE_COORD_FOR_PED(Var0[3 /*3*/], false, &(Var0[3 /*3*/]), 0);
			if (!CAM::IS_SPHERE_VISIBLE(Var0[0 /*3*/], 3f))
			{
				bLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[0 /*3*/], func_58(Var0[0 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_73, 6, joaat("s_m_y_ranger_01"), -1, true, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_73, 6, joaat("s_m_y_ranger_01"), 0, true, true);
				unk_0x92BD213E6A0E666B(iLocal_72[0], joaat("weapon_pistol"), -1, 0, 1);
				unk_0x92BD213E6A0E666B(iLocal_72[1], joaat("weapon_pistol"), -1, 0, 1);
			...
			{
				bLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[1 /*3*/], func_58(Var0[1 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_73, 6, joaat("s_m_y_ranger_01"), -1, true, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_73, 6, joaat("s_m_y_ranger_01"), 0, true, true);
				unk_0x92BD213E6A0E666B(iLocal_72[0], joaat("weapon_pistol"), -1, 0, 1);
				unk_0x92BD213E6A0E666B(iLocal_72[1], joaat("weapon_pistol"), -1, 0, 1);
			...
			{
				bLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[2 /*3*/], func_58(Var0[2 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_73, 6, joaat("s_m_y_ranger_01"), -1, true, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_73, 6, joaat("s_m_y_ranger_01"), 0, true, true);
				unk_0x92BD213E6A0E666B(iLocal_72[0], joaat("weapon_pistol"), -1, 0, 1);
				unk_0x92BD213E6A0E666B(iLocal_72[1], joaat("weapon_pistol"), -1, 0, 1);
			...
			{
				bLocal_73 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[3 /*3*/], func_58(Var0[3 /*3*/], func_59(PLAYER::PLAYER_ID())), true, true, false);
				iLocal_72[0] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_73, 6, joaat("s_m_y_ranger_01"), -1, true, true);
				iLocal_72[1] = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_73, 6, joaat("s_m_y_ranger_01"), 0, true, true);
				unk_0x92BD213E6A0E666B(iLocal_72[0], joaat("weapon_pistol"), -1, 0, 1);
				unk_0x92BD213E6A0E666B(iLocal_72[1], joaat("weapon_pistol"), -1, 0, 1);
	...
	if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_69, 0), 10f, 10f, 10f, 0, 0, 0) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
	{
		func_57();
	}
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
	{
		if (((!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && unk_0x1037B9D45CE6B788(bLocal_64, 990.7705f, -105.594f, 73.3055f, 954.8849f, -145.3864f, 79.1073f, 8.8125f, 0, 1, 0)) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 990.7705f, -105.594f, 73.3055f, 954.8849f, -145.3864f, 79.1073f, 8.8125f, 0, 1, 0)) || (unk_0xC2169C00B643278B(bLocal_64, Local_74, Global_19, 1, 1, 0) && func_56(1, 0, 1)))
		{
			SYSTEM::SETTIMERA(0);
			if (func_14())
			{
...
float func_60(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_61()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
	{
		if (PED::IS_PED_ON_FOOT(bLocal_64))
		{
			if (!iLocal_108)
			{
...
int func_63()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
	{
		if (PED::IS_PED_IN_GROUP(bLocal_64))
		{
			if ((((((((unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_98, 50f, 50f, 50f, 0, 1, 0) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_99, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_100, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_101, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_102, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_103, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_104, 50f, 50f, 50f, 0, 1, 0)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_105, 50f, 50f, 50f, 0, 1, 0)) || func_60(unk_0x9B0761B4C3EB8BC7(), Local_106, 1) < 205f)
			{
				return 1;
			}
		}
...
void func_64()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64) && func_94())
	{
		if (ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(unk_0x9B0761B4C3EB8BC7(), ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)) && PED::IS_PED_SITTING_IN_VEHICLE(bLocal_64, ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
			{
				SYSTEM::SETTIMERA(0);
				if (!PED::IS_PED_IN_GROUP(bLocal_64))
				{
					PED::SET_PED_AS_GROUP_MEMBER(bLocal_64, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
					PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(bLocal_64, 0);
					PED::SET_PED_NEVER_LEAVES_GROUP(bLocal_64, true);
				}
				if (iLocal_54 == 0)
				{
					if (!func_89())
					{
						if (func_73(&uLocal_114, "PRI1AU", "PRI1_CH", 4, 0, 0, 0))
						{
							...
							VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_78, 3);
							iLocal_80 = 1;
							iLocal_53 = 3;
						}
					}
				...
				else if (iLocal_54 == 1)
				{
					...
					PED::SET_PED_FLEE_ATTRIBUTES(bLocal_64, 2, true);
					iLocal_53 = 3;
				}
			}
		}
...
int func_65()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
	{
		if (ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_64, PLAYER::GET_PLAYERS_LAST_VEHICLE(), true))
			{
				func_52();
				return 1;
			}
		...
		if (!ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 250f, 250f, 250f, false, true, 0))
		{
			return 1;
		}
		if (iLocal_54 == 0)
		{
			...
			if (func_68())
			{
				...
				while (iVar0 < func_67())
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(func_66(iVar0), unk_0x9B0761B4C3EB8BC7(), false))
					{
		...
		if (iLocal_53 < 2)
		{
			if (PED::HAS_PED_RECEIVED_EVENT(bLocal_64, 126))
			{
				return 1;
			}
			if (iLocal_54 == 0)
			{
				...
				{
					if (((PED::IS_COP_PED_IN_AREA_3D(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_69, 0) + Vector(0f, 0f, 45f) - Vector(40f, 40f, 40f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_69, 0) + Vector(0f, 0f, 45f) + Vector(40f, 40f, 40f)) || PED::IS_COP_PED_IN_AREA_3D(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_69, 0) - Vector(0f, 0f, 45f) - Vector(40f, 40f, 40f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_69, 0) - Vector(0f, 0f, 45f) + Vector(40f, 40f, 40f))) || PED::IS_COP_PED_IN_AREA_3D(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_69, 0) + Vector(0f, 45f, 0f) - Vector(40f, 40f, 40f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_69, 0) + Vector(0f, 45f, 0f) + Vector(40f, 40f, 40f))) || PED::IS_COP_PED_IN_AREA_3D(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_69, 0) - Vector(0f, 45f, 0f) - Vector(40f, 40f, 40f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_69, 0) - Vector(0f, 45f, 0f) + Vector(40f, 40f, 40f)))
					{
						TASK::TASK_SMART_FLEE_PED(bLocal_64, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
						PED::SET_PED_KEEP_TASK(bLocal_64, true);
						return 1;
					}
				}
			...
			{
				if (PED::IS_COP_PED_IN_AREA_3D(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 0) - Vector(70f, 70f, 70f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 0) + Vector(70f, 70f, 70f)))
				{
					return 1;
				}
			}
			if (MISC::IS_BULLET_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 1), 20f, true))
			{
				return 1;
			}
			if ((MISC::IS_PROJECTILE_TYPE_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 1) - Vector(15f, 15f, 15f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 1) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 1) - Vector(15f, 15f, 15f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 1) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), true)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 1) - Vector(15f, 15f, 15f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 1) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), true))
			{
				return 1;
			}
			if (GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 1), 3f))
			{
				return 1;
			}
			if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			...
			if ((ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 20f, 20f, 8f, false, true, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(bLocal_64, unk_0x9B0761B4C3EB8BC7())) && WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bLocal_64) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bLocal_64))
				{
					return 1;
				}
			}
	...
	if (ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
		{
			if (!func_89())
			{
				...
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_64);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
				TASK::TASK_AIM_GUN_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 500, true);
				TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), unk_0x9B0761B4C3EB8BC7(), 1f, false, 1f, 0.5f, true, false, -957453492);
				TASK::TASK_ENTER_VEHICLE(false, PLAYER::GET_PLAYERS_LAST_VEHICLE(), -1, -1, 2f, 9, 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_66);
				AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_64, iLocal_66);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_66);
				SYSTEM::SETTIMERA(0);
...
void func_90()
{
	...
	{
		if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_69, 0) && !SYSTEM::VDIST2(bLocal_69, -1, 0))
		{
			AUDIO::_0x9D3AF56E94C9AE98(bLocal_69, 60000f);
			AUDIO::_SOUND_VEHICLE_HORN_THIS_FRAME(bLocal_69);
		}
	}
}
	...
	switch (iLocal_92)
	{
		case 0:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 20f, 20f, 8f, false, true, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7()) < 2.5f || !(SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), bLocal_64, 15f, 15f, 8f, false, true, 0)))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
						TASK::TASK_LOOK_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 30000, 2050, 2);
						TASK::TASK_GO_TO_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, 2f, 1f, 2f, 0);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_66);
						AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_64, iLocal_66);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_66);
		...
		case 1:
			...
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
			{
				...
				{
					bLocal_67 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_67) < 9f)
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(bLocal_64, bLocal_67, 20f, 20f, 5f, false, true, 0))
							{
								iLocal_92++;
							}
						}
				...
				{
					fLocal_93 = func_5(bLocal_64, unk_0x9B0761B4C3EB8BC7(), 1);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
					TASK::TASK_LOOK_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), 7000, 2048, 2);
					TASK::TASK_GO_TO_ENTITY(false, unk_0x9B0761B4C3EB8BC7(), -1, (fLocal_93 - 3f), 1f, 2f, 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_66);
					AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_64, iLocal_66);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_66);
					if (!func_89())
		...
		case 2:
			...
			if (!iLocal_96)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7()) < 2.5f)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_64);
						TASK::TASK_OPEN_VEHICLE_DOOR(bLocal_64, bLocal_67, -1, 0, 1f);
						iLocal_96 = 1;
					}
				}
				if (!func_89())
			...
			{
				bLocal_67 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_67) < 2.5f)
				{
					if (unk_0xC2169C00B643278B(bLocal_67, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_64, 1), 20f, 20f, 5f, 0, 1, 0))
					{
						if (iLocal_54 == 0)
						{
							if (!func_89())
		...
		case 3:
			...
			{
				bLocal_67 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_67) < 0.5f)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_64);
		...
		case 5:
			if (func_94())
			{
				if (ENTITY::GET_ENTITY_COORDS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), false))
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
					{
						if (PED::IS_PED_SITTING_IN_VEHICLE(bLocal_64, ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
						{
							if (SYSTEM::VMAG(bLocal_89))
							{
								unk_0x93370FA10F15BE44(&bLocal_89);
...
void func_93(var uParam0)
{
	switch (*uParam0)
	{
		case 0:
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
			{
				if (!PED::IS_PED_FACING_PED(bLocal_64, unk_0x9B0761B4C3EB8BC7(), 90f))
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(bLocal_64, unk_0x9B0761B4C3EB8BC7(), 0);
					*uParam0++;
				}
			}
			break;
...
int func_94()
{
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if ((((((!unk_0x653A331834B72BC0(unk_0x9B0761B4C3EB8BC7()) && !PED::IS_PED_IN_ANY_BOAT(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_HELI(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_PLANE(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_SUB(unk_0x9B0761B4C3EB8BC7())) && !PED::IS_PED_IN_ANY_TRAIN(unk_0x9B0761B4C3EB8BC7())) && !VEHICLE::IS_BIG_VEHICLE(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
			{
...
void func_95()
{
	...
	{
		bLocal_67 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
		if ((ENTITY::GET_ENTITY_COORDS(bLocal_67, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64)) && !bLocal_83)
		{
			fLocal_93 = func_5(bLocal_64, unk_0x9B0761B4C3EB8BC7(), 1);
			if (fLocal_93 > 5f)
			{
			...
			if (iLocal_54 == 0)
			{
				TASK::TASK_LOOK_AT_ENTITY(0, bLocal_67, 10000, 2048, 2);
				TASK::TASK_PLAY_ANIM(0, "random@prisoner_lift", "arms_waving", 2f, -2f, -1, 49, 0f, false, false, false);
				TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), unk_0x9B0761B4C3EB8BC7(), 1f, false, fLocal_93, 1f, true, false, -957453492);
			}
			else if (iLocal_54 == 1)
			{
				TASK::TASK_LOOK_AT_ENTITY(0, bLocal_67, 10000, 2052, 2);
				TASK::TASK_PLAY_ANIM(0, "random@prisoner_lift", "arms_waving", 2f, -2f, -1, 49, 0f, false, false, false);
				TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1f, 0f, 0f, 1f, -1, 0.5f, true);
			}
			TASK::CLOSE_SEQUENCE_TASK(iLocal_66);
			AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_64, iLocal_66);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_66);
...
void func_107()
{
	...
	{
		bLocal_89 = func_11(bLocal_64, 0, 145);
		HUD::SHOW_HEIGHT_ON_BLIP(bLocal_89, false);
	}
}
...
void func_108()
{
	...
	bLocal_64 = PED::CREATE_PED(26, iLocal_76, Local_68, fLocal_75, true, true);
	PED::_0x2208438012482A1A(bLocal_64, 1);
	PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_64, 1.87774E-43f, 1);
	PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_64, 1.919779E-43f, 1);
	PED::ADD_RELATIONSHIP_GROUP("PedPrisoner", &iLocal_65);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_64, iLocal_65);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("COP"), iLocal_65);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_65, joaat("COP"));
	TASK::TASK_PLAY_ANIM(bLocal_64, "random@prisoner_lift", "loop2_idlelook2", 2f, -2f, -1, 1, 0f, false, false, false);
	PED::SET_PED_MONEY(bLocal_64, 0);
	PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_64, 8, false);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_64, 128, true);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_64, 2, true);
	PED::SET_PED_FLEE_ATTRIBUTES(bLocal_64, 1, false);
	unk_0xBE20AB8238688965(&uLocal_78, 3);
	unk_0xBE20AB8238688965(&uLocal_78, 5);
	unk_0xBE20AB8238688965(&uLocal_78, 0);
	if (iLocal_54 == 0)
	{
		AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_64, "REPRI1Lost");
		func_109(&uLocal_114, 3, bLocal_64, "REPRI1Lost", 0, 1);
		MISC::CLEAR_AREA_OF_PEDS(Local_68, 50f, 0);
		MISC::CLEAR_AREA(Local_68, 10f, false, false, false, false);
		PATHFIND::SET_ROADS_IN_AREA(Local_68 - Vector(50f, 50f, 50f), Local_68 + Vector(50f, 50f, 50f), false, true, 1, 1);
		PATHFIND::SET_ROADS_IN_AREA(Local_74 - Vector(10f, 10f, 10f), Local_74 + Vector(10f, 10f, 10f), false, true, 1, 1);
		unk_0xAF7D4BF357E8B79E(Local_68 - Vector(10f, 10f, 10f), Local_68 + Vector(10f, 10f, 10f), 0, 1);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_65, -1865950624);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1865950624, iLocal_65);
		PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_64, 17, true);
		bLocal_69 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), 1524.332f, 2173.347f, 79.0619f, 201.6806f, true, true, false);
		VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bLocal_69, 0f);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(bLocal_69, 4, false, false);
		VEHICLE::SET_VEHICLE_TYRE_BURST(bLocal_69, 0, false, 1000f);
		VEHICLE::_0x0AD9E8F87FF7C16F(bLocal_69, false);
		...
		iVar0 = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_69, 26, joaat("s_m_y_ranger_01"), -1, true, true);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iVar0, 4.568233E-43f, 1);
		CAM::IS_AIM_CAM_ACTIVE(bVar0, 99, 0);
		PED::SET_PED_PLAYS_HEAD_ON_HORN_ANIM_WHEN_DIES_IN_VEHICLE(bVar0, true);
	...
	else if (iLocal_54 == 1)
	{
		...
		AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_64, "G_M_Y_STREETPUNK02_BLACK_MINI_04");
		func_109(&uLocal_114, 3, bLocal_64, "REPRI2Prisoner", 0, 1);
		unk_0x92BD213E6A0E666B(bLocal_64, joaat("weapon_pistol"), -1, 0, 1);
	}
	if (func_50() == 0)
	{
		func_109(&uLocal_114, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
	}
	else if (func_50() == 1)
	{
		func_109(&uLocal_114, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	}
	else if (func_50() == 2)
	{
		func_109(&uLocal_114, 2, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
	}
	iLocal_53 = 1;
}
...
void func_115()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_76) && STREAMING::HAS_ANIM_DICT_LOADED("random@prisoner_lift"))
	{
		if (iLocal_54 == 0)
		{
			if (((ENTITY::DOES_ENTITY_EXIST(joaat("s_m_y_ranger_01")) && ENTITY::DOES_ENTITY_EXIST(joaat("sheriff"))) && ENTITY::DOES_ENTITY_EXIST(joaat("ratloader"))) && ENTITY::DOES_ENTITY_EXIST(joaat("bfinjection")))
			{
				bLocal_55 = true;
			}
		}
...
int func_117()
{
	...
	{
		if (SYSTEM::VDIST2(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_50) < (75f * 75f))
		{
			return 1;
		}
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_128())
		{
			return 0;
		}
	}
...
int func_134(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_170(Global_111858.f_24991.f_43[iParam1]))
		{
			return 0;
		}
...
void func_140(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_142(fVar0, iVar1));
		iVar3 = (iVar3 - 1);
		fVar0 = SYSTEM::ROUND(func_141(SYSTEM::TO_FLOAT(fVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
int func_151()
{
	...
	func_152(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_168()) || Global_110905) || Global_30970) || func_167()) || func_86(8, -1)) || func_164()) || func_166()) || func_165()) || func_163()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_168() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_86(8, -1)) || func_163()) || func_162()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_176()
{
	if (iLocal_107)
	{
		...
		unk_0xAF7D4BF357E8B79E(Local_68 - Vector(10f, 10f, 10f), Local_68 + Vector(10f, 10f, 10f), 1, 1);
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_64))
		{
			...
			if (iLocal_54 == 0)
			{
				PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_64, 4.442116E-43f, 1);
				if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
					TASK::TASK_SMART_FLEE_COORD(false, 1449.05f, 2507.258f, 44.8843f, 1000f, -1, false, false);
			...
			else if (iLocal_54 == 1)
			{
				...
				else if (ENTITY::GET_ENTITY_COORDS(bLocal_67, false))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_66);
					TASK::TASK_ENTER_VEHICLE(false, bLocal_67, -1, -1, 2f, 9, 0);
					TASK::TASK_SMART_FLEE_COORD(false, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 300f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_66);
					AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_64, iLocal_66);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_66);
...
Vector3 func_191()
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		fVar0 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_59, 1);
		iLocal_58 = 1;
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_60, 1) < fVar0)
		{
			fVar0 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_60, 1);
			iLocal_58 = 2;
		}
		if (iLocal_58 == 1)
		{
