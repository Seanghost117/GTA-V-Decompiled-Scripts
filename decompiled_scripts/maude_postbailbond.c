...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			Var1 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_42, 1) };
			...
			switch (iLocal_47)
			{
				...
				case 2:
					...
					{
						if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_42, func_11(), func_3(), 3))
						{
							func_1();
						}
					}
...
void func_1()
{
	...
	{
		func_2(&iLocal_42);
		TASK::TASK_SMART_FLEE_PED(iLocal_42, unk_0x9B0761B4C3EB8BC7(), 10000f, -1, false, false);
...
void func_2(int iParam0)
{
	if (func_51(*iParam0))
	{
		...
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(*iParam0, 1.653532E-43f, 1);
	}
}
...
int func_5(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_51(*iParam0))
	{
		if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*iParam0, func_10(), func_9(), 3))
		{
			if (!MISC::IS_PC_VERSION(*iParam0) || TASK::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_11()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					if (func_8(*iParam1))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*iParam1, func_10(), func_7(), 3))
						{
...
void func_16(bool bParam0)
{
	...
	if (func_23())
	{
		Var0 = { func_22() };
		uVar1 = func_21();
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&Var0, uVar1))
		{
			if (bParam0)
			{
				func_19();
...
int func_25(int iParam0, bool bParam1)
{
	if (func_51(*iParam0))
	{
		...
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), *iParam0))
			{
				return 1;
			}
			if (MISC::IS_BIT_SET(iLocal_39))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_39))
				{
					return 1;
				}
			}
			if (MISC::IS_BIT_SET(iLocal_40))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_40))
				{
					return 1;
				}
			}
			if (MISC::IS_BIT_SET(iLocal_41))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_41))
				{
					return 1;
				}
			}
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(*iParam0, unk_0x9B0761B4C3EB8BC7(), 3f, 3f, 3f, false, true, 0))
			{
				return 1;
			}
		}
...
int func_29(int* iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_31(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
...
bool func_35(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_36(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_36(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_37(int* iParam0, bool bParam1)
{
	bool bVar0;
...
int func_39(int* iParam0, int* iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_31(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_43(struct<3> Param0, struct<3> Param1, int iParam2, float fParam3)
{
	...
	if (iLocal_44 < iLocal_45)
	{
		if (!func_23())
		{
			...
			{
				if (MISC::GET_GAME_TIMER() - iLocal_43) > (iParam2 + NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 2000))
				{
					uVar0 = 16;
...
void func_50()
{
	...
	if (func_51(iLocal_42))
	{
		...
		PED::_0x2208438012482A1A(iLocal_42, 1);
		...
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_42, 1.653532E-43f, 0);
		...
		if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Var0, 10f, joaat("prop_table_03b"), false))
		{
			...
			if (func_8(iLocal_40))
			{
				unk_0x03D382CB0B44E2FC(iLocal_40, 2727.4f, 4145.56f, 43.68f, 1, 0, 0, 1);
		...
		if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Var0, 10f, joaat("prop_laptop_01a"), false))
		{
			...
			if (func_8(iLocal_41))
			{
				...
				unk_0x03D382CB0B44E2FC(iLocal_41, 2727.686f, 4145.715f, 44.08f, 1, 0, 0, 1);
		...
		if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Var0, 10f, joaat("prop_table_03_chr"), false))
		{
			...
			if (func_8(iLocal_39))
			{
				...
				unk_0x03D382CB0B44E2FC(iLocal_39, 2728.35f, 4145.59f, 43.3f, 1, 0, 0, 1);
...
int func_52()
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		while (iVar1 < iVar0)
		{
			...
			{
				if (MISC::GET_MODEL_DIMENSIONS(uVar2[iVar1]) == func_53(62))
				{
...
void func_56()
{
	...
	if (func_8(iLocal_39))
	{
		ENTITY::SET_ENTITY_COORDS(iLocal_39, 0);
		if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_39, "special_ped@maude@base", "base_chair", 3))
		{
			NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(iLocal_39, "base_chair", "special_ped@maude@base", -1000f);
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_39, -1000f, true);
		}
		else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_39, func_11(), "Female_Flee_Table_Left_Maude_Chair", 3))
		{
			NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(iLocal_39, "Female_Flee_Table_Left_Maude_Chair", func_11(), -1000f);
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_39, -1000f, true);
		}
	}
	func_58(&iLocal_39, 0);
	...
	{
		PED::SET_PED_KEEP_TASK(iLocal_42, true);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_42, 1.653532E-43f, 1);
	}
