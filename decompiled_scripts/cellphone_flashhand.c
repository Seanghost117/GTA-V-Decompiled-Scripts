...
void __EntryFunction__()
{
	...
	Global_19861 = 145;
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 8);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7551, 14);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_4271024, 3);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 10);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7551, 17);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7551, 9);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7551, 26);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7551, 23);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 24);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 25);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 27);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 26);
	...
	if (Global_19663 == 0)
	{
		...
		if (Global_19664 == 1)
		{
			...
			VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7551, 30);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 5);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 21);
			VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7553, 2);
		...
		Global_19607 = 0.195f;
		Global_19608 = 0.05f;
		if ((unk_0x11E5DE894D6A8A5F() || NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE()) || ENTITY::GET_ENTITY_HEADING())
		{
			HUD::GET_HUD_COLOUR(18, &iLocal_104, &iLocal_105, &iLocal_106, &uLocal_107);
			func_109(Global_19662, "SET_SOFT_KEYS_COLOUR", 2f, SYSTEM::TO_FLOAT(iLocal_104), SYSTEM::TO_FLOAT(iLocal_105), SYSTEM::TO_FLOAT(iLocal_106), -1082130432);
			HUD::GET_HUD_COLOUR(9, &fLocal_104, &fLocal_105, &fLocal_106, &uLocal_107);
			func_109(Global_19662, "SET_SOFT_KEYS_COLOUR", 1f, SYSTEM::TO_FLOAT(fLocal_104), SYSTEM::TO_FLOAT(fLocal_105), SYSTEM::TO_FLOAT(fLocal_106), -1082130432);
			HUD::GET_HUD_COLOUR(6, &fLocal_104, &fLocal_105, &fLocal_106, &uLocal_107);
			func_109(Global_19662, "SET_SOFT_KEYS_COLOUR", 3f, SYSTEM::TO_FLOAT(fLocal_104), SYSTEM::TO_FLOAT(fLocal_105), SYSTEM::TO_FLOAT(fLocal_106), -1082130432);
		}
		else
		{
			HUD::GET_HUD_COLOUR(9, &fLocal_104, &fLocal_105, &fLocal_106, &uLocal_107);
			func_109(Global_19662, "SET_SOFT_KEYS_COLOUR", 2f, SYSTEM::TO_FLOAT(fLocal_104), SYSTEM::TO_FLOAT(fLocal_105), SYSTEM::TO_FLOAT(fLocal_106), -1082130432);
			HUD::GET_HUD_COLOUR(126, &fLocal_104, &fLocal_105, &fLocal_106, &uLocal_107);
			func_109(Global_19662, "SET_SOFT_KEYS_COLOUR", 1f, SYSTEM::TO_FLOAT(fLocal_104), SYSTEM::TO_FLOAT(fLocal_105), SYSTEM::TO_FLOAT(fLocal_106), -1082130432);
			HUD::GET_HUD_COLOUR(6, &fLocal_104, &fLocal_105, &fLocal_106, &uLocal_107);
			func_109(Global_19662, "SET_SOFT_KEYS_COLOUR", 3f, SYSTEM::TO_FLOAT(fLocal_104), SYSTEM::TO_FLOAT(fLocal_105), SYSTEM::TO_FLOAT(fLocal_106), -1082130432);
		}
	...
	{
		iLocal_96 = ENTITY::GET_ENTITY_HEALTH(unk_0x9B0761B4C3EB8BC7());
	}
	...
	if (Global_76833)
	{
		...
		if (Global_4271301 == 0)
		{
			...
			if ((MISC::IS_XBOX360_VERSION(&Var1) && MISC::IS_ORBIS_VERSION(0)) && Global_4271304 == 0)
			{
	...
	VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7551, 9);
	Global_2462245 = 0;
	if (func_85(0) && NETWORK::NETWORK_SESSION_IS_IN_VOICE_SESSION())
	{
		Global_2462245 = 1;
	}
	...
	func_82();
	func_81(1);
	DATAFILE::UGC_UPDATE_CONTENT(-1, "Pull_Out", &Global_19670, 1);
	SYSTEM::SETTIMERB(0);
	...
	while (true)
	{
		...
		if (unk_0xCE990E643CD9D0E5(Global_4271024, 24))
		{
			if (!Global_19865)
			{
				...
				{
					VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_4271024, 24);
					func_83();
					func_109(Global_19662, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
					func_81(1);
					...
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						...
						else
						{
							...
							if (Global_19634[Global_19626 /*3*/].f_1 != Local_77.f_1)
							{
								...
								if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("appemail")) < 1)
								{
									func_68();
								}
							}
						...
						else if (!PED::IS_PED_IN_COVER(unk_0x9B0761B4C3EB8BC7(), false))
						{
							iLocal_80 = 0;
							func_70();
		...
		if (!HUD::DISABLE_FRONTEND_THIS_FRAME())
		{
			if (Global_19609.f_1 != Global_19627[Global_19626 /*3*/].f_1 || func_75())
			{
				if (Global_19681.f_1 > 3)
				{
					...
					if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("appsecurohack")) == 0)
					{
					...
					if (!func_61() && INTERIOR::GET_INTERIOR_AT_COORDS(joaat("appsecurohack")) == 0)
					{
		...
		if (iLocal_75 == 1)
		{
			if (!PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, Global_19650))
			{
				Global_7555 = 1;
				iLocal_75 = 0;
			}
		...
		if (iLocal_94)
		{
			if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, Global_19649))
			{
		...
		if (Global_19864 == 0)
		{
			...
			if (Global_19667 == 1)
			{
				...
				if (Global_19624)
				{
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TIME(Global_19662, Global_19601, Global_19602, Global_19603, Global_19604, 255, 255, 255, 255, 0);
				}
				else
				{
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TIME(Global_19662, Global_19601, Global_19602, Global_19603, Global_19604, 255, 255, 255, 255, 0);
		...
		else if (!unk_0xCE990E643CD9D0E5(Global_7551, 23))
		{
			if (Global_19681.f_1 == 5 || Global_19681.f_1 == 6)
			{
				if (Global_19864 == 0)
				{
					if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("appcamera")) < 1 && INTERIOR::GET_INTERIOR_AT_COORDS(joaat("appemail")) < 1)
					{
						if (Global_19624 == 0)
						{
								...
								if (Global_22064 == 1)
								{
									if (unk_0xCE990E643CD9D0E5(Global_4271024, 1))
									{
										if (unk_0xCE990E643CD9D0E5(Global_7551, 14))
										{
											...
											Global_22064 = 0;
											VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_4271024, true);
										}
									}
		...
		else if (SCRIPT::HAS_SCRIPT_LOADED(&(Global_7558[Global_19684 /*15*/].f_5)))
		{
			if (Global_19684 == 0)
			{
				if (INTERIOR::GET_INTERIOR_AT_COORDS(Global_7558[Global_19684 /*15*/].f_9) == 0)
				{
			...
			else
			{
				...
				else if (INTERIOR::GET_INTERIOR_AT_COORDS(Global_7558[Global_19684 /*15*/].f_9) == 0)
				{
		...
		else
		{
			...
			if (Global_76833)
			{
				...
				{
					if (HUD::DISABLE_FRONTEND_THIS_FRAME() && !func_7())
					{
			...
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
			{
				if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(unk_0x9B0761B4C3EB8BC7()))
				{
					...
					if (ENTITY::GET_ENTITY_SUBMERGED_LEVEL(unk_0x9B0761B4C3EB8BC7()) == 1f)
					{
						if (unk_0xCE990E643CD9D0E5(Global_4456448.f_37, 17) && (STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED() || Global_1655232))
						{
							func_5(1, 1);
				...
				if ((((((((((((((PED::IS_PED_IN_ANY_TRAIN(unk_0x9B0761B4C3EB8BC7()) || PLAYER::IS_PLAYER_RIDING_TRAIN(PLAYER::PLAYER_ID())) || PED::IS_PED_ON_MOUNT(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_STUNT_JUMP_IN_PROGRESS()) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_JACKING(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_IN_COVER(unk_0x9B0761B4C3EB8BC7(), false)) || unk_0xEEFD6B1BEB00F02E(unk_0x9B0761B4C3EB8BC7())) || INTERIOR::GET_INTERIOR_AT_COORDS(joaat("michael1")) > 0) || Global_77094 == 1) || func_3(unk_0x9B0761B4C3EB8BC7())) || ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_ENTERING(unk_0x9B0761B4C3EB8BC7()), false)) || MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x9B0761B4C3EB8BC7())) || GRAPHICS::GET_USINGNIGHTVISION()) || iLocal_117)
				{
					if (!Global_19624)
					{
						unk_0xBE20AB8238688965(&Global_7552, 4);
				...
				if (ENTITY::GET_ENTITY_HEADING())
				{
					if (Global_76833 == 0)
					{
						if (iLocal_101 == 0)
						{
							...
							{
								if (!PED::IS_PED_SITTING_IN_VEHICLE(unk_0x9B0761B4C3EB8BC7(), ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
								{
									iLocal_99 = MISC::GET_GAME_TIMER();
									iLocal_101 = 1;
								}
				...
				if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 25) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 68))
				{
					if (Global_76833)
					{
						MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(unk_0x9B0761B4C3EB8BC7(), &iLocal_109, 1);
						if (iLocal_109 != joaat("weapon_unarmed") && Global_19681.f_1 < 7)
						{
							unk_0xBE20AB8238688965(&Global_7552, 4);
						}
					}
				...
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					...
					if (MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("submersible") || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("submersible2"))
					{
						iLocal_113 = 1;
					}
					else
					...
					if (((((MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("rhino") || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("cutter")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("chernobog")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("khanjali")) || iLocal_113) || ENTITY::GET_ENTITY_COORDS(iLocal_110, false) == 0)
					{
						unk_0xBE20AB8238688965(&Global_7552, 4);
					}
					if (((((((((((((((MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("valkyrie") || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("insurgent")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("technical")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("trash")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("trash2")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("limo2")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("insurgent3")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("halftrack")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("dune3")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("trailersmall2")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("technical2")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("boxville5")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("mogul")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("bombushka")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("tula")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("chernobog"))
					{
						if (PED::IS_PED_SITTING_IN_VEHICLE(unk_0x9B0761B4C3EB8BC7(), iLocal_110))
						{
							iVar6 = func_2(unk_0x9B0761B4C3EB8BC7(), iLocal_110);
							if (iVar6 != -2)
							{
								if (MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("insurgent") || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("limo2"))
								{
									if (iVar6 == 3)
									{
										unk_0xBE20AB8238688965(&Global_7552, 4);
								...
								if (MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("trash") || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("trash2"))
								{
									if (iVar6 == 2 || iVar6 == 1)
									{
										unk_0xBE20AB8238688965(&Global_7552, 4);
								...
								if (MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("technical2"))
								{
									if (iVar6 == 1)
									{
										unk_0xBE20AB8238688965(&Global_7552, 4);
								...
								if (MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("boxville5"))
								{
									if (iVar6 == 3)
									{
										unk_0xBE20AB8238688965(&Global_7552, 4);
								...
								if (MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("insurgent3"))
								{
									if (iVar6 == 3)
									{
										unk_0xBE20AB8238688965(&Global_7552, 4);
								...
								if (MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("halftrack"))
								{
									if (iVar6 == 1)
									{
										unk_0xBE20AB8238688965(&Global_7552, 4);
								...
								if (MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("dune3"))
								{
									if (iVar6 == 0)
									{
										unk_0xBE20AB8238688965(&Global_7552, 4);
								...
								if (MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("trailersmall2"))
								{
									if (iVar6 == -1)
									{
										unk_0xBE20AB8238688965(&Global_7552, 4);
					...
					if (PAD::IS_DISABLED_CONTROL_PRESSED(0, 69))
					{
						if (Global_76833 == 0)
						{
							if (Global_19681.f_1 == 6 || Global_19681.f_1 == 7)
							{
								bVar7 = true;
								if (MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("stromberg") && NETWORK::NETWORK_IS_PLAYER_ACTIVE(iLocal_110))
								{
									bVar7 = false;
								}
								if (((VEHICLE::IS_THIS_MODEL_A_HELI(MISC::GET_MODEL_DIMENSIONS(iLocal_110)) || VEHICLE::IS_THIS_MODEL_A_PLANE(MISC::GET_MODEL_DIMENSIONS(iLocal_110))) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("submersible")) || MISC::GET_MODEL_DIMENSIONS(iLocal_110) == joaat("submersible2"))
								{
									bVar7 = false;
								}
								if (bVar7)
				...
				if (Global_76833 == 0)
				{
					if (ENTITY::GET_ENTITY_HEALTH(unk_0x9B0761B4C3EB8BC7()) < iLocal_96)
					{
						if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
						{
							Global_19666 = 1;
				...
				if (HUD::CLEAR_HELP())
				{
					if (!PED::IS_PED_IN_COVER(unk_0x9B0761B4C3EB8BC7(), true))
					{
						if (!func_73())
						{
							MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(unk_0x9B0761B4C3EB8BC7(), &iLocal_109, 1);
				...
				if (PED::IS_PED_BEING_JACKED(unk_0x9B0761B4C3EB8BC7()))
				{
					Global_19666 = 1;
					func_66();
					func_63(0);
...
void func_1()
{
	if (!PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, Global_19650) && !PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, Global_19649))
	{
		Global_19659 = 0;
	}
}
...
int func_2(int iParam0, int iParam1)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam1, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(iParam0, iParam1))
		{
			...
			if (MISC::IS_MINIGAME_IN_PROGRESS(iParam1, 3, 0) == iParam0)
			{
				return 3;
			}
			if (MISC::IS_MINIGAME_IN_PROGRESS(iParam1, 4, 0) == iParam0)
			{
				return 4;
			}
			if (MISC::IS_MINIGAME_IN_PROGRESS(iParam1, 5, 0) == iParam0)
			{
				return 5;
			}
			if (MISC::IS_MINIGAME_IN_PROGRESS(iParam1, 6, 0) == iParam0)
			{
				return 6;
			}
			if (MISC::IS_MINIGAME_IN_PROGRESS(iParam1, 7, 0) == iParam0)
			{
				return 3;
			}
			if (MISC::IS_MINIGAME_IN_PROGRESS(iParam1, 8, 0) == iParam0)
			{
				return 4;
			}
		}
...
void func_9()
{
	...
	{
		Local_115 = { Global_19627[Global_19626 /*3*/] };
	}
	else
	{
		Local_115 = { Global_19634[Global_19626 /*3*/] };
	}
	fVar2 = func_15(Local_115, Global_19627[Global_19626 /*3*/], Global_19641, Var1, fVar0, 0);
	...
	if (iLocal_84 && (MISC::GET_GAME_TIMER() - iLocal_18) > 500)
	{
		...
		VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7551, 30);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 5);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 19);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 21);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 24);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 25);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&Global_7552, 27);
		...
		SYSTEM::SETTIMERA(0);
		if (INTERIOR::GET_INTERIOR_AT_COORDS(Global_7558[2 /*15*/].f_9) == 0)
		{
		...
		if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (Global_2547059.f_1)
			{
				if (Global_76833)
				{
					DATAFILE::UGC_UPDATE_CONTENT(-1, "Hang_Up", "Phone_SoundSet_Michael", 1);
				}
				else
				{
...
float func_15(struct<3> Param0, struct<3> Param1, struct<3> Param2, struct<3> Param3, float fParam4, bool bParam5)
{
	...
	if (fVar1 < 1f)
	{
		...
		Global_19609 = { func_16(Param0, Param1, fVar2) };
		Global_19612 = { func_16(Param2, Param3, fVar2) };
	}
	else
	{
		Global_19609 = { Param1 };
...
void func_20()
{
	if (unk_0xCE990E643CD9D0E5(Global_7552, 10) || iLocal_116 == 1)
	{
...
void func_35()
{
	...
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(1);
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(0);
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(Global_7558[10 /*15*/].f_10);
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(0);
	func_36(&(Global_7558[10 /*15*/]));
...
void func_44()
{
	...
	if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_73))
	{
		...
		if (Global_19684 == 3)
		{
			...
			{
				if (((((((PED::IS_PED_ON_MOUNT(unk_0x9B0761B4C3EB8BC7()) || MISC::IS_STUNT_JUMP_IN_PROGRESS()) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_JACKING(unk_0x9B0761B4C3EB8BC7())) || unk_0xEEFD6B1BEB00F02E(unk_0x9B0761B4C3EB8BC7())) || MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x9B0761B4C3EB8BC7())) || ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_ENTERING(unk_0x9B0761B4C3EB8BC7()), false)) || GRAPHICS::GET_USINGNIGHTVISION())
				{
					iVar0 = 1;
				}
				if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(unk_0x9B0761B4C3EB8BC7()) == 0)
					{
						iVar0 = 1;
					}
		...
		if (Global_19684 == 23 && NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&(Global_7558[Global_19684 /*15*/]), "CELL_BENWEB"))
		{
			if (unk_0xCE990E643CD9D0E5(Global_7552, 6))
			{
				iVar0 = 1;
		...
		if (Global_76833)
		{
			...
			else
			{
				...
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (TASK::CLEAR_PED_TASKS(unk_0x9B0761B4C3EB8BC7(), 78, 1) || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()))
					{
						if (Global_19684 == 3)
						{
							iVar0 = 1;
		...
		else
		{
			...
			else if (Global_19684 != 20)
			{
				...
				{
					if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("paparazzo3b")) > 0)
					{
						if (Global_19684 == 3)
						{
							if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
...
void func_49()
{
	...
	else if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("appemail")) < 1)
	{
	...
	else
	{
		if (iLocal_81 == 0)
		{
			Local_82 = { Global_19634[Global_19626 /*3*/] };
			Local_82.x = (Local_82.x - 10f);
			Local_82.f_1 = (Local_82.f_1 + 20f);
			iLocal_81 = 1;
		}
		fVar1 = func_15(Global_19627[Global_19626 /*3*/], Local_82, -90f, 0f, 90f, -90f, 0f, 90f, 450f, 1);
		if (fVar1 >= 1f)
		{
			unk_0xBE20AB8238688965(&Global_7552, 8);
			unk_0xBE20AB8238688965(&Global_7551, 14);
				...
				if (SYSTEM::TIMERB() > 1500)
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						if (!AUDIO::IS_PED_RINGTONE_PLAYING(unk_0x9B0761B4C3EB8BC7()))
						{
							if (Global_19624)
							{
								AUDIO::PLAY_PED_RINGTONE("Dial_and_Remote_Ring", unk_0x9B0761B4C3EB8BC7(), true);
							}
							else if (!unk_0xCE990E643CD9D0E5(Global_7553, 5))
							{
								AUDIO::PLAY_PED_RINGTONE("Remote_Ring", unk_0x9B0761B4C3EB8BC7(), true);
							}
						}
					}
				}
									...
									case 6:
										if (Global_19864 == 0)
										{
											...
											else
											{
												if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
												{
													DATAFILE::UGC_UPDATE_CONTENT(-1, "Put_Away", &Global_19670, 1);
												}
												iLocal_18 = 0;
												Global_19681.f_1 = 3;
											}
...
void func_67()
{
	...
	{
		if (func_75() && PED::IS_PED_IN_COVER(unk_0x9B0761B4C3EB8BC7(), false))
		{
			iVar1 = 1;
		}
	}
...
void func_79(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char[4] cParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
					...
					if (fVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[fVar0] == 0)
						{
							...
							if (Global_2462245)
							{
								if (iVar1 == 14)
								{
									func_79(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22068), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8120[fVar0] = 1;
						}
					...
					if (fVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[fVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_79(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22073), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76833)
								{
									...
									func_79(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(fVar4), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19681)
									...
									func_79(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(fVar6), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7558[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_79(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(fVar9), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_79(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(fVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8120[fVar0] = 1;
						}
					}
...
int func_85(int iParam0)
{
	...
	if (func_86(&iVar0) && VEHICLE::IS_THIS_MODEL_A_CAR(903) == 1)
	{
		return 1;
	}
	if (!func_86(&iVar0))
...
int func_88()
{
	if (unk_0xDCA0815D900F27F8())
	{
		...
		{
			if (NETWORK::NETWORK_IS_CABLE_CONNECTED() == 4)
			{
				return 0;
			}
			if (NETWORK::NETWORK_IS_CABLE_CONNECTED() == 2)
			{
				return 0;
			}
			if (NETWORK::NETWORK_IS_CABLE_CONNECTED() == 1)
			{
				return 0;
			}
			if (NETWORK::NETWORK_IS_CABLE_CONNECTED() == 5)
			{
				return 0;
			}
		}
...
void func_89()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		iLocal_111 = ZONE::GET_ZONE_SCUMMINESS(ZONE::GET_ZONE_AT_COORDS(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)));
	}
	switch (iLocal_111)
	{
		case 0:
	...
	bLocal_112 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 8);
	if (bLocal_112 < 2)
	{
		if (iLocal_87 > 2)
		{
	...
	func_109(Global_19662, "SET_PROVIDER_ICON", SYSTEM::TO_FLOAT(iLocal_86), SYSTEM::TO_FLOAT(iLocal_87), -1082130432, -1082130432, -1082130432);
}
...
int func_93(struct<3> Param0, int iParam1)
{
	if (iParam1 != -1)
	{
		...
		{
			return func_93(Param0, Global_41632[iParam1 /*5*/].f_4);
		}
	}
	return 0;
}
...
void func_97()
{
	...
	{
		if (func_99(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_107()
{
	...
	if (iLocal_89 != Global_7554)
	{
		Global_7554 = iLocal_89;
		iLocal_88 = CLOCK::GET_CLOCK_DAY_OF_MONTH();
		...
		func_79(Global_19662, "SET_TITLEBAR_TIME", SYSTEM::TO_FLOAT(iLocal_88), SYSTEM::TO_FLOAT(iLocal_89), -1f, -1f, -1f, &cLocal_91, 0, 0, 0, 0);
		if (Global_19624 == 0)
		{
			func_89();
		}
...
void func_116()
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (!AUDIO::IS_PED_RINGTONE_PLAYING(unk_0x9B0761B4C3EB8BC7()))
		{
			if (Global_76833)
			{
				if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&(Global_8356[3 /*2811*/][1 /*281*/].f_144[func_104(1198, -1, 0) /*6*/]), "Silent Ringtone Dummy"))
				{
					AUDIO::PLAY_PED_RINGTONE(&(Global_8356[3 /*2811*/][1 /*281*/].f_144[func_104(1198, -1, 0) /*6*/]), unk_0x9B0761B4C3EB8BC7(), true);
				}
			}
			else if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&(Global_111858.f_14047[Global_19681 /*20*/].f_11), "Silent Ringtone Dummy"))
			{
				if (!Global_8356[Global_19681 /*2811*/][0 /*281*/].f_259 == 1)
				{
					if (ENTITY::GET_ENTITY_HEADING())
					{
						...
						{
							AUDIO::PLAY_PED_RINGTONE(&(Global_111858.f_14047[Global_19681 /*20*/].f_11), unk_0x9B0761B4C3EB8BC7(), true);
						}
					}
					else
					{
