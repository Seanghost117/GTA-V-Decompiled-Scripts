...
void func_2(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_3(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, false, 2, AUDIO::ADD_LINE_TO_CONVERSATION(func_4(iParam1)), 0));
		}
		else
		{
			func_3(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, AUDIO::ADD_LINE_TO_CONVERSATION(func_4(iParam1)), 0));
		}
		switch (Global_19681)
		{
			case 0:
...
var func_61()
{
	...
	func_65(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_64(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_63(&uVar0, CLOCK::GET_CLOCK_YEAR());
	func_62(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
