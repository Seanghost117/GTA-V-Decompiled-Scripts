...
void func_1()
{
	switch (iLocal_82)
	{
		case 0:
			...
			func_21();
			if (!CAM::IS_SCREEN_FADED_OUT(bLocal_189))
			{
				if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bLocal_189, "PRE_FKICKOFF"))
				{
...
void func_78(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
int func_96(int iParam0, struct<3> Param1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			HUD::HAS_ADDITIONAL_TEXT_LOADED(sLocal_190, 0);
			HUD::HAS_ADDITIONAL_TEXT_LOADED(sLocal_202, 6);
...
bool func_105(bool bParam0, struct<3> Param1, float fParam2)
{
		...
		case 0:
			if (func_95(iLocal_81, 0))
			{
				if (func_281())
				{
					...
					func_116(&bVar3, Var1, fVar2, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
					func_113(0, -1, 1);
...
void func_116(bool bParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_196(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		{
			func_184(iParam10, 0);
			while (!func_117(bParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_117(bool bParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_178(bParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_178(bParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (MISC::GET_MODEL_DIMENSIONS(*bParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Var2))
			{
				...
				*bParam0 = VEHICLE::CREATE_VEHICLE(Var2, Param2, fParam3, true, true, false);
				...
				func_178(bParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_118(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	if ((func_14(iParam0) && MISC::IS_BIT_SET(*bParam1)) && ENTITY::GET_ENTITY_COORDS(*bParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*bParam1) >= 0 && func_123(*bParam1, 0, &uVar0))
		{
			func_122(bParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_121(*bParam1);
...
int func_122(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_123(bool bParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_151(fVar0, bParam1, uParam2) && !func_150(PLAYER::PLAYER_ID())) && !func_133(bParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_131(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_129(bParam0)) && !bVar1) && !(func_128(MISC::GET_MODEL_DIMENSIONS(bParam0)) && func_125(PLAYER::PLAYER_ID())))
	{
	...
	if (!MISC::SET_BIT())
	{
		if ((func_124(bParam0) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("sentinel2")) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_135(bool bParam0)
{
	...
	if (func_136(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		return 1;
	}
	return 0;
...
int func_137(bool bParam0, bool bParam1)
{
	switch (MISC::GET_MODEL_DIMENSIONS(bParam0))
	{
		...
		case joaat("insurgent"):
			if (func_139(MISC::GET_MODEL_DIMENSIONS(bParam0), 0))
			{
				if (Global_2540384.f_303 == bParam0)
				{
					return 1;
				}
				else if (func_138(bParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_139(void fParam0, int iParam1)
{
	if (iParam1 == 0)
	{
		if (func_147(fParam0, 0))
		{
			return 1;
		}
	}
...
int func_147(void fParam0, int iParam1)
{
	switch (fParam0)
	{
		case joaat("faction2"):
...
int func_151(void fParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_131(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fParam0)))
	{
		bVar0 = true;
	}
...
void func_153(bool bParam0, int iParam1)
{
	...
	func_154(bParam0, &(Global_111858.f_32745.f_5510));
}
...
void func_154(bool bParam0, var uParam1)
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_122(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_173(bParam0, 0, 0)) || func_173(bParam0, 1, 0)) || func_173(bParam0, 2, 0)) || func_172(bParam0) != 145) || func_171(bParam0)) || func_170(bParam0)) || func_124(bParam0)) || func_169(bParam0)) || !func_159(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_170(bParam0))
		{
		}
...
int func_159(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_160(fParam0, 0))
	{
		return 0;
	}
...
int func_160(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
int func_178(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_147(MISC::GET_MODEL_DIMENSIONS(*iParam0), 1) && unk_0x7F8B14CBFB9813E5(*iParam0, 24) != func_181(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_184(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || MISC::GET_MODEL_DIMENSIONS(Global_96286[iVar0]) == func_185(iParam0, iParam1))
				{
...
bool func_196(struct<3> Param0, float fParam1)
{
	return func_197(&(Global_105407.f_2890), Param0, fParam1, 0);
}

bool func_197(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	bool bVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_213(uParam0))
	{
		...
		if (func_212(uParam0))
		{
			...
			if (MISC::IS_BIT_SET(bVar0))
			{
				...
				func_201(bVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_175(bVar0, uParam0->f_11);
				}
				else if ((!func_199(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS(TASK::IS_PED_BEING_ARRESTED(), "startup_positioning"))
				{
					iVar4 = func_198(bVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_199(bool bParam0, struct<3> Param1, bool bParam2)
{
	void fVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_200(bParam0, Global_75654.f_139[38], 0))
			{
				func_187(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_200(bParam0, Global_75654.f_139[43], 1))
			{
				func_187(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_200(bParam0, uVar1[iVar3], 1) && func_97(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_195(Param1, 0f, 0f, 0f, 0)) || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_201(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::GET_ENTITY_COORDS(iParam0, false))
	{
		...
		if (((unk_0xCE990E643CD9D0E5(uParam1->f_77, 15) || func_204(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_203())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_231(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			bLocal_189 = "PRE_FKICKOFF";
			break;
		
		case 2:
			bLocal_189 = "PRE_FLEFT";
			break;
...
void func_243(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_245() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_245() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_244(bParam0));
		HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar1, &cVar1, true, 0, "", 0);
	}
}

char* func_244(bool bParam0)
{
	switch (bParam0)
	{
		case 0:
...
void func_246(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
...
var func_247(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
bool func_249(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_245() /*10931*/].f_6175.f_10, bParam0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			bVar0 = func_89(func_290(iParam1, uParam0->f_2), Global_76644, 0);
...
void func_295(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_296(iParam0));
			if (iVar11 > iVar10)
			{
