...
int func_39(var uParam0, struct<3> Param1, var uParam2, bool bParam3, int iParam4)
{
	...
	if (func_27(uParam0))
	{
		...
		unk_0xE922BAA80E8F9324(uParam0, uParam2);
		if (bParam3)
		{
			return bVar0;
		}
	...
	switch (iLocal_82)
	{
		case 0:
			if (func_95(iLocal_81, bLocal_28))
			{
				...
				if (unk_0x8F678487EEBD8CE4(uLocal_197))
				{
					unk_0xECC9A00CF1181EC2(uLocal_197, 2);
					unk_0x06B9B7C215BA4E0A(uLocal_197, 2);
				}
...
void func_108(var uParam0, struct<3> Param1, int iParam2, bool bParam3, char* sParam4)
{
	if (!unk_0x8F678487EEBD8CE4(*uParam0))
	{
		*uParam0 = func_109(Param1, 5, iParam2);
		if (bParam3)
		{
			unk_0xB023F5C66F5716C7(*uParam0, sParam4);
		}
	}
}
...
int func_199(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_200(iParam0, uVar1[iVar3], 1) && func_97(unk_0x3E4D3CCC220BDFB1(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_195(Param1, 0f, 0f, 0f, 0)) || unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(iParam0, 1), unk_0x3E4D3CCC220BDFB1(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_295(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x21A524CB091C80DE(uVar1, 7, -1, 0, -1, func_296(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_362(bool bParam0)
{
	...
	if (unk_0x40397A9A17EEC1C5(uLocal_198))
	{
		unk_0x3ED9330214992278(0, 0, 3000, 1, 0, 0);
		unk_0xB8B0F7C8C1548C5B(uLocal_198, 0);
	}
}
