...
void func_1(int iParam0)
{
	...
	func_3();
	unk_0x301D40601D63F19F(PLAYER::PLAYER_ID(), 0);
	func_2();
}
...
void func_3()
{
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_859), 3);
}
...
void func_16()
{
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_859), true);
}
...
void func_17(int iParam0)
{
	...
	if (func_48(iParam0))
	{
		unk_0x301D40601D63F19F(PLAYER::PLAYER_ID(), 1);
		func_47();
		func_46(iParam0);
	}
	...
	func_3();
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_859), 4);
}
...
void func_18(int iParam0)
{
	...
	if (((((((!func_9(&(iParam0->f_6), 0) && !func_9(&(iParam0->f_6), 2)) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && func_35(iParam0)) && !func_34(0)) && !func_33()) && func_31()) && MISC::IS_BIT_SET(MISC::IS_MINIGAME_IN_PROGRESS(iParam0->f_1, -1, 0)))
	{
		func_25(iParam0, 1);
		func_24(&(iParam0->f_6), 3);
		uVar0 = func_23(iParam0->f_6.f_2, 3333, 10000);
		iParam0->f_6.f_2 = 0;
		if (func_54(iParam0))
		{
			func_21(func_22(iParam0), func_15(iParam0->f_2), func_15(iParam0->f_2), uVar0);
		}
		else
		{
			func_20(func_22(iParam0), func_15(iParam0->f_2), uVar0);
		}
		func_19(iParam0);
...
void func_20(var uParam0, int iParam1, var uParam2)
{
	...
	HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(iParam1);
	FILES::GET_DLC_VEHICLE_FLAGS(0, 0, 1, uParam2);
}

void func_21(var uParam0, int iParam1, int iParam2, var uParam3)
{
	unk_0x17751E107423AFE9(uParam0);
	HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(iParam1);
	HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(iParam2);
	FILES::GET_DLC_VEHICLE_FLAGS(0, 0, 1, uParam3);
}
...
int func_28(int iParam0, int iParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
bool func_31()
{
	return (!unk_0xCE990E643CD9D0E5(Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_859, 4) && !func_32());
}
...
int func_38(int iParam0)
{
	...
	{
		case 1:
			if ((PAD::IS_CONTROL_JUST_PRESSED(0, 114) || PAD::IS_CONTROL_JUST_PRESSED(0, 99)) || PAD::IS_CONTROL_JUST_PRESSED(0, 100))
			{
				return 1;
			}
			break;
		...
		case 2:
			if (PAD::IS_CONTROL_JUST_PRESSED(0, 92))
			{
				return 1;
			}
			break;
		...
		case 3:
			if (PAD::IS_CONTROL_JUST_PRESSED(0, 68))
			{
				return 1;
			}
			break;
...
{
	return (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0));
}

void func_41()
{
	MONEY::NETWORK_MONEY_CAN_BET(0, 24, true);
	MONEY::NETWORK_MONEY_CAN_BET(0, 66, true);
	MONEY::NETWORK_MONEY_CAN_BET(0, 67, true);
...
void func_42(int iParam0)
{
	...
	if (((((((!func_9(&(iParam0->f_6), 0) && !func_9(&(iParam0->f_6), 1)) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && func_9(&(iParam0->f_6), 3)) && !func_34(0)) && !func_33()) && func_31()) && MISC::IS_BIT_SET(MISC::IS_MINIGAME_IN_PROGRESS(iParam0->f_1, -1, 0)))
	{
		uVar0 = func_23(iParam0->f_6.f_2, 3333, 10000);
		iParam0->f_6.f_2 = 0;
		if (func_54(iParam0))
		{
			func_37(func_43(iParam0), uVar0);
		}
		else
		{
			func_21(func_43(iParam0), func_15(iParam0->f_2), func_15(iParam0->f_2), uVar0);
		}
		func_49(iParam0);
		func_24(&(iParam0->f_6), 0);
	}
...
void func_44(int iParam0, int iParam1)
{
	...
	if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > iParam1)
	{
		PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_ID(), iParam1, false);
	}
}
...
void func_47()
{
	unk_0xBE20AB8238688965(&(Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_859), 1);
}
...
bool func_51()
{
	return unk_0xCE990E643CD9D0E5(Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_859, 3);
}
...
{
	return ((func_40(iParam0) && iParam0->f_3 == unk_0x9B0761B4C3EB8BC7()) || MISC::IS_MINIGAME_IN_PROGRESS(iParam0->f_1, -1, 0) == unk_0x9B0761B4C3EB8BC7());
}
...
void func_56(int iParam0)
{
	...
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_859), 2);
}
...
bool func_58()
{
	return unk_0xCE990E643CD9D0E5(Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_859, 2);
}
...
{
	return (MISC::IS_BIT_SET(iParam0->f_1) && ENTITY::GET_ENTITY_COORDS(iParam0->f_1, false));
}
...
void func_69(int iParam0)
{
	...
	if (func_40(iParam0))
	{
		...
		{
			iParam0->f_1 = STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7());
			if (func_68(iParam0))
			{
				iParam0->f_2 = MISC::GET_MODEL_DIMENSIONS(iParam0->f_1);
				if (TASK::GET_IS_TASK_ACTIVE(unk_0x9B0761B4C3EB8BC7(), 2))
				{
					func_24(iParam0, 2);
				}
			}
	...
	if (func_68(iParam0))
	{
		if (!SYSTEM::VDIST2(iParam0->f_1, -1, 0))
		{
			bVar2 = MISC::IS_MINIGAME_IN_PROGRESS(iParam0->f_1, -1, 0);
			if ((MISC::IS_BIT_SET(bVar2) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar2, 0)) && PLAYER::SET_PLAYER_WANTED_LEVEL(bVar2))
			{
				iParam0->f_3 = bVar2;
...
{
	if (MISC::IS_BIT_SET(iParam0->f_3) && func_71(VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(iParam0->f_3)))
	{
		func_24(iParam0, 0);
	}
	else
...
bool func_77()
{
	return unk_0xCE990E643CD9D0E5(Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_859, 1);
}
...
int func_82()
{
	...
	if (func_83() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_83()) == 0)
		{
			return 1;
		}
	}
