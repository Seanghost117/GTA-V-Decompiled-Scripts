...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_2(&(Var0.f_281));
		if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("tennis")) > 0)
		{
			func_304(2, 140);
			func_310(&Var0);
		}
	...
	switch (func_309(uParam1))
	{
		...
		case 4:
			if (func_269(uParam0))
			{
				if (uParam0->f_1657 == 1)
				{
					...
					func_267(uParam0[iParam3 /*94*/], PED::CREATE_PED(1, uParam0->f_1669, Var13, unk_0x9075769DD4F148B7(uParam0->f_1658, uParam0->f_1658.f_1), false, false));
					TASK::TASK_STAND_STILL((uParam0[iParam3 /*94*/])->f_32, -1);
					ENTITY::SET_ENTITY_HEADING(func_266(uParam0[iParam3 /*94*/]), (unk_0x9075769DD4F148B7(uParam0->f_1658, uParam0->f_1658.f_1) + 180f));
					Var1 = { func_271(&(uParam0->f_189), func_273(uParam1), uParam0->f_1661, uParam0->f_1658, iParam4 == func_272(uParam1), iParam4) };
					func_267(uParam0[iParam4 /*94*/], PED::CREATE_PED(1, uParam0->f_1668, Var1, unk_0x9075769DD4F148B7(-uParam0->f_1658, -uParam0->f_1658.f_1), false, false));
					TASK::TASK_STAND_STILL((uParam0[iParam4 /*94*/])->f_32, -1);
					ENTITY::SET_ENTITY_HEADING(func_266(uParam0[iParam4 /*94*/]), unk_0x9075769DD4F148B7(-uParam0->f_1658, -uParam0->f_1658.f_1));
					Var1 = { 0f, 0f, 0f };
					func_270(uParam1, 8);
					func_265(uParam1, 0);
		...
		case 9:
			...
			else
			{
				...
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(func_266(uParam0[func_272(uParam1) /*94*/]), sVar18, "serve", 3))
				{
					if (uParam0->f_1657 == 1 && MISC::IS_BIT_SET(uParam0->f_247))
					{
						fVar19 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(func_266(uParam0[func_272(uParam1) /*94*/]), sVar18, "serve");
		...
		case 20:
			...
			else if (((MISC::GET_GAME_TIMER() > func_22(uParam0) && func_230(uParam0, 4)) && MISC::IS_BIT_SET(uParam0->f_247)) && !ENTITY::IS_ENTITY_ATTACHED(uParam0->f_247))
			{
				func_268(uParam0, 1);
				func_195(uParam0[func_272(uParam1) /*94*/], &(uParam0->f_247));
...
void func_21(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	{
		if (MISC::IS_BIT_SET(func_266(uParam1)))
		{
...
int func_26(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	...
	else if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iVar1) && (bParam5 || iParam4 == 1)) && !func_105(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam3)
		{
	...
	else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iVar2) && ((bParam5 || iParam4 == 4) || iParam4 == 1)) && !func_105(uParam0[iParam2 /*94*/], 8192)) && TASK::GET_SCRIPT_TASK_STATUS(iVar2, 242628503) == 7)
	{
		if (iParam2 == iParam3)
		{
...
{
	if (!((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0)) && TASK::IS_TASK_MOVE_NETWORK_ACTIVE(func_266(uParam0))) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS(TASK::GET_TASK_MOVE_NETWORK_STATE(func_266(uParam0)), "running")))
	{
...
void func_58(var uParam0, var uParam1, struct<3> Param2)
{
	...
	{
		bVar0 = func_51(MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.5f, 0, 3);
...
int func_77(struct<3> Param0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	...
	if (iParam3 != iParam4 && ((func_105(uParam0, 512) && uParam0->f_31 != 4) || uParam0->f_31 == 4))
	{
		if (func_154(uParam0, Var11, bVar6))
		{
			...
			else if (iVar4 == 75 && func_146(uParam0, uParam1[iParam3 /*94*/], &(uParam1->f_247), uParam1->f_189.f_29, &fVar5))
			{
				...
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(func_266(uParam0));
...
void func_109(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam2 || bParam3)
	{
		...
		{
			ENTITY::GET_ENTITY_ALPHA(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_SMASH_MASTER", "TENNIS_NPC_SMASH_MASTER"), func_266(uParam0), 0, 0, 0);
		}
		else if (func_92(uParam1) == 2)
		{
			ENTITY::GET_ENTITY_ALPHA(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_SMASH_BACKSLICE_MASTER", "TENNIS_NPC_SMASH_BACKSLICE_MASTER"), func_266(uParam0), 0, 0, 0);
		}
	...
	{
		ENTITY::GET_ENTITY_ALPHA(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_LOB_MASTER", "TENNIS_NPC_LOB_MASTER"), func_266(uParam0), 0, 0, 0);
		iVar0 = 60;
	}
	else
	{
		if (func_92(uParam1) == 0)
		{
			ENTITY::GET_ENTITY_ALPHA(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_FOREARM_MASTER", "TENNIS_NPC_FOREARM_MASTER"), func_266(uParam0), 0, 0, 0);
		}
		else if (func_92(uParam1) == 2)
		{
			ENTITY::GET_ENTITY_ALPHA(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_BACKSLICE_MASTER", "TENNIS_NPC_BACKSLICE_MASTER"), func_266(uParam0), 0, 0, 0);
		}
		else if (func_92(uParam1) == 1)
		{
			ENTITY::GET_ENTITY_ALPHA(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_TOPSPIN_MASTER", "TENNIS_NPC_TOPSPIN_MASTER"), func_266(uParam0), 0, 0, 0);
		}
		iVar0 = 80;
	}
	if (uParam0->f_31 != 4)
...
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0)))
	{
...
void func_116(var uParam0, bool bParam1)
{
	...
	{
		Var0 = { func_117(bParam1, func_284(uParam0), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(*uParam0, 1)) };
	}
	uParam0->f_27 = { Var0 };
	uParam0->f_30 = { Var0 };
	uParam0->f_25 = 0f;
...
int func_134(var uParam0, var uParam1, struct<3> Param2, bool bParam3)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0)) && MISC::_0xE95B0C7D5BA3B96B(func_266(uParam0)))
	{
		return 0;
	}
...
void func_162(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	*bParam3 = 0;
	...
	{
		case 2:
			if (MISC::IS_BIT_SET(uParam1->f_247) && func_287(&(uParam1->f_247)) > 0)
			{
				fVar0 = MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f);
...
void func_179(var uParam0, var uParam1, bool bParam2)
{
	if (MISC::IS_BIT_SET(*uParam1))
	{
		...
		else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0)))
		{
...
int func_183(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!bParam3)
	{
		if (((func_254(uParam0) > func_192(uParam1) && func_76(uParam2) == 75) && uParam0->f_1657 != 1) || (((func_254(uParam0) > func_192(uParam1) && func_76(uParam2) == 75) && uParam0->f_1657 == 1) && GRAPHICS::DRAW_SCALEFORM_MOVIE()))
		{
			func_235(uParam2, 74);
			func_216(uParam0, 0);
		}
	...
	if (func_105(uParam2, 4))
	{
		...
		else if (uParam2->f_4.f_20 == 0)
		{
			...
			bVar0 = func_51(MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.2f, 6, bVar7);
		}
		else if (uParam2->f_4.f_20 == 1)
		{
			bVar7 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1, 4);
			bVar0 = func_51(MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.1f, 6, bVar7);
		}
		...
		*uParam2 = fVar4;
		...
		if (bVar0 == 1 || bVar0 == 0)
		{
			ENTITY::GET_ENTITY_ALPHA(-1, func_196(uParam0->f_1657 == 1, "TENNIS_AMB_SMASH_MASTER", "TENNIS_NPC_SMASH_MASTER"), func_266(uParam2), 0, 0, 0);
		}
		else
		{
			ENTITY::GET_ENTITY_ALPHA(-1, func_196(uParam0->f_1657 == 1, "TENNIS_AMB_SERVE_MASTER", "TENNIS_NPC_SERVE_MASTER"), func_266(uParam2), 0, 0, 0);
		}
...
void func_184(var uParam0, var uParam1, var uParam2)
{
	...
	if (MISC::IS_BIT_SET(uParam0->f_247))
	{
		...
		func_277(&(uParam0->f_247), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_247, 1));
		uParam0->f_247.f_16 = { func_284(&(uParam0->f_247)) };
		func_119(&(uParam0->f_247), MISC::GET_FRAME_COUNT() + 5);
		func_118(&(uParam0->f_247));
		func_116(&(uParam0->f_247), 1);
...
int func_200(var uParam0, var uParam1, int iParam2, var uParam3, bool bParam4)
{
	...
	{
		func_159(uParam0);
		if ((PAD::IS_DISABLED_CONTROL_PRESSED(0, 223) && !bParam4) || (func_161(uParam0) > 30f && uParam1->f_1657 == 4))
		{
			...
			if (func_105(uParam0, 64))
			{
				if (func_206(uParam0) > 0.965f)
				{
					*uParam3 = { uParam1->f_282[0 /*2*/] };
					ENTITY::GET_ENTITY_ALPHA(-1, "TENNIS_PLYR_SMASH_MASTER", func_266(uParam0), 0, 0, 0);
				...
				else if (func_206(uParam0) > 0.7f)
				{
					*uParam3 = { uParam1->f_282[2 /*2*/] };
					...
					ENTITY::GET_ENTITY_ALPHA(-1, "TENNIS_PLYR_SERVE_MASTER", func_266(uParam0), 0, 0, 0);
				}
		...
		if (func_161(uParam0) > 30f || (PAD::IS_DISABLED_CONTROL_PRESSED(0, 223) && !bParam4))
		{
			func_160(uParam0);
		}
	}
...
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0[iParam1 /*94*/])) && TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0[iParam1 /*94*/]), 242628503) != 7)
	{
		return 0;
	}
	else if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0[iParam1 /*94*/])) && ((bParam4 || iParam3 == 4) || iParam3 == 1)) && !func_105(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam2)
		{
			func_28(uParam0[iParam1 /*94*/], "TennisServeSet", 0f);
		...
		ENTITY::FREEZE_ENTITY_POSITION(func_266(uParam0[iParam1 /*94*/]), false, 0);
		func_59(uParam0[iParam1 /*94*/], 8192);
	}
	else if (func_105(uParam0[iParam1 /*94*/], 8192) && iParam1 == iParam2)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0[iParam1 /*94*/])) && TASK::IS_TASK_MOVE_NETWORK_ACTIVE(func_266(uParam0[iParam1 /*94*/])))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(TASK::GET_TASK_MOVE_NETWORK_STATE(func_266(uParam0[iParam1 /*94*/])), "Intro") && TASK::IS_TASK_MOVE_NETWORK_READY_FOR_TRANSITION(func_266(uParam0[iParam1 /*94*/])))
			{
...
void func_219(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if ((uParam0->f_31 != 4 && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0))) && !bParam5)
	{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			...
			if (!bParam6 && bParam7)
			{
				...
				TASK::TASK_PLAY_ANIM(0, func_196(func_197(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, bVar6, 0, 0f, false, false, false);
			}
			if (!bParam8)
			{
			...
			if (func_220(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_32, 1), Var1, 0.1f))
			{
			...
			AUDIO::STOP_SCRIPTED_CONVERSATION(func_266(uParam0), uParam0->f_54);
			PED::SET_PED_WEAPON_MOVEMENT_CLIPSET(func_266(uParam0), "weapons@tennis@male");
			func_81(&(uParam0->f_4), 4);
		}
	}
	if (bParam4 && MISC::IS_BIT_SET(func_266(uParam0)))
	{
		ENTITY::FREEZE_ENTITY_POSITION(func_266(uParam0), false, 0);
	}
}
...
void func_228(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if ((uParam0->f_31 != 4 && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0))) && !bParam7)
	{
		func_233(uParam1->f_1657, 1);
	}
	func_235(uParam0, 75);
...
void func_237(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (((uParam0->f_31 != 3 && !bParam4) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0))) && !MISC::IS_PC_VERSION(func_266(uParam0)))
	{
	...
	else if (uParam0->f_31 != 3)
	{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0)) && TASK::IS_TASK_MOVE_NETWORK_ACTIVE(func_266(uParam0)))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(TASK::GET_TASK_MOVE_NETWORK_STATE(func_266(uParam0)), "Intro") && TASK::IS_TASK_MOVE_NETWORK_READY_FOR_TRANSITION(func_266(uParam0)))
			{
	...
	if (((func_76(uParam0) == 75 && MISC::IS_BIT_SET(uParam1->f_247)) && ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(uParam1->f_247)) && SYSTEM::VDIST2(uParam0->f_37, func_284(&(uParam1->f_247))) < (0.88f * 0.88f))
	{
		func_59(uParam0, 256);
	...
	if ((MISC::GET_RAIN_LEVEL() <= 0f && MISC::GET_SNOW_LEVEL() <= 0f) && func_76(uParam0) == 75)
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(SYSTEM::TO_FLOAT(iParam1)) >= ENTITY::IS_ENTITY_PLAYING_ANIM(SYSTEM::TO_FLOAT(iParam2)))
		{
			if (iParam1 > 15)
			{
				...
				{
					ENTITY::GET_ENTITY_ALPHA(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_266(uParam0), 0, 0, 0);
				}
	...
	switch (func_148(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_76(uParam0) == 75)
			{
				...
				{
					HUD::_THEFEED_DISABLE(func_266(uParam0), Var1, 2f, -1, 1193033728, 1056964608);
				...
				else if ((unk_0xC2169C00B643278B(uParam0->f_32, func_71(&(uParam0->f_4)), Var2, 0, 1, 0) || TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), 2106541073) == 7) && !func_229(&(uParam0->f_4), 256))
				{
					func_236(&(uParam0->f_4), 0);
					func_218(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_76(uParam0) == 75)
			{
				...
				if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0)) && !SYSTEM::VDIST2(uParam0->f_37, Var1) <= (0f * 0f)) && !func_229(&(uParam0->f_4), 4)) && !func_105(uParam0, 1024))
				{
					HUD::_THEFEED_DISABLE(uParam0->f_32, func_71(&(uParam0->f_4)), 2f, -1, 1193033728, 1056964608);
					Var1 = { func_71(&(uParam0->f_4)) };
					func_243(&(uParam0->f_4), Var1);
					func_81(&(uParam0->f_4), 4);
...
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0[iParam1 /*94*/])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0[iParam2 /*94*/])))
	{
		if (!bParam3)
		{
			if (!bParam4)
			{
				OBJECT::CREATE_OBJECT_NO_OFFSET((uParam0[iParam1 /*94*/])->f_33, func_266(uParam0[iParam1 /*94*/]), ENTITY::ATTACH_ENTITY_TO_ENTITY(func_266(uParam0[iParam1 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			}
			OBJECT::CREATE_OBJECT_NO_OFFSET((uParam0[iParam2 /*94*/])->f_33, func_266(uParam0[iParam2 /*94*/]), ENTITY::ATTACH_ENTITY_TO_ENTITY(func_266(uParam0[iParam2 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
		else
		{
			if (!bParam4)
			{
				OBJECT::CREATE_OBJECT_NO_OFFSET((uParam0[iParam1 /*94*/])->f_33, func_266(uParam0[iParam1 /*94*/]), ENTITY::ATTACH_ENTITY_TO_ENTITY(func_266(uParam0[iParam1 /*94*/]), 28422), Local_242, Local_243, 0, 0, 0, 0, 2, 1);
			}
			OBJECT::CREATE_OBJECT_NO_OFFSET((uParam0[iParam2 /*94*/])->f_33, func_266(uParam0[iParam2 /*94*/]), ENTITY::ATTACH_ENTITY_TO_ENTITY(func_266(uParam0[iParam2 /*94*/]), 28422), Local_242, Local_243, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_274(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	iVar1 = (1 - iVar0);
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0[iVar0 /*94*/])) && TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0[iVar0 /*94*/]), 242628503) == 1)
	{
		*uParam2 = TASK::GET_SEQUENCE_PROGRESS(func_266(uParam0[iVar0 /*94*/]));
	}
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0[iVar1 /*94*/])) && TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0[iVar1 /*94*/]), 242628503) == 1)
	{
...
void func_291(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!func_230(uParam0, 1))
	{
		bVar0 = !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0[iParam3 /*94*/]));
		if (((bVar0 && !bParam5) && !func_229(&((uParam0[iParam3 /*94*/])->f_4), 256)) || ((bVar0 && func_105(uParam0[iParam3 /*94*/], 8192)) && uParam0->f_1657 == 1))
		{
			(uParam0[iParam3 /*94*/])->f_37 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(func_266(uParam0[iParam3 /*94*/]), 1) };
			func_21(iParam1, uParam0[iParam3 /*94*/], uParam2, func_105(uParam0[iParam3 /*94*/], 8192));
		}
		bVar0 = (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0[iParam4 /*94*/])) && MISC::IS_BIT_SET(func_266(uParam0[iParam4 /*94*/])));
		if (((bVar0 && !bParam5) && !func_229(&((uParam0[iParam4 /*94*/])->f_4), 256)) || ((bVar0 && func_105(uParam0[iParam4 /*94*/], 8192)) && uParam0->f_1657 == 1))
		{
			(uParam0[iParam4 /*94*/])->f_37 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(func_266(uParam0[iParam4 /*94*/]), 1) };
...
int func_307(var uParam0, int iParam1, int iParam2)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam0[(1 - iParam1) /*94*/])))
		{
			TASK::TASK_SEEK_COVER_FROM_PED(func_266(uParam0[(1 - iParam1) /*94*/]), unk_0x9B0761B4C3EB8BC7(), -1, false);
		}
		return 1;
	}
	if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iVar0))
...
void func_314(float fParam0, var uParam1, var uParam2)
{
	...
	*fParam0 = (*fParam0 + MISC::GET_FRAME_TIME());
	if ((((*fParam0 > (5f + MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 5f)) && func_76(uParam2) == 75) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(func_266(uParam2))) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) && func_77(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), uParam1->f_3[0 /*3*/] + FtoV((fVar2 * 0.5f)) * uParam1->f_52, uParam1->f_3[3 /*3*/] + FtoV((fVar2 * 0.5f)) * uParam1->f_52, (fVar2 * 1.5f)))
	{
