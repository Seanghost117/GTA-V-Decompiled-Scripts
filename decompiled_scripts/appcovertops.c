...
void __EntryFunction__()
{
	...
	iLocal_191 = -1;
	sLocal_193 = "";
	if (INTERIOR::GET_INTERIOR_AT_COORDS(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("appCovertOps")) > 1)
	{
		func_254(0, 0);
	}
	func_206();
...
void func_1()
{
	if (((!unk_0xCE990E643CD9D0E5(uLocal_188, 7) && !unk_0xCE990E643CD9D0E5(uLocal_188, 6)) && iLocal_198 == 1) && !func_10())
	{
		if (!func_9())
		{
...
var func_3(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
{
	if (func_13(&uLocal_204, "GNRCAUD", func_36(iParam0), 8, 0, 0, 0))
	{
		iLocal_191 = -1;
	}
}
...
void func_37()
{
	...
	if ((!unk_0xCE990E643CD9D0E5(uLocal_188, 4) && !func_10()) && iLocal_198 == 1)
	{
	...
	{
		if (!func_42(&uLocal_202))
		{
			func_41(&uLocal_202, 0, 0);
		}
		else if (func_40(&uLocal_202, iLocal_190, 0))
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_188, 4);
			iLocal_190 = 0;
			func_39(&uLocal_202);
			if (func_38())
			{
...
void func_43()
{
	...
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_370) && GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_371))
		{
			iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_370);
			iVar1 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_371);
			switch (iVar0)
			{
				case 102:
			...
			iLocal_198 = iVar1;
			VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_188, false);
		}
	}
}
...
int func_61(var uParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 < func_178(iParam2))
	{
		...
		if (iVar1 != -1)
		{
			...
			func_63(uParam0, 0, 0, 0f, 0f, 0f, &uVar2, 0f, 0f, 0f, 1, 0, &uVar2, &iVar3, iVar3, 0, 0, 1, 0, 0, 0, 0, 0);
			SYSTEM::SIN(0f);
			func_62();
...
void func_63(var uParam0, int iParam1, int iParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, var uParam8, var uParam9, int iParam10, bool bParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, bool bParam17, bool bParam18)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	...
	func_143(uParam0, iParam1, 1, iParam10, 1);
	...
	if (func_128(iParam1))
	{
		*uParam4 = { func_127(iParam1, iParam2) };
		Var1 = { func_126(iParam1, iParam2) };
		fVar2 = func_125(iParam1, iParam2);
	}
	if (!func_124(*uParam4))
	{
		Var0 = { *uParam4 };
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_124(Var0))
		{
			if (func_141(PLAYER::PLAYER_ID(), 0))
			{
				if (MISC::IS_BIT_SET(func_121()) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(func_121(), 0))
				{
					Var0 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(func_121(), 1) };
					Var1 = { 0f, 0f, ENTITY::IS_ENTITY_IN_WATER(func_121()) };
	...
	else if (func_115(Global_4456448.f_82708) || iParam14)
	{
	...
	else if (func_113(Global_4456448.f_82708) || iParam13)
	{
		Var0 = { 347.2638f, 4867.324f, -59.2679f };
		Var1 = { 1.2933f, 0.0747f, -34.6934f };
		fVar2 = 50f;
	}
	else if (iParam16 || func_112(Global_4456448.f_82708))
	{
	...
	{
		iVar3 = func_111(PLAYER::PLAYER_ID());
		Var0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_110(iVar3), func_109(iVar3), 3.5688f, 7.9792f, 4.1641f) };
		Var1 = { -21.6791f, 0f, (func_109(iVar3) + 40.237f) };
		fVar2 = 70f;
	}
	else if (bParam18 || func_108())
	{
		if (bParam18)
		{
	...
	{
		func_99();
		func_98(&Var4, 144, Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_28);
		if (!func_124(Var4))
		{
			Var0 = { Var4 };
		}
		func_92(&Var4, 144, Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_28);
		Var1 = { Var4 };
	}
	...
	func_64(func_140(), ((iParam12 || iParam13) || iParam14));
}
...
void func_79(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (AUDIO::PLAY_STREAM_FROM_VEHICLE(iParam0) && (ENTITY::IS_ENTITY_AT_COORD(bParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				...
				if (!func_83(fVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(fVar27))
				{
					if (!bVar22)
					{
...
void func_93(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*uParam2 = { func_95(iParam1, iParam3) };
	...
	Var1 = { func_94(Var1, -Var0[0 /*6*/].f_3.f_2) };
	Var1 = { func_94(Var1, Var0[1 /*6*/].f_3.f_2) };
...
Vector3 func_94(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
void func_146(int iParam0)
{
	...
	if (func_148() == 0 || HUD::DISABLE_FRONTEND_THIS_FRAME())
	{
		func_147(1);
...
void func_150(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_148() == 1 || HUD::DISABLE_FRONTEND_THIS_FRAME()) || iParam0)
	{
		func_147(0);
...
void func_181()
{
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_49(0);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_188, true);
}
...
void func_182()
{
	if (func_183())
	{
		if (!unk_0xCE990E643CD9D0E5(uLocal_188, 0))
		{
			...
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_369, "GET_CURRENT_SCREEN_ID");
			iLocal_371 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
...
void func_184()
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 206, true);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 206))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1f, -1f, -1f, -1f);
	}
	if (unk_0x3430895AB97DE4F3(2))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1f, -1f, -1f, -1f);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, true);
		if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1f, -1f, -1f, -1f);
		}
		if (STATS::STAT_GET_MASKED_INT(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1f, -1f, -1f, -1f);
		}
		if (STATS::STAT_GET_MASKED_INT(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1f, -1f, -1f, -1f);
		}
	}
	else
	{
		...
		if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1f, -1f, -1f, -1f);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, true);
		if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1f, -1f, -1f, -1f);
		}
	}
	PAD::ENABLE_CONTROL_ACTION(2, 189, true);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 189))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 190, true);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 190))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 201, true);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 201))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 202, true);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 202))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1f, -1f, -1f, -1f);
		if (iLocal_198 == 0 || iLocal_198 == 1)
		{
			if (!func_185())
			{
				func_254(1, 0);
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 204, true);
	if (PAD::IS_DISABLED_CONTROL_PRESSED(2, 204))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_369, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1f, -1f, -1f, -1f);
	}
	if (unk_0x3430895AB97DE4F3(2))
	{
	...
	else
	{
		...
		if (((iVar0 != 127 || iLocal_372 != 127) || iVar1 != 127) || iLocal_373 != 127)
		{
			...
			NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_372);
			NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_373);
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
	}
	...
	if (((iVar2 != 127 || iLocal_374 != 127) || iVar3 != 127) || iLocal_375 != 127)
	{
		...
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_374);
		NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(iLocal_375);
...
void func_186()
{
	...
	unk_0x9D15035C6653D1B1(1);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING(iLocal_369, 255, 255, 255, 255, 0);
	func_195();
	func_189(0);
	func_187(1);
}
...
{
	func_201();
	iLocal_369 = unk_0x5DEA4192B46CB99B("COVERT_OPS");
...
void func_208()
{
	...
	{
		func_210(1);
		func_209(&uLocal_204, 2, 0, "AGENT14", 0, 1);
	}
}
...
void func_211()
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_369, "SET_PLAYER_DATA");
...
void func_212(int iParam0)
{
	...
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_188, 7);
	}
	if (iVar1 != -1)
	{
		if (!func_244())
		{
			while (!func_240(Global_794709.f_4[iVar1 /*88*/].f_54))
			{
				...
				else if (func_40(&uLocal_200, 750, 0))
				{
					iVar1 = -1;
				}
				else
			...
			if (iVar1 != -1)
			{
				func_213(&fVar5, &fVar6, 0, 9, 0, 0, AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&(Global_794709.f_4[iVar1 /*88*/])));
			}
			if (fVar5 == 1f)
			{
				fVar5 = 0f;
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_369, "ADD_MISSION");
	...
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(SYSTEM::FLOOR(fVar6));
	NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE(SYSTEM::FLOOR(fVar5));
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}

void func_213(float* fParam0, float* fParam1, int iParam2, int iParam3, int iParam4, int iParam5, void fParam6)
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_218(iParam2, iParam3, 0, iParam4, iParam5);
	iVar1 = func_217(fParam6);
...
bool func_240(int iParam0)
{
	...
	if (bVar0)
	{
		...
		while (iVar6 < 8)
		{
			StringCopy(&(Local_194[iVar6 /*16*/]), "", 64);
			iVar6++;
		}
		sVar2 = func_241(iParam0, 500);
		...
		while (!bVar7)
		{
			...
			{
				StringCopy(&(Local_194[iVar5 /*16*/]), HUD::_GET_TEXT_SUBSTRING_SAFE(sVar2, iVar3, iVar4, 63), 64);
				iVar3 = (iVar3 + unk_0x984EC4F65F95F1DF(&(Local_194[iVar5 /*16*/])));
				iVar5++;
			}
		}
	}
