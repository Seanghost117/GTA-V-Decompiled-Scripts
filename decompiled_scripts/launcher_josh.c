...
float func_173(bool bParam0, bool bParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_174(var uParam0)
{
	if (*uParam0 == 29)
	{
		if (func_217(unk_0x9B0761B4C3EB8BC7(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			...
			else if ((!func_175(unk_0x9B0761B4C3EB8BC7(), -828834893) && func_205(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0))) && func_148(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 1f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0, 0);
			}
		}
...
int func_176(var uParam0)
{
	if (*uParam0 == 28)
	{
		if (func_217(unk_0x9B0761B4C3EB8BC7(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			...
			else if ((!func_175(unk_0x9B0761B4C3EB8BC7(), -828834893) && func_205(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0))) && func_148(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 4f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0, 0);
			}
		}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 4:
						if (((((func_191() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_189(8, -1)) || func_186()) || func_185()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_206(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_205(unk_0x9B0761B4C3EB8BC7()) && func_205(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_217(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_217(bool bParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_219(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_205(bParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_221(uParam1) || !ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_220(iParam2) && !PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(bParam0, unk_0x9B0761B4C3EB8BC7(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_221(uParam1) && uParam1->f_4 == 0) && HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_220(iParam2) || PED::IS_PED_FACING_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
bool func_231(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_232(&(Local_37[iVar2 /*4*/]), Var1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_232(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_235(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_237(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_237(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_244(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_237(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_255(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_258(char* sParam0, bool bParam1)
{
	...
	func_259(sParam0, iLocal_53, Var0, fVar1);
...
void func_259(char* sParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_260(sParam0);
...
int func_271(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_205(uParam0->f_28[0]))
			{
				PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(uParam0->f_28[0], 1.653532E-43f, 0);
...
{
	func_259(sParam0, iLocal_53, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*sParam0, 4);
...
void func_289(int iParam0, bool bParam1)
{
	...
	if (SYSTEM::VMAG(fLocal_224))
	{
		unk_0x93370FA10F15BE44(&fLocal_224);
	}
