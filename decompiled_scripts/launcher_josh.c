	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_205(uParam0->f_28[0]))
			{
				...
				uLocal_54 = unk_0xF341A134A5B8D4F6(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0x81493F39713559B1(uLocal_54, 1);
				unk_0xDFDB9C533700BC17(uParam0->f_28[0], uLocal_54, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
