...
int func_1()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("drunk")) > 0)
	{
		return 1;
	}
	if (Global_42560 > 0)
...
void func_2()
{
	...
	if (Global_42769 > iVar1 || Global_42769 == -1)
	{
		...
		if (Global_42772 != Global_42773)
		{
			...
			if (ENTITY::IS_ENTITY_PLAYING_ANIM((Global_42772 - Global_42773)) < 0.01f)
			{
		...
		if (!CAM::IS_SCREEN_FADED_OUT(&Global_42795) && !CAM::IS_SCREEN_FADED_OUT(&Global_42779))
		{
...
void func_16(int iParam0)
{
	...
	if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(Global_42562[iParam0 /*5*/].f_1, 0))
	{
		func_19(iParam0);
		return;
	}
