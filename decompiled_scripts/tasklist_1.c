		...
		switch (iLocal_21)
		{
			...
			case 1:
				...
				while (iLocal_19 < Global_22124[1 /*42*/].f_32[1])
				{
					...
					{
						if (MISC::IS_BIT_SET(uLocal_20[iLocal_19]))
						{
							if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_20[iLocal_19]))
							{
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_20[iLocal_19], unk_0x9B0761B4C3EB8BC7(), true))
								{
									...
									if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(uLocal_20[iLocal_19], 0))
									{
