...
void func_5(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_7() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_7() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_6(bParam0));
...
bool func_13(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_7() /*10931*/].f_6175.f_10, bParam0);
}
...
{
	GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(0.852f, 0.81f, 0.141f, 0.025f, 0, 0, 0, 175, 0);
	func_43(255, 255, 255, 255);
	func_42(0.81f, 0.8f, bParam0, uParam1, 0);
}

void func_42(char* sParam0, float fParam1, bool bParam2, var uParam3, int iParam4)
{
...
{
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("appsidetask")) > 0)
	{
		return 0;
	}
	if (func_48() == 0)
