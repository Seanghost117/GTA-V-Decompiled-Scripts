					...
					else
					{
						if (iLocal_42)
						{
							...
							while (iLocal_44 < 8)
							{
								...
								{
									if (func_38(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), iLocal_44 + 1, 0, 0))
									{
						...
						if (SYSTEM::TIMERA() > 125)
						{
							...
							if (func_35(bLocal_37, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0)))
							{
								...
								if (func_34(bLocal_37))
								{
									...
									if (INTERIOR::GET_INTERIOR_AT_COORDS(AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(&Local_48)) == 0)
									{
										if (!Global_31182[bLocal_37])
										{
											func_32(bLocal_37, Global_31182[bLocal_37]);
										}
									}
								}
								else if (!Global_31182[bLocal_37])
								{
									if (PED::IS_PED_IN_FLYING_VEHICLE(unk_0x9B0761B4C3EB8BC7()))
									{
										...
										if (!bLocal_40)
										{
											if (func_38(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), bLocal_37, 0, 0))
											{
												if ((MISC::GET_GAME_TIMER() - iLocal_49[iLocal_46]) > 8000)
												{
													func_24();
												}
												else if (MISC::IS_PROJECTILE_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0) + Vector(200f, 200f, 200f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0) - Vector(200f, 200f, 200f), true))
												{
													func_24();
												}
												else if (bLocal_37 != 4)
...
void func_14()
{
	...
	{
		if (func_17(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_24()
{
	switch (iLocal_46)
	{
		case 0:
			iLocal_47 = 2;
			if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) < iLocal_47)
			{
			}
			break;
		
		case 1:
			if (PED::IS_PED_IN_FLYING_VEHICLE(unk_0x9B0761B4C3EB8BC7()) && MISC::IS_PROJECTILE_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0) + Vector(200f, 200f, 200f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0) - Vector(200f, 200f, 200f), true))
			{
				iLocal_47 = 5;
			}
			else
	...
	if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) < iLocal_47)
	{
		PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_ID(), iLocal_47, false);
...
int func_29()
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if ((MONEY::NETWORK_SPENT_BUY_REVEAL_PLAYERS(MISC::GET_MODEL_DIMENSIONS(iVar0)) || MISC::GET_MODEL_DIMENSIONS(iVar0) == joaat("caddy")) || MISC::GET_MODEL_DIMENSIONS(iVar0) == joaat("caddy2"))
			{
				return 1;
			}
			else
