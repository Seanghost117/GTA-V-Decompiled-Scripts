...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		if ((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_60) || (func_111() && unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_46, 500f, 500f, 500f, 0, 1, 0)))
		{
			if (!func_111())
			{
				if (func_110())
...
void func_1()
{
	if (iLocal_54 && !iLocal_53)
	{
		...
		while (iLocal_71 < 6)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[iLocal_71]))
			{
				if (SYSTEM::VMAG(uLocal_68[iLocal_71]))
				{
...
void func_24()
{
	...
	switch (iLocal_45)
	{
		case 0:
			...
			{
				if (SYSTEM::VMAG(iLocal_66))
				{
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_49, Local_50, fLocal_51, 0, 1, 0))
					{
						func_67();
						if (!bLocal_61)
						{
		...
		case 1:
			if ((((STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[0]) && STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[1])) && STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[2])) && STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[3])) && STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[4]))
			{
				func_25();
			}
			else if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_46, 100f, 100f, 100f, 0, 1, 0))
			{
				func_25();
			}
			break;
...
bool func_68(int iParam0)
{
	...
	HUD::SET_BLIP_SCALE(iVar0, func_69(MISC::SET_BIT(), 0.7f, 0.7f));
	return bVar0;
}
...
void func_71()
{
	...
	while (iLocal_71 < 6)
	{
		...
		{
			if ((func_95() && iLocal_73 != 2) || (iLocal_73 == 1 && PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7())))
			{
				func_93();
				SYSTEM::WAIT(0);
				if (func_92())
			...
			switch (iLocal_73)
			{
				case 0:
					...
					{
						if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_63[iLocal_71], unk_0x9B0761B4C3EB8BC7(), 15f, 15f, 40f, false, true, 0) && PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_63[iLocal_71])) || PED::CAN_PED_SEE_HATED_PED(iLocal_63[iLocal_71], unk_0x9B0761B4C3EB8BC7()))
						{
							if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_49, Local_50, fLocal_51, 0, 1, 0) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, 0, 1, 0))
							{
								if (!func_56())
								{
								...
								while (iVar0 < iLocal_63)
								{
									...
									AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_63[iVar0], iLocal_70);
				...
				case 1:
					...
					while (iVar1 < iLocal_63)
					{
						if (!iLocal_56[iVar1])
						{
							...
							TASK::TASK_AIM_GUN_AT_ENTITY(0, unk_0x9B0761B4C3EB8BC7(), -1, false);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_70);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_63[iVar1], iLocal_70);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_70);
					...
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[iLocal_71]))
					{
						if (!PED::IS_PED_FACING_PED(iLocal_63[iLocal_71], unk_0x9B0761B4C3EB8BC7(), 50f))
						{
							TASK::TASK_LOOK_AT_ENTITY(iLocal_63[iLocal_71], unk_0x9B0761B4C3EB8BC7(), -1, 0, 2);
					...
					if (iLocal_56[iLocal_71])
					{
						...
						{
							if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_49, Local_50, fLocal_51, 0, 1, 0) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_63[iLocal_71], unk_0x9B0761B4C3EB8BC7(), 15f, 15f, 5f, false, true, 0))
							{
								func_93();
								SYSTEM::WAIT(0);
								if (func_92())
							...
							else
							{
								...
								{
									HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_63[iLocal_71]);
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[0]))
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_70);
										...
										TASK::CLOSE_SEQUENCE_TASK(iLocal_70);
										AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_63[0], iLocal_70);
										TASK::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[0], false, -1, 0);
									}
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[1]))
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_70);
										...
										TASK::SET_SEQUENCE_TO_REPEAT(iLocal_70, true);
										TASK::CLOSE_SEQUENCE_TASK(iLocal_70);
										AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_63[1], iLocal_70);
										TASK::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[1], false, -1, 0);
									}
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[2]))
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_70);
										...
										TASK::SET_SEQUENCE_TO_REPEAT(iLocal_70, true);
										TASK::CLOSE_SEQUENCE_TASK(iLocal_70);
										AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_63[2], iLocal_70);
										TASK::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[2], false, -1, 0);
									}
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[3]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[4]))
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_70);
										...
										TASK::CLOSE_SEQUENCE_TASK(iLocal_70);
										AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_63[3], iLocal_70);
										TASK::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[3], false, -1, 0);
									}
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[4]))
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_70);
										...
										TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, true);
										TASK::CLOSE_SEQUENCE_TASK(iLocal_70);
										AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_63[4], iLocal_70);
										TASK::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[4], false, -1, 0);
									}
									if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[5]))
									{
				...
				case 2:
					...
					while (iLocal_71 < 6)
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[iLocal_71]))
						{
							...
							{
								PED::_0xF1C03A5352243A30(iLocal_63[iLocal_71]);
								TASK::TASK_COMBAT_PED(iLocal_63[iLocal_71], unk_0x9B0761B4C3EB8BC7(), 0, 16);
								PED::SET_PED_KEEP_TASK(iLocal_63[iLocal_71], true);
								if (!SYSTEM::VMAG(uLocal_68[iLocal_71]))
								{
...
int func_95()
{
	...
	{
		if (ENTITY::GET_ENTITY_COORDS(iLocal_64[iVar0], false))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_64[iVar0], unk_0x9B0761B4C3EB8BC7(), true))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_63)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[iVar0]))
		{
			if (PED::CAN_PED_SEE_HATED_PED(iLocal_63[iVar0], unk_0x9B0761B4C3EB8BC7()))
			{
			...
			if ((((((MISC::IS_BULLET_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_63[iVar0], 1), 5f, true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63[iVar0], unk_0x9B0761B4C3EB8BC7(), true)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), iLocal_63[iVar0])) || MISC::IS_PROJECTILE_TYPE_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_63[iVar0], 1) - Vector(15f, 15f, 15f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_63[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), true)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_63[iVar0], 1) - Vector(15f, 15f, 15f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_63[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), true)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_63[iVar0], 1) - Vector(15f, 15f, 15f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_63[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), true)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_63[iVar0], 1) - Vector(15f, 15f, 15f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_63[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_stickybomb"), true))
			{
				return 1;
			}
		}
...
void func_96()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(joaat("g_m_y_salvagoon_01")) && ENTITY::DOES_ENTITY_EXIST(joaat("bobcatxl"))) && ENTITY::DOES_ENTITY_EXIST(joaat("prop_cash_case_01")))
	{
		PATHFIND::SET_ROADS_IN_AREA(Local_46 - Vector(20f, 50f, 50f), Local_46 + Vector(20f, 50f, 50f), false, true, 1, 1);
		...
		iLocal_65 = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), Local_47, -1.368082f, 0.230633f, 176.8749f, iVar0, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(40000, 100000), 2, true, joaat("prop_cash_case_01"));
		...
		while (iLocal_71 < 6)
		{
			...
			PED::_0x2208438012482A1A(iLocal_63[iLocal_71], 1);
			...
			bLocal_72 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 3);
			if (bLocal_72 == 0)
			{
				unk_0x92BD213E6A0E666B(iLocal_63[iLocal_71], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
			}
			else if (bLocal_72 == 1)
			{
				unk_0x92BD213E6A0E666B(iLocal_63[iLocal_71], joaat("weapon_microsmg"), -1, 1, 1);
			}
			else
			{
				unk_0x92BD213E6A0E666B(iLocal_63[iLocal_71], joaat("weapon_assaultrifle"), -1, 1, 1);
			}
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_63[iLocal_71], 5.885454E-44f, 1);
			func_91(&uLocal_77, 3, iLocal_63[iLocal_71], "SalvadorGang", 0, 1);
			iLocal_71++;
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_63[0]))
...
bool func_97(struct<3> Param0, bool bParam1)
{
	...
	HUD::SET_BLIP_SCALE(iVar0, func_69(MISC::SET_BIT(), 1f, 1f));
...
int func_98()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_109())
		{
			return 0;
		}
	}
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_134()) || Global_110905) || Global_30970) || func_133()) || func_88(8, -1)) || func_130()) || func_132()) || func_131()) || func_129()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_134() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_88(8, -1)) || func_129()) || func_128()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_134()) || func_131()) || Global_110905) || Global_30970) || func_133()) || Global_42801) || func_88(8, -1)) || func_130()) || func_128()) || func_129()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
