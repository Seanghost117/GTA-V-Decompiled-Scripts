					...
					case 1:
						switch (iLocal_44)
						{
							case 0:
								...
								{
									func_184();
									if (INTERIOR::IS_INTERIOR_READY(bLocal_88))
									{
										func_178();
										iLocal_76 = 1;
									}
								...
								else
								{
									...
									func_175();
									INTERIOR::UNPIN_INTERIOR(bLocal_88);
									if (func_174())
									{
										if (!iLocal_94)
										{
									...
									if (func_172())
									{
										...
										{
											if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[iVar0]))
											{
												TASK::TASK_COMBAT_PED(iLocal_66[iVar0], unk_0x9B0761B4C3EB8BC7(), 0, 16);
												PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
												if (!SYSTEM::VMAG(uLocal_116[iVar0]))
												{
										...
										if (iLocal_47 == 2)
										{
											...
											{
												if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[iVar0]))
												{
											...
											{
												if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_68[iVar0]))
												{
										...
										PED::GET_PED_BONE_INDEX(&bLocal_102);
										bLocal_79 = true;
										iLocal_44 = 1;
										iLocal_45 = 3;
									}
							...
							case 1:
								...
								{
									if (MISC::IS_BIT_SET(iLocal_67[iVar1]))
									{
										if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_67[iVar1], unk_0x9B0761B4C3EB8BC7(), true))
										{
											func_162();
										}
									}
								...
								{
									if (MISC::IS_BIT_SET(iLocal_68[iVar1]))
									{
										if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_68[iVar1], unk_0x9B0761B4C3EB8BC7(), true))
										{
											func_162();
										}
									}
								...
								switch (iLocal_45)
								{
									...
									case 2:
										...
										{
											if (MISC::IS_BIT_SET(bLocal_102))
											{
												if (!ENTITY::IS_ENTITY_ATTACHED(bLocal_102))
												{
													func_151();
													ENTITY::SET_ENTITY_HEALTH(iLocal_66[0], joaat("weapon_unarmed"), 1);
													OBJECT::CREATE_OBJECT_NO_OFFSET(bLocal_102, iLocal_66[0], ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_66[0], 57005), 0.3f, 0f, 0f, 80f, -90f, 0f, 1, 1, 0, 0, 2, 1);
												}
											}
										}
										if (MISC::IS_PROJECTILE_IN_AREA(Local_123 - Vector(20f, 20f, 20f), Local_123 + Vector(20f, 20f, 20f), false))
										{
											if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[1]))
											{
												TASK::TASK_SMART_FLEE_COORD(iLocal_67[1], Local_59, 150f, -1, false, false);
												PED::_0x2208438012482A1A(iLocal_67[1], 0);
												ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_67[1]));
											}
											if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[2]))
											{
												TASK::TASK_SMART_FLEE_COORD(iLocal_67[2], Local_59, 150f, -1, false, false);
												PED::_0x2208438012482A1A(iLocal_67[2], 0);
												ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_67[2]));
											}
											iVar2 = 0;
											while (iVar2 <= (iLocal_65 - 1))
											{
												if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_68[iVar2]))
												{
													ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_68[iVar2], true, 1);
													TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
													if (iLocal_47 == 1)
													{
														TASK::TASK_PLAY_ANIM(false, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, false, true, false);
													}
													else if (iLocal_47 == 2)
													{
													...
													AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_68[iVar2], iLocal_87);
													TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
													PED::SET_PED_KEEP_TASK(iLocal_68[iVar2], true);
													PED::_0x2208438012482A1A(iLocal_68[iVar2], 0);
										...
										if (func_150() || SYSTEM::TIMERA() > 20000)
										{
											if (!iLocal_99)
											{
												if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_66[0], 0))
												{
													...
													TASK::TASK_PLAY_ANIM(unk_0x9B0761B4C3EB8BC7(), "random@shop_robbery", "kneel_getup_p", 2f, -2f, 2700, 0, 0f, false, false, false);
													if (iLocal_47 == 1)
													{
														if (MISC::IS_BIT_SET(bLocal_102))
														{
															ENTITY::SET_ENTITY_VISIBLE(bLocal_102, false, false);
															ENTITY::SET_ENTITY_COLLISION(bLocal_102, false, false);
														}
													}
													else if (iLocal_47 == 2)
													{
													...
													while (iVar1 < iLocal_67)
													{
														if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[iVar1]))
														{
															PED::_0x2208438012482A1A(iLocal_67[iVar1], 0);
														}
														iVar1++;
													}
													iVar1 = 0;
													while (iVar1 < iLocal_68)
													{
														if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_68[iVar1]))
														{
															PED::_0x2208438012482A1A(iLocal_68[iVar1], 0);
														}
														iVar1++;
													}
													if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[0]))
													{
														PED::_0x2208438012482A1A(iLocal_67[0], 1);
														TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
														TASK::TASK_PLAY_ANIM(false, "random@robbery", "f_distressed_loop", 2f, -2f, -1, 9, 0f, false, false, false);
														TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
														AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_67[0], iLocal_87);
														TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
										...
										if (!iLocal_78)
										{
											if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(unk_0x9B0761B4C3EB8BC7(), "random@shop_robbery", "kneel_getup_p", 3))
											{
												if (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), "random@shop_robbery", "kneel_getup_p") > 0.7f || (NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), "random@shop_robbery", "kneel_getup_p") > 0.6f && func_117(64)))
												{
										...
										if (iLocal_47 == 1)
										{
											...
											if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]) && ENTITY::GET_ENTITY_COORDS(bLocal_106, false))
											{
												if (unk_0xE0B3BC41DDA88DF0(iLocal_66[0], bLocal_106, 0))
												{
													if (MISC::IS_BIT_SET(bLocal_102))
													{
														PED::GET_PED_BONE_INDEX(&bLocal_102);
											...
											{
												if (SYSTEM::VMAG(uLocal_116[0]))
												{
													unk_0x93370FA10F15BE44(&(uLocal_116[0]));
												}
												if (SYSTEM::VMAG(uLocal_116[1]))
												{
													unk_0x93370FA10F15BE44(&(uLocal_116[1]));
												}
												if (!SYSTEM::VMAG(uLocal_120))
												{
													iLocal_120 = func_113(bLocal_106, 1, 0);
												}
												bLocal_96 = true;
												if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_115))
												{
													PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_115, 17, true);
													PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_115, 6, true);
													PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_115, 1, true);
													TASK::TASK_VEHICLE_MISSION_PED_TARGET(bLocal_115, bLocal_106, unk_0x9B0761B4C3EB8BC7(), 8, 16f, 786469, -1f, -1f, true);
													PED::SET_PED_KEEP_TASK(bLocal_115, true);
													iLocal_97 = 1;
												}
											}
											if (iLocal_97 && !iLocal_143)
											{
												if (ENTITY::GET_ENTITY_COORDS(bLocal_106, false) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_115))
												{
													if (!unk_0xC2169C00B643278B(bLocal_106, Local_51[0 /*3*/], 20f, 20f, 10f, 0, 1, 0))
													{
														TASK::TASK_VEHICLE_MISSION_PED_TARGET(bLocal_115, bLocal_106, unk_0x9B0761B4C3EB8BC7(), 8, 19f, 786469, -1f, -1f, true);
														iLocal_143 = 1;
													}
												}
											}
											if (func_112())
											{
												if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_115))
												{
													if (ENTITY::GET_ENTITY_COORDS(bLocal_106, false))
													{
														if (!iLocal_98)
														{
															PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_115, 17, true);
															PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_115, 6, true);
															PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_115, 1, true);
															TASK::TASK_VEHICLE_MISSION_PED_TARGET(bLocal_115, bLocal_106, unk_0x9B0761B4C3EB8BC7(), 8, 17f, 786469, -1f, -1f, true);
															iLocal_98 = 1;
														}
														if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]))
														{
															if (unk_0xE0B3BC41DDA88DF0(iLocal_66[0], bLocal_106, 0))
															{
																if (SYSTEM::VMAG(uLocal_116[0]))
												...
												while (iVar3 <= (iLocal_63 - 1))
												{
													if (!iLocal_80[iVar3])
													{
														if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[iVar3]))
														{
															if (SYSTEM::VDIST(iLocal_66[iVar3], 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_115))
															{
																TASK::TASK_DRIVE_BY(iLocal_66[iVar3], unk_0x9B0761B4C3EB8BC7(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, false, -753768974);
																iLocal_80[iVar3] = 1;
															}
															else if (!SYSTEM::VMAG(uLocal_121))
															{
																TASK::TASK_COMBAT_PED(iLocal_66[iVar3], unk_0x9B0761B4C3EB8BC7(), 0, 16);
																PED::SET_PED_KEEP_TASK(iLocal_66[iVar3], true);
																if (SYSTEM::VMAG(iLocal_120))
																{
																	unk_0x93370FA10F15BE44(&iLocal_120);
																}
																if (!SYSTEM::VMAG(uLocal_116[iVar3]))
																{
													...
													if (!iLocal_81[iVar3])
													{
														if (ENTITY::GET_ENTITY_COORDS(bLocal_106, false))
														{
															if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[iVar3]))
															{
																if ((STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_115) || SYSTEM::VDIST2(bLocal_106, -1, 0)) || FIRE::IS_ENTITY_ON_FIRE(iLocal_66[iVar3]))
																{
																	...
																	TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
																	AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_66[iVar3], iLocal_87);
																	TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
																	PED::SET_PED_KEEP_TASK(iLocal_66[iVar3], true);
																	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_115))
																	{
																		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_115, true, 1);
																		TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
																		TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
																		TASK::TASK_SMART_FLEE_PED(false, unk_0x9B0761B4C3EB8BC7(), 300f, -1, false, false);
																		TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
																		AUDIO::STOP_SCRIPTED_CONVERSATION(bLocal_115, iLocal_87);
																		TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
																		PED::SET_PED_KEEP_TASK(bLocal_115, true);
																	}
										...
										else if (iLocal_47 == 2)
										{
											...
											if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[1]))
											{
												if (SYSTEM::VMAG(uLocal_116[1]))
												{
											...
											if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]))
											{
												if (MISC::IS_BIT_SET(bLocal_102))
												{
													if (ENTITY::IS_ENTITY_ATTACHED(bLocal_102))
													{
														ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_102, 1, 1);
													}
													PED::GET_PED_BONE_INDEX(&bLocal_102);
													func_110();
													func_107();
											...
											else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_66[0], unk_0x9B0761B4C3EB8BC7(), true))
											{
												if (MISC::IS_BIT_SET(bLocal_102))
												{
													if (ENTITY::IS_ENTITY_ATTACHED(bLocal_102))
									...
									case 10:
										...
										if (iLocal_47 == 1)
										{
											if (!iLocal_95)
											{
												...
												else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[0]))
												{
													unk_0x03D382CB0B44E2FC(iLocal_67[0], -818.5553f, -185.4815f, 36.5689f, 1, 0, 0, 1);
													...
													{
														if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_68[iVar4]))
														{
															TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
															TASK::TASK_PLAY_ANIM(false, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, false, true, false);
															TASK::TASK_SMART_FLEE_COORD(0, Local_59, 150f, -1, false, false);
															TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
															AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_68[iVar4], iLocal_87);
															TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
															PED::SET_PED_KEEP_TASK(iLocal_68[iVar4], true);
															PED::_0x2208438012482A1A(iLocal_68[iVar4], 0);
										...
										else if (iLocal_47 == 2)
										{
											if (!iLocal_95)
											{
												...
												{
													unk_0x03D382CB0B44E2FC(iLocal_67[0], -1197.455f, -776.0289f, 16.3254f, 1, 0, 0, 1);
													...
													{
														if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_68[iVar5]))
														{
															TASK::TASK_SMART_FLEE_COORD(iLocal_68[iVar5], Local_59, 150f, -1, false, false);
															PED::_0x2208438012482A1A(iLocal_68[iVar5], 0);
										...
										if ((func_170() && !SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0)) && !MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7()))
										{
											SYSTEM::SETTIMERA(0);
											iLocal_45 = 11;
										}
										if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), func_250()) > (bLocal_124 + 150f))
										{
											iLocal_45 = 12;
										}
										...
										else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_67[0], unk_0x9B0761B4C3EB8BC7(), true))
										{
											func_75(2);
											func_55();
										}
									...
									case 13:
										if (!iLocal_144)
										{
											if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[0]))
											{
												HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_67[0]);
												if (iLocal_47 == 1)
												{
...
void func_1()
{
	if (func_170())
	{
		...
		if (!iLocal_113)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[0]))
			{
				...
				MISC::CLEAR_AREA_OF_PROJECTILES(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_67[0], 1), 20f, 0);
	...
	if (bLocal_112)
	{
		if (!iLocal_114)
		{
			...
			Local_125 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_67[0], 0) };
			if (iLocal_47 == 1)
			{
			...
			TASK::TASK_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), iLocal_135, sLocal_130, sLocal_131, 1000f, -2f, 5, 0, 1000f, 0);
			...
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_67[0], false, 0);
			bLocal_102 = OBJECT::CREATE_OBJECT(joaat("prop_cs_duffel_01"), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), true, true, false);
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_102, iLocal_135, sLocal_133, sLocal_130, 1000f, 8f, 0, 1000f);
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[0]))
			{
				func_54();
	...
	if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_135) > fLocal_136 && iLocal_114)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[0]))
		{
			PED::SET_PED_MONEY(iLocal_67[0], bLocal_118);
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_67[0]);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
			TASK::TASK_PLAY_ANIM(false, "random@robbery", "stand_worried_female", 2f, -2f, -1, 1, 0f, false, false, false);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
			AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_67[0], iLocal_87);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
			PED::SET_PED_KEEP_TASK(iLocal_67[0], true);
...
int func_11(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (MISC::SET_BIT())
	{
		if (func_9() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_7(func_8(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
int func_12(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_13(func_43(iParam0), 0, iParam1, bParam2, 0);
}
...
void func_16(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_18() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_18() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_17(bParam0));
...
bool func_21(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_18() /*10931*/].f_6175.f_10, bParam0);
}
...
void func_51()
{
	if (iLocal_47 == 1)
	{
		...
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_68[0]))
			{
				PED::_0x2208438012482A1A(iLocal_68[0], 0);
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_68[0]));
			}
		}
		if (MISC::IS_BIT_SET(iLocal_68[1]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_68[1]))
			{
				PED::_0x2208438012482A1A(iLocal_68[1], 0);
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_68[1]));
			}
		}
		if (MISC::IS_BIT_SET(iLocal_68[2]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_68[2]))
			{
				unk_0x03D382CB0B44E2FC(iLocal_68[2], -820.424f, -181.9059f, 36.5687f, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(iLocal_68[2], 167.7909f);
				PED::_0x2208438012482A1A(iLocal_68[2], 0);
...
void func_54()
{
	if (iLocal_47 == 1)
	{
		...
		{
			if (unk_0xC2169C00B643278B(PLAYER::GET_PLAYERS_LAST_VEHICLE(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 8f, 8f, 8f, 0, 1, 0) || unk_0xC2169C00B643278B(PLAYER::GET_PLAYERS_LAST_VEHICLE(), -823.1281f, -187.9591f, 36.6189f, 8f, 8f, 8f, 0, 1, 0))
			{
				unk_0x03D382CB0B44E2FC(PLAYER::GET_PLAYERS_LAST_VEHICLE(), -831.9709f, -192.0823f, 36.5008f, 0, 0, 0, 1);
	...
	else if (iLocal_47 == 2)
	{
		if (ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
		{
			if (unk_0xC2169C00B643278B(PLAYER::GET_PLAYERS_LAST_VEHICLE(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), 8f, 8f, 8f, 0, 1, 0) || unk_0xC2169C00B643278B(PLAYER::GET_PLAYERS_LAST_VEHICLE(), -1201.017f, -777.5527f, 16.3398f, 8f, 8f, 8f, 0, 1, 0))
			{
				unk_0x03D382CB0B44E2FC(PLAYER::GET_PLAYERS_LAST_VEHICLE(), -1205.936f, -781.2014f, 16.0088f, 0, 0, 0, 1);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 5f);
			}
		}
...
int func_81(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				fVar0 = MISC::GET_MODEL_DIMENSIONS(func_82(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 1)));
				switch (fVar0)
				{
...
void func_83(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_84(iParam0) && INTERIOR::GET_INTERIOR_AT_COORDS(Global_89743[26 /*34*/].f_6) == 0)
			{
				Global_111858.f_7257[iParam0] = 1;
				unk_0xDC5C33A98881772F(uParam1->f_5, Global_111858.f_7257[iParam0], 1, 1);
			}
...
int func_86()
{
	...
	func_87(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
void func_104()
{
	if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_62))
	{
		...
		func_105(&uLocal_148);
		bLocal_124 = SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), func_250());
		SYSTEM::SETTIMERA(0);
		iLocal_45 = 10;
	}
	if (OBJECT::DOES_PICKUP_EXIST(iLocal_62))
	{
		if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), OBJECT::GET_PICKUP_COORDS(iLocal_62)) > 200f)
		{
			func_162();
		}
	}
...
void func_107()
{
	...
	if (!OBJECT::DOES_PICKUP_EXIST(iLocal_62))
	{
		...
		if (!bLocal_96)
		{
			if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_66[0], 0))
			{
				if (MISC::IS_BIT_SET(iLocal_66[0]))
				{
			...
			{
				Local_61 = { OBJECT::GET_SAFE_PICKUP_COORDS(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_66[0], 1), 1.2f, 1.5f) };
			}
		}
		else if (MISC::IS_BIT_SET(bLocal_106))
		{
			Local_61 = { OBJECT::GET_SAFE_PICKUP_COORDS(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_106, 0), 1.2f, 1.5f) };
		}
		Local_61 = { Local_61.x, Local_61.f_1, (Local_61.f_2 + 0.25f) };
		iLocal_62 = OBJECT::CREATE_PICKUP(joaat("pickup_money_med_bag"), Local_61, iLocal_60, bLocal_118, true, joaat("prop_cs_duffel_01"));
		...
		if (iLocal_47 == 1)
		{
			...
			while (iVar0 <= (iLocal_63 - 1))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[iVar0]))
				{
					...
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_66[iVar0]);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
					TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					TASK::TASK_SMART_FLEE_PED(false, unk_0x9B0761B4C3EB8BC7(), 300f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_66[iVar0], iLocal_87);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
					PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
				}
				iVar0++;
...
bool func_108(int iParam0)
{
	...
	HUD::SET_BLIP_SCALE(bVar0, func_109(MISC::SET_BIT(), 0.7f, 0.7f));
	return bVar0;
}
...
int func_111()
{
	...
	else if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]))
	{
		iLocal_84 = 1;
	}
	if (!bLocal_96)
	{
		...
		else if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[1]))
		{
			iLocal_85 = 1;
		}
	}
	...
	if (!MISC::IS_BIT_SET(bLocal_115))
	{
		iLocal_86 = 1;
	}
	else if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_115) || !SYSTEM::VDIST(bLocal_115, 0))
	{
		iLocal_86 = 1;
	}
...
int func_112()
{
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		...
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[iVar0]) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_66[iVar0], 0))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_66[iVar0], unk_0x9B0761B4C3EB8BC7(), true))
				{
					return 1;
				}
			}
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		if (MISC::IS_BIT_SET(iLocal_66[iVar0]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[iVar0]))
			{
				...
				{
					if (PED::GET_PEDS_JACKER(iLocal_66[iVar0]) == unk_0x9B0761B4C3EB8BC7())
					{
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_66[iVar0], true, 1);
						TASK::TASK_SMART_FLEE_PED(iLocal_66[iVar0], unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
						PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
						SYSTEM::WAIT(0);
	...
	if (MISC::IS_BIT_SET(bLocal_115))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_115) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_115, 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_115, unk_0x9B0761B4C3EB8BC7(), true))
			{
				return 1;
			}
		}
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_115))
		{
			if (PED::IS_PED_BEING_STUNNED(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_stungun")))
			{
				return 1;
			}
		}
	...
	if (MISC::IS_BIT_SET(bLocal_115))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_115))
		{
			if (PED::IS_PED_BEING_JACKED(bLocal_115))
			{
				if (PED::GET_PEDS_JACKER(bLocal_115) == unk_0x9B0761B4C3EB8BC7())
				{
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_115, true, 1);
					TASK::TASK_SMART_FLEE_PED(bLocal_115, unk_0x9B0761B4C3EB8BC7(), 250f, -1, false, false);
					PED::SET_PED_KEEP_TASK(bLocal_115, true);
					SYSTEM::WAIT(0);
					ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_115);
					return 1;
				}
			}
		}
	...
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_106, 0) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_106, 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_106, unk_0x9B0761B4C3EB8BC7(), true))
			{
				return 1;
			}
		}
...
bool func_114(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_109(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
	...
	if (ENTITY::GET_ENTITY_COORDS(bLocal_106, false))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]))
		{
			if (unk_0xE0B3BC41DDA88DF0(iLocal_66[0], bLocal_106, 0))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[1]))
				{
					if (unk_0xE0B3BC41DDA88DF0(iLocal_66[1], bLocal_106, 0))
					{
						return 1;
					}
				}
...
void func_142(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_146(PLAYER::PLAYER_ID())) && !func_144(PLAYER::PLAYER_ID(), 0)) && !func_143()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_146(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
int func_150()
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[1]))
	{
		if (iLocal_47 == 1)
		{
			if (!iLocal_100)
			{
				if (!unk_0x1037B9D45CE6B788(iLocal_66[0], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, 1, 0))
				{
					iLocal_100 = 1;
				}
			}
			if (!iLocal_101)
			{
				if (!unk_0x1037B9D45CE6B788(iLocal_66[1], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, 1, 0))
				{
					iLocal_101 = 1;
				}
			}
		...
		else if (iLocal_47 == 2)
		{
			if (!iLocal_100)
			{
				if ((!unk_0x1037B9D45CE6B788(iLocal_66[0], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) || unk_0x1037B9D45CE6B788(iLocal_66[0], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) || unk_0x1037B9D45CE6B788(iLocal_66[0], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_66[0], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
					iLocal_100 = 1;
				}
			}
			if (!iLocal_101)
			{
				if ((!unk_0x1037B9D45CE6B788(iLocal_66[1], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) || unk_0x1037B9D45CE6B788(iLocal_66[1], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) || unk_0x1037B9D45CE6B788(iLocal_66[1], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0))
				{
					TASK::TASK_SMART_FLEE_PED(iLocal_66[1], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
					iLocal_101 = 1;
				}
			}
		}
...
void func_151()
{
	...
	Var0 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_102, 1) };
	Var1 = { NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(bLocal_102, 2) };
	PED::GET_PED_BONE_INDEX(&bLocal_102);
	bLocal_102 = OBJECT::CREATE_OBJECT(joaat("prop_cs_duffel_01"), Var0, true, true, false);
	ENTITY::DETACH_ENTITY(bLocal_102, Var1, 2, 1);
}
...
void func_152()
{
	if (MISC::IS_BIT_SET(iLocal_66[0]))
	{
		if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_66[0], 0)) > 200f && ENTITY::IS_ENTITY_OCCLUDED(iLocal_66[0]))
		{
			if (SYSTEM::VMAG(uLocal_116[0]))
			{
				unk_0x93370FA10F15BE44(&(uLocal_116[0]));
	...
	if (MISC::IS_BIT_SET(bLocal_106))
	{
		if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bLocal_106, 0)) > 200f && ENTITY::IS_ENTITY_OCCLUDED(bLocal_106))
		{
			if (SYSTEM::VMAG(iLocal_120))
			{
				unk_0x93370FA10F15BE44(&iLocal_120);
			}
			STREAMING::REMOVE_ANIM_DICT(&bLocal_106);
			bLocal_83 = true;
		}
	}
	else
...
void func_153()
{
	...
	{
		if (ENTITY::GET_ENTITY_HEALTH(bLocal_106) < 800)
		{
			CAM::IS_AIM_CAM_ACTIVE(bLocal_106, 0, 0);
			VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bLocal_106, 10f);
		}
	}
}
...
void func_155()
{
	...
	if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!bLocal_79)
		{
			...
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[iVar1]))
				{
					TASK::TASK_COMBAT_PED(iLocal_66[iVar1], unk_0x9B0761B4C3EB8BC7(), 0, 16);
				}
				iVar1++;
			}
			bLocal_79 = true;
	...
	if (!bLocal_79)
	{
		...
		else if (iLocal_47 == 2)
		{
			...
			if (MISC::IS_BIT_SET(bLocal_102) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]))
			{
				if (!iLocal_109)
				{
					iLocal_109 = 1;
		...
		if (!iLocal_77)
		{
			if (iLocal_47 == 1)
			{
				...
				{
					PED::GET_PED_BONE_INDEX(&(iLocal_103[0]));
					PED::GET_PED_BONE_INDEX(&(iLocal_103[1]));
					if (ENTITY::GET_ENTITY_COORDS(bLocal_106, false))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]))
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_66[0]);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
							TASK::TASK_CLEAR_LOOK_AT(0);
							TASK::TASK_ENTER_VEHICLE(0, bLocal_106, -1, 0, 2f, 1, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_66[0], iLocal_87);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
						}
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[1]))
						{
							...
							TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
							TASK::TASK_CLEAR_LOOK_AT(0);
							TASK::TASK_ENTER_VEHICLE(0, bLocal_106, -1, 1, 2f, 1, 0);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
							AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_66[1], iLocal_87);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
						}
						iLocal_45 = 2;
						iLocal_77 = 1;
			...
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_135) > 0.453f)
				{
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[0]))
					{
						PED::_0x2208438012482A1A(iLocal_67[0], 1);
					...
					if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]))
					{
						...
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_66[0], true, 1);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
						TASK::TASK_PLAY_ANIM(false, "random@robbery", "run", 2f, -2f, -1, 49, 0f, false, false, false);
...
void func_158()
{
	...
	if (!iLocal_75 && func_161(1, 0, 1))
	{
		...
		if (iLocal_47 == 1)
		{
			if (!iLocal_108)
			{
				...
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(unk_0x9B0761B4C3EB8BC7());
				TASK::TASK_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), iLocal_135, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1000f, 0);
				ENTITY::FREEZE_ENTITY_POSITION(unk_0x9B0761B4C3EB8BC7(), true, 0);
				if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[1])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[0])) && MISC::IS_BIT_SET(bLocal_102))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_102, iLocal_135, "robbery_action_bag", "random@shop_robbery", 8f, -8f, 0, 1000f);
				}
		...
		else if (iLocal_47 == 2)
		{
			...
			if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[1])) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[0])) && MISC::IS_BIT_SET(bLocal_102))
			{
				...
				if (MISC::IS_BIT_SET(iLocal_103[0]) && MISC::IS_BIT_SET(iLocal_103[1]))
				{
					OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_103[0], iLocal_67[0], ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_67[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
					OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_103[1], iLocal_67[0], ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_67[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
				}
			}
			...
			ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 305.3806f);
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(unk_0x9B0761B4C3EB8BC7());
			TASK::OPEN_SEQUENCE_TASK(&iLocal_87);
			TASK::TASK_PLAY_ANIM(false, "random@shop_robbery", "robbery_action_p", 1000f, -2f, -1, 134217736, 0.06f, false, false, false);
			TASK::TASK_PLAY_ANIM(false, "random@shop_robbery", "kneel_loop_p", 2f, -4f, -1, 134217737, 0f, false, false, false);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
			AUDIO::STOP_SCRIPTED_CONVERSATION(unk_0x9B0761B4C3EB8BC7(), iLocal_87);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
			ENTITY::FREEZE_ENTITY_POSITION(unk_0x9B0761B4C3EB8BC7(), false, 0);
		}
		iLocal_75 = 1;
	...
	if ((iLocal_47 == 1 && MISC::IS_BIT_SET(bLocal_106)) || iLocal_47 == 2)
	{
		SYSTEM::SETTIMERA(0);
		iLocal_45 = 1;
	}
...
void func_159()
{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (func_160())
		{
			if (unk_0x1037B9D45CE6B788(bLocal_104, -828.3692f, -194.4669f, 36.41385f, -824.5801f, -201.1353f, 39.39436f, 4.3125f, 0, 1, 0))
			{
		...
		bLocal_106 = VEHICLE::CREATE_VEHICLE(iVar0, Local_105, 31.9252f, true, true, false);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_106, true, 1);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_106, 5f);
		VEHICLE::SET_VEHICLE_ENGINE_ON(bLocal_106, true, true, false);
		bLocal_115 = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_106, 26, joaat("g_m_y_korean_01"), -1, true, true);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_115, 1.87774E-43f, 1);
		PED::_0x2208438012482A1A(bLocal_115, 1);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_115, iLocal_119);
		PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_115, 8, false);
		PED::SET_PED_COMBAT_ABILITY(bLocal_115, 0);
		PED::SET_PED_ACCURACY(bLocal_115, 13);
		unk_0x92BD213E6A0E666B(bLocal_115, joaat("weapon_pistol"), -1, 1, 1);
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(bLocal_115, true, 0f);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(bLocal_115, 5.885454E-44f, 1);
		iLocal_107 = 1;
	}
}
...
int func_160()
{
	...
	{
		if (unk_0xC2169C00B643278B(bVar0, -829.3693f, -191.9869f, 36.4616f, 15f, 15f, 5f, 0, 1, 0))
		{
			bLocal_104 = bVar0;
			if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(bLocal_104))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_104, true, false);
			}
			return 1;
		}
	}
...
int func_172()
{
	...
	if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -823.1281f, -187.9591f, 36.6189f, 12f, 12f, 12f, 0, 1, 0) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -1201.017f, -777.5527f, 16.3398f, 12f, 12f, 12f, 0, 1, 0))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[1]))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_66[0], unk_0x9B0761B4C3EB8BC7(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_66[1], unk_0x9B0761B4C3EB8BC7(), true))
			{
				return 1;
			}
			if (PED::CAN_PED_SEE_HATED_PED(iLocal_66[0], unk_0x9B0761B4C3EB8BC7()) || PED::CAN_PED_SEE_HATED_PED(iLocal_66[1], unk_0x9B0761B4C3EB8BC7()))
			{
	...
	if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_66[0], 0) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(iLocal_66[1], 0))
	{
		return 1;
	}
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0) && func_170())
	{
		return 1;
	}
	if (MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7()) && func_170())
	{
		return 1;
	}
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[1]))
	{
		if (((PED::IS_PED_SHOOTING_IN_AREA(unk_0x9B0761B4C3EB8BC7(), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_66[1], 1) - Vector(12f, 12f, 12f), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_66[1], 1) + Vector(12f, 12f, 12f), false, true) && !WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_BULLET_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_66[0], 1), 3f, true)) || MISC::IS_BULLET_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iLocal_66[1], 1), 3f, true))
		{
			return 1;
		}
	}
	...
	while (iVar0 < iLocal_67)
	{
		if (MISC::IS_BIT_SET(iLocal_67[iVar0]))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_67[iVar0], unk_0x9B0761B4C3EB8BC7(), true))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_68)
	{
		if (MISC::IS_BIT_SET(iLocal_68[iVar0]))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_68[iVar0], unk_0x9B0761B4C3EB8BC7(), true))
			{
				return 1;
			}
		}
...
void func_178()
{
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		...
		PED::_0x2208438012482A1A(iLocal_66[iVar0], 1);
		...
		unk_0x92BD213E6A0E666B(iLocal_66[iVar0], joaat("weapon_pistol"), -1, 1, 1);
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_66[iVar0], true, 0f);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_66[iVar0], 5.885454E-44f, 1);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_66[iVar0], 3.769493E-43f, 1);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_66[iVar0], 2.634441E-43f, 1);
	...
	bLocal_102 = OBJECT::CREATE_OBJECT(iLocal_117, Local_57, true, true, false);
	if (iLocal_47 == 1)
	{
		PATHFIND::SET_ROADS_IN_AREA(Local_71 - Vector(20f, 20f, 20f), Local_71 + Vector(20f, 20f, 20f), false, true, 1, 1);
		...
		ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_102, iLocal_135, "robbery_intro_loop_bag", "random@shop_robbery", 1000f, 8f, 0, 1000f);
		iVar0 = 0;
		while (iVar0 <= (iLocal_64 - 1))
		{
			...
			PED::_0x2208438012482A1A(iLocal_67[iVar0], 1);
			PED::SET_PED_CAN_BE_TARGETTED(iLocal_67[iVar0], false);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_67[iVar0], 3.769493E-43f, 1);
			iVar0++;
		}
		...
		PED::_0x2208438012482A1A(iLocal_68[0], 1);
		PED::SET_PED_CAN_BE_TARGETTED(iLocal_68[0], false);
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_68[0], 3.769493E-43f, 1);
		iVar0 = 1;
		while (iVar0 <= 2)
		{
			...
			PED::_0x2208438012482A1A(iLocal_68[iVar0], 1);
			PED::SET_PED_CAN_BE_TARGETTED(iLocal_68[iVar0], false);
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_68[iVar0], 3.769493E-43f, 1);
			iVar0++;
		}
		...
		PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(-871f, -246f, 0f, -798f, -163f, 50f, 0, 1);
	...
	{
		PATHFIND::SET_ROADS_IN_AREA(Local_72 - Vector(20f, 20f, 20f), Local_72 + Vector(20f, 20f, 20f), false, true, 1, 1);
		ENTITY::DETACH_ENTITY(bLocal_102, Local_58, 2, 1);
...
void func_184()
{
	if (!iLocal_74)
	{
		bLocal_88 = CUTSCENE::IS_CUTSCENE_PLAYING(Local_51[0 /*3*/]);
		INTERIOR::PIN_INTERIOR_IN_MEMORY(bLocal_88);
		iLocal_74 = 1;
	}
}
...
void func_185()
{
	...
	if ((((((((((ENTITY::DOES_ENTITY_EXIST(iLocal_138) && ENTITY::DOES_ENTITY_EXIST(iLocal_139)) && ENTITY::DOES_ENTITY_EXIST(iLocal_140)) && ENTITY::DOES_ENTITY_EXIST(iLocal_141)) && ENTITY::DOES_ENTITY_EXIST(joaat("prop_anim_cash_pile_01"))) && ENTITY::DOES_ENTITY_EXIST(joaat("prop_cs_duffel_01"))) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("re_shoprobbery")) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("re_shoprobbery2")) && STREAMING::HAS_ANIM_DICT_LOADED("random@robbery")) && STREAMING::HAS_ANIM_DICT_LOADED("random@shop_robbery")) && AUDIO::PREPARE_MUSIC_EVENT("RE51A_SHOP"))
	{
		iLocal_49 = 1;
	}
	else
...
int func_187()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_198())
		{
			return 0;
		}
	}
...
void func_210(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = (iVar4 + func_90(fVar0, iVar1));
		iVar3 = (iVar3 - 1);
		fVar0 = SYSTEM::ROUND(func_211(SYSTEM::TO_FLOAT(fVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
		...
		if (MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0)) || func_226()) || Global_110905) || Global_30970) || func_225()) || func_131(8, -1)) || func_222()) || func_224()) || func_223()) || func_221()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_226() || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || func_131(8, -1)) || func_221()) || func_220()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(unk_0x9B0761B4C3EB8BC7(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !GRAPHICS::DRAW_SCALEFORM_MOVIE()) || ENTITY::IS_ENTITY_IN_AIR(unk_0x9B0761B4C3EB8BC7())) || MISC::IS_PC_VERSION(unk_0x9B0761B4C3EB8BC7())) || PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_226()) || func_223()) || Global_110905) || Global_30970) || func_225()) || Global_42801) || func_131(8, -1)) || func_222()) || func_220()) || func_221()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_236()
{
	...
	if (iLocal_142)
	{
		...
		while (iVar0 <= (iLocal_63 - 1))
		{
			if (MISC::IS_BIT_SET(iLocal_66[iVar0]))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_66[iVar0]) && !SYSTEM::VDIST(iLocal_66[iVar0], 0))
				{
		...
		while (iVar0 <= (iLocal_65 - 1))
		{
			if (MISC::IS_BIT_SET(iLocal_68[iVar0]))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_68[iVar0]))
				{
					...
					{
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_68[iVar0]);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 0.25f, false, 40000f);
					}
					TASK::TASK_SMART_FLEE_COORD(0, Local_59, 150f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
					AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_68[iVar0], iLocal_87);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
					PED::SET_PED_KEEP_TASK(iLocal_68[iVar0], true);
				}
			}
		...
		while (iVar0 <= (iLocal_64 - 1))
		{
			if (MISC::IS_BIT_SET(iLocal_67[iVar0]))
			{
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(iLocal_67[iVar0]))
				{
					PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(iLocal_67[iVar0], 4.442116E-43f, 1);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_67[iVar0], true, 1);
					if (iVar0 == 0)
					{
						if (!iLocal_114)
						{
							HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iLocal_67[iVar0]);
							TASK::TASK_SMART_FLEE_COORD(iLocal_67[iVar0], Local_59, 150f, -1, false, false);
						}
						else
						{
							PED::_0x2208438012482A1A(iLocal_67[iVar0], 0);
						}
					}
					else
					{
						...
						TASK::TASK_SMART_FLEE_COORD(0, Local_59, 150f, -1, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_87);
						AUDIO::STOP_SCRIPTED_CONVERSATION(iLocal_67[iVar0], iLocal_87);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_87);
					}
					PED::_0x2208438012482A1A(iLocal_67[iVar0], 0);
		...
		if (MISC::IS_BIT_SET(bLocal_102))
		{
			...
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&bLocal_102);
		}
		if (MISC::IS_BIT_SET(bLocal_106))
		{
			STREAMING::REMOVE_ANIM_DICT(&bLocal_106);
...
Vector3 func_250()
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		fVar0 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_71, 1);
		iLocal_70 = 1;
		if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_72, 1) < fVar0)
		{
			fVar0 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), Local_72, 1);
			iLocal_70 = 2;
		}
		if (iLocal_70 == 1)
		{
