						...
						while (iVar17 < 32)
						{
							...
							if ((func_462(iVar3) && func_458(iVar3, iParam2)) && func_9(iVar3, 0, 1))
							{
								...
								*(uParam4[iVar17 /*13*/]) = { func_180(iVar3) };
								...
								if (func_439(iParam5))
								{
									func_438(iVar3, uParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar8, iVar16, iVar15, fVar10, iVar8, iVar12, &Var22, (uParam0[iVar17 /*42*/])->f_40, iVar13, bParam6);
								}
								else
								{
									func_438(iVar3, uParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar8, iVar16, iVar15, fVar10, iVar11, iVar12, &Var22, (uParam0[iVar17 /*42*/])->f_40, iVar13, bParam6);
								}
							...
							if (func_462(iVar3))
							{
								if (func_9(unk_0xF1110FE23C67293A(iVar17), 0, 1))
								{
									...
									*(uParam4[iVar17 /*13*/]) = { func_180(iVar3) };
									...
									uParam3->f_38[iVar9 /*2*/].f_1 = iVar18;
									func_418(iVar3, unk_0x72C1D3A1AB8CAA5B(iVar3), uParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar16, iVar15);
									iVar18++;
								}
							}
							iVar17++;
	...
	if (func_406(&(uParam2->f_19)) || bParam5)
	{
		...
		else
		{
			...
			if (!unk_0xCE990E643CD9D0E5(uParam2->f_33, 0))
			{
				...
				unk_0x530DC1525CA60B00(fVar4);
				if (func_505(bVar3, uParam0, 0))
				{
					func_471(uParam0, 0, 0);
					uVar1 = func_502(iParam1, &(Global_4456448.f_82715), bParam4);
					Var0 = { func_500(iParam1) };
					if (bParam4)
					{
						func_497(uParam0, uVar1, "", 0, -1, -1, 1);
					}
					else if (iParam1 == 27)
					{
					...
					else if (iParam1 == 28)
					{
						...
						func_484(uParam0, sVar6, func_485(), -1);
					}
					else if (func_424())
					{
						uParam2->f_34 = Global_1574192;
						func_497(uParam0, uVar1, &Var0, 1, -1, Global_1574192, 1);
					}
					else if (bVar2)
					{
						iVar5 = func_479(iParam1);
						uParam2->f_34 = Global_1574192;
						func_497(uParam0, uVar1, "", 0, iVar5, Global_1574192, 1);
					}
					else
					{
						iVar5 = func_479(iParam1);
						func_497(uParam0, uVar1, &Var0, 1, iVar5, -1, 1);
					}
