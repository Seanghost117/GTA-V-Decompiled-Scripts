		...
		while (iVar0 < iLocal_85)
		{
			...
			else if (!unk_0x0F1E960B06B93848(unk_0x460153A63B9477BC(), 0))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_85[iVar0]))
				{
					...
					unk_0xCBA6B2B569DCAFD8(iLocal_85[iVar0], 1);
					unk_0x2481907DEE6B85EA(&(iLocal_85[iVar0]));
				}
				if (unk_0xAE06B9E39EBDE049(uLocal_87))
				{
	...
	while (iVar1 < iLocal_84)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_84[iVar1]))
		{
			if (!unk_0x8F678487EEBD8CE4(uLocal_89[iVar1]))
			{
				...
				unk_0x9DC06E2A59C5AEBB(&uLocal_108);
				unk_0x0AB756271BADC8DF(0, 0, 0);
				unk_0x8FF9CE1C0F94F59A(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
				unk_0x19F29730874AD6F1(uLocal_108);
				unk_0x9B6EC2CECE1010EF(iLocal_84[iVar1], uLocal_108);
				unk_0x4F83FEE4454169D4(&uLocal_108);
				unk_0xCBA6B2B569DCAFD8(iLocal_84[iVar1], 1);
			}
...
int func_44(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)
{
	...
	if (unk_0xCE990E643CD9D0E5(uParam0->f_13, 26))
	{
		...
		if (!unk_0xAE06B9E39EBDE049(uParam0->f_21))
		{
			...
			iVar16 |= 16;
			iVar16 |= 8;
			uVar15 = unk_0xC2E2CC6CF95AF8A3(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), 50f, 0, iVar16);
			if (unk_0x80FF6C016CDB0FAF(uVar15, 0))
			{
				uParam0->f_21 = iVar15;
			}
		}
...
void func_65()
{
	...
	if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_86, 0))
	{
		...
		{
			iLocal_87 = unk_0xCE4780E24AFDFBF9(iLocal_83, Local_66, fLocal_68, 1, 1, 0);
			iLocal_85[0] = unk_0x6A7A2C83BD302BA4(iLocal_87, 6, iLocal_81, -1, 1, 1);
			iLocal_85[1] = unk_0x6A7A2C83BD302BA4(iLocal_87, 6, iLocal_81, 0, 1, 1);
			unk_0xDE8F8016287F771F("rghCop", &uLocal_106);
			unk_0xEFBCE8F8316F89EA(4, uLocal_106, 1862763509);
			unk_0x6673CC701BC8E9C1(iLocal_85[0], 39, 1);
			unk_0x6673CC701BC8E9C1(iLocal_85[1], 39, 1);
			iVar0 = 0;
			while (iVar0 < iLocal_85)
			{
				unk_0x92BD213E6A0E666B(iLocal_85[iVar0], joaat("weapon_pistol"), -1, 0, 1);
				unk_0x6C08F93084C348FC(iLocal_85[iVar0], 100f);
				unk_0xD3D9D7C84656DAE5(iLocal_85[iVar0], uLocal_106);
				iVar0++;
			}
		}
		iLocal_38 = 2;
			...
			while (iVar0 < iLocal_84)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_84[iVar0]))
				{
					if (!unk_0x8F678487EEBD8CE4(uLocal_89[iVar0]))
					{
						...
						unk_0x6673CC701BC8E9C1(iLocal_84[iVar0], 1, 0);
						unk_0x9DC06E2A59C5AEBB(&uLocal_108);
						unk_0x0AB756271BADC8DF(0, 0, 0);
						unk_0x8FF9CE1C0F94F59A(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
						unk_0x19F29730874AD6F1(uLocal_108);
						unk_0x9B6EC2CECE1010EF(iLocal_84[iVar0], uLocal_108);
						unk_0x4F83FEE4454169D4(&uLocal_108);
					}
				}
...
void func_67()
{
	...
	{
		if (unk_0xE0B3BC41DDA88DF0(iLocal_84[0], iLocal_86, 0))
		{
...
void func_102()
{
	...
	if (!unk_0x80FF6C016CDB0FAF(iLocal_86, 0))
	{
		iLocal_86 = unk_0xCE4780E24AFDFBF9(iLocal_82, Local_64, uLocal_67, 1, 1, 0);
		iVar0 = 1;
		while (iVar0 <= 8)
		{
			unk_0xF242CEB863060ABC(iLocal_86, iVar0, 1);
			iVar0++;
		}
		if (iLocal_79 != -1)
		{
			unk_0xF242CEB863060ABC(iLocal_86, iLocal_79, 0);
		}
	}
	...
	if (iLocal_36 != 5 && iLocal_36 != 6)
	{
		if (iLocal_36 > 6)
		{
			unk_0x52090984B5C8A3E4(iLocal_86, 0, 0, 0, 0, 1, 0, 0, 0);
			unk_0x2DB2D4C3CB88500D(-1, "BAR_DELIVER_BOOZE_RATTLE_MASTER", iLocal_86, 0, 0, 0);
		}
		func_35(sLocal_91, 7500, 1);
	}
	else
	{
		iLocal_84[0] = unk_0x6A7A2C83BD302BA4(iLocal_86, 26, iLocal_80, -1, 1, 1);
		iLocal_84[1] = unk_0x6A7A2C83BD302BA4(iLocal_86, 26, iLocal_80, 0, 1, 1);
		unk_0xDE8F8016287F771F("rghCriminal", &uLocal_107);
		unk_0xEFBCE8F8316F89EA(5, uLocal_107, 1862763509);
		iVar1 = 0;
		while (iVar1 < iLocal_84)
		{
			unk_0x4E65320BC9AD521C(iLocal_84[iVar1], 1);
			unk_0x92BD213E6A0E666B(iLocal_84[iVar1], joaat("weapon_sawnoffshotgun"), -1, 0, 1);
			unk_0xD3D9D7C84656DAE5(iLocal_84[iVar1], uLocal_107);
			iVar1++;
		}
...
void func_107()
{
	...
	else if (func_111() == 14)
	{
		...
		fVar0 = unk_0x272784C60C397DB6(Local_64, Local_65, 1);
