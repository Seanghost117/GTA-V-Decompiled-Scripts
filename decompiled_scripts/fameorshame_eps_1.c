...
void func_1(char* sParam0, float fParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	switch (iLocal_59)
	{
		...
		case 1:
			if (!CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TIME(iLocal_51, 0.2f, 0.34f, 0.410001f, 0.69f, 100, 100, 100, 255, 0);
				...
				if (bLocal_55)
				{
					...
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TIME(iLocal_52, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
				}
			}
			else
			{
...
void func_4()
{
	...
	while (iVar1 <= (16 - 1))
	{
		if (Local_22[iVar1] != -1)
		{
			if ((!unk_0xCE990E643CD9D0E5(uLocal_39, iVar1) && iVar0 >= Local_22[iVar1]) && iVar0 < Local_22.f_17[iVar1])
			{
				func_5();
				unk_0xBE20AB8238688965(&uLocal_39, iVar1);
			}
		}
		iVar1++;
	}
...
void func_8(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_13(PLAYER::PLAYER_ID())) && !func_10(PLAYER::PLAYER_ID(), 0)) && !func_9()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_13(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_18(bool bParam0)
{
	...
	while (ENTITY::IS_ENTITY_WAITING_FOR_WORLD_COLLISION(unk_0x9B0761B4C3EB8BC7()))
	{
		SYSTEM::WAIT(0);
	}
...
{
	uParam0->f_22 = 0;
	VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_47, bParam1);
...
{
	uParam0->f_22 = 0;
	VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_45, bParam1);
	if (bParam1 == 0 && uParam0->f_22 == 0)
	{
	}
}
...
void func_23(var uParam0, bool bParam1)
{
	...
	func_28(uParam0);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&uLocal_43, bParam1);
	switch (bParam1)
	{
		case 0:
...
int func_29(int iParam0, char* sParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_47(var uParam0)
{
	...
	iVar1 = func_49(uParam0->f_16);
	bVar2 = func_48(uParam0->f_16);
	iVar0 = 0;
	while (iVar0 < uParam0->f_17)
	{
		if (MISC::IS_BIT_SET(uParam0->f_17[iVar0]) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_17[iVar0], 0))
		{
			NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(uParam0->f_17[iVar0], bVar2, iVar1, -1000f);
		}
