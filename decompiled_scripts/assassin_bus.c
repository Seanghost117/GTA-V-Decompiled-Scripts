#region Local Var
	...
	int iLocal_1464 = 0;
	int iLocal_1465 = 0;
	void fLocal_1466[6] = { 0, 0, 0, 0, 0, 0 };
	void fLocal_1467 = 0;
	int iLocal_1468 = 0;
	var uLocal_1469 = 0;
	var uLocal_1470 = 0;
...
void __EntryFunction__()
{
	...
	iLocal_1391 = 1;
	iLocal_1413 = -1;
	bLocal_1416 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(5, 15);
	bLocal_1421 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(5, 10);
	iLocal_1426 = 1000;
	fLocal_1434 = 0.5f;
	fLocal_1438 = 15f;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3))
	{
		...
		func_542();
		func_540();
		if (MISC::IS_BIT_SET(bLocal_1348))
		{
			ENTITY::SET_ENTITY_VISIBLE(bLocal_1348, true, false);
			ENTITY::SET_ENTITY_COLLISION(bLocal_1348, true, false);
			ENTITY::SET_ENTITY_CAN_BE_DAMAGED(bLocal_1348, true);
		}
		func_539();
	...
	fLocal_1495 = func_529(Vector(28.3097f, -764.507f, 305.0073f) + Vector(2f, 2f, 2f), Vector(28.3097f, -764.507f, 305.0073f) - Vector(2f, 2f, 2f));
	fLocal_1496 = func_529(Vector(28.5672f, -1067.149f, 355.6028f) + Vector(2f, 2f, 2f), Vector(28.5672f, -1067.149f, 355.6028f) - Vector(2f, 2f, 2f));
	func_528();
	iLocal_1328 = 3;
	...
	if (func_531())
	{
		...
		if (iLocal_1432 == 0)
		{
			if (bLocal_1400)
			{
				...
				bVar0 = func_492(Local_1451, fLocal_1452);
	...
	while (true)
	{
		...
		if (func_487(&uScriptParam_1911))
		{
			if (func_486())
			{
				func_542();
				func_485(&Local_983);
				func_484(fLocal_1495, Vector(28.3097f, -764.507f, 305.0073f) + Vector(2f, 2f, 2f), Vector(28.3097f, -764.507f, 305.0073f) - Vector(2f, 2f, 2f));
				func_484(fLocal_1496, Vector(28.3097f, -764.507f, 305.0073f) + Vector(2f, 2f, 2f), Vector(28.3097f, -764.507f, 305.0073f) - Vector(2f, 2f, 2f));
				func_483();
				PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_1466[0], 0);
				PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_1466[1], 0);
				PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_1466[2], 0);
				PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_1466[3], 0);
				PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_1466[4], 0);
				PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_1466[5], 0);
		...
		else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			if (func_169(&uScriptParam_1911, &Local_983))
			{
				...
				bLocal_132 = Global_111858.f_19959.f_8;
				func_164();
				func_114();
	...
	switch (iLocal_982)
	{
		case 0:
			if (!iLocal_137)
			{
				...
				bLocal_132 = func_165(&iLocal_976);
				func_106();
				iLocal_137 = 1;
				iLocal_982 = 1;
			}
...
void func_106()
{
	...
	if (!iLocal_137)
	{
		...
		if (Global_93132)
		{
			func_111(&uLocal_148, 6, &(Local_725.f_12), "MTPHPERSKI", SYSTEM::FLOOR(bLocal_132), 0, 3, 0);
		...
		else
		{
			if (bLocal_136)
			{
				func_111(&uLocal_148, 6, &(Local_725.f_12), "MTPHPERRET", SYSTEM::FLOOR(bLocal_132), 0, 3, 0);
			}
			else
			{
				func_111(&uLocal_148, 9, &(Local_725.f_12), "", SYSTEM::FLOOR(bLocal_132), 0, 0, 0);
			}
			if (!CAM::IS_SCREEN_FADED_OUT(&(Local_725.f_18)))
			{
				if (bLocal_135)
				{
		...
		if (iVar0 == 1)
		{
			bLocal_143 = 50;
			bLocal_144 = true;
			func_109(&uLocal_148, 1, &(Local_725.f_48), bLocal_143, 0, 0, 1, 0);
		}
		else if (bLocal_135)
		{
			if (bLocal_136)
			{
				bLocal_143 = 75;
				bLocal_144 = 2;
				func_109(&uLocal_148, 1, &(Local_725.f_42), bLocal_143, 0, 0, 2, 0);
			}
			else
			{
				bLocal_143 = 100;
				bLocal_144 = 3;
				func_109(&uLocal_148, 1, &(Local_725.f_36), bLocal_143, 0, 0, 3, 0);
			}
		}
...
void func_107()
{
	...
	{
		func_108(38, SYSTEM::FLOOR(bLocal_132), 1);
		if (bLocal_135)
		{
			func_108(39, 1, 1);
		}
		...
		func_108(41, bLocal_143, 1);
		func_108(42, bLocal_144, 1);
	}
	else if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("assassin_multi")) == 1)
	{
		func_108(52, SYSTEM::FLOOR(bLocal_132), 1);
		if (bLocal_135)
		{
			func_108(53, 1, 1);
		}
		...
		func_108(54, bLocal_143, 1);
		func_108(55, bLocal_144, 1);
	}
	else if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("assassin_hooker")) == 1)
	{
		func_108(66, SYSTEM::FLOOR(bLocal_132), 1);
		if (bLocal_135)
		{
			func_108(67, 1, 1);
		}
		...
		func_108(69, bLocal_143, 1);
		func_108(70, bLocal_144, 1);
	}
	else if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("assassin_bus")) == 1)
	{
		func_108(81, SYSTEM::FLOOR(bLocal_132), 1);
		if (bLocal_135)
		{
			func_108(82, 1, 1);
		}
		...
		func_108(84, bLocal_143, 1);
		func_108(85, bLocal_144, 1);
	}
	else if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("assassin_construction")) == 1)
	{
		func_108(97, SYSTEM::FLOOR(bLocal_132), 1);
		if (bLocal_135)
		{
			func_108(98, 1, 1);
		}
		...
		func_108(100, bLocal_143, 1);
		func_108(101, bLocal_144, 1);
	}
}
...
void func_114()
{
	if (MISC::IS_BIT_SET(bLocal_1463) && ENTITY::GET_ENTITY_COORDS(bLocal_1463, false))
	{
		func_115(bLocal_1463, -25.2554f, -1438.239f, 29.6542f, 2.31f, 24, 0);
	}
}

void func_115(bool bParam0, struct<3> Param1, bool bParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (MISC::IS_BIT_SET(bParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		func_150(iParam3, &Var0, Param1, bParam2, func_156(bParam0));
		func_116(iParam3, bParam0, 0);
	}
}
...
void func_117(bool bParam0, int iParam1)
{
	...
	func_158(bParam0, &(Global_111858.f_32745.f_5510));
}

int func_118(bool bParam0)
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_133(bParam0, 0, 0)) || func_133(bParam0, 1, 0)) || func_133(bParam0, 2, 0)) || func_156(bParam0) != 145) || func_132(bParam0)) || func_131(bParam0)) || func_130(bParam0)) || func_129(bParam0)) || !func_119(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_131(bParam0))
		{
		}
		...
		if (func_133(bParam0, 0, 0))
		{
		}
		if (func_133(bParam0, 1, 0))
		{
		}
		if (func_133(bParam0, 2, 0))
		{
		}
		if (func_156(bParam0) != 145)
		{
		}
		return 0;
	}
...
int func_119(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_120(fParam0, 0))
	{
		return 0;
	}
...
int func_120(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
int func_133(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
var func_141(bool bParam0)
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_142(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
void func_150(int iParam0, var uParam1, struct<3> Param2, bool bParam3, int iParam4)
{
	if (func_147(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
void func_158(bool bParam0, var uParam1)
{
	int iVar0;
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_160(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
void func_164()
{
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 <= 2)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Local_1898[iVar0 /*30*/].f_14[iVar1]) && SYSTEM::VDIST(Local_1898[iVar0 /*30*/].f_14[iVar1], 0))
			{
...
int func_169(var uParam0, int* iParam1)
{
	...
	switch (iLocal_980)
	{
		...
		case 7:
			...
			func_365(iParam1);
			func_364();
			if ((((PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && func_363(iParam1->f_1, 1) < fLocal_1438) || !func_362(iParam1->f_1)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, uParam0->f_9, 25f)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam1->f_1, unk_0x9B0761B4C3EB8BC7(), true))
			{
...
int func_174(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (MISC::SET_BIT())
	{
		if (func_176() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_19(func_175(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
void func_201(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
int func_202(int* iParam0)
{
	...
	{
		case 0:
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0->f_1, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
			{
		...
		case 1:
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0->f_1, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iParam0->f_1, 0))
				{
					Var1 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0->f_1, 0) };
			...
			else if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && MISC::IS_BIT_SET(iParam0->f_1))
			{
				if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iParam0->f_1, 0))
				{
					Var1 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0->f_1, 0) };
...
void func_204(bool bParam0, bool bParam1)
{
	...
	{
		bVar0 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 8);
		bVar1 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 2);
		if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
		{
			bVar2 = MISC::IS_MINIGAME_IN_PROGRESS(bParam0, bVar0, 0);
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar2))
			{
				if (!bParam1)
				{
					if (bVar1 == 0)
					{
						AUDIO::PLAY_PAIN(bVar2, 6, 0, 0);
					}
					else if (bVar1 == 1)
					{
						AUDIO::PLAY_PAIN(bVar2, 7, 0, 0);
					}
					else if (bVar1 == 2)
					{
						AUDIO::PLAY_PAIN(bVar2, 3, 0, 0);
					}
				}
			}
		}
...
void func_206(int* iParam0)
{
	...
	else if (ENTITY::GET_ENTITY_COORDS(iParam0->f_1, false))
	{
		if (MISC::IS_BIT_SET(*iParam0))
		{
			if (MISC::IS_BIT_SET(iParam0->f_8))
			{
				if (ENTITY::GET_ENTITY_COORDS(iParam0->f_8, false) && unk_0xE0B3BC41DDA88DF0(*iParam0, iParam0->f_8, 0))
				{
...
void func_207(var uParam0, int* iParam1)
{
	...
	switch (iLocal_1345)
	{
		...
		case 2:
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam1->f_1, unk_0x9B0761B4C3EB8BC7(), true))
			{
				func_352(Local_1346, uParam0, 2);
				return;
			}
			...
			if (func_165(&iLocal_1483) > 5f)
			{
				if (iLocal_1382)
				{
					if (ENTITY::GET_ENTITY_COORDS(iParam0->f_1, false))
					{
						if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iParam0->f_1, 0))
						{
							bVar0 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0->f_1);
							if (bVar0 > 10f)
							{
								if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(*iParam0))
								{
									if (func_165(&iLocal_1474) >= IntToFloat(bLocal_1416) && func_363(*iParam0, 1) <= 50f)
									{
										if (ENTITY::GET_ENTITY_COORDS(iParam0->f_8, false))
										{
									...
									else if (func_165(&iLocal_1477) >= IntToFloat(bLocal_1421))
									{
										func_216(iParam0);
									}
								}
...
void func_210(var uParam0)
{
	if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
		if (func_168(&iLocal_1477))
		{
			if (!func_221())
			{
				if (ENTITY::GET_ENTITY_COORDS(uParam0->f_1, false))
				{
	...
	if (iLocal_1424 > 0)
	{
		switch (iLocal_1419)
		{
			case 0:
				...
				if (iVar0 == 0)
				{
					if (func_213(uParam0, bLocal_1453))
					{
						func_201(&(uParam0->f_16), 4, bLocal_1453, "BusPed1", 0, 1);
						func_212(&(uParam0->f_16), "OJASAUD", "OJASbs_DMG", 9, 0, 0, 0);
						iLocal_1425 = iLocal_1424;
						iLocal_1419++;
					}
				}
				else if (func_213(uParam0, bLocal_1455))
				{
					func_201(&(uParam0->f_16), 6, bLocal_1455, "BusPed3", 0, 1);
			...
			case 1:
				...
				{
					if (func_213(uParam0, bLocal_1454))
					{
						func_201(&(uParam0->f_16), 5, bLocal_1454, "BusPed2", 0, 1);
...
{
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam1) && unk_0xE0B3BC41DDA88DF0(bParam1, uParam0->f_1, 0))
	{
		return 1;
	}
	return 0;
...
void func_214(var uParam0)
{
	...
	{
		case 0:
			if (STATS::_GET_NGSTAT_BOOL_HASH(uParam0->f_1) >= 2)
			{
		...
		case 3:
			if (!func_221())
			{
				...
				{
					if (func_213(uParam0, bLocal_1455))
					{
						func_201(&(uParam0->f_16), 6, bLocal_1455, "BusPed3", 0, 1);
...
void func_215(var uParam0)
{
	...
	else if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(*uParam0))
	{
		if (!SYSTEM::VDIST(*uParam0, 0))
		{
			if (func_165(&iLocal_1474) >= IntToFloat(bLocal_1416))
			{
...
void func_216(var uParam0)
{
	if (func_168(&iLocal_1477))
	{
		if (ENTITY::GET_ENTITY_COORDS(uParam0->f_1, false))
		{
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), uParam0->f_1, 0))
			{
				if (func_165(&iLocal_1477) >= IntToFloat(bLocal_1421))
				{
					switch (iLocal_1417)
					{
						case 0:
						...
						case 3:
							if (func_213(uParam0, bLocal_1453))
							{
								func_201(&(uParam0->f_16), 6, bLocal_1453, "BusPed3", 0, 1);
...
{
	bLocal_1421 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(iParam0, iParam1);
	func_183(&iLocal_1477);
	func_183(&iLocal_1483);
	iLocal_1417++;
}
...
{
	bLocal_1416 = NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(iParam0, iParam1);
	func_183(&iLocal_1474);
	func_183(&iLocal_1483);
	iLocal_1415++;
}
...
void func_222(var uParam0, int* iParam1)
{
	if (iLocal_1345 < 4)
	{
		...
		if (!bLocal_1378)
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam1->f_1, 0))
			{
				Local_1447 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1->f_1, 1) };
			}
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				Local_1448 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1) };
			}
...
int func_225(bool bParam0, float fParam1, float fParam2)
{
	bool bVar0;
	float fVar1;
	...
	if (MISC::IS_BIT_SET(bParam0))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
		{
			...
			else if (func_363(bParam0, 1) > fParam1)
			{
...
void func_226(var uParam0, int* iParam1)
{
	if (!iLocal_1377 == 1)
	{
		if (iLocal_1345 < 4)
		{
			if (((((func_235(*iParam1, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1) || func_233(&uLocal_1414)) || iLocal_1424 >= 2) || AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0) || !ENTITY::GET_ENTITY_COORDS(iParam1->f_1, false)) || func_232(*iParam1, iParam1->f_8, 1097859072))
			{
				if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) > 0)
				{
				}
				...
				if (ENTITY::GET_ENTITY_COORDS(iParam1->f_1, false))
				{
					if (MISC::IS_BIT_SET(*iParam1))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(*iParam1))
						{
							if (func_363(*iParam1, 1) < 30f || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(*iParam1, unk_0x9B0761B4C3EB8BC7(), true))
							{
								func_224();
								if (SYSTEM::VMAG(iParam1->f_2))
								{
...
{
	TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(bParam0, iParam1, "OJASbs_102", 52, 0, 20, -1, -1f, false, 2f);
...
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_1, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_8, 0))
	{
		if (ENTITY::GET_ENTITY_COORDS(uParam0->f_1, false))
		{
			if (ENTITY::GET_ENTITY_COORDS(uParam0->f_8, false))
			{
...
float func_231(bool bParam0, struct<3> Param1, int iParam2)
{
...
int func_232(bool bParam0, bool bParam1, float fParam2)
{
	if (MISC::IS_BIT_SET(bParam1))
	{
		if (ENTITY::GET_ENTITY_COORDS(bParam1, false))
		{
			...
			else if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(unk_0x9B0761B4C3EB8BC7(), bParam1))
			{
				return 1;
			}
		}
...
int func_233(var uParam0)
{
	...
	if (*uParam0 == 0)
	{
		bVar0 = Local_1898[iVar1 /*30*/].f_14[0];
	}
	else if (*uParam0 == 1)
	{
		bVar0 = Local_1898[iVar1 /*30*/].f_14[1];
	}
	else if (*uParam0 == 2)
	{
		bVar0 = Local_1898[iVar1 /*30*/].f_14[2];
	}
	if (MISC::IS_BIT_SET(bVar0))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar0))
		{
			if (func_235(bVar0, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1) || func_234())
			{
				return 1;
			}
		}
...
int func_234()
{
	if (bLocal_1378)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()) && !WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(unk_0x9B0761B4C3EB8BC7()))
				{
					return 1;
				}
			}
...
int func_235(bool bParam0, bool bParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	bool bVar0;
	bool bVar1;
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar0, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0))
	{
		...
		{
			if (func_239(bVar0, bParam0, uParam2, bParam5))
			{
				*uParam3 = 4;
				return 1;
			}
		...
		{
			if (func_238(bVar0, bParam0, uParam2))
			{
				*uParam3 = 8;
				return 1;
			}
		...
		if (bParam4)
		{
			if (func_236(bParam0, bParam1, 1, bParam6, bVar1, 1))
			{
				*uParam3 = 32;
				return 1;
			}
		...
		{
			if (func_236(bParam0, bParam1, 0, bParam6, bVar1, bParam8))
			{
				*uParam3 = 16;
				return 1;
			}
...
int func_236(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	bool bVar0;
	bool bVar1;
	...
	if (func_237(unk_0x9B0761B4C3EB8BC7(), bParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (MISC::IS_PC_VERSION(bParam0) && func_363(bParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_238(bool bParam0, bool bParam1, var uParam2)
{
...
int func_239(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	struct<3> Var0;
	bool bVar1;
	...
	if (WEAPON::IS_PED_ARMED(bParam0, 2))
	{
		...
		else
		{
			...
			if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(bParam0) || func_240(bVar1))
			{
				if (unk_0xC2169C00B643278B(bParam1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam1), bParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam1, bParam0, 17))
		...
		if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
		{
			if (MISC::IS_MINIGAME_IN_PROGRESS(bParam0, -1, 0) != 0)
			{
				if (MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(unk_0x9B0761B4C3EB8BC7(), &iVar0, 1))
				{
					...
					{
						if (func_241(unk_0x9B0761B4C3EB8BC7(), bParam0, 1) < 40f)
						{
...
float func_241(bool bParam0, bool bParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_242(bool bParam0, var uParam1)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0))
	{
		if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), bParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bParam0))
			{
				...
				{
					if (func_363(bParam0, 1) < uParam1->f_2)
					{
						if (uParam1->f_1 == 0)
						{
	...
	if (!SYSTEM::VMAG(uParam0->f_2))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(*uParam0))
		{
			if (iParam1 || !func_221())
			{
				...
				uParam0->f_2 = TASK::IS_PED_SPRINTING(*uParam0);
...
void func_246(var uParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_247(uParam0, bParam1, bParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_247(var uParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
	func_248(uParam0, bParam1, 0f, 0f, 0f, bParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_248(var uParam0, bool bParam1, struct<3> Param2, bool bParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	uParam0->f_6 = 2;
	func_249(uParam0, bParam1, Param2, bParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_249(var uParam0, bool bParam1, struct<3> Param2, bool bParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	bool bVar0;
	int iVar1;
	...
	if (func_272(bParam1) && ENTITY::IS_ENTITY_VISIBLE(bParam1))
	{
		iVar1 = 0;
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_264(uParam0, bParam1, Param2, iParam4);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_254(bool bParam0)
{
	if (!func_255(1, 1, 0))
	{
		if ((!CAM::IS_SCREEN_FADED_OUT(bParam0) && func_274(bParam0)) || func_274("CMN_HINT"))
		{
			unk_0xD289B55B6AADBA10(1);
		}
		return 0;
...
int func_255(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_262() || func_261(Global_4456448.f_129348)) || func_260())
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(bVar0, iVar1) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("apc") && iVar1 != -1)) || (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("akula") && iVar1 != -1)) || (((MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("riot2") && iVar1 == 0) && func_258(bVar0, 10)) && unk_0x7F8B14CBFB9813E5(bVar0, 10) != -1))
			{
				return 0;
			}
		}
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		if (SYSTEM::VDIST(bParam0, iParam1))
		{
			...
			if (MISC::IS_BIT_SET(bVar0))
			{
				...
				{
					bVar3 = (iVar2 - 1);
					if (!SYSTEM::VDIST2(bVar0, bVar3, 0))
					{
						if (MISC::IS_MINIGAME_IN_PROGRESS(bVar0, bVar3, 0) == bParam0)
						{
							return bVar3;
						}
					}
...
void func_264(var uParam0, bool bParam1, struct<3> Param2, int iParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_267(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_270(bParam1, bParam2, bParam3) || SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 1) || func_268(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_275(bool bParam0, bool bParam1, var uParam2)
{
	if (ENTITY::GET_ENTITY_COORDS(bParam1, false))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0))
		{
			if (SYSTEM::VDIST(bParam0, 0))
			{
				if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(bParam1))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, 451360105) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bParam0, 451360105) != 0)
					{
						TASK::TASK_LEAVE_VEHICLE(bParam0, bParam1, 0);
					}
				}
				else
				{
			...
			else if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, 713668775) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bParam0, -1794415470) != 1)
			{
				func_276(bParam0);
			}
		}
...
void func_276(bool bParam0)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bParam0, 0))
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, 242628503) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bParam0, 242628503) != 0)
		{
			if (func_231(bParam0, Local_1440, 1) <= 50f)
			{
			...
			{
				TASK::TASK_SMART_FLEE_PED(bParam0, unk_0x9B0761B4C3EB8BC7(), 500f, -1, false, false);
			}
			iLocal_1345 = 6;
		}
	}
...
void func_278(bool bParam0, bool bParam1)
{
	...
	{
		fVar0 = func_363(bParam0, 1);
		if (MISC::IS_BIT_SET(bParam0) && ENTITY::GET_ENTITY_COORDS(bParam1, false))
		{
			if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(bParam1))
			{
				if (fVar0 > 150f)
				...
				iVar1 = TASK::GET_VEHICLE_WAYPOINT_PROGRESS(bParam1);
				...
				if (fLocal_1436 != 0f)
				{
					TASK::SET_DRIVE_TASK_CRUISE_SPEED(bParam0, fLocal_1436);
				}
			}
		}
	}
...
void func_279()
{
	if (!iLocal_1396)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_1498))
		{
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_1498);
			TASK::TASK_PLAY_ANIM(bLocal_1498, "oddjobs@assassinate@bus@", "looking_for_help", 8f, -8f, -1, 1, 0f, false, false, false);
			AUDIO::PLAY_PAIN(bLocal_1498, 6, 0, 0);
			iLocal_1396 = 1;
		}
	}
	else if (MISC::IS_BIT_SET(bLocal_1498))
	{
		if (func_235(bLocal_1498, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1))
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_1498, 1805844857) != 1)
			{
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_1498);
				TASK::TASK_SMART_FLEE_PED(bLocal_1498, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, false);
			}
		}
		if (func_363(bLocal_1498, 1) > 100f)
		{
			if (!ENTITY::IS_ENTITY_ON_SCREEN(bLocal_1498) || ENTITY::IS_ENTITY_OCCLUDED(bLocal_1498))
			{
				PED::DELETE_PED(&bLocal_1498);
			}
		}
	}
}
	...
	switch (iLocal_1412)
	{
		case 0:
			if (func_300(1, 3f))
			{
				...
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam1->f_1, 0))
				{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(*uParam0, "Mugger", 0, MISC::GET_MODEL_DIMENSIONS(*uParam0), 0);
				}
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_1498, 0))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_1498, "Mugging_Victim", 0, joaat("a_f_o_genstreet_01"), 0);
				}
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam1->f_1, 0))
				{
					if (bLocal_1399)
					{
						...
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(false, "Franklins_Bus", 3, joaat("bus"), 0);
					}
					else
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uParam1->f_1, "Franklins_Bus", 0, joaat("bus"), 0);
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(false, "Franklins_Coach", 3, joaat("coach"), 0);
					}
				}
		...
		case 1:
			if (OBJECT::ADD_DOOR_TO_SYSTEM())
			{
				...
				if ((MISC::IS_BIT_SET(*uParam0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(*uParam0)) && ENTITY::GET_ENTITY_COORDS(uParam1->f_8, false))
				{
				...
				{
					if (MISC::IS_BIT_SET(bLocal_1498) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bLocal_1498))
					{
						func_279();
					}
				}
				...
				{
					if (((MISC::IS_BIT_SET(unk_0x9B0761B4C3EB8BC7()) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7())) && MISC::IS_BIT_SET(uParam1->f_1)) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam1->f_1, 0))
					{
						PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), uParam1->f_1, -1);
			...
			if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(*uParam0))
				{
					if (MISC::IS_BIT_SET(uParam1->f_8) && ENTITY::GET_ENTITY_COORDS(uParam1->f_8, false))
					{
					...
					else
					{
						...
						else if (!ENTITY::GET_ENTITY_COORDS(uParam1->f_8, false))
						{
						}
						TASK::TASK_SMART_FLEE_PED(*uParam0, unk_0x9B0761B4C3EB8BC7(), 500f, -1, false, false);
					}
				}
				func_228(uParam1, &(uParam1->f_8));
				CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
				func_284(1, 1, 1);
				ENTITY::SET_ENTITY_COORDS(uParam1->f_1, 0);
...
void func_282(bool bParam0, bool bParam1)
{
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		VEHICLE::SET_VEHICLE_DOOR_SHUT(bParam0, 1, bParam1);
		VEHICLE::SET_VEHICLE_DOOR_SHUT(bParam0, 0, bParam1);
	}
}
...
void func_283(bool bParam0, int iParam1)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		...
		while (iVar0 <= 2)
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Local_1898[iParam1 /*30*/].f_14[iVar0]))
			{
				if (iVar0 == 0)
				{
				...
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_1898[iParam1 /*30*/].f_14[iVar0]);
				TASK::OPEN_SEQUENCE_TASK(&iVar1);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, bParam0, 0);
				TASK::TASK_PLAY_ANIM(false, "misscommon@response", sVar2, 8f, -8f, -1, 0, 0f, false, false, false);
				TASK::TASK_WANDER_STANDARD(0, 40000f, 0);
				TASK::CLOSE_SEQUENCE_TASK(iVar1);
				AUDIO::STOP_SCRIPTED_CONVERSATION(Local_1898[iParam1 /*30*/].f_14[iVar0], iVar1);
...
void func_286(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_290(PLAYER::PLAYER_ID())) && !func_288(PLAYER::PLAYER_ID(), 0)) && !func_287()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_290(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_294(int iParam0, int iParam1)
{
	...
	if (iParam1 == 1)
	{
		if ((iLocal_1499 != 0 && iLocal_1499 != joaat("object")) && iLocal_1499 != joaat("gadget_parachute"))
		{
			...
			{
				ENTITY::SET_ENTITY_HEALTH(unk_0x9B0761B4C3EB8BC7(), iLocal_1499, 0);
			}
		}
	}
}
...
void func_295(struct<3> Param0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			...
			if (func_349(unk_0x9B0761B4C3EB8BC7()))
			{
				iLocal_1499 = WEAPON::GET_SELECTED_PED_WEAPON(unk_0x9B0761B4C3EB8BC7());
...
void func_298(bool bParam0)
{
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		if (!bLocal_1399)
		{
			VEHICLE::SET_VEHICLE_DOOR_OPEN(bParam0, 1, false, false);
		}
		VEHICLE::SET_VEHICLE_DOOR_OPEN(bParam0, 0, false, false);
	}
}
...
int func_300(int iParam0, float fParam1)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (!func_303(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
		{
			iVar0 = 0;
		}
		if (!VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0)))
		{
			iVar0 = 0;
		}
	}
...
int func_303(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
	MONEY::NETWORK_MONEY_CAN_BET(0, 71, true);
	MONEY::NETWORK_MONEY_CAN_BET(0, 72, true);
	MONEY::NETWORK_MONEY_CAN_BET(0, 76, true);
...
void func_307(var uParam0, var uParam1)
{
	...
	if (iVar0 == 3)
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_1, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
		{
	...
	if (iLocal_1391)
	{
		fVar1 = ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7()) / 5f) + 6f);
	...
	if (iLocal_1391)
	{
		if (ENTITY::GET_ENTITY_COORDS(uParam0->f_1, false) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), uParam0->f_1, 0))
		{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_1, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(unk_0x9B0761B4C3EB8BC7(), uParam0->f_1))
		{
			if (Local_1898[iVar0 /*30*/])
			{
				Var3 = { PED::GET_PED_BONE_COORDS(unk_0x9B0761B4C3EB8BC7(), 31086, 0f, 0f, 0f) };
				if ((((HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Var3, Local_1898[iVar0 /*30*/].f_21, 1) <= fVar1 && PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) && STREAMING::_0x7D41E9D2D17C5B2D(iLocal_1497)) && !func_334(iVar0)) && !bLocal_1387)
				{
					iLocal_1391 = 0;
				}
				if (iLocal_1429 > 0)
...
void func_308(var uParam0, var uParam1, int iParam2)
{
	...
	PED::SET_PED_RESET_FLAG(unk_0x9B0761B4C3EB8BC7(), 287, true);
	PED::SET_PED_RESET_FLAG(unk_0x9B0761B4C3EB8BC7(), 309, true);
	switch (iLocal_1411)
	{
		case 0:
			if (Local_1898[iParam2 /*30*/])
			{
				...
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Var0, 0f, 0f, 0f, 1) > 0.23f)
				{
					bLocal_1388 = true;
				...
				else
				{
					...
					Var2 = { NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uParam0->f_1, 1) };
					bVar4 = ENTITY::IS_ENTITY_IN_WATER(uParam0->f_1);
					Var3 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Var2, bVar4, 2f, 5.6201f, 0.1098f) };
					TASK::TASK_LOOK_AT_COORD(unk_0x9B0761B4C3EB8BC7(), Var3, 5000, 0, 2);
				}
		...
		case 1:
			...
			if (func_168(&iLocal_1468))
			{
				if (func_165(&iLocal_1468) > fLocal_1437)
				{
					...
					func_323(uParam0);
					bVar1 = func_322(Local_1441, iParam2);
					if (iParam2 == 0)
					{
						...
						{
							TASK::TASK_ENTER_VEHICLE(bVar1, uParam0->f_1, 20000, 0, 2f, 258, 0);
							if (MISC::IS_BIT_SET(bVar1))
							{
								ENTITY::FREEZE_ENTITY_POSITION(bVar1, true, 0);
							}
						}
					}
					else if (iParam2 == 1)
			...
			if (iParam2 == iLocal_1413)
			{
				...
				if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(*uParam0))
				{
					if (ENTITY::GET_ENTITY_COORDS(uParam0->f_8, false))
					{
						...
						HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(*uParam0);
...
void func_309(var uParam0)
{
	...
	func_284(1, 1, 1);
	CAM::DO_SCREEN_FADE_IN(500);
	ENTITY::SET_ENTITY_COORDS(uParam0->f_1, 0);
	iLocal_1410 = 0;
...
void func_314(var uParam0, var uParam1, int iParam2)
{
	...
	if (MISC::IS_BIT_SET(Local_1898[iParam2 /*30*/].f_14[2]))
	{
	...
	if (!MISC::IS_BIT_SET(*uParam1))
	{
		...
		CAM::IS_AIM_CAM_ACTIVE(*uParam1, 175, 0);
	}
	uParam1->f_8 = Local_1898[iParam2 /*30*/].f_19;
	if (!ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, "oddjobs@assassinate@bus@", "base", 3))
	{
...
void func_315(var uParam0, var uParam1)
{
	if (!MISC::IS_BIT_SET(*uParam1))
	{
		*uParam1 = PED::CREATE_PED(4, *uParam0, uParam0->f_1, uParam0->f_4, true, true);
		...
		PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(*uParam1, 4.063766E-44f, 1);
		...
		if (uParam0->f_268)
		{
			PED::_0x2208438012482A1A(*uParam1, 1);
		}
		if (uParam0->f_269)
		{
		...
		else if (uParam0->f_274 == 1)
		{
			...
			PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(*uParam1, 1.87774E-43f, 1);
			PED::SET_PED_PLAYS_HEAD_ON_HORN_ANIM_WHEN_DIES_IN_VEHICLE(*uParam1, true);
			PED::SET_PED_MONEY(*uParam1, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(80, 100));
...
void func_316(var uParam0, int iParam1)
{
	...
	unk_0xAF7D4BF357E8B79E((Local_1898[iParam1 /*30*/].f_1 - 30f), (Local_1898[iParam1 /*30*/].f_1.f_1 - 30f), (Local_1898[iParam1 /*30*/].f_1.f_2 - 30f), (Local_1898[iParam1 /*30*/].f_1 + 30f), (Local_1898[iParam1 /*30*/].f_1.f_1 + 30f), (Local_1898[iParam1 /*30*/].f_1.f_2 + 30f), 0, 1);
	if (!MISC::IS_BIT_SET(Local_1898[iParam1 /*30*/].f_14[0]))
	{
		...
		TASK::TASK_LOOK_AT_ENTITY(Local_1898[iParam1 /*30*/].f_14[0], unk_0x9B0761B4C3EB8BC7(), -1, 2048, 4);
		...
		PED::_0x2208438012482A1A(Local_1898[iParam1 /*30*/].f_14[0], 1);
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_1898[iParam1 /*30*/].f_14[0], "PASSENGERS_Group", 0f);
	}
	if (!MISC::IS_BIT_SET(Local_1898[iParam1 /*30*/].f_14[1]))
	{
		...
		TASK::TASK_LOOK_AT_ENTITY(Local_1898[iParam1 /*30*/].f_14[1], unk_0x9B0761B4C3EB8BC7(), -1, 2048, 4);
		...
		PED::_0x2208438012482A1A(Local_1898[iParam1 /*30*/].f_14[1], 1);
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_1898[iParam1 /*30*/].f_14[1], "PASSENGERS_Group", 0f);
	}
	if (!MISC::IS_BIT_SET(Local_1898[iParam1 /*30*/].f_14[2]))
	{
		...
		TASK::TASK_LOOK_AT_ENTITY(Local_1898[iParam1 /*30*/].f_14[2], unk_0x9B0761B4C3EB8BC7(), -1, 2048, 4);
		...
		PED::_0x2208438012482A1A(Local_1898[iParam1 /*30*/].f_14[2], 1);
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_1898[iParam1 /*30*/].f_14[2], "PASSENGERS_Group", 0f);
	}
	if (iParam1 == 3)
	{
		if (!MISC::IS_BIT_SET(Local_1898[iParam1 /*30*/].f_19))
		{
...
void func_318(var uParam0)
{
	...
	while (iVar1 < 9)
	{
		if (iLocal_1423 < 4)
		{
			if (ENTITY::GET_ENTITY_COORDS(uParam0->f_1, false))
			{
				if (MISC::IS_MINIGAME_IN_PROGRESS(uParam0->f_1, iVar1, 0) != 0)
				{
					bVar0 = MISC::IS_MINIGAME_IN_PROGRESS(uParam0->f_1, bVar1, 0);
					if (iLocal_1423 == 0)
					{
						func_201(&(uParam0->f_16), 4, bVar0, "BusPed1", 0, 1);
						bLocal_1453 = bVar0;
						iLocal_1423++;
					}
					else if (iLocal_1423 == 1)
					{
						func_201(&(uParam0->f_16), 5, bVar0, "BusPed2", 0, 1);
						bLocal_1454 = bVar0;
						iLocal_1423++;
					}
					else if (iLocal_1423 == 2)
					{
						func_201(&(uParam0->f_16), 6, bVar0, "BusPed3", 0, 1);
						bLocal_1455 = bVar0;
						iLocal_1423++;
					}
					else if (iLocal_1423 == 3)
					{
						func_201(&(uParam0->f_16), 7, bVar0, "BusPed4", 0, 1);
						bLocal_1456 = bLocal_1456;
						bLocal_1456 = bVar0;
						iLocal_1423++;
					}
				}
	...
	while (iVar0 <= 2)
	{
		if (ENTITY::GET_ENTITY_COORDS(uParam0->f_1, false))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Local_1898[iParam1 /*30*/].f_14[iVar0]))
			{
				...
				if (SYSTEM::VDIST2(uParam0->f_1, iVar1, 0))
				{
					PED::SET_PED_INTO_VEHICLE(Local_1898[iParam1 /*30*/].f_14[iVar0], uParam0->f_1, bVar1);
				}
			}
		}
		iVar0++;
...
void func_320()
{
	bLocal_1498 = PED::CREATE_PED(5, joaat("a_f_o_genstreet_01"), 110.6556f, -776.3679f, 30.439f, 346.1708f, true, true);
	PED::SET_PED_COMPONENT_VARIATION(bLocal_1498, 0, 0, 0, 0);
	PED::SET_PED_COMPONENT_VARIATION(bLocal_1498, 2, 1, 2, 0);
	PED::SET_PED_COMPONENT_VARIATION(bLocal_1498, 3, 0, 2, 0);
	PED::SET_PED_COMPONENT_VARIATION(bLocal_1498, 4, 0, 0, 0);
	PED::SET_PED_COMPONENT_VARIATION(bLocal_1498, 8, 1, 2, 0);
	PED::_0x2208438012482A1A(bLocal_1498, 1);
}
...
var func_322(struct<3> Param0, int iParam1)
{
	...
	while (iVar3 <= 2)
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(Local_1898[iParam1 /*30*/].f_14[iVar3], 0))
		{
...
void func_323(var uParam0)
{
	...
	{
		iLocal_1464 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, CAM::SET_WIDESCREEN_BORDERS(), CAM::GET_FINAL_RENDERED_CAM_ROT(2), 35f, false, 2);
	}
	if (!CAM::DOES_CAM_EXIST(iLocal_1465))
	{
		iLocal_1465 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, CAM::SET_WIDESCREEN_BORDERS(), CAM::GET_FINAL_RENDERED_CAM_ROT(2), 34f, false, 2);
	}
	if (ENTITY::GET_ENTITY_COORDS(uParam0->f_1, false) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_1, 0))
	{
		if (bLocal_1398)
		{
...
void func_324(var uParam0, int iParam1)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		bVar3 = ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7());
	}
	if (bLocal_1398)
	{
		Var0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Var2, bVar3, 2.519f, 5.6f, 0.1098f) };
	...
	{
		bVar1 = func_322(Local_1441, iParam1);
	}
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar1))
	{
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(bVar1);
		unk_0x03D382CB0B44E2FC(bVar1, Var0.x, Var0.f_1, fVar4, 1, 0, 0, 1);
		ENTITY::SET_ENTITY_HEADING(bVar1, fVar5);
	}
}
...
void func_325(var uParam0, int iParam1)
{
	...
	if (iParam1 == 1)
	{
		bVar0 = func_322(360.98f, -1068.01f, 28.53f, iParam1);
	}
	else if (iParam1 == 3)
	{
		bVar0 = *uParam0;
	...
	{
		bVar0 = func_322(Local_1441, iParam1);
	}
	if (MISC::IS_BIT_SET(bVar0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bVar0, 0))
	{
		ENTITY::FREEZE_ENTITY_POSITION(bVar0, false, 0);
		if (iParam1 == 0)
		{
			PED::SET_PED_MOVEMENT_CLIPSET(bVar0, "move_m@casual@d", 0.25f);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bVar0, 305.2689f, -768.1415f, 28.17335f, 1f, 20000, 0.25f, false, 40000f);
			PED::FORCE_PED_MOTION_STATE(bVar0, -668482597, false, 0, false);
		}
		else if (iParam1 == 1)
		{
			PED::SET_PED_MOVEMENT_CLIPSET(bVar0, "move_m@casual@d", 0.25f);
			HUD::_THEFEED_DISABLE(bVar0, 358.6953f, -1065.935f, 28.39328f, 1f, 20000, 1193033728, 1056964608);
		}
		else if (iParam1 == 3)
		{
			HUD::_THEFEED_DISABLE(bVar0, 111.6832f, -781.5098f, 30.26971f, 1f, 20000, 1193033728, 1056964608);
		}
		else
		{
			TASK::TASK_ENTER_VEHICLE(bVar0, uParam0->f_1, 20000, 0, 1f, 256, 0);
		}
	}
}
...
void func_326(var uParam0, int iParam1)
{
	switch (iLocal_1431)
	{
		case 0:
			...
			{
				case 0:
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(unk_0x9B0761B4C3EB8BC7(), uParam0->f_1, "OJASbs01", 786603, 0, 16, -1, 3f, false, 2f);
					func_212(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNG", 9, 0, 0, 0);
					break;
				
				case 1:
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(unk_0x9B0761B4C3EB8BC7(), uParam0->f_1, "OJASbs02", 786603, 0, 16, -1, 3f, false, 2f);
					func_212(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNGa", 9, 0, 0, 0);
					break;
				
				case 2:
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(unk_0x9B0761B4C3EB8BC7(), uParam0->f_1, "OJASbs03", 786603, 0, 16, -1, 3f, false, 2f);
					func_212(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNGb", 9, 0, 0, 0);
					break;
				
				case 3:
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(unk_0x9B0761B4C3EB8BC7(), uParam0->f_1, "OJASbs04", 786603, 0, 16, -1, 3f, false, 2f);
...
void func_327(var uParam0, int iParam1, bool bParam2)
{
	...
	else if (iParam1 == 1)
	{
		...
		bLocal_1449 = 269.7723f;
		Local_1445 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_1442, bLocal_1449, Var1) };
	}
	else if (iParam1 == 2)
	{
	...
	else if (iParam1 == 3)
	{
		...
		bLocal_1449 = 68.7612f;
		Local_1445 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_1442, bLocal_1449, Var1) };
	}
	MISC::GET_GROUND_Z_FOR_3D_COORD(Local_1442, &uVar0, false, false);
	PED::SET_PED_COORDS_KEEP_VEHICLE(unk_0x9B0761B4C3EB8BC7(), Local_1445);
	ENTITY::SET_ENTITY_HEADING(uParam0->f_1, bLocal_1449);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_1, 5f);
	VEHICLE::SET_VEHICLE_FORWARD_SPEED(uParam0->f_1, 5f);
	VEHICLE::SET_VEHICLE_FIXED(uParam0->f_1);
	if (bLocal_1398)
	{
		Local_1441 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_1442, bLocal_1449, 2f, 5.6201f, 0.1098f) };
	}
	else if (bLocal_1399)
	{
		Local_1441 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_1442, bLocal_1449, 2f, 5.6201f, 0.1098f) };
	...
	if (bParam2)
	{
		TASK::TASK_LOOK_AT_COORD(unk_0x9B0761B4C3EB8BC7(), Local_1441, 5000, 0, 2);
	}
}
...
void func_328(var uParam0)
{
	...
	if (MISC::IS_BIT_SET(uParam0->f_1) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam0->f_1, 0))
	{
		bVar1 = false;
		while (bVar1 < 8)
		{
			if (!SYSTEM::VDIST2(uParam0->f_1, bVar1, 0))
			{
				bVar0[bVar1] = MISC::IS_MINIGAME_IN_PROGRESS(uParam0->f_1, bVar1, 0);
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bVar0[bVar1], true, false);
				if (MISC::IS_BIT_SET(bVar0[bVar1]))
				{
					PED::DELETE_PED(&(bVar0[bVar1]));
				}
			}
			bVar1++;
		}
...
void func_329(int iParam0)
{
	...
	bVar0 = ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7());
	fVar1 = (Local_1898[iParam0 /*30*/].f_4 + 180f);
	Var2 = { -SYSTEM::SIN(bVar0), SYSTEM::COS(bVar0), 0f };
	Var3 = { Local_1898[iParam0 /*30*/].f_1 - Var4 };
	Var5 = { ENTITY::GET_ENTITY_SPEED_VECTOR(unk_0x9B0761B4C3EB8BC7(), false) };
	Var6 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(unk_0x9B0761B4C3EB8BC7()) };
	if (!bLocal_1386)
	{
	...
	if (!bLocal_1386 && !bLocal_1385)
	{
		if (fVar1 < 360f)
		{
			if (bVar0 > Local_1898[iParam0 /*30*/].f_4 && bVar0 < fVar1)
			{
				bLocal_1384 = false;
			}
			else
		...
		else if (bVar0 < Local_1898[iParam0 /*30*/].f_4 && bVar0 > (fVar1 - 360f))
		{
			bLocal_1384 = true;
		}
		else
...
void func_332(var uParam0)
{
	...
	switch (iLocal_1420)
	{
		case 0:
			...
			else if (func_213(uParam0, bLocal_1453))
			{
				if (!func_221())
				{
					func_201(&(uParam0->f_16), 4, bLocal_1453, "BusPed1", 0, 1);
...
int func_334(int iParam0)
{
	...
	bVar0 = ENTITY::IS_ENTITY_IN_WATER(unk_0x9B0761B4C3EB8BC7());
	fVar1 = (Local_1898[iParam0 /*30*/].f_4 - 180f);
	if (SYSTEM::COS(ENTITY::IS_ENTITY_PLAYING_ANIM((bVar0 - fVar1))) <= 0.766f)
	{
		bLocal_1386 = false;
		iVar2 = 0;
	}
...
void func_337()
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			if (!SYSTEM::VMAG(Local_1898[iVar0 /*30*/].f_9))
			{
				...
				PED::IS_PED_IN_PARACHUTE_FREE_FALL(Local_1898[iVar0 /*30*/].f_9, &(Local_1898[iVar0 /*30*/].f_10));
			}
		}
		iVar0++;
	}
...
bool func_338(struct<3> Param0, bool bParam1)
{
	int iVar0;
	
	iVar0 = HUD::ADD_BLIP_FOR_COORD(Param0);
	HUD::SET_BLIP_SCALE(iVar0, func_61(MISC::SET_BIT(), 1f, 1f));
...
void func_339()
{
	if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_1459, 0))
	{
		STREAMING::REMOVE_ANIM_DICT(&bLocal_1459);
	}
	if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_1460, 0))
	{
		STREAMING::REMOVE_ANIM_DICT(&bLocal_1460);
	}
}
...
int func_340(var uParam0)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			bVar0 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
			if (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("bus"))
			{
				uParam0->f_1 = bVar0;
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uParam0->f_1, true, false);
				bLocal_1398 = true;
			}
			else if (MISC::GET_MODEL_DIMENSIONS(bVar0) == joaat("coach"))
			{
				uParam0->f_1 = bVar0;
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uParam0->f_1, true, false);
				bLocal_1399 = true;
...
int func_343(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && ENTITY::DOES_ENTITY_EXIST(joaat("a_f_o_genstreet_01")))
	{
		iVar0 = 1;
	}
	else
...
int func_344(var uParam0)
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(uParam0->f_16) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_14)) && ENTITY::DOES_ENTITY_EXIST(joaat("a_m_m_eastsa_01")))
	{
		iVar0 = 1;
	}
	else
			...
			if (iLocal_1429 > 0)
			{
				if (!iLocal_1395)
				{
					...
					while (bVar0 < 9)
					{
						if (ENTITY::GET_ENTITY_COORDS(uParam0->f_1, false))
						{
							if (MISC::IS_MINIGAME_IN_PROGRESS(uParam0->f_1, bVar0, 0) != 0)
							{
								bLocal_1457 = MISC::IS_MINIGAME_IN_PROGRESS(uParam0->f_1, bVar0, 0);
								func_201(&(uParam0->f_16), 7, bLocal_1457, "BusPed7", 0, 1);
								iLocal_1395 = 1;
							}
						}
						bVar0++;
					}
					if (func_213(uParam0, bLocal_1457))
					{
...
void func_347(int* iParam0, bool bParam1)
{
	...
	if (!iLocal_1402)
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0->f_1, 0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iParam0->f_1) || PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
			{
				iLocal_1402 = 1;
			}
		}
	...
	if (iLocal_1392 && iLocal_1402)
	{
		if (!iLocal_1390)
		{
			...
			while (iVar0 < 9)
			{
				if (ENTITY::GET_ENTITY_COORDS(iParam0->f_1, false))
				{
					if (MISC::IS_MINIGAME_IN_PROGRESS(iParam0->f_1, iVar0, 0) != 0)
					{
						bVar1 = MISC::IS_MINIGAME_IN_PROGRESS(iParam0->f_1, bVar0, 0);
						if (!bParam1)
						{
							if ((NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(0, 65535) % 3) < 1)
							{
								if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bVar1, "veh@bus@passenger@rds@idle_panic", "sit", 3) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bVar1, "veh@bus@passenger@rps@idle_panic", "sit", 3))
								{
						...
						if (bParam1)
						{
							if ((bVar0 % 2) == 0)
							{
								TASK::TASK_PLAY_ANIM(bVar1, "veh@bus@passenger@rps@idle_panic", "sit", 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), false, false, false);
							}
							else
							{
								TASK::TASK_PLAY_ANIM(bVar1, "veh@bus@passenger@rds@idle_panic", "sit", 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), false, false, false);
							}
						}
					}
				}
...
void func_351(int* iParam0)
{
	if (!iLocal_1409)
	{
		if (MISC::IS_BIT_SET(iParam0->f_8) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0->f_8, 0))
		{
			if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iParam0->f_8, 0))
			{
...
float func_363(bool bParam0, int iParam1)
{
	return func_241(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), bParam0, iParam1);
}
	...
	if (iLocal_980 > 4)
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			if (MISC::IS_BIT_SET(bVar0))
			{
				...
				{
					if ((bVar0 != bLocal_1463 && MISC::GET_MODEL_DIMENSIONS(bVar0) != joaat("bus")) && MISC::GET_MODEL_DIMENSIONS(bVar0) != joaat("coach"))
					{
						bLocal_1463 = bVar0;
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_1463, true, true);
						VEHICLE::SET_VEHICLE_HAS_BEEN_DRIVEN_FLAG(bLocal_1463, false);
					}
				}
			}
		}
...
void func_365(int* iParam0)
{
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			bLocal_1461 = STATS::GET_PACKED_BOOL_STAT_KEY(unk_0x9B0761B4C3EB8BC7());
			fLocal_1467 = MISC::GET_MODEL_DIMENSIONS(bLocal_1461);
			if (fLocal_1467 != 0)
			{
				if (fLocal_1467 == joaat("bus"))
				{
					func_98(1);
					iParam0->f_1 = bLocal_1461;
					bLocal_1398 = true;
					VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iParam0->f_1, true);
					iLocal_980 = 10;
				}
				else if (fLocal_1467 == joaat("coach"))
				{
					func_98(1);
					iParam0->f_1 = bLocal_1461;
					bLocal_1399 = true;
...
void func_375()
{
	if (!MISC::IS_BIT_SET(bLocal_1462))
	{
		if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				bLocal_1462 = ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0);
				if (MISC::IS_BIT_SET(bLocal_1462) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(bLocal_1462, 0))
				{
					func_377(bLocal_1462);
				}
			}
...
void func_376()
{
	...
	if (!MISC::IS_BIT_SET(bLocal_1349))
	{
		return;
	}
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
	...
	if (SYSTEM::VDIST2(Var0, Local_1352) > 10000f)
	{
		if (MISC::IS_BIT_SET(bLocal_1349))
		{
			...
			PED::GET_PED_BONE_INDEX(&bLocal_1349);
		}
		if (MISC::IS_BIT_SET(bLocal_1348))
		{
			ENTITY::SET_ENTITY_VISIBLE(bLocal_1348, true, false);
...
{
	func_378(&(Global_105407.f_2890), &Global_105407, bParam0, 1);
}

int func_378(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	if (ENTITY::GET_ENTITY_COORDS(bParam2, false))
	{
		func_380(uParam0, bParam2, iParam3);
		uParam1->f_4 = bParam2;
		if (func_379(bParam2))
		{
			uParam1->f_3 = 1;
...
{
	func_158(bParam1, &(uParam0->f_12));
	uParam0->f_7 = func_382(bParam1, 145, 0);
	uParam0->f_11 = func_156(bParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
			uParam0->f_10 = func_381(bParam1);
		}
	}
	if (iParam2 == 1)
	{
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == bParam0)
			{
				...
				{
					if (iParam2 == 0 || MISC::GET_MODEL_DIMENSIONS(bParam0) == func_148(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_383(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_431(TASK::IS_PED_BEING_ARRESTED(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_424(TASK::IS_PED_BEING_ARRESTED(), 1);
			if (iVar4 != -1)
			{
		...
		func_384(iParam0, bParam1, bParam4, iParam5);
...
void func_384(int iParam0, var uParam1, bool bParam2, int iParam3)
{
	func_385(&Global_105407, TASK::IS_PED_BEING_ARRESTED(), iParam0, uParam1, iParam3, bParam2);
}

void func_385(var uParam0, bool bParam1, var uParam2, var uParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_43();
	...
	if (iParam4 == 1)
	{
		func_387(&(uParam0->f_2890), uParam0, bParam5, 1, 1, 0);
	}
...
void func_387(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, int iParam5)
{
	bool bVar0;
	...
	if (func_388(bParam2, &bVar0, iParam3, iParam5))
	{
		func_378(uParam0, uParam1, bVar0, iParam4);
	}
...
int func_388(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	bool bVar0;
...
void func_389(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		...
		while (iVar1 < 12)
		{
			func_392(bParam0, iVar1, &(uParam1->f_13[iVar1]), uParam1[iVar1], &(uParam1->f_26[iVar1]), iParam2, 145);
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 9)
		{
			func_391(bParam0, iVar1, &(uParam1->f_39[iVar1]), &(uParam1->f_49[iVar1]), iParam2, 145);
			iVar1++;
		}
		if (func_45(iVar0))
		{
...
void func_391(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_392(bool bParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_394(bool bParam0, bool bParam1)
{
	...
	if (func_45(iVar0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		if (bParam0 == unk_0x9B0761B4C3EB8BC7())
		{
			func_395(bParam0, &(Global_111858.f_2359.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_395(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(bParam0, func_400(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
int func_405(var uParam0)
{
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_178())
		{
			*uParam0 = func_407(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_407(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam1 == 6 || iParam1 == func_177(iVar0))
		{
			...
			{
				fVar1 = HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Param0, func_408(iVar0, 0), 1);
...
Vector3 func_412(struct<3> Param0, bool bParam1)
{
	struct<3> Var0;
	void fVar1;
	float fVar2;
...
int func_432(void fParam0, bool bParam1)
{
	int iVar0;
...
int func_435(var uParam0, var uParam1, bool bParam2)
{
	...
	if ((!HUD::REQUEST_ADDITIONAL_TEXT_FOR_DLC(3) && !func_441(&(uParam0->f_34))) && !func_436(uParam1))
	{
		func_488(uParam1);
		return 0;
	}
...
int func_439(bool bParam0, char* sParam1, int iParam2)
{
	if (unk_0xCE990E643CD9D0E5(bParam0, 30))
	{
		if (unk_0xCE990E643CD9D0E5(bParam0, 29))
		{
			switch (func_440(bParam0))
			{
				case 0:
...
void func_445(bool bParam0, bool bParam1, int iParam2)
{
...
void func_448(var uParam0, var uParam1)
{
	...
	unk_0x4C4FC7841A5FB983(0);
	CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
	if (!MISC::IS_BIT_SET(Local_1898[3 /*30*/].f_19))
	{
	...
	Local_1440 = { -455.2892f, -326.1364f, 41.22218f };
	TASK::WAYPOINT_RECORDING_GET_NUM_POINTS("OJASbs_102", &fLocal_1430);
...
{
	if (MISC::IS_BIT_SET(uParam1->f_1) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(uParam1->f_1, 0))
	{
		Local_1898[0 /*30*/].f_14[0] = PED::CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, uParam0->f_16, 3, true, true);
		PED::_0x2208438012482A1A(Local_1898[0 /*30*/].f_14[0], 1);
		...
		PED::_0x2208438012482A1A(Local_1898[0 /*30*/].f_14[1], 1);
		...
		PED::_0x2208438012482A1A(Local_1898[0 /*30*/].f_14[2], 1);
		Local_1898[1 /*30*/].f_14[0] = PED::CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, uParam0->f_16, 6, true, true);
		PED::_0x2208438012482A1A(Local_1898[1 /*30*/].f_14[0], 1);
		...
		PED::_0x2208438012482A1A(Local_1898[1 /*30*/].f_14[1], 1);
		...
		PED::_0x2208438012482A1A(Local_1898[1 /*30*/].f_14[2], 1);
		Local_1898[2 /*30*/].f_14[0] = PED::CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, uParam0->f_16, 0, true, true);
		PED::_0x2208438012482A1A(Local_1898[2 /*30*/].f_14[0], 1);
		...
		PED::_0x2208438012482A1A(Local_1898[2 /*30*/].f_14[1], 1);
		...
		PED::_0x2208438012482A1A(Local_1898[2 /*30*/].f_14[2], 1);
	}
}

void func_450(var uParam0)
{
	if (MISC::IS_BIT_SET(uParam0->f_1))
	{
...
void func_451()
{
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 < 3)
		{
			if (MISC::IS_BIT_SET(Local_1898[iVar0 /*30*/].f_14[iVar1]))
			{
...
void func_453(var uParam0, var uParam1)
{
	...
	unk_0xAF7D4BF357E8B79E((Local_1446.x - 40f), (Local_1446.f_1 - 40f), (Local_1446.f_2 - 40f), (Local_1446.x + 40f), (Local_1446.f_1 + 40f), (Local_1446.f_2 + 40f), 0, 1);
	if (MISC::IS_BIT_SET(uParam1->f_1))
	{
		if (!bLocal_1389)
		{
	...
	if (!bLocal_1389)
	{
		if (ENTITY::GET_ENTITY_COORDS(uParam1->f_1, false))
		{
			PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), uParam1->f_1, -1);
		}
	}
...
{
	bLocal_1459 = VEHICLE::CREATE_VEHICLE(uParam0->f_5, 439.7705f, -571.9359f, 27.5068f, 325f, true, true, false);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_1459, 5f);
	bLocal_1460 = VEHICLE::CREATE_VEHICLE(uParam0->f_5, 406.7046f, -625.4039f, 27.5068f, 91f, true, true, false);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_1460, 5f);
}
...
void func_457(var uParam0, var uParam1)
{
	...
	if (uParam0->f_274 == 1)
	{
		PED::IS_PED_IN_PARACHUTE_FREE_FALL(uParam1->f_2, "ASS_HK_DESTBLIP");
	}
	else if (uParam0->f_274 == 0)
	{
	}
	...
	if (uParam0->f_15 != 0)
	{
		...
		if (uParam0->f_274 == 1)
		{
			...
			bLocal_967 = PED::CREATE_PED_INSIDE_VEHICLE(uParam1->f_8, 4, uParam0->f_16, -1, true, true);
			PED::_0x2208438012482A1A(bLocal_967, 1);
			func_201(&(Local_983.f_16), 5, bLocal_967, "KerbCrawler", 0, 1);
		}
	}
	if (uParam0->f_274 == 2)
	{
	...
	else if (uParam0->f_274 == 0)
	{
		...
		PED::IS_PED_IN_PARACHUTE_FREE_FALL(uParam1->f_2, "ASS_BS_BLIP");
	}
	else
	{
		uParam1->f_2 = HUD::ADD_BLIP_FOR_COORD(uParam0->f_6);
	...
	if (uParam0->f_5 != 0)
	{
		if (!MISC::IS_BIT_SET(uParam1->f_1))
		{
			...
			if (uParam0->f_274 == 1)
			{
				...
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(uParam1->f_1, 1);
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(uParam1->f_1, 0);
			...
			if (uParam0->f_267 == 1)
			{
				if (MISC::IS_BIT_SET(uParam1->f_1))
				{
					if (ENTITY::GET_ENTITY_COORDS(uParam1->f_1, false))
					{
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(*uParam1))
						{
...
void func_460()
{
	...
	fLocal_1466[0] = PATHFIND::SET_ROADS_IN_AREA(Var0[0 /*3*/] - Vector(8f, 8f, 8f), Var0[0 /*3*/] + Vector(8f, 8f, 8f), false, true, 1, 1);
	fLocal_1466[1] = PATHFIND::SET_ROADS_IN_AREA(Var0[1 /*3*/] - Vector(8.5f, 8.5f, 8.5f), Var0[1 /*3*/] + Vector(8.5f, 8.5f, 8.5f), false, true, 1, 1);
	fLocal_1466[2] = PATHFIND::SET_ROADS_IN_AREA(Var0[2 /*3*/] - Vector(8.5f, 8.5f, 8.5f), Var0[2 /*3*/] + Vector(8.5f, 8.5f, 8.5f), false, true, 1, 1);
	fLocal_1466[3] = PATHFIND::SET_ROADS_IN_AREA(Var0[3 /*3*/] - Vector(9.5f, 9.5f, 9.5f), Var0[3 /*3*/] + Vector(9.5f, 9.5f, 9.5f), false, true, 1, 1);
	fLocal_1466[4] = PATHFIND::SET_ROADS_IN_AREA(Var0[4 /*3*/] - Vector(8f, 8f, 8f), Var0[4 /*3*/] + Vector(8f, 8f, 8f), false, true, 1, 1);
	fLocal_1466[5] = PATHFIND::SET_ROADS_IN_AREA(Var0[5 /*3*/] - Vector(15f, 15f, 15f), Var0[5 /*3*/] + Vector(15f, 15f, 15f), false, true, 1, 1);
}
...
void func_461(var uParam0, var uParam1, bool bParam2)
{
	...
	while ((!HUD::REQUEST_ADDITIONAL_TEXT_FOR_DLC(3) || !func_441(&(uParam0->f_34))) || !func_436(uParam1))
	{
		func_488(uParam1);
		SYSTEM::WAIT(0);
	}
...
void func_464(var uParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
...
void func_471(var uParam0)
{
	switch (iLocal_1347)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@assassinate@bus@call") && ENTITY::DOES_ENTITY_EXIST(joaat("p_phonebox_01b_s")))
			{
			...
			if (bLocal_1370)
			{
				if (MISC::IS_BIT_SET(bLocal_1348))
				{
					...
					if (MISC::IS_BIT_SET(bLocal_1348))
					{
						ENTITY::SET_ENTITY_VISIBLE(bLocal_1348, false, false);
						ENTITY::SET_ENTITY_COLLISION(bLocal_1348, false, false);
						ENTITY::SET_ENTITY_CAN_BE_DAMAGED(bLocal_1348, false);
						bLocal_1349 = OBJECT::CREATE_OBJECT(joaat("p_phonebox_01b_s"), -26.48f, -110.66f, 56.0227f, true, true, false);
						ENTITY::DETACH_ENTITY(bLocal_1349, 0f, 0f, 157.62f, 2, 1);
						ENTITY::SET_ENTITY_COLLISION(bLocal_1349, false, false);
						ENTITY::SET_ENTITY_CAN_BE_DAMAGED(bLocal_1349, false);
						ENTITY::SET_ENTITY_VISIBLE(unk_0x9B0761B4C3EB8BC7(), true, false);
					}
					...
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						...
						ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), fLocal_1354);
						PED::REMOVE_PED_HELMET(unk_0x9B0761B4C3EB8BC7(), true);
					}
					iLocal_1373 = PED::CREATE_SYNCHRONIZED_SCENE(Local_1371, Local_1372, 2);
					if (MISC::IS_BIT_SET(bLocal_1349))
					{
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_1373, bLocal_1349, -1);
					}
					TASK::TASK_SYNCHRONIZED_SCENE(unk_0x9B0761B4C3EB8BC7(), iLocal_1373, "oddjobs@assassinate@bus@call", "ass_bus_call_p1", 1000f, -2f, 2, 0, 1000f, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(bLocal_1349, iLocal_1373, "ass_bus_call_phone", "oddjobs@assassinate@bus@call", 1000f, -2f, 0, 1000f);
					...
					SYSTEM::SIN(false);
					HUD::DISPLAY_HUD(false);
					fLocal_1375 = PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(-26.48f, -110.66f, 56.0227f, 3f, 3f, 3f, 0f, 0, 7);
					ENTITY::SET_ENTITY_HEALTH(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_unarmed"), 1);
				...
				else
				{
					...
					if (!MISC::IS_BIT_SET(bLocal_1348))
					{
						bLocal_1348 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_1352, 5f, joaat("prop_phonebox_01b"), true, false, true);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1369)
			{
				if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_1373))
					{
						if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_1373) > 0.05f)
						{
			...
			if (func_168(&iLocal_1362))
			{
				if ((func_165(&iLocal_1362) > fLocal_1355 || (PED::DETACH_SYNCHRONIZED_SCENE(iLocal_1373) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_1373) >= 0.962f)) || bLocal_1368)
				{
					iLocal_1347 = 3;
				}
			}
			...
			if (bLocal_1368)
			{
				if (PED::REMOVE_SCENARIO_BLOCKING_AREA())
				{
					if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(unk_0x9B0761B4C3EB8BC7(), 0))
					{
						...
						ENTITY::SET_ENTITY_HEADING(unk_0x9B0761B4C3EB8BC7(), 236.2218f);
					}
					ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(bLocal_1349, -1000f, true);
					SYSTEM::WAIT(0);
					CAM::DO_SCREEN_FADE_IN(500);
		...
		case 3:
			...
			ENTITY::SET_ENTITY_COLLISION(bLocal_1349, true, false);
			SYSTEM::SIN(true);
			HUD::DISPLAY_HUD(true);
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(unk_0x9B0761B4C3EB8BC7());
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
			...
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&bLocal_1348);
			iLocal_980 = 4;
			break;
	}
}
...
void func_476(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, bool bParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (MISC::IS_BIT_SET(bVar0))
	{
		...
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_477(bVar0, Param0, Param1, fParam2))
					{
						bVar1 = true;
					}
				}
		...
		else
		{
			...
			if (fVar9 <= 2)
			{
				bVar8 = MISC::IS_MINIGAME_IN_PROGRESS(bVar0, false, 0);
				if (MISC::IS_BIT_SET(bVar8) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar8))
				{
					unk_0x03D382CB0B44E2FC(bVar8, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bVar8, 1), 1, 0, 0, 1);
				}
			...
			if (fVar9 <= 4)
			{
				bVar8 = MISC::IS_MINIGAME_IN_PROGRESS(bVar0, true, 0);
				if (MISC::IS_BIT_SET(bVar8) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar8))
				{
					unk_0x03D382CB0B44E2FC(bVar8, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bVar8, 1), 1, 0, 0, 1);
				}
...
int func_477(bool bParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
void func_483()
{
	if (MISC::IS_BIT_SET(bLocal_1461))
	{
		if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), bLocal_1461, 0))
		{
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(unk_0x9B0761B4C3EB8BC7());
			unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), 421.5518f, -640.2153f, 27.5072f, 1, 0, 0, 1);
		}
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_1461, true, false);
		VEHICLE::DELETE_VEHICLE(&bLocal_1461);
	}
}

void func_484(float fParam0, struct<3> Param1, struct<3> Param2)
{
...
bool func_492(struct<3> Param0, float fParam1)
{
	return func_493(&(Global_105407.f_2890), Param0, fParam1, 0);
}

bool func_493(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	bool bVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_521(uParam0))
	{
		...
		if (func_520(uParam0))
		{
			...
			if (MISC::IS_BIT_SET(bVar0))
			{
				...
				func_503(bVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
...
int func_498(bool bParam0, struct<3> Param1, bool bParam2)
{
	...
	{
		case joaat("cargobob"):
			if (func_500(bParam0, Global_75654.f_139[38], 0))
			{
				func_494(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_500(bParam0, Global_75654.f_139[43], 1))
			{
				func_494(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_500(bParam0, uVar1[iVar3], 1) && func_499(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_157(Param1, 0f, 0f, 0f, 0)) || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_502(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || MISC::GET_MODEL_DIMENSIONS(Global_96286[iVar0]) == func_148(iParam0, iParam1))
				{
...
void func_503(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::GET_ENTITY_COORDS(iParam0, false))
	{
		...
		if (((unk_0xCE990E643CD9D0E5(uParam1->f_77, 15) || func_511(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_510())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
int func_504(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_508(MISC::GET_MODEL_DIMENSIONS(*iParam0), 1) && unk_0x7F8B14CBFB9813E5(*iParam0, 24) != func_507(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_508(void fParam0, int iParam1)
{
	switch (fParam0)
	{
		case joaat("faction2"):
...
var func_529(struct<3> Param0, struct<3> Param1)
{
	...
	return PATHFIND::SET_ROADS_IN_AREA(Param0, Param1, false, true, 1, 1);
}
...
void func_539()
{
	if (PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(fLocal_1375))
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(fLocal_1375);
	}
}
