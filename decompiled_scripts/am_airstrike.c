...
void func_44()
{
	...
	if (func_41(Local_238.f_2))
	{
		uVar0 = unk_0x770D3B2B4702434A(Local_238.f_2);
		Var2 = { unk_0x3E4D3CCC220BDFB1(uVar0, 1) };
	}
	if (!iLocal_59)
	{
				...
				if (!iLocal_55)
				{
					if (!func_93(Local_238.f_2.f_3))
					{
						if (func_41(Local_238.f_2))
						{
							...
							unk_0x65555FEEBD9DBC22(unk_0x770D3B2B4702434A(Local_238.f_2), SYSTEM::ROUND(50f));
							iLocal_55 = 1;
						}
					}
				}
		...
		case 2:
			if (func_41(Local_238.f_2))
			{
				...
				if (!iLocal_53)
				{
					...
					if (unk_0x272784C60C397DB6(Var3, unk_0x3E4D3CCC220BDFB1(uVar0, 1), 1) <= (60f * 5f))
					{
...
void func_54()
{
	...
	if (!func_93(Local_238.f_2.f_3))
	{
		if (func_55(Local_238.f_2.f_3))
		{
			...
			{
				uVar0 = unk_0x3C6C6327BA564AEE(Local_238.f_2.f_3);
...
void func_65()
{
	if (!iLocal_50)
	{
		if (func_41(Local_238.f_2))
		{
			...
			unk_0x95B4DF5308CFD8F9(0, unk_0x770D3B2B4702434A(Local_238.f_2), 0, 0, Local_60 + Vector((50f + 5f), 0f, 0f), 4, 60f, 15f, -1f, SYSTEM::CEIL((50f + 5f)), 20, 1);
			unk_0x95B4DF5308CFD8F9(0, unk_0x770D3B2B4702434A(Local_238.f_2), 0, 0, Local_238.f_2.f_14, 4, 60f, 25f, -1f, SYSTEM::CEIL((50f + 5f)), 20, 1);
	...
	if (!unk_0xF7DE07F319727299(Local_238.f_2))
	{
		if (func_89(Local_238.f_2.f_1))
		{
			if (unk_0x33CDB98869100CA5("AIRSTRIKE_FLYOVER", 0))
			{
				...
				{
					if (func_68(&(Local_238.f_2), Local_238.f_2.f_1, Var0, uVar1, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
					{
						Local_238.f_2.f_14 = { Var0 * Vector(0f, -1f, -1f) };
						unk_0x5DC21979EC6C531F(unk_0x770D3B2B4702434A(Local_238.f_2), 2);
						unk_0x6A8F948698B360B4(unk_0x770D3B2B4702434A(Local_238.f_2), 0);
...
int func_68(var uParam0, int iParam1, struct<3> Param2, var uParam3, int iParam4, int iParam5, bool bParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, bool bParam13)
{
	float fVar0;
	int iVar1;
	...
	if (unk_0xAE06B9E39EBDE049(iVar1))
	{
		*uParam0 = unk_0x50ACD47FCBAD9F89(iVar1);
		...
		if (unk_0xF7DE07F319727299(*uParam0))
		{
			...
			func_69(Param2, uParam3, iParam1, iVar1);
			return 1;
		}
	}
	return 0;
...
void func_69(struct<3> Param0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
...
void func_92()
{
	if (!iLocal_51)
	{
		if (func_41(Local_238.f_2))
		{
			...
			unk_0x95B4DF5308CFD8F9(0, unk_0x770D3B2B4702434A(Local_238.f_2), 0, 0, Local_240[unk_0x59E2AD1A8ACEDA31() /*5*/].f_2 + Vector((50f + 5f), 0f, 0f), 4, 60f, 15f, -1f, SYSTEM::CEIL((50f + 5f)), 20, 1);
			unk_0x95B4DF5308CFD8F9(0, unk_0x770D3B2B4702434A(Local_238.f_2), 0, 0, Local_238.f_2.f_14, 4, 60f, 25f, -1f, SYSTEM::CEIL((50f + 5f)), 20, 1);
...
void func_124(var uParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!unk_0x25DDB354A40FFCDB())
	{
		func_103();
