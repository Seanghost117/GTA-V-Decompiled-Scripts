...
void __EntryFunction__()
{
	...
	func_328(&bLocal_83, &(Local_82.f_28[0]));
	while (true)
	{
		SYSTEM::WAIT(0);
...
void func_1()
{
	switch (iLocal_87)
	{
		case 0:
			func_304();
			if (func_303(bLocal_83))
			{
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_83, "rcmabigail", "loop_talk", 3) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_83, "rcmabigail", "loop_look", 3))
				{
					TASK::TASK_PLAY_ANIM(bLocal_83, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0f, false, false, false);
		...
		case 1:
			func_299();
			if ((func_303(bLocal_83) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_83, "rcmabigail", "loop_2_cs", 3)) && NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(bLocal_83, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_87++;
			}
			break;
		...
		case 2:
			...
			if (func_290(1, 1093140480, 0))
			{
				if (func_303(bLocal_83))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_83, "ABIGAIL", 0, 0, 0);
				}
				func_289();
		...
		case 4:
			if (OBJECT::ADD_DOOR_TO_SYSTEM())
			{
				...
				if (func_303(unk_0x9B0761B4C3EB8BC7()) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
				{
					RECORDING::_0x81CBAE94390F9F89();
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(unk_0x9B0761B4C3EB8BC7());
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(unk_0x9B0761B4C3EB8BC7(), -1606.534f, 5253.981f, 2.9994f, 1f, 20000, 0.25f, false, 40000f);
					TASK::TASK_LOOK_AT_COORD(unk_0x9B0761B4C3EB8BC7(), -1602.62f, 5260.37f, 1.41f, -1, 0, 2);
				}
				if (func_303(bLocal_83) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(bLocal_83);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bLocal_83, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 0.25f, false, 40000f);
				}
			}
			else
			{
		...
		case 5:
			if ((iLocal_89 == 0 && STATS::_PLAYSTATS_ARENA_WARS_ENDED() == 4) && MISC::GET_GAME_TIMER() > (iLocal_86 - 300))
			{
			...
			if (func_224(1000) || MISC::GET_GAME_TIMER() > iLocal_86)
			{
				...
				{
					HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(unk_0x9B0761B4C3EB8BC7());
					TASK::TASK_LOOK_AT_COORD(unk_0x9B0761B4C3EB8BC7(), -1602.62f, 5260.37f, 1.41f, 5000, 0, 2);
				}
				func_3();
			}
...
int func_44(bool bParam0, void fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_69(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			bVar0 = func_71(func_90(iParam1, uParam0->f_2), Global_76644, 0);
			if (unk_0xCE990E643CD9D0E5(bVar0, uParam0->f_1))
			{
				unk_0xBE20AB8238688965(&(uParam0->f_6), true);
			}
			bVar0 = func_71(func_89(iParam1, uParam0->f_2), Global_76644, 0);
			if (unk_0xCE990E643CD9D0E5(bVar0, uParam0->f_1))
			{
				unk_0xBE20AB8238688965(&(uParam0->f_6), 2);
			}
			...
			{
				bVar0 = func_71(iVar1, Global_76644, 0);
				if (!unk_0xCE990E643CD9D0E5(bVar0, uParam0->f_1))
				{
					unk_0xBE20AB8238688965(&(uParam0->f_6), 4);
				}
...
int func_199()
{
	return func_200(TASK::IS_PED_BEING_ARRESTED(), 0);
}
...
void func_214(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_218(PLAYER::PLAYER_ID())) && !func_216(PLAYER::PLAYER_ID(), 0)) && !func_215()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_218(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
void func_233(struct<3> Param0, bool bParam1, int iParam2, int iParam3)
{
	struct<3> Var0;
	var uVar1;
	...
	if (MISC::IS_BIT_SET(Global_102423.f_4))
	{
		if (ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, false))
		{
			if (func_281(24) != Global_102423.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_278(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Global_102423.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						bParam1 = uVar1;
					}
				}
				func_234(Global_102423.f_4, Param0, bParam1, 24, 0);
			}
		}
	}
}

void func_234(bool bParam0, struct<3> Param1, bool bParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (MISC::IS_BIT_SET(bParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		func_268(iParam3, &Var0, Param1, bParam2, func_271(bParam0));
		func_235(iParam3, bParam0, 0);
	}
}
...
void func_236(bool bParam0, int iParam1)
{
	...
	func_273(bParam0, &(Global_111858.f_32745.f_5510));
}

int func_237(bool bParam0)
{
	if ((((((((((!MISC::IS_BIT_SET(bParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_252(bParam0, 0, 0)) || func_252(bParam0, 1, 0)) || func_252(bParam0, 2, 0)) || func_271(bParam0) != 145) || func_251(bParam0)) || func_250(bParam0)) || func_249(bParam0)) || func_248(bParam0)) || !func_238(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_250(bParam0))
		{
		}
		...
		if (func_252(bParam0, 0, 0))
		{
		}
		if (func_252(bParam0, 1, 0))
		{
		}
		if (func_252(bParam0, 2, 0))
		{
		}
		if (func_271(bParam0) != 145)
		{
		}
		return 0;
	}
...
int func_238(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_239(fParam0, 0))
	{
		return 0;
	}
...
int func_239(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
var func_254()
{
	...
	func_255(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_260(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
void func_268(int iParam0, var uParam1, struct<3> Param2, bool bParam3, int iParam4)
{
	if (func_265(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
void func_273(bool bParam0, var uParam1)
{
	int iVar0;
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_275(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
int func_290(int iParam0, float fParam1, int iParam2)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_297(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_297(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_299()
{
	if (func_303(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (iLocal_88 == 0)
		{
			if (func_303(bLocal_83))
			{
				if (func_300(unk_0x9B0761B4C3EB8BC7(), bLocal_83, 1) < 4f || (ENTITY::IS_ENTITY_IN_ANGLED_AREA(unk_0x9B0761B4C3EB8BC7()) > 2f && func_300(unk_0x9B0761B4C3EB8BC7(), bLocal_83, 1) < 6f))
				{
...
float func_300(bool bParam0, bool bParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_305()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_ID()))
	{
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_297(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_325(0) || Global_77102) || Global_77091 == 1) || !GRAPHICS::DRAW_SCALEFORM_MOVIE())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((OBJECT::ADD_DOOR_TO_SYSTEM() || func_310(0)) || func_324(1))
			{
			}
			else
			{
...
void func_343(bool bParam0)
{
	...
	if (!func_360())
	{
		...
		{
			func_161(iVar0, 1, 0);
			func_344(TASK::IS_PED_BEING_ARRESTED(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_345(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_351())
	{
		...
		{
			iVar2 = func_346(TASK::IS_PED_BEING_ARRESTED());
			if (iVar2 > -1)
			{
...
int func_349(void fParam0, bool bParam1)
{
	int iVar0;
