...
int func_8(int iParam0)
{
	...
	{
		return !func_9(unk_0x770D3B2B4702434A(iParam0));
	}
	return 0;
}
...
int func_15(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar1 < 32)
	{
		...
		if (func_313(bVar3, 1, 0))
		{
			if (SYSTEM::VDIST(PLAYER::GET_PLAYER_PED(bVar3), iParam3))
			{
				if (!unk_0x4577ACD7664F1CF3(bVar3))
				{
					iVar2 = ENTITY::GET_ENTITY_MODEL(PLAYER::GET_PLAYER_PED(bVar3), iParam3);
					if (iVar2 == iParam0)
					{
...
int func_23()
{
	...
	if (!func_289(0))
	{
		if (func_98(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1), &Local_81, &(Local_81.f_3)))
		{
			func_97(0);
		}
	}
	...
	{
		MISC::CLEAR_AREA(Local_81, 5f, true, false, false, false);
		if (func_92(&(Local_75.f_6), func_96(), Local_81, Local_81.f_3, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
		{
			...
			if (NETWORK::NET_TO_VEH("MPBitset", 3))
			{
				...
				{
					bVar2 = PED::IS_PED_IN_ANY_VEHICLE(iVar0, "MPBitset");
				}
				unk_0xBE20AB8238688965(&bVar2, 11);
				DECORATOR::DECOR_SET_INT(iVar0, "MPBitset", bVar2);
			}
			if (NETWORK::NET_TO_VEH("Not_Allow_As_Saved_Veh", 3))
			{
				DECORATOR::DECOR_SET_INT(iVar0, "Not_Allow_As_Saved_Veh", true);
			}
...
void func_24(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		if ((MISC::SET_BIT() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iParam0)) || !MISC::SET_BIT())
		{
			...
			if ((!func_33(4) && !bParam4) && !STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED())
			{
				func_27(iParam0);
			}
			if (func_26(MISC::GET_MODEL_DIMENSIONS(iParam0)))
			{
			...
			switch (uParam1->f_94)
			{
				...
				case 2:
					if (unk_0xCE990E643CD9D0E5(uParam1->f_95, 1) && unk_0xCE990E643CD9D0E5(uParam1->f_95, 2))
					{
						...
						{
							DECORATOR::DECOR_SET_INT(iParam0, "Veh_Modded_By_Player", PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_ID()));
						}
					}
					else if (NETWORK::NET_TO_VEH("Veh_Modded_By_Player", 3))
					{
						if (func_25(uParam1->f_81) && NETWORK::NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(&(uParam1->f_81)))
						{
							DECORATOR::DECOR_SET_INT(iParam0, "Veh_Modded_By_Player", PED::GET_VEHICLE_PED_IS_IN(unk_0xAAA938655BBB5286(&(uParam1->f_81))));
						}
						else
						{
...
void func_27(int iParam0)
{
	...
	if (Global_262145.f_19692)
	{
		if (MISC::IS_BIT_SET(iParam0))
		{
			...
			{
				Var0.x = MISC::GET_MODEL_DIMENSIONS(iParam0);
				Var0.f_1 = AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT(VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT(iParam0));
				if (NETWORK::NET_TO_VEH("RandomID", 3))
				{
					...
					{
						Var0.f_2 = PED::IS_PED_IN_ANY_VEHICLE(iParam0, "RandomID");
					}
				}
				func_28(Var0);
			}
...
int func_42(int iParam0, char* sParam1)
{
	int iVar0;
	bool bVar1;
	
	if (!func_52(iParam0, sParam1))
	{
		return 1;
	}
	iVar0 = 0;
...
int func_45(int iParam0, bool bParam1)
{
	...
	{
		if (func_46(iParam0, bParam1, Global_1678175, Global_1678175.f_1, Global_1678175.f_4, Global_1678175.f_7, Global_1678175.f_10, 0, Global_1678175.f_13))
		{
			if (MISC::SET_BIT())
			{
	...
	else
	{
		...
		if (((Global_1678175.f_23 == 0 && func_46(iParam0, bParam1, Global_1678175, Global_1678175.f_1, Global_1678175.f_4, Global_1678175.f_7, Global_1678175.f_10, 0, Global_1678175.f_13)) || Global_1678175.f_23 != 0) && ((Global_1678175.f_24 == 0 && func_46(iParam0, bParam1, Global_1678175, Global_1678175.f_14, Global_1678175.f_17, Global_1678175.f_20, Global_1678175.f_10, 1, Global_1678175.f_13)) || Global_1678175.f_24 != 0))
		{
			if (MISC::SET_BIT())
			{
				Global_1315750 = NETWORK::GET_NETWORK_TIME();
...
bool func_46(var uParam0, bool bParam1, var uParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5, var uParam6, int iParam7, var uParam8)
{
...
int func_47(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	...
	*uParam1 = ENTITY::_GET_ENTITY_BONE_ROTATION_LOCAL(iParam0, "chassis_dummy");
...
int func_52(int iParam0, char* sParam1)
{
	...
	if (((((((!(MISC::IS_BIT_SET(iParam0) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0, 0)) || !NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iParam0)) || !MISC::IS_DURANGO_VERSION(0, -1, 1)) || !((HUD::DOES_TEXT_LABEL_EXIST(sParam1, 13) && INTERIOR::GET_INTERIOR_GROUP_ID()) && MISC::IS_XBOX360_VERSION(sParam1))) || bVar0 == func_89()) || !func_313(bVar0, 0, 0)) || !bVar1) || func_53(iParam0))
	{
		return 0;
	}
	return 1;
...
bool func_63(int iParam0, bool bParam1)
{
	...
	iVar1 = iParam0;
	return unk_0xCE990E643CD9D0E5(bVar0, func_64(iVar1));
}
...
int func_71(int iParam0, int iParam1, int iParam2)
{
	...
	if ((MISC::SET_BIT() && func_72()) && Global_1314052)
	{
...
int func_77(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_81(MISC::GET_MODEL_DIMENSIONS(*iParam0), 1) && unk_0x7F8B14CBFB9813E5(*iParam0, 24) != func_80(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_92(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	float fVar0;
	int iVar1;
...
void func_93(struct<3> Param0, float fParam1, int iParam2, int iParam3)
{
	...
	if (func_94(PLAYER::PLAYER_ID(), Param0, iParam2) > -1)
	{
	...
	switch (Global_2405074.f_671)
	{
		case 2:
			if (PATHFIND::_ARE_PATH_NODES_LOADED_IN_AREA((Param0.x - 100f), (Param0.f_1 - 100f), (Param0.x + 100f), (Param0.f_1 + 100f)))
			{
				...
				if (((uParam6->f_3 && func_182(Param0, fVar2, fVar3, fVar4, 1f, 0, 0, 0, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0)) && !uParam6->f_7) && !func_180(Param0, *uParam5, iParam2, PLAYER::PLAYER_ID(), 0))
				{
					Global_2405074.f_677 = { Param0 };
				...
				if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2405074.f_694) < 10000)
				{
					if (NETWORK::NETWORK_ENTITY_AREA_DOES_EXIST(Global_2405074.f_693))
					{
						if (NETWORK::_0x4DF7CFFF471A7FB1(Global_2405074.f_693))
						{
							...
							{
								if (func_119(Global_2405074.f_677, Global_2405074.f_680, iParam2, PLAYER::PLAYER_ID(), 0) || func_101(Global_2405074.f_677, Global_2405074.f_680, iParam2, 1, 0, 0, 0, 1, 0))
								{
									func_121(Global_2405074.f_677, 0);
									func_120(-1);
								}
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam7 == 1 && PLAYER::PLAYER_ID() != iVar1) || iParam7 == 0)
		{
			if (func_313(iVar1, bParam3, bParam4))
			{
				...
				{
					if (!bParam6 || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(PLAYER::GET_PLAYER_PED(iVar1)) && func_118(bVar1)))
					{
						...
						{
							if (((unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1 && iParam8) && bParam5) && func_113(bVar1))
							{
							}
							else if (MISC::IS_BIT_SET(PLAYER::GET_PLAYER_PED(bVar1)))
							{
								...
								if (SYSTEM::VDIST(PLAYER::GET_PLAYER_PED(bVar1), 0))
								{
									...
									if (MISC::IS_BIT_SET(iVar3) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iVar3, 0))
									{
										...
										if (func_112(Param0, fParam1, iParam2, Var5, bVar6, fVar4, 0))
										{
											return 1;
										}
									}
								...
								if (func_102(func_111(bVar1), Param0, fParam1, iParam2, fVar2))
								{
									return 1;
								}
							}
...
int func_102(struct<3> Param0, struct<3> Param1, bool bParam2, void fParam3, float fParam4)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	if (SYSTEM::VDIST(Param0, Param1) < func_110(fParam3, 1008981770))
	{
		func_103(Param1, bParam2, fParam3, &Var0, &Var1, &fVar2, fParam4);
...
void func_104(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)
{
	...
	else
	{
		...
		if (iVar0 != 0)
		{
			func_105(iVar0, fParam1, fParam2, 1086324736, 1080033280, 1077936128);
			return;
		}
	}
...
void func_105(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)
{
	int iVar0;
...
Vector3 func_111(bool bParam0)
{
	return NETWORK::NETWORK_ARE_HANDLES_THE_SAME(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_112(struct<3> Param0, float fParam1, int iParam2, struct<3> Param3, bool bParam4, void fParam5, bool bParam6)
{
	int iVar0;
	struct<3> Var1[4];
	struct<3> Var2;
	...
	if (func_102(Param0, Param3, bParam4, fParam5, 1036831949))
	{
		return 1;
	}
	if (Global_1312332 && (iParam2 == joaat("kosatka") || fParam5 == joaat("kosatka")))
	{
		...
		func_103(Param3, bParam4, fParam5, &(Global_1707737.f_7), &(Global_1707737.f_10), &(Global_1707737.f_13), 1036831949);
	...
	else
	{
		...
		while (iVar0 < 4)
		{
			if (func_102(Var1[iVar0 /*3*/], Param3, bParam4, fParam5, 1036831949))
			{
				return 1;
			}
			iVar0++;
		...
		if (!bParam6)
		{
			if (func_112(Param3, bParam4, fParam5, Param0, fParam1, iParam2, 1))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 32)
	{
		if (!iParam3 == iVar0 || iParam4 == 1)
		{
			...
			else if (func_313(iVar1, 0, 0))
			{
				...
				{
					if (func_102(func_111(bVar1), Param0, fParam1, iParam2, 1036831949))
					{
						return 1;
					}
				}
		...
		if (PATHFIND::IS_VEHICLE_NODE_ID_VALID(iVar6))
		{
						...
						if ((uParam2->f_13 || uVar5 & 64 == 0) || uParam2->f_33 == 1)
						{
							if (uParam2->f_14 || uVar5 & 16 == 0)
							{
								if ((uVar5 & 128 == 0 && uVar5 & 256 == 0) && uVar5 & 512 == 0)
								{
									if (!func_156(Var1))
									{
										Var1 = { func_151(Var1, &fVar2, iVar7, uParam2->f_9, *uParam2, bVar8, uParam2->f_11, uParam2->f_34, &bVar9, bVar10, 1, uParam2->f_51) };
														...
														if (func_146(Var1, uParam2))
														{
															if ((uParam2->f_48 && !func_166(&Var1, 0)) || uParam2->f_48 == 0)
															{
																...
																if (SYSTEM::VMAG(Var1) > 0f)
																{
																	...
																	{
																		if ((uParam2->f_12 && !func_145(Var1, fVar2, uParam2->f_34, PLAYER::PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
																		{
			...
			if (iVar0 >= (40 + iVar13) || iVar0 >= 100)
			{
				...
				else
				{
					...
					{
						func_132(iVar13, *uParam0, &iVar0, &Var1, &fVar2, uParam2, bVar8, iVar7, iVar3, fVar11, fVar12, bVar9);
						Var27 = { Var1 };
						fVar28 = fVar2;
						if (!uParam2->f_50)
						{
...
int func_131(struct<3> Param0, float fParam1, bool bParam2, int iParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (iVar0 < 32)
	{
		if (!iParam2 == iVar0 || iParam3 == 1)
		{
			...
			if (!bVar2)
			{
				if (func_313(bVar1, 0, 1) && func_313(bParam2, 0, 1))
				{
					if (Global_2417956.f_261[iVar0])
					{
					...
					else if (SYSTEM::VDIST(func_111(bVar1), Param0) < 1f)
					{
						return 1;
					}
				}
				...
				else if (func_313(bVar1, 0, 1))
				{
					if (SYSTEM::VDIST(func_111(bVar1), Param0) < 1f)
					{
						return 1;
					}
				}
...
void func_132(int iParam0, struct<3> Param1, int iParam2, var* uParam3, float* fParam4, var uParam5, bool bParam6, int iParam7, int iParam8, float fParam9, float fParam10, bool bParam11)
{
	int iVar0;
	...
	while (iVar0 < 30)
	{
		...
		*uParam3 = { func_151(*uParam3, fParam4, iParam7, uParam5->f_9, *uParam5, bParam6, uParam5->f_11, uParam5->f_34, &bParam11, 0, 0, uParam5->f_51) };
		if (!func_156(*uParam3))
		{
			iVar0 = 999;
			return;
		...
		if (!func_142(iParam0))
		{
			if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam0))
			{
				if (!unk_0x6CC163E30ECE0790(iParam0) == unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()))
				{
					...
					{
						if (!func_138(unk_0x6CC163E30ECE0790(bParam0), unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()), 0))
						{
							return 1;
						}
					}
...
int func_144(struct<3> Param0, float fParam1, int iParam2)
{
	...
	if (MISC::IS_BIT_SET(iVar1) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(iVar1, 0))
	{
		...
		if (func_112(Param0, fParam1, iParam2, Var3, bVar4, fVar2, 0))
		{
			return 1;
		}
	}
	...
	if (func_139(PLAYER::PLAYER_ID(), 1, 0))
	{
		...
		if (Global_969055.f_268 > 0)
		{
			...
			while (iVar0 < Global_969055.f_268)
			{
				...
				{
					if (func_102(Param0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Global_969055.f_233[iVar0], 1), ENTITY::IS_ENTITY_IN_WATER(Global_969055.f_233[iVar0]), MISC::GET_MODEL_DIMENSIONS(Global_969055.f_233[iVar0]), 0.5f))
					{
						return 1;
					}
				}
		...
		if (Global_969055.f_266 > 0)
		{
			...
			while (iVar0 < Global_969055.f_266)
			{
				...
				{
					if (func_102(Param0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Global_969055.f_119[iVar0], 1), ENTITY::IS_ENTITY_IN_WATER(Global_969055.f_119[iVar0]), MISC::GET_MODEL_DIMENSIONS(Global_969055.f_119[iVar0]), 0.5f))
					{
						return 1;
					}
				}
...
Vector3 func_151(struct<3> Param0, float* fParam1, int iParam2, bool bParam3, struct<3> Param4, bool bParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10, bool bParam11)
{
	struct<3> Var0;
	var uVar1;
	var uVar2;
	...
	if (uVar2 & 1024 == 0 && !bParam6)
	{
		...
		if (bParam10)
		{
			...
			if (VEHICLE::IS_THIS_MODEL_A_HELI(iParam7) && func_153(Param0))
			{
				return 0f, 0f, 0f;
			}
		}
			...
			if (iVar2 > -1 && iVar2 < 101)
			{
				...
				if (SYSTEM::VMAG(Var3) > 0f)
				{
					if ((uParam2->f_57 && SYSTEM::VDIST(Var3, uParam2->f_35) > uParam2->f_4) || uParam2->f_57 == 0)
					{
						...
						{
							if ((uParam2->f_12 && !func_145(Var3, fVar4, uParam2->f_34, PLAYER::PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
							{
...
int func_182(struct<3> Param0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, bool bParam6, int iParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, float fParam12, bool bParam13, float fParam14, bool bParam15, bool bParam16)
{
	...
	if (iParam2 && !bParam5)
	{
		if (func_313(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!PED::REMOVE_SCENARIO_BLOCKING_AREA())
			{
				...
				if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_184(PLAYER::PLAYER_ID()), Param0, 1) <= (fVar2 + fParam1))
				{
				...
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_118(iVar1) || !bParam8) && !Global_2425869[iVar1 /*443*/].f_263)
					{
						...
						if (!bParam5)
						{
							...
							{
								if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_184(bVar1), Param0, 1) <= (fVar2 + fParam1))
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && PLAYER::PLAYER_ID() != iVar1) || iParam6 == 0)
		{
			if (func_313(iVar1, bParam2, bParam3))
			{
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam5 || (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(PLAYER::GET_PLAYER_PED(iVar1)) && func_118(bVar1)))
					{
						...
						{
							if (((unk_0x6CC163E30ECE0790(PLAYER::PLAYER_ID()) == -1 && uParam7) && bParam4) && func_113(bVar1))
							{
							}
							else if (MISC::IS_BIT_SET(PLAYER::GET_PLAYER_PED(bVar1)))
							{
								if (HUD::SET_BLIP_NAME_FROM_TEXT_FILE(func_111(bVar1), Param0, 1) < fParam1)
								{
									return 1;
								}
							}
...
void func_203(struct<3> Param0, int iParam1)
{
	...
	if (!func_221())
	{
		...
		else if (func_213(Param0, &iVar2, &iVar3) || (func_189(Param0, &(iVar2[0])) && (VEHICLE::IS_THIS_MODEL_A_PLANE(iParam1) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam1))))
		{
			func_231();
			iVar0 = 0;
			while (iVar0 < iVar2)
			{
				...
				{
					if (((func_211(unk_0x9B0761B4C3EB8BC7()) || func_210(unk_0x9B0761B4C3EB8BC7())) && VEHICLE::IS_THIS_MODEL_A_PLANE(iParam1)) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam1))
					{
						if (func_209(iParam1))
						{
...
int func_210(int iParam0)
{
	...
	if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1), -1308.118f, -2934.27f, 13.7545f) < 1000f)
	{
		return 1;
	}
	return 0;
...
int func_211(int iParam0)
{
	...
	if (SYSTEM::VDIST(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1), -2270.245f, 3127.913f, 31.8118f) < 1000f)
	{
		return 1;
	}
	return 0;
...
{
	Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1 = iParam0;
}
...
{
	unk_0xBE20AB8238688965(&(Global_1630317[PLAYER::PLAYER_ID() /*595*/].f_11.f_6), iParam0);
}
...
int func_255()
{
	...
	else if (!NETWORK::UGC_CLEAR_QUERY_RESULTS(func_17()))
	{
		return 1;
	}
	return 0;
...
void func_258(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	bVar1 = (iParam0 % 32);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2[iVar0]), bVar1);
}
...
void func_259(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	unk_0xBE20AB8238688965(&(Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2[iVar0]), iVar1);
}
...
int func_271(int iParam0)
{
	...
	if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(iParam0, 0))
	{
		...
		while (iVar0 < iVar1)
		{
			if (!SYSTEM::VDIST2(iParam0, (iVar0 - 1), 0))
			{
				iVar2++;
			}
			iVar0++;
...
void func_274()
{
	if (func_280())
	{
		if (!SYSTEM::VMAG(bLocal_82))
		{
			bLocal_82 = TASK::IS_PED_SPRINTING(func_16());
			HUD::SET_BLIP_SPRITE(bLocal_82, func_279());
			func_276(&bLocal_82, func_278());
			PED::IS_PED_IN_PARACHUTE_FREE_FALL(bLocal_82, func_275());
		}
	}
	else if (SYSTEM::VMAG(bLocal_82))
	{
		unk_0x93370FA10F15BE44(&bLocal_82);
	}
}
...
{
	Local_77[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/] = iParam0;
}
...
void func_286()
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar0))
		{
			...
			iVar1 = NETWORK::NETWORK_GET_PLAYER_INDEX(iLocal_78[iVar0]);
...
void func_287(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	bVar1 = (iParam0 % 32);
	VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_75.f_2[iVar0]), bVar1);
}
...
int func_290()
{
	...
	if (func_291() != 0)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS(func_291()) == 0)
		{
			return 1;
		}
	}
...
int func_308(struct<21> Param0)
{
	...
	func_309(0, -1, 0);
	MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(&Local_75, 8);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_77, 33);
