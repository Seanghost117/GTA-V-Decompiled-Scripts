...
int func_23()
{
	...
	{
		unk_0x555EE41D7C7078E6(Local_81, 5f, 1, 0, 0, 0);
		if (func_92(&(Local_75.f_6), func_96(), Local_81, Local_81.f_3, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
		{
			...
			if (unk_0x6844807B17DC2DFC("MPBitset", 3))
			{
				...
				{
					iVar2 = unk_0x8C0800114C2864BE(uVar0, "MPBitset");
				}
				unk_0xBE20AB8238688965(&iVar2, 11);
				unk_0x00AF6A2AAFB41525(uVar0, "MPBitset", iVar2);
			}
...
int func_92(var uParam0, int iParam1, struct<3> Param2, var uParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, bool bParam13)
{
	float fVar0;
	int iVar1;
	...
	if (unk_0xAE06B9E39EBDE049(iVar1))
	{
		*uParam0 = unk_0x50ACD47FCBAD9F89(iVar1);
		...
		if (unk_0xF7DE07F319727299(*uParam0))
		{
			...
			func_93(Param2, uParam3, iParam1, iVar1);
			return 1;
		}
	}
	return 0;
...
void func_93(struct<3> Param0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
...
int func_102(struct<3> Param0, struct<3> Param1, float fParam2, int iParam3, float fParam4)
{
	...
	if (SYSTEM::VDIST(Param0, Param1) < func_110(iParam3, 1008981770))
	{
...
Vector3 func_151(struct<3> Param0, var uParam1, int iParam2, bool bParam3, struct<3> Param4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10, bool bParam11)
{
	struct<3> Var0;
	var uVar1;
	var uVar2;
	...
	if (bParam11)
	{
		...
		{
			if (!func_154(Param0, *uParam1, Param4))
			{
...
void func_274()
{
	if (func_280())
	{
		...
		{
			uLocal_82 = unk_0x2BE000892D65EA2A(func_16());
			unk_0xE7B8403ABCA0391D(uLocal_82, func_279());
			func_276(&uLocal_82, func_278());
			unk_0xB023F5C66F5716C7(uLocal_82, func_275());
		}
	}
	else if (unk_0x8F678487EEBD8CE4(uLocal_82))
	{
...
void func_286()
{
	...
	while (iVar0 < unk_0xEFA28384DDD283E1())
	{
		if (unk_0xBD09DF93F957A0CF(iVar0))
		{
			...
			uVar1 = unk_0x9019589211A13B02(iLocal_78[iVar0]);
