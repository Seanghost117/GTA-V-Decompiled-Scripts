...
void __EntryFunction__()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("controller_races")) > 1)
	{
		ENTITY::STOP_ENTITY_ANIM();
	}
	while (INTERIOR::GET_INTERIOR_AT_COORDS(joaat("initial")) > 0)
	{
		SYSTEM::WAIT(0);
	}
	func_30();
...
void func_1()
{
	...
	if (func_11(8))
	{
		...
		{
			iVar1 = func_10(bVar0);
			if (unk_0xCE990E643CD9D0E5(Global_111858.f_24975.f_1, bVar0))
			{
				if (unk_0xCE990E643CD9D0E5(Global_111858.f_24975.f_3, bVar0))
				{
					...
					if (fVar2 > 43681f)
					{
						if (!func_7(iVar1))
						{
							if (!Global_111832[bVar0])
							{
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24975.f_3), bVar0);
							}
							else if ((MISC::GET_GAME_TIMER() - Global_111838[bVar0]) > 60000)
							{
								Global_111832[bVar0] = 0;
								Global_111838[bVar0] = MISC::GET_GAME_TIMER();
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24975.f_3), bVar0);
							}
...
void func_19()
{
	...
	if (func_11(7))
	{
		...
		{
			iVar1 = func_22(bVar0);
			if (unk_0xCE990E643CD9D0E5(Global_111858.f_24972.f_2, bVar0))
			{
				fVar2 = SYSTEM::VDIST2(func_9(PLAYER::PLAYER_ID()), func_8(iVar1, 0));
				if (fVar2 > 43681f)
				{
					if (!func_7(iVar1))
					{
						if (!Global_111822[bVar0])
						{
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24972.f_2), bVar0);
						}
						else if ((MISC::GET_GAME_TIMER() - Global_111827[bVar0]) > 60000)
						{
							Global_111822[bVar0] = 0;
							Global_111827[bVar0] = MISC::GET_GAME_TIMER();
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_24972.f_2), bVar0);
						}
