...
void func_1()
{
	...
	{
		case 0:
			HUD::HAS_ADDITIONAL_TEXT_LOADED("PGANG", 0);
			if (HUD::REQUEST_ADDITIONAL_TEXT_FOR_DLC(0))
			{
				iVar1 = 0;
				while (iVar1 <= 5)
				{
					if (MISC::IS_BIT_SET(Global_110568.f_225[iVar1]))
					{
						...
						if (fLocal_226 == 0)
						{
							fLocal_226 = MISC::GET_MODEL_DIMENSIONS(uLocal_221[iVar1]);
						}
						if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iVar1]))
						{
				...
				while (iVar1 <= 1)
				{
					if (MISC::IS_BIT_SET(Global_110568.f_222[iVar1]))
					{
						...
						if (fLocal_225 == 0)
						{
							fLocal_225 = MISC::GET_MODEL_DIMENSIONS(uLocal_220[iVar1]);
						}
					}
					iVar1++;
				}
		...
		case 1:
			...
			while (iVar1 <= 5)
			{
				...
				if (MISC::IS_BIT_SET(uLocal_221[iVar1]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iVar1]))
				{
					bVar3 = false;
				}
				iVar1++;
	...
	while (iVar1 <= 5)
	{
		if (MISC::IS_BIT_SET(uLocal_221[iVar1]))
		{
			if (STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iVar1]))
			{
		...
		if (SYSTEM::VMAG(uLocal_223[iVar1]))
		{
			if (!MISC::IS_BIT_SET(uLocal_221[iVar1]) || STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iVar1]))
			{
...
float func_6(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_9()
{
	...
	while (iVar0 <= 5)
	{
		if (MISC::IS_BIT_SET(uLocal_221[iVar0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iVar0]))
		{
			...
			{
				iVar3 = 0;
				MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(uLocal_221[iVar0], &iVar3, 1);
				if (iVar3 == joaat("weapon_molotov"))
				{
					if (WEAPON::HAS_PED_GOT_WEAPON(uLocal_221[iVar0], joaat("weapon_microsmg"), false))
					{
						ENTITY::SET_ENTITY_HEALTH(uLocal_221[iVar0], joaat("weapon_microsmg"), 1);
					}
					else
					{
						unk_0x92BD213E6A0E666B(uLocal_221[iVar0], joaat("weapon_microsmg"), -1, 1, 1);
					}
				}
			}
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					{
						TASK::TASK_COMBAT_PED(uLocal_221[iVar0], unk_0x9B0761B4C3EB8BC7(), 0, 16);
					}
					break;
				...
				case 2:
					...
					{
						TASK::TASK_SMART_FLEE_PED(uLocal_221[iVar0], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, true, false);
					}
					break;
				}
		}
	...
	switch (iLocal_211)
	{
		...
		case 3:
			if ((func_37() && (MISC::GET_GAME_TIMER() - iLocal_212) > 3000) && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(unk_0x9B0761B4C3EB8BC7()))
			{
...
void func_39(bool bParam0, struct<3> Param1)
{
	...
	if (!func_42(Param1))
	{
		MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(bParam0, &iVar1, 1);
		if (iVar0 == joaat("weapon_molotov"))
		{
			if (iVar1 != joaat("weapon_molotov"))
			{
				ENTITY::SET_ENTITY_HEALTH(bParam0, joaat("weapon_molotov"), 1);
			}
			if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, 242628503) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bParam0, 242628503) != 0)
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar2);
				TASK::TASK_STAND_STILL(false, NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1000, 6000));
				...
				AUDIO::STOP_SCRIPTED_CONVERSATION(bParam0, iVar2);
				TASK::CLEAR_SEQUENCE_TASK(&iVar2);
			}
		}
		else if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, -653332088) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bParam0, -653332088) != 0)
		{
			TASK::TASK_SHOOT_AT_COORD(bParam0, Param1, -1, -687903391);
		}
	}
	else if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, -982327190) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bParam0, -982327190) != 0)
	{
...
int func_43(int iParam0)
{
	...
	while (iVar0 <= 5)
	{
		if ((MISC::IS_BIT_SET(uLocal_221[iVar0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iVar0])) && uLocal_222[iVar0] > 0)
		{
			iLocal_219 = 1;
		}
		iVar0++;
	}
	if (((((((((((func_44(Global_110568.f_35, 134217728) || PED::CAN_PED_SEE_HATED_PED(uLocal_221[iParam0], unk_0x9B0761B4C3EB8BC7())) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), uLocal_221[iParam0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_221[iParam0])) || MISC::IS_BULLET_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uLocal_221[iParam0], 1), 15f, true)) || MISC::HAS_BULLET_IMPACTED_IN_AREA(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uLocal_221[iParam0], 1), 15f, true, true)) || FIRE::IS_EXPLOSION_IN_SPHERE(21, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uLocal_221[iParam0], 1), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(10, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uLocal_221[iParam0], 1), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(7, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uLocal_221[iParam0], 1), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uLocal_221[iParam0], 1), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uLocal_221[iParam0], 1), 15f)) || iLocal_219)
	{
		return 1;
	}
	return 0;
...
void func_45()
{
	...
	while (iVar0 <= 1)
	{
		if (MISC::IS_BIT_SET(uLocal_220[iVar0]) && ENTITY::GET_ENTITY_COORDS(uLocal_220[iVar0], false))
		{
			iVar2 = 0;
			while (iVar2 <= 5)
			{
				if (MISC::IS_BIT_SET(uLocal_221[iVar2]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iVar2]))
				{
					if (Local_37[iVar2 /*10*/].f_8 != -1 && Local_37[iVar2 /*10*/].f_8 == iVar0)
					{
						if (!unk_0xE0B3BC41DDA88DF0(uLocal_221[iVar2], uLocal_220[iVar0], 0))
						{
							uVar1[iVar0]++;
						}
					}
		...
		if (MISC::IS_BIT_SET(uLocal_221[iVar0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iVar0]))
		{
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					{
						if (!TASK::CLEAR_PED_TASKS(uLocal_221[iVar0], 286, 1))
						{
							PLAYER::SET_PLAYER_VEHICLE_DEFENSE_MODIFIER(uLocal_221[iVar0], 4.007714E-43f, 1);
						}
					}
					else
					{
						bVar5 = false;
						if (SYSTEM::VDIST(uLocal_221[iVar0], 0))
						{
							iVar6 = ENTITY::GET_ENTITY_MODEL(uLocal_221[iVar0], 0);
							iVar4 = 0;
							while (iVar4 <= 1)
							{
								if (!bVar5)
				...
				case 2:
					if (iLocal_215 != -1)
					{
						...
						if (MISC::IS_BIT_SET(uLocal_221[iLocal_215]))
						{
							if (SYSTEM::VDIST(uLocal_221[iLocal_215], 0))
							{
								iVar7 = ENTITY::GET_ENTITY_MODEL(uLocal_221[iLocal_215], 0);
							}
						}
					}
					if ((((((((iLocal_215 == -1 || !MISC::IS_BIT_SET(uLocal_221[iLocal_215])) || STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iLocal_215])) || !MISC::IS_BIT_SET(iVar7)) || !ENTITY::GET_ENTITY_COORDS(bVar7, false)) || VEHICLE::IS_VEHICLE_TYRE_BURST(bVar7, 0, true)) || VEHICLE::IS_VEHICLE_TYRE_BURST(bVar7, 1, true)) || VEHICLE::IS_VEHICLE_TYRE_BURST(bVar7, 4, true)) || VEHICLE::IS_VEHICLE_TYRE_BURST(bVar7, 5, true))
					{
						iVar8 = -1;
						bVar9 = false;
						iVar4 = 0;
						while (iVar4 <= 5)
						{
							if (MISC::IS_BIT_SET(uLocal_221[iVar4]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iVar4]))
							{
			...
			{
				iVar10 = 0;
				MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(uLocal_221[iVar0], &iVar10, 1);
			...
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					else if (!unk_0xE0B3BC41DDA88DF0(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 0))
					{
					...
					{
						TASK::TASK_VEHICLE_SHOOT_AT_PED(uLocal_221[iVar0], unk_0x9B0761B4C3EB8BC7(), 20f);
					}
					break;
					...
					if (SYSTEM::VDIST(uLocal_221[iVar0], 0))
					{
						if (iLocal_215 == iVar0)
						{
							if (func_46(uLocal_221[iVar0], 0) != -1)
							{
								...
								{
									TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(uLocal_221[iVar0], ENTITY::GET_ENTITY_MODEL(uLocal_221[iVar0], 0), 0);
								}
							}
							else if (!func_38(uLocal_221[iVar0], -1273030092, 1) || iLocal_215 != iLocal_216)
							{
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_221[iVar0], ENTITY::GET_ENTITY_MODEL(uLocal_221[iVar0], 0), unk_0x9B0761B4C3EB8BC7(), 8, 40f, 786468, 1000f, 0f, true);
							}
							else if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_221[iVar0], -1273030092) == 1)
							{
								...
								{
									TASK::TASK_DRIVE_BY(uLocal_221[iVar0], unk_0x9B0761B4C3EB8BC7(), 0, 0f, 0f, 0f, 1000f, 100, true, -753768974);
								}
							}
						}
						else if (func_46(uLocal_221[iVar0], 0) == -1)
						{
							...
							{
								TASK::TASK_VEHICLE_ESCORT(uLocal_221[iVar0], ENTITY::GET_ENTITY_MODEL(uLocal_221[iVar0], 0), ENTITY::GET_ENTITY_MODEL(uLocal_221[iLocal_215], 0), -1, 40f, 786468, -1f, 20, 20f);
							}
							else if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_221[iVar0], -1273030092) == 1)
							{
								if (!TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_221[iVar0]))
						...
						{
							bVar11 = MISC::IS_MINIGAME_IN_PROGRESS(ENTITY::GET_ENTITY_MODEL(uLocal_221[iVar0], 0), -1, 0);
							if (!MISC::IS_BIT_SET(bVar11) || STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(bVar11))
							{
								if (!func_38(uLocal_221[iVar0], 355471868, 1))
								{
									TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(uLocal_221[iVar0], ENTITY::GET_ENTITY_MODEL(uLocal_221[iVar0], 0), 0);
	...
	switch (iLocal_211)
	{
		...
		case 4:
			if (func_37() && (MISC::GET_GAME_TIMER() - iLocal_212) > 1000)
			{
				...
				if (iVar12 != -1 && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(uLocal_221[iVar12]))
				{
					if (SYSTEM::VDIST(uLocal_221[iVar12], 0))
					{
...
bool func_50(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_51(MISC::SET_BIT(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(bVar0, func_51(MISC::SET_BIT(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(bVar0, bParam1);
	}
...
void func_61()
{
	...
	while (iVar0 <= 5)
	{
		if (MISC::IS_BIT_SET(uLocal_221[iVar0]))
		{
			if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(uLocal_221[iVar0]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()))
			{
				TASK::TASK_SMART_FLEE_PED(uLocal_221[iVar0], unk_0x9B0761B4C3EB8BC7(), 1000f, -1, false, true);
			}
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_221[iVar0]));
		}
		if (SYSTEM::VMAG(uLocal_223[iVar0]))
		{
	...
	while (iVar0 <= 1)
	{
		if (MISC::IS_BIT_SET(uLocal_220[iVar0]))
		{
			STREAMING::REMOVE_ANIM_DICT(&(uLocal_220[iVar0]));
		}
		iVar0++;
	}
	PED::SET_PED_MODEL_IS_SUPPRESSED(fLocal_225, false);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(fLocal_226, false);
