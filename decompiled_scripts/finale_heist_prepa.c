...
void __EntryFunction__()
{
	...
	func_395();
	func_381();
	fLocal_264 = PATHFIND::SET_ROADS_IN_AREA(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, false, true, 1, 1);
	func_380(27, 0);
	if (func_379())
	{
...
void func_1()
{
	switch (iLocal_41)
	{
		case 0:
			...
			func_33();
			if (!CAM::IS_SCREEN_FADED_OUT(sLocal_257))
			{
				func_31(sLocal_257);
			}
			else
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_150, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)))
				{
...
bool func_12(var uParam0, struct<2> Param1, bool bParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_35()
{
	...
	switch (iLocal_41)
	{
		...
		case 1:
			...
			if (iLocal_45 == 2)
			{
				if (func_12(&uLocal_150, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)))
				{
		...
		case 3:
			if (func_7(Local_290))
			{
				...
				{
					PED::SET_PED_INTO_VEHICLE(unk_0x9B0761B4C3EB8BC7(), Local_290, -1);
				}
				else
				{
...
void func_39(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (MISC::SET_BIT())
		{
			if (((((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_44(PLAYER::PLAYER_ID())) && !func_41(PLAYER::PLAYER_ID(), 0)) && !func_40()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
			}
		}
		else if (((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && !func_44(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(unk_0x9B0761B4C3EB8BC7(), false);
		}
		Global_76831 = 0;
...
int func_49(bool bParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
int func_58(bool bParam0, struct<3> Param1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10)
{
	float fVar0;
...
bool func_63(bool bParam0, struct<3> Param1, float fParam2)
{
...
bool func_65(struct<3> Param0, int iParam1, bool bParam2)
{
	bool bVar0;
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_82(1, Local_265, 0))
			{
				...
				{
					fLocal_271 = PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
...
void func_73()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (bVar0 <= (15 - 1))
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_289[iVar1 /*22*/].f_15), bVar0);
			bVar0++;
		}
...
void func_74(bool bParam0, struct<3> Param1, float fParam2)
{
	if (func_377(iParam0))
	{
		HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(iParam0);
	}
	func_49(bParam0, Param1, fParam2, 0, 1);
}
...
void func_76(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_77()
{
	...
	while (iVar0 <= 2)
	{
		PED::_0x2208438012482A1A(Local_289[iVar0 /*22*/], false);
		...
		unk_0x92BD213E6A0E666B(Local_289[iVar0 /*22*/], joaat("weapon_pistol"), -1, 0, 0);
...
void func_79(int iParam0, bool bParam1, bool bParam2)
{
	if (!SYSTEM::VMAG(*iParam0))
	{
		*iParam0 = func_80(bParam1, bParam2, 5);
	}
}
...
int func_82(int iParam0, struct<3> Param1, float fParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			HUD::HAS_ADDITIONAL_TEXT_LOADED(sLocal_258, 0);
			HUD::HAS_ADDITIONAL_TEXT_LOADED(cLocal_293, 6);
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (MISC::IS_BIT_SET(Global_95452.f_9[iVar0]))
				{
					if (!VEHICLE::GET_VEHICLE_MOD(Global_95452.f_9[iVar0], 1))
					{
		...
		case 4:
			...
			while (iVar3 <= 3)
			{
				...
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[iVar3], true, true);
		...
		case 5:
			if (func_83(&iLocal_262, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_290))
				{
					OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_262, Local_290, 0f, 0f, -1.85f, 0.05f, NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_290, 2), 0, 0, 0, 0, 2, 1);
		...
		if (func_85(iParam1, "Loading", 0))
		{
			*uParam0 = PED::CREATE_PED(26, iParam1, Param2, fParam3, true, true);
			if (func_377(*uParam0))
			{
				...
				if (bParam6)
				{
					PED::_0x2208438012482A1A(*uParam0, bParam6);
				}
				if (!bParam7)
				{
...
void func_91(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, struct<3> Param5, int iParam6, bool bParam7, int iParam8)
{
	if (func_7(*bParam0))
	{
		switch (*iParam2)
		{
			case 0:
				...
				else if (func_97(*bParam0) || func_96(*bParam0))
				{
					func_34(iParam3);
					if (func_66(func_60(func_69()), 0, 0))
					{
			...
			case 2:
			case 1:
				if ((!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), *bParam0, 0) && !func_97(*bParam0)) && !func_96(*bParam0))
				{
					func_34(iParam4);
					if (!unk_0xC2169C00B643278B(*bParam0, Param5, iParam8, iParam8, 2f, 0, 1, 2))
					{
						func_79(iParam3, *bParam0, 1);
					}
					*iParam2 = 0;
				}
				break;
			...
			case 3:
				if (!func_97(*bParam0) && !func_96(*bParam0))
				{
					func_34(iParam4);
					if (!unk_0xC2169C00B643278B(*bParam0, Param5, iParam8, iParam8, 2f, 0, 1, 2))
					{
...
void func_92(char* sParam0, var uParam1)
{
	bool bVar0;
	void fVar1;
	int iVar2;
		...
		if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			if (bVar0 != *sParam0)
			{
				if (func_7(bVar0))
				{
					...
					{
						iVar2 = VEHICLE::GET_ENTITY_ATTACHED_TO_TOW_TRUCK(ENTITY::GET_ENTITY_MODEL(unk_0x9B0761B4C3EB8BC7(), 0));
						if (func_6(iVar2))
						{
							bVar0 = ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(iVar2);
...
void func_94(char* sParam0)
{
	...
	if (SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		if (bVar0 != *sParam0)
		{
			if (func_7(bVar0))
			{
				if (MISC::GET_MODEL_DIMENSIONS(bVar0) == func_95(func_69()))
				{
					func_93(sParam0);
					*sParam0 = bVar0;
					func_89(*sParam0, 1);
...
int func_96(int iParam0)
{
	...
	if ((func_377(unk_0x9B0761B4C3EB8BC7()) && SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0)) && func_7(iParam0))
	{
...
int func_101(bool bParam0, struct<3> Param1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
...
int func_107(int iParam0, bool bParam1)
{
	...
	{
		case 0:
			TASK::TASK_VEHICLE_MISSION_COORS_TARGET(bParam1, ENTITY::GET_ENTITY_MODEL(bParam1, 0), Local_266, 4, 20f, 786469, 3.5f, 5f, true);
			iLocal_43[iParam0] = 3;
			break;
		
		case 3:
			if (!func_111(iParam0, bParam1) || func_63(unk_0x9B0761B4C3EB8BC7(), Local_266, 2f))
			{
				iLocal_43[iParam0] = 4;
			}
			break;
...
int func_108(bool bParam0)
{
	...
	{
		bVar0 = func_26(bParam0);
		if (bVar0 > 3)
		{
			return 0;
		}
		if (func_116(bVar0) != bParam0)
		{
			return 0;
		}
...
int func_109(int iParam0, bool bParam1)
{
	...
	{
		case 0:
			if (!MISC::IS_POSITION_OCCUPIED(Local_254[iLocal_470 /*4*/], 1.5f, false, false, true, false, false, bParam1, false))
			{
				if (func_63(bParam1, Local_254[iLocal_470 /*4*/], 5f))
				{
					fVar0 = 1f;
				}
				else
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bParam1, Local_254[iLocal_470 /*4*/], fVar0, 20000, 0.25f, false, Local_254[iLocal_470 /*4*/].f_3);
				iLocal_43[iParam0] = 1;
			}
			break;
		...
		case 1:
			...
			{
				unk_0xF7E0A845F25F0FFE(bParam1, 0);
				iLocal_43[iParam0] = 2;
			}
			break;
...
int func_111(int iParam0, bool bParam1)
{
	if (!func_112())
	{
		if ((MISC::IS_BIT_SET(Local_290) && ENTITY::GET_ENTITY_COORDS(Local_290, false)) && !unk_0xC2169C00B643278B(Local_290, Local_266, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(unk_0x9B0761B4C3EB8BC7()) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_290, 0)) && AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) == 0)
			{
				if (unk_0xE0B3BC41DDA88DF0(bParam1, Local_290, 0) && MISC::IS_MINIGAME_IN_PROGRESS(Local_290, -1, 0) == bParam1)
				{
					iLocal_44[iParam0] = 2;
					return 1;
				}
...
int func_113(int iParam0, bool bParam1)
{
	if (!func_112())
	{
		if (unk_0x1037B9D45CE6B788(bParam1, 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.63f, 0, 1, 0) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.38f, 0, 1, 0))
		{
			iLocal_470 = 0;
			iLocal_44[iParam0] = 1;
			return 1;
		}
		else if (unk_0x1037B9D45CE6B788(bParam1, 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.63f, 0, 1, 0) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.38f, 0, 1, 0))
		{
			iLocal_470 = 1;
			iLocal_44[iParam0] = 1;
			return 1;
...
void func_119()
{
	...
	{
		if (MISC::IS_BIT_SET(Local_289[iVar0 /*22*/]) && !STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(Local_289[iVar0 /*22*/]))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_289[iVar0 /*22*/], unk_0x9B0761B4C3EB8BC7(), true))
			{
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_289[iVar0 /*22*/]);
				if (((WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(unk_0x9B0761B4C3EB8BC7()) || PED::IS_PED_BEING_STEALTH_KILLED(Local_289[iVar0 /*22*/])) || PED::WAS_PED_KILLED_BY_STEALTH(Local_289[iVar0 /*22*/])) || PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_289[iVar0 /*22*/]))
				{
					if (!bLocal_274)
					{
...
void func_120(int iParam0)
{
	...
	switch (Local_289[iParam0 /*22*/].f_20)
	{
		case 1:
			...
			{
				if (MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1000, 1500)
				{
					if (!func_78(Local_289[iParam0 /*22*/], -875674219))
					{
						PED::_0xF1C03A5352243A30(Local_289[iParam0 /*22*/]);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_289[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7(), 0);
					}
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(5000, 6000)
			{
		...
		case 3:
			if (MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(2500, 3000)
			{
		...
		case 5:
			if (MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1000, 3000)
			{
				func_125();
				return;
			}
		...
		case 7:
			if ((MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > 350)
			{
				...
				else
				{
					if (iLocal_465 != -1)
					{
						...
						else if ((PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()) || TASK::IS_PED_STRAFING(unk_0x9B0761B4C3EB8BC7())) || MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x9B0761B4C3EB8BC7()))
						{
							func_123(2);
						}
					...
					if ((func_78(Local_289[iParam0 /*22*/], -2128726980) || func_78(Local_289[iParam0 /*22*/], -982327190)) && AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) < 2)
					{
						if (!func_78(Local_289[iParam0 /*22*/], 1392476864))
						{
							TASK::TASK_ARREST_PED(Local_289[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7());
						}
					}
				}
			}
			if (!iLocal_463)
			{
				if (unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, true) && unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, 14))
				{
					if (iParam0 == 0)
					{
						sVar3 = "PRA_COPSHT1";
...
void func_123(int iParam0)
{
	...
	{
		PED::_0x2208438012482A1A(Local_289[0 /*22*/], false);
	}
	if (func_377(Local_289[1 /*22*/]))
	{
		PED::_0x2208438012482A1A(Local_289[1 /*22*/], false);
	}
	if (func_377(Local_289[2 /*22*/]))
	{
		PED::_0x2208438012482A1A(Local_289[2 /*22*/], false);
	}
	if (iParam0 != -1)
	{
		PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_ID(), iParam0, false);
		PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), false);
	}
}
...
int func_124(int iParam0, int iParam1)
{
	...
	while (bVar0 <= 14)
	{
		if (bVar0 != iParam1)
		{
			if (unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, bVar0))
			{
				return 0;
			}
		}
...
void func_127(int iParam0)
{
	if (Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (func_377(Local_289[iParam0 /*22*/]))
		{
			...
			{
				HUD::HIDE_HUD_AND_RADAR_THIS_FRAME(Local_289[iParam0 /*22*/]);
			}
			...
			TASK::TASK_ARREST_PED(Local_289[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7());
			unk_0x92BD213E6A0E666B(Local_289[iParam0 /*22*/], joaat("weapon_pistol"), -1, 0, 1);
...
void func_128(int iParam0)
{
	...
	if ((iLocal_40 != 2 && !iLocal_464) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(Local_289[iParam0 /*22*/], 0))
	{
		if (func_133(iParam0) && func_131(Local_289[iParam0 /*22*/], 30f))
		{
			...
			else if (!func_124(iParam0, 15) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
			{
				...
				{
					AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_289[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", false);
				}
				iLocal_464 = 1;
			}
		}
...
float func_132(bool bParam0, bool bParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_134(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_18 != 1 && !func_78(Local_289[iParam0 /*22*/], 242628503))
	{
		...
		if (iParam0 == 2)
		{
			...
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(false, Local_289[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, false, Local_289[iParam0 /*22*/].f_4);
			}
			else
			{
				TASK::TASK_ACHIEVE_HEADING(0, Local_289[iParam0 /*22*/].f_4, 0);
			}
			if (iLocal_459[2] && CAM::IS_SCREEN_FADED_OUT("sResumeRoot"))
			{
			...
			AUDIO::STOP_SCRIPTED_CONVERSATION(Local_289[iParam0 /*22*/], iVar0);
		...
		func_135();
		PED::_0x2208438012482A1A(Local_289[iParam0 /*22*/], false);
...
void func_135()
{
	if (func_12(&uLocal_46, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)))
	{
		if (!func_103())
		{
			if ((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&cLocal_471, "NONE") && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&cLocal_475, "NONE")) && !func_66("PR_TAKBACK", 0, 0))
			{
...
void func_152(int iParam0)
{
	...
	if (!func_173(iParam0))
	{
		if (func_154(Local_289[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_289[iParam0 /*22*/], 1), 100f))
		{
...
bool func_153(bool bParam0, bool bParam1, float fParam2, int* iParam3)
{
...
int func_154(bool bParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	struct<3> Var0;
	
	if (func_6(unk_0x9B0761B4C3EB8BC7()) && func_6(bParam0))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bParam0, unk_0x9B0761B4C3EB8BC7(), true))
		{
			return 1;
		}
		if (func_168(bParam0, bParam1, bParam5, bParam6, bParam7))
		{
			return 1;
		}
		if (!WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				{
					return func_167(unk_0x9B0761B4C3EB8BC7(), bParam0, fParam2);
				}
			}
		}
		if (bParam4)
		...
		else if (func_155(bParam0, fParam3))
		{
			return 1;
		}
	}
...
int func_155(bool bParam0, float fParam1)
{
	float fVar0;
	
	if (func_6(unk_0x9B0761B4C3EB8BC7()) && func_6(bParam0))
	{
		if (func_166(bParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bParam0))
		{
			if (WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
			{
				fVar0 = 40f;
...
bool func_156(bool bParam0, float fParam1)
{
	return func_157(bParam0, unk_0x9B0761B4C3EB8BC7(), fParam1, 1, 250, 7);
}

bool func_157(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	
	iVar2 = func_165(iParam0, bParam1);
	if (!func_6(iParam0) || !func_6(bParam1))
	{
		if (iVar2 != -1)
		{
	...
	if (!func_161(iParam0, bParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar2 == -1)
	...
	uVar0 = func_158(&(Local_38[iVar2 /*4*/]), Var1, bParam1, &(Local_38[iVar2 /*4*/].f_3), bParam0, bParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_38[iVar2 /*4*/].f_3) < iParam4);
}

int func_158(var uParam0, struct<3> Param1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_159(bool bParam0, bool bParam1)
{
	bool bVar0;
...
int func_161(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_163(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam1, 1) - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(iParam0, 1)) };
	...
	{
		Var1 = { func_163(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_167(bool bParam0, bool bParam1, float fParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_168(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_6(unk_0x9B0761B4C3EB8BC7()) && func_6(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_172(bParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_169(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_169(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_170(bool bParam0, float fParam1)
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_171(bParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_171(bool bParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_163(Param1 - NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_172(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
...
{
	if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(Local_289[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 6))
	{
		return 1;
	}
	return 0;
		...
		else if (iParam1 == 5)
		{
			if (Local_289[func_150(iParam0) /*22*/].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					...
					AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_289[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", false);
				}
				else if (iParam0 == 1)
				{
...
void func_178(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	Var0 = { func_181() };
	if (CAM::IS_SCREEN_FADED_OUT(sParam1) || CAM::IS_SCREEN_FADED_OUT(&Var0))
	{
	...
	if ((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&Var0, sParam1) && !func_66("PR_TAKBACK", 0, 0)) && !func_66("PR_GOVEH", 0, 0))
	{
		func_179();
		func_121(&uLocal_294, cLocal_293, sParam1, 7, 0, 0);
		if (bParam2)
...
void func_179()
{
	...
	{
		Var0 = { func_181() };
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&Var0, "PRA_COPTLK1") || NETWORK::NETWORK_IS_GAME_IN_PROGRESS(&Var0, "PRA_COPTLK2"))
		{
			cLocal_471 = { func_181() };
			cLocal_475 = { func_180() };
		}
	...
	if (!func_149(iParam0) || iParam2)
	{
		...
		else if (iParam1 == 5)
		{
			if (Local_289[iParam0 /*22*/].f_19 != 5)
			{
				...
				AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_289[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", false);
				func_183(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
	...
	if ((!func_149(iParam0) && Local_289[iParam0 /*22*/].f_20 != 6) && Local_289[iParam0 /*22*/].f_20 != 7)
	{
		...
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_282)
			{
				...
				{
					if (PED::IS_PED_SHOOTING(unk_0x9B0761B4C3EB8BC7()) || TASK::IS_PED_STRAFING(unk_0x9B0761B4C3EB8BC7()))
					{
						iLocal_282 = 1;
				...
				if (((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, 1, 0) && unk_0x1037B9D45CE6B788(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, 1, 0)) && !unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, 10)) && !unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_289[iParam0 /*22*/].f_16) && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0))
					{
						func_186(iParam0, 11);
					}
				}
		...
		else if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, 0, 1, 0) && unk_0x1037B9D45CE6B788(Local_289[iParam0 /*22*/], Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, 0, 1, 0))
		{
...
{
	if (unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, bParam1))
	{
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_289[iParam0 /*22*/].f_15), bParam1);
		Local_289[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_186(int iParam0, bool bParam1)
{
	if (!unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, bParam1))
	{
		unk_0xBE20AB8238688965(&(Local_289[iParam0 /*22*/].f_15), bParam1);
		Local_289[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_187(int iParam0)
{
	...
	{
		bVar0 = false;
		if (((func_153(Local_289[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7(), 5f, 1) && !PED::IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_289[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_289[iParam0 /*22*/]))
		{
...
int func_188(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(Local_289[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, 0, 1, 0))
		{
			return 1;
		}
	}
...
{
	if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_289[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7()))
	{
		if (MISC::IS_PC_VERSION(Local_289[iParam0 /*22*/]))
		{
			*iParam1 = 1;
		}
		else
...
void func_190(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_20 != 6 && Local_289[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			if (Local_289[iParam0 /*22*/].f_16)
			{
				if (!unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, 12))
				{
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, 1, 0))
					{
						iLocal_282 = 1;
						iLocal_281 = MISC::GET_GAME_TIMER();
						if (iVar0 == 4)
			...
			else if (!unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, 1, 0) || unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, 12))
			{
				func_191(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_255[3 /*7*/], Local_255[3 /*7*/].f_3, Local_255[3 /*7*/].f_6, 0, 1, 0))
	{
		func_193(iParam0, 3);
	}
	else
	...
	switch (iParam1)
	{
		...
		case 4:
			if (!SYSTEM::VDIST(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				...
				if (func_7(bVar0))
				{
					if (func_192(MISC::GET_MODEL_DIMENSIONS(bVar0)))
					{
						bLocal_273 = true;
					}
					else
					...
					if (!unk_0x1037B9D45CE6B788(bVar0, Local_255[4 /*7*/], Local_255[4 /*7*/].f_3, Local_255[4 /*7*/].f_6, 0, 1, 0))
					{
						func_185(iParam0, 8);
						func_185(iParam0, 7);
					}
...
void func_193(int iParam0, int iParam1)
{
	...
	{
		case 1:
			if ((!unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, 6) && !unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, true)) && !unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, 9))
			{
		...
		case 2:
			if (!unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, true))
			{
		...
		case 4:
			if (!unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, 8))
			{
				...
				{
					VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_289[iParam0 /*22*/].f_15), 9);
					func_186(iParam0, 8);
				}
			}
			break;
...
int func_196(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_197()
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			if (MISC::IS_BIT_SET(Local_289[iVar0 /*22*/]))
			{
	...
	switch (Local_289[iParam0 /*22*/].f_19)
	{
		case 1:
			if (MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(2500, 3000)
			{
				...
				{
					if ((unk_0xCE990E643CD9D0E5(Local_289[iParam0 /*22*/].f_15, 13) && (MISC::GET_GAME_TIMER() - iLocal_276) > 2500) && !iLocal_466)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_121(&uLocal_294, cLocal_293, sVar0, 7, 0, 0);
						VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_289[iParam0 /*22*/].f_15), 13);
						VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_289[func_150(iParam0) /*22*/].f_15), 13);
						iLocal_466 = 1;
					}
					Local_289[iParam0 /*22*/].f_17 = 1;
				}
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(1500, 2000)
			{
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 5:
			if (MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(2500, 3000)
			{
				...
				{
					VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_289[iParam0 /*22*/].f_15), 5);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 7:
			if (MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > NETWORK::_NETWORK_GET_ROS_PRIVILEGE_25(2500, 3000)
			{
				...
				{
					VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_289[iParam0 /*22*/].f_15), 11);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
...
void func_201(int iParam0)
{
	...
	if (!iLocal_466)
	{
		bVar0 = PED::GET_PED_STEALTH_MOVEMENT(unk_0x9B0761B4C3EB8BC7());
...
void func_202(int iParam0)
{
	...
	bVar0 = WEAPON::IS_PED_ARMED(unk_0x9B0761B4C3EB8BC7(), 4);
	if (Local_289[iParam0 /*22*/].f_20 != 6 && Local_289[iParam0 /*22*/].f_20 != 7)
	{
...
void func_203(int iParam0)
{
	if (!func_173(iParam0))
	{
		...
		else if (func_154(Local_289[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(Local_289[iParam0 /*22*/], 1), 100f))
		{
			func_125();
		}
...
int func_204(int iParam0)
{
	...
	if (func_377(Local_289[iParam0 /*22*/]))
	{
		...
		if (ENTITY::IS_ENTITY_AT_ENTITY(unk_0x9B0761B4C3EB8BC7(), Local_289[iParam0 /*22*/], fVar0, fVar0, fVar0, false, true, 0))
		{
...
void func_205()
{
	...
	{
		if ((((func_377(Local_289[0 /*22*/]) && func_377(Local_289[1 /*22*/])) && func_12(&uLocal_46, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1))) && func_63(Local_289[0 /*22*/], Local_289[0 /*22*/].f_1, 3f)) && func_63(Local_289[1 /*22*/], Local_289[1 /*22*/].f_1, 3f))
		{
		...
		else if ((func_377(Local_289[2 /*22*/]) && func_12(&uLocal_98, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1))) && func_63(Local_289[2 /*22*/], Local_289[2 /*22*/].f_1, 3f))
		{
...
bool func_206(int iParam0, var uParam1, char* sParam2, float fParam3, int iParam4)
{
	if (!*uParam1)
	{
		if (!func_103() && GRAPHICS::DRAW_SCALEFORM_MOVIE())
		{
...
void func_208(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (MISC::IS_BIT_SET(*iParam0))
	{
		if (!STATS::_GET_PACKED_TITLE_UPDATE_INT_STAT_KEY(*iParam0))
		{
			...
			if (iParam2 == 1)
			{
				PED::_0x2208438012482A1A(*iParam0, false);
			}
		}
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_71(iLocal_40, bLocal_28))
			{
				...
				if (OBJECT::DOOR_SYSTEM_SET_HOLD_OPEN(Global_40754[13 /*31*/]))
				{
					SYSTEM::TIMESTEP(Global_40754[13 /*31*/], 1);
				}
				iLocal_479 = 0;
		...
		case 1:
			if (AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(PLAYER::PLAYER_ID()) < 3)
			{
				if (func_377(Local_289[2 /*22*/]))
				{
					...
					{
						if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 371.9393f, -1604.252f, 45.603f, 399.8371f, -1627.065f, 31.75287f, 32.73f, 0, 1, 2) || PED::IS_PED_PRONE(unk_0x9B0761B4C3EB8BC7()))
						{
			...
			if ((TASK::IS_PED_STRAFING(unk_0x9B0761B4C3EB8BC7()) && iLocal_479 == 0) && func_132(Local_290, unk_0x9B0761B4C3EB8BC7(), 1) < 100f)
			{
...
{
	unk_0xBE20AB8238688965(&Global_94810, bParam0);
}
...
void func_224()
{
	...
	if (MISC::IS_BIT_SET(iVar0))
	{
		if (ENTITY::GET_ENTITY_COORDS(bVar0, false))
		{
			func_225(bVar0, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bVar0, 1), ENTITY::IS_ENTITY_IN_WATER(bVar0), 24, 0);
		}
	}
}

void func_225(bool bParam0, struct<3> Param1, bool bParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (MISC::IS_BIT_SET(iParam0) && ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		func_260(iParam3, &Var0, Param1, bParam2, func_266(bParam0));
		func_226(iParam3, bParam0, 0);
	}
}
...
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_243(bParam0, 0, 0)) || func_243(bParam0, 1, 0)) || func_243(bParam0, 2, 0)) || func_266(bParam0) != 145) || func_242(bParam0)) || func_241(bParam0)) || func_240(bParam0)) || func_239(bParam0)) || !func_229(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_241(bParam0))
		{
		}
		...
		if (func_243(bParam0, 0, 0))
		{
		}
		if (func_243(bParam0, 1, 0))
		{
		}
		if (func_243(bParam0, 2, 0))
		{
		}
		if (func_266(bParam0) != 145)
		{
		}
		return 0;
	}
...
int func_229(void fParam0)
{
	if (fParam0 == 0)
	{
		return 0;
	}
	if (!func_230(fParam0, 0))
	{
		return 0;
	}
...
int func_230(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
var func_246()
{
	...
	func_247(&uVar0, SYSTEM::SHIFT_LEFT());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_252(unk_0xCE990E643CD9D0E5(bParam0, 31), -1, 1)) + 2011;
}
...
void func_260(int iParam0, var uParam1, struct<3> Param2, bool bParam3, int iParam4)
{
	if (func_257(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
int func_273(bool bParam0, int iParam1, int iParam2)
{
	...
	Global_76647[1 /*14*/] = { func_293(fVar0, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		uVar5 = { func_289(fVar0, iParam2) };
		iVar2 = 0;
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_273(bParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar6 = { func_285(fVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_273(bParam0, 14, uVar6[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_76647[2 /*14*/] = { func_293(fVar0, 14, iVar4, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar3)
									{
										if (func_273(bParam0, 14, iVar4))
										{
											if (!func_277(fVar0, iParam2, 14, iVar4, &uVar5, &(Global_76647[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					{
						iVar1 = func_275(bParam0, iVar2);
						Global_76647[2 /*14*/] = { func_293(fVar0, iVar2, iVar1, -1) };
						if (!func_277(fVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76647[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	{
		uVar8 = { func_285(fVar0, iParam2) };
		iVar7 = 0;
		while (iVar7 <= 8)
		{
			if (!func_273(bParam0, 14, uVar8[iVar7]))
			{
				return 0;
			}
			iVar7++;
	...
	else if (Global_76647[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(bParam0, func_274(iParam1)) && Global_76647[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(bParam0, func_274(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_275(bool bParam0, int iParam1)
{
	...
	return func_276(bParam0, iVar1, iVar2, iParam1);
}
...
int func_277(void fParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar1;
	...
	if (iParam2 == 14)
	{
		uVar0 = { func_285(fParam0, (*uParam4)[13]) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
	...
	if (func_284(fParam0, iParam2, iParam3))
	{
		return 1;
	}
	if (fParam0 == joaat("player_zero"))
	{
		if (func_283(fParam0, iParam2, iParam3, -1))
		{
		...
		else if (func_282(fParam0, iParam2, iParam3, -1))
		{
		...
		else if (func_278(fParam0, iParam2, iParam3, -1))
		{
			if (((((((((iParam1 == 1 || iParam1 == 2) || iParam1 == 4) || iParam1 == 5) || iParam1 == 10) || iParam1 == 11) || iParam1 == 12) || iParam1 == 14) || iParam1 == 18) || iParam1 == 50)
			{
				return 0;
...
int func_278(void fParam0, int iParam1, int iParam2, int iParam3)
{
	switch (fParam0)
	{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_279(fParam0, iParam2, 14, 3);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 1) || unk_0x4D0432E34C5996D9(func_279(fParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_279(fParam0, iParam2, 1, 3);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 0) || unk_0x4D0432E34C5996D9(func_279(fParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_279(fParam0, iParam2, 14, 4);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 1) || unk_0x4D0432E34C5996D9(func_279(fParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_279(fParam0, iParam2, 1, 4);
						}
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 0) || unk_0x4D0432E34C5996D9(func_279(fParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_279(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_274(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_282(void fParam0, int iParam1, int iParam2, int iParam3)
{
	if (fParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_284(void fParam0, int iParam1, int iParam2)
{
	switch (fParam0)
	{
		case joaat("player_zero"):
...
struct<10> func_285(void fParam0, int iParam1)
{
	int iVar0;
	struct<10> Var1;
	...
	switch (fParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				default:
					func_286(&Var1, fParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				default:
					func_286(&Var1, fParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_286(&Var1, fParam0, iParam1, 25);
					break;
			}
			break;
...
struct<17> func_289(void fParam0, int iParam1)
{
	int iVar0;
	struct<17> Var1;
	...
	switch (fParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				default:
					func_290(&Var1, fParam0, iParam1, 53);
					break;
			}
			break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				default:
					func_290(&Var1, fParam0, iParam1, 47);
					break;
			}
			break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				default:
					func_290(&Var1, fParam0, iParam1, 48);
					break;
			}
			break;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_290(&Var1, fParam0, iParam1, 26);
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_290(&Var1, fParam0, iParam1, 28);
					break;
			}
			break;
	}
...
struct<14> func_293(void fParam0, int iParam1, int iParam2, int iParam3)
{
	func_360();
	if (fParam0 == joaat("player_zero"))
	{
...
void func_296(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			bVar0 = func_299(func_298(iParam1, uParam0->f_2), Global_76644, 0);
			...
			{
				bVar0 = func_299(iVar1, Global_76644, 0);
				if (!unk_0xCE990E643CD9D0E5(bVar0, uParam0->f_1))
				{
					unk_0xBE20AB8238688965(&(uParam0->f_6), 4);
				}
...
void func_306(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_274(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_364()
{
	if (bLocal_274)
	{
		if (PED::IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0))
		{
			if (func_12(&uLocal_150, NETWORK::NETWORK_ARE_HANDLES_THE_SAME(unk_0x9B0761B4C3EB8BC7(), 1)))
			{
	...
	{
		if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0) || PED::IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
		{
			func_366(Global_40754[13 /*31*/], &fLocal_270);
		}
		else
...
{
	if (OBJECT::DOOR_SYSTEM_SET_HOLD_OPEN(iParam0))
	{
		if (*fParam1 != 0f)
		{
			if (!PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(fLocal_271))
			{
				fLocal_271 = PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
			}
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iParam0, *fParam1, true, true);
			*fParam1 = (*fParam1 - (0.2f * SYSTEM::TIMESTEP()));
			if (*fParam1 <= 0f)
			{
				unk_0xDC5C33A98881772F(iParam0, 1, 1, 0);
				VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(fLocal_271);
				*fParam1 = 0f;
			}
		}
	}
...
void func_385()
{
	...
	if (!OBJECT::DOOR_SYSTEM_SET_HOLD_OPEN(iLocal_269))
	{
		OBJECT::DOOR_SYSTEM_GET_OPEN_RATIO(iLocal_269, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, 1, 1, 0);
	}
...
void func_391()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (bVar2 <= (15 - 1))
		{
			VEHICLE::IS_VEHICLE_DRIVEABLE(&(Local_289[iVar1 /*22*/].f_15), bVar2);
			bVar2++;
		}
		iVar1++;
	}
...
void func_396()
{
	...
	if (OBJECT::DOOR_SYSTEM_SET_HOLD_OPEN(Global_40754[13 /*31*/]))
	{
		SYSTEM::TIMESTEP(Global_40754[13 /*31*/], 0);
	}
	OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40754[13 /*31*/], 0f, true, true);
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(fLocal_264, 0);
	func_55();
	PLAYER::SET_MAX_WANTED_LEVEL(5);
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	func_406();
