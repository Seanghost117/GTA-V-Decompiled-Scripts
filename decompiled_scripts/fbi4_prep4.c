...
void func_1()
{
	switch (iLocal_81)
	{
		case 0:
			...
			func_21();
			if (!CAM::IS_SCREEN_FADED_OUT(bLocal_187))
			{
				if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS(bLocal_187, "PRE_FKICKOFF"))
				{
...
void func_12()
{
	...
	{
		if (func_16(Global_111858.f_2359.f_539.f_4321) != MISC::GET_MODEL_DIMENSIONS(unk_0x9B0761B4C3EB8BC7()))
		{
...
void func_23()
{
	switch (iLocal_81)
	{
		case 0:
			...
			{
				TASK::TASK_LOOK_AT_COORD(unk_0x9B0761B4C3EB8BC7(), -1335.905f, -1278.671f, 5.07569f, -1, 0, 2);
				iLocal_81 = 1;
			}
			break;
...
int func_56(bool bParam0, int iParam1)
{
	...
	{
		bVar0 = func_15(bParam0);
		if (bVar0 > 3)
		{
			return 0;
		}
		if (func_57(bVar0) != bParam0)
		{
			return 0;
		}
		if (iParam1 == 0)
...
void func_77(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_84(int iParam0, struct<3> Param1, bool bParam2, bool bParam3, char* sParam4)
{
	if (!SYSTEM::VMAG(*iParam0))
	{
		*iParam0 = func_85(Param1, 5, bParam2);
		if (bParam3)
		{
			PED::IS_PED_IN_PARACHUTE_FREE_FALL(*iParam0, sParam4);
		}
	}
}
...
int func_88(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (MISC::SET_BIT())
	{
		if (func_92() == 0)
		{
			return unk_0xCE990E643CD9D0E5(func_89(func_91(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
bool func_93(bool bParam0, struct<3> Param1, float fParam2)
{
...
int func_97(int iParam0, struct<3> Param1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			HUD::HAS_ADDITIONAL_TEXT_LOADED(sLocal_188, 0);
			HUD::HAS_ADDITIONAL_TEXT_LOADED(sLocal_203, 6);
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_94(iLocal_80, 0))
			{
				...
				if (func_271())
				{
					func_114(&bVar1, -1327.175f, -1290.811f, 3.8472f, 291.8355f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
					func_111(0, -1, 1);
...
void func_114(bool bParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_194(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		{
			func_182(iParam10, 0);
			while (!func_115(bParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_115(bool bParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_176(bParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam3, false, false, false);
				...
				func_176(bParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (MISC::GET_MODEL_DIMENSIONS(*bParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Var2))
			{
				...
				*bParam0 = VEHICLE::CREATE_VEHICLE(Var2, Param2, fParam3, true, true, false);
				...
				func_176(bParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_116(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	if ((func_14(iParam0) && MISC::IS_BIT_SET(*bParam1)) && ENTITY::GET_ENTITY_COORDS(*bParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*bParam1) >= 0 && func_121(*bParam1, 0, &uVar0))
		{
			func_120(bParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_119(*bParam1);
...
int func_121(bool bParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_149(fVar0, bParam1, uParam2) && !func_148(PLAYER::PLAYER_ID())) && !func_131(bParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_129(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_127(bParam0)) && !bVar1) && !(func_126(MISC::GET_MODEL_DIMENSIONS(bParam0)) && func_123(PLAYER::PLAYER_ID())))
	{
	...
	if (!MISC::SET_BIT())
	{
		if ((func_122(bParam0) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("sentinel2")) && MISC::GET_MODEL_DIMENSIONS(bParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_133(bool bParam0)
{
	...
	if (func_134(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		return 1;
	}
	return 0;
...
int func_135(bool bParam0, bool bParam1)
{
	switch (MISC::GET_MODEL_DIMENSIONS(bParam0))
	{
		...
		case joaat("insurgent"):
			if (func_137(MISC::GET_MODEL_DIMENSIONS(bParam0), 0))
			{
				if (Global_2540384.f_303 == bParam0)
				{
					return 1;
				}
				else if (func_136(bParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_137(void fParam0, int iParam1)
{
	if (iParam1 == 0)
	{
		if (func_145(fParam0, 0))
		{
			return 1;
		}
	}
...
int func_145(void fParam0, int iParam1)
{
	switch (fParam0)
	{
		case joaat("faction2"):
...
int func_149(void fParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_129(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(fParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(fParam0)))
	{
		bVar0 = true;
	}
...
void func_151(bool bParam0, int iParam1)
{
	...
	func_152(bParam0, &(Global_111858.f_32745.f_5510));
}
...
void func_152(bool bParam0, var uParam1)
{
	...
	if (ENTITY::GET_ENTITY_COORDS(bParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(bParam0);
		...
		func_120(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
{
	if ((((((((((!MISC::IS_BIT_SET(iParam0) || !ENTITY::GET_ENTITY_COORDS(bParam0, false)) || func_171(bParam0, 0, 0)) || func_171(bParam0, 1, 0)) || func_171(bParam0, 2, 0)) || func_170(bParam0) != 145) || func_169(bParam0)) || func_168(bParam0)) || func_122(bParam0)) || func_167(bParam0)) || !func_157(MISC::GET_MODEL_DIMENSIONS(bParam0)))
	{
		if (func_168(bParam0))
		{
		}
		...
		if (func_171(bParam0, 0, 0))
		{
		}
		if (func_171(bParam0, 1, 0))
		{
		}
		if (func_171(bParam0, 2, 0))
		{
		}
		if (func_170(bParam0) != 145)
		{
		}
		return 0;
	}
...
int func_158(void fParam0, bool bParam1)
{
	int iVar0;
	struct<2> Var1;
...
int func_176(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_145(MISC::GET_MODEL_DIMENSIONS(*iParam0), 1) && unk_0x7F8B14CBFB9813E5(*iParam0, 24) != func_179(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_182(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (MISC::IS_BIT_SET(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || MISC::GET_MODEL_DIMENSIONS(Global_96286[iVar0]) == func_183(iParam0, iParam1))
				{
...
bool func_194(struct<3> Param0, float fParam1)
{
	...
	if (func_211(uParam0))
	{
		...
		if (func_210(uParam0))
		{
			...
			if (MISC::IS_BIT_SET(bVar0))
			{
				...
				func_199(bVar0, &(uParam0->f_12), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_173(bVar0, uParam0->f_11);
				}
				else if ((!func_197(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS(TASK::IS_PED_BEING_ARRESTED(), "startup_positioning"))
				{
					iVar4 = func_196(bVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_197(bool bParam0, struct<3> Param1, bool bParam2)
{
	void fVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_198(bParam0, Global_75654.f_139[38], 0))
			{
				func_185(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_198(bParam0, Global_75654.f_139[43], 1))
			{
				func_185(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_198(bParam0, uVar1[iVar3], 1) && func_98(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_193(Param1, 0f, 0f, 0f, 0)) || HUD::SET_BLIP_NAME_FROM_TEXT_FILE(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(bParam0, 1), NETWORK::NETWORK_ARE_HANDLES_THE_SAME(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_199(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::GET_ENTITY_COORDS(iParam0, false))
	{
		...
		if (((unk_0xCE990E643CD9D0E5(uParam1->f_77, 15) || func_202(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_201())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_176(&bParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
...
void func_227(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			bLocal_187 = "PRD_FKICKOFF";
			break;
		
		case 2:
			bLocal_187 = "PRD_FLEFT";
			break;
...
void func_240(bool bParam0)
{
	...
	else if (unk_0xCE990E643CD9D0E5(Global_111858.f_20560.f_471, bParam0) || unk_0xCE990E643CD9D0E5(Global_2097152[func_242() /*10931*/].f_6175.f_10, bParam0))
	{
		bVar0 = true;
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_111858.f_20560.f_471), bParam0);
		VEHICLE::IS_VEHICLE_DRIVEABLE(&(Global_2097152[func_242() /*10931*/].f_6175.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_241(bParam0));
...
var func_244(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	void fVar0;
	int iVar1;
	int iVar2;
...
bool func_246(bool bParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_2097152[func_242() /*10931*/].f_6175.f_10, bParam0);
}
...
int func_274(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			bVar0 = func_89(func_280(iParam1, uParam0->f_2), Global_76644, 0);
			...
			{
				bVar0 = func_89(iVar1, Global_76644, 0);
				if (!unk_0xCE990E643CD9D0E5(bVar0, uParam0->f_1))
				{
					unk_0xBE20AB8238688965(&(uParam0->f_6), 4);
				}
...
void func_285(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_286(iParam0));
			if (iVar11 > iVar10)
			{
